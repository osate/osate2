...
/**
 * @author lwrage
 * @version $Id: ProjectDirectoryFieldEditor.java,v 1.3 2005-10-03 15:55:44 aarong Exp $
 */
public class ProjectDirectoryFieldEditor extends DirectoryFieldEditor {
	...
	protected boolean doCheckState() {
		if (getTextControl() != null) {
			...
			IPath prefDir = new Path(getTextControl().getText());
			return projectDir.isPrefixOf(prefDir);
		} else {
			return true;
		}
	}
