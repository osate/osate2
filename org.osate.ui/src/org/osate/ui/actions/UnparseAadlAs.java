...
//		return "org.osate.ui.UnparseObjectMarker";
//	}
//
...
//		} else {
//			final IPath path = Dialog.saveAsDialog();
//			if (path != null) {
//				monitor.beginTask("Unparsing " + OsateResourceManager.convertToIResource(obj.eResource()).getFullPath(),
//						IProgressMonitor.UNKNOWN);
//				new AadlUnparser().doUnparseToFile(obj,path);
//				monitor.done();
//			}
//		}
//	}	
