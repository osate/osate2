...
public class AadlNavigatorSorter extends ViewerSorter {
	...
	public int compare(Viewer viewer, Object e1, Object e2) {
		boolean e1IsPluginResources = e1 instanceof IProject
				&& ((IProject) e1).getName().equals(PredeclaredProperties.PLUGIN_RESOURCES_PROJECT_NAME);
		boolean e2IsPluginResources = e2 instanceof IProject
				&& ((IProject) e2).getName().equals(PredeclaredProperties.PLUGIN_RESOURCES_PROJECT_NAME);
