...
public interface SystemConfiguration extends EObject
{
   ...
   * @see #setSystemImplementation(EObject)
   * @see org.osate.xtext.aadl2.sandbox.sandbox.SandboxPackage#getSystemConfiguration_SystemImplementation()
   * @model
   * @generated
   */
  EObject getSystemImplementation();

  /**
   * Sets the value of the '{@link org.osate.xtext.aadl2.sandbox.sandbox.SystemConfiguration#getSystemImplementation <em>System Implementation</em>}' reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @generated
   */
  void setSystemImplementation(EObject value);
