...
public class SystemConfigurationImpl extends MinimalEObjectImpl.Container implements SystemConfiguration
{
   ...
   * @ordered
   */
  protected AadlPackage systemImplementation;
   ...
   * @generated
   */
  public AadlPackage getSystemImplementation()
  {
   ...
   * @generated
   */
  public NotificationChain basicSetSystemImplementation(AadlPackage newSystemImplementation, NotificationChain msgs)
  {
    AadlPackage oldSystemImplementation = systemImplementation;
    systemImplementation = newSystemImplementation;
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, SandboxPackage.SYSTEM_CONFIGURATION__SYSTEM_IMPLEMENTATION, oldSystemImplementation, newSystemImplementation);
   ...
   * @generated
   */
  public void setSystemImplementation(AadlPackage newSystemImplementation)
  {
    if (newSystemImplementation != systemImplementation)
    {
      NotificationChain msgs = null;
      if (systemImplementation != null)
        msgs = ((InternalEObject)systemImplementation).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - SandboxPackage.SYSTEM_CONFIGURATION__SYSTEM_IMPLEMENTATION, null, msgs);
      if (newSystemImplementation != null)
        msgs = ((InternalEObject)newSystemImplementation).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - SandboxPackage.SYSTEM_CONFIGURATION__SYSTEM_IMPLEMENTATION, null, msgs);
      msgs = basicSetSystemImplementation(newSystemImplementation, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SandboxPackage.SYSTEM_CONFIGURATION__SYSTEM_IMPLEMENTATION, newSystemImplementation, newSystemImplementation));
  }
  ...
  public void eSet(int featureID, Object newValue)
  {
    switch (featureID)
    {
      case SandboxPackage.SYSTEM_CONFIGURATION__NAME:
        ...
        return;
      case SandboxPackage.SYSTEM_CONFIGURATION__SYSTEM_IMPLEMENTATION:
        setSystemImplementation((AadlPackage)newValue);
        return;
      case SandboxPackage.SYSTEM_CONFIGURATION__SYSTEM_INSTANCE_PROXY:
  ...
  public void eUnset(int featureID)
  {
    switch (featureID)
    {
      case SandboxPackage.SYSTEM_CONFIGURATION__NAME:
        ...
        return;
      case SandboxPackage.SYSTEM_CONFIGURATION__SYSTEM_IMPLEMENTATION:
        setSystemImplementation((AadlPackage)null);
        return;
      case SandboxPackage.SYSTEM_CONFIGURATION__SYSTEM_INSTANCE_PROXY:
