 ...
 * </p>
 * <ul>
 *   <li>{@link org.osate.xtext.aadl2.ba.behaviorAnnex.impl.BehaviorActionSetImpl#getActions <em>Actions</em>}</li>
 * </ul>
 *
 * @generated
 */
public class BehaviorActionSetImpl extends BehaviorActionsImpl implements BehaviorActionSet
{
  /**
  ...
  {
    return BehaviorAnnexPackage.Literals.BEHAVIOR_ACTION_SET;
  }
  ...
  public EList<BehaviorAction> getActions()
  {
    if (actions == null)
    {
      actions = new EObjectContainmentEList<BehaviorAction>(BehaviorAction.class, this, BehaviorAnnexPackage.BEHAVIOR_ACTION_SET__ACTIONS);
    }
    return actions;
  }
