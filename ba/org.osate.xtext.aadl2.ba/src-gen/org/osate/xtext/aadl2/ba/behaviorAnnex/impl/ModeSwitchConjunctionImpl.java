 ...
 * @generated
 */
public class ModeSwitchConjunctionImpl extends MinimalEObjectImpl.Container implements ModeSwitchConjunction
{
  /**
  ...
  {
    return BehaviorAnnexPackage.Literals.MODE_SWITCH_CONJUNCTION;
  }
  ...
  public EList<Reference> getTriggers()
  {
    if (triggers == null)
    {
      triggers = new EObjectContainmentEList<Reference>(Reference.class, this, BehaviorAnnexPackage.MODE_SWITCH_CONJUNCTION__TRIGGERS);
    }
    return triggers;
  }
