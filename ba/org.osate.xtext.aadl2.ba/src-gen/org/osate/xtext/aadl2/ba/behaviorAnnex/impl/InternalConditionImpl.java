 ...
 * </p>
 * <ul>
 *   <li>{@link org.osate.xtext.aadl2.ba.behaviorAnnex.impl.InternalConditionImpl#getInternalPorts <em>Internal Ports</em>}</li>
 * </ul>
 *
 * @generated
 */
public class InternalConditionImpl extends MinimalEObjectImpl.Container implements InternalCondition
{
  /**
   ...
   * @ordered
   */
  protected EList<Reference> internalPorts;
  ...
  {
    return BehaviorAnnexPackage.Literals.INTERNAL_CONDITION;
  }
   ...
   */
  @Override
  public EList<Reference> getInternalPorts()
  {
    if (internalPorts == null)
    {
      internalPorts = new EObjectContainmentEList<Reference>(Reference.class, this, BehaviorAnnexPackage.INTERNAL_CONDITION__INTERNAL_PORTS);
    }
  ...
  public void eSet(int featureID, Object newValue)
  {
    switch (featureID)
    {
      case BehaviorAnnexPackage.INTERNAL_CONDITION__INTERNAL_PORTS:
        ...
        getInternalPorts().addAll((Collection<? extends Reference>)newValue);
        return;
    }
