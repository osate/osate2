...
Resolved since the review: G03 ([#3167](https://github.com/osate/osate2/issues/3167), frozen-port parentheses), G10 ([#3174](https://github.com/osate/osate2/issues/3174), internal port actions), G11 ([#3175](https://github.com/osate/osate2/issues/3175), numeric literals), and V01 ([#3182](https://github.com/osate/osate2/issues/3182), declaration naming rules) are closed. G01 ([#3165](https://github.com/osate/osate2/issues/3165), internal conditions) and G08 ([#3172](https://github.com/osate/osate2/issues/3172), `self` property references) are addressed. Each row's assessment below still describes the state at the review date unless it says otherwise.
