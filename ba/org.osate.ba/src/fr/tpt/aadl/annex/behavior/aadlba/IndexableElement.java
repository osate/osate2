 ...
 * <ul>
 *   <li>{@link fr.tpt.aadl.annex.behavior.aadlba.IndexableElement#getArrayIndexes <em>Array Indexes</em>}</li>
 * </ul>
 * </p>
 *
 * @see fr.tpt.aadl.annex.behavior.aadlba.AadlBaPackage#getIndexableElement()
...
public interface IndexableElement extends BehaviorElement
{
   ...
   * @see fr.tpt.aadl.annex.behavior.aadlba.AadlBaPackage#getIndexableElement_ArrayIndexes()
  ...
  /**
   * Unsets the value of the '{@link fr.tpt.aadl.annex.behavior.aadlba.IndexableElement#getArrayIndexes <em>Array Indexes</em>}' containment reference list.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @see #isSetArrayIndexes()
   * @see #getArrayIndexes()
  ...
  /**
   * Returns whether the value of the '{@link fr.tpt.aadl.annex.behavior.aadlba.IndexableElement#getArrayIndexes <em>Array Indexes</em>}' containment reference list is set.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
