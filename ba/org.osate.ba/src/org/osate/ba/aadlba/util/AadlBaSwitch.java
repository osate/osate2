...
public class AadlBaSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		...
		case AadlBaPackage.BEHAVIOR_ARRAY_SIZE: {
			BehaviorArraySize behaviorArraySize = (BehaviorArraySize) theEObject;
			T result = caseBehaviorArraySize(behaviorArraySize);
			if (result == null) {
				result = caseArraySize(behaviorArraySize);
			}
			if (result == null) {
				result = caseBehaviorElement(behaviorArraySize);
			}
			if (result == null) {
				result = caseElement(behaviorArraySize);
			}
			if (result == null) {
				result = defaultCase(theEObject);
			}
		...
		case AadlBaPackage.INTERNAL_PORT_HOLDER: {
			InternalPortHolder internalPortHolder = (InternalPortHolder) theEObject;
			T result = caseInternalPortHolder(internalPortHolder);
			if (result == null) {
				result = caseClassifierFeatureHolder(internalPortHolder);
			}
			if (result == null) {
				result = caseTarget(internalPortHolder);
			}
			if (result == null) {
				result = caseElementHolder(internalPortHolder);
			}
			if (result == null) {
				result = caseParameterLabel(internalPortHolder);
			}
			if (result == null) {
				result = caseBehaviorElement(internalPortHolder);
			}
			if (result == null) {
				result = caseElement(internalPortHolder);
			}
			if (result == null) {
				result = defaultCase(theEObject);
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Behavior Array Size</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Behavior Array Size</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseBehaviorArraySize(BehaviorArraySize object) {
		return null;
	}
