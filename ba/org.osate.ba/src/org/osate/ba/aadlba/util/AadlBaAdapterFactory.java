...
public class AadlBaAdapterFactory extends AdapterFactoryImpl {
	...
	protected AadlBaSwitch<Adapter> modelSwitch = new AadlBaSwitch<>() {
		...
		@Override
		public Adapter caseTimeoutResetPort(TimeoutResetPort object) {
			return createTimeoutResetPortAdapter();
		}
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.osate.ba.aadlba.TimeoutResetPort <em>Timeout Reset Port</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
