...
public enum FeatureType implements Enumerator {
	 ...
	 * @ordered
	 */
	PROVIDES_SUBPROGRAM_ACCESS_PROTOTYPE(54, "PROVIDES_SUBPROGRAM_ACCESS_PROTOTYPE",
	 ...
	 * @ordered
	 */
	REQUIRES_SUBPROGRAM_ACCESS_PROTOTYPE(55, "REQUIRES_SUBPROGRAM_ACCESS_PROTOTYPE",
	 ...
	 * @ordered
	 */
	PROVIDES_SUBPROGRAM_GROUP_ACCESS_PROTOTYPE(56, "PROVIDES_SUBPROGRAM_GROUP_ACCESS_PROTOTYPE",
	 ...
	 * @ordered
	 */
	REQUIRES_SUBPROGRAM_GROUP_ACCESS_PROTOTYPE(57, "REQUIRES_SUBPROGRAM_GROUP_ACCESS_PROTOTYPE",
	...
	*/
	 ...
	 * @generated
	 */
	private static final FeatureType[] VALUES_ARRAY = new FeatureType[] { NONE, IN_DATA_PORT, OUT_DATA_PORT,
			IN_OUT_DATA_PORT, IN_EVENT_PORT, OUT_EVENT_PORT, IN_OUT_EVENT_PORT, IN_EVENT_DATA_PORT, OUT_EVENT_DATA_PORT,
			IN_OUT_EVENT_DATA_PORT, PROVIDES_SUBPROGRAM_ACCESS, REQUIRES_SUBPROGRAM_ACCESS,
			PROVIDES_SUBPROGRAM_GROUP_ACCESS, REQUIRES_SUBPROGRAM_GROUP_ACCESS, SUBPROGRAM_SUBCOMPONENT,
			SUBPROGRAM_CLASSIFIER, SUBPROGRAM_PROTOTYPE, COMPONENT_PROTOTYPE, COMPONENT_PROTOTYPE_BINDING,
			FEATURE_PROTOTYPE, FEATURE_PROTOTYPE_BINDING, FEATURE_GROUP_PROTOTYPE, FEATURE_GROUP_PROTOTYPE_BINDING,
			PROVIDES_DATA_ACCESS, REQUIRES_DATA_ACCESS, DATA_SUBCOMPONENT, DATA_CLASSIFIER, IN_PARAMETER, OUT_PARAMETER,
			IN_OUT_PARAMETER, PROPERTY_CONSTANT, PROPERTY_VALUE, PROVIDES_BUS_ACCESS, REQUIRES_BUS_ACCESS,
			FEATURE_GROUP, CLASSIFIER_VALUE, ABSTRACT_FEATURE, IN_FEATURE_PROTOTYPE, OUT_FEATURE_PROTOTYPE,
			IN_OUT_FEATURE_PROTOTYPE, THREAD_GROUP, SUBPROGRAM_GROUP, SUBPROGRAM_GROUP_PROTOTYPE, THREAD_PROTOTYPE,
			THREAD_GROUP_PROTOTYPE, IN_DATA_PORT_PROTOTYPE, OUT_DATA_PORT_PROTOTYPE, IN_OUT_DATA_PORT_PROTOTYPE,
			IN_EVENT_PORT_PROTOTYPE, OUT_EVENT_PORT_PROTOTYPE, IN_OUT_EVENT_PORT_PROTOTYPE,
			IN_EVENT_DATA_PORT_PROTOTYPE, OUT_EVENT_DATA_PORT_PROTOTYPE, IN_OUT_EVENT_DATA_PORT_PROTOTYPE,
			PROVIDES_SUBPROGRAM_ACCESS_PROTOTYPE, REQUIRES_SUBPROGRAM_ACCESS_PROTOTYPE,
			PROVIDES_SUBPROGRAM_GROUP_ACCESS_PROTOTYPE, REQUIRES_SUBPROGRAM_GROUP_ACCESS_PROTOTYPE,
			PROVIDES_DATA_ACCESS_PROTOTYPE, REQUIRES_DATA_ACCESS_PROTOTYPE, PROVIDES_BUS_ACCESS_PROTOTYPE,
			REQUIRES_BUS_ACCESS_PROTOTYPE, SYSTEM_SUBCOMPONENT, PROCESSOR_CLASSIFIER, PROCESS_CLASSIFIER, };
	...
	public static FeatureType get(int value) {
		...
		case NONE_VALUE:
			return NONE;
		case IN_DATA_PORT_VALUE:
			return IN_DATA_PORT;
		case OUT_DATA_PORT_VALUE:
			return OUT_DATA_PORT;
		case IN_OUT_DATA_PORT_VALUE:
			return IN_OUT_DATA_PORT;
		case IN_EVENT_PORT_VALUE:
			return IN_EVENT_PORT;
		case OUT_EVENT_PORT_VALUE:
			return OUT_EVENT_PORT;
		case IN_OUT_EVENT_PORT_VALUE:
			return IN_OUT_EVENT_PORT;
		case IN_EVENT_DATA_PORT_VALUE:
			return IN_EVENT_DATA_PORT;
		case OUT_EVENT_DATA_PORT_VALUE:
			return OUT_EVENT_DATA_PORT;
		case IN_OUT_EVENT_DATA_PORT_VALUE:
			return IN_OUT_EVENT_DATA_PORT;
		case PROVIDES_SUBPROGRAM_ACCESS_VALUE:
			return PROVIDES_SUBPROGRAM_ACCESS;
		case REQUIRES_SUBPROGRAM_ACCESS_VALUE:
			return REQUIRES_SUBPROGRAM_ACCESS;
		case PROVIDES_SUBPROGRAM_GROUP_ACCESS_VALUE:
			return PROVIDES_SUBPROGRAM_GROUP_ACCESS;
		case REQUIRES_SUBPROGRAM_GROUP_ACCESS_VALUE:
			return REQUIRES_SUBPROGRAM_GROUP_ACCESS;
		case SUBPROGRAM_SUBCOMPONENT_VALUE:
			return SUBPROGRAM_SUBCOMPONENT;
		case SUBPROGRAM_CLASSIFIER_VALUE:
			return SUBPROGRAM_CLASSIFIER;
		case SUBPROGRAM_PROTOTYPE_VALUE:
			return SUBPROGRAM_PROTOTYPE;
		case COMPONENT_PROTOTYPE_VALUE:
			return COMPONENT_PROTOTYPE;
		case COMPONENT_PROTOTYPE_BINDING_VALUE:
			return COMPONENT_PROTOTYPE_BINDING;
		case FEATURE_PROTOTYPE_VALUE:
			return FEATURE_PROTOTYPE;
		case FEATURE_PROTOTYPE_BINDING_VALUE:
			return FEATURE_PROTOTYPE_BINDING;
		case FEATURE_GROUP_PROTOTYPE_VALUE:
			return FEATURE_GROUP_PROTOTYPE;
		case FEATURE_GROUP_PROTOTYPE_BINDING_VALUE:
			return FEATURE_GROUP_PROTOTYPE_BINDING;
		case PROVIDES_DATA_ACCESS_VALUE:
			return PROVIDES_DATA_ACCESS;
		case REQUIRES_DATA_ACCESS_VALUE:
			return REQUIRES_DATA_ACCESS;
		case DATA_SUBCOMPONENT_VALUE:
			return DATA_SUBCOMPONENT;
		case DATA_CLASSIFIER_VALUE:
			return DATA_CLASSIFIER;
		case IN_PARAMETER_VALUE:
			return IN_PARAMETER;
		case OUT_PARAMETER_VALUE:
			return OUT_PARAMETER;
		case IN_OUT_PARAMETER_VALUE:
			return IN_OUT_PARAMETER;
		case PROPERTY_CONSTANT_VALUE:
			return PROPERTY_CONSTANT;
		case PROPERTY_VALUE_VALUE:
			return PROPERTY_VALUE;
		case PROVIDES_BUS_ACCESS_VALUE:
			return PROVIDES_BUS_ACCESS;
		case REQUIRES_BUS_ACCESS_VALUE:
			return REQUIRES_BUS_ACCESS;
		case FEATURE_GROUP_VALUE:
			return FEATURE_GROUP;
		case CLASSIFIER_VALUE_VALUE:
			return CLASSIFIER_VALUE;
		case ABSTRACT_FEATURE_VALUE:
			return ABSTRACT_FEATURE;
		case IN_FEATURE_PROTOTYPE_VALUE:
			return IN_FEATURE_PROTOTYPE;
		case OUT_FEATURE_PROTOTYPE_VALUE:
			return OUT_FEATURE_PROTOTYPE;
		case IN_OUT_FEATURE_PROTOTYPE_VALUE:
			return IN_OUT_FEATURE_PROTOTYPE;
		case THREAD_GROUP_VALUE:
			return THREAD_GROUP;
		case SUBPROGRAM_GROUP_VALUE:
			return SUBPROGRAM_GROUP;
		case SUBPROGRAM_GROUP_PROTOTYPE_VALUE:
			return SUBPROGRAM_GROUP_PROTOTYPE;
		case THREAD_PROTOTYPE_VALUE:
			return THREAD_PROTOTYPE;
		case THREAD_GROUP_PROTOTYPE_VALUE:
			return THREAD_GROUP_PROTOTYPE;
		case IN_DATA_PORT_PROTOTYPE_VALUE:
			return IN_DATA_PORT_PROTOTYPE;
		case OUT_DATA_PORT_PROTOTYPE_VALUE:
			return OUT_DATA_PORT_PROTOTYPE;
		case IN_OUT_DATA_PORT_PROTOTYPE_VALUE:
			return IN_OUT_DATA_PORT_PROTOTYPE;
		case IN_EVENT_PORT_PROTOTYPE_VALUE:
			return IN_EVENT_PORT_PROTOTYPE;
		case OUT_EVENT_PORT_PROTOTYPE_VALUE:
			return OUT_EVENT_PORT_PROTOTYPE;
		case IN_OUT_EVENT_PORT_PROTOTYPE_VALUE:
			return IN_OUT_EVENT_PORT_PROTOTYPE;
		case IN_EVENT_DATA_PORT_PROTOTYPE_VALUE:
			return IN_EVENT_DATA_PORT_PROTOTYPE;
		case OUT_EVENT_DATA_PORT_PROTOTYPE_VALUE:
			return OUT_EVENT_DATA_PORT_PROTOTYPE;
		case IN_OUT_EVENT_DATA_PORT_PROTOTYPE_VALUE:
			return IN_OUT_EVENT_DATA_PORT_PROTOTYPE;
		case PROVIDES_SUBPROGRAM_ACCESS_PROTOTYPE_VALUE:
			return PROVIDES_SUBPROGRAM_ACCESS_PROTOTYPE;
		case REQUIRES_SUBPROGRAM_ACCESS_PROTOTYPE_VALUE:
			return REQUIRES_SUBPROGRAM_ACCESS_PROTOTYPE;
		case PROVIDES_SUBPROGRAM_GROUP_ACCESS_PROTOTYPE_VALUE:
			return PROVIDES_SUBPROGRAM_GROUP_ACCESS_PROTOTYPE;
		case REQUIRES_SUBPROGRAM_GROUP_ACCESS_PROTOTYPE_VALUE:
			return REQUIRES_SUBPROGRAM_GROUP_ACCESS_PROTOTYPE;
		case PROVIDES_DATA_ACCESS_PROTOTYPE_VALUE:
			return PROVIDES_DATA_ACCESS_PROTOTYPE;
		case REQUIRES_DATA_ACCESS_PROTOTYPE_VALUE:
			return REQUIRES_DATA_ACCESS_PROTOTYPE;
		case PROVIDES_BUS_ACCESS_PROTOTYPE_VALUE:
			return PROVIDES_BUS_ACCESS_PROTOTYPE;
		case REQUIRES_BUS_ACCESS_PROTOTYPE_VALUE:
			return REQUIRES_BUS_ACCESS_PROTOTYPE;
		case SYSTEM_SUBCOMPONENT_VALUE:
			return SYSTEM_SUBCOMPONENT;
		case PROCESSOR_CLASSIFIER_VALUE:
			return PROCESSOR_CLASSIFIER;
		case PROCESS_CLASSIFIER_VALUE:
