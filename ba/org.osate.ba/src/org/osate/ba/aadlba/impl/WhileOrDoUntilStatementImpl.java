...
public class WhileOrDoUntilStatementImpl extends LoopStatementImpl implements WhileOrDoUntilStatement {
	...
	public NotificationChain basicSetLogicalValueExpression(ValueExpression newLogicalValueExpression,
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					AadlBaPackage.WHILE_OR_DO_UNTIL_STATEMENT__LOGICAL_VALUE_EXPRESSION, oldLogicalValueExpression,
		...
		if (newLogicalValueExpression != logicalValueExpression) {
			...
			if (logicalValueExpression != null)
				msgs = ((InternalEObject) logicalValueExpression).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - AadlBaPackage.WHILE_OR_DO_UNTIL_STATEMENT__LOGICAL_VALUE_EXPRESSION,
						null, msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					AadlBaPackage.WHILE_OR_DO_UNTIL_STATEMENT__LOGICAL_VALUE_EXPRESSION, newLogicalValueExpression,
					newLogicalValueExpression));
	}
	...
	public void setDoUntil(boolean newDoUntil) {
		...
		doUntil = newDoUntil;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AadlBaPackage.WHILE_OR_DO_UNTIL_STATEMENT__DO_UNTIL,
					oldDoUntil, doUntil));
	}
