...
public class BehaviorVariableImpl extends BehaviorNamedElementImpl implements BehaviorVariable {
			...
			if (dataClassifier != oldDataClassifier) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							AadlBaPackage.BEHAVIOR_VARIABLE__DATA_CLASSIFIER, oldDataClassifier, dataClassifier));
			}
		}
	...
	public void setDataClassifier(DataClassifier newDataClassifier) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AadlBaPackage.BEHAVIOR_VARIABLE__DATA_CLASSIFIER,
	...
	public EList<PropertyAssociation> getOwnedPropertyAssociations() {
		if (ownedPropertyAssociations == null) {
			ownedPropertyAssociations = new EObjectContainmentEList<PropertyAssociation>(PropertyAssociation.class,
					this, AadlBaPackage.BEHAVIOR_VARIABLE__OWNED_PROPERTY_ASSOCIATIONS);
		}
	...
	public NotificationChain basicSetOwnedValueConstant(ValueConstant newOwnedValueConstant, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					AadlBaPackage.BEHAVIOR_VARIABLE__OWNED_VALUE_CONSTANT, oldOwnedValueConstant,
					newOwnedValueConstant);
			if (msgs == null)
				msgs = notification;
			else
	...
	public void setOwnedValueConstant(ValueConstant newOwnedValueConstant) {
		if (newOwnedValueConstant != ownedValueConstant) {
			...
			if (ownedValueConstant != null)
				msgs = ((InternalEObject) ownedValueConstant).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - AadlBaPackage.BEHAVIOR_VARIABLE__OWNED_VALUE_CONSTANT, null, msgs);
			if (newOwnedValueConstant != null)
				msgs = ((InternalEObject) newOwnedValueConstant).eInverseAdd(this,
						EOPPOSITE_FEATURE_BASE - AadlBaPackage.BEHAVIOR_VARIABLE__OWNED_VALUE_CONSTANT, null, msgs);
			msgs = basicSetOwnedValueConstant(newOwnedValueConstant, msgs);
			if (msgs != null)
				msgs.dispatch();
		} else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AadlBaPackage.BEHAVIOR_VARIABLE__OWNED_VALUE_CONSTANT,
					newOwnedValueConstant, newOwnedValueConstant));
	}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == ArrayableElement.class) {
			...
			case Aadl2Package.ARRAYABLE_ELEMENT__ARRAY_DIMENSION:
				return AadlBaPackage.BEHAVIOR_VARIABLE__ARRAY_DIMENSION;
			default:
				return -1;
			}
		}
