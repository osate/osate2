...
public abstract class SharedDataActionImpl extends BehaviorElementImpl implements SharedDataAction {
	...
	public NotificationChain basicSetDataAccess(DataAccessHolder newDataAccess, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					AadlBaPackage.SHARED_DATA_ACTION__DATA_ACCESS, oldDataAccess, newDataAccess);
			if (msgs == null)
				msgs = notification;
			else
	...
	public void setDataAccess(DataAccessHolder newDataAccess) {
		if (newDataAccess != dataAccess) {
			...
			if (dataAccess != null)
				msgs = ((InternalEObject) dataAccess).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - AadlBaPackage.SHARED_DATA_ACTION__DATA_ACCESS, null, msgs);
			if (newDataAccess != null)
				msgs = ((InternalEObject) newDataAccess).eInverseAdd(this,
						EOPPOSITE_FEATURE_BASE - AadlBaPackage.SHARED_DATA_ACTION__DATA_ACCESS, null, msgs);
			msgs = basicSetDataAccess(newDataAccess, msgs);
			if (msgs != null)
				msgs.dispatch();
		} else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AadlBaPackage.SHARED_DATA_ACTION__DATA_ACCESS,
