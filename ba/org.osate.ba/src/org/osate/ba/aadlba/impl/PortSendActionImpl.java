...
public class PortSendActionImpl extends BehaviorElementImpl implements PortSendAction {
	...
	public NotificationChain basicSetPort(ActualPortHolder newPort, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					AadlBaPackage.PORT_SEND_ACTION__PORT, oldPort, newPort);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newPort != port) {
			...
			if (port != null)
				msgs = ((InternalEObject) port).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - AadlBaPackage.PORT_SEND_ACTION__PORT, null, msgs);
			if (newPort != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET, AadlBaPackage.PORT_SEND_ACTION__PORT, newPort,
					newPort));
	}
	...
	public NotificationChain basicSetValueExpression(ValueExpression newValueExpression, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					AadlBaPackage.PORT_SEND_ACTION__VALUE_EXPRESSION, oldValueExpression, newValueExpression);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
		...
		if (newValueExpression != valueExpression) {
			...
			if (valueExpression != null)
				msgs = ((InternalEObject) valueExpression).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - AadlBaPackage.PORT_SEND_ACTION__VALUE_EXPRESSION, null, msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET, AadlBaPackage.PORT_SEND_ACTION__VALUE_EXPRESSION,
