...
public class FactorImpl extends BehaviorElementImpl implements Factor {
	...
	public NotificationChain basicSetFirstValue(Value newFirstValue, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					AadlBaPackage.FACTOR__FIRST_VALUE, oldFirstValue, newFirstValue);
			if (msgs == null)
				msgs = notification;
			else
	...
	public void setFirstValue(Value newFirstValue) {
		if (newFirstValue != firstValue) {
			...
			if (firstValue != null)
				msgs = ((InternalEObject) firstValue).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - AadlBaPackage.FACTOR__FIRST_VALUE, null, msgs);
			if (newFirstValue != null)
				msgs = ((InternalEObject) newFirstValue).eInverseAdd(this,
						EOPPOSITE_FEATURE_BASE - AadlBaPackage.FACTOR__FIRST_VALUE, null, msgs);
			msgs = basicSetFirstValue(newFirstValue, msgs);
			if (msgs != null)
				msgs.dispatch();
		} else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AadlBaPackage.FACTOR__FIRST_VALUE, newFirstValue,
					newFirstValue));
	}
	...
	public NotificationChain basicSetSecondValue(Value newSecondValue, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					AadlBaPackage.FACTOR__SECOND_VALUE, oldSecondValue, newSecondValue);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
	...
	public void setSecondValue(Value newSecondValue) {
		if (newSecondValue != secondValue) {
			NotificationChain msgs = null;
			if (secondValue != null)
				msgs = ((InternalEObject) secondValue).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - AadlBaPackage.FACTOR__SECOND_VALUE, null, msgs);
			if (newSecondValue != null)
				msgs = ((InternalEObject) newSecondValue).eInverseAdd(this,
						EOPPOSITE_FEATURE_BASE - AadlBaPackage.FACTOR__SECOND_VALUE, null, msgs);
			msgs = basicSetSecondValue(newSecondValue, msgs);
			if (msgs != null)
				msgs.dispatch();
		} else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AadlBaPackage.FACTOR__SECOND_VALUE, newSecondValue,
					newSecondValue));
	}
	...
	public void setBinaryNumericOperator(BinaryNumericOperator newBinaryNumericOperator) {
		...
		binaryNumericOperator = newBinaryNumericOperator == null ? BINARY_NUMERIC_OPERATOR_EDEFAULT
				: newBinaryNumericOperator;
		boolean oldBinaryNumericOperatorESet = binaryNumericOperatorESet;
		binaryNumericOperatorESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AadlBaPackage.FACTOR__BINARY_NUMERIC_OPERATOR,
					oldBinaryNumericOperator, binaryNumericOperator, !oldBinaryNumericOperatorESet));
	}
	...
	public void unsetBinaryNumericOperator() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, AadlBaPackage.FACTOR__BINARY_NUMERIC_OPERATOR,
					oldBinaryNumericOperator, BINARY_NUMERIC_OPERATOR_EDEFAULT, oldBinaryNumericOperatorESet));
	}
	...
	public void setUnaryNumericOperator(UnaryNumericOperator newUnaryNumericOperator) {
		...
		unaryNumericOperator = newUnaryNumericOperator == null ? UNARY_NUMERIC_OPERATOR_EDEFAULT
				: newUnaryNumericOperator;
		boolean oldUnaryNumericOperatorESet = unaryNumericOperatorESet;
		unaryNumericOperatorESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AadlBaPackage.FACTOR__UNARY_NUMERIC_OPERATOR,
					oldUnaryNumericOperator, unaryNumericOperator, !oldUnaryNumericOperatorESet));
	}
	...
	public void unsetUnaryNumericOperator() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, AadlBaPackage.FACTOR__UNARY_NUMERIC_OPERATOR,
					oldUnaryNumericOperator, UNARY_NUMERIC_OPERATOR_EDEFAULT, oldUnaryNumericOperatorESet));
	}
	...
	public void setUnaryBooleanOperator(UnaryBooleanOperator newUnaryBooleanOperator) {
		...
		unaryBooleanOperator = newUnaryBooleanOperator == null ? UNARY_BOOLEAN_OPERATOR_EDEFAULT
				: newUnaryBooleanOperator;
		boolean oldUnaryBooleanOperatorESet = unaryBooleanOperatorESet;
		unaryBooleanOperatorESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AadlBaPackage.FACTOR__UNARY_BOOLEAN_OPERATOR,
					oldUnaryBooleanOperator, unaryBooleanOperator, !oldUnaryBooleanOperatorESet));
	}
	...
	public void unsetUnaryBooleanOperator() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, AadlBaPackage.FACTOR__UNARY_BOOLEAN_OPERATOR,
					oldUnaryBooleanOperator, UNARY_BOOLEAN_OPERATOR_EDEFAULT, oldUnaryBooleanOperatorESet));
	}
	...
	public String toString() {
		...
		if (binaryNumericOperatorESet)
			result.append(binaryNumericOperator);
		else
			result.append("<unset>");
		result.append(", unaryNumericOperator: ");
		if (unaryNumericOperatorESet)
			result.append(unaryNumericOperator);
		else
			result.append("<unset>");
		result.append(", unaryBooleanOperator: ");
		if (unaryBooleanOperatorESet)
			result.append(unaryBooleanOperator);
		else
			result.append("<unset>");
		result.append(')');
