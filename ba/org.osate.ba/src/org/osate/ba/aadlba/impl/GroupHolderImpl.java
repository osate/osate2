...
public class GroupHolderImpl extends BehaviorElementImpl implements GroupHolder {
		...
		if (element != null && ((EObject) element).eIsProxy()) {
			...
			if (element != oldElement) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, AadlBaPackage.GROUP_HOLDER__ELEMENT,
							oldElement, element));
			}
		}
		return element;
	...
	public void setElement(NamedElement newElement) {
		...
		element = newElement;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AadlBaPackage.GROUP_HOLDER__ELEMENT, oldElement,
					element));
	}
	...
	public EList<IntegerValue> getArrayIndexes() {
		if (arrayIndexes == null) {
			arrayIndexes = new EObjectContainmentEList.Unsettable<IntegerValue>(IntegerValue.class, this,
					AadlBaPackage.GROUP_HOLDER__ARRAY_INDEXES);
		}
		return arrayIndexes;
	}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == IndexableElement.class) {
			...
			case AadlBaPackage.INDEXABLE_ELEMENT__ARRAY_INDEXES:
				return AadlBaPackage.GROUP_HOLDER__ARRAY_INDEXES;
			default:
				return -1;
			}
		}
