...
public class BehaviorPropertyConstantImpl extends BehaviorElementImpl implements BehaviorPropertyConstant {
			...
			if (property != oldProperty) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							AadlBaPackage.BEHAVIOR_PROPERTY_CONSTANT__PROPERTY, oldProperty, property));
			}
		}
		return property;
	}
	...
	public void setProperty(PropertyConstant newProperty) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AadlBaPackage.BEHAVIOR_PROPERTY_CONSTANT__PROPERTY,
	...
	public PropertySet getPropertySet() {
		if (propertySet != null && ((EObject) propertySet).eIsProxy()) {
			...
			if (propertySet != oldPropertySet) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							AadlBaPackage.BEHAVIOR_PROPERTY_CONSTANT__PROPERTY_SET, oldPropertySet, propertySet));
			}
		}
		return propertySet;
	}
