	...
	public NotificationChain basicSetBehaviorActions(BehaviorActions newBehaviorActions, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					AadlBaPackage.LOOP_STATEMENT__BEHAVIOR_ACTIONS, oldBehaviorActions, newBehaviorActions);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newBehaviorActions != behaviorActions) {
			...
			if (behaviorActions != null)
				msgs = ((InternalEObject) behaviorActions).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - AadlBaPackage.LOOP_STATEMENT__BEHAVIOR_ACTIONS, null, msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET, AadlBaPackage.LOOP_STATEMENT__BEHAVIOR_ACTIONS,
