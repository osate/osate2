...
public class DispatchConditionImpl extends BehaviorElementImpl implements DispatchCondition {
	 ...
	 * @generated
	 */
	public NotificationChain basicSetDispatchTriggerCondition(DispatchTriggerCondition newDispatchTriggerCondition,
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					AadlBaPackage.DISPATCH_CONDITION__DISPATCH_TRIGGER_CONDITION, oldDispatchTriggerCondition,
					newDispatchTriggerCondition);
			if (msgs == null)
				msgs = notification;
			else
	...
	public void setDispatchTriggerCondition(DispatchTriggerCondition newDispatchTriggerCondition) {
		if (newDispatchTriggerCondition != dispatchTriggerCondition) {
			...
			if (dispatchTriggerCondition != null)
				msgs = ((InternalEObject) dispatchTriggerCondition).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - AadlBaPackage.DISPATCH_CONDITION__DISPATCH_TRIGGER_CONDITION, null,
						msgs);
			if (newDispatchTriggerCondition != null)
				msgs = ((InternalEObject) newDispatchTriggerCondition).eInverseAdd(this,
						EOPPOSITE_FEATURE_BASE - AadlBaPackage.DISPATCH_CONDITION__DISPATCH_TRIGGER_CONDITION, null,
						msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					AadlBaPackage.DISPATCH_CONDITION__DISPATCH_TRIGGER_CONDITION, newDispatchTriggerCondition,
					newDispatchTriggerCondition));
	}
	...
	public EList<ActualPortHolder> getFrozenPorts() {
		if (frozenPorts == null) {
			frozenPorts = new EObjectContainmentEList.Unsettable<ActualPortHolder>(ActualPortHolder.class, this,
					AadlBaPackage.DISPATCH_CONDITION__FROZEN_PORTS);
		}
		return frozenPorts;
	}
	...
	public void unsetFrozenPorts() {
		if (frozenPorts != null)
			((InternalEList.Unsettable<?>) frozenPorts).unset();
	}
