...
public class BehaviorAnnexImpl extends AnnexSubclauseImpl implements BehaviorAnnex {
			...
			if (initialState != oldInitialState) {
				if (eNotificationRequired()) {
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							AadlBaPackage.BEHAVIOR_ANNEX__INITIAL_STATE, oldInitialState, initialState));
				}
			}
		}
		return initialState;
	...
	public void setInitialState(BehaviorState newInitialState) {
		...
		if (eNotificationRequired()) {
			eNotify(new ENotificationImpl(this, Notification.SET, AadlBaPackage.BEHAVIOR_ANNEX__INITIAL_STATE,
	...
	private Map<BehaviorAnnex, AadlBaHighlighter> _annexHighlighters = new WeakHashMap<BehaviorAnnex, AadlBaHighlighter>();
