...
public class IntegerRangeImpl extends BehaviorElementImpl implements IntegerRange {
	...
	public NotificationChain basicSetLowerIntegerValue(IntegerValue newLowerIntegerValue, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					AadlBaPackage.INTEGER_RANGE__LOWER_INTEGER_VALUE, oldLowerIntegerValue, newLowerIntegerValue);
			if (msgs == null)
				msgs = notification;
			else
	...
	public void setLowerIntegerValue(IntegerValue newLowerIntegerValue) {
		if (newLowerIntegerValue != lowerIntegerValue) {
			...
			if (lowerIntegerValue != null)
				msgs = ((InternalEObject) lowerIntegerValue).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - AadlBaPackage.INTEGER_RANGE__LOWER_INTEGER_VALUE, null, msgs);
			if (newLowerIntegerValue != null)
				msgs = ((InternalEObject) newLowerIntegerValue).eInverseAdd(this,
						EOPPOSITE_FEATURE_BASE - AadlBaPackage.INTEGER_RANGE__LOWER_INTEGER_VALUE, null, msgs);
			msgs = basicSetLowerIntegerValue(newLowerIntegerValue, msgs);
			if (msgs != null)
				msgs.dispatch();
		} else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AadlBaPackage.INTEGER_RANGE__LOWER_INTEGER_VALUE,
					newLowerIntegerValue, newLowerIntegerValue));
	}
	...
	public NotificationChain basicSetUpperIntegerValue(IntegerValue newUpperIntegerValue, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					AadlBaPackage.INTEGER_RANGE__UPPER_INTEGER_VALUE, oldUpperIntegerValue, newUpperIntegerValue);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
	...
	public void setUpperIntegerValue(IntegerValue newUpperIntegerValue) {
		if (newUpperIntegerValue != upperIntegerValue) {
			...
			if (upperIntegerValue != null)
				msgs = ((InternalEObject) upperIntegerValue).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - AadlBaPackage.INTEGER_RANGE__UPPER_INTEGER_VALUE, null, msgs);
			if (newUpperIntegerValue != null)
				msgs = ((InternalEObject) newUpperIntegerValue).eInverseAdd(this,
						EOPPOSITE_FEATURE_BASE - AadlBaPackage.INTEGER_RANGE__UPPER_INTEGER_VALUE, null, msgs);
			msgs = basicSetUpperIntegerValue(newUpperIntegerValue, msgs);
			if (msgs != null)
				msgs.dispatch();
		} else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AadlBaPackage.INTEGER_RANGE__UPPER_INTEGER_VALUE,
					newUpperIntegerValue, newUpperIntegerValue));
	}
