...
public class RelationImpl extends BehaviorElementImpl implements Relation {
	...
	public NotificationChain basicSetFirstExpression(SimpleExpression newFirstExpression, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					AadlBaPackage.RELATION__FIRST_EXPRESSION, oldFirstExpression, newFirstExpression);
			if (msgs == null)
				msgs = notification;
			else
	...
	public void setFirstExpression(SimpleExpression newFirstExpression) {
		if (newFirstExpression != firstExpression) {
			...
			if (firstExpression != null)
				msgs = ((InternalEObject) firstExpression).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - AadlBaPackage.RELATION__FIRST_EXPRESSION, null, msgs);
			if (newFirstExpression != null)
				msgs = ((InternalEObject) newFirstExpression).eInverseAdd(this,
						EOPPOSITE_FEATURE_BASE - AadlBaPackage.RELATION__FIRST_EXPRESSION, null, msgs);
			msgs = basicSetFirstExpression(newFirstExpression, msgs);
			if (msgs != null)
				msgs.dispatch();
		} else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AadlBaPackage.RELATION__FIRST_EXPRESSION,
					newFirstExpression, newFirstExpression));
	}
	...
	public NotificationChain basicSetSecondExpression(SimpleExpression newSecondExpression, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					AadlBaPackage.RELATION__SECOND_EXPRESSION, oldSecondExpression, newSecondExpression);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
	...
	public void setSecondExpression(SimpleExpression newSecondExpression) {
		if (newSecondExpression != secondExpression) {
			...
			if (secondExpression != null)
				msgs = ((InternalEObject) secondExpression).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - AadlBaPackage.RELATION__SECOND_EXPRESSION, null, msgs);
			if (newSecondExpression != null)
				msgs = ((InternalEObject) newSecondExpression).eInverseAdd(this,
						EOPPOSITE_FEATURE_BASE - AadlBaPackage.RELATION__SECOND_EXPRESSION, null, msgs);
			msgs = basicSetSecondExpression(newSecondExpression, msgs);
			if (msgs != null)
				msgs.dispatch();
		} else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AadlBaPackage.RELATION__SECOND_EXPRESSION,
					newSecondExpression, newSecondExpression));
	}
	...
	public void setRelationalOperator(RelationalOperator newRelationalOperator) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AadlBaPackage.RELATION__RELATIONAL_OPERATOR,
					oldRelationalOperator, relationalOperator, !oldRelationalOperatorESet));
	}
	...
	public void unsetRelationalOperator() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, AadlBaPackage.RELATION__RELATIONAL_OPERATOR,
					oldRelationalOperator, RELATIONAL_OPERATOR_EDEFAULT, oldRelationalOperatorESet));
	}
