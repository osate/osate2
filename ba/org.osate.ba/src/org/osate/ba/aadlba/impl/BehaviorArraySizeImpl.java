...
import org.osate.aadl2.impl.ArraySizeImpl;
...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Behavior Array Size</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link org.osate.ba.aadlba.impl.BehaviorArraySizeImpl#getIntegerValue <em>Integer Value</em>}</li>
 * </ul>
 *
 * @generated
 */
public class BehaviorArraySizeImpl extends ArraySizeImpl implements BehaviorArraySize {
	/**
	 ...
	 * @generated
	 */
	protected BehaviorArraySizeImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return AadlBaPackage.Literals.BEHAVIOR_ARRAY_SIZE;
	}
	...
	public NotificationChain basicSetIntegerValue(IntegerValue newIntegerValue, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					AadlBaPackage.BEHAVIOR_ARRAY_SIZE__INTEGER_VALUE, oldIntegerValue, newIntegerValue);
			if (msgs == null) {
				msgs = notification;
			} else {
		...
		if (newIntegerValue != integerValue) {
			...
			if (integerValue != null) {
				msgs = ((InternalEObject) integerValue).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - AadlBaPackage.BEHAVIOR_ARRAY_SIZE__INTEGER_VALUE, null, msgs);
			}
			...
			eNotify(new ENotificationImpl(this, Notification.SET, AadlBaPackage.BEHAVIOR_ARRAY_SIZE__INTEGER_VALUE,
