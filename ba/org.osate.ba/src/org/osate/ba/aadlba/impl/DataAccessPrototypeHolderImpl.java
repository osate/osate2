...
public class DataAccessPrototypeHolderImpl extends DataHolderImpl implements DataAccessPrototypeHolder {
			...
			if (prototypeBinding != oldPrototypeBinding) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							AadlBaPackage.DATA_ACCESS_PROTOTYPE_HOLDER__PROTOTYPE_BINDING, oldPrototypeBinding,
							prototypeBinding));
			}
		}
	...
	public EList<IntegerValue> getArrayIndexes() {
		if (arrayIndexes == null) {
			arrayIndexes = new EObjectContainmentEList.Unsettable<IntegerValue>(IntegerValue.class, this,
					AadlBaPackage.DATA_ACCESS_PROTOTYPE_HOLDER__ARRAY_INDEXES);
		}
		return arrayIndexes;
	}
	...
	public EList<GroupHolder> getGroupHolders() {
		if (groupHolders == null) {
			groupHolders = new EObjectContainmentEList.Unsettable<GroupHolder>(GroupHolder.class, this,
					AadlBaPackage.DATA_ACCESS_PROTOTYPE_HOLDER__GROUP_HOLDERS);
		}
		return groupHolders;
	}
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		...
		if (baseClass == PrototypeHolder.class) {
			switch (derivedFeatureID) {
			case AadlBaPackage.DATA_ACCESS_PROTOTYPE_HOLDER__PROTOTYPE_BINDING:
				return AadlBaPackage.PROTOTYPE_HOLDER__PROTOTYPE_BINDING;
			default:
				return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == IndexableElement.class) {
			...
			case AadlBaPackage.INDEXABLE_ELEMENT__ARRAY_INDEXES:
				return AadlBaPackage.DATA_ACCESS_PROTOTYPE_HOLDER__ARRAY_INDEXES;
			default:
				return -1;
			}
		}
		if (baseClass == GroupableElement.class) {
			...
			case AadlBaPackage.GROUPABLE_ELEMENT__GROUP_HOLDERS:
				return AadlBaPackage.DATA_ACCESS_PROTOTYPE_HOLDER__GROUP_HOLDERS;
			default:
				return -1;
			}
		}
		...
		if (baseClass == PrototypeHolder.class) {
			switch (baseFeatureID) {
			case AadlBaPackage.PROTOTYPE_HOLDER__PROTOTYPE_BINDING:
				return AadlBaPackage.DATA_ACCESS_PROTOTYPE_HOLDER__PROTOTYPE_BINDING;
			default:
				return -1;
			}
		}
