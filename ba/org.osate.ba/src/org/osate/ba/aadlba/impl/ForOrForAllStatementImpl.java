...
public class ForOrForAllStatementImpl extends LoopStatementImpl implements ForOrForAllStatement {
	...
	public NotificationChain basicSetIteratedValues(ElementValues newIteratedValues, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					AadlBaPackage.FOR_OR_FOR_ALL_STATEMENT__ITERATED_VALUES, oldIteratedValues, newIteratedValues);
			if (msgs == null)
				msgs = notification;
			else
	...
	public void setIteratedValues(ElementValues newIteratedValues) {
		if (newIteratedValues != iteratedValues) {
			...
			if (iteratedValues != null)
				msgs = ((InternalEObject) iteratedValues).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - AadlBaPackage.FOR_OR_FOR_ALL_STATEMENT__ITERATED_VALUES, null, msgs);
			if (newIteratedValues != null)
				msgs = ((InternalEObject) newIteratedValues).eInverseAdd(this,
						EOPPOSITE_FEATURE_BASE - AadlBaPackage.FOR_OR_FOR_ALL_STATEMENT__ITERATED_VALUES, null, msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					AadlBaPackage.FOR_OR_FOR_ALL_STATEMENT__ITERATED_VALUES, newIteratedValues, newIteratedValues));
	}
	...
	public void setForAll(boolean newForAll) {
		...
		forAll = newForAll;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AadlBaPackage.FOR_OR_FOR_ALL_STATEMENT__FOR_ALL,
					oldForAll, forAll));
	}
	...
	public NotificationChain basicSetIterativeVariable(IterativeVariable newIterativeVariable, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					AadlBaPackage.FOR_OR_FOR_ALL_STATEMENT__ITERATIVE_VARIABLE, oldIterativeVariable,
					newIterativeVariable);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
	...
	public void setIterativeVariable(IterativeVariable newIterativeVariable) {
		if (newIterativeVariable != iterativeVariable) {
			...
			if (iterativeVariable != null)
				msgs = ((InternalEObject) iterativeVariable).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - AadlBaPackage.FOR_OR_FOR_ALL_STATEMENT__ITERATIVE_VARIABLE, null,
						msgs);
			if (newIterativeVariable != null)
				msgs = ((InternalEObject) newIterativeVariable).eInverseAdd(this,
						EOPPOSITE_FEATURE_BASE - AadlBaPackage.FOR_OR_FOR_ALL_STATEMENT__ITERATIVE_VARIABLE, null,
						msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					AadlBaPackage.FOR_OR_FOR_ALL_STATEMENT__ITERATIVE_VARIABLE, newIterativeVariable,
					newIterativeVariable));
	}
