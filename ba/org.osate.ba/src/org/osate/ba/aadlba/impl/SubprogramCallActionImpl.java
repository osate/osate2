...
public class SubprogramCallActionImpl extends BehaviorElementImpl implements SubprogramCallAction {
	...
	public NotificationChain basicSetSubprogram(CalledSubprogramHolder newSubprogram, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					AadlBaPackage.SUBPROGRAM_CALL_ACTION__SUBPROGRAM, oldSubprogram, newSubprogram);
			if (msgs == null)
				msgs = notification;
			else
	...
	public void setSubprogram(CalledSubprogramHolder newSubprogram) {
		if (newSubprogram != subprogram) {
			...
			if (subprogram != null)
				msgs = ((InternalEObject) subprogram).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - AadlBaPackage.SUBPROGRAM_CALL_ACTION__SUBPROGRAM, null, msgs);
			if (newSubprogram != null)
				msgs = ((InternalEObject) newSubprogram).eInverseAdd(this,
						EOPPOSITE_FEATURE_BASE - AadlBaPackage.SUBPROGRAM_CALL_ACTION__SUBPROGRAM, null, msgs);
			msgs = basicSetSubprogram(newSubprogram, msgs);
			if (msgs != null)
				msgs.dispatch();
		} else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AadlBaPackage.SUBPROGRAM_CALL_ACTION__SUBPROGRAM,
					newSubprogram, newSubprogram));
	}
	...
	public EList<ParameterLabel> getParameterLabels() {
		if (parameterLabels == null) {
			parameterLabels = new EObjectContainmentEList.Unsettable<ParameterLabel>(ParameterLabel.class, this,
					AadlBaPackage.SUBPROGRAM_CALL_ACTION__PARAMETER_LABELS);
		}
	...
	public void unsetParameterLabels() {
		if (parameterLabels != null)
			((InternalEList.Unsettable<?>) parameterLabels).unset();
	}
	...
	public NotificationChain basicSetProxy(SubprogramHolderProxy newProxy, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					AadlBaPackage.SUBPROGRAM_CALL_ACTION__PROXY, oldProxy, newProxy);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
	...
	public void setProxy(SubprogramHolderProxy newProxy) {
		if (newProxy != proxy) {
			NotificationChain msgs = null;
			if (proxy != null)
				msgs = ((InternalEObject) proxy).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - AadlBaPackage.SUBPROGRAM_CALL_ACTION__PROXY, null, msgs);
			if (newProxy != null)
				msgs = ((InternalEObject) newProxy).eInverseAdd(this,
						EOPPOSITE_FEATURE_BASE - AadlBaPackage.SUBPROGRAM_CALL_ACTION__PROXY, null, msgs);
			msgs = basicSetProxy(newProxy, msgs);
			if (msgs != null)
				msgs.dispatch();
		} else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AadlBaPackage.SUBPROGRAM_CALL_ACTION__PROXY, newProxy,
					newProxy));
	}
