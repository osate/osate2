...
public class AssignmentActionImpl extends BehaviorElementImpl implements AssignmentAction {
	...
	public NotificationChain basicSetTarget(Target newTarget, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					AadlBaPackage.ASSIGNMENT_ACTION__TARGET, oldTarget, newTarget);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newTarget != target) {
			...
			if (target != null)
				msgs = ((InternalEObject) target).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - AadlBaPackage.ASSIGNMENT_ACTION__TARGET, null, msgs);
			if (newTarget != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET, AadlBaPackage.ASSIGNMENT_ACTION__TARGET, newTarget,
					newTarget));
	}
	...
	public NotificationChain basicSetValueExpression(ValueExpression newValueExpression, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					AadlBaPackage.ASSIGNMENT_ACTION__VALUE_EXPRESSION, oldValueExpression, newValueExpression);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
		...
		if (newValueExpression != valueExpression) {
			...
			if (valueExpression != null)
				msgs = ((InternalEObject) valueExpression).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - AadlBaPackage.ASSIGNMENT_ACTION__VALUE_EXPRESSION, null, msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET, AadlBaPackage.ASSIGNMENT_ACTION__VALUE_EXPRESSION,
