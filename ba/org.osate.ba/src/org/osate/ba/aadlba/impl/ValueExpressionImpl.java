...
public class ValueExpressionImpl extends BehaviorElementImpl implements ValueExpression {
	...
	public EList<Relation> getRelations() {
		if (relations == null) {
			relations = new EObjectContainmentEList<Relation>(Relation.class, this,
					AadlBaPackage.VALUE_EXPRESSION__RELATIONS);
		}
		return relations;
	}
	...
	public EList<LogicalOperator> getLogicalOperators() {
		if (logicalOperators == null) {
			logicalOperators = new EDataTypeEList.Unsettable<LogicalOperator>(LogicalOperator.class, this,
					AadlBaPackage.VALUE_EXPRESSION__LOGICAL_OPERATORS);
		}
