 ...
 * @generated
 */
public class ClassifierFeaturePropertyReferenceImpl extends PropertyReferenceImpl
		implements ClassifierFeaturePropertyReference {
	/**
	...
	public NotificationChain basicSetComponent(ClassifierFeatureHolder newComponent, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					AadlBaPackage.CLASSIFIER_FEATURE_PROPERTY_REFERENCE__COMPONENT, oldComponent, newComponent);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newComponent != component) {
			...
			if (component != null)
				msgs = ((InternalEObject) component).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - AadlBaPackage.CLASSIFIER_FEATURE_PROPERTY_REFERENCE__COMPONENT, null,
						msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					AadlBaPackage.CLASSIFIER_FEATURE_PROPERTY_REFERENCE__COMPONENT, newComponent, newComponent));
	}
