...
public class StructUnionElementHolderImpl extends DataHolderImpl implements StructUnionElementHolder {
	...
	public EList<IntegerValue> getArrayIndexes() {
		if (arrayIndexes == null) {
			arrayIndexes = new EObjectContainmentEList.Unsettable<IntegerValue>(IntegerValue.class, this,
					AadlBaPackage.STRUCT_UNION_ELEMENT_HOLDER__ARRAY_INDEXES);
		}
		return arrayIndexes;
	}
	...
	public void setStructUnionElement(StructUnionElement newStructUnionElement) {
		if (newStructUnionElement != structUnionElement) {
			...
			if (structUnionElement != null)
				msgs = ((InternalEObject) structUnionElement).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - AadlBaPackage.STRUCT_UNION_ELEMENT_HOLDER__STRUCT_UNION_ELEMENT, null,
						msgs);
			if (newStructUnionElement != null)
				msgs = ((InternalEObject) newStructUnionElement).eInverseAdd(this,
						EOPPOSITE_FEATURE_BASE - AadlBaPackage.STRUCT_UNION_ELEMENT_HOLDER__STRUCT_UNION_ELEMENT, null,
						msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					AadlBaPackage.STRUCT_UNION_ELEMENT_HOLDER__STRUCT_UNION_ELEMENT, newStructUnionElement,
					newStructUnionElement));
	}
	 ...
	 * @generated NOT
	 */
	public NotificationChain basicSetStructUnionElement(StructUnionElement newStructUnionElement,
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					AadlBaPackage.STRUCT_UNION_ELEMENT_HOLDER__STRUCT_UNION_ELEMENT, oldStructUnionElement,
					newStructUnionElement);
			if (msgs == null)
				msgs = notification;
			else
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == IndexableElement.class) {
			...
			case AadlBaPackage.INDEXABLE_ELEMENT__ARRAY_INDEXES:
				return AadlBaPackage.STRUCT_UNION_ELEMENT_HOLDER__ARRAY_INDEXES;
			default:
				return -1;
			}
		}
