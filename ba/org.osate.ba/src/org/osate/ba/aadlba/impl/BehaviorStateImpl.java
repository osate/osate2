...
public class BehaviorStateImpl extends BehaviorNamedElementImpl implements BehaviorState {
	...
	public void setInitial(boolean newInitial) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AadlBaPackage.BEHAVIOR_STATE__INITIAL, oldInitial,
					initial));
	}
	...
	public void setComplete(boolean newComplete) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AadlBaPackage.BEHAVIOR_STATE__COMPLETE, oldComplete,
					complete));
	}
	...
	public void setFinal(boolean newFinal) {
		...
		final_ = newFinal;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AadlBaPackage.BEHAVIOR_STATE__FINAL, oldFinal,
					final_));
	}
	...
	public Mode getBindedMode() {
		if (bindedMode != null && ((EObject) bindedMode).eIsProxy()) {
			...
			if (bindedMode != oldBindedMode) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, AadlBaPackage.BEHAVIOR_STATE__BINDED_MODE,
							oldBindedMode, bindedMode));
			}
		}
		return bindedMode;
	}
	...
	public void setBindedMode(Mode newBindedMode) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AadlBaPackage.BEHAVIOR_STATE__BINDED_MODE,
					oldBindedMode, bindedMode));
	}
	...
	public EList<BehaviorTransition> getIncomingTransitions() {
		if (incomingTransitions == null) {
			incomingTransitions = new EObjectWithInverseResolvingEList<BehaviorTransition>(BehaviorTransition.class,
					this, AadlBaPackage.BEHAVIOR_STATE__INCOMING_TRANSITIONS,
	...
	public EList<BehaviorTransition> getOutgoingTransitions() {
		if (outgoingTransitions == null) {
			outgoingTransitions = new EObjectWithInverseResolvingEList<BehaviorTransition>(BehaviorTransition.class,
					this, AadlBaPackage.BEHAVIOR_STATE__OUTGOING_TRANSITIONS,
