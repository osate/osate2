...
public class IfStatementImpl extends BehaviorElementImpl implements IfStatement {
	...
	public NotificationChain basicSetBehaviorActions(BehaviorActions newBehaviorActions, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					AadlBaPackage.IF_STATEMENT__BEHAVIOR_ACTIONS, oldBehaviorActions, newBehaviorActions);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newBehaviorActions != behaviorActions) {
			...
			if (behaviorActions != null)
				msgs = ((InternalEObject) behaviorActions).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - AadlBaPackage.IF_STATEMENT__BEHAVIOR_ACTIONS, null, msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET, AadlBaPackage.IF_STATEMENT__BEHAVIOR_ACTIONS,
	 ...
	 * @generated
	 */
	public NotificationChain basicSetLogicalValueExpression(ValueExpression newLogicalValueExpression,
			NotificationChain msgs) {
		ValueExpression oldLogicalValueExpression = logicalValueExpression;
		logicalValueExpression = newLogicalValueExpression;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					AadlBaPackage.IF_STATEMENT__LOGICAL_VALUE_EXPRESSION, oldLogicalValueExpression,
					newLogicalValueExpression);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
	...
	public void setLogicalValueExpression(ValueExpression newLogicalValueExpression) {
		if (newLogicalValueExpression != logicalValueExpression) {
			...
			if (logicalValueExpression != null)
				msgs = ((InternalEObject) logicalValueExpression).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - AadlBaPackage.IF_STATEMENT__LOGICAL_VALUE_EXPRESSION, null, msgs);
			if (newLogicalValueExpression != null)
				msgs = ((InternalEObject) newLogicalValueExpression).eInverseAdd(this,
						EOPPOSITE_FEATURE_BASE - AadlBaPackage.IF_STATEMENT__LOGICAL_VALUE_EXPRESSION, null, msgs);
			msgs = basicSetLogicalValueExpression(newLogicalValueExpression, msgs);
			if (msgs != null)
				msgs.dispatch();
		} else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AadlBaPackage.IF_STATEMENT__LOGICAL_VALUE_EXPRESSION,
					newLogicalValueExpression, newLogicalValueExpression));
	}
	...
	public NotificationChain basicSetElseStatement(ElseStatement newElseStatement, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					AadlBaPackage.IF_STATEMENT__ELSE_STATEMENT, oldElseStatement, newElseStatement);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
		...
		if (newElseStatement != elseStatement) {
			...
			if (elseStatement != null)
				msgs = ((InternalEObject) elseStatement).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - AadlBaPackage.IF_STATEMENT__ELSE_STATEMENT, null, msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET, AadlBaPackage.IF_STATEMENT__ELSE_STATEMENT,
