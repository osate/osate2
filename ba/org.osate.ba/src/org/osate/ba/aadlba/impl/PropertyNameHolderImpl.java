...
public class PropertyNameHolderImpl extends BehaviorElementImpl implements PropertyNameHolder {
	...
	public NotificationChain basicSetProperty(PropertyElementHolder newProperty, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					AadlBaPackage.PROPERTY_NAME_HOLDER__PROPERTY, oldProperty, newProperty);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newProperty != property) {
			...
			if (property != null)
				msgs = ((InternalEObject) property).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - AadlBaPackage.PROPERTY_NAME_HOLDER__PROPERTY, null, msgs);
			if (newProperty != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET, AadlBaPackage.PROPERTY_NAME_HOLDER__PROPERTY,
	...
	public NotificationChain basicSetField(PropertyNameField newField, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					AadlBaPackage.PROPERTY_NAME_HOLDER__FIELD, oldField, newField, !oldFieldESet);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
		...
		if (newField != field) {
			...
			if (field != null)
				msgs = ((InternalEObject) field).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - AadlBaPackage.PROPERTY_NAME_HOLDER__FIELD, null, msgs);
			if (newField != null)
			...
			fieldESet = true;
			if (eNotificationRequired())
				eNotify(new ENotificationImpl(this, Notification.SET, AadlBaPackage.PROPERTY_NAME_HOLDER__FIELD,
						newField, newField, !oldFieldESet));
		}
	}
	...
	public NotificationChain basicUnsetField(NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.UNSET,
					AadlBaPackage.PROPERTY_NAME_HOLDER__FIELD, oldField, null, oldFieldESet);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
	...
	public void unsetField() {
		if (field != null) {
			...
			fieldESet = false;
			if (eNotificationRequired())
				eNotify(new ENotificationImpl(this, Notification.UNSET, AadlBaPackage.PROPERTY_NAME_HOLDER__FIELD, null,
						null, oldFieldESet));
		}
	}
