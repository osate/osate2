			...
			if (prototypeBinding != oldPrototypeBinding) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							AadlBaPackage.PORT_PROTOTYPE_HOLDER__PROTOTYPE_BINDING, oldPrototypeBinding,
							prototypeBinding));
			}
		}
	...
	public void setPrototypeBinding(PrototypeBinding newPrototypeBinding) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					AadlBaPackage.PORT_PROTOTYPE_HOLDER__PROTOTYPE_BINDING, oldPrototypeBinding, prototypeBinding));
	}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == PrototypeHolder.class) {
			...
			case AadlBaPackage.PROTOTYPE_HOLDER__PROTOTYPE_BINDING:
				return AadlBaPackage.PORT_PROTOTYPE_HOLDER__PROTOTYPE_BINDING;
			default:
				return -1;
			}
		}
