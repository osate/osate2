...
public class SimpleExpressionImpl extends BehaviorElementImpl implements SimpleExpression {
	...
	public void setUnaryAddingOperator(UnaryAddingOperator newUnaryAddingOperator) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					AadlBaPackage.SIMPLE_EXPRESSION__UNARY_ADDING_OPERATOR, oldUnaryAddingOperator, unaryAddingOperator,
					!oldUnaryAddingOperatorESet));
	}
	...
	public void unsetUnaryAddingOperator() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET,
					AadlBaPackage.SIMPLE_EXPRESSION__UNARY_ADDING_OPERATOR, oldUnaryAddingOperator,
					UNARY_ADDING_OPERATOR_EDEFAULT, oldUnaryAddingOperatorESet));
	}
	...
	public EList<BinaryAddingOperator> getBinaryAddingOperators() {
		if (binaryAddingOperators == null) {
			binaryAddingOperators = new EDataTypeEList.Unsettable<BinaryAddingOperator>(BinaryAddingOperator.class,
					this, AadlBaPackage.SIMPLE_EXPRESSION__BINARY_ADDING_OPERATORS);
		}
	...
	public void unsetBinaryAddingOperators() {
		if (binaryAddingOperators != null)
			((InternalEList.Unsettable<?>) binaryAddingOperators).unset();
	}
