...
public class BehaviorActionBlockImpl extends BehaviorElementImpl implements BehaviorActionBlock {
	...
	public NotificationChain basicSetContent(BehaviorActions newContent, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					AadlBaPackage.BEHAVIOR_ACTION_BLOCK__CONTENT, oldContent, newContent);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newContent != content) {
			...
			if (content != null)
				msgs = ((InternalEObject) content).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - AadlBaPackage.BEHAVIOR_ACTION_BLOCK__CONTENT, null, msgs);
			if (newContent != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET, AadlBaPackage.BEHAVIOR_ACTION_BLOCK__CONTENT,
	...
	public NotificationChain basicSetTimeout(BehaviorTime newTimeout, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					AadlBaPackage.BEHAVIOR_ACTION_BLOCK__TIMEOUT, oldTimeout, newTimeout);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
		...
		if (newTimeout != timeout) {
			...
			if (timeout != null)
				msgs = ((InternalEObject) timeout).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - AadlBaPackage.BEHAVIOR_ACTION_BLOCK__TIMEOUT, null, msgs);
			if (newTimeout != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET, AadlBaPackage.BEHAVIOR_ACTION_BLOCK__TIMEOUT,
