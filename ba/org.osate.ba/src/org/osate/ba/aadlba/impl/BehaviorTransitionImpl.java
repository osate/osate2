...
public class BehaviorTransitionImpl extends BehaviorNamedElementImpl implements BehaviorTransition {
			...
			if (sourceState != oldSourceState) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							AadlBaPackage.BEHAVIOR_TRANSITION__SOURCE_STATE, oldSourceState, sourceState));
			}
		}
		return sourceState;
	}
	...
	public NotificationChain basicSetSourceState(BehaviorState newSourceState, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					AadlBaPackage.BEHAVIOR_TRANSITION__SOURCE_STATE, oldSourceState, newSourceState);
			if (msgs == null)
				msgs = notification;
			else
	...
	public void setSourceState(BehaviorState newSourceState) {
		if (newSourceState != sourceState) {
			...
			if (sourceState != null)
				msgs = ((InternalEObject) sourceState).eInverseRemove(this,
						AadlBaPackage.BEHAVIOR_STATE__OUTGOING_TRANSITIONS, BehaviorState.class, msgs);
			if (newSourceState != null)
				msgs = ((InternalEObject) newSourceState).eInverseAdd(this,
						AadlBaPackage.BEHAVIOR_STATE__OUTGOING_TRANSITIONS, BehaviorState.class, msgs);
			msgs = basicSetSourceState(newSourceState, msgs);
			if (msgs != null)
				msgs.dispatch();
		} else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AadlBaPackage.BEHAVIOR_TRANSITION__SOURCE_STATE,
	...
	public NotificationChain basicSetCondition(BehaviorCondition newCondition, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					AadlBaPackage.BEHAVIOR_TRANSITION__CONDITION, oldCondition, newCondition);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
		...
		if (newCondition != condition) {
			...
			if (condition != null)
				msgs = ((InternalEObject) condition).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - AadlBaPackage.BEHAVIOR_TRANSITION__CONDITION, null, msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET, AadlBaPackage.BEHAVIOR_TRANSITION__CONDITION,
	...
	public BehaviorState getDestinationState() {
		if (destinationState != null && ((EObject) destinationState).eIsProxy()) {
			...
			if (destinationState != oldDestinationState) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							AadlBaPackage.BEHAVIOR_TRANSITION__DESTINATION_STATE, oldDestinationState,
							destinationState));
			}
		}
	...
	public NotificationChain basicSetDestinationState(BehaviorState newDestinationState, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					AadlBaPackage.BEHAVIOR_TRANSITION__DESTINATION_STATE, oldDestinationState, newDestinationState);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
	...
	public void setDestinationState(BehaviorState newDestinationState) {
		if (newDestinationState != destinationState) {
			...
			if (destinationState != null)
				msgs = ((InternalEObject) destinationState).eInverseRemove(this,
						AadlBaPackage.BEHAVIOR_STATE__INCOMING_TRANSITIONS, BehaviorState.class, msgs);
			if (newDestinationState != null)
				msgs = ((InternalEObject) newDestinationState).eInverseAdd(this,
						AadlBaPackage.BEHAVIOR_STATE__INCOMING_TRANSITIONS, BehaviorState.class, msgs);
			msgs = basicSetDestinationState(newDestinationState, msgs);
			if (msgs != null)
				msgs.dispatch();
		} else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AadlBaPackage.BEHAVIOR_TRANSITION__DESTINATION_STATE,
	...
	public BehaviorActionBlock getActionBlock() {
		if (actionBlock != null && ((EObject) actionBlock).eIsProxy()) {
			...
			if (actionBlock != oldActionBlock) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							AadlBaPackage.BEHAVIOR_TRANSITION__ACTION_BLOCK, oldActionBlock, actionBlock));
			}
		}
		return actionBlock;
	}
	...
	public void setActionBlock(BehaviorActionBlock newActionBlock) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AadlBaPackage.BEHAVIOR_TRANSITION__ACTION_BLOCK,
	...
	public void setPriority(long newPriority) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AadlBaPackage.BEHAVIOR_TRANSITION__PRIORITY,
