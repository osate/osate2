...
public class FeatureHolderImpl extends BehaviorElementImpl implements FeatureHolder {
		...
		if (element != null && ((EObject) element).eIsProxy()) {
			...
			if (element != oldElement) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, AadlBaPackage.FEATURE_HOLDER__ELEMENT,
							oldElement, element));
			}
		}
		return element;
	...
	public void setElement(NamedElement newElement) {
		...
		element = newElement;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AadlBaPackage.FEATURE_HOLDER__ELEMENT, oldElement,
					element));
	}
	...
	public EList<IntegerValue> getArrayIndexes() {
		if (arrayIndexes == null) {
			arrayIndexes = new EObjectContainmentEList.Unsettable<IntegerValue>(IntegerValue.class, this,
					AadlBaPackage.FEATURE_HOLDER__ARRAY_INDEXES);
		}
		return arrayIndexes;
	}
	...
	public EList<GroupHolder> getGroupHolders() {
		if (groupHolders == null) {
			groupHolders = new EObjectContainmentEList.Unsettable<GroupHolder>(GroupHolder.class, this,
					AadlBaPackage.FEATURE_HOLDER__GROUP_HOLDERS);
		}
		return groupHolders;
	}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == IndexableElement.class) {
			...
			case AadlBaPackage.INDEXABLE_ELEMENT__ARRAY_INDEXES:
				return AadlBaPackage.FEATURE_HOLDER__ARRAY_INDEXES;
			default:
				return -1;
			}
		}
		if (baseClass == GroupableElement.class) {
			...
			case AadlBaPackage.GROUPABLE_ELEMENT__GROUP_HOLDERS:
				return AadlBaPackage.FEATURE_HOLDER__GROUP_HOLDERS;
			default:
				return -1;
			}
		}
