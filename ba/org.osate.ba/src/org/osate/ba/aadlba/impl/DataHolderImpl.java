...
public abstract class DataHolderImpl extends BehaviorElementImpl implements DataHolder {
		...
		if (element != null && ((EObject) element).eIsProxy()) {
			...
			if (element != oldElement) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, AadlBaPackage.DATA_HOLDER__ELEMENT,
							oldElement, element));
			}
		}
		return element;
	...
	public void setElement(NamedElement newElement) {
		...
		element = newElement;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AadlBaPackage.DATA_HOLDER__ELEMENT, oldElement,
					element));
	}
