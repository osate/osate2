...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Iterative Variable</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link org.osate.ba.aadlba.impl.IterativeVariableImpl#getDataClassifier <em>Data Classifier</em>}</li>
 * </ul>
 *
 * @generated
 */
public class IterativeVariableImpl extends BehaviorNamedElementImpl implements IterativeVariable {
			...
			if (dataClassifier != oldDataClassifier) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							AadlBaPackage.ITERATIVE_VARIABLE__DATA_CLASSIFIER, oldDataClassifier, dataClassifier));
			}
		}
	...
	public void setDataClassifier(DataClassifier newDataClassifier) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AadlBaPackage.ITERATIVE_VARIABLE__DATA_CLASSIFIER,
