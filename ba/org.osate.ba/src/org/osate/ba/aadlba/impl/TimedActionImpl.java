...
public class TimedActionImpl extends BehaviorElementImpl implements TimedAction {
	...
	public NotificationChain basicSetLowerTime(BehaviorTime newLowerTime, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					AadlBaPackage.TIMED_ACTION__LOWER_TIME, oldLowerTime, newLowerTime);
			if (msgs == null)
				msgs = notification;
			else
	...
	public void setLowerTime(BehaviorTime newLowerTime) {
		if (newLowerTime != lowerTime) {
			...
			if (lowerTime != null)
				msgs = ((InternalEObject) lowerTime).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - AadlBaPackage.TIMED_ACTION__LOWER_TIME, null, msgs);
			if (newLowerTime != null)
				msgs = ((InternalEObject) newLowerTime).eInverseAdd(this,
						EOPPOSITE_FEATURE_BASE - AadlBaPackage.TIMED_ACTION__LOWER_TIME, null, msgs);
			msgs = basicSetLowerTime(newLowerTime, msgs);
			if (msgs != null)
				msgs.dispatch();
		} else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AadlBaPackage.TIMED_ACTION__LOWER_TIME, newLowerTime,
					newLowerTime));
	}
	...
	public NotificationChain basicSetUpperTime(BehaviorTime newUpperTime, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					AadlBaPackage.TIMED_ACTION__UPPER_TIME, oldUpperTime, newUpperTime);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
	...
	public void setUpperTime(BehaviorTime newUpperTime) {
		if (newUpperTime != upperTime) {
			NotificationChain msgs = null;
			if (upperTime != null)
				msgs = ((InternalEObject) upperTime).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - AadlBaPackage.TIMED_ACTION__UPPER_TIME, null, msgs);
			if (newUpperTime != null)
				msgs = ((InternalEObject) newUpperTime).eInverseAdd(this,
						EOPPOSITE_FEATURE_BASE - AadlBaPackage.TIMED_ACTION__UPPER_TIME, null, msgs);
			msgs = basicSetUpperTime(newUpperTime, msgs);
			if (msgs != null)
				msgs.dispatch();
		} else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AadlBaPackage.TIMED_ACTION__UPPER_TIME, newUpperTime,
					newUpperTime));
	}
	...
	public EList<ProcessorClassifier> getProcessorClassifier() {
		if (processorClassifier == null) {
			processorClassifier = new EObjectResolvingEList.Unsettable<ProcessorClassifier>(ProcessorClassifier.class,
					this, AadlBaPackage.TIMED_ACTION__PROCESSOR_CLASSIFIER);
		}
	...
	public void unsetProcessorClassifier() {
		if (processorClassifier != null)
			((InternalEList.Unsettable<?>) processorClassifier).unset();
	}
