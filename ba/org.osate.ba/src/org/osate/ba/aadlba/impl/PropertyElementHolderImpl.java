...
public abstract class PropertyElementHolderImpl extends BehaviorElementImpl implements PropertyElementHolder {
	...
	public EList<IntegerValue> getArrayIndexes() {
		if (arrayIndexes == null) {
			arrayIndexes = new EObjectContainmentEList.Unsettable<IntegerValue>(IntegerValue.class, this,
					AadlBaPackage.PROPERTY_ELEMENT_HOLDER__ARRAY_INDEXES);
		}
		return arrayIndexes;
	}
			...
			if (element != oldElement) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							AadlBaPackage.PROPERTY_ELEMENT_HOLDER__ELEMENT, oldElement, element));
			}
		}
		return element;
	}
	...
	public void setElement(Element newElement) {
		...
		element = newElement;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AadlBaPackage.PROPERTY_ELEMENT_HOLDER__ELEMENT,
					oldElement, element));
	}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == IndexableElement.class) {
			...
			case AadlBaPackage.INDEXABLE_ELEMENT__ARRAY_INDEXES:
				return AadlBaPackage.PROPERTY_ELEMENT_HOLDER__ARRAY_INDEXES;
			default:
				return -1;
			}
		}
