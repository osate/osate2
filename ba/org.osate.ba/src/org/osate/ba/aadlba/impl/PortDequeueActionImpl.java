...
public class PortDequeueActionImpl extends BehaviorElementImpl implements PortDequeueAction {
	...
	public NotificationChain basicSetPort(ActualPortHolder newPort, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					AadlBaPackage.PORT_DEQUEUE_ACTION__PORT, oldPort, newPort);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newPort != port) {
			...
			if (port != null)
				msgs = ((InternalEObject) port).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - AadlBaPackage.PORT_DEQUEUE_ACTION__PORT, null, msgs);
			if (newPort != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET, AadlBaPackage.PORT_DEQUEUE_ACTION__PORT, newPort,
					newPort));
	}
	...
	public NotificationChain basicSetTarget(Target newTarget, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					AadlBaPackage.PORT_DEQUEUE_ACTION__TARGET, oldTarget, newTarget);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
		...
		if (newTarget != target) {
			...
			if (target != null)
				msgs = ((InternalEObject) target).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - AadlBaPackage.PORT_DEQUEUE_ACTION__TARGET, null, msgs);
			if (newTarget != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET, AadlBaPackage.PORT_DEQUEUE_ACTION__TARGET, newTarget,
					newTarget));
	}
