	...
	public NotificationChain basicSetBehaviorActions(BehaviorActions newBehaviorActions, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					AadlBaPackage.ELSE_STATEMENT__BEHAVIOR_ACTIONS, oldBehaviorActions, newBehaviorActions);
			if (msgs == null)
				msgs = notification;
			else
	...
	public void setBehaviorActions(BehaviorActions newBehaviorActions) {
		if (newBehaviorActions != behaviorActions) {
			...
			if (behaviorActions != null)
				msgs = ((InternalEObject) behaviorActions).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - AadlBaPackage.ELSE_STATEMENT__BEHAVIOR_ACTIONS, null, msgs);
			if (newBehaviorActions != null)
				msgs = ((InternalEObject) newBehaviorActions).eInverseAdd(this,
						EOPPOSITE_FEATURE_BASE - AadlBaPackage.ELSE_STATEMENT__BEHAVIOR_ACTIONS, null, msgs);
			msgs = basicSetBehaviorActions(newBehaviorActions, msgs);
			if (msgs != null)
				msgs.dispatch();
		} else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AadlBaPackage.ELSE_STATEMENT__BEHAVIOR_ACTIONS,
					newBehaviorActions, newBehaviorActions));
	}
