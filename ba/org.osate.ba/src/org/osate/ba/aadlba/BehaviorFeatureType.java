...
public enum BehaviorFeatureType implements Enumerator {
	 ...
	 * @generated
	 */
	private static final BehaviorFeatureType[] VALUES_ARRAY = new BehaviorFeatureType[] { NONE, BEHAVIOR_VARIABLE,
			ITERATIVE_VARIABLE, };
	...
	public static BehaviorFeatureType get(int value) {
		...
		case NONE_VALUE:
			return NONE;
		case BEHAVIOR_VARIABLE_VALUE:
			return BEHAVIOR_VARIABLE;
		case ITERATIVE_VARIABLE_VALUE:
			return ITERATIVE_VARIABLE;
		}
		return null;
	}
