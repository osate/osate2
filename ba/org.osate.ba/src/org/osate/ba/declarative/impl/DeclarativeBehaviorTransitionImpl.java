 ...
 * @generated
 */
public class DeclarativeBehaviorTransitionImpl extends BehaviorTransitionImpl implements DeclarativeBehaviorTransition {
	/**
			...
			if (osateRef != oldOsateRef) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							DeclarativePackage.DECLARATIVE_BEHAVIOR_TRANSITION__OSATE_REF, oldOsateRef, osateRef));
			}
		}
		return osateRef;
	}
	...
	public BehaviorElement getBaRef() {
		if (baRef != null && ((EObject) baRef).eIsProxy()) {
			...
			if (baRef != oldBaRef) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							DeclarativePackage.DECLARATIVE_BEHAVIOR_TRANSITION__BA_REF, oldBaRef, baRef));
			}
		}
		return baRef;
	}
	...
	public EList<Identifier> getSrcStates() {
		if (srcStates == null) {
			srcStates = new EObjectContainmentEList<Identifier>(Identifier.class, this,
	 ...
	 * @generated
	 */
	public NotificationChain basicSetDestState(Identifier newDestState, NotificationChain msgs) {
		Identifier oldDestState = destState;
		destState = newDestState;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					DeclarativePackage.DECLARATIVE_BEHAVIOR_TRANSITION__DEST_STATE, oldDestState, newDestState);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newDestState != destState) {
			...
			if (destState != null)
				msgs = ((InternalEObject) destState).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - DeclarativePackage.DECLARATIVE_BEHAVIOR_TRANSITION__DEST_STATE, null,
						msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					DeclarativePackage.DECLARATIVE_BEHAVIOR_TRANSITION__DEST_STATE, newDestState, newDestState));
	}
