 ...
 * @generated
 */
public class DeclarativeClassifierValueImpl extends DeclarativePropertyExpressionImpl
		implements DeclarativeClassifierValue {
	/**
			...
			if (classifier != oldClassifier) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							DeclarativePackage.DECLARATIVE_CLASSIFIER_VALUE__CLASSIFIER, oldClassifier, classifier));
			}
		}
		return classifier;
	}
