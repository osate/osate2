...
public class NamedValueImpl extends BehaviorElementImpl implements NamedValue {
		...
		if (osateRef != null && ((EObject) osateRef).eIsProxy()) {
			...
			if (osateRef != oldOsateRef) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, DeclarativePackage.NAMED_VALUE__OSATE_REF,
	...
	public void setOsateRef(Element newOsateRef) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DeclarativePackage.NAMED_VALUE__OSATE_REF,
					oldOsateRef, osateRef));
	}
	...
	public BehaviorElement getBaRef() {
		if (baRef != null && ((EObject) baRef).eIsProxy()) {
			...
			if (baRef != oldBaRef) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, DeclarativePackage.NAMED_VALUE__BA_REF,
							oldBaRef, baRef));
			}
		}
		return baRef;
	...
	public void setBaRef(BehaviorElement newBaRef) {
		...
		baRef = newBaRef;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DeclarativePackage.NAMED_VALUE__BA_REF, oldBaRef,
					baRef));
	}
	...
	public NotificationChain basicSetReference(Reference newReference, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					DeclarativePackage.NAMED_VALUE__REFERENCE, oldReference, newReference);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newReference != reference) {
			...
			if (reference != null)
				msgs = ((InternalEObject) reference).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - DeclarativePackage.NAMED_VALUE__REFERENCE, null, msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET, DeclarativePackage.NAMED_VALUE__REFERENCE,
	...
	public void setDequeue(boolean newDequeue) {
		...
		dequeue = newDequeue;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DeclarativePackage.NAMED_VALUE__DEQUEUE, oldDequeue,
					dequeue));
	}
	...
	public void setFresh(boolean newFresh) {
		...
		fresh = newFresh;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DeclarativePackage.NAMED_VALUE__FRESH, oldFresh,
					fresh));
	}
	...
	public void setCount(boolean newCount) {
		...
		count = newCount;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DeclarativePackage.NAMED_VALUE__COUNT, oldCount,
					count));
	}
