...
public class CommActionImpl extends BehaviorElementImpl implements CommAction {
		...
		if (osateRef != null && ((EObject) osateRef).eIsProxy()) {
			...
			if (osateRef != oldOsateRef) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, DeclarativePackage.COMM_ACTION__OSATE_REF,
	...
	public void setOsateRef(Element newOsateRef) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DeclarativePackage.COMM_ACTION__OSATE_REF,
					oldOsateRef, osateRef));
	}
	...
	public BehaviorElement getBaRef() {
		if (baRef != null && ((EObject) baRef).eIsProxy()) {
			...
			if (baRef != oldBaRef) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, DeclarativePackage.COMM_ACTION__BA_REF,
							oldBaRef, baRef));
			}
		}
		return baRef;
	...
	public void setBaRef(BehaviorElement newBaRef) {
		...
		baRef = newBaRef;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DeclarativePackage.COMM_ACTION__BA_REF, oldBaRef,
					baRef));
	}
	...
	public EList<ParameterLabel> getParameters() {
		if (parameters == null) {
			parameters = new EObjectContainmentEList.Unsettable<ParameterLabel>(ParameterLabel.class, this,
	...
	public void setPortFreeze(boolean newPortFreeze) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DeclarativePackage.COMM_ACTION__PORT_FREEZE,
	...
	public void setPortDequeue(boolean newPortDequeue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DeclarativePackage.COMM_ACTION__PORT_DEQUEUE,
	...
	public void setLock(boolean newLock) {
		...
		lock = newLock;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DeclarativePackage.COMM_ACTION__LOCK, oldLock, lock));
	}
	...
	public void setUnlock(boolean newUnlock) {
		...
		unlock = newUnlock;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DeclarativePackage.COMM_ACTION__UNLOCK, oldUnlock,
					unlock));
	}
		...
		if (newTarget != target) {
			...
			if (target != null)
				msgs = ((InternalEObject) target).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - DeclarativePackage.COMM_ACTION__TARGET, null, msgs);
			if (newTarget != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET, DeclarativePackage.COMM_ACTION__TARGET, newTarget,
					newTarget));
	}
	...
	public NotificationChain basicSetQualifiedName(QualifiedNamedElement newQualifiedName, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					DeclarativePackage.COMM_ACTION__QUALIFIED_NAME, oldQualifiedName, newQualifiedName);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
		...
		if (newQualifiedName != qualifiedName) {
			...
			if (qualifiedName != null)
				msgs = ((InternalEObject) qualifiedName).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - DeclarativePackage.COMM_ACTION__QUALIFIED_NAME, null, msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET, DeclarativePackage.COMM_ACTION__QUALIFIED_NAME,
	...
	public NotificationChain basicSetReference(Reference newReference, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					DeclarativePackage.COMM_ACTION__REFERENCE, oldReference, newReference);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
		...
		if (newReference != reference) {
			...
			if (reference != null)
				msgs = ((InternalEObject) reference).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - DeclarativePackage.COMM_ACTION__REFERENCE, null, msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET, DeclarativePackage.COMM_ACTION__REFERENCE,
