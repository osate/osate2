 ...
 * @generated
 */
public class DeclarativePropertyReferenceImpl extends DeclarativeBehaviorElementImpl
		implements DeclarativePropertyReference {
	/**
	 ...
	 * @generated
	 */
	public NotificationChain basicSetQualifiedName(QualifiedNamedElement newQualifiedName, NotificationChain msgs) {
		QualifiedNamedElement oldQualifiedName = qualifiedName;
		qualifiedName = newQualifiedName;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					DeclarativePackage.DECLARATIVE_PROPERTY_REFERENCE__QUALIFIED_NAME, oldQualifiedName,
					newQualifiedName);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newQualifiedName != qualifiedName) {
			...
			if (qualifiedName != null)
				msgs = ((InternalEObject) qualifiedName).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - DeclarativePackage.DECLARATIVE_PROPERTY_REFERENCE__QUALIFIED_NAME,
						null, msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					DeclarativePackage.DECLARATIVE_PROPERTY_REFERENCE__QUALIFIED_NAME, newQualifiedName,
					newQualifiedName));
	}
	...
	public NotificationChain basicSetReference(Reference newReference, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					DeclarativePackage.DECLARATIVE_PROPERTY_REFERENCE__REFERENCE, oldReference, newReference);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
		...
		if (newReference != reference) {
			...
			if (reference != null)
				msgs = ((InternalEObject) reference).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - DeclarativePackage.DECLARATIVE_PROPERTY_REFERENCE__REFERENCE, null,
						msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					DeclarativePackage.DECLARATIVE_PROPERTY_REFERENCE__REFERENCE, newReference, newReference));
	}
	...
	public EList<DeclarativePropertyName> getPropertyNames() {
		if (propertyNames == null) {
			propertyNames = new EObjectContainmentEList<DeclarativePropertyName>(DeclarativePropertyName.class, this,
	...
	public void setPropertySet(boolean newPropertySet) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					DeclarativePackage.DECLARATIVE_PROPERTY_REFERENCE__PROPERTY_SET, oldPropertySet, propertySet));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		...
		case DeclarativePackage.DECLARATIVE_PROPERTY_REFERENCE__PROPERTY_NAMES:
			return ((InternalEList<?>) getPropertyNames()).basicRemove(otherEnd, msgs);
		}
