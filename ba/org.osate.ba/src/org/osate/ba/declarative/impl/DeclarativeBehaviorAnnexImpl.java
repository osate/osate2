 ...
 * @generated
 */
public class DeclarativeBehaviorAnnexImpl extends EObjectImpl implements DeclarativeBehaviorAnnex {
	/**
	...
	public EList<DeclarativeBehaviorElement> getDeclarativeBehaviorElements() {
		if (declarativeBehaviorElements == null) {
			declarativeBehaviorElements = new EObjectContainmentEList<DeclarativeBehaviorElement>(
					DeclarativeBehaviorElement.class, this,
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		...
		case DeclarativePackage.DECLARATIVE_BEHAVIOR_ANNEX__DECLARATIVE_BEHAVIOR_ELEMENTS:
			return ((InternalEList<?>) getDeclarativeBehaviorElements()).basicRemove(otherEnd, msgs);
		}
	...
	public boolean eIsSet(int featureID) {
		switch (featureID) {
		case DeclarativePackage.DECLARATIVE_BEHAVIOR_ANNEX__DECLARATIVE_BEHAVIOR_ELEMENTS:
			return declarativeBehaviorElements != null && !declarativeBehaviorElements.isEmpty();
		}
