 ...
 * @generated
 */
public class DeclarativeArrayDimensionImpl extends ArrayDimensionImpl
		implements DeclarativeArrayDimension, IBAVisitable {
	/**
			...
			if (osateRef != oldOsateRef) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							DeclarativePackage.DECLARATIVE_ARRAY_DIMENSION__OSATE_REF, oldOsateRef, osateRef));
			}
		}
		return osateRef;
	}
	...
	public BehaviorElement getBaRef() {
		if (baRef != null && ((EObject) baRef).eIsProxy()) {
			...
			if (baRef != oldBaRef) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							DeclarativePackage.DECLARATIVE_ARRAY_DIMENSION__BA_REF, oldBaRef, baRef));
			}
		}
		return baRef;
	}
	...
	public NotificationChain basicSetDimension(IntegerValueConstant newDimension, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					DeclarativePackage.DECLARATIVE_ARRAY_DIMENSION__DIMENSION, oldDimension, newDimension);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newDimension != dimension) {
			...
			if (dimension != null)
				msgs = ((InternalEObject) dimension).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - DeclarativePackage.DECLARATIVE_ARRAY_DIMENSION__DIMENSION, null, msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					DeclarativePackage.DECLARATIVE_ARRAY_DIMENSION__DIMENSION, newDimension, newDimension));
	}
