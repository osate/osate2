...
public class IdentifierImpl extends BehaviorStateImpl implements Identifier {
		...
		if (osateRef != null && ((EObject) osateRef).eIsProxy()) {
			...
			if (osateRef != oldOsateRef) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, DeclarativePackage.IDENTIFIER__OSATE_REF,
	...
	public void setOsateRef(Element newOsateRef) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DeclarativePackage.IDENTIFIER__OSATE_REF, oldOsateRef,
					osateRef));
	}
	...
	public BehaviorElement getBaRef() {
		if (baRef != null && ((EObject) baRef).eIsProxy()) {
			...
			if (baRef != oldBaRef) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, DeclarativePackage.IDENTIFIER__BA_REF,
							oldBaRef, baRef));
			}
		}
		return baRef;
	...
	public void setBaRef(BehaviorElement newBaRef) {
		...
		baRef = newBaRef;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DeclarativePackage.IDENTIFIER__BA_REF, oldBaRef,
					baRef));
	}
	...
	public void setId(String newId) {
		...
		id = newId;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DeclarativePackage.IDENTIFIER__ID, oldId, id));
	}
