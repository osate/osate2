 ...
 * @generated
 */
public abstract class DeclarativeBehaviorElementImpl extends BehaviorElementImpl implements DeclarativeBehaviorElement {
	/**
			...
			if (osateRef != oldOsateRef) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							DeclarativePackage.DECLARATIVE_BEHAVIOR_ELEMENT__OSATE_REF, oldOsateRef, osateRef));
			}
		}
		return osateRef;
	}
	...
	public BehaviorElement getBaRef() {
		if (baRef != null && ((EObject) baRef).eIsProxy()) {
			...
			if (baRef != oldBaRef) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							DeclarativePackage.DECLARATIVE_BEHAVIOR_ELEMENT__BA_REF, oldBaRef, baRef));
			}
		}
		return baRef;
	}
