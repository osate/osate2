 ...
 * @generated
 */
public class DeclarativePropertyAssociationImpl extends DeclarativeBehaviorElementImpl
		implements DeclarativePropertyAssociation {
	/**
			...
			if (property != oldProperty) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							DeclarativePackage.DECLARATIVE_PROPERTY_ASSOCIATION__PROPERTY, oldProperty, property));
			}
		}
		return property;
	}
	 ...
	 * @generated
	 */
	public NotificationChain basicSetOwnedValue(DeclarativePropertyExpression newOwnedValue, NotificationChain msgs) {
		DeclarativePropertyExpression oldOwnedValue = ownedValue;
		ownedValue = newOwnedValue;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					DeclarativePackage.DECLARATIVE_PROPERTY_ASSOCIATION__OWNED_VALUE, oldOwnedValue, newOwnedValue);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newOwnedValue != ownedValue) {
			...
			if (ownedValue != null)
				msgs = ((InternalEObject) ownedValue).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - DeclarativePackage.DECLARATIVE_PROPERTY_ASSOCIATION__OWNED_VALUE, null,
						msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					DeclarativePackage.DECLARATIVE_PROPERTY_ASSOCIATION__OWNED_VALUE, newOwnedValue, newOwnedValue));
	}
