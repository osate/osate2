...
public class ReferenceImpl extends ActualPortHolderImpl implements Reference {
		...
		if (osateRef != null && ((EObject) osateRef).eIsProxy()) {
			...
			if (osateRef != oldOsateRef) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, DeclarativePackage.REFERENCE__OSATE_REF,
	...
	public void setOsateRef(Element newOsateRef) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DeclarativePackage.REFERENCE__OSATE_REF, oldOsateRef,
					osateRef));
	}
	...
	public BehaviorElement getBaRef() {
		if (baRef != null && ((EObject) baRef).eIsProxy()) {
			...
			if (baRef != oldBaRef) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, DeclarativePackage.REFERENCE__BA_REF,
							oldBaRef, baRef));
			}
		}
		return baRef;
	...
	public void setBaRef(BehaviorElement newBaRef) {
		...
		baRef = newBaRef;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DeclarativePackage.REFERENCE__BA_REF, oldBaRef,
					baRef));
	}
			...
			if (namedElement != oldNamedElement) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							DeclarativePackage.REFERENCE__NAMED_ELEMENT, oldNamedElement, namedElement));
			}
		}
		return namedElement;
	}
	...
	public void setNamedElement(NamedElement newNamedElement) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DeclarativePackage.REFERENCE__NAMED_ELEMENT,
	...
	public void setAnnexName(String newAnnexName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DeclarativePackage.REFERENCE__ANNEX_NAME,
	...
	public NotificationChain basicSetPath(ContainmentPathElement newPath, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					DeclarativePackage.REFERENCE__PATH, oldPath, newPath);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newPath != path) {
			...
			if (path != null)
				msgs = ((InternalEObject) path).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - DeclarativePackage.REFERENCE__PATH, null, msgs);
			if (newPath != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET, DeclarativePackage.REFERENCE__PATH, newPath,
					newPath));
	}
	...
	public EList<ArrayableIdentifier> getIds() {
		if (ids == null) {
			ids = new EObjectContainmentEList<ArrayableIdentifier>(ArrayableIdentifier.class, this,
