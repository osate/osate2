 ...
 * @generated
 */
public class DeclarativeReferenceValueImpl extends DeclarativePropertyExpressionImpl
			...
			if (ref != oldRef) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							DeclarativePackage.DECLARATIVE_REFERENCE_VALUE__REF, oldRef, ref));
			}
		}
		return ref;
	}
	...
	public void setRef(Reference newRef) {
		...
		ref = newRef;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DeclarativePackage.DECLARATIVE_REFERENCE_VALUE__REF,
					oldRef, ref));
	}
