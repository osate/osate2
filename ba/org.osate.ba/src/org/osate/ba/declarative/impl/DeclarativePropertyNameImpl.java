...
public class DeclarativePropertyNameImpl extends DeclarativeBehaviorElementImpl implements DeclarativePropertyName {
	 ...
	 * @generated
	 */
	public NotificationChain basicSetPropertyName(Identifier newPropertyName, NotificationChain msgs) {
		Identifier oldPropertyName = propertyName;
		propertyName = newPropertyName;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					DeclarativePackage.DECLARATIVE_PROPERTY_NAME__PROPERTY_NAME, oldPropertyName, newPropertyName);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newPropertyName != propertyName) {
			...
			if (propertyName != null)
				msgs = ((InternalEObject) propertyName).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - DeclarativePackage.DECLARATIVE_PROPERTY_NAME__PROPERTY_NAME, null,
						msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					DeclarativePackage.DECLARATIVE_PROPERTY_NAME__PROPERTY_NAME, newPropertyName, newPropertyName));
	}
	...
	public NotificationChain basicSetField(PropertyNameField newField, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					DeclarativePackage.DECLARATIVE_PROPERTY_NAME__FIELD, oldField, newField);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
		...
		if (newField != field) {
			...
			if (field != null)
				msgs = ((InternalEObject) field).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - DeclarativePackage.DECLARATIVE_PROPERTY_NAME__FIELD, null, msgs);
			if (newField != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET, DeclarativePackage.DECLARATIVE_PROPERTY_NAME__FIELD,
					newField, newField));
	}
	...
	public EList<IntegerValue> getIndexes() {
		if (indexes == null) {
			indexes = new EObjectResolvingEList.Unsettable<IntegerValue>(IntegerValue.class, this,
