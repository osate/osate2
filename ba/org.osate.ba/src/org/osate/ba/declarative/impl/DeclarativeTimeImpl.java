 ...
 * @generated
 */
public class DeclarativeTimeImpl extends BehaviorTimeImpl implements DeclarativeTime {
	/**
			...
			if (osateRef != oldOsateRef) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							DeclarativePackage.DECLARATIVE_TIME__OSATE_REF, oldOsateRef, osateRef));
			}
		}
		return osateRef;
	}
	...
	public void setOsateRef(Element newOsateRef) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DeclarativePackage.DECLARATIVE_TIME__OSATE_REF,
	...
	public void setBaRef(BehaviorElement newBaRef) {
		...
		baRef = newBaRef;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DeclarativePackage.DECLARATIVE_TIME__BA_REF, oldBaRef,
					baRef));
	}
	 ...
	 * @generated
	 */
	public NotificationChain basicSetUnitId(Identifier newUnitId, NotificationChain msgs) {
		Identifier oldUnitId = unitId;
		unitId = newUnitId;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					DeclarativePackage.DECLARATIVE_TIME__UNIT_ID, oldUnitId, newUnitId);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newUnitId != unitId) {
			...
			if (unitId != null)
				msgs = ((InternalEObject) unitId).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - DeclarativePackage.DECLARATIVE_TIME__UNIT_ID, null, msgs);
			if (newUnitId != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET, DeclarativePackage.DECLARATIVE_TIME__UNIT_ID,
					newUnitId, newUnitId));
	}
