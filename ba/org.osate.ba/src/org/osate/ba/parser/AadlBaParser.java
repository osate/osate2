...
public class AadlBaParser extends Parser {
	...
	public final Dispatch_trigger_conditionContext dispatch_trigger_condition() throws RecognitionException {
		...
		try {
			...
			case TIMEOUT:
				...
				setState(330);
				_la = _input.LA(1);
				if (_la==FALSE || _la==TRUE || ((((_la - 73)) & ~0x3f) == 0 && ((1L << (_la - 73)) & ((1L << (HASH - 73)) | (1L << (IDENT - 73)) | (1L << (STRING_LITERAL - 73)) | (1L << (REAL_LIT - 73)) | (1L << (INTEGER_LIT - 73)))) != 0)) {
					{
	...
	public final Property_referenceContext property_reference() throws RecognitionException {
		...
		try {
			...
			case 1:
				{
				setState(961); qualified_named_element();
				}
				break;
			...
			setState(965); match(HASH);
			setState(966); property_name();
			setState(971);
			_errHandler.sync(this);
			_la = _input.LA(1);
			while (_la==DOT) {
	...
	public final Property_nameContext property_name() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(974); match(IDENT);
			setState(981);
			switch ( getInterpreter().adaptivePredict(_input,130,_ctx) ) {
			case 1:
				{
				{
				setState(975); match(LBRACK);
				setState(976); integer_value();
				setState(977); match(RBRACK);
				}
				}
				break;
			...
			case 2:
				...
				setState(980);
				_la = _input.LA(1);
				if ( !(((((_la - 22)) & ~0x3f) == 0 && ((1L << (_la - 22)) & ((1L << (LOWER_BOUND - 22)) | (1L << (UPPER_BOUND - 22)) | (1L << (IDENT - 22)))) != 0)) ) {
				_errHandler.recoverInline(this);
				}
				consume();
				}
	...
	public final Numeric_literalContext numeric_literal() throws RecognitionException {
		...
		try {
			...
			case INTEGER_LIT:
				enterOuterAlt(_localctx, 1);
				{
				setState(983); integer_literal();
				}
				break;
			case REAL_LIT:
				enterOuterAlt(_localctx, 2);
				{
				setState(984); real_literal();
				}
				break;
			default:
				throw new NoViableAltException(this);
	...
	public final Integer_literalContext integer_literal() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(990); match(INTEGER_LIT);
	...
	public final String_literalContext string_literal() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(993); match(STRING_LITERAL);
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final NumeralContext numeral() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(995); match(INTEGER_LIT);
	...
	public static final String _serializedATN =
		...
		"\n<\3=\3=\3=\3>\3>\5>\u03c6\n>\3>\3>\3>\3>\7>\u03cc\n>\f>\16>\u03cf\13"+
		">\3?\3?\3?\3?\3?\3?\3?\5?\u03d8\n?\3@\3@\5@\u03dc\n@\3A\3A\3A\3B\3B\3"+
		"B\3C\3C\3D\3D\3D\3D\2E\2\4\6\b\n\f\16\20\22\24\26\30\32\34\36 \"$&(*,"+
		".\60\62\64\668:<>@BDFHJLNPRTVXZ\\^`bdfhjlnprtvxz|~\u0080\u0082\u0084\u0086"+
		"\2\13\4\2\r\rNN\4\2\65\65==\3\29:\4\2\t\t\23\23\5\2\4\4\34\34))\3\2CD"+
		"\5\2\31\31\37\37EF\4\2\17\17%%\5\2\30\30\'\'OO\u0446\2\u008e\3\2\2\2\4"+
		"\u00a0\3\2\2\2\6\u00b4\3\2\2\2\b\u00c3\3\2\2\2\n\u00cd\3\2\2\2\f\u00cf"+
		"\3\2\2\2\16\u00f3\3\2\2\2\20\u010d\3\2\2\2\22\u0123\3\2\2\2\24\u012a\3"+
		"\2\2\2\26\u012f\3\2\2\2\30\u0133\3\2\2\2\32\u0135\3\2\2\2\34\u014f\3\2"+
		"\2\2\36\u0151\3\2\2\2 \u0159\3\2\2\2\"\u0161\3\2\2\2$\u018a\3\2\2\2&\u01bc"+
