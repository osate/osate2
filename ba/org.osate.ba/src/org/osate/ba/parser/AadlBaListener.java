...
public interface AadlBaListener extends ParseTreeListener {
	 ...
	 * @param ctx the parse tree
	 */
	void enterData_classifier_property_association(
			@NotNull AadlBaParser.Data_classifier_property_associationContext ctx);

	/**
	 * Exit a parse tree produced by {@link AadlBaParser#data_classifier_property_association}.
	 * @param ctx the parse tree
	 */
	void exitData_classifier_property_association(
			@NotNull AadlBaParser.Data_classifier_property_associationContext ctx);
	 ...
	 * @param ctx the parse tree
	 */
	void enterMode_switch_trigger_logical_expression(
	 ...
	 * @param ctx the parse tree
	 */
	void exitMode_switch_trigger_logical_expression(
			@NotNull AadlBaParser.Mode_switch_trigger_logical_expressionContext ctx);
	 ...
	 * @param ctx the parse tree
	 */
	void enterUnique_component_classifier_reference(
	 ...
	 * @param ctx the parse tree
	 */
	void exitUnique_component_classifier_reference(
			@NotNull AadlBaParser.Unique_component_classifier_referenceContext ctx);
