...
/**
 * This is the item provider adapter for a {@link fr.tpt.aadl.annex.behavior.aadlba.IterativeVariable} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class IterativeVariableItemProvider
    ...
    IItemPropertySource
{
    ...
    itemPropertyDescriptors.add
      (createItemPropertyDescriptor
        (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
         ...
         getString("_UI_PropertyDescriptor_description", "_UI_IterativeVariable_dataClassifier_feature", "_UI_IterativeVariable_type"),
         AadlBaPackage.Literals.ITERATIVE_VARIABLE__DATA_CLASSIFIER,
         true,
         false,
         true,
         null,
  ...
  public String getText(Object object)
  {
    ...
    return label == null || label.length() == 0 ?
      getString("_UI_IterativeVariable_type") :
