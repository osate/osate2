...
/**
 * This is the item provider adapter for a {@link fr.tpt.aadl.annex.behavior.aadlba.Relation} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
    ...
    IItemPropertySource
{
    ...
    itemPropertyDescriptors.add
      (createItemPropertyDescriptor
        (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
         getResourceLocator(),
         getString("_UI_Relation_relationalOperator_feature"),
         getString("_UI_PropertyDescriptor_description", "_UI_Relation_relationalOperator_feature", "_UI_Relation_type"),
         AadlBaPackage.Literals.RELATION__RELATIONAL_OPERATOR,
         true,
         false,
         false,
  ...
  public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object)
  {
    if (childrenFeatures == null)
    {
      ...
      childrenFeatures.add(AadlBaPackage.Literals.RELATION__FIRST_EXPRESSION);
      childrenFeatures.add(AadlBaPackage.Literals.RELATION__SECOND_EXPRESSION);
    }
  ...
  protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object)
  {
    ...
    newChildDescriptors.add
      (createChildParameter
        (AadlBaPackage.Literals.RELATION__FIRST_EXPRESSION,
         AadlBaFactory.eINSTANCE.createSimpleExpression()));

    newChildDescriptors.add
      (createChildParameter
        (AadlBaPackage.Literals.RELATION__SECOND_EXPRESSION,
         AadlBaFactory.eINSTANCE.createSimpleExpression()));
  }
  ...
  public String getCreateChildText(Object owner, Object feature, Object child, Collection<?> selection)
  {
    ...
    boolean qualify =
      childFeature == AadlBaPackage.Literals.RELATION__FIRST_EXPRESSION ||
      childFeature == AadlBaPackage.Literals.RELATION__SECOND_EXPRESSION;
