...
/**
 * This is the item provider adapter for a {@link org.osate.ba.aadlba.DataAccessPrototypeHolder} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DataAccessPrototypeHolderItemProvider extends DataHolderItemProvider {
	/**
	 ...
	 * @generated
	 */
	public DataAccessPrototypeHolderItemProvider(AdapterFactory adapterFactory) {
	...
	protected void addPrototypeBindingPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_PrototypeHolder_prototypeBinding_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_PrototypeHolder_prototypeBinding_feature",
								"_UI_PrototypeHolder_type"),
						AadlBaPackage.Literals.PROTOTYPE_HOLDER__PROTOTYPE_BINDING, true, false, true, null, null,
						null));
	}
	...
	public String getText(Object object) {
		return getString("_UI_DataAccessPrototypeHolder_type");
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(DataAccessPrototypeHolder.class)) {
