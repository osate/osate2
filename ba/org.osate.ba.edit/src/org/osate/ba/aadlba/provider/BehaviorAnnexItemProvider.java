...
public class BehaviorAnnexItemProvider extends AnnexSubclauseItemProvider {
	...
	protected void addInitialStatePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_BehaviorAnnex_initialState_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_BehaviorAnnex_initialState_feature",
								"_UI_BehaviorAnnex_type"),
						AadlBaPackage.Literals.BEHAVIOR_ANNEX__INITIAL_STATE, true, false, true, null, null, null));
	}
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ? getString("_UI_BehaviorAnnex_type")
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(createChildParameter(AadlBaPackage.Literals.BEHAVIOR_ANNEX__VARIABLES,
				AadlBaFactory.eINSTANCE.createBehaviorVariable()));

		newChildDescriptors.add(createChildParameter(AadlBaPackage.Literals.BEHAVIOR_ANNEX__STATES,
				AadlBaFactory.eINSTANCE.createBehaviorState()));

		newChildDescriptors.add(createChildParameter(AadlBaPackage.Literals.BEHAVIOR_ANNEX__TRANSITIONS,
				AadlBaFactory.eINSTANCE.createBehaviorTransition()));

		newChildDescriptors.add(createChildParameter(AadlBaPackage.Literals.BEHAVIOR_ANNEX__ACTIONS,
