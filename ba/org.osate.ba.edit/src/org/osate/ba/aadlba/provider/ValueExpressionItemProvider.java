    ...
    itemPropertyDescriptors.add
      (createItemPropertyDescriptor
        (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
         getResourceLocator(),
         getString("_UI_ValueExpression_logicalOperators_feature"),
         getString("_UI_PropertyDescriptor_description", "_UI_ValueExpression_logicalOperators_feature", "_UI_ValueExpression_type"),
         AadlBaPackage.Literals.VALUE_EXPRESSION__LOGICAL_OPERATORS,
         true,
         false,
         false,
  ...
  protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object)
  {
    ...
    newChildDescriptors.add
      (createChildParameter
        (AadlBaPackage.Literals.VALUE_EXPRESSION__RELATIONS,
