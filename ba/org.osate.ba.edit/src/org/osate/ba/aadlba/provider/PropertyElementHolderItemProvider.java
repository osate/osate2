    ...
    itemPropertyDescriptors.add
      (createItemPropertyDescriptor
        (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
         getResourceLocator(),
         getString("_UI_PropertyElementHolder_element_feature"),
         getString("_UI_PropertyDescriptor_description", "_UI_PropertyElementHolder_element_feature", "_UI_PropertyElementHolder_type"),
         AadlBaPackage.Literals.PROPERTY_ELEMENT_HOLDER__ELEMENT,
         true,
         false,
         true,
         null,
