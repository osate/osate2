 ...
 * @generated
 */
public class FactorItemProvider extends BehaviorElementItemProvider {
	/**
	...
	protected void addBinaryNumericOperatorPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Factor_binaryNumericOperator_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Factor_binaryNumericOperator_feature",
								"_UI_Factor_type"),
						AadlBaPackage.Literals.FACTOR__BINARY_NUMERIC_OPERATOR, true, false, false,
	...
	protected void addUnaryNumericOperatorPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Factor_unaryNumericOperator_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Factor_unaryNumericOperator_feature",
								"_UI_Factor_type"),
						AadlBaPackage.Literals.FACTOR__UNARY_NUMERIC_OPERATOR, true, false, false,
						ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	protected void addUnaryBooleanOperatorPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Factor_unaryBooleanOperator_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Factor_unaryBooleanOperator_feature",
								"_UI_Factor_type"),
						AadlBaPackage.Literals.FACTOR__UNARY_BOOLEAN_OPERATOR, true, false, false,
						ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ? getString("_UI_Factor_type")
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(
				createChildParameter(AadlBaPackage.Literals.FACTOR__FIRST_VALUE, AadlBaFactory.eINSTANCE.createAny()));
		...
		newChildDescriptors.add(
				createChildParameter(AadlBaPackage.Literals.FACTOR__SECOND_VALUE, AadlBaFactory.eINSTANCE.createAny()));
	...
	public String getCreateChildText(Object owner, Object feature, Object child, Collection<?> selection) {
		...
		boolean qualify = childFeature == AadlBaPackage.Literals.FACTOR__FIRST_VALUE
