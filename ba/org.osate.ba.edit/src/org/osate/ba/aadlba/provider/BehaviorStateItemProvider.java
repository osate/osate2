 ...
 * @generated
 */
public class BehaviorStateItemProvider extends BehaviorNamedElementItemProvider {
	/**
	...
	protected void addInitialPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_BehaviorState_initial_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_BehaviorState_initial_feature",
								"_UI_BehaviorState_type"),
						AadlBaPackage.Literals.BEHAVIOR_STATE__INITIAL, true, false, false,
	...
	protected void addCompletePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_BehaviorState_complete_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_BehaviorState_complete_feature",
								"_UI_BehaviorState_type"),
						AadlBaPackage.Literals.BEHAVIOR_STATE__COMPLETE, true, false, false,
						ItemPropertyDescriptor.BOOLEAN_VALUE_IMAGE, null, null));
	}
	...
	protected void addFinalPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_BehaviorState_final_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_BehaviorState_final_feature",
								"_UI_BehaviorState_type"),
						AadlBaPackage.Literals.BEHAVIOR_STATE__FINAL, true, false, false,
						ItemPropertyDescriptor.BOOLEAN_VALUE_IMAGE, null, null));
	}
	...
	protected void addBindedModePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_BehaviorState_bindedMode_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_BehaviorState_bindedMode_feature",
								"_UI_BehaviorState_type"),
						AadlBaPackage.Literals.BEHAVIOR_STATE__BINDED_MODE, true, false, true, null, null, null));
	}
	...
	protected void addIncomingTransitionsPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_BehaviorState_incomingTransitions_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_BehaviorState_incomingTransitions_feature",
								"_UI_BehaviorState_type"),
						AadlBaPackage.Literals.BEHAVIOR_STATE__INCOMING_TRANSITIONS, true, false, true, null, null,
						null));
	}
	...
	protected void addOutgoingTransitionsPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_BehaviorState_outgoingTransitions_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_BehaviorState_outgoingTransitions_feature",
								"_UI_BehaviorState_type"),
						AadlBaPackage.Literals.BEHAVIOR_STATE__OUTGOING_TRANSITIONS, true, false, true, null, null,
						null));
	}
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ? getString("_UI_BehaviorState_type")
