 ...
 * @generated
 */
public class IfStatementItemProvider extends BehaviorElementItemProvider {
	/**
	...
	protected void addElifPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_IfStatement_elif_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_IfStatement_elif_feature",
								"_UI_IfStatement_type"),
						AadlBaPackage.Literals.IF_STATEMENT__ELIF, true, false, false,
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(createChildParameter(AadlBaPackage.Literals.IF_STATEMENT__ELSE_STATEMENT,
				AadlBaFactory.eINSTANCE.createElseStatement()));
	...
	public String getCreateChildText(Object owner, Object feature, Object child, Collection<?> selection) {
		...
		boolean qualify = childFeature == AadlBaPackage.Literals.COND_STATEMENT__BEHAVIOR_ACTIONS
