...
/**
 * This is the item provider adapter for a {@link org.osate.ba.aadlba.ForOrForAllStatement} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ForOrForAllStatementItemProvider extends LoopStatementItemProvider {
	/**
	 ...
	 * @generated
	 */
	public ForOrForAllStatementItemProvider(AdapterFactory adapterFactory) {
	...
	protected void addForAllPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_ForOrForAllStatement_forAll_feature"),
				getString("_UI_PropertyDescriptor_description", "_UI_ForOrForAllStatement_forAll_feature",
						"_UI_ForOrForAllStatement_type"),
				AadlBaPackage.Literals.FOR_OR_FOR_ALL_STATEMENT__FOR_ALL, true, false, false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(AadlBaPackage.Literals.FOR_OR_FOR_ALL_STATEMENT__ITERATED_VALUES);
			childrenFeatures.add(AadlBaPackage.Literals.FOR_OR_FOR_ALL_STATEMENT__ITERATIVE_VARIABLE);
		}
	...
	public String getText(Object object) {
		ForOrForAllStatement forOrForAllStatement = (ForOrForAllStatement) object;
		return getString("_UI_ForOrForAllStatement_type") + " " + forOrForAllStatement.isForAll();
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(ForOrForAllStatement.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors
				.add(createChildParameter(AadlBaPackage.Literals.FOR_OR_FOR_ALL_STATEMENT__ITERATIVE_VARIABLE,
						AadlBaFactory.eINSTANCE.createIterativeVariable()));
	}
