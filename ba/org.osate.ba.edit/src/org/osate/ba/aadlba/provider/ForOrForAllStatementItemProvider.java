 ...
 * @generated
 */
public class ForOrForAllStatementItemProvider
    ...
    itemPropertyDescriptors.add
      (createItemPropertyDescriptor
        (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
         ...
         getString("_UI_PropertyDescriptor_description", "_UI_ForOrForAllStatement_forAll_feature", "_UI_ForOrForAllStatement_type"),
         AadlBaPackage.Literals.FOR_OR_FOR_ALL_STATEMENT__FOR_ALL,
         true,
         false,
         false,
  ...
  protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object)
  {
    ...
    newChildDescriptors.add
      (createChildParameter
        (AadlBaPackage.Literals.FOR_OR_FOR_ALL_STATEMENT__ITERATED_VALUES,
    ...
    newChildDescriptors.add
      (createChildParameter
        (AadlBaPackage.Literals.FOR_OR_FOR_ALL_STATEMENT__ITERATIVE_VARIABLE,
