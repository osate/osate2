 ...
 * @generated
 */
public class BehaviorTimeItemProvider extends BehaviorElementItemProvider {
	/**
	...
	protected void addUnitPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_BehaviorTime_unit_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_BehaviorTime_unit_feature",
								"_UI_BehaviorTime_type"),
						AadlBaPackage.Literals.BEHAVIOR_TIME__UNIT, true, false, true, null, null, null));
	}
