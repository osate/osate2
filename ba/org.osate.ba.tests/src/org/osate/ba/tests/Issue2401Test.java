...
public class Issue2401Test {
	private static final String MODEL = "org.osate.ba.tests/models/issue2401/issue2401.aadl";

	@Inject
	private TestHelper<AadlPackage> testHelper;

	@Test
	public void testIssue2401() throws Exception {
		...
		assertEquals("issue2401", pkg.getName());
		var classifier = pkg.getPublicSection().getOwnedClassifiers().get(2);
		assertEquals("test.impl", classifier.getName());
