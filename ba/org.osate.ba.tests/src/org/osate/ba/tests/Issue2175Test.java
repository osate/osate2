...
public class Issue2175Test {
	private static final String MODEL = "org.osate.ba.tests/models/issue2175/issue2175.aadl";

	@Inject
	private TestHelper<AadlPackage> testHelper;

	@Test
	public void testIssue2175() throws Exception {
		...
		assertEquals("issue2175", pkg.getName());
		var classifier = pkg.getPublicSection().getOwnedClassifiers().get(0);
		assertEquals("function1", classifier.getName());
