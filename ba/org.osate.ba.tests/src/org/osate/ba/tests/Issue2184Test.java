...
public class Issue2184Test {
	private static final String MODEL = "org.osate.ba.tests/models/issue2184/issue2184.aadl";

	@Inject
	private TestHelper<AadlPackage> testHelper;

	@Test
	public void testIssue2184() throws Exception {
		...
		assertEquals("issue2184", pkg.getName());
