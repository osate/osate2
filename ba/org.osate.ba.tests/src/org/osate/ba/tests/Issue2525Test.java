...
public class Issue2525Test {
	private static final String MODEL = "org.osate.ba.tests/models/issue2525/issue2525.aadl";

	@Inject
	private TestHelper<AadlPackage> testHelper;

	@Test
	public void testIssue2525() throws Exception {
		...
		assertEquals("issue2525", pkg.getName());
		var classifier = pkg.getPublicSection().getOwnedClassifiers().getFirst();
		assertEquals("t", classifier.getName());
