...
public class Issue2236Test {
	private static final String MODEL = "org.osate.ba.tests/models/issue2236/issue2236.aadl";

	@Inject
	private TestHelper<AadlPackage> testHelper;

	@Test
	public void testIssue2236() throws Exception {
		...
		assertEquals("issue2236", pkg.getName());
