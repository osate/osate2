...
public class Issue2154Test {
	private static final String MODEL = "org.osate.ba.tests/models/issue2154/issue2154.aadl";

	@Inject
	private TestHelper<AadlPackage> testHelper;

	@Test
	public void testIssue2154() throws Exception {
		...
		assertEquals("issue2154", pkg.getName());
		var classifier = pkg.getPublicSection().getOwnedClassifiers().get(0);
		assertEquals("abst", classifier.getName());
