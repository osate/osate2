...
public class Issue2147Test {
	private static final String MODEL = "org.osate.ba.tests/models/issue2147/issue2147.aadl";

	@Inject
	private TestHelper<AadlPackage> testHelper;

	@Test
	public void testIssue2147() throws Exception {
		...
		assertEquals("issue2147", pkg.getName());
