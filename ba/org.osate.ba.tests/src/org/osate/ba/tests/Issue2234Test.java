...
public class Issue2234Test {
	private static final String MODEL = "org.osate.ba.tests/models/issue2234/issue2234.aadl";

	@Inject
	private TestHelper<AadlPackage> testHelper;

	@Test
	public void testIssue2234() throws Exception {
		...
		assertEquals("issue2234", pkg.getName());
		var classifier = pkg.getPublicSection().getOwnedClassifiers().get(1);
		assertEquals("spg", classifier.getName());
