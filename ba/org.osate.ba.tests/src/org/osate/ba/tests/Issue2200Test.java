...
public class Issue2200Test {
	private static final String MODEL = "org.osate.ba.tests/models/issue2200/issue2200.aadl";

	@Inject
	private TestHelper<AadlPackage> testHelper;

	@Test
	public void testIssue2200() throws Exception {
		...
		assertEquals("BA_example1", pkg.getName());
		var classifier = pkg.getPublicSection().getOwnedClassifiers().get(3);
		assertEquals("cube.ba", classifier.getName());
