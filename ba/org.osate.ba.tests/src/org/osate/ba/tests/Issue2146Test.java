...
public class Issue2146Test {
	private static final String MODEL = "org.osate.ba.tests/models/issue2146/issue2146.aadl";

	@Inject
	private TestHelper<AadlPackage> testHelper;

	@Test
	public void testIssue2146() throws Exception {
		...
		assertEquals("issue2146", pkg.getName());
		var classifier = pkg.getPublicSection().getOwnedClassifiers().get(3);
		assertEquals("threadA.impl", classifier.getName());
