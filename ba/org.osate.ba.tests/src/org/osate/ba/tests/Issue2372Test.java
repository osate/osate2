...
public class Issue2372Test {
	private static final String MODEL = "org.osate.ba.tests/models/issue2372/issue2372.aadl";

	@Inject
	private TestHelper<AadlPackage> testHelper;

	@Test
	public void testIssue2372() throws Exception {
		...
		assertEquals("test_lock_actions", pkg.getName());
		...
		var actions = (BehaviorActionCollection) strict.getActions().get(0).getContent();
		assertNotNull(((SharedDataAction) actions.getActions().get(1)).getDataAccess().getDataAccess());
		assertNotNull(((SharedDataAction) actions.getActions().get(3)).getDataAccess().getDataAccess());
