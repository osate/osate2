...
public class Issue2466Test {
	private static final String MODEL = "org.osate.ba.tests/models/issue2466/issue2466.aadl";

	@Inject
	private TestHelper<AadlPackage> testHelper;

	@Test
	public void testIssue2466() throws Exception {
		...
		assertEquals("issue2466", pkg.getName());
		var classifier = pkg.getPublicSection().getOwnedClassifiers().get(5);
