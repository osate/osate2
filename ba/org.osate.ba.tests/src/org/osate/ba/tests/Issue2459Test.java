...
public class Issue2459Test {
	private static final String MODEL = "org.osate.ba.tests/models/issue2459/issue2459.aadl";

	@Inject
	private TestHelper<AadlPackage> testHelper;

	@Test
	public void testIssue2459() throws Exception {
		...
		assertEquals("issue2459", pkg.getName());
		var classifier = pkg.getPublicSection().getOwnedClassifiers().getFirst();
