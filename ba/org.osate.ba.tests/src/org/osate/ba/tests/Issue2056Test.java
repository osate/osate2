...
public class Issue2056Test {
	private static final String MODEL = "org.osate.ba.tests/models/issue2056/issue2056.aadl";

	@Inject
	private TestHelper<AadlPackage> testHelper;

	@Test
	public void testIssue2056() throws Exception {
		...
		assertEquals("issue2056", pkg.getName());
