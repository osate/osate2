...
/**
 * This is the item provider adapter for a {@link org.osate.xtext.aadl2.ba.behaviorAnnex.AssignmentAction} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class AssignmentActionItemProvider extends BehaviorActionItemProvider
{
  /**
    ...
    itemPropertyDescriptors.add
      (createItemPropertyDescriptor
        (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
         getResourceLocator(),
         getString("_UI_AssignmentAction_any_feature"),
         getString("_UI_PropertyDescriptor_description", "_UI_AssignmentAction_any_feature", "_UI_AssignmentAction_type"),
         BehaviorAnnexPackage.Literals.ASSIGNMENT_ACTION__ANY,
         true,
         false,
         false,
  ...
  public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object)
  {
    if (childrenFeatures == null)
    {
      ...
      childrenFeatures.add(BehaviorAnnexPackage.Literals.ASSIGNMENT_ACTION__TARGET);
      childrenFeatures.add(BehaviorAnnexPackage.Literals.ASSIGNMENT_ACTION__VALUE);
    }
  ...
  {
    AssignmentAction assignmentAction = (AssignmentAction)object;
    return getString("_UI_AssignmentAction_type") + " " + assignmentAction.isAny();
  }
  ...
  protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object)
  {
    ...
    newChildDescriptors.add
      (createChildParameter
        (BehaviorAnnexPackage.Literals.ASSIGNMENT_ACTION__TARGET,
