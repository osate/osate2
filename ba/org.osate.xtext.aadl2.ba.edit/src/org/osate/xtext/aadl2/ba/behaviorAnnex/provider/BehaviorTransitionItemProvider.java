...
/**
 * This is the item provider adapter for a {@link org.osate.xtext.aadl2.ba.behaviorAnnex.BehaviorTransition} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
    ...
    IItemPropertySource
{
  ...
  public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object)
  {
    if (itemPropertyDescriptors == null)
    {
      ...
      addSourceStatesPropertyDescriptor(object);
    ...
    itemPropertyDescriptors.add
      (createItemPropertyDescriptor
        (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
         getResourceLocator(),
         getString("_UI_BehaviorTransition_name_feature"),
         getString("_UI_PropertyDescriptor_description", "_UI_BehaviorTransition_name_feature", "_UI_BehaviorTransition_type"),
         BehaviorAnnexPackage.Literals.BEHAVIOR_TRANSITION__NAME,
         true,
         false,
         false,
    ...
    itemPropertyDescriptors.add
      (createItemPropertyDescriptor
        (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
         ...
         BehaviorAnnexPackage.Literals.BEHAVIOR_TRANSITION__PRIORITY,
         true,
         false,
         false,
         ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
  ...
  /**
   * This adds a property descriptor for the Source States feature.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @generated
   */
  protected void addSourceStatesPropertyDescriptor(Object object)
  {
    itemPropertyDescriptors.add
      (createItemPropertyDescriptor
        (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
         getResourceLocator(),
         getString("_UI_BehaviorTransition_sourceStates_feature"),
         getString("_UI_PropertyDescriptor_description", "_UI_BehaviorTransition_sourceStates_feature", "_UI_BehaviorTransition_type"),
         BehaviorAnnexPackage.Literals.BEHAVIOR_TRANSITION__SOURCE_STATES,
         true,
         false,
         true,
         null,
    ...
    itemPropertyDescriptors.add
      (createItemPropertyDescriptor
        (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
         ...
         BehaviorAnnexPackage.Literals.BEHAVIOR_TRANSITION__DESTINATION_STATE,
         true,
         false,
         true,
         null,
  ...
  public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object)
  {
    if (childrenFeatures == null)
    {
      ...
      childrenFeatures.add(BehaviorAnnexPackage.Literals.BEHAVIOR_TRANSITION__CONDITION);
      childrenFeatures.add(BehaviorAnnexPackage.Literals.BEHAVIOR_TRANSITION__ACTION_BLOCK);
    }
  ...
  protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object)
  {
    ...
    newChildDescriptors.add
      (createChildParameter
        (BehaviorAnnexPackage.Literals.BEHAVIOR_TRANSITION__CONDITION,
         BehaviorAnnexFactory.eINSTANCE.createBehaviorCondition()));

    newChildDescriptors.add
      (createChildParameter
        (BehaviorAnnexPackage.Literals.BEHAVIOR_TRANSITION__ACTION_BLOCK,
