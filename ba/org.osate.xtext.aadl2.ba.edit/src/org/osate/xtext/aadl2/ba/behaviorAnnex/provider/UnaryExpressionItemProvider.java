...
/**
 * This is the item provider adapter for a {@link org.osate.xtext.aadl2.ba.behaviorAnnex.UnaryExpression} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class UnaryExpressionItemProvider extends ValueExpressionItemProvider
{
  /**
    ...
    itemPropertyDescriptors.add
      (createItemPropertyDescriptor
        (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
         ...
         BehaviorAnnexPackage.Literals.UNARY_EXPRESSION__OPERATOR,
         true,
         false,
         false,
  ...
  public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object)
  {
    if (childrenFeatures == null)
    {
      ...
      childrenFeatures.add(BehaviorAnnexPackage.Literals.UNARY_EXPRESSION__OPERAND);
    }
  ...
  {
    String label = ((UnaryExpression)object).getOperator();
