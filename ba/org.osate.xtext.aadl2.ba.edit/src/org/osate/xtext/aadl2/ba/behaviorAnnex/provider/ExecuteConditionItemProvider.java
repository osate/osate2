...
/**
 * This is the item provider adapter for a {@link org.osate.xtext.aadl2.ba.behaviorAnnex.ExecuteCondition} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
    ...
    IItemPropertySource
{
   ...
   * @generated
   */
  public ExecuteConditionItemProvider(AdapterFactory adapterFactory)
  {
    ...
    itemPropertyDescriptors.add
      (createItemPropertyDescriptor
        (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
         getResourceLocator(),
         getString("_UI_ExecuteCondition_timeout_feature"),
         getString("_UI_PropertyDescriptor_description", "_UI_ExecuteCondition_timeout_feature", "_UI_ExecuteCondition_type"),
         BehaviorAnnexPackage.Literals.EXECUTE_CONDITION__TIMEOUT,
         true,
         false,
         false,
  ...
  protected void addOtherwisePropertyDescriptor(Object object)
  {
    itemPropertyDescriptors.add
      (createItemPropertyDescriptor
        (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
         getResourceLocator(),
         getString("_UI_ExecuteCondition_otherwise_feature"),
         getString("_UI_PropertyDescriptor_description", "_UI_ExecuteCondition_otherwise_feature", "_UI_ExecuteCondition_type"),
         BehaviorAnnexPackage.Literals.EXECUTE_CONDITION__OTHERWISE,
         true,
         false,
         false,
         ItemPropertyDescriptor.BOOLEAN_VALUE_IMAGE,
  ...
  public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object)
  {
    if (childrenFeatures == null)
    {
      ...
      childrenFeatures.add(BehaviorAnnexPackage.Literals.EXECUTE_CONDITION__VALUE);
    }
  ...
  /**
   * This returns ExecuteCondition.gif.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @generated
   */
  ...
  {
    return overlayImage(object, getResourceLocator().getImage("full/obj16/ExecuteCondition"));
  }
  ...
  {
    ExecuteCondition executeCondition = (ExecuteCondition)object;
    return getString("_UI_ExecuteCondition_type") + " " + executeCondition.isTimeout();
  }
  ...
  public void notifyChanged(Notification notification)
  {
    ...
    switch (notification.getFeatureID(ExecuteCondition.class))
    {
  ...
  protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object)
  {
    ...
    newChildDescriptors.add
      (createChildParameter
        (BehaviorAnnexPackage.Literals.EXECUTE_CONDITION__VALUE,
