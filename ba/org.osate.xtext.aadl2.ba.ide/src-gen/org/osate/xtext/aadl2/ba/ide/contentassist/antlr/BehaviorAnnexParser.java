...
public class BehaviorAnnexParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, BehaviorAnnexGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getModeSwitchTriggerAccess().getAlternatives(), "rule__ModeSwitchTrigger__Alternatives");
			...
			builder.put(grammarAccess.getLogicalOrOperatorAccess().getAlternatives(), "rule__LogicalOrOperator__Alternatives");
			builder.put(grammarAccess.getRelationalOperatorAccess().getAlternatives(), "rule__RelationalOperator__Alternatives");
			builder.put(grammarAccess.getSimpleExpressionAccess().getAlternatives_0(), "rule__SimpleExpression__Alternatives_0");
			builder.put(grammarAccess.getUnaryAddingOperatorAccess().getAlternatives(), "rule__UnaryAddingOperator__Alternatives");
			builder.put(grammarAccess.getBinaryAddingOperatorAccess().getAlternatives(), "rule__BinaryAddingOperator__Alternatives");
			builder.put(grammarAccess.getMultiplyingOperatorAccess().getAlternatives(), "rule__MultiplyingOperator__Alternatives");
			builder.put(grammarAccess.getFactorAccess().getAlternatives(), "rule__Factor__Alternatives");
			builder.put(grammarAccess.getUnaryValueOperatorAccess().getAlternatives(), "rule__UnaryValueOperator__Alternatives");
			...
			builder.put(grammarAccess.getLogicalOrOperatorAccess().getGroup_0(), "rule__LogicalOrOperator__Group_0__0");
			builder.put(grammarAccess.getLogicalAndOperatorAccess().getGroup(), "rule__LogicalAndOperator__Group__0");
			...
			builder.put(grammarAccess.getSimpleExpressionAccess().getGroup_0_0(), "rule__SimpleExpression__Group_0_0__0");
			...
			builder.put(grammarAccess.getFactorAccess().getGroup_0_1(), "rule__Factor__Group_0_1__0");
			...
			builder.put(grammarAccess.getValueExpressionAccess().getOperatorAssignment_1_1(), "rule__ValueExpression__OperatorAssignment_1_1");
			builder.put(grammarAccess.getValueExpressionAccess().getRightAssignment_1_2(), "rule__ValueExpression__RightAssignment_1_2");
			...
			builder.put(grammarAccess.getSimpleExpressionAccess().getOperatorAssignment_0_0_1(), "rule__SimpleExpression__OperatorAssignment_0_0_1");
			builder.put(grammarAccess.getSimpleExpressionAccess().getOperandAssignment_0_0_2(), "rule__SimpleExpression__OperandAssignment_0_0_2");
			builder.put(grammarAccess.getSimpleExpressionAccess().getOperatorAssignment_1_1(), "rule__SimpleExpression__OperatorAssignment_1_1");
			builder.put(grammarAccess.getSimpleExpressionAccess().getRightAssignment_1_2(), "rule__SimpleExpression__RightAssignment_1_2");
			...
			builder.put(grammarAccess.getFactorAccess().getOperatorAssignment_0_1_1(), "rule__Factor__OperatorAssignment_0_1_1");
			builder.put(grammarAccess.getFactorAccess().getRightAssignment_0_1_2(), "rule__Factor__RightAssignment_0_1_2");
			builder.put(grammarAccess.getFactorAccess().getOperatorAssignment_1_1(), "rule__Factor__OperatorAssignment_1_1");
			builder.put(grammarAccess.getFactorAccess().getOperandAssignment_1_2(), "rule__Factor__OperandAssignment_1_2");
