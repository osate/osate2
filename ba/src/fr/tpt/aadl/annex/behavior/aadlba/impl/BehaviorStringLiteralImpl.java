...
import edu.cmu.sei.aadl.aadl2.impl.StringLiteralImpl ;
 ...
 * <ul>
 *   <li>{@link fr.tpt.aadl.annex.behavior.aadlba.impl.BehaviorStringLiteralImpl#getValue <em>Value</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class BehaviorStringLiteralImpl extends StringLiteralImpl implements BehaviorStringLiteral {
	...
	public void setValue(String newValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AadlBaPackage.BEHAVIOR_STRING_LITERAL__VALUE, oldValue, value));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case AadlBaPackage.BEHAVIOR_STRING_LITERAL__VALUE:
				return getValue();
		}
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		...
		if (baseClass == StringLiteral.class) {
			switch (derivedFeatureID) {
				case AadlBaPackage.BEHAVIOR_STRING_LITERAL__VALUE: return Aadl2Package.STRING_LITERAL__VALUE;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		...
		if (baseClass == StringLiteral.class) {
			switch (baseFeatureID) {
				case Aadl2Package.STRING_LITERAL__VALUE: return AadlBaPackage.BEHAVIOR_STRING_LITERAL__VALUE;
				default: return -1;
			}
		}
