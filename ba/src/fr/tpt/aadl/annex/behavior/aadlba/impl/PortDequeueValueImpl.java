 ...
 * <ul>
 *   <li>{@link fr.tpt.aadl.annex.behavior.aadlba.impl.PortDequeueValueImpl#getIdentifierOwned <em>Identifier Owned</em>}</li>
 *   <li>{@link fr.tpt.aadl.annex.behavior.aadlba.impl.PortDequeueValueImpl#getArrayIndexes <em>Array Indexes</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class PortDequeueValueImpl extends BehaviorElementImpl implements PortDequeueValue {
	/**
	...
	public NotificationChain basicSetIdentifierOwned(Identifier newIdentifierOwned, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, AadlBaPackage.PORT_DEQUEUE_VALUE__IDENTIFIER_OWNED, oldIdentifierOwned, newIdentifierOwned);
	...
	public void setIdentifierOwned(Identifier newIdentifierOwned) {
		if (newIdentifierOwned != identifierOwned) {
			...
			if (identifierOwned != null)
				msgs = ((InternalEObject)identifierOwned).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - AadlBaPackage.PORT_DEQUEUE_VALUE__IDENTIFIER_OWNED, null, msgs);
			if (newIdentifierOwned != null)
				msgs = ((InternalEObject)newIdentifierOwned).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - AadlBaPackage.PORT_DEQUEUE_VALUE__IDENTIFIER_OWNED, null, msgs);
			msgs = basicSetIdentifierOwned(newIdentifierOwned, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AadlBaPackage.PORT_DEQUEUE_VALUE__IDENTIFIER_OWNED, newIdentifierOwned, newIdentifierOwned));
	}
	...
	public EList<IntegerValueVariable> getArrayIndexes() {
		if (arrayIndexes == null) {
			arrayIndexes = new EObjectContainmentEList.Unsettable<IntegerValueVariable>(IntegerValueVariable.class, this, AadlBaPackage.PORT_DEQUEUE_VALUE__ARRAY_INDEXES);
		}
		return arrayIndexes;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case AadlBaPackage.PORT_DEQUEUE_VALUE__IDENTIFIER_OWNED:
				return basicSetIdentifierOwned(null, msgs);
			case AadlBaPackage.PORT_DEQUEUE_VALUE__ARRAY_INDEXES:
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		...
		if (baseClass == Name.class) {
			switch (derivedFeatureID) {
				case AadlBaPackage.PORT_DEQUEUE_VALUE__IDENTIFIER_OWNED: return AadlBaPackage.NAME__IDENTIFIER_OWNED;
				case AadlBaPackage.PORT_DEQUEUE_VALUE__ARRAY_INDEXES: return AadlBaPackage.NAME__ARRAY_INDEXES;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		...
		if (baseClass == Name.class) {
			switch (baseFeatureID) {
				case AadlBaPackage.NAME__IDENTIFIER_OWNED: return AadlBaPackage.PORT_DEQUEUE_VALUE__IDENTIFIER_OWNED;
				case AadlBaPackage.NAME__ARRAY_INDEXES: return AadlBaPackage.PORT_DEQUEUE_VALUE__ARRAY_INDEXES;
				default: return -1;
			}
		}
