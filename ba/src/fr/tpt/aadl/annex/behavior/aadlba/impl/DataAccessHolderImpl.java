 ...
 *   <li>{@link fr.tpt.aadl.annex.behavior.aadlba.impl.DataAccessHolderImpl#getArrayIndexes <em>Array Indexes</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class DataAccessHolderImpl extends DataHolderImpl implements DataAccessHolder
{
  ...
  public EList<IntegerValue> getArrayIndexes()
  {
    ...
    {
      arrayIndexes = new EObjectContainmentEList.Unsettable<IntegerValue>(IntegerValue.class, this, AadlBaPackage.DATA_ACCESS_HOLDER__ARRAY_INDEXES);
    }
    return arrayIndexes;
  }
