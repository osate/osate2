 ...
 * <ul>
 *   <li>{@link fr.tpt.aadl.annex.behavior.aadlba.impl.FactorImpl#getFirstValue <em>First Value</em>}</li>
 *   <li>{@link fr.tpt.aadl.annex.behavior.aadlba.impl.FactorImpl#getSecondValue <em>Second Value</em>}</li>
 *   <li>{@link fr.tpt.aadl.annex.behavior.aadlba.impl.FactorImpl#getBinaryNumericOperator <em>Binary Numeric Operator</em>}</li>
 *   <li>{@link fr.tpt.aadl.annex.behavior.aadlba.impl.FactorImpl#getUnaryNumericOperator <em>Unary Numeric Operator</em>}</li>
 *   <li>{@link fr.tpt.aadl.annex.behavior.aadlba.impl.FactorImpl#getUnaryBooleanOperator <em>Unary Boolean Operator</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
