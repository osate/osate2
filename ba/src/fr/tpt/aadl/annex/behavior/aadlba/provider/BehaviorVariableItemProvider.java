...
/**
 * This is the item provider adapter for a {@link fr.tpt.aadl.annex.behavior.aadlba.BehaviorVariable} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
    ...
    itemPropertyDescriptors.add
      (createItemPropertyDescriptor
        (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
         getResourceLocator(),
         getString("_UI_BehaviorVariable_dataClassifier_feature"),
         getString("_UI_PropertyDescriptor_description", "_UI_BehaviorVariable_dataClassifier_feature", "_UI_BehaviorVariable_type"),
         AadlBaPackage.Literals.BEHAVIOR_VARIABLE__DATA_CLASSIFIER,
         true,
         false,
         true,
         null,
