...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Port Holder</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link fr.tpt.aadl.annex.behavior.aadlba.impl.PortHolderImpl#getArrayIndexes <em>Array Indexes</em>}</li>
 *   <li>{@link fr.tpt.aadl.annex.behavior.aadlba.impl.PortHolderImpl#getElement <em>Element</em>}</li>
 *   <li>{@link fr.tpt.aadl.annex.behavior.aadlba.impl.PortHolderImpl#getGroupHolders <em>Group Holders</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public abstract class PortHolderImpl extends BehaviorElementImpl implements PortHolder
{
  ...
  {
		return AadlBaPackage.Literals.PORT_HOLDER;
	}
  ...
  public EList<IntegerValue> getArrayIndexes()
  {
		if (arrayIndexes == null) {
			arrayIndexes = new EObjectContainmentEList.Unsettable<IntegerValue>(IntegerValue.class, this, AadlBaPackage.PORT_HOLDER__ARRAY_INDEXES);
		}
		return arrayIndexes;
	}
		...
		if (element != null && ((EObject)element).eIsProxy()) {
			...
			if (element != oldElement) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, AadlBaPackage.PORT_HOLDER__ELEMENT, oldElement, element));
			}
		}
		return element;
	}
  ...
  public void setElement(NamedElement newElement)
  {
		...
		element = newElement;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AadlBaPackage.PORT_HOLDER__ELEMENT, oldElement, element));
	}
  ...
  public EList<GroupHolder> getGroupHolders()
  {
		if (groupHolders == null) {
			groupHolders = new EObjectContainmentEList.Unsettable<GroupHolder>(GroupHolder.class, this, AadlBaPackage.PORT_HOLDER__GROUP_HOLDERS);
		}
		return groupHolders;
	}
