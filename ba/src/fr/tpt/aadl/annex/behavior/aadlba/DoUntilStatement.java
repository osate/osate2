 ...
 * <ul>
 *   <li>{@link fr.tpt.aadl.annex.behavior.aadlba.DoUntilStatement#getBehaviorActionsOwned <em>Behavior Actions Owned</em>}</li>
 ...
 * @generated
 */
public interface DoUntilStatement extends CondStatement
{
   /**
    ...
    * @see fr.tpt.aadl.annex.behavior.aadlba.AadlBaPackage#getDoUntilStatement_BehaviorActionsOwned()
   ...
   /**
    * Sets the value of the '{@link fr.tpt.aadl.annex.behavior.aadlba.DoUntilStatement#getBehaviorActionsOwned <em>Behavior Actions Owned</em>}' containment reference.
    * <!-- begin-user-doc -->
    * <!-- end-user-doc -->
   ...
   /**
    * Unsets the value of the '{@link fr.tpt.aadl.annex.behavior.aadlba.DoUntilStatement#getBehaviorActionsOwned <em>Behavior Actions Owned</em>}' containment reference.
    * <!-- begin-user-doc -->
    * <!-- end-user-doc -->
    * @see #isSetBehaviorActionsOwned()
    * @see #getBehaviorActionsOwned()
   ...
   /**
    * Returns whether the value of the '{@link fr.tpt.aadl.annex.behavior.aadlba.DoUntilStatement#getBehaviorActionsOwned <em>Behavior Actions Owned</em>}' containment reference is set.
    * <!-- begin-user-doc -->
    * <!-- end-user-doc -->
