 ...
 * <ul>
 *   <li>{@link fr.tpt.aadl.annex.behavior.aadlba.impl.BehaviorActionSetImpl#getBehaviorActions <em>Behavior Actions</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class BehaviorActionSetImpl extends ElementImpl implements BehaviorActionSet {
	/**
	...
	public EList<BehaviorAction> getBehaviorActions() {
		if (behaviorActions == null) {
			behaviorActions = new EObjectContainmentEList.Unsettable<BehaviorAction>(BehaviorAction.class, this, AadlBaPackage.BEHAVIOR_ACTION_SET__BEHAVIOR_ACTIONS);
		}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case AadlBaPackage.BEHAVIOR_ACTION_SET__BEHAVIOR_ACTIONS:
