...
/**
 * This is the item provider adapter for a {@link fr.tpt.aadl.annex.behavior.aadlba.WhileOrDoUntilStatement} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class WhileOrDoUntilStatementItemProvider
    ...
    itemPropertyDescriptors.add
      (createItemPropertyDescriptor
        (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
         getResourceLocator(),
         getString("_UI_WhileOrDoUntilStatement_doUntil_feature"),
         getString("_UI_PropertyDescriptor_description", "_UI_WhileOrDoUntilStatement_doUntil_feature", "_UI_WhileOrDoUntilStatement_type"),
         AadlBaPackage.Literals.WHILE_OR_DO_UNTIL_STATEMENT__DO_UNTIL,
         true,
         false,
         false,
  ...
  protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object)
  {
    ...
    newChildDescriptors.add
      (createChildParameter
        (AadlBaPackage.Literals.WHILE_OR_DO_UNTIL_STATEMENT__LOGICAL_VALUE_EXPRESSION,
