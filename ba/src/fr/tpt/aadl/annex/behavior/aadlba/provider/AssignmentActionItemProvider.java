...
/**
 * This is the item provider adapter for a {@link fr.tpt.aadl.annex.behavior.aadlba.AssignmentAction} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class AssignmentActionItemProvider
    ...
    IItemPropertySource
{
   ...
   * @generated
   */
  public AssignmentActionItemProvider(AdapterFactory adapterFactory)
  {
  ...
  public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object)
  {
    if (childrenFeatures == null)
    {
      ...
      childrenFeatures.add(AadlBaPackage.Literals.ASSIGNMENT_ACTION__TARGET);
      childrenFeatures.add(AadlBaPackage.Literals.ASSIGNMENT_ACTION__VALUE_EXPRESSION);
    }
  ...
  /**
   * This returns AssignmentAction.gif.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @generated
   */
  ...
  {
    return overlayImage(object, getResourceLocator().getImage("full/obj16/AssignmentAction"));
  }
  ...
  {
    return getString("_UI_AssignmentAction_type");
  }
  ...
  public void notifyChanged(Notification notification)
  {
    ...
    switch (notification.getFeatureID(AssignmentAction.class))
    {
  ...
  protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object)
  {
    ...
    newChildDescriptors.add
      (createChildParameter
        (AadlBaPackage.Literals.ASSIGNMENT_ACTION__TARGET,
    ...
    newChildDescriptors.add
      (createChildParameter
        (AadlBaPackage.Literals.ASSIGNMENT_ACTION__VALUE_EXPRESSION,
