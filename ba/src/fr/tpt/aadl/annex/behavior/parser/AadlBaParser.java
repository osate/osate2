...
public class AadlBaParser extends Parser {
    ...
    */  
    ...
    // AadlBa.g:387:1: behavior_annex returns [BehaviorAnnex BehAnnex] : (keyword= VARIABLES (lbv= behavior_variable_list[BehAnnex] )+ )? ( STATES (lbs= behavior_state_list )+ )? ( TRANSITIONS (BehTrans= behavior_transition )+ )? ;
    public final BehaviorAnnex behavior_annex() throws RecognitionException {
        ...
        try {
            // AadlBa.g:398:3: ( (keyword= VARIABLES (lbv= behavior_variable_list[BehAnnex] )+ )? ( STATES (lbs= behavior_state_list )+ )? ( TRANSITIONS (BehTrans= behavior_transition )+ )? )
            // AadlBa.g:399:4: (keyword= VARIABLES (lbv= behavior_variable_list[BehAnnex] )+ )? ( STATES (lbs= behavior_state_list )+ )? ( TRANSITIONS (BehTrans= behavior_transition )+ )?
            {
            ...
            // AadlBa.g:403:4: ( STATES (lbs= behavior_state_list )+ )?
            int alt4=2;
            ...
            switch (alt4) {
                case 1 :
                    // AadlBa.g:403:6: STATES (lbs= behavior_state_list )+
                    {
            ...
            // AadlBa.g:407:4: ( TRANSITIONS (BehTrans= behavior_transition )+ )?
            int alt6=2;
            ...
            switch (alt6) {
                case 1 :
                    // AadlBa.g:407:6: TRANSITIONS (BehTrans= behavior_transition )+
                    {
    ...
    // AadlBa.g:555:1: behavior_state_list returns [List<BehaviorState> lbs] : identifier= IDENT ( COMMA identifier= IDENT )* COLON ( (keyword= INITIAL )? (keyword= COMPLETE )? (keyword= FINAL )? ) STATE SEMICOLON ;
    public final List<BehaviorState> behavior_state_list() throws RecognitionException {
        ...
        try {
            // AadlBa.g:559:3: (identifier= IDENT ( COMMA identifier= IDENT )* COLON ( (keyword= INITIAL )? (keyword= COMPLETE )? (keyword= FINAL )? ) STATE SEMICOLON )
            // AadlBa.g:560:5: identifier= IDENT ( COMMA identifier= IDENT )* COLON ( (keyword= INITIAL )? (keyword= COMPLETE )? (keyword= FINAL )? ) STATE SEMICOLON
            {
            ...
            // AadlBa.g:576:4: ( (keyword= INITIAL )? (keyword= COMPLETE )? (keyword= FINAL )? )
            // AadlBa.g:577:6: (keyword= INITIAL )? (keyword= COMPLETE )? (keyword= FINAL )?
            {
            // AadlBa.g:577:6: (keyword= INITIAL )?
            int alt12=2;
            ...
            switch (alt12) {
                case 1 :
                    // AadlBa.g:577:7: keyword= INITIAL
                    {
            ...
            // AadlBa.g:583:6: (keyword= COMPLETE )?
            int alt13=2;
            ...
            switch (alt13) {
                case 1 :
                    // AadlBa.g:583:7: keyword= COMPLETE
                    {
    ...
    // AadlBa.g:614:1: behavior_transition returns [DeclarativeBehaviorTransition BehTrans] : (identifier= IDENT ( LBRACK Num= numeral RBRACK )? COLON )? identifier= IDENT ( COMMA identifier= IDENT )* (identifier= LTRANS BehCond= behavior_condition RTRANS ) identifier= IDENT (BehActionBlock= behavior_action_block )? SEMICOLON ;
    public final DeclarativeBehaviorTransition behavior_transition() throws RecognitionException {
        ...
        try {
            // AadlBa.g:619:3: ( (identifier= IDENT ( LBRACK Num= numeral RBRACK )? COLON )? identifier= IDENT ( COMMA identifier= IDENT )* (identifier= LTRANS BehCond= behavior_condition RTRANS ) identifier= IDENT (BehActionBlock= behavior_action_block )? SEMICOLON )
            // AadlBa.g:620:4: (identifier= IDENT ( LBRACK Num= numeral RBRACK )? COLON )? identifier= IDENT ( COMMA identifier= IDENT )* (identifier= LTRANS BehCond= behavior_condition RTRANS ) identifier= IDENT (BehActionBlock= behavior_action_block )? SEMICOLON
            {
            // AadlBa.g:620:4: (identifier= IDENT ( LBRACK Num= numeral RBRACK )? COLON )?
            int alt16=2;
            ...
            switch (alt16) {
                case 1 :
                    // AadlBa.g:620:6: identifier= IDENT ( LBRACK Num= numeral RBRACK )? COLON
                    {
                    ...
                    // AadlBa.g:625:6: ( LBRACK Num= numeral RBRACK )?
                    int alt15=2;
                    ...
                    switch (alt15) {
                        case 1 :
                            // AadlBa.g:625:8: LBRACK Num= numeral RBRACK
                            {
            ...
            // AadlBa.g:642:4: ( COMMA identifier= IDENT )*
            loop17:
            do {
                int alt17=2;
                ...
                switch (alt17) {
            	case 1 :
            	    // AadlBa.g:642:6: COMMA identifier= IDENT
            	    {
            ...
            // AadlBa.g:651:4: (identifier= LTRANS BehCond= behavior_condition RTRANS )
            // AadlBa.g:651:6: identifier= LTRANS BehCond= behavior_condition RTRANS
            {
            ...
            // AadlBa.g:671:4: (BehActionBlock= behavior_action_block )?
            int alt18=2;
            ...
            switch (alt18) {
                case 1 :
                    // AadlBa.g:671:6: BehActionBlock= behavior_action_block
                    {
    ...
    // AadlBa.g:688:1: behavior_action_block returns [BehaviorActionBlock BehActionBlock] : identifier= LCURLY BehActions= behavior_actions RCURLY ( TIMEOUT BehTime= behavior_time )? ;
    public final BehaviorActionBlock behavior_action_block() throws RecognitionException {
        ...
        try {
            // AadlBa.g:692:3: (identifier= LCURLY BehActions= behavior_actions RCURLY ( TIMEOUT BehTime= behavior_time )? )
            // AadlBa.g:692:5: identifier= LCURLY BehActions= behavior_actions RCURLY ( TIMEOUT BehTime= behavior_time )?
            {
            ...
            // AadlBa.g:699:5: ( TIMEOUT BehTime= behavior_time )?
            int alt19=2;
            ...
            switch (alt19) {
                case 1 :
                    // AadlBa.g:699:7: TIMEOUT BehTime= behavior_time
                    {
    ...
    // AadlBa.g:714:1: behavior_condition returns [BehaviorCondition BehCond] : (pos= ON DisCond= dispatch_condition | (ExecCond= execute_condition )? ) ;
    public final BehaviorCondition behavior_condition() throws RecognitionException {
        ...
        try {
            // AadlBa.g:717:3: ( (pos= ON DisCond= dispatch_condition | (ExecCond= execute_condition )? ) )
            // AadlBa.g:718:4: (pos= ON DisCond= dispatch_condition | (ExecCond= execute_condition )? )
            {
            // AadlBa.g:718:4: (pos= ON DisCond= dispatch_condition | (ExecCond= execute_condition )? )
            int alt21=2;
            ...
            switch (alt21) {
                case 1 :
                    // AadlBa.g:719:8: pos= ON DisCond= dispatch_condition
                    {
                    ...
                    break;
                case 2 :
                    // AadlBa.g:724:8: (ExecCond= execute_condition )?
                    {
                    // AadlBa.g:724:8: (ExecCond= execute_condition )?
                    int alt20=2;
                    ...
                    switch (alt20) {
                        case 1 :
                            // AadlBa.g:724:9: ExecCond= execute_condition
                            {
    ...
    // AadlBa.g:753:1: execute_condition returns [ExecuteCondition ExecCond] : (identifier= TIMEOUT |identifier= OTHERWISE |ValExpr= value_expression ) ;
    public final ExecuteCondition execute_condition() throws RecognitionException {
        ...
        try {
            // AadlBa.g:758:3: ( (identifier= TIMEOUT |identifier= OTHERWISE |ValExpr= value_expression ) )
            // AadlBa.g:759:4: (identifier= TIMEOUT |identifier= OTHERWISE |ValExpr= value_expression )
            {
            // AadlBa.g:759:4: (identifier= TIMEOUT |identifier= OTHERWISE |ValExpr= value_expression )
            int alt22=3;
            switch ( input.LA(1) ) {
            ...
            switch (alt22) {
                case 1 :
                    // AadlBa.g:760:8: identifier= TIMEOUT
                    {
                    ...
                    break;
                case 2 :
                    // AadlBa.g:766:8: identifier= OTHERWISE
                    {
                    ...
                    break;
                case 3 :
                    // AadlBa.g:772:8: ValExpr= value_expression
                    {
    ...
    // AadlBa.g:784:1: integer_value_constant returns [IntegerValueConstant ivc] : (il= integer_literal |prop= property );
    public final IntegerValueConstant integer_value_constant() throws RecognitionException {
        ...
        try {
            // AadlBa.g:786:2: (il= integer_literal |prop= property )
            int alt23=2;
            ...
            switch (alt23) {
                case 1 :
                    // AadlBa.g:787:6: il= integer_literal
                    {
    ...
    // AadlBa.g:816:1: dispatch_condition returns [DispatchCondition DisCond] : DISPATCH (DisTriggCond= dispatch_trigger_condition )? ( FROZEN port= reference ( COMMA port= reference )* )? ;
    public final DispatchCondition dispatch_condition() throws RecognitionException {
        ...
        try {
            // AadlBa.g:821:3: ( DISPATCH (DisTriggCond= dispatch_trigger_condition )? ( FROZEN port= reference ( COMMA port= reference )* )? )
            // AadlBa.g:822:4: DISPATCH (DisTriggCond= dispatch_trigger_condition )? ( FROZEN port= reference ( COMMA port= reference )* )?
            {
            match(input,DISPATCH,FOLLOW_DISPATCH_in_dispatch_condition2396); if (state.failed) return DisCond;

            // AadlBa.g:823:4: (DisTriggCond= dispatch_trigger_condition )?
            int alt24=2;
            ...
            switch (alt24) {
                case 1 :
                    // AadlBa.g:823:6: DisTriggCond= dispatch_trigger_condition
                    {
            ...
            // AadlBa.g:829:4: ( FROZEN port= reference ( COMMA port= reference )* )?
            int alt26=2;
            ...
            switch (alt26) {
                case 1 :
                    // AadlBa.g:829:6: FROZEN port= reference ( COMMA port= reference )*
                    {
                    ...
                    // AadlBa.g:833:6: ( COMMA port= reference )*
                    loop25:
                    do {
                        int alt25=2;
                        ...
                        switch (alt25) {
                    	case 1 :
                    	    // AadlBa.g:833:8: COMMA port= reference
                    	    {
    ...
    // AadlBa.g:858:1: dispatch_trigger_condition returns [DispatchTriggerCondition DisTriggCond] : (identifier= STOP | (identifier= TIMEOUT (BehTime= behavior_time )? ) |DisTriggLogicalExpr= dispatch_trigger_logical_expression );
    public final DispatchTriggerCondition dispatch_trigger_condition() throws RecognitionException {
        ...
        try {
            // AadlBa.g:862:4: (identifier= STOP | (identifier= TIMEOUT (BehTime= behavior_time )? ) |DisTriggLogicalExpr= dispatch_trigger_logical_expression )
            int alt28=3;
            switch ( input.LA(1) ) {
            case STOP:
                {
            ...
            switch (alt28) {
                case 1 :
                    // AadlBa.g:868:8: identifier= STOP
                    {
                    ...
                    break;
                case 2 :
                    // AadlBa.g:873:8: (identifier= TIMEOUT (BehTime= behavior_time )? )
                    {
                    // AadlBa.g:873:8: (identifier= TIMEOUT (BehTime= behavior_time )? )
                    // AadlBa.g:873:10: identifier= TIMEOUT (BehTime= behavior_time )?
                    {
                    ...
                    // AadlBa.g:877:10: (BehTime= behavior_time )?
                    int alt27=2;
                    ...
                    switch (alt27) {
                        case 1 :
                            // AadlBa.g:878:12: BehTime= behavior_time
                            {
                    ...
                    break;
                case 3 :
                    // AadlBa.g:885:8: DisTriggLogicalExpr= dispatch_trigger_logical_expression
                    {
    ...
    // AadlBa.g:898:1: dispatch_trigger_logical_expression returns [DispatchTriggerLogicalExpression\n DisTriggLogicalExpr] : DisConjunct= dispatch_conjunction ( OR DisConjunct= dispatch_conjunction )* ;
    public final DispatchTriggerLogicalExpression dispatch_trigger_logical_expression() throws RecognitionException {
        ...
        try {
            // AadlBa.g:903:4: (DisConjunct= dispatch_conjunction ( OR DisConjunct= dispatch_conjunction )* )
            // AadlBa.g:904:6: DisConjunct= dispatch_conjunction ( OR DisConjunct= dispatch_conjunction )*
            {
            ...
            // AadlBa.g:910:6: ( OR DisConjunct= dispatch_conjunction )*
            loop29:
            do {
                int alt29=2;
                ...
                switch (alt29) {
            	case 1 :
            	    // AadlBa.g:911:8: OR DisConjunct= dispatch_conjunction
            	    {
    ...
    // AadlBa.g:929:1: dispatch_conjunction returns [DispatchConjunction DisConjunct] : ref= reference (keyword= AND ref= reference )* ;
    public final DispatchConjunction dispatch_conjunction() throws RecognitionException {
        ...
        try {
            // AadlBa.g:934:4: (ref= reference (keyword= AND ref= reference )* )
            // AadlBa.g:935:6: ref= reference (keyword= AND ref= reference )*
            {
            ...
            // AadlBa.g:940:6: (keyword= AND ref= reference )*
            loop30:
            do {
                int alt30=2;
                ...
                switch (alt30) {
            	case 1 :
            	    // AadlBa.g:941:8: keyword= AND ref= reference
            	    {
    ...
    // AadlBa.g:974:1: behavior_actions returns [BehaviorActions BehActs] : BehAction= behavior_action ( ( SEMICOLON BehAction2= behavior_action )* | ( CONCAT BehAction2= behavior_action )* ) ;
    public final BehaviorActions behavior_actions() throws RecognitionException {
        ...
        try {
            // AadlBa.g:980:3: (BehAction= behavior_action ( ( SEMICOLON BehAction2= behavior_action )* | ( CONCAT BehAction2= behavior_action )* ) )
            // AadlBa.g:981:4: BehAction= behavior_action ( ( SEMICOLON BehAction2= behavior_action )* | ( CONCAT BehAction2= behavior_action )* )
            {
            ...
            // AadlBa.g:986:4: ( ( SEMICOLON BehAction2= behavior_action )* | ( CONCAT BehAction2= behavior_action )* )
            int alt33=2;
            switch ( input.LA(1) ) {
            case SEMICOLON:
                {
            ...
            switch (alt33) {
                case 1 :
                    // AadlBa.g:987:9: ( SEMICOLON BehAction2= behavior_action )*
                    {
                    // AadlBa.g:987:9: ( SEMICOLON BehAction2= behavior_action )*
                    loop31:
                    do {
                        ...
                        switch (alt31) {
                    	case 1 :
                    	    // AadlBa.g:987:11: SEMICOLON BehAction2= behavior_action
                    	    {
                    ...
                    break;
                case 2 :
                    // AadlBa.g:994:9: ( CONCAT BehAction2= behavior_action )*
                    {
                    // AadlBa.g:994:9: ( CONCAT BehAction2= behavior_action )*
                    loop32:
                    do {
                        ...
                        switch (alt32) {
                    	case 1 :
                    	    // AadlBa.g:994:11: CONCAT BehAction2= behavior_action
                    	    {
    ...
    public final BehaviorAction behavior_action() throws RecognitionException {
        ...
        try {
            // AadlBa.g:1040:3: ( ( (BaAct= basic_action ) | (BehActionBlock= behavior_action_block ) | (identifier1= IF identifier2= LPAREN ValExpr= value_expression RPAREN BehActions= behavior_actions (identifier1= ELSIF identifier2= LPAREN ValExpr= value_expression RPAREN BehActions= behavior_actions )* (identifier= ELSE BehActions= behavior_actions )? END IF ) | (identifier= FOR LPAREN identifier= IDENT COLON dt= unique_component_classifier_reference IN EltVal= element_values RPAREN identifier= LCURLY BehActions= behavior_actions RCURLY ) | (identifier= FORALL LPAREN identifier= IDENT COLON dt= unique_component_classifier_reference IN EltVal= element_values RPAREN identifier= LCURLY BehActions= behavior_actions RCURLY ) | (identifier1= WHILE identifier2= LPAREN ValExpr= value_expression RPAREN LCURLY BehActions= behavior_actions RCURLY ) | (identifier1= DO BehActions= behavior_actions UNTIL identifier2= LPAREN ValExpr= value_expression RPAREN ) ) )
            // AadlBa.g:1041:4: ( (BaAct= basic_action ) | (BehActionBlock= behavior_action_block ) | (identifier1= IF identifier2= LPAREN ValExpr= value_expression RPAREN BehActions= behavior_actions (identifier1= ELSIF identifier2= LPAREN ValExpr= value_expression RPAREN BehActions= behavior_actions )* (identifier= ELSE BehActions= behavior_actions )? END IF ) | (identifier= FOR LPAREN identifier= IDENT COLON dt= unique_component_classifier_reference IN EltVal= element_values RPAREN identifier= LCURLY BehActions= behavior_actions RCURLY ) | (identifier= FORALL LPAREN identifier= IDENT COLON dt= unique_component_classifier_reference IN EltVal= element_values RPAREN identifier= LCURLY BehActions= behavior_actions RCURLY ) | (identifier1= WHILE identifier2= LPAREN ValExpr= value_expression RPAREN LCURLY BehActions= behavior_actions RCURLY ) | (identifier1= DO BehActions= behavior_actions UNTIL identifier2= LPAREN ValExpr= value_expression RPAREN ) )
            {
            // AadlBa.g:1041:4: ( (BaAct= basic_action ) | (BehActionBlock= behavior_action_block ) | (identifier1= IF identifier2= LPAREN ValExpr= value_expression RPAREN BehActions= behavior_actions (identifier1= ELSIF identifier2= LPAREN ValExpr= value_expression RPAREN BehActions= behavior_actions )* (identifier= ELSE BehActions= behavior_actions )? END IF ) | (identifier= FOR LPAREN identifier= IDENT COLON dt= unique_component_classifier_reference IN EltVal= element_values RPAREN identifier= LCURLY BehActions= behavior_actions RCURLY ) | (identifier= FORALL LPAREN identifier= IDENT COLON dt= unique_component_classifier_reference IN EltVal= element_values RPAREN identifier= LCURLY BehActions= behavior_actions RCURLY ) | (identifier1= WHILE identifier2= LPAREN ValExpr= value_expression RPAREN LCURLY BehActions= behavior_actions RCURLY ) | (identifier1= DO BehActions= behavior_actions UNTIL identifier2= LPAREN ValExpr= value_expression RPAREN ) )
            int alt36=7;
            switch ( input.LA(1) ) {
            ...
            switch (alt36) {
                case 1 :
                    // AadlBa.g:1042:6: (BaAct= basic_action )
                    {
                    // AadlBa.g:1042:6: (BaAct= basic_action )
                    // AadlBa.g:1042:8: BaAct= basic_action
                    {
                    ...
                    break;
                case 2 :
                    // AadlBa.g:1046:6: (BehActionBlock= behavior_action_block )
                    {
                    // AadlBa.g:1046:6: (BehActionBlock= behavior_action_block )
                    // AadlBa.g:1046:8: BehActionBlock= behavior_action_block
                    {
                    ...
                    break;
                case 3 :
                    // AadlBa.g:1053:6: (identifier1= IF identifier2= LPAREN ValExpr= value_expression RPAREN BehActions= behavior_actions (identifier1= ELSIF identifier2= LPAREN ValExpr= value_expression RPAREN BehActions= behavior_actions )* (identifier= ELSE BehActions= behavior_actions )? END IF )
                    {
                    // AadlBa.g:1053:6: (identifier1= IF identifier2= LPAREN ValExpr= value_expression RPAREN BehActions= behavior_actions (identifier1= ELSIF identifier2= LPAREN ValExpr= value_expression RPAREN BehActions= behavior_actions )* (identifier= ELSE BehActions= behavior_actions )? END IF )
                    // AadlBa.g:1053:8: identifier1= IF identifier2= LPAREN ValExpr= value_expression RPAREN BehActions= behavior_actions (identifier1= ELSIF identifier2= LPAREN ValExpr= value_expression RPAREN BehActions= behavior_actions )* (identifier= ELSE BehActions= behavior_actions )? END IF
                    {
                    ...
                    // AadlBa.g:1062:8: (identifier1= ELSIF identifier2= LPAREN ValExpr= value_expression RPAREN BehActions= behavior_actions )*
                    loop34:
                    do {
                        int alt34=2;
                        ...
                        switch (alt34) {
                    	case 1 :
                    	    // AadlBa.g:1063:10: identifier1= ELSIF identifier2= LPAREN ValExpr= value_expression RPAREN BehActions= behavior_actions
                    	    {
                    ...
                    // AadlBa.g:1077:8: (identifier= ELSE BehActions= behavior_actions )?
                    int alt35=2;
                    ...
                    switch (alt35) {
                        case 1 :
                            // AadlBa.g:1078:10: identifier= ELSE BehActions= behavior_actions
                            {
                    ...
                    break;
                case 4 :
                    // AadlBa.g:1093:6: (identifier= FOR LPAREN identifier= IDENT COLON dt= unique_component_classifier_reference IN EltVal= element_values RPAREN identifier= LCURLY BehActions= behavior_actions RCURLY )
                    {
                    // AadlBa.g:1093:6: (identifier= FOR LPAREN identifier= IDENT COLON dt= unique_component_classifier_reference IN EltVal= element_values RPAREN identifier= LCURLY BehActions= behavior_actions RCURLY )
                    // AadlBa.g:1093:8: identifier= FOR LPAREN identifier= IDENT COLON dt= unique_component_classifier_reference IN EltVal= element_values RPAREN identifier= LCURLY BehActions= behavior_actions RCURLY
                    {
                    ...
                    break;
                case 5 :
                    // AadlBa.g:1116:6: (identifier= FORALL LPAREN identifier= IDENT COLON dt= unique_component_classifier_reference IN EltVal= element_values RPAREN identifier= LCURLY BehActions= behavior_actions RCURLY )
                    {
                    // AadlBa.g:1116:6: (identifier= FORALL LPAREN identifier= IDENT COLON dt= unique_component_classifier_reference IN EltVal= element_values RPAREN identifier= LCURLY BehActions= behavior_actions RCURLY )
                    // AadlBa.g:1116:8: identifier= FORALL LPAREN identifier= IDENT COLON dt= unique_component_classifier_reference IN EltVal= element_values RPAREN identifier= LCURLY BehActions= behavior_actions RCURLY
                    {
                    ...
                    break;
                case 6 :
                    // AadlBa.g:1141:6: (identifier1= WHILE identifier2= LPAREN ValExpr= value_expression RPAREN LCURLY BehActions= behavior_actions RCURLY )
                    {
                    // AadlBa.g:1141:6: (identifier1= WHILE identifier2= LPAREN ValExpr= value_expression RPAREN LCURLY BehActions= behavior_actions RCURLY )
                    // AadlBa.g:1141:8: identifier1= WHILE identifier2= LPAREN ValExpr= value_expression RPAREN LCURLY BehActions= behavior_actions RCURLY
                    {
                    ...
                    break;
                case 7 :
                    // AadlBa.g:1155:6: (identifier1= DO BehActions= behavior_actions UNTIL identifier2= LPAREN ValExpr= value_expression RPAREN )
                    {
                    // AadlBa.g:1155:6: (identifier1= DO BehActions= behavior_actions UNTIL identifier2= LPAREN ValExpr= value_expression RPAREN )
                    // AadlBa.g:1155:8: identifier1= DO BehActions= behavior_actions UNTIL identifier2= LPAREN ValExpr= value_expression RPAREN
                    {
    ...
    // AadlBa.g:1179:1: element_values returns [ElementValues EltVal] : ( (IntRange= integer_range ) | (AdcRef= reference ) );
    public final ElementValues element_values() throws RecognitionException {
        ...
        try {
            // AadlBa.g:1182:3: ( (IntRange= integer_range ) | (AdcRef= reference ) )
            int alt37=2;
            ...
            switch (alt37) {
                case 1 :
                    // AadlBa.g:1183:6: (IntRange= integer_range )
                    {
                    // AadlBa.g:1183:6: (IntRange= integer_range )
                    // AadlBa.g:1183:8: IntRange= integer_range
                    {
                    ...
                    break;
                case 2 :
                    // AadlBa.g:1185:6: (AdcRef= reference )
                    {
                    // AadlBa.g:1185:6: (AdcRef= reference )
                    // AadlBa.g:1185:8: AdcRef= reference
                    {
    ...
    // AadlBa.g:1198:1: basic_action returns [BasicAction BaAction] : ( (AssAct= assignment_action ) | (CommAct= communication_action ) | (TimedAct= timed_action ) );
    public final BasicAction basic_action() throws RecognitionException {
        ...
        try {
            // AadlBa.g:1201:3: ( (AssAct= assignment_action ) | (CommAct= communication_action ) | (TimedAct= timed_action ) )
            int alt38=3;
            switch ( input.LA(1) ) {
            case IDENT:
                {
            ...
            switch (alt38) {
                case 1 :
                    // AadlBa.g:1202:6: (AssAct= assignment_action )
                    {
                    // AadlBa.g:1202:6: (AssAct= assignment_action )
                    // AadlBa.g:1202:8: AssAct= assignment_action
                    {
                    ...
                    break;
                case 2 :
                    // AadlBa.g:1204:6: (CommAct= communication_action )
                    {
                    // AadlBa.g:1204:6: (CommAct= communication_action )
                    // AadlBa.g:1204:8: CommAct= communication_action
                    {
                    ...
                    break;
                case 3 :
                    // AadlBa.g:1206:6: (TimedAct= timed_action )
                    {
                    // AadlBa.g:1206:6: (TimedAct= timed_action )
                    // AadlBa.g:1206:8: TimedAct= timed_action
                    {
    ...
    // AadlBa.g:1218:1: assignment_action returns [AssignmentAction AssAct] : Tar= target ASSIGN (ValExpr= value_expression |identifier= ANY ) ;
    public final AssignmentAction assignment_action() throws RecognitionException {
        ...
        try {
            // AadlBa.g:1222:3: (Tar= target ASSIGN (ValExpr= value_expression |identifier= ANY ) )
            // AadlBa.g:1223:4: Tar= target ASSIGN (ValExpr= value_expression |identifier= ANY )
            {
            ...
            // AadlBa.g:1223:22: (ValExpr= value_expression |identifier= ANY )
            int alt39=2;
            ...
            switch (alt39) {
                case 1 :
                    // AadlBa.g:1223:24: ValExpr= value_expression
                    {
                    ...
                    break;
                case 2 :
                    // AadlBa.g:1223:51: identifier= ANY
                    {
    ...
    // $ANTLR start "target"
    // AadlBa.g:1252:1: target returns [Target Tar] : dt= reference ;
    public final Target target() throws RecognitionException {
        ...
        try {
            // AadlBa.g:1256:3: (dt= reference )
            // AadlBa.g:1256:5: dt= reference
            {
    ...
    // AadlBa.g:1265:1: qualified_named_element returns [QualifiedNamedElement qne] : ( (identifier1= IDENT DOUBLECOLON )+ identifier2= IDENT ( DOT identifier3= IDENT )? ) ;
    public final QualifiedNamedElement qualified_named_element() throws RecognitionException {
        ...
        try {
            // AadlBa.g:1271:3: ( ( (identifier1= IDENT DOUBLECOLON )+ identifier2= IDENT ( DOT identifier3= IDENT )? ) )
            // AadlBa.g:1272:4: ( (identifier1= IDENT DOUBLECOLON )+ identifier2= IDENT ( DOT identifier3= IDENT )? )
            {
            // AadlBa.g:1272:4: ( (identifier1= IDENT DOUBLECOLON )+ identifier2= IDENT ( DOT identifier3= IDENT )? )
            // AadlBa.g:1273:5: (identifier1= IDENT DOUBLECOLON )+ identifier2= IDENT ( DOT identifier3= IDENT )?
            {
            // AadlBa.g:1273:5: (identifier1= IDENT DOUBLECOLON )+
            int cnt40=0;
            loop40:
            do {
                int alt40=2;
                ...
                switch (alt40) {
            	case 1 :
            	    // AadlBa.g:1273:7: identifier1= IDENT DOUBLECOLON
            	    {
            ...
            // AadlBa.g:1283:5: ( DOT identifier3= IDENT )?
            int alt41=2;
            ...
            switch (alt41) {
                case 1 :
                    // AadlBa.g:1283:7: DOT identifier3= IDENT
                    {
    ...
    // AadlBa.g:1324:1: communication_action returns [CommAction ca] : ( (qne= qualified_named_element EXCLAM ( LPAREN SubpgmParamList= subprogram_parameter_list RPAREN )? ) | (ref= reference ( ( INTERROG ( LPAREN Tar= target RPAREN )? ) | ( GGREATER ) | ( EXCLLESS ) | ( EXCLGREATER ) | ( EXCLAM ( LPAREN SubpgmParamList= subprogram_parameter_list RPAREN )? ) ) ) | (identifier= STAR ( EXCLLESS | EXCLGREATER ) ) );
    public final CommAction communication_action() throws RecognitionException {
        ...
        try {
            // AadlBa.g:1329:3: ( (qne= qualified_named_element EXCLAM ( LPAREN SubpgmParamList= subprogram_parameter_list RPAREN )? ) | (ref= reference ( ( INTERROG ( LPAREN Tar= target RPAREN )? ) | ( GGREATER ) | ( EXCLLESS ) | ( EXCLGREATER ) | ( EXCLAM ( LPAREN SubpgmParamList= subprogram_parameter_list RPAREN )? ) ) ) | (identifier= STAR ( EXCLLESS | EXCLGREATER ) ) )
            int alt47=3;
            ...
            switch (alt47) {
                case 1 :
                    // AadlBa.g:1343:7: (qne= qualified_named_element EXCLAM ( LPAREN SubpgmParamList= subprogram_parameter_list RPAREN )? )
                    {
                    // AadlBa.g:1343:7: (qne= qualified_named_element EXCLAM ( LPAREN SubpgmParamList= subprogram_parameter_list RPAREN )? )
                    // AadlBa.g:1344:9: qne= qualified_named_element EXCLAM ( LPAREN SubpgmParamList= subprogram_parameter_list RPAREN )?
                    {
                    ...
                    // AadlBa.g:1349:9: ( LPAREN SubpgmParamList= subprogram_parameter_list RPAREN )?
                    int alt42=2;
                    ...
                    switch (alt42) {
                        case 1 :
                            // AadlBa.g:1350:11: LPAREN SubpgmParamList= subprogram_parameter_list RPAREN
                            {
                    ...
                    break;
                case 2 :
                    // AadlBa.g:1357:7: (ref= reference ( ( INTERROG ( LPAREN Tar= target RPAREN )? ) | ( GGREATER ) | ( EXCLLESS ) | ( EXCLGREATER ) | ( EXCLAM ( LPAREN SubpgmParamList= subprogram_parameter_list RPAREN )? ) ) )
                    {
                    // AadlBa.g:1357:7: (ref= reference ( ( INTERROG ( LPAREN Tar= target RPAREN )? ) | ( GGREATER ) | ( EXCLLESS ) | ( EXCLGREATER ) | ( EXCLAM ( LPAREN SubpgmParamList= subprogram_parameter_list RPAREN )? ) ) )
                    // AadlBa.g:1358:9: ref= reference ( ( INTERROG ( LPAREN Tar= target RPAREN )? ) | ( GGREATER ) | ( EXCLLESS ) | ( EXCLGREATER ) | ( EXCLAM ( LPAREN SubpgmParamList= subprogram_parameter_list RPAREN )? ) )
                    {
                    ...
                    // AadlBa.g:1363:9: ( ( INTERROG ( LPAREN Tar= target RPAREN )? ) | ( GGREATER ) | ( EXCLLESS ) | ( EXCLGREATER ) | ( EXCLAM ( LPAREN SubpgmParamList= subprogram_parameter_list RPAREN )? ) )
                    int alt45=5;
                    switch ( input.LA(1) ) {
                    case INTERROG:
                        {
                    ...
                    switch (alt45) {
                        case 1 :
                            // AadlBa.g:1364:13: ( INTERROG ( LPAREN Tar= target RPAREN )? )
                            {
                            // AadlBa.g:1364:13: ( INTERROG ( LPAREN Tar= target RPAREN )? )
                            // AadlBa.g:1365:15: INTERROG ( LPAREN Tar= target RPAREN )?
                            {
                            ...
                            // AadlBa.g:1369:15: ( LPAREN Tar= target RPAREN )?
                            int alt43=2;
                            ...
                            switch (alt43) {
                                case 1 :
                                    // AadlBa.g:1370:17: LPAREN Tar= target RPAREN
                                    {
                            ...
                            break;
                        case 2 :
                            // AadlBa.g:1377:13: ( GGREATER )
                            {
                            // AadlBa.g:1377:13: ( GGREATER )
                            // AadlBa.g:1378:15: GGREATER
                            {
                            ...
                            break;
                        case 3 :
                            // AadlBa.g:1384:13: ( EXCLLESS )
                            {
                            // AadlBa.g:1384:13: ( EXCLLESS )
                            // AadlBa.g:1385:15: EXCLLESS
                            {
                            ...
                            break;
                        case 4 :
                            // AadlBa.g:1391:13: ( EXCLGREATER )
                            {
                            // AadlBa.g:1391:13: ( EXCLGREATER )
                            // AadlBa.g:1392:15: EXCLGREATER
                            {
                            ...
                            break;
                        case 5 :
                            // AadlBa.g:1398:13: ( EXCLAM ( LPAREN SubpgmParamList= subprogram_parameter_list RPAREN )? )
                            {
                            // AadlBa.g:1398:13: ( EXCLAM ( LPAREN SubpgmParamList= subprogram_parameter_list RPAREN )? )
                            // AadlBa.g:1399:15: EXCLAM ( LPAREN SubpgmParamList= subprogram_parameter_list RPAREN )?
                            {
                            match(input,EXCLAM,FOLLOW_EXCLAM_in_communication_action4752); if (state.failed) return ca;

                            // AadlBa.g:1400:15: ( LPAREN SubpgmParamList= subprogram_parameter_list RPAREN )?
                            int alt44=2;
                            ...
                            switch (alt44) {
                                case 1 :
                                    // AadlBa.g:1401:17: LPAREN SubpgmParamList= subprogram_parameter_list RPAREN
                                    {
                    ...
                    break;
                case 3 :
                    // AadlBa.g:1410:7: (identifier= STAR ( EXCLLESS | EXCLGREATER ) )
                    {
                    // AadlBa.g:1410:7: (identifier= STAR ( EXCLLESS | EXCLGREATER ) )
                    // AadlBa.g:1411:9: identifier= STAR ( EXCLLESS | EXCLGREATER )
                    {
                    identifier=(Token)match(input,STAR,FOLLOW_STAR_in_communication_action4886); if (state.failed) return ca;

                    // AadlBa.g:1412:9: ( EXCLLESS | EXCLGREATER )
                    int alt46=2;
    ...
    // AadlBa.g:1436:1: timed_action returns [TimedAction TimedAct] : (identifier= COMPUTATION ) LPAREN BehTime= behavior_time ( DOTDOT BehTime= behavior_time )? RPAREN ;
    public final TimedAction timed_action() throws RecognitionException {
        ...
        try {
            // AadlBa.g:1440:3: ( (identifier= COMPUTATION ) LPAREN BehTime= behavior_time ( DOTDOT BehTime= behavior_time )? RPAREN )
            // AadlBa.g:1441:4: (identifier= COMPUTATION ) LPAREN BehTime= behavior_time ( DOTDOT BehTime= behavior_time )? RPAREN
            {
            // AadlBa.g:1441:4: (identifier= COMPUTATION )
            // AadlBa.g:1441:6: identifier= COMPUTATION
            {
            ...
            // AadlBa.g:1445:6: ( DOTDOT BehTime= behavior_time )?
            int alt48=2;
            ...
            switch (alt48) {
                case 1 :
                    // AadlBa.g:1445:7: DOTDOT BehTime= behavior_time
                    {
    ...
    // AadlBa.g:1458:1: subprogram_parameter_list returns [EList<ParameterLabel> SpgParamList] : ParamLabel= parameter_label (identifier= COMMA ParamLabel= parameter_label )* ;
    public final EList<ParameterLabel> subprogram_parameter_list() throws RecognitionException {
        ...
        try {
            // AadlBa.g:1462:3: (ParamLabel= parameter_label (identifier= COMMA ParamLabel= parameter_label )* )
            // AadlBa.g:1463:4: ParamLabel= parameter_label (identifier= COMMA ParamLabel= parameter_label )*
            {
            ...
            // AadlBa.g:1464:4: (identifier= COMMA ParamLabel= parameter_label )*
            loop49:
            do {
                int alt49=2;
                ...
                switch (alt49) {
            	case 1 :
            	    // AadlBa.g:1464:5: identifier= COMMA ParamLabel= parameter_label
            	    {
    ...
    // AadlBa.g:1479:1: parameter_label returns [ParameterLabel ParamLabel] : (ValExpr= value_expression ) ;
    public final ParameterLabel parameter_label() throws RecognitionException {
        ...
        try {
            // AadlBa.g:1482:3: ( (ValExpr= value_expression ) )
            // AadlBa.g:1484:4: (ValExpr= value_expression )
            {
            // AadlBa.g:1484:4: (ValExpr= value_expression )
            // AadlBa.g:1485:8: ValExpr= value_expression
            {
    ...
    // AadlBa.g:1516:1: reference returns [Reference ref] : id= array_identifier ( DOT id= array_identifier )* ;
    public final Reference reference() throws RecognitionException {
        ...
        try {
            // AadlBa.g:1521:3: (id= array_identifier ( DOT id= array_identifier )* )
            // AadlBa.g:1522:5: id= array_identifier ( DOT id= array_identifier )*
            {
            ...
            // AadlBa.g:1527:5: ( DOT id= array_identifier )*
            loop50:
            do {
                int alt50=2;
                ...
                switch (alt50) {
            	case 1 :
            	    // AadlBa.g:1528:7: DOT id= array_identifier
            	    {
    ...
    // AadlBa.g:1542:1: array_identifier returns [ArrayableIdentifier id] : identifier= IDENT ( LBRACK Val= integer_value RBRACK )* ;
    public final ArrayableIdentifier array_identifier() throws RecognitionException {
        ...
        try {
            // AadlBa.g:1547:3: (identifier= IDENT ( LBRACK Val= integer_value RBRACK )* )
            // AadlBa.g:1548:5: identifier= IDENT ( LBRACK Val= integer_value RBRACK )*
            {
            ...
            // AadlBa.g:1553:5: ( LBRACK Val= integer_value RBRACK )*
            loop51:
            do {
                int alt51=2;
                ...
                switch (alt51) {
            	case 1 :
            	    // AadlBa.g:1554:7: LBRACK Val= integer_value RBRACK
            	    {
    ...
    // AadlBa.g:1595:1: fact_value returns [Value Val] : ( (id1= IDENT DOUBLECOLON id2= IDENT ) |ValueVar= value_variable |bl= boolean_literal |nl= numeric_literal |st= string_literal |lit= behavior_enumeration_literal ) ;
    public final Value fact_value() throws RecognitionException {
        ...
        try {
            // AadlBa.g:1600:3: ( ( (id1= IDENT DOUBLECOLON id2= IDENT ) |ValueVar= value_variable |bl= boolean_literal |nl= numeric_literal |st= string_literal |lit= behavior_enumeration_literal ) )
            // AadlBa.g:1604:4: ( (id1= IDENT DOUBLECOLON id2= IDENT ) |ValueVar= value_variable |bl= boolean_literal |nl= numeric_literal |st= string_literal |lit= behavior_enumeration_literal )
            {
            // AadlBa.g:1604:4: ( (id1= IDENT DOUBLECOLON id2= IDENT ) |ValueVar= value_variable |bl= boolean_literal |nl= numeric_literal |st= string_literal |lit= behavior_enumeration_literal )
            int alt52=6;
            switch ( input.LA(1) ) {
            ...
            switch (alt52) {
                case 1 :
                    // AadlBa.g:1606:8: (id1= IDENT DOUBLECOLON id2= IDENT )
                    {
                    // AadlBa.g:1606:8: (id1= IDENT DOUBLECOLON id2= IDENT )
                    // AadlBa.g:1607:11: id1= IDENT DOUBLECOLON id2= IDENT
                    {
                    ...
                    break;
                case 2 :
                    // AadlBa.g:1629:8: ValueVar= value_variable
                    {
                    ...
                    break;
                case 3 :
                    // AadlBa.g:1632:8: bl= boolean_literal
                    {
                    ...
                    break;
                case 4 :
                    // AadlBa.g:1634:8: nl= numeric_literal
                    {
                    ...
                    break;
                case 5 :
                    // AadlBa.g:1636:8: st= string_literal
                    {
                    ...
                    break;
                case 6 :
                    // AadlBa.g:1638:8: lit= behavior_enumeration_literal
                    {
    ...
    // $ANTLR start "value"
    // AadlBa.g:1659:1: value returns [Value Val] : ( (ValTmp= fact_value ) | (identifier= LPAREN ValExpr= value_expression RPAREN ) ) ;
    public final Value value() throws RecognitionException {
        ...
        try {
            // AadlBa.g:1662:3: ( ( (ValTmp= fact_value ) | (identifier= LPAREN ValExpr= value_expression RPAREN ) ) )
            // AadlBa.g:1663:4: ( (ValTmp= fact_value ) | (identifier= LPAREN ValExpr= value_expression RPAREN ) )
            {
            // AadlBa.g:1663:4: ( (ValTmp= fact_value ) | (identifier= LPAREN ValExpr= value_expression RPAREN ) )
            int alt53=2;
            ...
            switch (alt53) {
                case 1 :
                    // AadlBa.g:1664:8: (ValTmp= fact_value )
                    {
                    // AadlBa.g:1664:8: (ValTmp= fact_value )
                    // AadlBa.g:1664:10: ValTmp= fact_value
                    {
                    ...
                    break;
                case 2 :
                    // AadlBa.g:1666:8: (identifier= LPAREN ValExpr= value_expression RPAREN )
                    {
                    // AadlBa.g:1666:8: (identifier= LPAREN ValExpr= value_expression RPAREN )
                    // AadlBa.g:1666:10: identifier= LPAREN ValExpr= value_expression RPAREN
                    {
    ...
    // AadlBa.g:1683:1: value_variable returns [ValueVariable ValueVar] : (ref= reference ( INTERROG | TICK ( COUNT | FRESH ) )? ) ;
    public final ValueVariable value_variable() throws RecognitionException {
        ...
        try {
            // AadlBa.g:1688:3: ( (ref= reference ( INTERROG | TICK ( COUNT | FRESH ) )? ) )
            // AadlBa.g:1689:6: (ref= reference ( INTERROG | TICK ( COUNT | FRESH ) )? )
            {
            // AadlBa.g:1689:6: (ref= reference ( INTERROG | TICK ( COUNT | FRESH ) )? )
            // AadlBa.g:1690:8: ref= reference ( INTERROG | TICK ( COUNT | FRESH ) )?
            {
            ...
            // AadlBa.g:1692:8: ( INTERROG | TICK ( COUNT | FRESH ) )?
            int alt55=3;
    ...
    // AadlBa.g:1746:1: value_expression returns [ValueExpression ValueExpr] : (Rel= relation (LogicalOp= logical_operator Rel= relation )* ) ;
    public final ValueExpression value_expression() throws RecognitionException {
        ...
        try {
            // AadlBa.g:1750:3: ( (Rel= relation (LogicalOp= logical_operator Rel= relation )* ) )
            // AadlBa.g:1751:4: (Rel= relation (LogicalOp= logical_operator Rel= relation )* )
            {
            // AadlBa.g:1751:4: (Rel= relation (LogicalOp= logical_operator Rel= relation )* )
            // AadlBa.g:1752:6: Rel= relation (LogicalOp= logical_operator Rel= relation )*
            {
            ...
            // AadlBa.g:1756:6: (LogicalOp= logical_operator Rel= relation )*
            loop56:
            do {
                int alt56=2;
                ...
                switch (alt56) {
            	case 1 :
            	    // AadlBa.g:1757:8: LogicalOp= logical_operator Rel= relation
            	    {
    ...
    // AadlBa.g:1774:1: relation returns [Relation Rel] : SimpleExpr= simple_expression (RelationalOp= relational_operator SimpleExpr= simple_expression )? ;
    public final Relation relation() throws RecognitionException {
        ...
        try {
            // AadlBa.g:1778:3: (SimpleExpr= simple_expression (RelationalOp= relational_operator SimpleExpr= simple_expression )? )
            // AadlBa.g:1779:4: SimpleExpr= simple_expression (RelationalOp= relational_operator SimpleExpr= simple_expression )?
            {
            ...
            // AadlBa.g:1783:4: (RelationalOp= relational_operator SimpleExpr= simple_expression )?
            int alt57=2;
            ...
            switch (alt57) {
                case 1 :
                    // AadlBa.g:1784:6: RelationalOp= relational_operator SimpleExpr= simple_expression
                    {
    ...
    // AadlBa.g:1800:1: simple_expression returns [SimpleExpression SimpleExpr] : (UnaryAddOp= unary_adding_operator )? tm= term (BinaryAddOp= binary_adding_operator tm= term )* ;
    public final SimpleExpression simple_expression() throws RecognitionException {
        ...
        try {
            // AadlBa.g:1804:3: ( (UnaryAddOp= unary_adding_operator )? tm= term (BinaryAddOp= binary_adding_operator tm= term )* )
            // AadlBa.g:1805:4: (UnaryAddOp= unary_adding_operator )? tm= term (BinaryAddOp= binary_adding_operator tm= term )*
            {
            // AadlBa.g:1805:4: (UnaryAddOp= unary_adding_operator )?
            int alt58=2;
            ...
            switch (alt58) {
                case 1 :
                    // AadlBa.g:1806:6: UnaryAddOp= unary_adding_operator
                    {
            ...
            // AadlBa.g:1818:4: (BinaryAddOp= binary_adding_operator tm= term )*
            loop59:
            do {
                int alt59=2;
                ...
                switch (alt59) {
            	case 1 :
            	    // AadlBa.g:1819:6: BinaryAddOp= binary_adding_operator tm= term
            	    {
    ...
    // $ANTLR start "term"
    // AadlBa.g:1834:1: term returns [Term tm] : fact= factor (MultiplyingOp= multiplying_operator fact= factor )* ;
    public final Term term() throws RecognitionException {
        ...
        try {
            // AadlBa.g:1838:3: (fact= factor (MultiplyingOp= multiplying_operator fact= factor )* )
            // AadlBa.g:1839:4: fact= factor (MultiplyingOp= multiplying_operator fact= factor )*
            {
            ...
            // AadlBa.g:1843:4: (MultiplyingOp= multiplying_operator fact= factor )*
            loop60:
            do {
                int alt60=2;
                ...
                switch (alt60) {
            	case 1 :
            	    // AadlBa.g:1844:6: MultiplyingOp= multiplying_operator fact= factor
            	    {
    ...
    // $ANTLR start "factor"
    // AadlBa.g:1862:1: factor returns [Factor Fact] : ( (val= value (BinaryNumOp= binary_numeric_operator val2= value )? ) | (UnaryNumOp= unary_numeric_operator val= value ) | (UnaryBoolOp= unary_boolean_operator val= value ) ) ;
    public final Factor factor() throws RecognitionException {
        ...
        try {
            // AadlBa.g:1867:3: ( ( (val= value (BinaryNumOp= binary_numeric_operator val2= value )? ) | (UnaryNumOp= unary_numeric_operator val= value ) | (UnaryBoolOp= unary_boolean_operator val= value ) ) )
            // AadlBa.g:1868:4: ( (val= value (BinaryNumOp= binary_numeric_operator val2= value )? ) | (UnaryNumOp= unary_numeric_operator val= value ) | (UnaryBoolOp= unary_boolean_operator val= value ) )
            {
            // AadlBa.g:1868:4: ( (val= value (BinaryNumOp= binary_numeric_operator val2= value )? ) | (UnaryNumOp= unary_numeric_operator val= value ) | (UnaryBoolOp= unary_boolean_operator val= value ) )
            int alt62=3;
            switch ( input.LA(1) ) {
            ...
            switch (alt62) {
                case 1 :
                    // AadlBa.g:1869:5: (val= value (BinaryNumOp= binary_numeric_operator val2= value )? )
                    {
                    // AadlBa.g:1869:5: (val= value (BinaryNumOp= binary_numeric_operator val2= value )? )
                    // AadlBa.g:1869:7: val= value (BinaryNumOp= binary_numeric_operator val2= value )?
                    {
                    ...
                    // AadlBa.g:1873:7: (BinaryNumOp= binary_numeric_operator val2= value )?
                    int alt61=2;
                    ...
                    switch (alt61) {
                        case 1 :
                            // AadlBa.g:1874:9: BinaryNumOp= binary_numeric_operator val2= value
                            {
                    ...
                    break;
                case 2 :
                    // AadlBa.g:1882:5: (UnaryNumOp= unary_numeric_operator val= value )
                    {
                    // AadlBa.g:1882:5: (UnaryNumOp= unary_numeric_operator val= value )
                    // AadlBa.g:1882:7: UnaryNumOp= unary_numeric_operator val= value
                    {
                    ...
                    break;
                case 3 :
                    // AadlBa.g:1890:5: (UnaryBoolOp= unary_boolean_operator val= value )
                    {
                    // AadlBa.g:1890:5: (UnaryBoolOp= unary_boolean_operator val= value )
                    // AadlBa.g:1890:7: UnaryBoolOp= unary_boolean_operator val= value
                    {
    ...
    // AadlBa.g:1906:1: logical_operator returns [LogicalOperator LogicalOp] : ( AND | OR | XOR ) ;
    public final LogicalOperator logical_operator() throws RecognitionException {
        ...
        try {
            // AadlBa.g:1911:3: ( ( AND | OR | XOR ) )
            // AadlBa.g:1912:4: ( AND | OR | XOR )
            {
            // AadlBa.g:1912:4: ( AND | OR | XOR )
            int alt63=3;
            switch ( input.LA(1) ) {
    ...
    // AadlBa.g:1928:1: relational_operator returns [RelationalOperator RelationalOp] : ( EQUAL | NOTEQUAL | LESSTHAN | LESSOREQUAL | GREATERTHAN | GREATEROREQUAL ) ;
    public final RelationalOperator relational_operator() throws RecognitionException {
        ...
        try {
            // AadlBa.g:1933:3: ( ( EQUAL | NOTEQUAL | LESSTHAN | LESSOREQUAL | GREATERTHAN | GREATEROREQUAL ) )
            // AadlBa.g:1934:4: ( EQUAL | NOTEQUAL | LESSTHAN | LESSOREQUAL | GREATERTHAN | GREATEROREQUAL )
            {
            // AadlBa.g:1934:4: ( EQUAL | NOTEQUAL | LESSTHAN | LESSOREQUAL | GREATERTHAN | GREATEROREQUAL )
            int alt64=6;
            switch ( input.LA(1) ) {
            ...
            switch (alt64) {
                ...
                case 5 :
                    ...
                    break;
                case 6 :
                    // AadlBa.g:1945:6: GREATEROREQUAL
                    {
    ...
    // AadlBa.g:1956:1: binary_adding_operator returns [BinaryAddingOperator BinaryAddOp] : ( PLUS | MINUS ) ;
    public final BinaryAddingOperator binary_adding_operator() throws RecognitionException {
        ...
        try {
            // AadlBa.g:1961:3: ( ( PLUS | MINUS ) )
            // AadlBa.g:1962:4: ( PLUS | MINUS )
            {
            // AadlBa.g:1962:4: ( PLUS | MINUS )
            int alt65=2;
    ...
    // AadlBa.g:1976:1: unary_adding_operator returns [UnaryAddingOperator UnaryAddOp] : ( PLUS | MINUS ) ;
    public final UnaryAddingOperator unary_adding_operator() throws RecognitionException {
        ...
        try {
            // AadlBa.g:1980:3: ( ( PLUS | MINUS ) )
            // AadlBa.g:1981:4: ( PLUS | MINUS )
            {
            // AadlBa.g:1981:4: ( PLUS | MINUS )
            int alt66=2;
    ...
    // AadlBa.g:1995:1: multiplying_operator returns [MultiplyingOperator MultiplyingOp] : ( STAR | DIVIDE | MOD | REM ) ;
    public final MultiplyingOperator multiplying_operator() throws RecognitionException {
        ...
        try {
            // AadlBa.g:2000:3: ( ( STAR | DIVIDE | MOD | REM ) )
            // AadlBa.g:2001:4: ( STAR | DIVIDE | MOD | REM )
            {
            // AadlBa.g:2001:4: ( STAR | DIVIDE | MOD | REM )
            int alt67=4;
            switch ( input.LA(1) ) {
    ...
    // AadlBa.g:2019:1: binary_numeric_operator returns [BinaryNumericOperator BinaryNumOp] : STARSTAR ;
    public final BinaryNumericOperator binary_numeric_operator() throws RecognitionException {
        ...
        try {
            // AadlBa.g:2024:3: ( STARSTAR )
            // AadlBa.g:2025:4: STARSTAR
            {
    ...
    // AadlBa.g:2035:1: unary_numeric_operator returns [UnaryNumericOperator UnaryNumOp] : keyword= ABS ;
    public final UnaryNumericOperator unary_numeric_operator() throws RecognitionException {
        ...
        try {
            // AadlBa.g:2040:3: (keyword= ABS )
            // AadlBa.g:2041:4: keyword= ABS
            {
    ...
    // AadlBa.g:2051:1: unary_boolean_operator returns [UnaryBooleanOperator UnaryBoolOp] : NOT ;
    ...
    // AadlBa.g:2066:1: boolean_literal returns [BehaviorBooleanLiteral BoolLit] : (identifier= TRUE |identifier= FALSE ) ;
    public final BehaviorBooleanLiteral boolean_literal() throws RecognitionException {
        ...
        try {
            // AadlBa.g:2070:3: ( (identifier= TRUE |identifier= FALSE ) )
            // AadlBa.g:2071:4: (identifier= TRUE |identifier= FALSE )
            {
            // AadlBa.g:2071:4: (identifier= TRUE |identifier= FALSE )
            int alt68=2;
            ...
            switch (alt68) {
                case 1 :
                    // AadlBa.g:2072:8: identifier= TRUE
                    {
                    ...
                    break;
                case 2 :
                    // AadlBa.g:2074:8: identifier= FALSE
                    {
    ...
    // AadlBa.g:2085:1: integer_range returns [IntegerRange IntRange] : (IntValue= integer_value DOTDOT IntValue2= integer_value ) ;
    public final IntegerRange integer_range() throws RecognitionException {
        ...
        try {
            // AadlBa.g:2089:3: ( (IntValue= integer_value DOTDOT IntValue2= integer_value ) )
            // AadlBa.g:2090:4: (IntValue= integer_value DOTDOT IntValue2= integer_value )
            {
            // AadlBa.g:2090:4: (IntValue= integer_value DOTDOT IntValue2= integer_value )
            // AadlBa.g:2091:6: IntValue= integer_value DOTDOT IntValue2= integer_value
            {
    ...
    // AadlBa.g:2108:1: integer_value returns [IntegerValue IntVal] : (ValTmp= fact_value ) ;
    public final IntegerValue integer_value() throws RecognitionException {
        ...
        try {
            // AadlBa.g:2111:3: ( (ValTmp= fact_value ) )
            // AadlBa.g:2113:4: (ValTmp= fact_value )
            {
            // AadlBa.g:2113:4: (ValTmp= fact_value )
            // AadlBa.g:2114:6: ValTmp= fact_value
            {
    ...
    // AadlBa.g:2125:1: behavior_time returns [DeclarativeTime BehTime] : (IntValue= integer_value UnitIdent= IDENT ) ;
    public final DeclarativeTime behavior_time() throws RecognitionException {
        ...
        try {
            // AadlBa.g:2129:3: ( (IntValue= integer_value UnitIdent= IDENT ) )
            // AadlBa.g:2130:4: (IntValue= integer_value UnitIdent= IDENT )
            {
            // AadlBa.g:2130:4: (IntValue= integer_value UnitIdent= IDENT )
            // AadlBa.g:2131:6: IntValue= integer_value UnitIdent= IDENT
            {
    ...
    // AadlBa.g:2162:1: property returns [QualifiedNamedElement property] : ( (PropertySetId= IDENT DOUBLECOLON )? PropertyId= IDENT ) ;
    public final QualifiedNamedElement property() throws RecognitionException {
        ...
        try {
            // AadlBa.g:2166:3: ( ( (PropertySetId= IDENT DOUBLECOLON )? PropertyId= IDENT ) )
            // AadlBa.g:2167:4: ( (PropertySetId= IDENT DOUBLECOLON )? PropertyId= IDENT )
            {
            // AadlBa.g:2167:4: ( (PropertySetId= IDENT DOUBLECOLON )? PropertyId= IDENT )
            // AadlBa.g:2168:6: (PropertySetId= IDENT DOUBLECOLON )? PropertyId= IDENT
            {
            // AadlBa.g:2168:6: (PropertySetId= IDENT DOUBLECOLON )?
            int alt69=2;
            ...
            switch (alt69) {
                case 1 :
                    // AadlBa.g:2168:8: PropertySetId= IDENT DOUBLECOLON
                    {
    ...
    // AadlBa.g:2203:1: behavior_enumeration_literal returns [Enumeration enumeration] : ( qualifiable_named_element[enumeration] DOT id1= ENUMERATOR HASH id2= IDENT ) ;
    public final Enumeration behavior_enumeration_literal() throws RecognitionException {
        ...
        try {
            // AadlBa.g:2207:3: ( ( qualifiable_named_element[enumeration] DOT id1= ENUMERATOR HASH id2= IDENT ) )
            // AadlBa.g:2208:3: ( qualifiable_named_element[enumeration] DOT id1= ENUMERATOR HASH id2= IDENT )
            {
            // AadlBa.g:2208:3: ( qualifiable_named_element[enumeration] DOT id1= ENUMERATOR HASH id2= IDENT )
            // AadlBa.g:2209:6: qualifiable_named_element[enumeration] DOT id1= ENUMERATOR HASH id2= IDENT
            {
    ...
    // AadlBa.g:2235:1: numeric_literal returns [NumericLiteral nl] : (realval= REAL_LIT |intLit= integer_literal ) ;
    public final NumericLiteral numeric_literal() throws RecognitionException {
        ...
        try {
            // AadlBa.g:2240:3: ( (realval= REAL_LIT |intLit= integer_literal ) )
            // AadlBa.g:2241:3: (realval= REAL_LIT |intLit= integer_literal )
            {
            // AadlBa.g:2241:3: (realval= REAL_LIT |intLit= integer_literal )
            int alt70=2;
            ...
            switch (alt70) {
                case 1 :
                    // AadlBa.g:2242:7: realval= REAL_LIT
                    {
                    ...
                    break;
                case 2 :
                    // AadlBa.g:2252:7: intLit= integer_literal
                    {
    ...
    // AadlBa.g:2264:1: integer_literal returns [BehaviorIntegerLiteral bil] : integerval= INTEGER_LIT ;
    public final BehaviorIntegerLiteral integer_literal() throws RecognitionException {
        ...
        try {
            // AadlBa.g:2266:2: (integerval= INTEGER_LIT )
            // AadlBa.g:2267:5: integerval= INTEGER_LIT
            {
    ...
    // AadlBa.g:2298:1: string_literal returns [BehaviorStringLiteral StringLit] : (sl= STRING_LITERAL ) ;
    public final BehaviorStringLiteral string_literal() throws RecognitionException {
        ...
        try {
            // AadlBa.g:2302:3: ( (sl= STRING_LITERAL ) )
            // AadlBa.g:2303:4: (sl= STRING_LITERAL )
            {
            // AadlBa.g:2303:4: (sl= STRING_LITERAL )
            // AadlBa.g:2304:6: sl= STRING_LITERAL
            {
    ...
    // $ANTLR start "numeral"
    // AadlBa.g:2322:1: numeral returns [Integer Num] : (NumVal= INTEGER_LIT ) ;
    public final Integer numeral() throws RecognitionException {
        ...
        try {
            // AadlBa.g:2324:3: ( (NumVal= INTEGER_LIT ) )
            // AadlBa.g:2325:4: (NumVal= INTEGER_LIT )
            {
            // AadlBa.g:2325:4: (NumVal= INTEGER_LIT )
            // AadlBa.g:2326:6: NumVal= INTEGER_LIT
            {
