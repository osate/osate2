...
import fr.tpt.aadl.annex.behavior.parser.AadlBaParser.Array_identifierContext ;
import fr.tpt.aadl.annex.behavior.parser.AadlBaParser.Behavior_actionContext ;
import fr.tpt.aadl.annex.behavior.parser.AadlBaParser.Behavior_state_listContext ;
import fr.tpt.aadl.annex.behavior.parser.AadlBaParser.Behavior_transitionContext ;
import fr.tpt.aadl.annex.behavior.parser.AadlBaParser.Behavior_variableContext ;
import fr.tpt.aadl.annex.behavior.parser.AadlBaParser.Behavior_variable_listContext ;
import fr.tpt.aadl.annex.behavior.parser.AadlBaParser.Binary_adding_operatorContext ;
import fr.tpt.aadl.annex.behavior.parser.AadlBaParser.Dispatch_conjunctionContext ;
import fr.tpt.aadl.annex.behavior.parser.AadlBaParser.Elsif_statementContext ;
import fr.tpt.aadl.annex.behavior.parser.AadlBaParser.FactorContext ;
import fr.tpt.aadl.annex.behavior.parser.AadlBaParser.Integer_valueContext ;
import fr.tpt.aadl.annex.behavior.parser.AadlBaParser.Integer_value_constantContext ;
import fr.tpt.aadl.annex.behavior.parser.AadlBaParser.Logical_operatorContext ;
import fr.tpt.aadl.annex.behavior.parser.AadlBaParser.Multiplying_operatorContext ;
import fr.tpt.aadl.annex.behavior.parser.AadlBaParser.Parameter_labelContext ;
import fr.tpt.aadl.annex.behavior.parser.AadlBaParser.Real_literalContext ;
import fr.tpt.aadl.annex.behavior.parser.AadlBaParser.ReferenceContext ;
import fr.tpt.aadl.annex.behavior.parser.AadlBaParser.RelationContext ;
import fr.tpt.aadl.annex.behavior.parser.AadlBaParser.TermContext ;
import fr.tpt.aadl.annex.behavior.parser.AadlBaParser.ValueContext ;
