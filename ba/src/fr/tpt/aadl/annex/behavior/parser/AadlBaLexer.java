// $ANTLR 3.4 AadlBa.g 2012-07-24 10:26:48
...
public class AadlBaLexer extends Lexer {
    ...
    public final void mCATCH() throws RecognitionException {
        try {
            int _type = CATCH;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // AadlBa.g:270:16: ( 'catch' )
            // AadlBa.g:270:18: 'catch'
            {
            match("catch"); 
    ...
    public final void mCOMPLETE() throws RecognitionException {
        try {
            int _type = COMPLETE;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // AadlBa.g:271:16: ( 'complete' )
            // AadlBa.g:271:18: 'complete'
            {
            match("complete"); 
    ...
    public final void mCOMPUTATION() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // AadlBa.g:272:16: ( 'computation' )
            // AadlBa.g:272:18: 'computation'
            {
            match("computation"); 
    ...
    public final void mCOUNT() throws RecognitionException {
        try {
            int _type = COUNT;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // AadlBa.g:273:16: ( 'count' )
            // AadlBa.g:273:18: 'count'
            {
            match("count"); 
    ...
    public final void mDISPATCH() throws RecognitionException {
        try {
            int _type = DISPATCH;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // AadlBa.g:274:16: ( 'dispatch' )
            // AadlBa.g:274:18: 'dispatch'
            {
            match("dispatch"); 
    ...
    public final void mELSE() throws RecognitionException {
        try {
            int _type = ELSE;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // AadlBa.g:276:16: ( 'else' )
            // AadlBa.g:276:18: 'else'
            {
            match("else"); 
    ...
    public final void mELSIF() throws RecognitionException {
        try {
            int _type = ELSIF;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // AadlBa.g:277:16: ( 'elsif' )
            // AadlBa.g:277:18: 'elsif'
            {
            match("elsif"); 
    ...
    public final void mFALSE() throws RecognitionException {
        try {
            int _type = FALSE;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // AadlBa.g:279:16: ( 'false' )
            // AadlBa.g:279:18: 'false'
            {
            match("false"); 
    ...
    public final void mFINAL() throws RecognitionException {
        try {
            int _type = FINAL;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // AadlBa.g:280:16: ( 'final' )
            // AadlBa.g:280:18: 'final'
            {
            match("final"); 
    ...
    public final void mFORALL() throws RecognitionException {
        try {
            int _type = FORALL;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // AadlBa.g:282:16: ( 'forall' )
            // AadlBa.g:282:18: 'forall'
            {
            match("forall"); 
    ...
    public final void mFRESH() throws RecognitionException {
        try {
            int _type = FRESH;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // AadlBa.g:283:16: ( 'fresh' )
            // AadlBa.g:283:18: 'fresh'
            {
            match("fresh"); 
    ...
    public final void mFROZEN() throws RecognitionException {
        try {
            int _type = FROZEN;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // AadlBa.g:284:16: ( 'frozen' )
            // AadlBa.g:284:18: 'frozen'
            {
            match("frozen"); 
    ...
    public final void mINITIAL() throws RecognitionException {
        try {
            int _type = INITIAL;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // AadlBa.g:287:16: ( 'initial' )
            // AadlBa.g:287:18: 'initial'
            {
            match("initial"); 
    ...
    public final void mOTHERWISE() throws RecognitionException {
        try {
            int _type = OTHERWISE;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // AadlBa.g:292:16: ( 'otherwise' )
            // AadlBa.g:292:18: 'otherwise'
            {
            match("otherwise"); 
    ...
    public final void mVARIABLES() throws RecognitionException {
        try {
            int _type = VARIABLES;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // AadlBa.g:293:16: ( 'variables' )
            // AadlBa.g:293:18: 'variables'
            {
            match("variables"); 
    ...
    public final void mSTATE() throws RecognitionException {
        try {
            int _type = STATE;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // AadlBa.g:295:16: ( 'state' )
            // AadlBa.g:295:18: 'state'
            {
            match("state"); 
    ...
    public final void mSTATES() throws RecognitionException {
        try {
            int _type = STATES;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // AadlBa.g:296:16: ( 'states' )
            // AadlBa.g:296:18: 'states'
            {
            match("states"); 
    ...
    public final void mSTOP() throws RecognitionException {
        try {
            int _type = STOP;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // AadlBa.g:297:16: ( 'stop' )
            // AadlBa.g:297:18: 'stop'
            {
            match("stop"); 
    ...
    public final void mTIMEOUT() throws RecognitionException {
        try {
            int _type = TIMEOUT;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // AadlBa.g:298:16: ( 'timeout' )
            // AadlBa.g:298:18: 'timeout'
            {
            match("timeout"); 
    ...
    public final void mTRANSITIONS() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // AadlBa.g:299:16: ( 'transitions' )
            // AadlBa.g:299:18: 'transitions'
            {
            match("transitions"); 
    ...
    public final void mTRUE() throws RecognitionException {
        try {
            int _type = TRUE;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // AadlBa.g:300:16: ( 'true' )
            // AadlBa.g:300:18: 'true'
            {
            match("true"); 
    ...
    public final void mUNTIL() throws RecognitionException {
        try {
            int _type = UNTIL;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // AadlBa.g:301:16: ( 'until' )
            // AadlBa.g:301:18: 'until'
            {
            match("until"); 
    ...
    public final void mWHILE() throws RecognitionException {
        try {
            int _type = WHILE;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // AadlBa.g:302:16: ( 'while' )
            // AadlBa.g:302:18: 'while'
            {
            match("while"); 
    ...
    public final void mENUMERATOR() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // AadlBa.g:343:16: ( 'enumerators' )
            // AadlBa.g:343:18: 'enumerators'
            {
            match("enumerators"); 
    ...
    public final void mIDENT() throws RecognitionException {
        try {
            int _type = IDENT;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // AadlBa.g:2310:7: ( LETTER ( ( '_' )? ( LETTER | '0' .. '9' ) )* )
            // AadlBa.g:2310:9: LETTER ( ( '_' )? ( LETTER | '0' .. '9' ) )*
            {
            mLETTER(); 


            // AadlBa.g:2311:7: ( ( '_' )? ( LETTER | '0' .. '9' ) )*
            loop2:
            do {
                int alt2=2;
    ...
    public final void mSTRING_LITERAL() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // AadlBa.g:2320:15: ( '\"' ( '\"\"' | ESC |~ ( '\"' | '\\\\' ) )* '\"' )
            // AadlBa.g:2320:16: '\"' ( '\"\"' | ESC |~ ( '\"' | '\\\\' ) )* '\"'
            {
            match('\"'); 

            // AadlBa.g:2320:20: ( '\"\"' | ESC |~ ( '\"' | '\\\\' ) )*
            loop3:
            do {
                int alt3=4;
    ...
    public final void mREAL_LIT() throws RecognitionException {
        try {
            int _type = REAL_LIT;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // AadlBa.g:2322:10: ( ( DIGIT )+ ( '_' ( DIGIT )+ )* ( ( '.' ( DIGIT )+ ( '_' ( DIGIT )+ )* ( EXPONENT )? ) ) )
            // AadlBa.g:2322:13: ( DIGIT )+ ( '_' ( DIGIT )+ )* ( ( '.' ( DIGIT )+ ( '_' ( DIGIT )+ )* ( EXPONENT )? ) )
            {
            // AadlBa.g:2322:13: ( DIGIT )+
            int cnt4=0;
            loop4:
            do {
                int alt4=2;
            ...
            do {
                ...
                switch (alt6) {
            	case 1 :
            	    // AadlBa.g:2322:22: '_' ( DIGIT )+
            	    {
            	    match('_'); 

            	    // AadlBa.g:2322:26: ( DIGIT )+
            	    int cnt5=0;
            	    loop5:
            	    do {
            	        int alt5=2;
            ...
            // AadlBa.g:2323:5: ( ( '.' ( DIGIT )+ ( '_' ( DIGIT )+ )* ( EXPONENT )? ) )
            // AadlBa.g:2324:7: ( '.' ( DIGIT )+ ( '_' ( DIGIT )+ )* ( EXPONENT )? )
            {
            // AadlBa.g:2324:7: ( '.' ( DIGIT )+ ( '_' ( DIGIT )+ )* ( EXPONENT )? )
            // AadlBa.g:2324:9: '.' ( DIGIT )+ ( '_' ( DIGIT )+ )* ( EXPONENT )?
            {
            match('.'); 

            // AadlBa.g:2324:13: ( DIGIT )+
            int cnt7=0;
            loop7:
            do {
                int alt7=2;
            ...
            do {
                ...
                switch (alt9) {
            	case 1 :
            	    // AadlBa.g:2324:22: '_' ( DIGIT )+
            	    {
            	    match('_'); 

            	    // AadlBa.g:2324:26: ( DIGIT )+
            	    int cnt8=0;
            	    loop8:
            	    do {
            	        int alt8=2;
    ...
    public final void mINTEGER_LIT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // AadlBa.g:2328:13: ( ( DIGIT )+ ( '_' ( DIGIT )+ )* ( ( '#' BASED_INTEGER '#' ( INT_EXPONENT )? ) | ( INT_EXPONENT )? ) )
            // AadlBa.g:2329:5: ( DIGIT )+ ( '_' ( DIGIT )+ )* ( ( '#' BASED_INTEGER '#' ( INT_EXPONENT )? ) | ( INT_EXPONENT )? )
            {
            // AadlBa.g:2329:5: ( DIGIT )+
            int cnt11=0;
            loop11:
            do {
                int alt11=2;
            ...
            do {
                ...
                switch (alt13) {
            	case 1 :
            	    // AadlBa.g:2329:14: '_' ( DIGIT )+
            	    {
            	    match('_'); 

            	    // AadlBa.g:2329:18: ( DIGIT )+
            	    int cnt12=0;
            	    loop12:
            	    do {
            	        int alt12=2;
            ...
            // AadlBa.g:2330:5: ( ( '#' BASED_INTEGER '#' ( INT_EXPONENT )? ) | ( INT_EXPONENT )? )
            int alt16=2;
            ...
            switch (alt16) {
                case 1 :
                    // AadlBa.g:2331:7: ( '#' BASED_INTEGER '#' ( INT_EXPONENT )? )
                    {
                    // AadlBa.g:2331:7: ( '#' BASED_INTEGER '#' ( INT_EXPONENT )? )
                    // AadlBa.g:2331:9: '#' BASED_INTEGER '#' ( INT_EXPONENT )?
                    {
                    match('#'); 
    ...
    public final void mEXPONENT() throws RecognitionException {
        try {
            // AadlBa.g:2341:10: ( ( 'e' ) ( '+' | '-' )? ( DIGIT )+ )
            // AadlBa.g:2341:12: ( 'e' ) ( '+' | '-' )? ( DIGIT )+
            {
            // AadlBa.g:2341:12: ( 'e' )
            // AadlBa.g:2341:13: 'e'
            {
    ...
    public final void mINT_EXPONENT() throws RecognitionException {
        try {
            // AadlBa.g:2344:14: ( ( 'e' ) ( '+' )? ( DIGIT )+ )
            // AadlBa.g:2344:16: ( 'e' ) ( '+' )? ( DIGIT )+
            {
            // AadlBa.g:2344:16: ( 'e' )
            // AadlBa.g:2344:17: 'e'
            {
    ...
    public final void mBASED_INTEGER() throws RecognitionException {
        try {
            // AadlBa.g:2350:15: ( ( EXTENDED_DIGIT ) ( ( '_' )? EXTENDED_DIGIT )* )
            // AadlBa.g:2350:17: ( EXTENDED_DIGIT ) ( ( '_' )? EXTENDED_DIGIT )*
            {
            if ( (input.LA(1) >= '0' && input.LA(1) <= '9')||(input.LA(1) >= 'a' && input.LA(1) <= 'f') ) {
                input.consume();
            }
            ...
            // AadlBa.g:2350:36: ( ( '_' )? EXTENDED_DIGIT )*
            loop22:
            do {
                int alt22=2;
                ...
                switch (alt22) {
            	case 1 :
            	    // AadlBa.g:2350:38: ( '_' )? EXTENDED_DIGIT
            	    {
            	    // AadlBa.g:2350:38: ( '_' )?
            	    int alt21=2;
    ...
    public final void mBASE() throws RecognitionException {
        try {
            // AadlBa.g:2353:6: ( DIGIT ( DIGIT )? )
            // AadlBa.g:2353:8: DIGIT ( DIGIT )?
            {
            mDIGIT(); 


            // AadlBa.g:2353:14: ( DIGIT )?
            int alt23=2;
    ...
    public final void mESC() throws RecognitionException {
        try {
            // AadlBa.g:2386:3: ( '\\\\' ( 'n' | 'r' | 't' | 'b' | 'f' | '\"' | '\\'' | '\\\\' | ( 'u' )+ HEX_DIGIT HEX_DIGIT HEX_DIGIT HEX_DIGIT | '0' .. '3' ( '0' .. '7' ( '0' .. '7' )? )? | '4' .. '7' ( '0' .. '7' )? ) )
            // AadlBa.g:2386:5: '\\\\' ( 'n' | 'r' | 't' | 'b' | 'f' | '\"' | '\\'' | '\\\\' | ( 'u' )+ HEX_DIGIT HEX_DIGIT HEX_DIGIT HEX_DIGIT | '0' .. '3' ( '0' .. '7' ( '0' .. '7' )? )? | '4' .. '7' ( '0' .. '7' )? )
            {
            match('\\'); 
            ...
            switch (alt30) {
                ...
                case 8 :
                    ...
                    break;
                case 9 :
                    // AadlBa.g:2395:7: ( 'u' )+ HEX_DIGIT HEX_DIGIT HEX_DIGIT HEX_DIGIT
                    {
                    // AadlBa.g:2395:7: ( 'u' )+
                    int cnt26=0;
                    loop26:
                    ...
                    break;
                case 10 :
                    // AadlBa.g:2396:7: '0' .. '3' ( '0' .. '7' ( '0' .. '7' )? )?
                    {
                    matchRange('0','3'); 

                    // AadlBa.g:2397:7: ( '0' .. '7' ( '0' .. '7' )? )?
                    int alt28=2;
