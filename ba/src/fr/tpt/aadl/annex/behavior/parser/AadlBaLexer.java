...
public class AadlBaLexer extends Lexer {
    ...
    public final void mIDENT() throws RecognitionException {
        try {
            int _type = IDENT;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // AadlBa.g:2456:7: ( LETTER ( ( '_' )? ( LETTER | '0' .. '9' ) )* )
            // AadlBa.g:2456:9: LETTER ( ( '_' )? ( LETTER | '0' .. '9' ) )*
            {
            mLETTER(); 


            // AadlBa.g:2457:7: ( ( '_' )? ( LETTER | '0' .. '9' ) )*
            loop2:
            do {
                int alt2=2;
    ...
    public final void mSTRING_LITERAL() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // AadlBa.g:2466:15: ( '\"' ( '\"\"' | ESC |~ ( '\"' | '\\\\' ) )* '\"' )
            // AadlBa.g:2466:16: '\"' ( '\"\"' | ESC |~ ( '\"' | '\\\\' ) )* '\"'
            {
            match('\"'); 

            // AadlBa.g:2466:20: ( '\"\"' | ESC |~ ( '\"' | '\\\\' ) )*
            loop3:
            do {
                int alt3=4;
    ...
    public final void mREAL_LIT() throws RecognitionException {
        try {
            int _type = REAL_LIT;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // AadlBa.g:2468:10: ( ( DIGIT )+ ( '_' ( DIGIT )+ )* ( ( '.' ( DIGIT )+ ( '_' ( DIGIT )+ )* ( EXPONENT )? ) ) )
            // AadlBa.g:2468:13: ( DIGIT )+ ( '_' ( DIGIT )+ )* ( ( '.' ( DIGIT )+ ( '_' ( DIGIT )+ )* ( EXPONENT )? ) )
            {
            // AadlBa.g:2468:13: ( DIGIT )+
            int cnt4=0;
            loop4:
            do {
                int alt4=2;
            ...
            do {
                ...
                switch (alt6) {
            	case 1 :
            	    // AadlBa.g:2468:22: '_' ( DIGIT )+
            	    {
            	    match('_'); 

            	    // AadlBa.g:2468:26: ( DIGIT )+
            	    int cnt5=0;
            	    loop5:
            	    do {
            	        int alt5=2;
            ...
            // AadlBa.g:2469:5: ( ( '.' ( DIGIT )+ ( '_' ( DIGIT )+ )* ( EXPONENT )? ) )
            // AadlBa.g:2470:7: ( '.' ( DIGIT )+ ( '_' ( DIGIT )+ )* ( EXPONENT )? )
            {
            // AadlBa.g:2470:7: ( '.' ( DIGIT )+ ( '_' ( DIGIT )+ )* ( EXPONENT )? )
            // AadlBa.g:2470:9: '.' ( DIGIT )+ ( '_' ( DIGIT )+ )* ( EXPONENT )?
            {
            match('.'); 

            // AadlBa.g:2470:13: ( DIGIT )+
            int cnt7=0;
            loop7:
            do {
                int alt7=2;
            ...
            do {
                ...
                switch (alt9) {
            	case 1 :
            	    // AadlBa.g:2470:22: '_' ( DIGIT )+
            	    {
            	    match('_'); 

            	    // AadlBa.g:2470:26: ( DIGIT )+
            	    int cnt8=0;
            	    loop8:
            	    do {
            	        int alt8=2;
    ...
    public final void mINTEGER_LIT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // AadlBa.g:2474:13: ( ( DIGIT )+ ( '_' ( DIGIT )+ )* ( ( '#' BASED_INTEGER '#' ( INT_EXPONENT )? ) | ( INT_EXPONENT )? ) )
            // AadlBa.g:2475:5: ( DIGIT )+ ( '_' ( DIGIT )+ )* ( ( '#' BASED_INTEGER '#' ( INT_EXPONENT )? ) | ( INT_EXPONENT )? )
            {
            // AadlBa.g:2475:5: ( DIGIT )+
            int cnt11=0;
            loop11:
            do {
                int alt11=2;
            ...
            do {
                ...
                switch (alt13) {
            	case 1 :
            	    // AadlBa.g:2475:14: '_' ( DIGIT )+
            	    {
            	    match('_'); 

            	    // AadlBa.g:2475:18: ( DIGIT )+
            	    int cnt12=0;
            	    loop12:
            	    do {
            	        int alt12=2;
            ...
            // AadlBa.g:2476:5: ( ( '#' BASED_INTEGER '#' ( INT_EXPONENT )? ) | ( INT_EXPONENT )? )
            int alt16=2;
            ...
            switch (alt16) {
                case 1 :
                    // AadlBa.g:2477:7: ( '#' BASED_INTEGER '#' ( INT_EXPONENT )? )
                    {
                    // AadlBa.g:2477:7: ( '#' BASED_INTEGER '#' ( INT_EXPONENT )? )
                    // AadlBa.g:2477:9: '#' BASED_INTEGER '#' ( INT_EXPONENT )?
                    {
                    match('#'); 
    ...
    public final void mEXPONENT() throws RecognitionException {
        try {
            // AadlBa.g:2487:10: ( ( 'e' ) ( '+' | '-' )? ( DIGIT )+ )
            // AadlBa.g:2487:12: ( 'e' ) ( '+' | '-' )? ( DIGIT )+
            {
            // AadlBa.g:2487:12: ( 'e' )
            // AadlBa.g:2487:13: 'e'
            {
    ...
    public final void mINT_EXPONENT() throws RecognitionException {
        try {
            // AadlBa.g:2490:14: ( ( 'e' ) ( '+' )? ( DIGIT )+ )
            // AadlBa.g:2490:16: ( 'e' ) ( '+' )? ( DIGIT )+
            {
            // AadlBa.g:2490:16: ( 'e' )
            // AadlBa.g:2490:17: 'e'
            {
    ...
    public final void mBASED_INTEGER() throws RecognitionException {
        try {
            // AadlBa.g:2496:15: ( ( EXTENDED_DIGIT ) ( ( '_' )? EXTENDED_DIGIT )* )
            // AadlBa.g:2496:17: ( EXTENDED_DIGIT ) ( ( '_' )? EXTENDED_DIGIT )*
            {
            if ( (input.LA(1) >= '0' && input.LA(1) <= '9')||(input.LA(1) >= 'a' && input.LA(1) <= 'f') ) {
                input.consume();
            }
            ...
            // AadlBa.g:2496:36: ( ( '_' )? EXTENDED_DIGIT )*
            loop22:
            do {
                int alt22=2;
                ...
                switch (alt22) {
            	case 1 :
            	    // AadlBa.g:2496:38: ( '_' )? EXTENDED_DIGIT
            	    {
            	    // AadlBa.g:2496:38: ( '_' )?
            	    int alt21=2;
    ...
    public final void mBASE() throws RecognitionException {
        try {
            // AadlBa.g:2499:6: ( DIGIT ( DIGIT )? )
            // AadlBa.g:2499:8: DIGIT ( DIGIT )?
            {
            mDIGIT(); 


            // AadlBa.g:2499:14: ( DIGIT )?
            int alt23=2;
    ...
    public final void mSL_COMMENT() throws RecognitionException {
        try {
            ...
            // AadlBa.g:2517:3: (comment= '--' (~ ( '\\n' | '\\r' ) )* )
            // AadlBa.g:2517:5: comment= '--' (~ ( '\\n' | '\\r' ) )*
            {
    ...
    public final void mESC() throws RecognitionException {
        try {
            // AadlBa.g:2534:3: ( '\\\\' ( 'n' | 'r' | 't' | 'b' | 'f' | '\"' | '\\'' | '\\\\' | ( 'u' )+ HEX_DIGIT HEX_DIGIT HEX_DIGIT HEX_DIGIT | '0' .. '3' ( '0' .. '7' ( '0' .. '7' )? )? | '4' .. '7' ( '0' .. '7' )? ) )
            // AadlBa.g:2534:5: '\\\\' ( 'n' | 'r' | 't' | 'b' | 'f' | '\"' | '\\'' | '\\\\' | ( 'u' )+ HEX_DIGIT HEX_DIGIT HEX_DIGIT HEX_DIGIT | '0' .. '3' ( '0' .. '7' ( '0' .. '7' )? )? | '4' .. '7' ( '0' .. '7' )? )
            {
            match('\\'); 

            // AadlBa.g:2535:5: ( 'n' | 'r' | 't' | 'b' | 'f' | '\"' | '\\'' | '\\\\' | ( 'u' )+ HEX_DIGIT HEX_DIGIT HEX_DIGIT HEX_DIGIT | '0' .. '3' ( '0' .. '7' ( '0' .. '7' )? )? | '4' .. '7' ( '0' .. '7' )? )
            int alt30=11;
            switch ( input.LA(1) ) {
            case 'n':
                {
            ...
            switch (alt30) {
                ...
                case 8 :
                    ...
                    break;
                case 9 :
                    // AadlBa.g:2543:7: ( 'u' )+ HEX_DIGIT HEX_DIGIT HEX_DIGIT HEX_DIGIT
                    {
                    // AadlBa.g:2543:7: ( 'u' )+
                    int cnt26=0;
                    loop26:
                    ...
                    break;
                case 10 :
                    // AadlBa.g:2544:7: '0' .. '3' ( '0' .. '7' ( '0' .. '7' )? )?
                    {
                    matchRange('0','3'); 

                    // AadlBa.g:2545:7: ( '0' .. '7' ( '0' .. '7' )? )?
                    int alt28=2;
