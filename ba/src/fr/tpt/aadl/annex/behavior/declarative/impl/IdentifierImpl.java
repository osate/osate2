...
import fr.tpt.aadl.annex.behavior.aadlba.impl.BehaviorStateImpl;
 ...
 * <ul>
 *   <li>{@link fr.tpt.aadl.annex.behavior.declarative.impl.IdentifierImpl#getOsateRef <em>Osate Ref</em>}</li>
 *   <li>{@link fr.tpt.aadl.annex.behavior.declarative.impl.IdentifierImpl#getBaRef <em>Ba Ref</em>}</li>
 *   <li>{@link fr.tpt.aadl.annex.behavior.declarative.impl.IdentifierImpl#getId <em>Id</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
	...
	public void setOsateRef(Element newOsateRef) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					DeclarativePackage.IDENTIFIER__OSATE_REF, oldOsateRef,
					osateRef));
	}
	...
	public BehaviorElement getBaRef() {
		if (baRef != null && ((EObject) baRef).eIsProxy()) {
			...
			if (baRef != oldBaRef) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							DeclarativePackage.IDENTIFIER__BA_REF, oldBaRef,
							baRef));
			}
		}
		return baRef;
