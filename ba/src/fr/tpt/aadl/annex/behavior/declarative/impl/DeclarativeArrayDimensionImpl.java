 ...
 * <ul>
 *   <li>{@link fr.tpt.aadl.annex.behavior.declarative.impl.DeclarativeArrayDimensionImpl#getOsateRef <em>Osate Ref</em>}</li>
 *   <li>{@link fr.tpt.aadl.annex.behavior.declarative.impl.DeclarativeArrayDimensionImpl#getBaRef <em>Ba Ref</em>}</li>
 *   <li>{@link fr.tpt.aadl.annex.behavior.declarative.impl.DeclarativeArrayDimensionImpl#getDimension <em>Dimension</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class DeclarativeArrayDimensionImpl extends ArrayDimensionImpl implements
	 ...
	 * @generated
	 */
	public NotificationChain basicSetDimension(
			IntegerValueConstant newDimension, NotificationChain msgs) {
	...
	public void setDimension(IntegerValueConstant newDimension) {
		if (newDimension != dimension) {
			...
			if (dimension != null)
				msgs = ((InternalEObject) dimension)
						.eInverseRemove(
								this,
			...
			if (newDimension != null)
				msgs = ((InternalEObject) newDimension)
						.eInverseAdd(
								this,
								EOPPOSITE_FEATURE_BASE
										- DeclarativePackage.DECLARATIVE_ARRAY_DIMENSION__DIMENSION,
