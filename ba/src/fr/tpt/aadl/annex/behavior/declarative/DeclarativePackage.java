...
public interface DeclarativePackage extends EPackage
{
  ...
  DeclarativePackage eINSTANCE =
        fr.tpt.aadl.annex.behavior.declarative.impl.DeclarativePackageImpl
              .init() ;
   ...
   * @generated
   */
  int DECLARATIVE_BEHAVIOR_ELEMENT = 0 ;
   ...
   * @generated
   */
  int DECLARATIVE_BEHAVIOR_TRANSITION = 9 ;
   ...
   * @generated
   */
  int DECLARATIVE_ARRAY_DIMENSION = 10 ;
