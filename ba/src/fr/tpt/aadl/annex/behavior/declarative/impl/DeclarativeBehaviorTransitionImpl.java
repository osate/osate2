...
import fr.tpt.aadl.annex.behavior.aadlba.impl.BehaviorTransitionImpl;
 ...
 * <ul>
 *   <li>{@link fr.tpt.aadl.annex.behavior.declarative.impl.DeclarativeBehaviorTransitionImpl#getOsateRef <em>Osate Ref</em>}</li>
 *   <li>{@link fr.tpt.aadl.annex.behavior.declarative.impl.DeclarativeBehaviorTransitionImpl#getBaRef <em>Ba Ref</em>}</li>
 *   <li>{@link fr.tpt.aadl.annex.behavior.declarative.impl.DeclarativeBehaviorTransitionImpl#getSrcStates <em>Src States</em>}</li>
 *   <li>{@link fr.tpt.aadl.annex.behavior.declarative.impl.DeclarativeBehaviorTransitionImpl#getDestState <em>Dest State</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class DeclarativeBehaviorTransitionImpl extends BehaviorTransitionImpl
		implements DeclarativeBehaviorTransition {
	/**
	...
	public EList<Identifier> getSrcStates() {
		if (srcStates == null) {
			srcStates = new EObjectContainmentEList<Identifier>(
					Identifier.class,
					this,
	...
	public void setDestState(Identifier newDestState) {
		if (newDestState != destState) {
			...
			if (destState != null)
				msgs = ((InternalEObject) destState)
						.eInverseRemove(
								this,
			...
			if (newDestState != null)
				msgs = ((InternalEObject) newDestState)
						.eInverseAdd(
								this,
								EOPPOSITE_FEATURE_BASE
										- DeclarativePackage.DECLARATIVE_BEHAVIOR_TRANSITION__DEST_STATE,
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd,
		...
		case DeclarativePackage.DECLARATIVE_BEHAVIOR_TRANSITION__SRC_STATES:
			return ((InternalEList<?>) getSrcStates()).basicRemove(otherEnd,
					msgs);
