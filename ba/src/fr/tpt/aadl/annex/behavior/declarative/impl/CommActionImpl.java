...
import fr.tpt.aadl.annex.behavior.aadlba.impl.BehaviorElementImpl;
 ...
 * <ul>
 *   <li>{@link fr.tpt.aadl.annex.behavior.declarative.impl.CommActionImpl#getOsateRef <em>Osate Ref</em>}</li>
 *   <li>{@link fr.tpt.aadl.annex.behavior.declarative.impl.CommActionImpl#getBaRef <em>Ba Ref</em>}</li>
 *   <li>{@link fr.tpt.aadl.annex.behavior.declarative.impl.CommActionImpl#getParameters <em>Parameters</em>}</li>
 *   <li>{@link fr.tpt.aadl.annex.behavior.declarative.impl.CommActionImpl#isPortFreeze <em>Port Freeze</em>}</li>
 *   <li>{@link fr.tpt.aadl.annex.behavior.declarative.impl.CommActionImpl#isPortDequeue <em>Port Dequeue</em>}</li>
 *   <li>{@link fr.tpt.aadl.annex.behavior.declarative.impl.CommActionImpl#isLock <em>Lock</em>}</li>
 *   <li>{@link fr.tpt.aadl.annex.behavior.declarative.impl.CommActionImpl#isUnlock <em>Unlock</em>}</li>
 *   <li>{@link fr.tpt.aadl.annex.behavior.declarative.impl.CommActionImpl#getTarget <em>Target</em>}</li>
 *   <li>{@link fr.tpt.aadl.annex.behavior.declarative.impl.CommActionImpl#getQualifiedName <em>Qualified Name</em>}</li>
 *   <li>{@link fr.tpt.aadl.annex.behavior.declarative.impl.CommActionImpl#getReference <em>Reference</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class CommActionImpl extends BehaviorElementImpl implements CommAction {
	...
	public BehaviorElement getBaRef() {
		if (baRef != null && ((EObject) baRef).eIsProxy()) {
			...
			if (baRef != oldBaRef) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							DeclarativePackage.COMM_ACTION__BA_REF, oldBaRef,
							baRef));
			}
		}
		return baRef;
	...
	public NotificationChain basicSetTarget(Target newTarget,
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this,
					Notification.SET, DeclarativePackage.COMM_ACTION__TARGET,
					oldTarget, newTarget);
			if (msgs == null)
				msgs = notification;
			else
	...
	public void setTarget(Target newTarget) {
		if (newTarget != target) {
			...
			if (target != null)
				msgs = ((InternalEObject) target).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE
								- DeclarativePackage.COMM_ACTION__TARGET, null,
						msgs);
			if (newTarget != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					DeclarativePackage.COMM_ACTION__TARGET, newTarget,
					newTarget));
	}
	...
	public NotificationChain basicSetQualifiedName(
			QualifiedNamedElement newQualifiedName, NotificationChain msgs) {
	...
	public void setQualifiedName(QualifiedNamedElement newQualifiedName) {
		if (newQualifiedName != qualifiedName) {
			...
			if (qualifiedName != null)
				msgs = ((InternalEObject) qualifiedName)
						.eInverseRemove(
								this,
								EOPPOSITE_FEATURE_BASE
										- DeclarativePackage.COMM_ACTION__QUALIFIED_NAME,
			...
			if (newQualifiedName != null)
				msgs = ((InternalEObject) newQualifiedName)
						.eInverseAdd(
								this,
								EOPPOSITE_FEATURE_BASE
										- DeclarativePackage.COMM_ACTION__QUALIFIED_NAME,
	...
	public void eSet(int featureID, Object newValue) {
		...
		case DeclarativePackage.COMM_ACTION__PARAMETERS:
			...
			getParameters().addAll(
					(Collection<? extends ParameterLabel>) newValue);
			return;
		case DeclarativePackage.COMM_ACTION__PORT_FREEZE:
