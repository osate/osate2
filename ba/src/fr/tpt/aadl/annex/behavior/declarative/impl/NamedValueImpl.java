 ...
 * <ul>
 *   <li>{@link fr.tpt.aadl.annex.behavior.declarative.impl.NamedValueImpl#getOsateRef <em>Osate Ref</em>}</li>
 *   <li>{@link fr.tpt.aadl.annex.behavior.declarative.impl.NamedValueImpl#getBaRef <em>Ba Ref</em>}</li>
 *   <li>{@link fr.tpt.aadl.annex.behavior.declarative.impl.NamedValueImpl#getReference <em>Reference</em>}</li>
 *   <li>{@link fr.tpt.aadl.annex.behavior.declarative.impl.NamedValueImpl#isDequeue <em>Dequeue</em>}</li>
 *   <li>{@link fr.tpt.aadl.annex.behavior.declarative.impl.NamedValueImpl#isFresh <em>Fresh</em>}</li>
 *   <li>{@link fr.tpt.aadl.annex.behavior.declarative.impl.NamedValueImpl#isCount <em>Count</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class NamedValueImpl extends BehaviorElementImpl implements NamedValue {
	...
	public BehaviorElement getBaRef() {
		if (baRef != null && ((EObject) baRef).eIsProxy()) {
			...
			if (baRef != oldBaRef) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							DeclarativePackage.NAMED_VALUE__BA_REF, oldBaRef,
							baRef));
			}
		}
		return baRef;
	...
	public void setDequeue(boolean newDequeue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					DeclarativePackage.NAMED_VALUE__DEQUEUE, oldDequeue,
					dequeue));
	}
