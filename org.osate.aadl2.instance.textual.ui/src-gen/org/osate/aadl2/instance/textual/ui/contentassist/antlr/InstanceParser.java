		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getComponentInstanceAccess().getClassifierAssignment_5(), "rule__ComponentInstance__ClassifierAssignment_5");
					put(grammarAccess.getComponentInstanceAccess().getSubcomponentAssignment_7(), "rule__ComponentInstance__SubcomponentAssignment_7");
					...
					put(grammarAccess.getComponentInstanceAccess().getOwnedPropertyAssociationAssignment_8_1_7(), "rule__ComponentInstance__OwnedPropertyAssociationAssignment_8_1_7");
