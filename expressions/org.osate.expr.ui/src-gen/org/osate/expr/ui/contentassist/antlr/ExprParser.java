		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getTypeDeclAccess().getTypeAssignment_4(), "rule__TypeDecl__TypeAssignment_4");
					put(grammarAccess.getVarDeclAccess().getConstAssignment_1_0(), "rule__VarDecl__ConstAssignment_1_0");
					put(grammarAccess.getVarDeclAccess().getNameAssignment_2(), "rule__VarDecl__NameAssignment_2");
					put(grammarAccess.getVarDeclAccess().getTypeAssignment_3_1(), "rule__VarDecl__TypeAssignment_3_1");
					put(grammarAccess.getVarDeclAccess().getValueAssignment_4_1(), "rule__VarDecl__ValueAssignment_4_1");
					put(grammarAccess.getFunDeclAccess().getNameAssignment_2(), "rule__FunDecl__NameAssignment_2");
