...
:
	(
		...
		rulePropertyAssociation
		{ after(grammarAccess.getTypeDeclAccess().getOwnedPropertyAssociationsPropertyAssociationParserRuleCall_4_1_0()); }
	)
;
finally {
	restoreStackSize(stackSize);
...
:
	(
		...
		rulePropertyAssociation
		{ after(grammarAccess.getTypeDeclAccess().getOwnedPropertyAssociationsPropertyAssociationParserRuleCall_4_2_1_0()); }
	)
;
finally {
	restoreStackSize(stackSize);
...
:
	(
		...
		(
			...
			ruleQPREF
			{ after(grammarAccess.getPropertyExpressionAccess().getPropertyAbstractNamedValueQPREFParserRuleCall_1_1_0_1()); }
		)
...
:
	(
		...
		(
			...
			RULE_ID
			{ after(grammarAccess.getWrappedNamedElementAccess().getElemNamedElementIDTerminalRuleCall_1_0_1()); }
		)
...
:
	(
		...
		ruleINTVALUE
		{ after(grammarAccess.getEIntegerLiteralAccess().getValueINTVALUEParserRuleCall_1_0()); }
	)
;
finally {
	restoreStackSize(stackSize);
...
:
	(
		...
		ruleSignedReal
		{ after(grammarAccess.getERealLiteralAccess().getValueSignedRealParserRuleCall_1_0()); }
	)
;
finally {
	restoreStackSize(stackSize);
...
:
	(
		...
		(
			...
			ruleQPREF
			{ after(grammarAccess.getPropertyAssociationAccess().getPropertyPropertyQPREFParserRuleCall_0_0_1()); }
		)
...
:
	(
		...
		ruleOptionalModalPropertyValue
		{ after(grammarAccess.getPropertyAssociationAccess().getOwnedValueOptionalModalPropertyValueParserRuleCall_3_0_0()); }
	)
;
finally {
	restoreStackSize(stackSize);
...
:
	(
		...
		ruleOptionalModalPropertyValue
		{ after(grammarAccess.getPropertyAssociationAccess().getOwnedValueOptionalModalPropertyValueParserRuleCall_3_1_1_0()); }
	)
;
finally {
	restoreStackSize(stackSize);
