...
public class Aadl2QualifiedNameHelper {

	public static QualifiedName getFullyQualifiedName(final EObject obj) {
		if (obj instanceof AadlPackage || obj instanceof Classifier || obj instanceof PropertyConstant
			...
			String qualifiedNameAsString = getTheName((NamedElement) obj);
	...
	protected static String getTheName(NamedElement namedElement) {
