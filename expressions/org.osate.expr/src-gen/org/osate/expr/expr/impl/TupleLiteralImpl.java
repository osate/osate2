 ...
 * </p>
 * <ul>
 *   <li>{@link org.osate.expr.expr.impl.TupleLiteralImpl#getElements <em>Elements</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TupleLiteralImpl extends LiteralImpl implements TupleLiteral
{
  ...
  public EList<Expression> getElements()
  {
    if (elements == null)
    {
      elements = new EObjectContainmentEList<Expression>(Expression.class, this, ExprPackage.TUPLE_LITERAL__ELEMENTS);
    }
    return elements;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case ExprPackage.TUPLE_LITERAL__ELEMENTS:
