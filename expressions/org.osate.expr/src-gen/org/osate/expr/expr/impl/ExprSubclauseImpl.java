 ...
 * </p>
 * <ul>
 *   <li>{@link org.osate.expr.expr.impl.ExprSubclauseImpl#getGreetings <em>Greetings</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ExprSubclauseImpl extends AnnexSubclauseImpl implements ExprSubclause
{
  ...
  public EList<Greeting> getGreetings()
  {
    if (greetings == null)
    {
      greetings = new EObjectContainmentEList<Greeting>(Greeting.class, this, ExprPackage.EXPR_SUBCLAUSE__GREETINGS);
    }
    return greetings;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case ExprPackage.EXPR_SUBCLAUSE__GREETINGS:
