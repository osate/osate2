 ...
 * </p>
 * <ul>
 *   <li>{@link org.osate.expr.expr.impl.SetLiteralImpl#getElements <em>Elements</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SetLiteralImpl extends LiteralImpl implements SetLiteral
{
  ...
  public EList<Expression> getElements()
  {
    if (elements == null)
    {
      elements = new EObjectContainmentEList<Expression>(Expression.class, this, ExprPackage.SET_LITERAL__ELEMENTS);
    }
    return elements;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case ExprPackage.SET_LITERAL__ELEMENTS:
