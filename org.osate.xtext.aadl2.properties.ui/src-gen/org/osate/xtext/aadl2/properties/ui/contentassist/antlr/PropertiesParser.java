		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getContainedPropertyAssociationAccess().getGroup_3_0_1(), "rule__ContainedPropertyAssociation__Group_3_0_1__0");
					...
					put(grammarAccess.getPropertyAssociationAccess().getGroup_3_0_1(), "rule__PropertyAssociation__Group_3_0_1__0");
					...
					put(grammarAccess.getContainedPropertyAssociationAccess().getOwnedValueAssignment_3_0_1_0(), "rule__ContainedPropertyAssociation__OwnedValueAssignment_3_0_1_0");
					put(grammarAccess.getContainedPropertyAssociationAccess().getOwnedValueAssignment_3_0_2(), "rule__ContainedPropertyAssociation__OwnedValueAssignment_3_0_2");
					...
					put(grammarAccess.getPropertyAssociationAccess().getOwnedValueAssignment_3_0_1_0(), "rule__PropertyAssociation__OwnedValueAssignment_3_0_1_0");
					put(grammarAccess.getPropertyAssociationAccess().getOwnedValueAssignment_3_0_2(), "rule__PropertyAssociation__OwnedValueAssignment_3_0_2");
