...
public class Aadl2JavaValidatorTest extends OsateTest {
    ...
    try {
      ...
      final Procedure1<AadlPackage> _function = new Procedure1<AadlPackage>() {
        public void apply(final AadlPackage it) {
          ...
          final List<Issue> allIssues = Aadl2JavaValidatorTest.this._validationTestHelper.validate(it);
          final Function1<Issue, Boolean> _function = new Function1<Issue, Boolean>() {
            public Boolean apply(final Issue it) {
              return Boolean.valueOf(it.isSyntaxError());
            }
          };
          Iterable<Issue> _filter = IterableExtensions.<Issue>filter(allIssues, _function);
          boolean _isEmpty = IterableExtensions.isEmpty(_filter);
          Assert.assertTrue(_isEmpty);
          Aadl2JavaValidatorTest.this.assertAllCrossReferencesResolvable(it);
          int _size = allIssues.size();
          Assert.assertEquals(398, _size);
            ...
            public void apply(final AbstractImplementation it) {
              ...
              final Procedure1<DataSubcomponent> _function = new Procedure1<DataSubcomponent>() {
                public void apply(final DataSubcomponent it) {
                  ...
                  Aadl2JavaValidatorTest.assertError(it, allIssues, 
              ...
              AccessConnection _get_1 = _ownedAccessConnections.get(0);
              final Procedure1<AccessConnection> _function_1 = new Procedure1<AccessConnection>() {
                public void apply(final AccessConnection it) {
                  ...
                  Aadl2JavaValidatorTest.assertNoIssues(_source, allIssues);
                  ConnectedElement _destination = it.getDestination();
                  Aadl2JavaValidatorTest.assertNoIssues(_destination, allIssues);
                }
              };
              ...
              AccessConnection _get_2 = _ownedAccessConnections_1.get(1);
              final Procedure1<AccessConnection> _function_2 = new Procedure1<AccessConnection>() {
                public void apply(final AccessConnection it) {
                  String _name = it.getName();
                  Assert.assertEquals("aconn2", _name);
                  ConnectedElement _source = it.getSource();
                  Aadl2JavaValidatorTest.assertNoIssues(_source, allIssues);
                  ConnectedElement _destination = it.getDestination();
                  Aadl2JavaValidatorTest.assertNoIssues(_destination, allIssues);
              ...
              AccessConnection _get_3 = _ownedAccessConnections_2.get(2);
              final Procedure1<AccessConnection> _function_3 = new Procedure1<AccessConnection>() {
                public void apply(final AccessConnection it) {
                  String _name = it.getName();
                  Assert.assertEquals("aconn3", _name);
                  ConnectedElement _source = it.getSource();
                  Aadl2JavaValidatorTest.assertNoIssues(_source, allIssues);
                  ConnectedElement _destination = it.getDestination();
                  Aadl2JavaValidatorTest.assertNoIssues(_destination, allIssues);
              ...
              AccessConnection _get_4 = _ownedAccessConnections_3.get(3);
              final Procedure1<AccessConnection> _function_4 = new Procedure1<AccessConnection>() {
                public void apply(final AccessConnection it) {
                  String _name = it.getName();
                  Assert.assertEquals("aconn4", _name);
                  ConnectedElement _source = it.getSource();
                  Aadl2JavaValidatorTest.assertNoIssues(_source, allIssues);
                  ConnectedElement _destination = it.getDestination();
                  Aadl2JavaValidatorTest.assertNoIssues(_destination, allIssues);
              ...
              AccessConnection _get_5 = _ownedAccessConnections_4.get(4);
              final Procedure1<AccessConnection> _function_5 = new Procedure1<AccessConnection>() {
                public void apply(final AccessConnection it) {
                  String _name = it.getName();
                  Assert.assertEquals("aconn5", _name);
                  ConnectedElement _source = it.getSource();
                  Aadl2JavaValidatorTest.assertNoIssues(_source, allIssues);
                  ConnectedElement _destination = it.getDestination();
                  Aadl2JavaValidatorTest.assertNoIssues(_destination, allIssues);
              ...
              AccessConnection _get_6 = _ownedAccessConnections_5.get(5);
              final Procedure1<AccessConnection> _function_6 = new Procedure1<AccessConnection>() {
                public void apply(final AccessConnection it) {
                  String _name = it.getName();
                  Assert.assertEquals("aconn6", _name);
                  ConnectedElement _source = it.getSource();
                  Aadl2JavaValidatorTest.assertError(_source, allIssues, "A \'port proxy\' is not a valid access connection end.");
                  ConnectedElement _destination = it.getDestination();
                  Aadl2JavaValidatorTest.assertNoIssues(_destination, allIssues);
                }
              };
              ...
              AccessConnection _get_7 = _ownedAccessConnections_6.get(6);
              final Procedure1<AccessConnection> _function_7 = new Procedure1<AccessConnection>() {
                public void apply(final AccessConnection it) {
                  String _name = it.getName();
                  Assert.assertEquals("aconn7", _name);
                  ConnectedElement _source = it.getSource();
                  Aadl2JavaValidatorTest.assertError(_source, allIssues, "An \'event data source\' is not a valid access connection end.");
                  ConnectedElement _destination = it.getDestination();
                  Aadl2JavaValidatorTest.assertNoIssues(_destination, allIssues);
                }
              };
              ...
              AccessConnection _get_8 = _ownedAccessConnections_7.get(7);
              final Procedure1<AccessConnection> _function_8 = new Procedure1<AccessConnection>() {
                public void apply(final AccessConnection it) {
                  String _name = it.getName();
                  Assert.assertEquals("aconn8", _name);
                  ConnectedElement _source = it.getSource();
                  Aadl2JavaValidatorTest.assertError(_source, allIssues, "An \'abstract feature\' is not a valid access connection end.");
                  ConnectedElement _destination = it.getDestination();
                  Aadl2JavaValidatorTest.assertNoIssues(_destination, allIssues);
                }
              };
              ...
              AccessConnection _get_9 = _ownedAccessConnections_8.get(8);
              final Procedure1<AccessConnection> _function_9 = new Procedure1<AccessConnection>() {
                public void apply(final AccessConnection it) {
                  String _name = it.getName();
                  Assert.assertEquals("aconn9", _name);
                  ConnectedElement _source = it.getSource();
                  Aadl2JavaValidatorTest.assertError(_source, allIssues, "A \'feature group\' is not a valid access connection end.");
                  ConnectedElement _destination = it.getDestination();
                  Aadl2JavaValidatorTest.assertNoIssues(_destination, allIssues);
                }
              };
              ...
              AccessConnection _get_10 = _ownedAccessConnections_9.get(9);
              final Procedure1<AccessConnection> _function_10 = new Procedure1<AccessConnection>() {
                public void apply(final AccessConnection it) {
                  String _name = it.getName();
                  Assert.assertEquals("aconn10", _name);
                  ConnectedElement _source = it.getSource();
                  Aadl2JavaValidatorTest.assertNoIssues(_source, allIssues);
                  ConnectedElement _destination = it.getDestination();
                  Aadl2JavaValidatorTest.assertNoIssues(_destination, allIssues);
              ...
              AccessConnection _get_11 = _ownedAccessConnections_10.get(10);
              final Procedure1<AccessConnection> _function_11 = new Procedure1<AccessConnection>() {
                public void apply(final AccessConnection it) {
                  String _name = it.getName();
                  Assert.assertEquals("aconn11", _name);
                  ConnectedElement _source = it.getSource();
                  Aadl2JavaValidatorTest.assertNoIssues(_source, allIssues);
                  ConnectedElement _destination = it.getDestination();
                  Aadl2JavaValidatorTest.assertNoIssues(_destination, allIssues);
              ...
              AccessConnection _get_12 = _ownedAccessConnections_11.get(11);
              final Procedure1<AccessConnection> _function_12 = new Procedure1<AccessConnection>() {
                public void apply(final AccessConnection it) {
                  String _name = it.getName();
                  Assert.assertEquals("aconn12", _name);
                  ConnectedElement _source = it.getSource();
                  Aadl2JavaValidatorTest.assertError(_source, allIssues, "An \'event port\' is not a valid access connection end.");
                  ConnectedElement _destination = it.getDestination();
                  Aadl2JavaValidatorTest.assertNoIssues(_destination, allIssues);
                }
              };
              ...
              AccessConnection _get_13 = _ownedAccessConnections_12.get(12);
              final Procedure1<AccessConnection> _function_13 = new Procedure1<AccessConnection>() {
                public void apply(final AccessConnection it) {
                  String _name = it.getName();
                  Assert.assertEquals("aconn13", _name);
                  ConnectedElement _source = it.getSource();
                  Aadl2JavaValidatorTest.assertError(_source, allIssues, "A \'data port\' is not a valid access connection end.");
                  ConnectedElement _destination = it.getDestination();
                  Aadl2JavaValidatorTest.assertNoIssues(_destination, allIssues);
                }
              };
              ...
              AccessConnection _get_14 = _ownedAccessConnections_13.get(13);
              final Procedure1<AccessConnection> _function_14 = new Procedure1<AccessConnection>() {
                public void apply(final AccessConnection it) {
                  String _name = it.getName();
                  Assert.assertEquals("aconn14", _name);
                  ConnectedElement _source = it.getSource();
                  Aadl2JavaValidatorTest.assertError(_source, allIssues, "An \'event data port\' is not a valid access connection end.");
                  ConnectedElement _destination = it.getDestination();
                  Aadl2JavaValidatorTest.assertNoIssues(_destination, allIssues);
                }
              };
              ...
              AccessConnection _get_15 = _ownedAccessConnections_14.get(14);
              final Procedure1<AccessConnection> _function_15 = new Procedure1<AccessConnection>() {
                public void apply(final AccessConnection it) {
                  String _name = it.getName();
                  Assert.assertEquals("aconn15", _name);
                  ConnectedElement _source = it.getSource();
                  Aadl2JavaValidatorTest.assertError(_source, allIssues, "Anything in a \'data port\' is not a valid access connection end.");
                  ConnectedElement _destination = it.getDestination();
                  Aadl2JavaValidatorTest.assertNoIssues(_destination, allIssues);
                }
              };
              ...
              AccessConnection _get_16 = _ownedAccessConnections_15.get(15);
              ...
              AccessConnection _get_17 = _ownedAccessConnections_16.get(16);
              ...
              AccessConnection _get_18 = _ownedAccessConnections_17.get(17);
              ...
              AccessConnection _get_19 = _ownedAccessConnections_18.get(18);
              ...
              AccessConnection _get_20 = _ownedAccessConnections_19.get(19);
              ...
              AccessConnection _get_21 = _ownedAccessConnections_20.get(20);
              ...
              AccessConnection _get_22 = _ownedAccessConnections_21.get(21);
              ...
              AccessConnection _get_23 = _ownedAccessConnections_22.get(22);
              ...
              AccessConnection _get_24 = _ownedAccessConnections_23.get(23);
              ...
              AccessConnection _get_25 = _ownedAccessConnections_24.get(24);
              ...
              AccessConnection _get_26 = _ownedAccessConnections_25.get(25);
              ...
              AccessConnection _get_27 = _ownedAccessConnections_26.get(26);
              ...
              AccessConnection _get_28 = _ownedAccessConnections_27.get(27);
              ...
              AccessConnection _get_29 = _ownedAccessConnections_28.get(28);
              final Procedure1<AccessConnection> _function_29 = new Procedure1<AccessConnection>() {
                public void apply(final AccessConnection it) {
                  String _name = it.getName();
                  Assert.assertEquals("aconn29", _name);
                  ConnectedElement _source = it.getSource();
                  Aadl2JavaValidatorTest.assertError(_source, allIssues, "Anything in an \'event data port\' is not a valid access connection end.");
                  ConnectedElement _destination = it.getDestination();
                  Aadl2JavaValidatorTest.assertNoIssues(_destination, allIssues);
                }
              };
              ...
              AccessConnection _get_30 = _ownedAccessConnections_29.get(29);
              ...
              AccessConnection _get_31 = _ownedAccessConnections_30.get(30);
              ...
              AccessConnection _get_32 = _ownedAccessConnections_31.get(31);
              ...
              AccessConnection _get_33 = _ownedAccessConnections_32.get(32);
              ...
              AccessConnection _get_34 = _ownedAccessConnections_33.get(33);
              ...
              AccessConnection _get_35 = _ownedAccessConnections_34.get(34);
              ...
              AccessConnection _get_36 = _ownedAccessConnections_35.get(35);
              ...
              AccessConnection _get_37 = _ownedAccessConnections_36.get(36);
              ...
              AccessConnection _get_38 = _ownedAccessConnections_37.get(37);
              ...
              AccessConnection _get_39 = _ownedAccessConnections_38.get(38);
              ...
              AccessConnection _get_40 = _ownedAccessConnections_39.get(39);
              ...
              AccessConnection _get_41 = _ownedAccessConnections_40.get(40);
              ...
              AccessConnection _get_42 = _ownedAccessConnections_41.get(41);
              ...
              AccessConnection _get_43 = _ownedAccessConnections_42.get(42);
              final Procedure1<AccessConnection> _function_43 = new Procedure1<AccessConnection>() {
                public void apply(final AccessConnection it) {
                  String _name = it.getName();
                  Assert.assertEquals("aconn43", _name);
                  ConnectedElement _source = it.getSource();
                  Aadl2JavaValidatorTest.assertError(_source, allIssues, "An \'abstract feature\' in a \'feature group\' is not a valid access connection end.");
                  ConnectedElement _destination = it.getDestination();
                  Aadl2JavaValidatorTest.assertNoIssues(_destination, allIssues);
                }
              };
              ...
              AccessConnection _get_44 = _ownedAccessConnections_43.get(43);
              final Procedure1<AccessConnection> _function_44 = new Procedure1<AccessConnection>() {
                public void apply(final AccessConnection it) {
                  String _name = it.getName();
                  Assert.assertEquals("aconn44", _name);
                  ConnectedElement _source = it.getSource();
                  Aadl2JavaValidatorTest.assertError(_source, allIssues, "A \'feature group\' in a \'feature group\' is not a valid access connection end.");
                  ConnectedElement _destination = it.getDestination();
                  Aadl2JavaValidatorTest.assertNoIssues(_destination, allIssues);
                }
              };
              ...
              AccessConnection _get_45 = _ownedAccessConnections_44.get(44);
              final Procedure1<AccessConnection> _function_45 = new Procedure1<AccessConnection>() {
                public void apply(final AccessConnection it) {
                  String _name = it.getName();
                  Assert.assertEquals("aconn45", _name);
                  ConnectedElement _source = it.getSource();
                  Aadl2JavaValidatorTest.assertError(_source, allIssues, "A \'parameter\' in a \'feature group\' is not a valid access connection end.");
                  ConnectedElement _destination = it.getDestination();
                  Aadl2JavaValidatorTest.assertNoIssues(_destination, allIssues);
                }
              };
              ...
              AccessConnection _get_46 = _ownedAccessConnections_45.get(45);
              final Procedure1<AccessConnection> _function_46 = new Procedure1<AccessConnection>() {
                public void apply(final AccessConnection it) {
                  String _name = it.getName();
                  Assert.assertEquals("aconn46", _name);
                  ConnectedElement _source = it.getSource();
                  Aadl2JavaValidatorTest.assertNoIssues(_source, allIssues);
                  ConnectedElement _destination = it.getDestination();
                  Aadl2JavaValidatorTest.assertNoIssues(_destination, allIssues);
              ...
              AccessConnection _get_47 = _ownedAccessConnections_46.get(46);
              final Procedure1<AccessConnection> _function_47 = new Procedure1<AccessConnection>() {
                public void apply(final AccessConnection it) {
                  String _name = it.getName();
                  Assert.assertEquals("aconn47", _name);
                  ConnectedElement _source = it.getSource();
                  Aadl2JavaValidatorTest.assertNoIssues(_source, allIssues);
                  ConnectedElement _destination = it.getDestination();
                  Aadl2JavaValidatorTest.assertNoIssues(_destination, allIssues);
              ...
              AccessConnection _get_48 = _ownedAccessConnections_47.get(47);
              final Procedure1<AccessConnection> _function_48 = new Procedure1<AccessConnection>() {
                public void apply(final AccessConnection it) {
                  String _name = it.getName();
                  Assert.assertEquals("aconn48", _name);
                  ConnectedElement _source = it.getSource();
                  Aadl2JavaValidatorTest.assertError(_source, allIssues, "An \'event port\' in a \'feature group\' is not a valid access connection end.");
                  ConnectedElement _destination = it.getDestination();
                  Aadl2JavaValidatorTest.assertNoIssues(_destination, allIssues);
                }
              };
              ...
              AccessConnection _get_49 = _ownedAccessConnections_48.get(48);
              final Procedure1<AccessConnection> _function_49 = new Procedure1<AccessConnection>() {
                public void apply(final AccessConnection it) {
                  String _name = it.getName();
                  Assert.assertEquals("aconn49", _name);
                  ConnectedElement _source = it.getSource();
                  Aadl2JavaValidatorTest.assertError(_source, allIssues, "A \'data port\' in a \'feature group\' is not a valid access connection end.");
                  ConnectedElement _destination = it.getDestination();
                  Aadl2JavaValidatorTest.assertNoIssues(_destination, allIssues);
                }
              };
              ...
              AccessConnection _get_50 = _ownedAccessConnections_49.get(49);
              final Procedure1<AccessConnection> _function_50 = new Procedure1<AccessConnection>() {
                public void apply(final AccessConnection it) {
                  String _name = it.getName();
                  Assert.assertEquals("aconn50", _name);
                  ConnectedElement _source = it.getSource();
                  Aadl2JavaValidatorTest.assertError(_source, allIssues, "An \'event data port\' in a \'feature group\' is not a valid access connection end.");
                  ConnectedElement _destination = it.getDestination();
                  Aadl2JavaValidatorTest.assertNoIssues(_destination, allIssues);
                }
              };
              ...
              AccessConnection _get_51 = _ownedAccessConnections_50.get(50);
              final Procedure1<AccessConnection> _function_51 = new Procedure1<AccessConnection>() {
                public void apply(final AccessConnection it) {
                  String _name = it.getName();
                  Assert.assertEquals("aconn51", _name);
                  ConnectedElement _source = it.getSource();
                  Aadl2JavaValidatorTest.assertError(_source, allIssues, "A \'bus subcomponent\' in an \'abstract subcomponent\' is not a valid access connection end.");
                  ConnectedElement _destination = it.getDestination();
                  Aadl2JavaValidatorTest.assertNoIssues(_destination, allIssues);
                }
              };
              ...
              AccessConnection _get_52 = _ownedAccessConnections_51.get(51);
              final Procedure1<AccessConnection> _function_52 = new Procedure1<AccessConnection>() {
                public void apply(final AccessConnection it) {
                  String _name = it.getName();
                  Assert.assertEquals("aconn52", _name);
                  ConnectedElement _source = it.getSource();
                  Aadl2JavaValidatorTest.assertError(_source, allIssues, "A \'data subcomponent\' in an \'abstract subcomponent\' is not a valid access connection end.");
                  ConnectedElement _destination = it.getDestination();
                  Aadl2JavaValidatorTest.assertNoIssues(_destination, allIssues);
                }
              };
              ...
              AccessConnection _get_53 = _ownedAccessConnections_52.get(52);
              final Procedure1<AccessConnection> _function_53 = new Procedure1<AccessConnection>() {
                public void apply(final AccessConnection it) {
                  String _name = it.getName();
                  Assert.assertEquals("aconn53", _name);
                  ConnectedElement _source = it.getSource();
                  Aadl2JavaValidatorTest.assertError(_source, allIssues, "A \'subprogram group subcomponent\' in an \'abstract subcomponent\' is not a valid access connection end.");
                  ConnectedElement _destination = it.getDestination();
                  Aadl2JavaValidatorTest.assertNoIssues(_destination, allIssues);
                }
              };
              ...
              AccessConnection _get_54 = _ownedAccessConnections_53.get(53);
              final Procedure1<AccessConnection> _function_54 = new Procedure1<AccessConnection>() {
                public void apply(final AccessConnection it) {
                  String _name = it.getName();
                  Assert.assertEquals("aconn54", _name);
                  ConnectedElement _source = it.getSource();
                  Aadl2JavaValidatorTest.assertError(_source, allIssues, "A \'subprogram subcomponent\' in an \'abstract subcomponent\' is not a valid access connection end.");
                  ConnectedElement _destination = it.getDestination();
                  Aadl2JavaValidatorTest.assertNoIssues(_destination, allIssues);
                }
              };
              ...
              AccessConnection _get_55 = _ownedAccessConnections_54.get(54);
              final Procedure1<AccessConnection> _function_55 = new Procedure1<AccessConnection>() {
                public void apply(final AccessConnection it) {
                  String _name = it.getName();
                  Assert.assertEquals("aconn55", _name);
                  ConnectedElement _source = it.getSource();
                  Aadl2JavaValidatorTest.assertError(_source, allIssues, "A \'subprogram proxy\' in an \'abstract subcomponent\' is not a valid access connection end.");
                  ConnectedElement _destination = it.getDestination();
                  Aadl2JavaValidatorTest.assertNoIssues(_destination, allIssues);
                }
              };
              ...
              AccessConnection _get_56 = _ownedAccessConnections_55.get(55);
              final Procedure1<AccessConnection> _function_56 = new Procedure1<AccessConnection>() {
                public void apply(final AccessConnection it) {
                  String _name = it.getName();
                  Assert.assertEquals("aconn56", _name);
                  ConnectedElement _source = it.getSource();
                  Aadl2JavaValidatorTest.assertError(_source, allIssues, "A \'port proxy\' in an \'abstract subcomponent\' is not a valid access connection end.");
                  ConnectedElement _destination = it.getDestination();
                  Aadl2JavaValidatorTest.assertNoIssues(_destination, allIssues);
                }
              };
              ...
              AccessConnection _get_57 = _ownedAccessConnections_56.get(56);
              final Procedure1<AccessConnection> _function_57 = new Procedure1<AccessConnection>() {
                public void apply(final AccessConnection it) {
                  String _name = it.getName();
                  Assert.assertEquals("aconn57", _name);
                  ConnectedElement _source = it.getSource();
                  Aadl2JavaValidatorTest.assertError(_source, allIssues, "An \'event data source\' in an \'abstract subcomponent\' is not a valid access connection end.");
                  ConnectedElement _destination = it.getDestination();
                  Aadl2JavaValidatorTest.assertNoIssues(_destination, allIssues);
                }
              };
              ...
              AccessConnection _get_58 = _ownedAccessConnections_57.get(57);
              final Procedure1<AccessConnection> _function_58 = new Procedure1<AccessConnection>() {
                public void apply(final AccessConnection it) {
                  String _name = it.getName();
                  Assert.assertEquals("aconn58", _name);
                  ConnectedElement _source = it.getSource();
                  Aadl2JavaValidatorTest.assertError(_source, allIssues, "An \'abstract feature\' in an \'abstract subcomponent\' is not a valid access connection end.");
                  ConnectedElement _destination = it.getDestination();
                  Aadl2JavaValidatorTest.assertNoIssues(_destination, allIssues);
                }
              };
              ...
              AccessConnection _get_59 = _ownedAccessConnections_58.get(58);
              final Procedure1<AccessConnection> _function_59 = new Procedure1<AccessConnection>() {
                public void apply(final AccessConnection it) {
                  String _name = it.getName();
                  Assert.assertEquals("aconn59", _name);
                  ConnectedElement _source = it.getSource();
                  Aadl2JavaValidatorTest.assertError(_source, allIssues, "A \'feature group\' in an \'abstract subcomponent\' is not a valid access connection end.");
                  ConnectedElement _destination = it.getDestination();
                  Aadl2JavaValidatorTest.assertNoIssues(_destination, allIssues);
                }
              };
              ...
              AccessConnection _get_60 = _ownedAccessConnections_59.get(59);
              final Procedure1<AccessConnection> _function_60 = new Procedure1<AccessConnection>() {
                public void apply(final AccessConnection it) {
                  String _name = it.getName();
                  Assert.assertEquals("aconn60", _name);
                  ConnectedElement _source = it.getSource();
                  Aadl2JavaValidatorTest.assertError(_source, allIssues, "A \'parameter\' in a \'subprogram subcomponent\' is not a valid access connection end.");
                  ConnectedElement _destination = it.getDestination();
                  Aadl2JavaValidatorTest.assertNoIssues(_destination, allIssues);
                }
              };
              ...
              AccessConnection _get_61 = _ownedAccessConnections_60.get(60);
              final Procedure1<AccessConnection> _function_61 = new Procedure1<AccessConnection>() {
                public void apply(final AccessConnection it) {
                  String _name = it.getName();
                  Assert.assertEquals("aconn61", _name);
                  ConnectedElement _source = it.getSource();
                  Aadl2JavaValidatorTest.assertNoIssues(_source, allIssues);
                  ConnectedElement _destination = it.getDestination();
                  Aadl2JavaValidatorTest.assertNoIssues(_destination, allIssues);
              ...
              AccessConnection _get_62 = _ownedAccessConnections_61.get(61);
              final Procedure1<AccessConnection> _function_62 = new Procedure1<AccessConnection>() {
                public void apply(final AccessConnection it) {
                  String _name = it.getName();
                  Assert.assertEquals("aconn62", _name);
                  ConnectedElement _source = it.getSource();
                  Aadl2JavaValidatorTest.assertNoIssues(_source, allIssues);
                  ConnectedElement _destination = it.getDestination();
                  Aadl2JavaValidatorTest.assertNoIssues(_destination, allIssues);
              ...
              AccessConnection _get_63 = _ownedAccessConnections_62.get(62);
              final Procedure1<AccessConnection> _function_63 = new Procedure1<AccessConnection>() {
                public void apply(final AccessConnection it) {
                  String _name = it.getName();
                  Assert.assertEquals("aconn63", _name);
                  ConnectedElement _source = it.getSource();
                  Aadl2JavaValidatorTest.assertError(_source, allIssues, "An \'event port\' in an \'abstract subcomponent\' is not a valid access connection end.");
                  ConnectedElement _destination = it.getDestination();
                  Aadl2JavaValidatorTest.assertNoIssues(_destination, allIssues);
                }
              };
              ...
              AccessConnection _get_64 = _ownedAccessConnections_63.get(63);
              final Procedure1<AccessConnection> _function_64 = new Procedure1<AccessConnection>() {
                public void apply(final AccessConnection it) {
                  String _name = it.getName();
                  Assert.assertEquals("aconn64", _name);
                  ConnectedElement _source = it.getSource();
                  Aadl2JavaValidatorTest.assertError(_source, allIssues, "A \'data port\' in an \'abstract subcomponent\' is not a valid access connection end.");
                  ConnectedElement _destination = it.getDestination();
                  Aadl2JavaValidatorTest.assertNoIssues(_destination, allIssues);
                }
              };
              ObjectExtensions.<AccessConnection>operator_doubleArrow(_get_64, _function_64);
              EList<AccessConnection> _ownedAccessConnections_64 = it.getOwnedAccessConnections();
              AccessConnection _get_65 = _ownedAccessConnections_64.get(64);
              final Procedure1<AccessConnection> _function_65 = new Procedure1<AccessConnection>() {
                public void apply(final AccessConnection it) {
                  String _name = it.getName();
                  Assert.assertEquals("aconn65", _name);
                  ConnectedElement _source = it.getSource();
                  Aadl2JavaValidatorTest.assertError(_source, allIssues, "An \'event data port\' in an \'abstract subcomponent\' is not a valid access connection end.");
                  ConnectedElement _destination = it.getDestination();
                  Aadl2JavaValidatorTest.assertNoIssues(_destination, allIssues);
                }
              };
              ObjectExtensions.<AccessConnection>operator_doubleArrow(_get_65, _function_65);
              EList<AccessConnection> _ownedAccessConnections_65 = it.getOwnedAccessConnections();
              AccessConnection _get_66 = _ownedAccessConnections_65.get(65);
              final Procedure1<AccessConnection> _function_66 = new Procedure1<AccessConnection>() {
                public void apply(final AccessConnection it) {
                  String _name = it.getName();
                  Assert.assertEquals("aconn66", _name);
                  ConnectedElement _source = it.getSource();
                  Aadl2JavaValidatorTest.assertError(_source, allIssues, "A \'data subcomponent\' in a \'subprogram call\' is not a valid access connection end.");
                  ConnectedElement _destination = it.getDestination();
                  Aadl2JavaValidatorTest.assertNoIssues(_destination, allIssues);
                }
              };
              ObjectExtensions.<AccessConnection>operator_doubleArrow(_get_66, _function_66);
              EList<AccessConnection> _ownedAccessConnections_66 = it.getOwnedAccessConnections();
              AccessConnection _get_67 = _ownedAccessConnections_66.get(66);
              final Procedure1<AccessConnection> _function_67 = new Procedure1<AccessConnection>() {
                public void apply(final AccessConnection it) {
                  String _name = it.getName();
                  Assert.assertEquals("aconn67", _name);
                  ConnectedElement _source = it.getSource();
                  Aadl2JavaValidatorTest.assertError(_source, allIssues, "A \'subprogram subcomponent\' in a \'subprogram call\' is not a valid access connection end.");
                  ConnectedElement _destination = it.getDestination();
                  Aadl2JavaValidatorTest.assertNoIssues(_destination, allIssues);
                }
              };
              ObjectExtensions.<AccessConnection>operator_doubleArrow(_get_67, _function_67);
              EList<AccessConnection> _ownedAccessConnections_67 = it.getOwnedAccessConnections();
              AccessConnection _get_68 = _ownedAccessConnections_67.get(67);
              final Procedure1<AccessConnection> _function_68 = new Procedure1<AccessConnection>() {
                public void apply(final AccessConnection it) {
                  String _name = it.getName();
                  Assert.assertEquals("aconn68", _name);
                  ConnectedElement _source = it.getSource();
                  Aadl2JavaValidatorTest.assertError(_source, allIssues, "A \'subprogram proxy\' in a \'subprogram call\' is not a valid access connection end.");
                  ConnectedElement _destination = it.getDestination();
                  Aadl2JavaValidatorTest.assertNoIssues(_destination, allIssues);
                }
              };
              ObjectExtensions.<AccessConnection>operator_doubleArrow(_get_68, _function_68);
              EList<AccessConnection> _ownedAccessConnections_68 = it.getOwnedAccessConnections();
              AccessConnection _get_69 = _ownedAccessConnections_68.get(68);
              final Procedure1<AccessConnection> _function_69 = new Procedure1<AccessConnection>() {
                public void apply(final AccessConnection it) {
                  String _name = it.getName();
                  Assert.assertEquals("aconn69", _name);
                  ConnectedElement _source = it.getSource();
                  Aadl2JavaValidatorTest.assertError(_source, allIssues, "A \'port proxy\' in a \'subprogram call\' is not a valid access connection end.");
                  ConnectedElement _destination = it.getDestination();
                  Aadl2JavaValidatorTest.assertNoIssues(_destination, allIssues);
                }
              };
              ObjectExtensions.<AccessConnection>operator_doubleArrow(_get_69, _function_69);
              EList<AccessConnection> _ownedAccessConnections_69 = it.getOwnedAccessConnections();
              AccessConnection _get_70 = _ownedAccessConnections_69.get(69);
              final Procedure1<AccessConnection> _function_70 = new Procedure1<AccessConnection>() {
                public void apply(final AccessConnection it) {
                  String _name = it.getName();
                  Assert.assertEquals("aconn70", _name);
                  ConnectedElement _source = it.getSource();
                  Aadl2JavaValidatorTest.assertError(_source, allIssues, "An \'event data source\' in a \'subprogram call\' is not a valid access connection end.");
                  ConnectedElement _destination = it.getDestination();
                  Aadl2JavaValidatorTest.assertNoIssues(_destination, allIssues);
                }
              };
              ObjectExtensions.<AccessConnection>operator_doubleArrow(_get_70, _function_70);
              EList<AccessConnection> _ownedAccessConnections_70 = it.getOwnedAccessConnections();
              AccessConnection _get_71 = _ownedAccessConnections_70.get(70);
              final Procedure1<AccessConnection> _function_71 = new Procedure1<AccessConnection>() {
                public void apply(final AccessConnection it) {
                  String _name = it.getName();
                  Assert.assertEquals("aconn71", _name);
                  ConnectedElement _source = it.getSource();
                  Aadl2JavaValidatorTest.assertError(_source, allIssues, "An \'abstract feature\' in a \'subprogram call\' is not a valid access connection end.");
                  ConnectedElement _destination = it.getDestination();
                  Aadl2JavaValidatorTest.assertNoIssues(_destination, allIssues);
                }
              };
              ObjectExtensions.<AccessConnection>operator_doubleArrow(_get_71, _function_71);
              EList<AccessConnection> _ownedAccessConnections_71 = it.getOwnedAccessConnections();
              AccessConnection _get_72 = _ownedAccessConnections_71.get(71);
              final Procedure1<AccessConnection> _function_72 = new Procedure1<AccessConnection>() {
                public void apply(final AccessConnection it) {
                  String _name = it.getName();
                  Assert.assertEquals("aconn72", _name);
                  ConnectedElement _source = it.getSource();
                  Aadl2JavaValidatorTest.assertError(_source, allIssues, "A \'feature group\' in a \'subprogram call\' is not a valid access connection end.");
                  ConnectedElement _destination = it.getDestination();
                  Aadl2JavaValidatorTest.assertNoIssues(_destination, allIssues);
                }
              };
              ObjectExtensions.<AccessConnection>operator_doubleArrow(_get_72, _function_72);
              EList<AccessConnection> _ownedAccessConnections_72 = it.getOwnedAccessConnections();
              AccessConnection _get_73 = _ownedAccessConnections_72.get(72);
              final Procedure1<AccessConnection> _function_73 = new Procedure1<AccessConnection>() {
                public void apply(final AccessConnection it) {
                  String _name = it.getName();
                  Assert.assertEquals("aconn73", _name);
                  ConnectedElement _source = it.getSource();
                  Aadl2JavaValidatorTest.assertError(_source, allIssues, "A \'parameter\' in a \'subprogram call\' is not a valid access connection end.");
                  ConnectedElement _destination = it.getDestination();
                  Aadl2JavaValidatorTest.assertNoIssues(_destination, allIssues);
                }
              };
              ObjectExtensions.<AccessConnection>operator_doubleArrow(_get_73, _function_73);
              EList<AccessConnection> _ownedAccessConnections_73 = it.getOwnedAccessConnections();
              AccessConnection _get_74 = _ownedAccessConnections_73.get(73);
              final Procedure1<AccessConnection> _function_74 = new Procedure1<AccessConnection>() {
                public void apply(final AccessConnection it) {
                  String _name = it.getName();
                  Assert.assertEquals("aconn74", _name);
                  ConnectedElement _source = it.getSource();
                  Aadl2JavaValidatorTest.assertNoIssues(_source, allIssues);
                  ConnectedElement _destination = it.getDestination();
                  Aadl2JavaValidatorTest.assertNoIssues(_destination, allIssues);
              ...
              ObjectExtensions.<AccessConnection>operator_doubleArrow(_get_74, _function_74);
              EList<AccessConnection> _ownedAccessConnections_74 = it.getOwnedAccessConnections();
              AccessConnection _get_75 = _ownedAccessConnections_74.get(74);
              final Procedure1<AccessConnection> _function_75 = new Procedure1<AccessConnection>() {
                public void apply(final AccessConnection it) {
                  String _name = it.getName();
                  Assert.assertEquals("aconn75", _name);
                  ConnectedElement _source = it.getSource();
                  Aadl2JavaValidatorTest.assertNoIssues(_source, allIssues);
                  ConnectedElement _destination = it.getDestination();
                  Aadl2JavaValidatorTest.assertNoIssues(_destination, allIssues);
              ...
              ObjectExtensions.<AccessConnection>operator_doubleArrow(_get_75, _function_75);
              EList<AccessConnection> _ownedAccessConnections_75 = it.getOwnedAccessConnections();
              AccessConnection _get_76 = _ownedAccessConnections_75.get(75);
              final Procedure1<AccessConnection> _function_76 = new Procedure1<AccessConnection>() {
                public void apply(final AccessConnection it) {
                  String _name = it.getName();
                  Assert.assertEquals("aconn76", _name);
                  ConnectedElement _source = it.getSource();
                  Aadl2JavaValidatorTest.assertError(_source, allIssues, "An \'event port\' in a \'subprogram call\' is not a valid access connection end.");
                  ConnectedElement _destination = it.getDestination();
                  Aadl2JavaValidatorTest.assertNoIssues(_destination, allIssues);
                }
              };
              ObjectExtensions.<AccessConnection>operator_doubleArrow(_get_76, _function_76);
              EList<AccessConnection> _ownedAccessConnections_76 = it.getOwnedAccessConnections();
              AccessConnection _get_77 = _ownedAccessConnections_76.get(76);
              final Procedure1<AccessConnection> _function_77 = new Procedure1<AccessConnection>() {
                public void apply(final AccessConnection it) {
                  String _name = it.getName();
                  Assert.assertEquals("aconn77", _name);
                  ConnectedElement _source = it.getSource();
                  Aadl2JavaValidatorTest.assertError(_source, allIssues, "An \'event data port\' in a \'subprogram call\' is not a valid access connection end.");
                  ConnectedElement _destination = it.getDestination();
                  Aadl2JavaValidatorTest.assertNoIssues(_destination, allIssues);
                }
              };
              ObjectExtensions.<AccessConnection>operator_doubleArrow(_get_77, _function_77);
              EList<FeatureConnection> _ownedFeatureConnections = it.getOwnedFeatureConnections();
              FeatureConnection _get_78 = _ownedFeatureConnections.get(0);
              final Procedure1<FeatureConnection> _function_78 = new Procedure1<FeatureConnection>() {
                public void apply(final FeatureConnection it) {
                  ...
                  ConnectedElement _source = it.getSource();
                  Aadl2JavaValidatorTest.assertError(_source, allIssues, "A \'bus subcomponent\' is not a valid feature connection end.");
                  ConnectedElement _destination = it.getDestination();
                  Aadl2JavaValidatorTest.assertNoIssues(_destination, allIssues);
                }
              };
              ...
              FeatureConnection _get_79 = _ownedFeatureConnections_1.get(1);
              final Procedure1<FeatureConnection> _function_79 = new Procedure1<FeatureConnection>() {
                public void apply(final FeatureConnection it) {
                  String _name = it.getName();
                  Assert.assertEquals("fconn2", _name);
                  ConnectedElement _source = it.getSource();
                  Aadl2JavaValidatorTest.assertError(_source, allIssues, "A \'data subcomponent\' is not a valid feature connection end.");
                  ConnectedElement _destination = it.getDestination();
                  Aadl2JavaValidatorTest.assertNoIssues(_destination, allIssues);
                }
              };
              ...
              FeatureConnection _get_80 = _ownedFeatureConnections_2.get(2);
              final Procedure1<FeatureConnection> _function_80 = new Procedure1<FeatureConnection>() {
                public void apply(final FeatureConnection it) {
                  String _name = it.getName();
                  Assert.assertEquals("fconn3", _name);
                  ConnectedElement _source = it.getSource();
                  Aadl2JavaValidatorTest.assertError(_source, allIssues, "A \'subprogram group subcomponent\' is not a valid feature connection end.");
                  ConnectedElement _destination = it.getDestination();
                  Aadl2JavaValidatorTest.assertNoIssues(_destination, allIssues);
                }
              };
              ...
              FeatureConnection _get_81 = _ownedFeatureConnections_3.get(3);
              final Procedure1<FeatureConnection> _function_81 = new Procedure1<FeatureConnection>() {
                public void apply(final FeatureConnection it) {
                  String _name = it.getName();
                  Assert.assertEquals("fconn4", _name);
                  ConnectedElement _source = it.getSource();
                  Aadl2JavaValidatorTest.assertError(_source, allIssues, "A \'subprogram subcomponent\' is not a valid feature connection end.");
                  ConnectedElement _destination = it.getDestination();
                  Aadl2JavaValidatorTest.assertNoIssues(_destination, allIssues);
                }
              };
              ...
              FeatureConnection _get_82 = _ownedFeatureConnections_4.get(4);
              final Procedure1<FeatureConnection> _function_82 = new Procedure1<FeatureConnection>() {
                public void apply(final FeatureConnection it) {
                  String _name = it.getName();
                  Assert.assertEquals("fconn5", _name);
                  ConnectedElement _source = it.getSource();
                  Aadl2JavaValidatorTest.assertError(_source, allIssues, "A \'subprogram proxy\' is not a valid feature connection end.");
                  ConnectedElement _destination = it.getDestination();
                  Aadl2JavaValidatorTest.assertNoIssues(_destination, allIssues);
                }
              };
              ...
              FeatureConnection _get_83 = _ownedFeatureConnections_5.get(5);
              final Procedure1<FeatureConnection> _function_83 = new Procedure1<FeatureConnection>() {
                public void apply(final FeatureConnection it) {
                  String _name = it.getName();
                  Assert.assertEquals("fconn6", _name);
                  ConnectedElement _source = it.getSource();
                  Aadl2JavaValidatorTest.assertNoIssues(_source, allIssues);
                  ConnectedElement _destination = it.getDestination();
                  Aadl2JavaValidatorTest.assertNoIssues(_destination, allIssues);
              ...
              FeatureConnection _get_84 = _ownedFeatureConnections_6.get(6);
              final Procedure1<FeatureConnection> _function_84 = new Procedure1<FeatureConnection>() {
                public void apply(final FeatureConnection it) {
                  String _name = it.getName();
                  Assert.assertEquals("fconn7", _name);
                  ConnectedElement _source = it.getSource();
                  Aadl2JavaValidatorTest.assertNoIssues(_source, allIssues);
                  ConnectedElement _destination = it.getDestination();
                  Aadl2JavaValidatorTest.assertNoIssues(_destination, allIssues);
              ...
              FeatureConnection _get_85 = _ownedFeatureConnections_7.get(7);
              final Procedure1<FeatureConnection> _function_85 = new Procedure1<FeatureConnection>() {
                public void apply(final FeatureConnection it) {
                  String _name = it.getName();
                  Assert.assertEquals("fconn8", _name);
                  ConnectedElement _source = it.getSource();
                  Aadl2JavaValidatorTest.assertNoIssues(_source, allIssues);
                  ConnectedElement _destination = it.getDestination();
                  Aadl2JavaValidatorTest.assertNoIssues(_destination, allIssues);
              ...
              FeatureConnection _get_86 = _ownedFeatureConnections_8.get(8);
              final Procedure1<FeatureConnection> _function_86 = new Procedure1<FeatureConnection>() {
                public void apply(final FeatureConnection it) {
                  String _name = it.getName();
                  Assert.assertEquals("fconn9", _name);
                  ConnectedElement _source = it.getSource();
                  Aadl2JavaValidatorTest.assertNoIssues(_source, allIssues);
                  ConnectedElement _destination = it.getDestination();
                  Aadl2JavaValidatorTest.assertNoIssues(_destination, allIssues);
              ...
              FeatureConnection _get_87 = _ownedFeatureConnections_9.get(9);
              final Procedure1<FeatureConnection> _function_87 = new Procedure1<FeatureConnection>() {
                public void apply(final FeatureConnection it) {
                  String _name = it.getName();
                  Assert.assertEquals("fconn10", _name);
                  ConnectedElement _source = it.getSource();
                  Aadl2JavaValidatorTest.assertNoIssues(_source, allIssues);
                  ConnectedElement _destination = it.getDestination();
                  Aadl2JavaValidatorTest.assertNoIssues(_destination, allIssues);
              ...
              FeatureConnection _get_88 = _ownedFeatureConnections_10.get(10);
              final Procedure1<FeatureConnection> _function_88 = new Procedure1<FeatureConnection>() {
                public void apply(final FeatureConnection it) {
                  String _name = it.getName();
                  Assert.assertEquals("fconn11", _name);
                  ConnectedElement _source = it.getSource();
                  Aadl2JavaValidatorTest.assertNoIssues(_source, allIssues);
                  ConnectedElement _destination = it.getDestination();
                  Aadl2JavaValidatorTest.assertNoIssues(_destination, allIssues);
              ...
              FeatureConnection _get_89 = _ownedFeatureConnections_11.get(11);
              final Procedure1<FeatureConnection> _function_89 = new Procedure1<FeatureConnection>() {
                public void apply(final FeatureConnection it) {
                  String _name = it.getName();
                  Assert.assertEquals("fconn12", _name);
                  ConnectedElement _source = it.getSource();
                  Aadl2JavaValidatorTest.assertNoIssues(_source, allIssues);
                  ConnectedElement _destination = it.getDestination();
                  Aadl2JavaValidatorTest.assertNoIssues(_destination, allIssues);
              ...
              FeatureConnection _get_90 = _ownedFeatureConnections_12.get(12);
              final Procedure1<FeatureConnection> _function_90 = new Procedure1<FeatureConnection>() {
                public void apply(final FeatureConnection it) {
                  String _name = it.getName();
                  Assert.assertEquals("fconn13", _name);
                  ConnectedElement _source = it.getSource();
                  Aadl2JavaValidatorTest.assertNoIssues(_source, allIssues);
                  ConnectedElement _destination = it.getDestination();
                  Aadl2JavaValidatorTest.assertNoIssues(_destination, allIssues);
              ...
              FeatureConnection _get_91 = _ownedFeatureConnections_13.get(13);
              final Procedure1<FeatureConnection> _function_91 = new Procedure1<FeatureConnection>() {
                public void apply(final FeatureConnection it) {
                  String _name = it.getName();
                  Assert.assertEquals("fconn14", _name);
                  ConnectedElement _source = it.getSource();
                  Aadl2JavaValidatorTest.assertNoIssues(_source, allIssues);
                  ConnectedElement _destination = it.getDestination();
                  Aadl2JavaValidatorTest.assertNoIssues(_destination, allIssues);
              ...
              FeatureConnection _get_92 = _ownedFeatureConnections_14.get(14);
              final Procedure1<FeatureConnection> _function_92 = new Procedure1<FeatureConnection>() {
                public void apply(final FeatureConnection it) {
                  String _name = it.getName();
                  Assert.assertEquals("fconn15", _name);
                  ConnectedElement _source = it.getSource();
                  Aadl2JavaValidatorTest.assertError(_source, allIssues, "Anything in a \'data port\' is not a valid feature connection end.");
                  ConnectedElement _destination = it.getDestination();
                  Aadl2JavaValidatorTest.assertNoIssues(_destination, allIssues);
                }
              };
              ...
              FeatureConnection _get_93 = _ownedFeatureConnections_15.get(15);
              ...
              FeatureConnection _get_94 = _ownedFeatureConnections_16.get(16);
              ...
              FeatureConnection _get_95 = _ownedFeatureConnections_17.get(17);
              ...
              FeatureConnection _get_96 = _ownedFeatureConnections_18.get(18);
              ...
              FeatureConnection _get_97 = _ownedFeatureConnections_19.get(19);
              ...
              FeatureConnection _get_98 = _ownedFeatureConnections_20.get(20);
              ...
              FeatureConnection _get_99 = _ownedFeatureConnections_21.get(21);
              ...
              FeatureConnection _get_100 = _ownedFeatureConnections_22.get(22);
              ...
              FeatureConnection _get_101 = _ownedFeatureConnections_23.get(23);
              ...
              FeatureConnection _get_102 = _ownedFeatureConnections_24.get(24);
              ...
              FeatureConnection _get_103 = _ownedFeatureConnections_25.get(25);
              ...
              FeatureConnection _get_104 = _ownedFeatureConnections_26.get(26);
              ...
              FeatureConnection _get_105 = _ownedFeatureConnections_27.get(27);
              ...
              FeatureConnection _get_106 = _ownedFeatureConnections_28.get(28);
              final Procedure1<FeatureConnection> _function_106 = new Procedure1<FeatureConnection>() {
                public void apply(final FeatureConnection it) {
                  String _name = it.getName();
                  Assert.assertEquals("fconn29", _name);
                  ConnectedElement _source = it.getSource();
                  Aadl2JavaValidatorTest.assertError(_source, allIssues, "Anything in an \'event data port\' is not a valid feature connection end.");
                  ConnectedElement _destination = it.getDestination();
                  Aadl2JavaValidatorTest.assertNoIssues(_destination, allIssues);
                }
              };
              ...
              FeatureConnection _get_107 = _ownedFeatureConnections_29.get(29);
              ...
              FeatureConnection _get_108 = _ownedFeatureConnections_30.get(30);
              ...
              FeatureConnection _get_109 = _ownedFeatureConnections_31.get(31);
              ...
              FeatureConnection _get_110 = _ownedFeatureConnections_32.get(32);
              final Procedure1<FeatureConnection> _function_110 = new Procedure1<FeatureConnection>() {
                public void apply(final FeatureConnection it) {
                  String _name = it.getName();
              ...
              ObjectExtensions.<FeatureConnection>operator_doubleArrow(_get_110, _function_110);
              EList<FeatureConnection> _ownedFeatureConnections_33 = it.getOwnedFeatureConnections();
              FeatureConnection _get_111 = _ownedFeatureConnections_33.get(33);
              final Procedure1<FeatureConnection> _function_111 = new Procedure1<FeatureConnection>() {
                public void apply(final FeatureConnection it) {
                  String _name = it.getName();
              ...
              ObjectExtensions.<FeatureConnection>operator_doubleArrow(_get_111, _function_111);
              EList<FeatureConnection> _ownedFeatureConnections_34 = it.getOwnedFeatureConnections();
              FeatureConnection _get_112 = _ownedFeatureConnections_34.get(34);
              final Procedure1<FeatureConnection> _function_112 = new Procedure1<FeatureConnection>() {
                public void apply(final FeatureConnection it) {
                  String _name = it.getName();
              ...
              ObjectExtensions.<FeatureConnection>operator_doubleArrow(_get_112, _function_112);
              EList<FeatureConnection> _ownedFeatureConnections_35 = it.getOwnedFeatureConnections();
              FeatureConnection _get_113 = _ownedFeatureConnections_35.get(35);
              final Procedure1<FeatureConnection> _function_113 = new Procedure1<FeatureConnection>() {
                public void apply(final FeatureConnection it) {
                  String _name = it.getName();
              ...
              ObjectExtensions.<FeatureConnection>operator_doubleArrow(_get_113, _function_113);
              EList<FeatureConnection> _ownedFeatureConnections_36 = it.getOwnedFeatureConnections();
              FeatureConnection _get_114 = _ownedFeatureConnections_36.get(36);
              final Procedure1<FeatureConnection> _function_114 = new Procedure1<FeatureConnection>() {
                public void apply(final FeatureConnection it) {
                  String _name = it.getName();
              ...
              ObjectExtensions.<FeatureConnection>operator_doubleArrow(_get_114, _function_114);
              EList<FeatureConnection> _ownedFeatureConnections_37 = it.getOwnedFeatureConnections();
              FeatureConnection _get_115 = _ownedFeatureConnections_37.get(37);
              final Procedure1<FeatureConnection> _function_115 = new Procedure1<FeatureConnection>() {
                public void apply(final FeatureConnection it) {
                  String _name = it.getName();
              ...
              ObjectExtensions.<FeatureConnection>operator_doubleArrow(_get_115, _function_115);
              EList<FeatureConnection> _ownedFeatureConnections_38 = it.getOwnedFeatureConnections();
              FeatureConnection _get_116 = _ownedFeatureConnections_38.get(38);
              final Procedure1<FeatureConnection> _function_116 = new Procedure1<FeatureConnection>() {
                public void apply(final FeatureConnection it) {
                  String _name = it.getName();
              ...
              ObjectExtensions.<FeatureConnection>operator_doubleArrow(_get_116, _function_116);
              EList<FeatureConnection> _ownedFeatureConnections_39 = it.getOwnedFeatureConnections();
              FeatureConnection _get_117 = _ownedFeatureConnections_39.get(39);
              final Procedure1<FeatureConnection> _function_117 = new Procedure1<FeatureConnection>() {
                public void apply(final FeatureConnection it) {
                  String _name = it.getName();
              ...
              ObjectExtensions.<FeatureConnection>operator_doubleArrow(_get_117, _function_117);
              EList<FeatureConnection> _ownedFeatureConnections_40 = it.getOwnedFeatureConnections();
              FeatureConnection _get_118 = _ownedFeatureConnections_40.get(40);
              final Procedure1<FeatureConnection> _function_118 = new Procedure1<FeatureConnection>() {
                public void apply(final FeatureConnection it) {
                  String _name = it.getName();
              ...
              ObjectExtensions.<FeatureConnection>operator_doubleArrow(_get_118, _function_118);
              EList<FeatureConnection> _ownedFeatureConnections_41 = it.getOwnedFeatureConnections();
              FeatureConnection _get_119 = _ownedFeatureConnections_41.get(41);
              final Procedure1<FeatureConnection> _function_119 = new Procedure1<FeatureConnection>() {
                public void apply(final FeatureConnection it) {
                  String _name = it.getName();
              ...
              ObjectExtensions.<FeatureConnection>operator_doubleArrow(_get_119, _function_119);
              EList<FeatureConnection> _ownedFeatureConnections_42 = it.getOwnedFeatureConnections();
              FeatureConnection _get_120 = _ownedFeatureConnections_42.get(42);
              final Procedure1<FeatureConnection> _function_120 = new Procedure1<FeatureConnection>() {
                public void apply(final FeatureConnection it) {
                  String _name = it.getName();
                  Assert.assertEquals("fconn43", _name);
                  ConnectedElement _source = it.getSource();
                  Aadl2JavaValidatorTest.assertNoIssues(_source, allIssues);
                  ConnectedElement _destination = it.getDestination();
                  Aadl2JavaValidatorTest.assertNoIssues(_destination, allIssues);
              ...
              ObjectExtensions.<FeatureConnection>operator_doubleArrow(_get_120, _function_120);
              EList<FeatureConnection> _ownedFeatureConnections_43 = it.getOwnedFeatureConnections();
              FeatureConnection _get_121 = _ownedFeatureConnections_43.get(43);
              final Procedure1<FeatureConnection> _function_121 = new Procedure1<FeatureConnection>() {
                public void apply(final FeatureConnection it) {
                  String _name = it.getName();
                  Assert.assertEquals("fconn44", _name);
                  ConnectedElement _source = it.getSource();
                  Aadl2JavaValidatorTest.assertNoIssues(_source, allIssues);
                  ConnectedElement _destination = it.getDestination();
                  Aadl2JavaValidatorTest.assertNoIssues(_destination, allIssues);
              ...
              ObjectExtensions.<FeatureConnection>operator_doubleArrow(_get_121, _function_121);
              EList<FeatureConnection> _ownedFeatureConnections_44 = it.getOwnedFeatureConnections();
              FeatureConnection _get_122 = _ownedFeatureConnections_44.get(44);
              final Procedure1<FeatureConnection> _function_122 = new Procedure1<FeatureConnection>() {
                public void apply(final FeatureConnection it) {
                  String _name = it.getName();
                  Assert.assertEquals("fconn45", _name);
                  ConnectedElement _source = it.getSource();
                  Aadl2JavaValidatorTest.assertNoIssues(_source, allIssues);
                  ConnectedElement _destination = it.getDestination();
                  Aadl2JavaValidatorTest.assertNoIssues(_destination, allIssues);
              ...
              ObjectExtensions.<FeatureConnection>operator_doubleArrow(_get_122, _function_122);
              EList<FeatureConnection> _ownedFeatureConnections_45 = it.getOwnedFeatureConnections();
              FeatureConnection _get_123 = _ownedFeatureConnections_45.get(45);
              final Procedure1<FeatureConnection> _function_123 = new Procedure1<FeatureConnection>() {
                public void apply(final FeatureConnection it) {
                  String _name = it.getName();
                  Assert.assertEquals("fconn46", _name);
                  ConnectedElement _source = it.getSource();
                  Aadl2JavaValidatorTest.assertNoIssues(_source, allIssues);
                  ConnectedElement _destination = it.getDestination();
                  Aadl2JavaValidatorTest.assertNoIssues(_destination, allIssues);
              ...
              ObjectExtensions.<FeatureConnection>operator_doubleArrow(_get_123, _function_123);
              EList<FeatureConnection> _ownedFeatureConnections_46 = it.getOwnedFeatureConnections();
              FeatureConnection _get_124 = _ownedFeatureConnections_46.get(46);
              final Procedure1<FeatureConnection> _function_124 = new Procedure1<FeatureConnection>() {
                public void apply(final FeatureConnection it) {
                  String _name = it.getName();
                  Assert.assertEquals("fconn47", _name);
                  ConnectedElement _source = it.getSource();
                  Aadl2JavaValidatorTest.assertNoIssues(_source, allIssues);
                  ConnectedElement _destination = it.getDestination();
                  Aadl2JavaValidatorTest.assertNoIssues(_destination, allIssues);
              ...
              ObjectExtensions.<FeatureConnection>operator_doubleArrow(_get_124, _function_124);
              EList<FeatureConnection> _ownedFeatureConnections_47 = it.getOwnedFeatureConnections();
              FeatureConnection _get_125 = _ownedFeatureConnections_47.get(47);
              final Procedure1<FeatureConnection> _function_125 = new Procedure1<FeatureConnection>() {
                public void apply(final FeatureConnection it) {
                  String _name = it.getName();
                  Assert.assertEquals("fconn48", _name);
                  ConnectedElement _source = it.getSource();
                  Aadl2JavaValidatorTest.assertNoIssues(_source, allIssues);
                  ConnectedElement _destination = it.getDestination();
                  Aadl2JavaValidatorTest.assertNoIssues(_destination, allIssues);
              ...
              ObjectExtensions.<FeatureConnection>operator_doubleArrow(_get_125, _function_125);
              EList<FeatureConnection> _ownedFeatureConnections_48 = it.getOwnedFeatureConnections();
              FeatureConnection _get_126 = _ownedFeatureConnections_48.get(48);
              final Procedure1<FeatureConnection> _function_126 = new Procedure1<FeatureConnection>() {
                public void apply(final FeatureConnection it) {
                  String _name = it.getName();
                  Assert.assertEquals("fconn49", _name);
                  ConnectedElement _source = it.getSource();
                  Aadl2JavaValidatorTest.assertNoIssues(_source, allIssues);
                  ConnectedElement _destination = it.getDestination();
                  Aadl2JavaValidatorTest.assertNoIssues(_destination, allIssues);
              ...
              ObjectExtensions.<FeatureConnection>operator_doubleArrow(_get_126, _function_126);
              EList<FeatureConnection> _ownedFeatureConnections_49 = it.getOwnedFeatureConnections();
              FeatureConnection _get_127 = _ownedFeatureConnections_49.get(49);
              final Procedure1<FeatureConnection> _function_127 = new Procedure1<FeatureConnection>() {
                public void apply(final FeatureConnection it) {
                  String _name = it.getName();
                  Assert.assertEquals("fconn50", _name);
                  ConnectedElement _source = it.getSource();
                  Aadl2JavaValidatorTest.assertNoIssues(_source, allIssues);
                  ConnectedElement _destination = it.getDestination();
                  Aadl2JavaValidatorTest.assertNoIssues(_destination, allIssues);
              ...
              ObjectExtensions.<FeatureConnection>operator_doubleArrow(_get_127, _function_127);
              EList<FeatureConnection> _ownedFeatureConnections_50 = it.getOwnedFeatureConnections();
              FeatureConnection _get_128 = _ownedFeatureConnections_50.get(50);
              final Procedure1<FeatureConnection> _function_128 = new Procedure1<FeatureConnection>() {
                public void apply(final FeatureConnection it) {
                  String _name = it.getName();
                  Assert.assertEquals("fconn51", _name);
                  ConnectedElement _source = it.getSource();
                  Aadl2JavaValidatorTest.assertError(_source, allIssues, "A \'bus subcomponent\' in an \'abstract subcomponent\' is not a valid feature connection end.");
                  ConnectedElement _destination = it.getDestination();
                  Aadl2JavaValidatorTest.assertNoIssues(_destination, allIssues);
                }
              };
              ObjectExtensions.<FeatureConnection>operator_doubleArrow(_get_128, _function_128);
              EList<FeatureConnection> _ownedFeatureConnections_51 = it.getOwnedFeatureConnections();
              FeatureConnection _get_129 = _ownedFeatureConnections_51.get(51);
              final Procedure1<FeatureConnection> _function_129 = new Procedure1<FeatureConnection>() {
                public void apply(final FeatureConnection it) {
                  String _name = it.getName();
                  Assert.assertEquals("fconn52", _name);
                  ConnectedElement _source = it.getSource();
                  Aadl2JavaValidatorTest.assertError(_source, allIssues, "A \'data subcomponent\' in an \'abstract subcomponent\' is not a valid feature connection end.");
                  ConnectedElement _destination = it.getDestination();
                  Aadl2JavaValidatorTest.assertNoIssues(_destination, allIssues);
                }
              };
              ObjectExtensions.<FeatureConnection>operator_doubleArrow(_get_129, _function_129);
              EList<FeatureConnection> _ownedFeatureConnections_52 = it.getOwnedFeatureConnections();
              FeatureConnection _get_130 = _ownedFeatureConnections_52.get(52);
              final Procedure1<FeatureConnection> _function_130 = new Procedure1<FeatureConnection>() {
                public void apply(final FeatureConnection it) {
                  String _name = it.getName();
                  Assert.assertEquals("fconn53", _name);
                  ConnectedElement _source = it.getSource();
                  Aadl2JavaValidatorTest.assertError(_source, allIssues, "A \'subprogram group subcomponent\' in an \'abstract subcomponent\' is not a valid feature connection end.");
                  ConnectedElement _destination = it.getDestination();
                  Aadl2JavaValidatorTest.assertNoIssues(_destination, allIssues);
                }
              };
              ObjectExtensions.<FeatureConnection>operator_doubleArrow(_get_130, _function_130);
              EList<FeatureConnection> _ownedFeatureConnections_53 = it.getOwnedFeatureConnections();
              FeatureConnection _get_131 = _ownedFeatureConnections_53.get(53);
              final Procedure1<FeatureConnection> _function_131 = new Procedure1<FeatureConnection>() {
                public void apply(final FeatureConnection it) {
                  String _name = it.getName();
                  Assert.assertEquals("fconn54", _name);
                  ConnectedElement _source = it.getSource();
                  Aadl2JavaValidatorTest.assertError(_source, allIssues, "A \'subprogram subcomponent\' in an \'abstract subcomponent\' is not a valid feature connection end.");
                  ConnectedElement _destination = it.getDestination();
                  Aadl2JavaValidatorTest.assertNoIssues(_destination, allIssues);
                }
              };
              ObjectExtensions.<FeatureConnection>operator_doubleArrow(_get_131, _function_131);
              EList<FeatureConnection> _ownedFeatureConnections_54 = it.getOwnedFeatureConnections();
              FeatureConnection _get_132 = _ownedFeatureConnections_54.get(54);
              final Procedure1<FeatureConnection> _function_132 = new Procedure1<FeatureConnection>() {
                public void apply(final FeatureConnection it) {
                  String _name = it.getName();
                  Assert.assertEquals("fconn55", _name);
                  ConnectedElement _source = it.getSource();
                  Aadl2JavaValidatorTest.assertError(_source, allIssues, "A \'subprogram proxy\' in an \'abstract subcomponent\' is not a valid feature connection end.");
                  ConnectedElement _destination = it.getDestination();
                  Aadl2JavaValidatorTest.assertNoIssues(_destination, allIssues);
                }
              };
              ObjectExtensions.<FeatureConnection>operator_doubleArrow(_get_132, _function_132);
              EList<FeatureConnection> _ownedFeatureConnections_55 = it.getOwnedFeatureConnections();
              FeatureConnection _get_133 = _ownedFeatureConnections_55.get(55);
              final Procedure1<FeatureConnection> _function_133 = new Procedure1<FeatureConnection>() {
                public void apply(final FeatureConnection it) {
                  String _name = it.getName();
                  Assert.assertEquals("fconn56", _name);
                  ConnectedElement _source = it.getSource();
                  Aadl2JavaValidatorTest.assertError(_source, allIssues, "A \'port proxy\' in an \'abstract subcomponent\' is not a valid feature connection end.");
                  ConnectedElement _destination = it.getDestination();
                  Aadl2JavaValidatorTest.assertNoIssues(_destination, allIssues);
                }
              };
              ObjectExtensions.<FeatureConnection>operator_doubleArrow(_get_133, _function_133);
              EList<FeatureConnection> _ownedFeatureConnections_56 = it.getOwnedFeatureConnections();
              FeatureConnection _get_134 = _ownedFeatureConnections_56.get(56);
              final Procedure1<FeatureConnection> _function_134 = new Procedure1<FeatureConnection>() {
                public void apply(final FeatureConnection it) {
                  String _name = it.getName();
                  Assert.assertEquals("fconn57", _name);
                  ConnectedElement _source = it.getSource();
                  Aadl2JavaValidatorTest.assertError(_source, allIssues, "An \'event data source\' in an \'abstract subcomponent\' is not a valid feature connection end.");
                  ConnectedElement _destination = it.getDestination();
                  Aadl2JavaValidatorTest.assertNoIssues(_destination, allIssues);
                }
              };
              ObjectExtensions.<FeatureConnection>operator_doubleArrow(_get_134, _function_134);
              EList<FeatureConnection> _ownedFeatureConnections_57 = it.getOwnedFeatureConnections();
              FeatureConnection _get_135 = _ownedFeatureConnections_57.get(57);
              final Procedure1<FeatureConnection> _function_135 = new Procedure1<FeatureConnection>() {
                public void apply(final FeatureConnection it) {
                  String _name = it.getName();
                  Assert.assertEquals("fconn58", _name);
                  ConnectedElement _source = it.getSource();
                  Aadl2JavaValidatorTest.assertNoIssues(_source, allIssues);
                  ConnectedElement _destination = it.getDestination();
                  Aadl2JavaValidatorTest.assertNoIssues(_destination, allIssues);
              ...
              ObjectExtensions.<FeatureConnection>operator_doubleArrow(_get_135, _function_135);
              EList<FeatureConnection> _ownedFeatureConnections_58 = it.getOwnedFeatureConnections();
              FeatureConnection _get_136 = _ownedFeatureConnections_58.get(58);
              final Procedure1<FeatureConnection> _function_136 = new Procedure1<FeatureConnection>() {
                public void apply(final FeatureConnection it) {
                  String _name = it.getName();
                  Assert.assertEquals("fconn59", _name);
                  ConnectedElement _source = it.getSource();
                  Aadl2JavaValidatorTest.assertNoIssues(_source, allIssues);
                  ConnectedElement _destination = it.getDestination();
                  Aadl2JavaValidatorTest.assertNoIssues(_destination, allIssues);
              ...
              ObjectExtensions.<FeatureConnection>operator_doubleArrow(_get_136, _function_136);
              EList<FeatureConnection> _ownedFeatureConnections_59 = it.getOwnedFeatureConnections();
              FeatureConnection _get_137 = _ownedFeatureConnections_59.get(59);
              final Procedure1<FeatureConnection> _function_137 = new Procedure1<FeatureConnection>() {
                public void apply(final FeatureConnection it) {
                  String _name = it.getName();
                  Assert.assertEquals("fconn60", _name);
                  ConnectedElement _source = it.getSource();
                  Aadl2JavaValidatorTest.assertNoIssues(_source, allIssues);
                  ConnectedElement _destination = it.getDestination();
                  Aadl2JavaValidatorTest.assertNoIssues(_destination, allIssues);
              ...
              ObjectExtensions.<FeatureConnection>operator_doubleArrow(_get_137, _function_137);
              EList<FeatureConnection> _ownedFeatureConnections_60 = it.getOwnedFeatureConnections();
              FeatureConnection _get_138 = _ownedFeatureConnections_60.get(60);
              final Procedure1<FeatureConnection> _function_138 = new Procedure1<FeatureConnection>() {
                public void apply(final FeatureConnection it) {
                  String _name = it.getName();
                  Assert.assertEquals("fconn61", _name);
                  ConnectedElement _source = it.getSource();
                  Aadl2JavaValidatorTest.assertNoIssues(_source, allIssues);
                  ConnectedElement _destination = it.getDestination();
                  Aadl2JavaValidatorTest.assertNoIssues(_destination, allIssues);
              ...
              ObjectExtensions.<FeatureConnection>operator_doubleArrow(_get_138, _function_138);
              EList<FeatureConnection> _ownedFeatureConnections_61 = it.getOwnedFeatureConnections();
              FeatureConnection _get_139 = _ownedFeatureConnections_61.get(61);
              final Procedure1<FeatureConnection> _function_139 = new Procedure1<FeatureConnection>() {
                public void apply(final FeatureConnection it) {
                  String _name = it.getName();
                  Assert.assertEquals("fconn62", _name);
                  ConnectedElement _source = it.getSource();
                  Aadl2JavaValidatorTest.assertNoIssues(_source, allIssues);
                  ConnectedElement _destination = it.getDestination();
                  Aadl2JavaValidatorTest.assertNoIssues(_destination, allIssues);
              ...
              ObjectExtensions.<FeatureConnection>operator_doubleArrow(_get_139, _function_139);
              EList<FeatureConnection> _ownedFeatureConnections_62 = it.getOwnedFeatureConnections();
              FeatureConnection _get_140 = _ownedFeatureConnections_62.get(62);
              final Procedure1<FeatureConnection> _function_140 = new Procedure1<FeatureConnection>() {
                public void apply(final FeatureConnection it) {
                  String _name = it.getName();
                  Assert.assertEquals("fconn63", _name);
                  ConnectedElement _source = it.getSource();
                  Aadl2JavaValidatorTest.assertNoIssues(_source, allIssues);
                  ConnectedElement _destination = it.getDestination();
                  Aadl2JavaValidatorTest.assertNoIssues(_destination, allIssues);
              ...
              ObjectExtensions.<FeatureConnection>operator_doubleArrow(_get_140, _function_140);
              EList<FeatureConnection> _ownedFeatureConnections_63 = it.getOwnedFeatureConnections();
              FeatureConnection _get_141 = _ownedFeatureConnections_63.get(63);
              final Procedure1<FeatureConnection> _function_141 = new Procedure1<FeatureConnection>() {
                public void apply(final FeatureConnection it) {
                  String _name = it.getName();
                  Assert.assertEquals("fconn64", _name);
                  ConnectedElement _source = it.getSource();
                  Aadl2JavaValidatorTest.assertNoIssues(_source, allIssues);
                  ConnectedElement _destination = it.getDestination();
                  Aadl2JavaValidatorTest.assertNoIssues(_destination, allIssues);
              ...
              ObjectExtensions.<FeatureConnection>operator_doubleArrow(_get_141, _function_141);
              EList<FeatureConnection> _ownedFeatureConnections_64 = it.getOwnedFeatureConnections();
              FeatureConnection _get_142 = _ownedFeatureConnections_64.get(64);
              final Procedure1<FeatureConnection> _function_142 = new Procedure1<FeatureConnection>() {
                public void apply(final FeatureConnection it) {
                  String _name = it.getName();
                  Assert.assertEquals("fconn65", _name);
                  ConnectedElement _source = it.getSource();
                  Aadl2JavaValidatorTest.assertNoIssues(_source, allIssues);
                  ConnectedElement _destination = it.getDestination();
                  Aadl2JavaValidatorTest.assertNoIssues(_destination, allIssues);
              ...
              ObjectExtensions.<FeatureConnection>operator_doubleArrow(_get_142, _function_142);
              EList<FeatureConnection> _ownedFeatureConnections_65 = it.getOwnedFeatureConnections();
              FeatureConnection _get_143 = _ownedFeatureConnections_65.get(65);
              final Procedure1<FeatureConnection> _function_143 = new Procedure1<FeatureConnection>() {
                public void apply(final FeatureConnection it) {
                  String _name = it.getName();
                  Assert.assertEquals("fconn66", _name);
                  ConnectedElement _source = it.getSource();
                  Aadl2JavaValidatorTest.assertError(_source, allIssues, "A \'data subcomponent\' in a \'subprogram call\' is not a valid feature connection end.");
                  ConnectedElement _destination = it.getDestination();
                  Aadl2JavaValidatorTest.assertNoIssues(_destination, allIssues);
                }
              };
              ObjectExtensions.<FeatureConnection>operator_doubleArrow(_get_143, _function_143);
              EList<FeatureConnection> _ownedFeatureConnections_66 = it.getOwnedFeatureConnections();
              FeatureConnection _get_144 = _ownedFeatureConnections_66.get(66);
              final Procedure1<FeatureConnection> _function_144 = new Procedure1<FeatureConnection>() {
                public void apply(final FeatureConnection it) {
                  String _name = it.getName();
                  Assert.assertEquals("fconn67", _name);
                  ConnectedElement _source = it.getSource();
                  Aadl2JavaValidatorTest.assertError(_source, allIssues, "A \'subprogram subcomponent\' in a \'subprogram call\' is not a valid feature connection end.");
                  ConnectedElement _destination = it.getDestination();
                  Aadl2JavaValidatorTest.assertNoIssues(_destination, allIssues);
                }
              };
              ObjectExtensions.<FeatureConnection>operator_doubleArrow(_get_144, _function_144);
              EList<FeatureConnection> _ownedFeatureConnections_67 = it.getOwnedFeatureConnections();
              FeatureConnection _get_145 = _ownedFeatureConnections_67.get(67);
              final Procedure1<FeatureConnection> _function_145 = new Procedure1<FeatureConnection>() {
                public void apply(final FeatureConnection it) {
                  String _name = it.getName();
                  Assert.assertEquals("fconn68", _name);
                  ConnectedElement _source = it.getSource();
                  Aadl2JavaValidatorTest.assertError(_source, allIssues, "A \'subprogram proxy\' in a \'subprogram call\' is not a valid feature connection end.");
                  ConnectedElement _destination = it.getDestination();
                  Aadl2JavaValidatorTest.assertNoIssues(_destination, allIssues);
                }
              };
              ObjectExtensions.<FeatureConnection>operator_doubleArrow(_get_145, _function_145);
              EList<FeatureConnection> _ownedFeatureConnections_68 = it.getOwnedFeatureConnections();
              FeatureConnection _get_146 = _ownedFeatureConnections_68.get(68);
              final Procedure1<FeatureConnection> _function_146 = new Procedure1<FeatureConnection>() {
                public void apply(final FeatureConnection it) {
                  String _name = it.getName();
                  Assert.assertEquals("fconn69", _name);
                  ConnectedElement _source = it.getSource();
                  Aadl2JavaValidatorTest.assertError(_source, allIssues, "A \'port proxy\' in a \'subprogram call\' is not a valid feature connection end.");
                  ConnectedElement _destination = it.getDestination();
                  Aadl2JavaValidatorTest.assertNoIssues(_destination, allIssues);
                }
              };
              ObjectExtensions.<FeatureConnection>operator_doubleArrow(_get_146, _function_146);
              EList<FeatureConnection> _ownedFeatureConnections_69 = it.getOwnedFeatureConnections();
              FeatureConnection _get_147 = _ownedFeatureConnections_69.get(69);
              final Procedure1<FeatureConnection> _function_147 = new Procedure1<FeatureConnection>() {
                public void apply(final FeatureConnection it) {
                  String _name = it.getName();
                  Assert.assertEquals("fconn70", _name);
                  ConnectedElement _source = it.getSource();
                  Aadl2JavaValidatorTest.assertError(_source, allIssues, "An \'event data source\' in a \'subprogram call\' is not a valid feature connection end.");
                  ConnectedElement _destination = it.getDestination();
                  Aadl2JavaValidatorTest.assertNoIssues(_destination, allIssues);
                }
              };
              ObjectExtensions.<FeatureConnection>operator_doubleArrow(_get_147, _function_147);
              EList<FeatureConnection> _ownedFeatureConnections_70 = it.getOwnedFeatureConnections();
              FeatureConnection _get_148 = _ownedFeatureConnections_70.get(70);
              final Procedure1<FeatureConnection> _function_148 = new Procedure1<FeatureConnection>() {
                public void apply(final FeatureConnection it) {
                  String _name = it.getName();
                  Assert.assertEquals("fconn71", _name);
                  ConnectedElement _source = it.getSource();
                  Aadl2JavaValidatorTest.assertNoIssues(_source, allIssues);
                  ConnectedElement _destination = it.getDestination();
                  Aadl2JavaValidatorTest.assertNoIssues(_destination, allIssues);
              ...
              ObjectExtensions.<FeatureConnection>operator_doubleArrow(_get_148, _function_148);
              EList<FeatureConnection> _ownedFeatureConnections_71 = it.getOwnedFeatureConnections();
              FeatureConnection _get_149 = _ownedFeatureConnections_71.get(71);
              final Procedure1<FeatureConnection> _function_149 = new Procedure1<FeatureConnection>() {
                public void apply(final FeatureConnection it) {
                  String _name = it.getName();
                  Assert.assertEquals("fconn72", _name);
                  ConnectedElement _source = it.getSource();
                  Aadl2JavaValidatorTest.assertNoIssues(_source, allIssues);
                  ConnectedElement _destination = it.getDestination();
                  Aadl2JavaValidatorTest.assertNoIssues(_destination, allIssues);
              ...
              ObjectExtensions.<FeatureConnection>operator_doubleArrow(_get_149, _function_149);
              EList<FeatureConnection> _ownedFeatureConnections_72 = it.getOwnedFeatureConnections();
              FeatureConnection _get_150 = _ownedFeatureConnections_72.get(72);
              final Procedure1<FeatureConnection> _function_150 = new Procedure1<FeatureConnection>() {
                public void apply(final FeatureConnection it) {
                  String _name = it.getName();
                  Assert.assertEquals("fconn73", _name);
                  ConnectedElement _source = it.getSource();
                  Aadl2JavaValidatorTest.assertNoIssues(_source, allIssues);
                  ConnectedElement _destination = it.getDestination();
                  Aadl2JavaValidatorTest.assertNoIssues(_destination, allIssues);
              ...
              ObjectExtensions.<FeatureConnection>operator_doubleArrow(_get_150, _function_150);
              EList<FeatureConnection> _ownedFeatureConnections_73 = it.getOwnedFeatureConnections();
              FeatureConnection _get_151 = _ownedFeatureConnections_73.get(73);
              final Procedure1<FeatureConnection> _function_151 = new Procedure1<FeatureConnection>() {
                public void apply(final FeatureConnection it) {
                  String _name = it.getName();
                  Assert.assertEquals("fconn74", _name);
                  ConnectedElement _source = it.getSource();
                  Aadl2JavaValidatorTest.assertNoIssues(_source, allIssues);
                  ConnectedElement _destination = it.getDestination();
                  Aadl2JavaValidatorTest.assertNoIssues(_destination, allIssues);
              ...
              ObjectExtensions.<FeatureConnection>operator_doubleArrow(_get_151, _function_151);
              EList<FeatureConnection> _ownedFeatureConnections_74 = it.getOwnedFeatureConnections();
              FeatureConnection _get_152 = _ownedFeatureConnections_74.get(74);
              final Procedure1<FeatureConnection> _function_152 = new Procedure1<FeatureConnection>() {
                public void apply(final FeatureConnection it) {
                  String _name = it.getName();
                  Assert.assertEquals("fconn75", _name);
                  ConnectedElement _source = it.getSource();
                  Aadl2JavaValidatorTest.assertNoIssues(_source, allIssues);
                  ConnectedElement _destination = it.getDestination();
                  Aadl2JavaValidatorTest.assertNoIssues(_destination, allIssues);
              ...
              ObjectExtensions.<FeatureConnection>operator_doubleArrow(_get_152, _function_152);
              EList<FeatureConnection> _ownedFeatureConnections_75 = it.getOwnedFeatureConnections();
              FeatureConnection _get_153 = _ownedFeatureConnections_75.get(75);
              final Procedure1<FeatureConnection> _function_153 = new Procedure1<FeatureConnection>() {
                public void apply(final FeatureConnection it) {
                  String _name = it.getName();
                  Assert.assertEquals("fconn76", _name);
                  ConnectedElement _source = it.getSource();
                  Aadl2JavaValidatorTest.assertNoIssues(_source, allIssues);
                  ConnectedElement _destination = it.getDestination();
                  Aadl2JavaValidatorTest.assertNoIssues(_destination, allIssues);
              ...
              ObjectExtensions.<FeatureConnection>operator_doubleArrow(_get_153, _function_153);
              EList<FeatureConnection> _ownedFeatureConnections_76 = it.getOwnedFeatureConnections();
              FeatureConnection _get_154 = _ownedFeatureConnections_76.get(76);
              final Procedure1<FeatureConnection> _function_154 = new Procedure1<FeatureConnection>() {
                public void apply(final FeatureConnection it) {
                  String _name = it.getName();
                  Assert.assertEquals("fconn77", _name);
                  ConnectedElement _source = it.getSource();
                  Aadl2JavaValidatorTest.assertNoIssues(_source, allIssues);
                  ConnectedElement _destination = it.getDestination();
                  Aadl2JavaValidatorTest.assertNoIssues(_destination, allIssues);
              ...
              ObjectExtensions.<FeatureConnection>operator_doubleArrow(_get_154, _function_154);
              EList<FeatureGroupConnection> _ownedFeatureGroupConnections = it.getOwnedFeatureGroupConnections();
              FeatureGroupConnection _get_155 = _ownedFeatureGroupConnections.get(0);
              final Procedure1<FeatureGroupConnection> _function_155 = new Procedure1<FeatureGroupConnection>() {
                public void apply(final FeatureGroupConnection it) {
                  ...
                  ConnectedElement _source = it.getSource();
                  Aadl2JavaValidatorTest.assertError(_source, allIssues, "A \'bus subcomponent\' is not a valid feature group connection end.");
                  ConnectedElement _destination = it.getDestination();
                  Aadl2JavaValidatorTest.assertNoIssues(_destination, allIssues);
                }
              };
              ...
              FeatureGroupConnection _get_156 = _ownedFeatureGroupConnections_1.get(1);
              final Procedure1<FeatureGroupConnection> _function_156 = new Procedure1<FeatureGroupConnection>() {
                public void apply(final FeatureGroupConnection it) {
                  ...
                  ConnectedElement _source = it.getSource();
                  Aadl2JavaValidatorTest.assertError(_source, allIssues, "A \'data subcomponent\' is not a valid feature group connection end.");
                  ConnectedElement _destination = it.getDestination();
                  Aadl2JavaValidatorTest.assertNoIssues(_destination, allIssues);
                }
              };
              ...
              FeatureGroupConnection _get_157 = _ownedFeatureGroupConnections_2.get(2);
              final Procedure1<FeatureGroupConnection> _function_157 = new Procedure1<FeatureGroupConnection>() {
                public void apply(final FeatureGroupConnection it) {
                  ...
                  ConnectedElement _source = it.getSource();
                  Aadl2JavaValidatorTest.assertError(_source, allIssues, "A \'subprogram group subcomponent\' is not a valid feature group connection end.");
                  ConnectedElement _destination = it.getDestination();
                  Aadl2JavaValidatorTest.assertNoIssues(_destination, allIssues);
                }
              };
              ...
              FeatureGroupConnection _get_158 = _ownedFeatureGroupConnections_3.get(3);
              final Procedure1<FeatureGroupConnection> _function_158 = new Procedure1<FeatureGroupConnection>() {
                public void apply(final FeatureGroupConnection it) {
                  ...
                  ConnectedElement _source = it.getSource();
                  Aadl2JavaValidatorTest.assertError(_source, allIssues, "A \'subprogram subcomponent\' is not a valid feature group connection end.");
                  ConnectedElement _destination = it.getDestination();
                  Aadl2JavaValidatorTest.assertNoIssues(_destination, allIssues);
                }
              };
              ...
              FeatureGroupConnection _get_159 = _ownedFeatureGroupConnections_4.get(4);
              final Procedure1<FeatureGroupConnection> _function_159 = new Procedure1<FeatureGroupConnection>() {
                public void apply(final FeatureGroupConnection it) {
                  ...
                  ConnectedElement _source = it.getSource();
                  Aadl2JavaValidatorTest.assertError(_source, allIssues, "A \'subprogram proxy\' is not a valid feature group connection end.");
                  ConnectedElement _destination = it.getDestination();
                  Aadl2JavaValidatorTest.assertNoIssues(_destination, allIssues);
                }
              };
              ...
              FeatureGroupConnection _get_160 = _ownedFeatureGroupConnections_5.get(5);
              final Procedure1<FeatureGroupConnection> _function_160 = new Procedure1<FeatureGroupConnection>() {
                public void apply(final FeatureGroupConnection it) {
                  ...
                  ConnectedElement _source = it.getSource();
                  Aadl2JavaValidatorTest.assertError(_source, allIssues, "A \'port proxy\' is not a valid feature group connection end.");
                  ConnectedElement _destination = it.getDestination();
                  Aadl2JavaValidatorTest.assertNoIssues(_destination, allIssues);
                }
              };
              ...
              FeatureGroupConnection _get_161 = _ownedFeatureGroupConnections_6.get(6);
              final Procedure1<FeatureGroupConnection> _function_161 = new Procedure1<FeatureGroupConnection>() {
                public void apply(final FeatureGroupConnection it) {
                  ...
                  ConnectedElement _source = it.getSource();
                  Aadl2JavaValidatorTest.assertError(_source, allIssues, "An \'event data source\' is not a valid feature group connection end.");
                  ConnectedElement _destination = it.getDestination();
                  Aadl2JavaValidatorTest.assertNoIssues(_destination, allIssues);
                }
              };
              ...
              FeatureGroupConnection _get_162 = _ownedFeatureGroupConnections_7.get(7);
              final Procedure1<FeatureGroupConnection> _function_162 = new Procedure1<FeatureGroupConnection>() {
                public void apply(final FeatureGroupConnection it) {
                  ...
                  ConnectedElement _source = it.getSource();
                  Aadl2JavaValidatorTest.assertError(_source, allIssues, "An \'abstract feature\' is not a valid feature group connection end.");
                  ConnectedElement _destination = it.getDestination();
                  Aadl2JavaValidatorTest.assertNoIssues(_destination, allIssues);
                }
              };
              ...
              FeatureGroupConnection _get_163 = _ownedFeatureGroupConnections_8.get(8);
              final Procedure1<FeatureGroupConnection> _function_163 = new Procedure1<FeatureGroupConnection>() {
                public void apply(final FeatureGroupConnection it) {
                  String _name = it.getName();
                  Assert.assertEquals("fgconn9", _name);
                  ConnectedElement _source = it.getSource();
                  Aadl2JavaValidatorTest.assertNoIssues(_source, allIssues);
                  ConnectedElement _destination = it.getDestination();
                  Aadl2JavaValidatorTest.assertNoIssues(_destination, allIssues);
              ...
              FeatureGroupConnection _get_164 = _ownedFeatureGroupConnections_9.get(9);
              final Procedure1<FeatureGroupConnection> _function_164 = new Procedure1<FeatureGroupConnection>() {
                public void apply(final FeatureGroupConnection it) {
                  ...
                  ConnectedElement _source = it.getSource();
                  Aadl2JavaValidatorTest.assertError(_source, allIssues, "A \'bus access\' is not a valid feature group connection end.");
                  ConnectedElement _destination = it.getDestination();
                  Aadl2JavaValidatorTest.assertNoIssues(_destination, allIssues);
                }
              };
              ...
              FeatureGroupConnection _get_165 = _ownedFeatureGroupConnections_10.get(10);
              final Procedure1<FeatureGroupConnection> _function_165 = new Procedure1<FeatureGroupConnection>() {
                public void apply(final FeatureGroupConnection it) {
                  ...
                  ConnectedElement _source = it.getSource();
                  Aadl2JavaValidatorTest.assertError(_source, allIssues, "A \'data access\' is not a valid feature group connection end.");
                  ConnectedElement _destination = it.getDestination();
                  Aadl2JavaValidatorTest.assertNoIssues(_destination, allIssues);
                }
              };
              ...
              FeatureGroupConnection _get_166 = _ownedFeatureGroupConnections_11.get(11);
              final Procedure1<FeatureGroupConnection> _function_166 = new Procedure1<FeatureGroupConnection>() {
                public void apply(final FeatureGroupConnection it) {
                  ...
                  ConnectedElement _source = it.getSource();
                  Aadl2JavaValidatorTest.assertError(_source, allIssues, "An \'event port\' is not a valid feature group connection end.");
                  ConnectedElement _destination = it.getDestination();
                  Aadl2JavaValidatorTest.assertNoIssues(_destination, allIssues);
                }
              };
              ...
              FeatureGroupConnection _get_167 = _ownedFeatureGroupConnections_12.get(12);
              final Procedure1<FeatureGroupConnection> _function_167 = new Procedure1<FeatureGroupConnection>() {
                public void apply(final FeatureGroupConnection it) {
                  ...
                  ConnectedElement _source = it.getSource();
                  Aadl2JavaValidatorTest.assertError(_source, allIssues, "A \'data port\' is not a valid feature group connection end.");
                  ConnectedElement _destination = it.getDestination();
                  Aadl2JavaValidatorTest.assertNoIssues(_destination, allIssues);
                }
              };
              ...
              FeatureGroupConnection _get_168 = _ownedFeatureGroupConnections_13.get(13);
              final Procedure1<FeatureGroupConnection> _function_168 = new Procedure1<FeatureGroupConnection>() {
                public void apply(final FeatureGroupConnection it) {
                  ...
                  ConnectedElement _source = it.getSource();
                  Aadl2JavaValidatorTest.assertError(_source, allIssues, "An \'event data port\' is not a valid feature group connection end.");
                  ConnectedElement _destination = it.getDestination();
                  Aadl2JavaValidatorTest.assertNoIssues(_destination, allIssues);
                }
              };
              ...
              FeatureGroupConnection _get_169 = _ownedFeatureGroupConnections_14.get(14);
              final Procedure1<FeatureGroupConnection> _function_169 = new Procedure1<FeatureGroupConnection>() {
                public void apply(final FeatureGroupConnection it) {
                  ...
                  ConnectedElement _source = it.getSource();
                  Aadl2JavaValidatorTest.assertError(_source, allIssues, "Anything in a \'data port\' is not a valid feature group connection end.");
                  ConnectedElement _destination = it.getDestination();
                  Aadl2JavaValidatorTest.assertNoIssues(_destination, allIssues);
                }
              };
              ...
              FeatureGroupConnection _get_170 = _ownedFeatureGroupConnections_15.get(15);
              ...
              FeatureGroupConnection _get_171 = _ownedFeatureGroupConnections_16.get(16);
              ...
              FeatureGroupConnection _get_172 = _ownedFeatureGroupConnections_17.get(17);
              ...
              FeatureGroupConnection _get_173 = _ownedFeatureGroupConnections_18.get(18);
              ...
              FeatureGroupConnection _get_174 = _ownedFeatureGroupConnections_19.get(19);
              ...
              FeatureGroupConnection _get_175 = _ownedFeatureGroupConnections_20.get(20);
              ...
              FeatureGroupConnection _get_176 = _ownedFeatureGroupConnections_21.get(21);
              ...
              FeatureGroupConnection _get_177 = _ownedFeatureGroupConnections_22.get(22);
              ...
              FeatureGroupConnection _get_178 = _ownedFeatureGroupConnections_23.get(23);
              ...
              FeatureGroupConnection _get_179 = _ownedFeatureGroupConnections_24.get(24);
              ...
              FeatureGroupConnection _get_180 = _ownedFeatureGroupConnections_25.get(25);
              ...
              FeatureGroupConnection _get_181 = _ownedFeatureGroupConnections_26.get(26);
              ...
              FeatureGroupConnection _get_182 = _ownedFeatureGroupConnections_27.get(27);
              ...
              FeatureGroupConnection _get_183 = _ownedFeatureGroupConnections_28.get(28);
              final Procedure1<FeatureGroupConnection> _function_183 = new Procedure1<FeatureGroupConnection>() {
                public void apply(final FeatureGroupConnection it) {
                  ...
                  ConnectedElement _source = it.getSource();
                  Aadl2JavaValidatorTest.assertError(_source, allIssues, "Anything in an \'event data port\' is not a valid feature group connection end.");
                  ConnectedElement _destination = it.getDestination();
                  Aadl2JavaValidatorTest.assertNoIssues(_destination, allIssues);
                }
              };
              ...
              FeatureGroupConnection _get_184 = _ownedFeatureGroupConnections_29.get(29);
              final Procedure1<FeatureGroupConnection> _function_184 = new Procedure1<FeatureGroupConnection>() {
                public void apply(final FeatureGroupConnection it) {
                  String _name = it.getName();
              ...
              ObjectExtensions.<FeatureGroupConnection>operator_doubleArrow(_get_184, _function_184);
              EList<FeatureGroupConnection> _ownedFeatureGroupConnections_30 = it.getOwnedFeatureGroupConnections();
              FeatureGroupConnection _get_185 = _ownedFeatureGroupConnections_30.get(30);
              final Procedure1<FeatureGroupConnection> _function_185 = new Procedure1<FeatureGroupConnection>() {
                public void apply(final FeatureGroupConnection it) {
                  String _name = it.getName();
              ...
              ObjectExtensions.<FeatureGroupConnection>operator_doubleArrow(_get_185, _function_185);
              EList<FeatureGroupConnection> _ownedFeatureGroupConnections_31 = it.getOwnedFeatureGroupConnections();
              FeatureGroupConnection _get_186 = _ownedFeatureGroupConnections_31.get(31);
              final Procedure1<FeatureGroupConnection> _function_186 = new Procedure1<FeatureGroupConnection>() {
                public void apply(final FeatureGroupConnection it) {
                  String _name = it.getName();
              ...
              ObjectExtensions.<FeatureGroupConnection>operator_doubleArrow(_get_186, _function_186);
              EList<FeatureGroupConnection> _ownedFeatureGroupConnections_32 = it.getOwnedFeatureGroupConnections();
              FeatureGroupConnection _get_187 = _ownedFeatureGroupConnections_32.get(32);
              final Procedure1<FeatureGroupConnection> _function_187 = new Procedure1<FeatureGroupConnection>() {
                public void apply(final FeatureGroupConnection it) {
                  String _name = it.getName();
              ...
              ObjectExtensions.<FeatureGroupConnection>operator_doubleArrow(_get_187, _function_187);
              EList<FeatureGroupConnection> _ownedFeatureGroupConnections_33 = it.getOwnedFeatureGroupConnections();
              FeatureGroupConnection _get_188 = _ownedFeatureGroupConnections_33.get(33);
              final Procedure1<FeatureGroupConnection> _function_188 = new Procedure1<FeatureGroupConnection>() {
                public void apply(final FeatureGroupConnection it) {
                  String _name = it.getName();
              ...
              ObjectExtensions.<FeatureGroupConnection>operator_doubleArrow(_get_188, _function_188);
              EList<FeatureGroupConnection> _ownedFeatureGroupConnections_34 = it.getOwnedFeatureGroupConnections();
              FeatureGroupConnection _get_189 = _ownedFeatureGroupConnections_34.get(34);
              final Procedure1<FeatureGroupConnection> _function_189 = new Procedure1<FeatureGroupConnection>() {
                public void apply(final FeatureGroupConnection it) {
                  String _name = it.getName();
              ...
              ObjectExtensions.<FeatureGroupConnection>operator_doubleArrow(_get_189, _function_189);
              EList<FeatureGroupConnection> _ownedFeatureGroupConnections_35 = it.getOwnedFeatureGroupConnections();
              FeatureGroupConnection _get_190 = _ownedFeatureGroupConnections_35.get(35);
              final Procedure1<FeatureGroupConnection> _function_190 = new Procedure1<FeatureGroupConnection>() {
                public void apply(final FeatureGroupConnection it) {
                  String _name = it.getName();
              ...
              ObjectExtensions.<FeatureGroupConnection>operator_doubleArrow(_get_190, _function_190);
              EList<FeatureGroupConnection> _ownedFeatureGroupConnections_36 = it.getOwnedFeatureGroupConnections();
              FeatureGroupConnection _get_191 = _ownedFeatureGroupConnections_36.get(36);
              final Procedure1<FeatureGroupConnection> _function_191 = new Procedure1<FeatureGroupConnection>() {
                public void apply(final FeatureGroupConnection it) {
                  String _name = it.getName();
              ...
              ObjectExtensions.<FeatureGroupConnection>operator_doubleArrow(_get_191, _function_191);
              EList<FeatureGroupConnection> _ownedFeatureGroupConnections_37 = it.getOwnedFeatureGroupConnections();
              FeatureGroupConnection _get_192 = _ownedFeatureGroupConnections_37.get(37);
              final Procedure1<FeatureGroupConnection> _function_192 = new Procedure1<FeatureGroupConnection>() {
                public void apply(final FeatureGroupConnection it) {
                  String _name = it.getName();
              ...
              ObjectExtensions.<FeatureGroupConnection>operator_doubleArrow(_get_192, _function_192);
              EList<FeatureGroupConnection> _ownedFeatureGroupConnections_38 = it.getOwnedFeatureGroupConnections();
              FeatureGroupConnection _get_193 = _ownedFeatureGroupConnections_38.get(38);
              final Procedure1<FeatureGroupConnection> _function_193 = new Procedure1<FeatureGroupConnection>() {
                public void apply(final FeatureGroupConnection it) {
                  String _name = it.getName();
              ...
              ObjectExtensions.<FeatureGroupConnection>operator_doubleArrow(_get_193, _function_193);
              EList<FeatureGroupConnection> _ownedFeatureGroupConnections_39 = it.getOwnedFeatureGroupConnections();
              FeatureGroupConnection _get_194 = _ownedFeatureGroupConnections_39.get(39);
              final Procedure1<FeatureGroupConnection> _function_194 = new Procedure1<FeatureGroupConnection>() {
                public void apply(final FeatureGroupConnection it) {
                  String _name = it.getName();
              ...
              ObjectExtensions.<FeatureGroupConnection>operator_doubleArrow(_get_194, _function_194);
              EList<FeatureGroupConnection> _ownedFeatureGroupConnections_40 = it.getOwnedFeatureGroupConnections();
              FeatureGroupConnection _get_195 = _ownedFeatureGroupConnections_40.get(40);
              final Procedure1<FeatureGroupConnection> _function_195 = new Procedure1<FeatureGroupConnection>() {
                public void apply(final FeatureGroupConnection it) {
                  String _name = it.getName();
              ...
              ObjectExtensions.<FeatureGroupConnection>operator_doubleArrow(_get_195, _function_195);
              EList<FeatureGroupConnection> _ownedFeatureGroupConnections_41 = it.getOwnedFeatureGroupConnections();
              FeatureGroupConnection _get_196 = _ownedFeatureGroupConnections_41.get(41);
              final Procedure1<FeatureGroupConnection> _function_196 = new Procedure1<FeatureGroupConnection>() {
                public void apply(final FeatureGroupConnection it) {
                  String _name = it.getName();
              ...
              ObjectExtensions.<FeatureGroupConnection>operator_doubleArrow(_get_196, _function_196);
              EList<FeatureGroupConnection> _ownedFeatureGroupConnections_42 = it.getOwnedFeatureGroupConnections();
              FeatureGroupConnection _get_197 = _ownedFeatureGroupConnections_42.get(42);
              final Procedure1<FeatureGroupConnection> _function_197 = new Procedure1<FeatureGroupConnection>() {
                public void apply(final FeatureGroupConnection it) {
                  String _name = it.getName();
                  Assert.assertEquals("fgconn43", _name);
                  ConnectedElement _source = it.getSource();
                  Aadl2JavaValidatorTest.assertError(_source, allIssues, "An \'abstract feature\' in a \'feature group\' is not a valid feature group connection end.");
                  ConnectedElement _destination = it.getDestination();
                  Aadl2JavaValidatorTest.assertNoIssues(_destination, allIssues);
                }
              };
              ObjectExtensions.<FeatureGroupConnection>operator_doubleArrow(_get_197, _function_197);
              EList<FeatureGroupConnection> _ownedFeatureGroupConnections_43 = it.getOwnedFeatureGroupConnections();
              FeatureGroupConnection _get_198 = _ownedFeatureGroupConnections_43.get(43);
              final Procedure1<FeatureGroupConnection> _function_198 = new Procedure1<FeatureGroupConnection>() {
                public void apply(final FeatureGroupConnection it) {
                  String _name = it.getName();
                  Assert.assertEquals("fgconn44", _name);
                  ConnectedElement _source = it.getSource();
                  Aadl2JavaValidatorTest.assertNoIssues(_source, allIssues);
                  ConnectedElement _destination = it.getDestination();
                  Aadl2JavaValidatorTest.assertNoIssues(_destination, allIssues);
              ...
              ObjectExtensions.<FeatureGroupConnection>operator_doubleArrow(_get_198, _function_198);
              EList<FeatureGroupConnection> _ownedFeatureGroupConnections_44 = it.getOwnedFeatureGroupConnections();
              FeatureGroupConnection _get_199 = _ownedFeatureGroupConnections_44.get(44);
              final Procedure1<FeatureGroupConnection> _function_199 = new Procedure1<FeatureGroupConnection>() {
                public void apply(final FeatureGroupConnection it) {
                  String _name = it.getName();
                  Assert.assertEquals("fgconn45", _name);
                  ConnectedElement _source = it.getSource();
                  Aadl2JavaValidatorTest.assertError(_source, allIssues, "A \'parameter\' in a \'feature group\' is not a valid feature group connection end.");
                  ConnectedElement _destination = it.getDestination();
                  Aadl2JavaValidatorTest.assertNoIssues(_destination, allIssues);
                }
              };
              ObjectExtensions.<FeatureGroupConnection>operator_doubleArrow(_get_199, _function_199);
              EList<FeatureGroupConnection> _ownedFeatureGroupConnections_45 = it.getOwnedFeatureGroupConnections();
              FeatureGroupConnection _get_200 = _ownedFeatureGroupConnections_45.get(45);
              final Procedure1<FeatureGroupConnection> _function_200 = new Procedure1<FeatureGroupConnection>() {
                public void apply(final FeatureGroupConnection it) {
                  String _name = it.getName();
                  Assert.assertEquals("fgconn46", _name);
                  ConnectedElement _source = it.getSource();
                  Aadl2JavaValidatorTest.assertError(_source, allIssues, "A \'bus access\' in a \'feature group\' is not a valid feature group connection end.");
                  ConnectedElement _destination = it.getDestination();
                  Aadl2JavaValidatorTest.assertNoIssues(_destination, allIssues);
                }
              };
              ObjectExtensions.<FeatureGroupConnection>operator_doubleArrow(_get_200, _function_200);
              EList<FeatureGroupConnection> _ownedFeatureGroupConnections_46 = it.getOwnedFeatureGroupConnections();
              FeatureGroupConnection _get_201 = _ownedFeatureGroupConnections_46.get(46);
              final Procedure1<FeatureGroupConnection> _function_201 = new Procedure1<FeatureGroupConnection>() {
                public void apply(final FeatureGroupConnection it) {
                  String _name = it.getName();
                  Assert.assertEquals("fgconn47", _name);
                  ConnectedElement _source = it.getSource();
                  Aadl2JavaValidatorTest.assertError(_source, allIssues, "A \'data access\' in a \'feature group\' is not a valid feature group connection end.");
                  ConnectedElement _destination = it.getDestination();
                  Aadl2JavaValidatorTest.assertNoIssues(_destination, allIssues);
                }
              };
              ObjectExtensions.<FeatureGroupConnection>operator_doubleArrow(_get_201, _function_201);
              EList<FeatureGroupConnection> _ownedFeatureGroupConnections_47 = it.getOwnedFeatureGroupConnections();
              FeatureGroupConnection _get_202 = _ownedFeatureGroupConnections_47.get(47);
              final Procedure1<FeatureGroupConnection> _function_202 = new Procedure1<FeatureGroupConnection>() {
                public void apply(final FeatureGroupConnection it) {
                  String _name = it.getName();
                  Assert.assertEquals("fgconn48", _name);
                  ConnectedElement _source = it.getSource();
                  Aadl2JavaValidatorTest.assertError(_source, allIssues, "An \'event port\' in a \'feature group\' is not a valid feature group connection end.");
                  ConnectedElement _destination = it.getDestination();
                  Aadl2JavaValidatorTest.assertNoIssues(_destination, allIssues);
                }
              };
              ObjectExtensions.<FeatureGroupConnection>operator_doubleArrow(_get_202, _function_202);
              EList<FeatureGroupConnection> _ownedFeatureGroupConnections_48 = it.getOwnedFeatureGroupConnections();
              FeatureGroupConnection _get_203 = _ownedFeatureGroupConnections_48.get(48);
              final Procedure1<FeatureGroupConnection> _function_203 = new Procedure1<FeatureGroupConnection>() {
                public void apply(final FeatureGroupConnection it) {
                  String _name = it.getName();
                  Assert.assertEquals("fgconn49", _name);
                  ConnectedElement _source = it.getSource();
                  Aadl2JavaValidatorTest.assertError(_source, allIssues, "A \'data port\' in a \'feature group\' is not a valid feature group connection end.");
                  ConnectedElement _destination = it.getDestination();
                  Aadl2JavaValidatorTest.assertNoIssues(_destination, allIssues);
                }
              };
              ObjectExtensions.<FeatureGroupConnection>operator_doubleArrow(_get_203, _function_203);
              EList<FeatureGroupConnection> _ownedFeatureGroupConnections_49 = it.getOwnedFeatureGroupConnections();
              FeatureGroupConnection _get_204 = _ownedFeatureGroupConnections_49.get(49);
              final Procedure1<FeatureGroupConnection> _function_204 = new Procedure1<FeatureGroupConnection>() {
                public void apply(final FeatureGroupConnection it) {
                  String _name = it.getName();
                  Assert.assertEquals("fgconn50", _name);
                  ConnectedElement _source = it.getSource();
                  Aadl2JavaValidatorTest.assertError(_source, allIssues, "An \'event data port\' in a \'feature group\' is not a valid feature group connection end.");
                  ConnectedElement _destination = it.getDestination();
                  Aadl2JavaValidatorTest.assertNoIssues(_destination, allIssues);
                }
              };
              ObjectExtensions.<FeatureGroupConnection>operator_doubleArrow(_get_204, _function_204);
              EList<FeatureGroupConnection> _ownedFeatureGroupConnections_50 = it.getOwnedFeatureGroupConnections();
              FeatureGroupConnection _get_205 = _ownedFeatureGroupConnections_50.get(50);
              final Procedure1<FeatureGroupConnection> _function_205 = new Procedure1<FeatureGroupConnection>() {
                public void apply(final FeatureGroupConnection it) {
                  String _name = it.getName();
                  Assert.assertEquals("fgconn51", _name);
                  ConnectedElement _source = it.getSource();
                  Aadl2JavaValidatorTest.assertError(_source, allIssues, "A \'bus subcomponent\' in an \'abstract subcomponent\' is not a valid feature group connection end.");
                  ConnectedElement _destination = it.getDestination();
                  Aadl2JavaValidatorTest.assertNoIssues(_destination, allIssues);
                }
              };
              ObjectExtensions.<FeatureGroupConnection>operator_doubleArrow(_get_205, _function_205);
              EList<FeatureGroupConnection> _ownedFeatureGroupConnections_51 = it.getOwnedFeatureGroupConnections();
              FeatureGroupConnection _get_206 = _ownedFeatureGroupConnections_51.get(51);
              final Procedure1<FeatureGroupConnection> _function_206 = new Procedure1<FeatureGroupConnection>() {
                public void apply(final FeatureGroupConnection it) {
                  String _name = it.getName();
                  Assert.assertEquals("fgconn52", _name);
                  ConnectedElement _source = it.getSource();
                  Aadl2JavaValidatorTest.assertError(_source, allIssues, "A \'data subcomponent\' in an \'abstract subcomponent\' is not a valid feature group connection end.");
                  ConnectedElement _destination = it.getDestination();
                  Aadl2JavaValidatorTest.assertNoIssues(_destination, allIssues);
                }
              };
              ObjectExtensions.<FeatureGroupConnection>operator_doubleArrow(_get_206, _function_206);
              EList<FeatureGroupConnection> _ownedFeatureGroupConnections_52 = it.getOwnedFeatureGroupConnections();
              FeatureGroupConnection _get_207 = _ownedFeatureGroupConnections_52.get(52);
              final Procedure1<FeatureGroupConnection> _function_207 = new Procedure1<FeatureGroupConnection>() {
                public void apply(final FeatureGroupConnection it) {
                  String _name = it.getName();
                  Assert.assertEquals("fgconn53", _name);
                  ConnectedElement _source = it.getSource();
                  Aadl2JavaValidatorTest.assertError(_source, allIssues, "A \'subprogram group subcomponent\' in an \'abstract subcomponent\' is not a valid feature group connection end.");
                  ConnectedElement _destination = it.getDestination();
                  Aadl2JavaValidatorTest.assertNoIssues(_destination, allIssues);
                }
              };
              ObjectExtensions.<FeatureGroupConnection>operator_doubleArrow(_get_207, _function_207);
              EList<FeatureGroupConnection> _ownedFeatureGroupConnections_53 = it.getOwnedFeatureGroupConnections();
              FeatureGroupConnection _get_208 = _ownedFeatureGroupConnections_53.get(53);
              final Procedure1<FeatureGroupConnection> _function_208 = new Procedure1<FeatureGroupConnection>() {
                public void apply(final FeatureGroupConnection it) {
                  String _name = it.getName();
                  Assert.assertEquals("fgconn54", _name);
                  ConnectedElement _source = it.getSource();
                  Aadl2JavaValidatorTest.assertError(_source, allIssues, "A \'subprogram subcomponent\' in an \'abstract subcomponent\' is not a valid feature group connection end.");
                  ConnectedElement _destination = it.getDestination();
                  Aadl2JavaValidatorTest.assertNoIssues(_destination, allIssues);
                }
              };
              ObjectExtensions.<FeatureGroupConnection>operator_doubleArrow(_get_208, _function_208);
              EList<FeatureGroupConnection> _ownedFeatureGroupConnections_54 = it.getOwnedFeatureGroupConnections();
              FeatureGroupConnection _get_209 = _ownedFeatureGroupConnections_54.get(54);
              final Procedure1<FeatureGroupConnection> _function_209 = new Procedure1<FeatureGroupConnection>() {
                public void apply(final FeatureGroupConnection it) {
                  String _name = it.getName();
                  Assert.assertEquals("fgconn55", _name);
                  ConnectedElement _source = it.getSource();
                  Aadl2JavaValidatorTest.assertError(_source, allIssues, "A \'subprogram proxy\' in an \'abstract subcomponent\' is not a valid feature group connection end.");
                  ConnectedElement _destination = it.getDestination();
                  Aadl2JavaValidatorTest.assertNoIssues(_destination, allIssues);
                }
              };
              ObjectExtensions.<FeatureGroupConnection>operator_doubleArrow(_get_209, _function_209);
              EList<FeatureGroupConnection> _ownedFeatureGroupConnections_55 = it.getOwnedFeatureGroupConnections();
              FeatureGroupConnection _get_210 = _ownedFeatureGroupConnections_55.get(55);
              final Procedure1<FeatureGroupConnection> _function_210 = new Procedure1<FeatureGroupConnection>() {
                public void apply(final FeatureGroupConnection it) {
                  String _name = it.getName();
                  Assert.assertEquals("fgconn56", _name);
                  ConnectedElement _source = it.getSource();
                  Aadl2JavaValidatorTest.assertError(_source, allIssues, "A \'port proxy\' in an \'abstract subcomponent\' is not a valid feature group connection end.");
                  ConnectedElement _destination = it.getDestination();
                  Aadl2JavaValidatorTest.assertNoIssues(_destination, allIssues);
                }
              };
              ObjectExtensions.<FeatureGroupConnection>operator_doubleArrow(_get_210, _function_210);
              EList<FeatureGroupConnection> _ownedFeatureGroupConnections_56 = it.getOwnedFeatureGroupConnections();
              FeatureGroupConnection _get_211 = _ownedFeatureGroupConnections_56.get(56);
              final Procedure1<FeatureGroupConnection> _function_211 = new Procedure1<FeatureGroupConnection>() {
                public void apply(final FeatureGroupConnection it) {
                  String _name = it.getName();
                  Assert.assertEquals("fgconn57", _name);
                  ConnectedElement _source = it.getSource();
                  Aadl2JavaValidatorTest.assertError(_source, allIssues, "An \'event data source\' in an \'abstract subcomponent\' is not a valid feature group connection end.");
                  ConnectedElement _destination = it.getDestination();
                  Aadl2JavaValidatorTest.assertNoIssues(_destination, allIssues);
                }
              };
              ObjectExtensions.<FeatureGroupConnection>operator_doubleArrow(_get_211, _function_211);
              EList<FeatureGroupConnection> _ownedFeatureGroupConnections_57 = it.getOwnedFeatureGroupConnections();
              FeatureGroupConnection _get_212 = _ownedFeatureGroupConnections_57.get(57);
              final Procedure1<FeatureGroupConnection> _function_212 = new Procedure1<FeatureGroupConnection>() {
                public void apply(final FeatureGroupConnection it) {
                  String _name = it.getName();
                  Assert.assertEquals("fgconn58", _name);
                  ConnectedElement _source = it.getSource();
                  Aadl2JavaValidatorTest.assertError(_source, allIssues, "An \'abstract feature\' in an \'abstract subcomponent\' is not a valid feature group connection end.");
                  ConnectedElement _destination = it.getDestination();
                  Aadl2JavaValidatorTest.assertNoIssues(_destination, allIssues);
                }
              };
              ObjectExtensions.<FeatureGroupConnection>operator_doubleArrow(_get_212, _function_212);
              EList<FeatureGroupConnection> _ownedFeatureGroupConnections_58 = it.getOwnedFeatureGroupConnections();
              FeatureGroupConnection _get_213 = _ownedFeatureGroupConnections_58.get(58);
              final Procedure1<FeatureGroupConnection> _function_213 = new Procedure1<FeatureGroupConnection>() {
                public void apply(final FeatureGroupConnection it) {
                  String _name = it.getName();
                  Assert.assertEquals("fgconn59", _name);
                  ConnectedElement _source = it.getSource();
                  Aadl2JavaValidatorTest.assertNoIssues(_source, allIssues);
                  ConnectedElement _destination = it.getDestination();
                  Aadl2JavaValidatorTest.assertNoIssues(_destination, allIssues);
              ...
              ObjectExtensions.<FeatureGroupConnection>operator_doubleArrow(_get_213, _function_213);
              EList<FeatureGroupConnection> _ownedFeatureGroupConnections_59 = it.getOwnedFeatureGroupConnections();
              FeatureGroupConnection _get_214 = _ownedFeatureGroupConnections_59.get(59);
              final Procedure1<FeatureGroupConnection> _function_214 = new Procedure1<FeatureGroupConnection>() {
                public void apply(final FeatureGroupConnection it) {
                  String _name = it.getName();
                  Assert.assertEquals("fgconn60", _name);
                  ConnectedElement _source = it.getSource();
                  Aadl2JavaValidatorTest.assertError(_source, allIssues, "A \'parameter\' in a \'subprogram subcomponent\' is not a valid feature group connection end.");
                  ConnectedElement _destination = it.getDestination();
                  Aadl2JavaValidatorTest.assertNoIssues(_destination, allIssues);
                }
              };
              ObjectExtensions.<FeatureGroupConnection>operator_doubleArrow(_get_214, _function_214);
              EList<FeatureGroupConnection> _ownedFeatureGroupConnections_60 = it.getOwnedFeatureGroupConnections();
              FeatureGroupConnection _get_215 = _ownedFeatureGroupConnections_60.get(60);
              final Procedure1<FeatureGroupConnection> _function_215 = new Procedure1<FeatureGroupConnection>() {
                public void apply(final FeatureGroupConnection it) {
                  String _name = it.getName();
                  Assert.assertEquals("fgconn61", _name);
                  ConnectedElement _source = it.getSource();
                  Aadl2JavaValidatorTest.assertError(_source, allIssues, "A \'bus access\' in an \'abstract subcomponent\' is not a valid feature group connection end.");
                  ConnectedElement _destination = it.getDestination();
                  Aadl2JavaValidatorTest.assertNoIssues(_destination, allIssues);
                }
              };
              ObjectExtensions.<FeatureGroupConnection>operator_doubleArrow(_get_215, _function_215);
              EList<FeatureGroupConnection> _ownedFeatureGroupConnections_61 = it.getOwnedFeatureGroupConnections();
              FeatureGroupConnection _get_216 = _ownedFeatureGroupConnections_61.get(61);
              final Procedure1<FeatureGroupConnection> _function_216 = new Procedure1<FeatureGroupConnection>() {
                public void apply(final FeatureGroupConnection it) {
                  String _name = it.getName();
                  Assert.assertEquals("fgconn62", _name);
                  ConnectedElement _source = it.getSource();
                  Aadl2JavaValidatorTest.assertError(_source, allIssues, "A \'data access\' in an \'abstract subcomponent\' is not a valid feature group connection end.");
                  ConnectedElement _destination = it.getDestination();
                  Aadl2JavaValidatorTest.assertNoIssues(_destination, allIssues);
                }
              };
              ObjectExtensions.<FeatureGroupConnection>operator_doubleArrow(_get_216, _function_216);
              EList<FeatureGroupConnection> _ownedFeatureGroupConnections_62 = it.getOwnedFeatureGroupConnections();
              FeatureGroupConnection _get_217 = _ownedFeatureGroupConnections_62.get(62);
              final Procedure1<FeatureGroupConnection> _function_217 = new Procedure1<FeatureGroupConnection>() {
                public void apply(final FeatureGroupConnection it) {
                  String _name = it.getName();
                  Assert.assertEquals("fgconn63", _name);
                  ConnectedElement _source = it.getSource();
                  Aadl2JavaValidatorTest.assertError(_source, allIssues, "An \'event port\' in an \'abstract subcomponent\' is not a valid feature group connection end.");
                  ConnectedElement _destination = it.getDestination();
                  Aadl2JavaValidatorTest.assertNoIssues(_destination, allIssues);
                }
              };
              ObjectExtensions.<FeatureGroupConnection>operator_doubleArrow(_get_217, _function_217);
              EList<FeatureGroupConnection> _ownedFeatureGroupConnections_63 = it.getOwnedFeatureGroupConnections();
              FeatureGroupConnection _get_218 = _ownedFeatureGroupConnections_63.get(63);
              final Procedure1<FeatureGroupConnection> _function_218 = new Procedure1<FeatureGroupConnection>() {
                public void apply(final FeatureGroupConnection it) {
                  String _name = it.getName();
                  Assert.assertEquals("fgconn64", _name);
                  ConnectedElement _source = it.getSource();
                  Aadl2JavaValidatorTest.assertError(_source, allIssues, "A \'data port\' in an \'abstract subcomponent\' is not a valid feature group connection end.");
                  ConnectedElement _destination = it.getDestination();
                  Aadl2JavaValidatorTest.assertNoIssues(_destination, allIssues);
                }
              };
              ObjectExtensions.<FeatureGroupConnection>operator_doubleArrow(_get_218, _function_218);
              EList<FeatureGroupConnection> _ownedFeatureGroupConnections_64 = it.getOwnedFeatureGroupConnections();
              FeatureGroupConnection _get_219 = _ownedFeatureGroupConnections_64.get(64);
              final Procedure1<FeatureGroupConnection> _function_219 = new Procedure1<FeatureGroupConnection>() {
                public void apply(final FeatureGroupConnection it) {
                  String _name = it.getName();
                  Assert.assertEquals("fgconn65", _name);
                  ConnectedElement _source = it.getSource();
                  Aadl2JavaValidatorTest.assertError(_source, allIssues, "An \'event data port\' in an \'abstract subcomponent\' is not a valid feature group connection end.");
                  ConnectedElement _destination = it.getDestination();
                  Aadl2JavaValidatorTest.assertNoIssues(_destination, allIssues);
                }
              };
              ObjectExtensions.<FeatureGroupConnection>operator_doubleArrow(_get_219, _function_219);
              EList<FeatureGroupConnection> _ownedFeatureGroupConnections_65 = it.getOwnedFeatureGroupConnections();
              FeatureGroupConnection _get_220 = _ownedFeatureGroupConnections_65.get(65);
              final Procedure1<FeatureGroupConnection> _function_220 = new Procedure1<FeatureGroupConnection>() {
                public void apply(final FeatureGroupConnection it) {
                  String _name = it.getName();
                  Assert.assertEquals("fgconn66", _name);
                  ConnectedElement _source = it.getSource();
                  Aadl2JavaValidatorTest.assertError(_source, allIssues, "Anything in a \'subprogram call\' is not a valid feature group connection end.");
                  ConnectedElement _destination = it.getDestination();
                  Aadl2JavaValidatorTest.assertNoIssues(_destination, allIssues);
                }
              };
              ObjectExtensions.<FeatureGroupConnection>operator_doubleArrow(_get_220, _function_220);
              EList<FeatureGroupConnection> _ownedFeatureGroupConnections_66 = it.getOwnedFeatureGroupConnections();
              FeatureGroupConnection _get_221 = _ownedFeatureGroupConnections_66.get(66);
              final Procedure1<FeatureGroupConnection> _function_221 = new Procedure1<FeatureGroupConnection>() {
                public void apply(final FeatureGroupConnection it) {
                  String _name = it.getName();
              ...
              ObjectExtensions.<FeatureGroupConnection>operator_doubleArrow(_get_221, _function_221);
              EList<FeatureGroupConnection> _ownedFeatureGroupConnections_67 = it.getOwnedFeatureGroupConnections();
              FeatureGroupConnection _get_222 = _ownedFeatureGroupConnections_67.get(67);
              final Procedure1<FeatureGroupConnection> _function_222 = new Procedure1<FeatureGroupConnection>() {
                public void apply(final FeatureGroupConnection it) {
                  String _name = it.getName();
              ...
              ObjectExtensions.<FeatureGroupConnection>operator_doubleArrow(_get_222, _function_222);
              EList<FeatureGroupConnection> _ownedFeatureGroupConnections_68 = it.getOwnedFeatureGroupConnections();
              FeatureGroupConnection _get_223 = _ownedFeatureGroupConnections_68.get(68);
              final Procedure1<FeatureGroupConnection> _function_223 = new Procedure1<FeatureGroupConnection>() {
                public void apply(final FeatureGroupConnection it) {
                  String _name = it.getName();
              ...
              ObjectExtensions.<FeatureGroupConnection>operator_doubleArrow(_get_223, _function_223);
              EList<FeatureGroupConnection> _ownedFeatureGroupConnections_69 = it.getOwnedFeatureGroupConnections();
              FeatureGroupConnection _get_224 = _ownedFeatureGroupConnections_69.get(69);
              final Procedure1<FeatureGroupConnection> _function_224 = new Procedure1<FeatureGroupConnection>() {
                public void apply(final FeatureGroupConnection it) {
                  String _name = it.getName();
              ...
              ObjectExtensions.<FeatureGroupConnection>operator_doubleArrow(_get_224, _function_224);
              EList<FeatureGroupConnection> _ownedFeatureGroupConnections_70 = it.getOwnedFeatureGroupConnections();
              FeatureGroupConnection _get_225 = _ownedFeatureGroupConnections_70.get(70);
              final Procedure1<FeatureGroupConnection> _function_225 = new Procedure1<FeatureGroupConnection>() {
                public void apply(final FeatureGroupConnection it) {
                  String _name = it.getName();
              ...
              ObjectExtensions.<FeatureGroupConnection>operator_doubleArrow(_get_225, _function_225);
              EList<FeatureGroupConnection> _ownedFeatureGroupConnections_71 = it.getOwnedFeatureGroupConnections();
              FeatureGroupConnection _get_226 = _ownedFeatureGroupConnections_71.get(71);
              final Procedure1<FeatureGroupConnection> _function_226 = new Procedure1<FeatureGroupConnection>() {
                public void apply(final FeatureGroupConnection it) {
                  String _name = it.getName();
              ...
              ObjectExtensions.<FeatureGroupConnection>operator_doubleArrow(_get_226, _function_226);
              EList<FeatureGroupConnection> _ownedFeatureGroupConnections_72 = it.getOwnedFeatureGroupConnections();
              FeatureGroupConnection _get_227 = _ownedFeatureGroupConnections_72.get(72);
              final Procedure1<FeatureGroupConnection> _function_227 = new Procedure1<FeatureGroupConnection>() {
                public void apply(final FeatureGroupConnection it) {
                  String _name = it.getName();
              ...
              ObjectExtensions.<FeatureGroupConnection>operator_doubleArrow(_get_227, _function_227);
              EList<FeatureGroupConnection> _ownedFeatureGroupConnections_73 = it.getOwnedFeatureGroupConnections();
              FeatureGroupConnection _get_228 = _ownedFeatureGroupConnections_73.get(73);
              final Procedure1<FeatureGroupConnection> _function_228 = new Procedure1<FeatureGroupConnection>() {
                public void apply(final FeatureGroupConnection it) {
                  String _name = it.getName();
              ...
              ObjectExtensions.<FeatureGroupConnection>operator_doubleArrow(_get_228, _function_228);
              EList<FeatureGroupConnection> _ownedFeatureGroupConnections_74 = it.getOwnedFeatureGroupConnections();
              FeatureGroupConnection _get_229 = _ownedFeatureGroupConnections_74.get(74);
              final Procedure1<FeatureGroupConnection> _function_229 = new Procedure1<FeatureGroupConnection>() {
                public void apply(final FeatureGroupConnection it) {
                  String _name = it.getName();
              ...
              ObjectExtensions.<FeatureGroupConnection>operator_doubleArrow(_get_229, _function_229);
              EList<FeatureGroupConnection> _ownedFeatureGroupConnections_75 = it.getOwnedFeatureGroupConnections();
              FeatureGroupConnection _get_230 = _ownedFeatureGroupConnections_75.get(75);
              final Procedure1<FeatureGroupConnection> _function_230 = new Procedure1<FeatureGroupConnection>() {
                public void apply(final FeatureGroupConnection it) {
                  String _name = it.getName();
              ...
              ObjectExtensions.<FeatureGroupConnection>operator_doubleArrow(_get_230, _function_230);
              EList<FeatureGroupConnection> _ownedFeatureGroupConnections_76 = it.getOwnedFeatureGroupConnections();
              FeatureGroupConnection _get_231 = _ownedFeatureGroupConnections_76.get(76);
              final Procedure1<FeatureGroupConnection> _function_231 = new Procedure1<FeatureGroupConnection>() {
                public void apply(final FeatureGroupConnection it) {
                  String _name = it.getName();
              ...
              ObjectExtensions.<FeatureGroupConnection>operator_doubleArrow(_get_231, _function_231);
              EList<ParameterConnection> _ownedParameterConnections = it.getOwnedParameterConnections();
              ParameterConnection _get_232 = _ownedParameterConnections.get(0);
              final Procedure1<ParameterConnection> _function_232 = new Procedure1<ParameterConnection>() {
                public void apply(final ParameterConnection it) {
                  ...
                  ConnectedElement _source = it.getSource();
                  Aadl2JavaValidatorTest.assertError(_source, allIssues, "A \'bus subcomponent\' is not a valid parameter connection end.");
                  ConnectedElement _destination = it.getDestination();
                  Aadl2JavaValidatorTest.assertNoIssues(_destination, allIssues);
                }
              };
              ...
              ParameterConnection _get_233 = _ownedParameterConnections_1.get(1);
              final Procedure1<ParameterConnection> _function_233 = new Procedure1<ParameterConnection>() {
                public void apply(final ParameterConnection it) {
                  String _name = it.getName();
                  Assert.assertEquals("paramconn2", _name);
                  ConnectedElement _source = it.getSource();
                  Aadl2JavaValidatorTest.assertNoIssues(_source, allIssues);
                  ConnectedElement _destination = it.getDestination();
                  Aadl2JavaValidatorTest.assertNoIssues(_destination, allIssues);
              ...
              ParameterConnection _get_234 = _ownedParameterConnections_2.get(2);
              final Procedure1<ParameterConnection> _function_234 = new Procedure1<ParameterConnection>() {
                public void apply(final ParameterConnection it) {
                  ...
                  ConnectedElement _source = it.getSource();
                  Aadl2JavaValidatorTest.assertError(_source, allIssues, "A \'subprogram group subcomponent\' is not a valid parameter connection end.");
                  ConnectedElement _destination = it.getDestination();
                  Aadl2JavaValidatorTest.assertNoIssues(_destination, allIssues);
                }
              };
              ...
              ParameterConnection _get_235 = _ownedParameterConnections_3.get(3);
              final Procedure1<ParameterConnection> _function_235 = new Procedure1<ParameterConnection>() {
                public void apply(final ParameterConnection it) {
                  ...
                  ConnectedElement _source = it.getSource();
                  Aadl2JavaValidatorTest.assertError(_source, allIssues, "A \'subprogram subcomponent\' is not a valid parameter connection end.");
                  ConnectedElement _destination = it.getDestination();
                  Aadl2JavaValidatorTest.assertNoIssues(_destination, allIssues);
                }
              };
              ...
              ParameterConnection _get_236 = _ownedParameterConnections_4.get(4);
              final Procedure1<ParameterConnection> _function_236 = new Procedure1<ParameterConnection>() {
                public void apply(final ParameterConnection it) {
                  ...
                  ConnectedElement _source = it.getSource();
                  Aadl2JavaValidatorTest.assertError(_source, allIssues, "A \'subprogram proxy\' is not a valid parameter connection end.");
                  ConnectedElement _destination = it.getDestination();
                  Aadl2JavaValidatorTest.assertNoIssues(_destination, allIssues);
                }
              };
              ...
              ParameterConnection _get_237 = _ownedParameterConnections_5.get(5);
              final Procedure1<ParameterConnection> _function_237 = new Procedure1<ParameterConnection>() {
                public void apply(final ParameterConnection it) {
                  ...
                  ConnectedElement _source = it.getSource();
                  Aadl2JavaValidatorTest.assertError(_source, allIssues, "A \'port proxy\' is not a valid parameter connection end.");
                  ConnectedElement _destination = it.getDestination();
                  Aadl2JavaValidatorTest.assertNoIssues(_destination, allIssues);
                }
              };
              ...
              ParameterConnection _get_238 = _ownedParameterConnections_6.get(6);
              final Procedure1<ParameterConnection> _function_238 = new Procedure1<ParameterConnection>() {
                public void apply(final ParameterConnection it) {
                  ...
                  ConnectedElement _source = it.getSource();
                  Aadl2JavaValidatorTest.assertError(_source, allIssues, "An \'event data source\' is not a valid parameter connection end.");
                  ConnectedElement _destination = it.getDestination();
                  Aadl2JavaValidatorTest.assertNoIssues(_destination, allIssues);
                }
              };
              ...
              ParameterConnection _get_239 = _ownedParameterConnections_7.get(7);
              final Procedure1<ParameterConnection> _function_239 = new Procedure1<ParameterConnection>() {
                public void apply(final ParameterConnection it) {
                  ...
                  ConnectedElement _source = it.getSource();
                  Aadl2JavaValidatorTest.assertError(_source, allIssues, "An \'abstract feature\' is not a valid parameter connection end.");
                  ConnectedElement _destination = it.getDestination();
                  Aadl2JavaValidatorTest.assertNoIssues(_destination, allIssues);
                }
              };
              ...
              ParameterConnection _get_240 = _ownedParameterConnections_8.get(8);
              final Procedure1<ParameterConnection> _function_240 = new Procedure1<ParameterConnection>() {
                public void apply(final ParameterConnection it) {
                  ...
                  ConnectedElement _source = it.getSource();
                  Aadl2JavaValidatorTest.assertError(_source, allIssues, "A \'feature group\' is not a valid parameter connection end.");
                  ConnectedElement _destination = it.getDestination();
                  Aadl2JavaValidatorTest.assertNoIssues(_destination, allIssues);
                }
              };
              ...
              ParameterConnection _get_241 = _ownedParameterConnections_9.get(9);
              final Procedure1<ParameterConnection> _function_241 = new Procedure1<ParameterConnection>() {
                public void apply(final ParameterConnection it) {
                  ...
                  ConnectedElement _source = it.getSource();
                  Aadl2JavaValidatorTest.assertError(_source, allIssues, "A \'bus access\' is not a valid parameter connection end.");
                  ConnectedElement _destination = it.getDestination();
                  Aadl2JavaValidatorTest.assertNoIssues(_destination, allIssues);
                }
              };
              ...
              ParameterConnection _get_242 = _ownedParameterConnections_10.get(10);
              final Procedure1<ParameterConnection> _function_242 = new Procedure1<ParameterConnection>() {
                public void apply(final ParameterConnection it) {
                  String _name = it.getName();
                  Assert.assertEquals("paramconn11", _name);
                  ConnectedElement _source = it.getSource();
                  Aadl2JavaValidatorTest.assertNoIssues(_source, allIssues);
                  ConnectedElement _destination = it.getDestination();
                  Aadl2JavaValidatorTest.assertNoIssues(_destination, allIssues);
              ...
              ParameterConnection _get_243 = _ownedParameterConnections_11.get(11);
              final Procedure1<ParameterConnection> _function_243 = new Procedure1<ParameterConnection>() {
                public void apply(final ParameterConnection it) {
                  ...
                  ConnectedElement _source = it.getSource();
                  Aadl2JavaValidatorTest.assertError(_source, allIssues, "An \'event port\' is not a valid parameter connection end.");
                  ConnectedElement _destination = it.getDestination();
                  Aadl2JavaValidatorTest.assertNoIssues(_destination, allIssues);
                }
              };
              ...
              ParameterConnection _get_244 = _ownedParameterConnections_12.get(12);
              final Procedure1<ParameterConnection> _function_244 = new Procedure1<ParameterConnection>() {
                public void apply(final ParameterConnection it) {
                  String _name = it.getName();
                  Assert.assertEquals("paramconn13", _name);
                  ConnectedElement _source = it.getSource();
                  Aadl2JavaValidatorTest.assertNoIssues(_source, allIssues);
                  ConnectedElement _destination = it.getDestination();
                  Aadl2JavaValidatorTest.assertNoIssues(_destination, allIssues);
              ...
              ParameterConnection _get_245 = _ownedParameterConnections_13.get(13);
              final Procedure1<ParameterConnection> _function_245 = new Procedure1<ParameterConnection>() {
                public void apply(final ParameterConnection it) {
                  String _name = it.getName();
                  Assert.assertEquals("paramconn14", _name);
                  ConnectedElement _source = it.getSource();
                  Aadl2JavaValidatorTest.assertNoIssues(_source, allIssues);
                  ConnectedElement _destination = it.getDestination();
                  Aadl2JavaValidatorTest.assertNoIssues(_destination, allIssues);
              ...
              ParameterConnection _get_246 = _ownedParameterConnections_14.get(14);
              final Procedure1<ParameterConnection> _function_246 = new Procedure1<ParameterConnection>() {
                public void apply(final ParameterConnection it) {
                  ...
                  ConnectedElement _source = it.getSource();
                  Aadl2JavaValidatorTest.assertError(_source, allIssues, "A \'bus subcomponent\' in a \'data port\' is not a valid parameter connection end.");
                  ConnectedElement _destination = it.getDestination();
                  Aadl2JavaValidatorTest.assertNoIssues(_destination, allIssues);
                }
              };
              ...
              ParameterConnection _get_247 = _ownedParameterConnections_15.get(15);
              final Procedure1<ParameterConnection> _function_247 = new Procedure1<ParameterConnection>() {
                public void apply(final ParameterConnection it) {
                  String _name = it.getName();
                  Assert.assertEquals("paramconn16", _name);
                  ConnectedElement _source = it.getSource();
                  Aadl2JavaValidatorTest.assertNoIssues(_source, allIssues);
                  ConnectedElement _destination = it.getDestination();
                  Aadl2JavaValidatorTest.assertNoIssues(_destination, allIssues);
              ...
              ParameterConnection _get_248 = _ownedParameterConnections_16.get(16);
              final Procedure1<ParameterConnection> _function_248 = new Procedure1<ParameterConnection>() {
                public void apply(final ParameterConnection it) {
                  ...
                  ConnectedElement _source = it.getSource();
                  Aadl2JavaValidatorTest.assertError(_source, allIssues, "A \'subprogram group subcomponent\' in a \'data port\' is not a valid parameter connection end.");
                  ConnectedElement _destination = it.getDestination();
                  Aadl2JavaValidatorTest.assertNoIssues(_destination, allIssues);
                }
              };
              ...
              ParameterConnection _get_249 = _ownedParameterConnections_17.get(17);
              final Procedure1<ParameterConnection> _function_249 = new Procedure1<ParameterConnection>() {
                public void apply(final ParameterConnection it) {
                  ...
                  ConnectedElement _source = it.getSource();
                  Aadl2JavaValidatorTest.assertError(_source, allIssues, "A \'subprogram subcomponent\' in a \'data port\' is not a valid parameter connection end.");
                  ConnectedElement _destination = it.getDestination();
                  Aadl2JavaValidatorTest.assertNoIssues(_destination, allIssues);
                }
              };
              ...
              ParameterConnection _get_250 = _ownedParameterConnections_18.get(18);
              final Procedure1<ParameterConnection> _function_250 = new Procedure1<ParameterConnection>() {
                public void apply(final ParameterConnection it) {
                  String _name = it.getName();
                  Assert.assertEquals("paramconn19", _name);
                  ConnectedElement _source = it.getSource();
                  Aadl2JavaValidatorTest.assertError(_source, allIssues, "A \'subprogram proxy\' in a \'data port\' is not a valid parameter connection end.");
                  ConnectedElement _destination = it.getDestination();
                  Aadl2JavaValidatorTest.assertNoIssues(_destination, allIssues);
                }
              };
              ObjectExtensions.<ParameterConnection>operator_doubleArrow(_get_250, _function_250);
              EList<ParameterConnection> _ownedParameterConnections_19 = it.getOwnedParameterConnections();
              ParameterConnection _get_251 = _ownedParameterConnections_19.get(19);
              final Procedure1<ParameterConnection> _function_251 = new Procedure1<ParameterConnection>() {
                public void apply(final ParameterConnection it) {
                  String _name = it.getName();
                  Assert.assertEquals("paramconn20", _name);
                  ConnectedElement _source = it.getSource();
                  Aadl2JavaValidatorTest.assertError(_source, allIssues, "A \'port proxy\' in a \'data port\' is not a valid parameter connection end.");
                  ConnectedElement _destination = it.getDestination();
                  Aadl2JavaValidatorTest.assertNoIssues(_destination, allIssues);
                }
              };
              ObjectExtensions.<ParameterConnection>operator_doubleArrow(_get_251, _function_251);
              EList<ParameterConnection> _ownedParameterConnections_20 = it.getOwnedParameterConnections();
              ParameterConnection _get_252 = _ownedParameterConnections_20.get(20);
              final Procedure1<ParameterConnection> _function_252 = new Procedure1<ParameterConnection>() {
                public void apply(final ParameterConnection it) {
                  String _name = it.getName();
                  Assert.assertEquals("paramconn21", _name);
                  ConnectedElement _source = it.getSource();
                  Aadl2JavaValidatorTest.assertError(_source, allIssues, "An \'event data source\' in a \'data port\' is not a valid parameter connection end.");
                  ConnectedElement _destination = it.getDestination();
                  Aadl2JavaValidatorTest.assertNoIssues(_destination, allIssues);
                }
              };
              ObjectExtensions.<ParameterConnection>operator_doubleArrow(_get_252, _function_252);
              EList<ParameterConnection> _ownedParameterConnections_21 = it.getOwnedParameterConnections();
              ParameterConnection _get_253 = _ownedParameterConnections_21.get(21);
              final Procedure1<ParameterConnection> _function_253 = new Procedure1<ParameterConnection>() {
                public void apply(final ParameterConnection it) {
                  String _name = it.getName();
                  Assert.assertEquals("paramconn22", _name);
                  ConnectedElement _source = it.getSource();
                  Aadl2JavaValidatorTest.assertError(_source, allIssues, "An \'abstract feature\' in a \'data port\' is not a valid parameter connection end.");
                  ConnectedElement _destination = it.getDestination();
                  Aadl2JavaValidatorTest.assertNoIssues(_destination, allIssues);
                }
              };
              ObjectExtensions.<ParameterConnection>operator_doubleArrow(_get_253, _function_253);
              EList<ParameterConnection> _ownedParameterConnections_22 = it.getOwnedParameterConnections();
              ParameterConnection _get_254 = _ownedParameterConnections_22.get(22);
              final Procedure1<ParameterConnection> _function_254 = new Procedure1<ParameterConnection>() {
                public void apply(final ParameterConnection it) {
                  String _name = it.getName();
                  Assert.assertEquals("paramconn23", _name);
                  ConnectedElement _source = it.getSource();
                  Aadl2JavaValidatorTest.assertError(_source, allIssues, "A \'feature group\' in a \'data port\' is not a valid parameter connection end.");
                  ConnectedElement _destination = it.getDestination();
                  Aadl2JavaValidatorTest.assertNoIssues(_destination, allIssues);
                }
              };
              ObjectExtensions.<ParameterConnection>operator_doubleArrow(_get_254, _function_254);
              EList<ParameterConnection> _ownedParameterConnections_23 = it.getOwnedParameterConnections();
              ParameterConnection _get_255 = _ownedParameterConnections_23.get(23);
              final Procedure1<ParameterConnection> _function_255 = new Procedure1<ParameterConnection>() {
                public void apply(final ParameterConnection it) {
                  String _name = it.getName();
                  Assert.assertEquals("paramconn24", _name);
                  ConnectedElement _source = it.getSource();
                  Aadl2JavaValidatorTest.assertError(_source, allIssues, "A \'bus access\' in a \'data port\' is not a valid parameter connection end.");
                  ConnectedElement _destination = it.getDestination();
                  Aadl2JavaValidatorTest.assertNoIssues(_destination, allIssues);
                }
              };
              ObjectExtensions.<ParameterConnection>operator_doubleArrow(_get_255, _function_255);
              EList<ParameterConnection> _ownedParameterConnections_24 = it.getOwnedParameterConnections();
              ParameterConnection _get_256 = _ownedParameterConnections_24.get(24);
              final Procedure1<ParameterConnection> _function_256 = new Procedure1<ParameterConnection>() {
                public void apply(final ParameterConnection it) {
                  String _name = it.getName();
                  Assert.assertEquals("paramconn25", _name);
                  ConnectedElement _source = it.getSource();
                  Aadl2JavaValidatorTest.assertError(_source, allIssues, "A \'data access\' in a \'data port\' is not a valid parameter connection end.");
                  ConnectedElement _destination = it.getDestination();
                  Aadl2JavaValidatorTest.assertNoIssues(_destination, allIssues);
                }
              };
              ObjectExtensions.<ParameterConnection>operator_doubleArrow(_get_256, _function_256);
              EList<ParameterConnection> _ownedParameterConnections_25 = it.getOwnedParameterConnections();
              ParameterConnection _get_257 = _ownedParameterConnections_25.get(25);
              final Procedure1<ParameterConnection> _function_257 = new Procedure1<ParameterConnection>() {
                public void apply(final ParameterConnection it) {
                  String _name = it.getName();
                  Assert.assertEquals("paramconn26", _name);
                  ConnectedElement _source = it.getSource();
                  Aadl2JavaValidatorTest.assertError(_source, allIssues, "An \'event port\' in a \'data port\' is not a valid parameter connection end.");
                  ConnectedElement _destination = it.getDestination();
                  Aadl2JavaValidatorTest.assertNoIssues(_destination, allIssues);
                }
              };
              ObjectExtensions.<ParameterConnection>operator_doubleArrow(_get_257, _function_257);
              EList<ParameterConnection> _ownedParameterConnections_26 = it.getOwnedParameterConnections();
              ParameterConnection _get_258 = _ownedParameterConnections_26.get(26);
              final Procedure1<ParameterConnection> _function_258 = new Procedure1<ParameterConnection>() {
                public void apply(final ParameterConnection it) {
                  String _name = it.getName();
                  Assert.assertEquals("paramconn27", _name);
                  ConnectedElement _source = it.getSource();
                  Aadl2JavaValidatorTest.assertError(_source, allIssues, "A \'data port\' in a \'data port\' is not a valid parameter connection end.");
                  ConnectedElement _destination = it.getDestination();
                  Aadl2JavaValidatorTest.assertNoIssues(_destination, allIssues);
                }
              };
              ObjectExtensions.<ParameterConnection>operator_doubleArrow(_get_258, _function_258);
              EList<ParameterConnection> _ownedParameterConnections_27 = it.getOwnedParameterConnections();
              ParameterConnection _get_259 = _ownedParameterConnections_27.get(27);
              final Procedure1<ParameterConnection> _function_259 = new Procedure1<ParameterConnection>() {
                public void apply(final ParameterConnection it) {
                  String _name = it.getName();
                  Assert.assertEquals("paramconn28", _name);
                  ConnectedElement _source = it.getSource();
                  Aadl2JavaValidatorTest.assertError(_source, allIssues, "An \'event data port\' in a \'data port\' is not a valid parameter connection end.");
                  ConnectedElement _destination = it.getDestination();
                  Aadl2JavaValidatorTest.assertNoIssues(_destination, allIssues);
                }
              };
              ObjectExtensions.<ParameterConnection>operator_doubleArrow(_get_259, _function_259);
              EList<ParameterConnection> _ownedParameterConnections_28 = it.getOwnedParameterConnections();
              ParameterConnection _get_260 = _ownedParameterConnections_28.get(28);
              final Procedure1<ParameterConnection> _function_260 = new Procedure1<ParameterConnection>() {
                public void apply(final ParameterConnection it) {
                  String _name = it.getName();
                  Assert.assertEquals("paramconn29", _name);
                  ConnectedElement _source = it.getSource();
                  Aadl2JavaValidatorTest.assertError(_source, allIssues, "A \'bus subcomponent\' in an \'event data port\' is not a valid parameter connection end.");
                  ConnectedElement _destination = it.getDestination();
                  Aadl2JavaValidatorTest.assertNoIssues(_destination, allIssues);
                }
              };
              ObjectExtensions.<ParameterConnection>operator_doubleArrow(_get_260, _function_260);
              EList<ParameterConnection> _ownedParameterConnections_29 = it.getOwnedParameterConnections();
              ParameterConnection _get_261 = _ownedParameterConnections_29.get(29);
              final Procedure1<ParameterConnection> _function_261 = new Procedure1<ParameterConnection>() {
                public void apply(final ParameterConnection it) {
                  String _name = it.getName();
                  Assert.assertEquals("paramconn30", _name);
                  ConnectedElement _source = it.getSource();
                  Aadl2JavaValidatorTest.assertNoIssues(_source, allIssues);
                  ConnectedElement _destination = it.getDestination();
                  Aadl2JavaValidatorTest.assertNoIssues(_destination, allIssues);
              ...
              ObjectExtensions.<ParameterConnection>operator_doubleArrow(_get_261, _function_261);
              EList<ParameterConnection> _ownedParameterConnections_30 = it.getOwnedParameterConnections();
              ParameterConnection _get_262 = _ownedParameterConnections_30.get(30);
              final Procedure1<ParameterConnection> _function_262 = new Procedure1<ParameterConnection>() {
                public void apply(final ParameterConnection it) {
                  String _name = it.getName();
                  Assert.assertEquals("paramconn31", _name);
                  ConnectedElement _source = it.getSource();
                  Aadl2JavaValidatorTest.assertError(_source, allIssues, "A \'subprogram group subcomponent\' in an \'event data port\' is not a valid parameter connection end.");
                  ConnectedElement _destination = it.getDestination();
                  Aadl2JavaValidatorTest.assertNoIssues(_destination, allIssues);
                }
              };
              ObjectExtensions.<ParameterConnection>operator_doubleArrow(_get_262, _function_262);
              EList<ParameterConnection> _ownedParameterConnections_31 = it.getOwnedParameterConnections();
              ParameterConnection _get_263 = _ownedParameterConnections_31.get(31);
              final Procedure1<ParameterConnection> _function_263 = new Procedure1<ParameterConnection>() {
                public void apply(final ParameterConnection it) {
                  String _name = it.getName();
                  Assert.assertEquals("paramconn32", _name);
                  ConnectedElement _source = it.getSource();
                  Aadl2JavaValidatorTest.assertError(_source, allIssues, "A \'subprogram subcomponent\' in an \'event data port\' is not a valid parameter connection end.");
                  ConnectedElement _destination = it.getDestination();
                  Aadl2JavaValidatorTest.assertNoIssues(_destination, allIssues);
                }
              };
              ObjectExtensions.<ParameterConnection>operator_doubleArrow(_get_263, _function_263);
              EList<ParameterConnection> _ownedParameterConnections_32 = it.getOwnedParameterConnections();
              ParameterConnection _get_264 = _ownedParameterConnections_32.get(32);
              final Procedure1<ParameterConnection> _function_264 = new Procedure1<ParameterConnection>() {
                public void apply(final ParameterConnection it) {
                  String _name = it.getName();
                  Assert.assertEquals("paramconn33", _name);
                  ConnectedElement _source = it.getSource();
                  Aadl2JavaValidatorTest.assertError(_source, allIssues, "A \'subprogram proxy\' in an \'event data port\' is not a valid parameter connection end.");
                  ConnectedElement _destination = it.getDestination();
                  Aadl2JavaValidatorTest.assertNoIssues(_destination, allIssues);
                }
              };
              ObjectExtensions.<ParameterConnection>operator_doubleArrow(_get_264, _function_264);
              EList<ParameterConnection> _ownedParameterConnections_33 = it.getOwnedParameterConnections();
              ParameterConnection _get_265 = _ownedParameterConnections_33.get(33);
              final Procedure1<ParameterConnection> _function_265 = new Procedure1<ParameterConnection>() {
                public void apply(final ParameterConnection it) {
                  String _name = it.getName();
                  Assert.assertEquals("paramconn34", _name);
                  ConnectedElement _source = it.getSource();
                  Aadl2JavaValidatorTest.assertError(_source, allIssues, "A \'port proxy\' in an \'event data port\' is not a valid parameter connection end.");
                  ConnectedElement _destination = it.getDestination();
                  Aadl2JavaValidatorTest.assertNoIssues(_destination, allIssues);
                }
              };
              ObjectExtensions.<ParameterConnection>operator_doubleArrow(_get_265, _function_265);
              EList<ParameterConnection> _ownedParameterConnections_34 = it.getOwnedParameterConnections();
              ParameterConnection _get_266 = _ownedParameterConnections_34.get(34);
              final Procedure1<ParameterConnection> _function_266 = new Procedure1<ParameterConnection>() {
                public void apply(final ParameterConnection it) {
                  String _name = it.getName();
                  Assert.assertEquals("paramconn35", _name);
                  ConnectedElement _source = it.getSource();
                  Aadl2JavaValidatorTest.assertError(_source, allIssues, "An \'event data source\' in an \'event data port\' is not a valid parameter connection end.");
                  ConnectedElement _destination = it.getDestination();
                  Aadl2JavaValidatorTest.assertNoIssues(_destination, allIssues);
                }
              };
              ObjectExtensions.<ParameterConnection>operator_doubleArrow(_get_266, _function_266);
              EList<ParameterConnection> _ownedParameterConnections_35 = it.getOwnedParameterConnections();
              ParameterConnection _get_267 = _ownedParameterConnections_35.get(35);
              final Procedure1<ParameterConnection> _function_267 = new Procedure1<ParameterConnection>() {
                public void apply(final ParameterConnection it) {
                  String _name = it.getName();
                  Assert.assertEquals("paramconn36", _name);
                  ConnectedElement _source = it.getSource();
                  Aadl2JavaValidatorTest.assertError(_source, allIssues, "An \'abstract feature\' in an \'event data port\' is not a valid parameter connection end.");
                  ConnectedElement _destination = it.getDestination();
                  Aadl2JavaValidatorTest.assertNoIssues(_destination, allIssues);
                }
              };
              ObjectExtensions.<ParameterConnection>operator_doubleArrow(_get_267, _function_267);
              EList<ParameterConnection> _ownedParameterConnections_36 = it.getOwnedParameterConnections();
              ParameterConnection _get_268 = _ownedParameterConnections_36.get(36);
              final Procedure1<ParameterConnection> _function_268 = new Procedure1<ParameterConnection>() {
                public void apply(final ParameterConnection it) {
                  String _name = it.getName();
                  Assert.assertEquals("paramconn37", _name);
                  ConnectedElement _source = it.getSource();
                  Aadl2JavaValidatorTest.assertError(_source, allIssues, "A \'feature group\' in an \'event data port\' is not a valid parameter connection end.");
                  ConnectedElement _destination = it.getDestination();
                  Aadl2JavaValidatorTest.assertNoIssues(_destination, allIssues);
                }
              };
              ObjectExtensions.<ParameterConnection>operator_doubleArrow(_get_268, _function_268);
              EList<ParameterConnection> _ownedParameterConnections_37 = it.getOwnedParameterConnections();
              ParameterConnection _get_269 = _ownedParameterConnections_37.get(37);
              final Procedure1<ParameterConnection> _function_269 = new Procedure1<ParameterConnection>() {
                public void apply(final ParameterConnection it) {
                  String _name = it.getName();
                  Assert.assertEquals("paramconn38", _name);
                  ConnectedElement _source = it.getSource();
                  Aadl2JavaValidatorTest.assertError(_source, allIssues, "A \'bus access\' in an \'event data port\' is not a valid parameter connection end.");
                  ConnectedElement _destination = it.getDestination();
                  Aadl2JavaValidatorTest.assertNoIssues(_destination, allIssues);
                }
              };
              ObjectExtensions.<ParameterConnection>operator_doubleArrow(_get_269, _function_269);
              EList<ParameterConnection> _ownedParameterConnections_38 = it.getOwnedParameterConnections();
              ParameterConnection _get_270 = _ownedParameterConnections_38.get(38);
              final Procedure1<ParameterConnection> _function_270 = new Procedure1<ParameterConnection>() {
                public void apply(final ParameterConnection it) {
                  String _name = it.getName();
                  Assert.assertEquals("paramconn39", _name);
                  ConnectedElement _source = it.getSource();
                  Aadl2JavaValidatorTest.assertError(_source, allIssues, "A \'data access\' in an \'event data port\' is not a valid parameter connection end.");
                  ConnectedElement _destination = it.getDestination();
                  Aadl2JavaValidatorTest.assertNoIssues(_destination, allIssues);
                }
              };
              ObjectExtensions.<ParameterConnection>operator_doubleArrow(_get_270, _function_270);
              EList<ParameterConnection> _ownedParameterConnections_39 = it.getOwnedParameterConnections();
              ParameterConnection _get_271 = _ownedParameterConnections_39.get(39);
              final Procedure1<ParameterConnection> _function_271 = new Procedure1<ParameterConnection>() {
                public void apply(final ParameterConnection it) {
                  String _name = it.getName();
                  Assert.assertEquals("paramconn40", _name);
                  ConnectedElement _source = it.getSource();
                  Aadl2JavaValidatorTest.assertError(_source, allIssues, "An \'event port\' in an \'event data port\' is not a valid parameter connection end.");
                  ConnectedElement _destination = it.getDestination();
                  Aadl2JavaValidatorTest.assertNoIssues(_destination, allIssues);
                }
              };
              ObjectExtensions.<ParameterConnection>operator_doubleArrow(_get_271, _function_271);
              EList<ParameterConnection> _ownedParameterConnections_40 = it.getOwnedParameterConnections();
              ParameterConnection _get_272 = _ownedParameterConnections_40.get(40);
              final Procedure1<ParameterConnection> _function_272 = new Procedure1<ParameterConnection>() {
                public void apply(final ParameterConnection it) {
                  String _name = it.getName();
                  Assert.assertEquals("paramconn41", _name);
                  ConnectedElement _source = it.getSource();
                  Aadl2JavaValidatorTest.assertError(_source, allIssues, "A \'data port\' in an \'event data port\' is not a valid parameter connection end.");
                  ConnectedElement _destination = it.getDestination();
                  Aadl2JavaValidatorTest.assertNoIssues(_destination, allIssues);
                }
              };
              ObjectExtensions.<ParameterConnection>operator_doubleArrow(_get_272, _function_272);
              EList<ParameterConnection> _ownedParameterConnections_41 = it.getOwnedParameterConnections();
              ParameterConnection _get_273 = _ownedParameterConnections_41.get(41);
              final Procedure1<ParameterConnection> _function_273 = new Procedure1<ParameterConnection>() {
                public void apply(final ParameterConnection it) {
                  String _name = it.getName();
                  Assert.assertEquals("paramconn42", _name);
                  ConnectedElement _source = it.getSource();
                  Aadl2JavaValidatorTest.assertError(_source, allIssues, "An \'event data port\' in an \'event data port\' is not a valid parameter connection end.");
                  ConnectedElement _destination = it.getDestination();
                  Aadl2JavaValidatorTest.assertNoIssues(_destination, allIssues);
                }
              };
              ObjectExtensions.<ParameterConnection>operator_doubleArrow(_get_273, _function_273);
              EList<ParameterConnection> _ownedParameterConnections_42 = it.getOwnedParameterConnections();
              ParameterConnection _get_274 = _ownedParameterConnections_42.get(42);
              final Procedure1<ParameterConnection> _function_274 = new Procedure1<ParameterConnection>() {
                public void apply(final ParameterConnection it) {
                  String _name = it.getName();
                  Assert.assertEquals("paramconn43", _name);
                  ConnectedElement _source = it.getSource();
                  Aadl2JavaValidatorTest.assertError(_source, allIssues, "An \'abstract feature\' in a \'feature group\' is not a valid parameter connection end.");
                  ConnectedElement _destination = it.getDestination();
                  Aadl2JavaValidatorTest.assertNoIssues(_destination, allIssues);
                }
              };
              ObjectExtensions.<ParameterConnection>operator_doubleArrow(_get_274, _function_274);
              EList<ParameterConnection> _ownedParameterConnections_43 = it.getOwnedParameterConnections();
              ParameterConnection _get_275 = _ownedParameterConnections_43.get(43);
              final Procedure1<ParameterConnection> _function_275 = new Procedure1<ParameterConnection>() {
                public void apply(final ParameterConnection it) {
                  String _name = it.getName();
                  Assert.assertEquals("paramconn44", _name);
                  ConnectedElement _source = it.getSource();
                  Aadl2JavaValidatorTest.assertError(_source, allIssues, "A \'feature group\' in a \'feature group\' is not a valid parameter connection end.");
                  ConnectedElement _destination = it.getDestination();
                  Aadl2JavaValidatorTest.assertNoIssues(_destination, allIssues);
                }
              };
              ObjectExtensions.<ParameterConnection>operator_doubleArrow(_get_275, _function_275);
              EList<ParameterConnection> _ownedParameterConnections_44 = it.getOwnedParameterConnections();
              ParameterConnection _get_276 = _ownedParameterConnections_44.get(44);
              final Procedure1<ParameterConnection> _function_276 = new Procedure1<ParameterConnection>() {
                public void apply(final ParameterConnection it) {
                  String _name = it.getName();
                  Assert.assertEquals("paramconn45", _name);
                  ConnectedElement _source = it.getSource();
                  Aadl2JavaValidatorTest.assertNoIssues(_source, allIssues);
                  ConnectedElement _destination = it.getDestination();
                  Aadl2JavaValidatorTest.assertNoIssues(_destination, allIssues);
              ...
              ObjectExtensions.<ParameterConnection>operator_doubleArrow(_get_276, _function_276);
              EList<ParameterConnection> _ownedParameterConnections_45 = it.getOwnedParameterConnections();
              ParameterConnection _get_277 = _ownedParameterConnections_45.get(45);
              final Procedure1<ParameterConnection> _function_277 = new Procedure1<ParameterConnection>() {
                public void apply(final ParameterConnection it) {
                  String _name = it.getName();
                  Assert.assertEquals("paramconn46", _name);
                  ConnectedElement _source = it.getSource();
                  Aadl2JavaValidatorTest.assertError(_source, allIssues, "A \'bus access\' in a \'feature group\' is not a valid parameter connection end.");
                  ConnectedElement _destination = it.getDestination();
                  Aadl2JavaValidatorTest.assertNoIssues(_destination, allIssues);
                }
              };
              ObjectExtensions.<ParameterConnection>operator_doubleArrow(_get_277, _function_277);
              EList<ParameterConnection> _ownedParameterConnections_46 = it.getOwnedParameterConnections();
              ParameterConnection _get_278 = _ownedParameterConnections_46.get(46);
              final Procedure1<ParameterConnection> _function_278 = new Procedure1<ParameterConnection>() {
                public void apply(final ParameterConnection it) {
                  String _name = it.getName();
                  Assert.assertEquals("paramconn47", _name);
                  ConnectedElement _source = it.getSource();
                  Aadl2JavaValidatorTest.assertNoIssues(_source, allIssues);
                  ConnectedElement _destination = it.getDestination();
                  Aadl2JavaValidatorTest.assertNoIssues(_destination, allIssues);
              ...
              ObjectExtensions.<ParameterConnection>operator_doubleArrow(_get_278, _function_278);
              EList<ParameterConnection> _ownedParameterConnections_47 = it.getOwnedParameterConnections();
              ParameterConnection _get_279 = _ownedParameterConnections_47.get(47);
              final Procedure1<ParameterConnection> _function_279 = new Procedure1<ParameterConnection>() {
                public void apply(final ParameterConnection it) {
                  String _name = it.getName();
                  Assert.assertEquals("paramconn48", _name);
                  ConnectedElement _source = it.getSource();
                  Aadl2JavaValidatorTest.assertError(_source, allIssues, "An \'event port\' in a \'feature group\' is not a valid parameter connection end.");
                  ConnectedElement _destination = it.getDestination();
                  Aadl2JavaValidatorTest.assertNoIssues(_destination, allIssues);
                }
              };
              ObjectExtensions.<ParameterConnection>operator_doubleArrow(_get_279, _function_279);
              EList<ParameterConnection> _ownedParameterConnections_48 = it.getOwnedParameterConnections();
              ParameterConnection _get_280 = _ownedParameterConnections_48.get(48);
              final Procedure1<ParameterConnection> _function_280 = new Procedure1<ParameterConnection>() {
                public void apply(final ParameterConnection it) {
                  String _name = it.getName();
                  Assert.assertEquals("paramconn49", _name);
                  ConnectedElement _source = it.getSource();
                  Aadl2JavaValidatorTest.assertNoIssues(_source, allIssues);
                  ConnectedElement _destination = it.getDestination();
                  Aadl2JavaValidatorTest.assertNoIssues(_destination, allIssues);
              ...
              ObjectExtensions.<ParameterConnection>operator_doubleArrow(_get_280, _function_280);
              EList<ParameterConnection> _ownedParameterConnections_49 = it.getOwnedParameterConnections();
              ParameterConnection _get_281 = _ownedParameterConnections_49.get(49);
              final Procedure1<ParameterConnection> _function_281 = new Procedure1<ParameterConnection>() {
                public void apply(final ParameterConnection it) {
                  String _name = it.getName();
                  Assert.assertEquals("paramconn50", _name);
                  ConnectedElement _source = it.getSource();
                  Aadl2JavaValidatorTest.assertNoIssues(_source, allIssues);
                  ConnectedElement _destination = it.getDestination();
                  Aadl2JavaValidatorTest.assertNoIssues(_destination, allIssues);
              ...
              ObjectExtensions.<ParameterConnection>operator_doubleArrow(_get_281, _function_281);
              EList<ParameterConnection> _ownedParameterConnections_50 = it.getOwnedParameterConnections();
              ParameterConnection _get_282 = _ownedParameterConnections_50.get(50);
              final Procedure1<ParameterConnection> _function_282 = new Procedure1<ParameterConnection>() {
                public void apply(final ParameterConnection it) {
                  String _name = it.getName();
                  Assert.assertEquals("paramconn51", _name);
                  ConnectedElement _source = it.getSource();
                  Aadl2JavaValidatorTest.assertError(_source, allIssues, "Anything in an \'abstract subcomponent\' is not a valid parameter connection end.");
                  ConnectedElement _destination = it.getDestination();
                  Aadl2JavaValidatorTest.assertNoIssues(_destination, allIssues);
                }
              };
              ObjectExtensions.<ParameterConnection>operator_doubleArrow(_get_282, _function_282);
              EList<ParameterConnection> _ownedParameterConnections_51 = it.getOwnedParameterConnections();
              ParameterConnection _get_283 = _ownedParameterConnections_51.get(51);
              final Procedure1<ParameterConnection> _function_283 = new Procedure1<ParameterConnection>() {
                public void apply(final ParameterConnection it) {
                  String _name = it.getName();
              ...
              ObjectExtensions.<ParameterConnection>operator_doubleArrow(_get_283, _function_283);
              EList<ParameterConnection> _ownedParameterConnections_52 = it.getOwnedParameterConnections();
              ParameterConnection _get_284 = _ownedParameterConnections_52.get(52);
              final Procedure1<ParameterConnection> _function_284 = new Procedure1<ParameterConnection>() {
                public void apply(final ParameterConnection it) {
                  String _name = it.getName();
              ...
              ObjectExtensions.<ParameterConnection>operator_doubleArrow(_get_284, _function_284);
              EList<ParameterConnection> _ownedParameterConnections_53 = it.getOwnedParameterConnections();
              ParameterConnection _get_285 = _ownedParameterConnections_53.get(53);
              final Procedure1<ParameterConnection> _function_285 = new Procedure1<ParameterConnection>() {
                public void apply(final ParameterConnection it) {
                  String _name = it.getName();
              ...
              ObjectExtensions.<ParameterConnection>operator_doubleArrow(_get_285, _function_285);
              EList<ParameterConnection> _ownedParameterConnections_54 = it.getOwnedParameterConnections();
              ParameterConnection _get_286 = _ownedParameterConnections_54.get(54);
              final Procedure1<ParameterConnection> _function_286 = new Procedure1<ParameterConnection>() {
                public void apply(final ParameterConnection it) {
                  String _name = it.getName();
              ...
              ObjectExtensions.<ParameterConnection>operator_doubleArrow(_get_286, _function_286);
              EList<ParameterConnection> _ownedParameterConnections_55 = it.getOwnedParameterConnections();
              ParameterConnection _get_287 = _ownedParameterConnections_55.get(55);
              final Procedure1<ParameterConnection> _function_287 = new Procedure1<ParameterConnection>() {
                public void apply(final ParameterConnection it) {
                  String _name = it.getName();
              ...
              ObjectExtensions.<ParameterConnection>operator_doubleArrow(_get_287, _function_287);
              EList<ParameterConnection> _ownedParameterConnections_56 = it.getOwnedParameterConnections();
              ParameterConnection _get_288 = _ownedParameterConnections_56.get(56);
              final Procedure1<ParameterConnection> _function_288 = new Procedure1<ParameterConnection>() {
                public void apply(final ParameterConnection it) {
                  String _name = it.getName();
              ...
              ObjectExtensions.<ParameterConnection>operator_doubleArrow(_get_288, _function_288);
              EList<ParameterConnection> _ownedParameterConnections_57 = it.getOwnedParameterConnections();
              ParameterConnection _get_289 = _ownedParameterConnections_57.get(57);
              final Procedure1<ParameterConnection> _function_289 = new Procedure1<ParameterConnection>() {
                public void apply(final ParameterConnection it) {
                  String _name = it.getName();
              ...
              ObjectExtensions.<ParameterConnection>operator_doubleArrow(_get_289, _function_289);
              EList<ParameterConnection> _ownedParameterConnections_58 = it.getOwnedParameterConnections();
              ParameterConnection _get_290 = _ownedParameterConnections_58.get(58);
              final Procedure1<ParameterConnection> _function_290 = new Procedure1<ParameterConnection>() {
                public void apply(final ParameterConnection it) {
                  String _name = it.getName();
              ...
              ObjectExtensions.<ParameterConnection>operator_doubleArrow(_get_290, _function_290);
              EList<ParameterConnection> _ownedParameterConnections_59 = it.getOwnedParameterConnections();
              ParameterConnection _get_291 = _ownedParameterConnections_59.get(59);
              final Procedure1<ParameterConnection> _function_291 = new Procedure1<ParameterConnection>() {
                public void apply(final ParameterConnection it) {
                  String _name = it.getName();
                  Assert.assertEquals("paramconn60", _name);
                  ConnectedElement _source = it.getSource();
                  Aadl2JavaValidatorTest.assertError(_source, allIssues, "Anything in a \'subprogram subcomponent\' is not a valid parameter connection end.");
                  ConnectedElement _destination = it.getDestination();
                  Aadl2JavaValidatorTest.assertNoIssues(_destination, allIssues);
                }
              };
              ObjectExtensions.<ParameterConnection>operator_doubleArrow(_get_291, _function_291);
              EList<ParameterConnection> _ownedParameterConnections_60 = it.getOwnedParameterConnections();
              ParameterConnection _get_292 = _ownedParameterConnections_60.get(60);
              final Procedure1<ParameterConnection> _function_292 = new Procedure1<ParameterConnection>() {
                public void apply(final ParameterConnection it) {
                  String _name = it.getName();
              ...
              ObjectExtensions.<ParameterConnection>operator_doubleArrow(_get_292, _function_292);
              EList<ParameterConnection> _ownedParameterConnections_61 = it.getOwnedParameterConnections();
              ParameterConnection _get_293 = _ownedParameterConnections_61.get(61);
              final Procedure1<ParameterConnection> _function_293 = new Procedure1<ParameterConnection>() {
                public void apply(final ParameterConnection it) {
                  String _name = it.getName();
              ...
              ObjectExtensions.<ParameterConnection>operator_doubleArrow(_get_293, _function_293);
              EList<ParameterConnection> _ownedParameterConnections_62 = it.getOwnedParameterConnections();
              ParameterConnection _get_294 = _ownedParameterConnections_62.get(62);
              final Procedure1<ParameterConnection> _function_294 = new Procedure1<ParameterConnection>() {
                public void apply(final ParameterConnection it) {
                  String _name = it.getName();
              ...
              ObjectExtensions.<ParameterConnection>operator_doubleArrow(_get_294, _function_294);
              EList<ParameterConnection> _ownedParameterConnections_63 = it.getOwnedParameterConnections();
              ParameterConnection _get_295 = _ownedParameterConnections_63.get(63);
              final Procedure1<ParameterConnection> _function_295 = new Procedure1<ParameterConnection>() {
                public void apply(final ParameterConnection it) {
                  String _name = it.getName();
              ...
              ObjectExtensions.<ParameterConnection>operator_doubleArrow(_get_295, _function_295);
              EList<ParameterConnection> _ownedParameterConnections_64 = it.getOwnedParameterConnections();
              ParameterConnection _get_296 = _ownedParameterConnections_64.get(64);
              final Procedure1<ParameterConnection> _function_296 = new Procedure1<ParameterConnection>() {
                public void apply(final ParameterConnection it) {
                  String _name = it.getName();
              ...
              ObjectExtensions.<ParameterConnection>operator_doubleArrow(_get_296, _function_296);
              EList<ParameterConnection> _ownedParameterConnections_65 = it.getOwnedParameterConnections();
              ParameterConnection _get_297 = _ownedParameterConnections_65.get(65);
              final Procedure1<ParameterConnection> _function_297 = new Procedure1<ParameterConnection>() {
                public void apply(final ParameterConnection it) {
                  String _name = it.getName();
                  Assert.assertEquals("paramconn66", _name);
                  ConnectedElement _source = it.getSource();
                  Aadl2JavaValidatorTest.assertError(_source, allIssues, "A \'data subcomponent\' in a \'subprogram call\' is not a valid parameter connection end.");
                  ConnectedElement _destination = it.getDestination();
                  Aadl2JavaValidatorTest.assertNoIssues(_destination, allIssues);
                }
              };
              ObjectExtensions.<ParameterConnection>operator_doubleArrow(_get_297, _function_297);
              EList<ParameterConnection> _ownedParameterConnections_66 = it.getOwnedParameterConnections();
              ParameterConnection _get_298 = _ownedParameterConnections_66.get(66);
              final Procedure1<ParameterConnection> _function_298 = new Procedure1<ParameterConnection>() {
                public void apply(final ParameterConnection it) {
                  String _name = it.getName();
                  Assert.assertEquals("paramconn67", _name);
                  ConnectedElement _source = it.getSource();
                  Aadl2JavaValidatorTest.assertError(_source, allIssues, "A \'subprogram subcomponent\' in a \'subprogram call\' is not a valid parameter connection end.");
                  ConnectedElement _destination = it.getDestination();
                  Aadl2JavaValidatorTest.assertNoIssues(_destination, allIssues);
                }
              };
              ObjectExtensions.<ParameterConnection>operator_doubleArrow(_get_298, _function_298);
              EList<ParameterConnection> _ownedParameterConnections_67 = it.getOwnedParameterConnections();
              ParameterConnection _get_299 = _ownedParameterConnections_67.get(67);
              final Procedure1<ParameterConnection> _function_299 = new Procedure1<ParameterConnection>() {
                public void apply(final ParameterConnection it) {
                  String _name = it.getName();
                  Assert.assertEquals("paramconn68", _name);
                  ConnectedElement _source = it.getSource();
                  Aadl2JavaValidatorTest.assertError(_source, allIssues, "A \'subprogram proxy\' in a \'subprogram call\' is not a valid parameter connection end.");
                  ConnectedElement _destination = it.getDestination();
                  Aadl2JavaValidatorTest.assertNoIssues(_destination, allIssues);
                }
              };
              ObjectExtensions.<ParameterConnection>operator_doubleArrow(_get_299, _function_299);
              EList<ParameterConnection> _ownedParameterConnections_68 = it.getOwnedParameterConnections();
              ParameterConnection _get_300 = _ownedParameterConnections_68.get(68);
              final Procedure1<ParameterConnection> _function_300 = new Procedure1<ParameterConnection>() {
                public void apply(final ParameterConnection it) {
                  String _name = it.getName();
                  Assert.assertEquals("paramconn69", _name);
                  ConnectedElement _source = it.getSource();
                  Aadl2JavaValidatorTest.assertError(_source, allIssues, "A \'port proxy\' in a \'subprogram call\' is not a valid parameter connection end.");
                  ConnectedElement _destination = it.getDestination();
                  Aadl2JavaValidatorTest.assertNoIssues(_destination, allIssues);
                }
              };
              ObjectExtensions.<ParameterConnection>operator_doubleArrow(_get_300, _function_300);
              EList<ParameterConnection> _ownedParameterConnections_69 = it.getOwnedParameterConnections();
              ParameterConnection _get_301 = _ownedParameterConnections_69.get(69);
              final Procedure1<ParameterConnection> _function_301 = new Procedure1<ParameterConnection>() {
                public void apply(final ParameterConnection it) {
                  String _name = it.getName();
                  Assert.assertEquals("paramconn70", _name);
                  ConnectedElement _source = it.getSource();
                  Aadl2JavaValidatorTest.assertError(_source, allIssues, "An \'event data source\' in a \'subprogram call\' is not a valid parameter connection end.");
                  ConnectedElement _destination = it.getDestination();
                  Aadl2JavaValidatorTest.assertNoIssues(_destination, allIssues);
                }
              };
              ObjectExtensions.<ParameterConnection>operator_doubleArrow(_get_301, _function_301);
              EList<ParameterConnection> _ownedParameterConnections_70 = it.getOwnedParameterConnections();
              ParameterConnection _get_302 = _ownedParameterConnections_70.get(70);
              final Procedure1<ParameterConnection> _function_302 = new Procedure1<ParameterConnection>() {
                public void apply(final ParameterConnection it) {
                  String _name = it.getName();
                  Assert.assertEquals("paramconn71", _name);
                  ConnectedElement _source = it.getSource();
                  Aadl2JavaValidatorTest.assertError(_source, allIssues, "An \'abstract feature\' in a \'subprogram call\' is not a valid parameter connection end.");
                  ConnectedElement _destination = it.getDestination();
                  Aadl2JavaValidatorTest.assertNoIssues(_destination, allIssues);
                }
              };
              ObjectExtensions.<ParameterConnection>operator_doubleArrow(_get_302, _function_302);
              EList<ParameterConnection> _ownedParameterConnections_71 = it.getOwnedParameterConnections();
              ParameterConnection _get_303 = _ownedParameterConnections_71.get(71);
              final Procedure1<ParameterConnection> _function_303 = new Procedure1<ParameterConnection>() {
                public void apply(final ParameterConnection it) {
                  String _name = it.getName();
                  Assert.assertEquals("paramconn72", _name);
                  ConnectedElement _source = it.getSource();
                  Aadl2JavaValidatorTest.assertError(_source, allIssues, "A \'feature group\' in a \'subprogram call\' is not a valid parameter connection end.");
                  ConnectedElement _destination = it.getDestination();
                  Aadl2JavaValidatorTest.assertNoIssues(_destination, allIssues);
                }
              };
              ObjectExtensions.<ParameterConnection>operator_doubleArrow(_get_303, _function_303);
              EList<ParameterConnection> _ownedParameterConnections_72 = it.getOwnedParameterConnections();
              ParameterConnection _get_304 = _ownedParameterConnections_72.get(72);
              final Procedure1<ParameterConnection> _function_304 = new Procedure1<ParameterConnection>() {
                public void apply(final ParameterConnection it) {
                  String _name = it.getName();
                  Assert.assertEquals("paramconn73", _name);
                  ConnectedElement _source = it.getSource();
                  Aadl2JavaValidatorTest.assertNoIssues(_source, allIssues);
                  ConnectedElement _destination = it.getDestination();
                  Aadl2JavaValidatorTest.assertNoIssues(_destination, allIssues);
              ...
              ObjectExtensions.<ParameterConnection>operator_doubleArrow(_get_304, _function_304);
              EList<ParameterConnection> _ownedParameterConnections_73 = it.getOwnedParameterConnections();
              ParameterConnection _get_305 = _ownedParameterConnections_73.get(73);
              final Procedure1<ParameterConnection> _function_305 = new Procedure1<ParameterConnection>() {
                public void apply(final ParameterConnection it) {
                  String _name = it.getName();
                  Assert.assertEquals("paramconn74", _name);
                  ConnectedElement _source = it.getSource();
                  Aadl2JavaValidatorTest.assertError(_source, allIssues, "A \'subprogram access\' in a \'subprogram call\' is not a valid parameter connection end.");
                  ConnectedElement _destination = it.getDestination();
                  Aadl2JavaValidatorTest.assertNoIssues(_destination, allIssues);
                }
              };
              ObjectExtensions.<ParameterConnection>operator_doubleArrow(_get_305, _function_305);
              EList<ParameterConnection> _ownedParameterConnections_74 = it.getOwnedParameterConnections();
              ParameterConnection _get_306 = _ownedParameterConnections_74.get(74);
              final Procedure1<ParameterConnection> _function_306 = new Procedure1<ParameterConnection>() {
                public void apply(final ParameterConnection it) {
                  String _name = it.getName();
                  Assert.assertEquals("paramconn75", _name);
                  ConnectedElement _source = it.getSource();
                  Aadl2JavaValidatorTest.assertError(_source, allIssues, "A \'data access\' in a \'subprogram call\' is not a valid parameter connection end.");
                  ConnectedElement _destination = it.getDestination();
                  Aadl2JavaValidatorTest.assertNoIssues(_destination, allIssues);
                }
              };
              ObjectExtensions.<ParameterConnection>operator_doubleArrow(_get_306, _function_306);
              EList<ParameterConnection> _ownedParameterConnections_75 = it.getOwnedParameterConnections();
              ParameterConnection _get_307 = _ownedParameterConnections_75.get(75);
              final Procedure1<ParameterConnection> _function_307 = new Procedure1<ParameterConnection>() {
                public void apply(final ParameterConnection it) {
                  String _name = it.getName();
                  Assert.assertEquals("paramconn76", _name);
                  ConnectedElement _source = it.getSource();
                  Aadl2JavaValidatorTest.assertError(_source, allIssues, "An \'event port\' in a \'subprogram call\' is not a valid parameter connection end.");
                  ConnectedElement _destination = it.getDestination();
                  Aadl2JavaValidatorTest.assertNoIssues(_destination, allIssues);
                }
              };
              ObjectExtensions.<ParameterConnection>operator_doubleArrow(_get_307, _function_307);
              EList<ParameterConnection> _ownedParameterConnections_76 = it.getOwnedParameterConnections();
              ParameterConnection _get_308 = _ownedParameterConnections_76.get(76);
              final Procedure1<ParameterConnection> _function_308 = new Procedure1<ParameterConnection>() {
                public void apply(final ParameterConnection it) {
                  String _name = it.getName();
                  Assert.assertEquals("paramconn77", _name);
                  ConnectedElement _source = it.getSource();
                  Aadl2JavaValidatorTest.assertError(_source, allIssues, "An \'event data port\' in a \'subprogram call\' is not a valid parameter connection end.");
                  ConnectedElement _destination = it.getDestination();
                  Aadl2JavaValidatorTest.assertNoIssues(_destination, allIssues);
                }
              };
              ObjectExtensions.<ParameterConnection>operator_doubleArrow(_get_308, _function_308);
              EList<PortConnection> _ownedPortConnections = it.getOwnedPortConnections();
              PortConnection _get_309 = _ownedPortConnections.get(0);
              final Procedure1<PortConnection> _function_309 = new Procedure1<PortConnection>() {
                public void apply(final PortConnection it) {
                  ...
                  ConnectedElement _source = it.getSource();
                  Aadl2JavaValidatorTest.assertError(_source, allIssues, "A \'bus subcomponent\' is not a valid port connection end.");
                  ConnectedElement _destination = it.getDestination();
                  Aadl2JavaValidatorTest.assertNoIssues(_destination, allIssues);
                }
              };
              ...
              PortConnection _get_310 = _ownedPortConnections_1.get(1);
              ...
              PortConnection _get_311 = _ownedPortConnections_2.get(2);
              final Procedure1<PortConnection> _function_311 = new Procedure1<PortConnection>() {
                public void apply(final PortConnection it) {
                  String _name = it.getName();
                  Assert.assertEquals("portconn3", _name);
                  ConnectedElement _source = it.getSource();
                  Aadl2JavaValidatorTest.assertError(_source, allIssues, "A \'subprogram group subcomponent\' is not a valid port connection end.");
                  ConnectedElement _destination = it.getDestination();
                  Aadl2JavaValidatorTest.assertNoIssues(_destination, allIssues);
                }
              };
              ...
              PortConnection _get_312 = _ownedPortConnections_3.get(3);
              final Procedure1<PortConnection> _function_312 = new Procedure1<PortConnection>() {
                public void apply(final PortConnection it) {
                  String _name = it.getName();
                  Assert.assertEquals("portconn4", _name);
                  ConnectedElement _source = it.getSource();
                  Aadl2JavaValidatorTest.assertError(_source, allIssues, "A \'subprogram subcomponent\' is not a valid port connection end.");
                  ConnectedElement _destination = it.getDestination();
                  Aadl2JavaValidatorTest.assertNoIssues(_destination, allIssues);
                }
              };
              ...
              PortConnection _get_313 = _ownedPortConnections_4.get(4);
              final Procedure1<PortConnection> _function_313 = new Procedure1<PortConnection>() {
                public void apply(final PortConnection it) {
                  String _name = it.getName();
                  Assert.assertEquals("portconn5", _name);
                  ConnectedElement _source = it.getSource();
                  Aadl2JavaValidatorTest.assertError(_source, allIssues, "A \'subprogram proxy\' is not a valid port connection end.");
                  ConnectedElement _destination = it.getDestination();
                  Aadl2JavaValidatorTest.assertNoIssues(_destination, allIssues);
                }
              };
              ...
              PortConnection _get_314 = _ownedPortConnections_5.get(5);
              final Procedure1<PortConnection> _function_314 = new Procedure1<PortConnection>() {
                public void apply(final PortConnection it) {
                  String _name = it.getName();
                  Assert.assertEquals("portconn6", _name);
                  ConnectedElement _source = it.getSource();
                  Aadl2JavaValidatorTest.assertNoIssues(_source, allIssues);
                  ConnectedElement _destination = it.getDestination();
                  Aadl2JavaValidatorTest.assertNoIssues(_destination, allIssues);
              ...
              PortConnection _get_315 = _ownedPortConnections_6.get(6);
              final Procedure1<PortConnection> _function_315 = new Procedure1<PortConnection>() {
                public void apply(final PortConnection it) {
                  String _name = it.getName();
                  Assert.assertEquals("portconn7", _name);
                  ConnectedElement _source = it.getSource();
                  Aadl2JavaValidatorTest.assertNoIssues(_source, allIssues);
                  ConnectedElement _destination = it.getDestination();
                  Aadl2JavaValidatorTest.assertNoIssues(_destination, allIssues);
              ...
              ObjectExtensions.<PortConnection>operator_doubleArrow(_get_315, _function_315);
              EList<PortConnection> _ownedPortConnections_7 = it.getOwnedPortConnections();
              PortConnection _get_316 = _ownedPortConnections_7.get(7);
              final Procedure1<PortConnection> _function_316 = new Procedure1<PortConnection>() {
                public void apply(final PortConnection it) {
                  String _name = it.getName();
                  Assert.assertEquals("portconn8", _name);
                  ConnectedElement _source = it.getSource();
                  Aadl2JavaValidatorTest.assertError(_source, allIssues, "An \'abstract feature\' is not a valid port connection end.");
                  ConnectedElement _destination = it.getDestination();
                  Aadl2JavaValidatorTest.assertNoIssues(_destination, allIssues);
                }
              };
              ObjectExtensions.<PortConnection>operator_doubleArrow(_get_316, _function_316);
              EList<PortConnection> _ownedPortConnections_8 = it.getOwnedPortConnections();
              PortConnection _get_317 = _ownedPortConnections_8.get(8);
              final Procedure1<PortConnection> _function_317 = new Procedure1<PortConnection>() {
                public void apply(final PortConnection it) {
                  String _name = it.getName();
                  Assert.assertEquals("portconn9", _name);
                  ConnectedElement _source = it.getSource();
                  Aadl2JavaValidatorTest.assertError(_source, allIssues, "A \'feature group\' is not a valid port connection end.");
                  ConnectedElement _destination = it.getDestination();
                  Aadl2JavaValidatorTest.assertNoIssues(_destination, allIssues);
                }
              };
              ObjectExtensions.<PortConnection>operator_doubleArrow(_get_317, _function_317);
              EList<PortConnection> _ownedPortConnections_9 = it.getOwnedPortConnections();
              PortConnection _get_318 = _ownedPortConnections_9.get(9);
              final Procedure1<PortConnection> _function_318 = new Procedure1<PortConnection>() {
                public void apply(final PortConnection it) {
                  String _name = it.getName();
                  Assert.assertEquals("portconn10", _name);
                  ConnectedElement _source = it.getSource();
                  Aadl2JavaValidatorTest.assertError(_source, allIssues, "A \'bus access\' is not a valid port connection end.");
                  ConnectedElement _destination = it.getDestination();
                  Aadl2JavaValidatorTest.assertNoIssues(_destination, allIssues);
                }
              };
              ObjectExtensions.<PortConnection>operator_doubleArrow(_get_318, _function_318);
              EList<PortConnection> _ownedPortConnections_10 = it.getOwnedPortConnections();
              PortConnection _get_319 = _ownedPortConnections_10.get(10);
              final Procedure1<PortConnection> _function_319 = new Procedure1<PortConnection>() {
                public void apply(final PortConnection it) {
                  String _name = it.getName();
                  Assert.assertEquals("portconn11", _name);
                  ConnectedElement _source = it.getSource();
                  Aadl2JavaValidatorTest.assertNoIssues(_source, allIssues);
                  ConnectedElement _destination = it.getDestination();
                  Aadl2JavaValidatorTest.assertNoIssues(_destination, allIssues);
              ...
              ObjectExtensions.<PortConnection>operator_doubleArrow(_get_319, _function_319);
              EList<PortConnection> _ownedPortConnections_11 = it.getOwnedPortConnections();
              PortConnection _get_320 = _ownedPortConnections_11.get(11);
              final Procedure1<PortConnection> _function_320 = new Procedure1<PortConnection>() {
                public void apply(final PortConnection it) {
                  String _name = it.getName();
                  Assert.assertEquals("portconn12", _name);
                  ConnectedElement _source = it.getSource();
                  Aadl2JavaValidatorTest.assertNoIssues(_source, allIssues);
                  ConnectedElement _destination = it.getDestination();
                  Aadl2JavaValidatorTest.assertNoIssues(_destination, allIssues);
              ...
              ObjectExtensions.<PortConnection>operator_doubleArrow(_get_320, _function_320);
              EList<PortConnection> _ownedPortConnections_12 = it.getOwnedPortConnections();
              PortConnection _get_321 = _ownedPortConnections_12.get(12);
              final Procedure1<PortConnection> _function_321 = new Procedure1<PortConnection>() {
                public void apply(final PortConnection it) {
                  String _name = it.getName();
                  Assert.assertEquals("portconn13", _name);
                  ConnectedElement _source = it.getSource();
                  Aadl2JavaValidatorTest.assertNoIssues(_source, allIssues);
                  ConnectedElement _destination = it.getDestination();
                  Aadl2JavaValidatorTest.assertNoIssues(_destination, allIssues);
              ...
              ObjectExtensions.<PortConnection>operator_doubleArrow(_get_321, _function_321);
              EList<PortConnection> _ownedPortConnections_13 = it.getOwnedPortConnections();
              PortConnection _get_322 = _ownedPortConnections_13.get(13);
              final Procedure1<PortConnection> _function_322 = new Procedure1<PortConnection>() {
                public void apply(final PortConnection it) {
                  String _name = it.getName();
                  Assert.assertEquals("portconn14", _name);
                  ConnectedElement _source = it.getSource();
                  Aadl2JavaValidatorTest.assertNoIssues(_source, allIssues);
                  ConnectedElement _destination = it.getDestination();
                  Aadl2JavaValidatorTest.assertNoIssues(_destination, allIssues);
              ...
              ObjectExtensions.<PortConnection>operator_doubleArrow(_get_322, _function_322);
              EList<PortConnection> _ownedPortConnections_14 = it.getOwnedPortConnections();
              PortConnection _get_323 = _ownedPortConnections_14.get(14);
              final Procedure1<PortConnection> _function_323 = new Procedure1<PortConnection>() {
                public void apply(final PortConnection it) {
                  String _name = it.getName();
                  Assert.assertEquals("portconn15", _name);
                  ConnectedElement _source = it.getSource();
                  Aadl2JavaValidatorTest.assertError(_source, allIssues, "A \'bus subcomponent\' in a \'data port\' is not a valid port connection end.");
                  ConnectedElement _destination = it.getDestination();
                  Aadl2JavaValidatorTest.assertNoIssues(_destination, allIssues);
                }
              };
              ObjectExtensions.<PortConnection>operator_doubleArrow(_get_323, _function_323);
              EList<PortConnection> _ownedPortConnections_15 = it.getOwnedPortConnections();
              PortConnection _get_324 = _ownedPortConnections_15.get(15);
              final Procedure1<PortConnection> _function_324 = new Procedure1<PortConnection>() {
                public void apply(final PortConnection it) {
                  String _name = it.getName();
                  Assert.assertEquals("portconn16", _name);
                  ConnectedElement _source = it.getSource();
                  Aadl2JavaValidatorTest.assertNoIssues(_source, allIssues);
                  ConnectedElement _destination = it.getDestination();
                  Aadl2JavaValidatorTest.assertNoIssues(_destination, allIssues);
              ...
              ObjectExtensions.<PortConnection>operator_doubleArrow(_get_324, _function_324);
              EList<PortConnection> _ownedPortConnections_16 = it.getOwnedPortConnections();
              PortConnection _get_325 = _ownedPortConnections_16.get(16);
              final Procedure1<PortConnection> _function_325 = new Procedure1<PortConnection>() {
                public void apply(final PortConnection it) {
                  String _name = it.getName();
                  Assert.assertEquals("portconn17", _name);
                  ConnectedElement _source = it.getSource();
                  Aadl2JavaValidatorTest.assertError(_source, allIssues, "A \'subprogram group subcomponent\' in a \'data port\' is not a valid port connection end.");
                  ConnectedElement _destination = it.getDestination();
                  Aadl2JavaValidatorTest.assertNoIssues(_destination, allIssues);
                }
              };
              ObjectExtensions.<PortConnection>operator_doubleArrow(_get_325, _function_325);
              EList<PortConnection> _ownedPortConnections_17 = it.getOwnedPortConnections();
              PortConnection _get_326 = _ownedPortConnections_17.get(17);
              final Procedure1<PortConnection> _function_326 = new Procedure1<PortConnection>() {
                public void apply(final PortConnection it) {
                  String _name = it.getName();
                  Assert.assertEquals("portconn18", _name);
                  ConnectedElement _source = it.getSource();
                  Aadl2JavaValidatorTest.assertError(_source, allIssues, "A \'subprogram subcomponent\' in a \'data port\' is not a valid port connection end.");
                  ConnectedElement _destination = it.getDestination();
                  Aadl2JavaValidatorTest.assertNoIssues(_destination, allIssues);
                }
              };
              ObjectExtensions.<PortConnection>operator_doubleArrow(_get_326, _function_326);
              EList<PortConnection> _ownedPortConnections_18 = it.getOwnedPortConnections();
              PortConnection _get_327 = _ownedPortConnections_18.get(18);
              final Procedure1<PortConnection> _function_327 = new Procedure1<PortConnection>() {
                public void apply(final PortConnection it) {
                  String _name = it.getName();
                  Assert.assertEquals("portconn19", _name);
                  ConnectedElement _source = it.getSource();
                  Aadl2JavaValidatorTest.assertError(_source, allIssues, "A \'subprogram proxy\' in a \'data port\' is not a valid port connection end.");
                  ConnectedElement _destination = it.getDestination();
                  Aadl2JavaValidatorTest.assertNoIssues(_destination, allIssues);
                }
              };
              ObjectExtensions.<PortConnection>operator_doubleArrow(_get_327, _function_327);
              EList<PortConnection> _ownedPortConnections_19 = it.getOwnedPortConnections();
              PortConnection _get_328 = _ownedPortConnections_19.get(19);
              final Procedure1<PortConnection> _function_328 = new Procedure1<PortConnection>() {
                public void apply(final PortConnection it) {
                  String _name = it.getName();
                  Assert.assertEquals("portconn20", _name);
                  ConnectedElement _source = it.getSource();
                  Aadl2JavaValidatorTest.assertError(_source, allIssues, "A \'port proxy\' in a \'data port\' is not a valid port connection end.");
                  ConnectedElement _destination = it.getDestination();
                  Aadl2JavaValidatorTest.assertNoIssues(_destination, allIssues);
                }
              };
              ObjectExtensions.<PortConnection>operator_doubleArrow(_get_328, _function_328);
              EList<PortConnection> _ownedPortConnections_20 = it.getOwnedPortConnections();
              PortConnection _get_329 = _ownedPortConnections_20.get(20);
              final Procedure1<PortConnection> _function_329 = new Procedure1<PortConnection>() {
                public void apply(final PortConnection it) {
                  String _name = it.getName();
                  Assert.assertEquals("portconn21", _name);
                  ConnectedElement _source = it.getSource();
                  Aadl2JavaValidatorTest.assertError(_source, allIssues, "An \'event data source\' in a \'data port\' is not a valid port connection end.");
                  ConnectedElement _destination = it.getDestination();
                  Aadl2JavaValidatorTest.assertNoIssues(_destination, allIssues);
                }
              };
              ObjectExtensions.<PortConnection>operator_doubleArrow(_get_329, _function_329);
              EList<PortConnection> _ownedPortConnections_21 = it.getOwnedPortConnections();
              PortConnection _get_330 = _ownedPortConnections_21.get(21);
              final Procedure1<PortConnection> _function_330 = new Procedure1<PortConnection>() {
                public void apply(final PortConnection it) {
                  String _name = it.getName();
                  Assert.assertEquals("portconn22", _name);
                  ConnectedElement _source = it.getSource();
                  Aadl2JavaValidatorTest.assertError(_source, allIssues, "An \'abstract feature\' in a \'data port\' is not a valid port connection end.");
                  ConnectedElement _destination = it.getDestination();
                  Aadl2JavaValidatorTest.assertNoIssues(_destination, allIssues);
                }
              };
              ObjectExtensions.<PortConnection>operator_doubleArrow(_get_330, _function_330);
              EList<PortConnection> _ownedPortConnections_22 = it.getOwnedPortConnections();
              PortConnection _get_331 = _ownedPortConnections_22.get(22);
              final Procedure1<PortConnection> _function_331 = new Procedure1<PortConnection>() {
                public void apply(final PortConnection it) {
                  String _name = it.getName();
                  Assert.assertEquals("portconn23", _name);
                  ConnectedElement _source = it.getSource();
                  Aadl2JavaValidatorTest.assertError(_source, allIssues, "A \'feature group\' in a \'data port\' is not a valid port connection end.");
                  ConnectedElement _destination = it.getDestination();
                  Aadl2JavaValidatorTest.assertNoIssues(_destination, allIssues);
                }
              };
              ObjectExtensions.<PortConnection>operator_doubleArrow(_get_331, _function_331);
              EList<PortConnection> _ownedPortConnections_23 = it.getOwnedPortConnections();
              PortConnection _get_332 = _ownedPortConnections_23.get(23);
              final Procedure1<PortConnection> _function_332 = new Procedure1<PortConnection>() {
                public void apply(final PortConnection it) {
                  String _name = it.getName();
                  Assert.assertEquals("portconn24", _name);
                  ConnectedElement _source = it.getSource();
                  Aadl2JavaValidatorTest.assertError(_source, allIssues, "A \'bus access\' in a \'data port\' is not a valid port connection end.");
                  ConnectedElement _destination = it.getDestination();
                  Aadl2JavaValidatorTest.assertNoIssues(_destination, allIssues);
                }
              };
              ObjectExtensions.<PortConnection>operator_doubleArrow(_get_332, _function_332);
              EList<PortConnection> _ownedPortConnections_24 = it.getOwnedPortConnections();
              PortConnection _get_333 = _ownedPortConnections_24.get(24);
              final Procedure1<PortConnection> _function_333 = new Procedure1<PortConnection>() {
                public void apply(final PortConnection it) {
                  String _name = it.getName();
                  Assert.assertEquals("portconn25", _name);
                  ConnectedElement _source = it.getSource();
                  Aadl2JavaValidatorTest.assertError(_source, allIssues, "A \'data access\' in a \'data port\' is not a valid port connection end.");
                  ConnectedElement _destination = it.getDestination();
                  Aadl2JavaValidatorTest.assertNoIssues(_destination, allIssues);
                }
              };
              ObjectExtensions.<PortConnection>operator_doubleArrow(_get_333, _function_333);
              EList<PortConnection> _ownedPortConnections_25 = it.getOwnedPortConnections();
              PortConnection _get_334 = _ownedPortConnections_25.get(25);
              final Procedure1<PortConnection> _function_334 = new Procedure1<PortConnection>() {
                public void apply(final PortConnection it) {
                  String _name = it.getName();
                  Assert.assertEquals("portconn26", _name);
                  ConnectedElement _source = it.getSource();
                  Aadl2JavaValidatorTest.assertError(_source, allIssues, "An \'event port\' in a \'data port\' is not a valid port connection end.");
                  ConnectedElement _destination = it.getDestination();
                  Aadl2JavaValidatorTest.assertNoIssues(_destination, allIssues);
                }
              };
              ObjectExtensions.<PortConnection>operator_doubleArrow(_get_334, _function_334);
              EList<PortConnection> _ownedPortConnections_26 = it.getOwnedPortConnections();
              PortConnection _get_335 = _ownedPortConnections_26.get(26);
              final Procedure1<PortConnection> _function_335 = new Procedure1<PortConnection>() {
                public void apply(final PortConnection it) {
                  String _name = it.getName();
                  Assert.assertEquals("portconn27", _name);
                  ConnectedElement _source = it.getSource();
                  Aadl2JavaValidatorTest.assertError(_source, allIssues, "A \'data port\' in a \'data port\' is not a valid port connection end.");
                  ConnectedElement _destination = it.getDestination();
                  Aadl2JavaValidatorTest.assertNoIssues(_destination, allIssues);
                }
              };
              ObjectExtensions.<PortConnection>operator_doubleArrow(_get_335, _function_335);
              EList<PortConnection> _ownedPortConnections_27 = it.getOwnedPortConnections();
              PortConnection _get_336 = _ownedPortConnections_27.get(27);
              final Procedure1<PortConnection> _function_336 = new Procedure1<PortConnection>() {
                public void apply(final PortConnection it) {
                  String _name = it.getName();
                  Assert.assertEquals("portconn28", _name);
                  ConnectedElement _source = it.getSource();
                  Aadl2JavaValidatorTest.assertError(_source, allIssues, "An \'event data port\' in a \'data port\' is not a valid port connection end.");
                  ConnectedElement _destination = it.getDestination();
                  Aadl2JavaValidatorTest.assertNoIssues(_destination, allIssues);
                }
              };
              ObjectExtensions.<PortConnection>operator_doubleArrow(_get_336, _function_336);
              EList<PortConnection> _ownedPortConnections_28 = it.getOwnedPortConnections();
              PortConnection _get_337 = _ownedPortConnections_28.get(28);
              final Procedure1<PortConnection> _function_337 = new Procedure1<PortConnection>() {
                public void apply(final PortConnection it) {
                  String _name = it.getName();
                  Assert.assertEquals("portconn29", _name);
                  ConnectedElement _source = it.getSource();
                  Aadl2JavaValidatorTest.assertError(_source, allIssues, "A \'bus subcomponent\' in an \'event data port\' is not a valid port connection end.");
                  ConnectedElement _destination = it.getDestination();
                  Aadl2JavaValidatorTest.assertNoIssues(_destination, allIssues);
                }
              };
              ObjectExtensions.<PortConnection>operator_doubleArrow(_get_337, _function_337);
              EList<PortConnection> _ownedPortConnections_29 = it.getOwnedPortConnections();
              PortConnection _get_338 = _ownedPortConnections_29.get(29);
              final Procedure1<PortConnection> _function_338 = new Procedure1<PortConnection>() {
                public void apply(final PortConnection it) {
                  String _name = it.getName();
                  Assert.assertEquals("portconn30", _name);
                  ConnectedElement _source = it.getSource();
                  Aadl2JavaValidatorTest.assertNoIssues(_source, allIssues);
                  ConnectedElement _destination = it.getDestination();
                  Aadl2JavaValidatorTest.assertNoIssues(_destination, allIssues);
              ...
              ObjectExtensions.<PortConnection>operator_doubleArrow(_get_338, _function_338);
              EList<PortConnection> _ownedPortConnections_30 = it.getOwnedPortConnections();
              PortConnection _get_339 = _ownedPortConnections_30.get(30);
              final Procedure1<PortConnection> _function_339 = new Procedure1<PortConnection>() {
                public void apply(final PortConnection it) {
                  String _name = it.getName();
                  Assert.assertEquals("portconn31", _name);
                  ConnectedElement _source = it.getSource();
                  Aadl2JavaValidatorTest.assertError(_source, allIssues, "A \'subprogram group subcomponent\' in an \'event data port\' is not a valid port connection end.");
                  ConnectedElement _destination = it.getDestination();
                  Aadl2JavaValidatorTest.assertNoIssues(_destination, allIssues);
                }
              };
              ObjectExtensions.<PortConnection>operator_doubleArrow(_get_339, _function_339);
              EList<PortConnection> _ownedPortConnections_31 = it.getOwnedPortConnections();
              PortConnection _get_340 = _ownedPortConnections_31.get(31);
              final Procedure1<PortConnection> _function_340 = new Procedure1<PortConnection>() {
                public void apply(final PortConnection it) {
                  String _name = it.getName();
                  Assert.assertEquals("portconn32", _name);
                  ConnectedElement _source = it.getSource();
                  Aadl2JavaValidatorTest.assertError(_source, allIssues, "A \'subprogram subcomponent\' in an \'event data port\' is not a valid port connection end.");
                  ConnectedElement _destination = it.getDestination();
                  Aadl2JavaValidatorTest.assertNoIssues(_destination, allIssues);
                }
              };
              ObjectExtensions.<PortConnection>operator_doubleArrow(_get_340, _function_340);
              EList<PortConnection> _ownedPortConnections_32 = it.getOwnedPortConnections();
              PortConnection _get_341 = _ownedPortConnections_32.get(32);
              final Procedure1<PortConnection> _function_341 = new Procedure1<PortConnection>() {
                public void apply(final PortConnection it) {
                  String _name = it.getName();
                  Assert.assertEquals("portconn33", _name);
                  ConnectedElement _source = it.getSource();
                  Aadl2JavaValidatorTest.assertError(_source, allIssues, "A \'subprogram proxy\' in an \'event data port\' is not a valid port connection end.");
                  ConnectedElement _destination = it.getDestination();
                  Aadl2JavaValidatorTest.assertNoIssues(_destination, allIssues);
                }
              };
              ObjectExtensions.<PortConnection>operator_doubleArrow(_get_341, _function_341);
              EList<PortConnection> _ownedPortConnections_33 = it.getOwnedPortConnections();
              PortConnection _get_342 = _ownedPortConnections_33.get(33);
              final Procedure1<PortConnection> _function_342 = new Procedure1<PortConnection>() {
                public void apply(final PortConnection it) {
                  String _name = it.getName();
                  Assert.assertEquals("portconn34", _name);
                  ConnectedElement _source = it.getSource();
                  Aadl2JavaValidatorTest.assertError(_source, allIssues, "A \'port proxy\' in an \'event data port\' is not a valid port connection end.");
                  ConnectedElement _destination = it.getDestination();
                  Aadl2JavaValidatorTest.assertNoIssues(_destination, allIssues);
                }
              };
              ObjectExtensions.<PortConnection>operator_doubleArrow(_get_342, _function_342);
              EList<PortConnection> _ownedPortConnections_34 = it.getOwnedPortConnections();
              PortConnection _get_343 = _ownedPortConnections_34.get(34);
              final Procedure1<PortConnection> _function_343 = new Procedure1<PortConnection>() {
                public void apply(final PortConnection it) {
                  String _name = it.getName();
                  Assert.assertEquals("portconn35", _name);
                  ConnectedElement _source = it.getSource();
                  Aadl2JavaValidatorTest.assertError(_source, allIssues, "An \'event data source\' in an \'event data port\' is not a valid port connection end.");
                  ConnectedElement _destination = it.getDestination();
                  Aadl2JavaValidatorTest.assertNoIssues(_destination, allIssues);
                }
              };
              ObjectExtensions.<PortConnection>operator_doubleArrow(_get_343, _function_343);
              EList<PortConnection> _ownedPortConnections_35 = it.getOwnedPortConnections();
              PortConnection _get_344 = _ownedPortConnections_35.get(35);
              final Procedure1<PortConnection> _function_344 = new Procedure1<PortConnection>() {
                public void apply(final PortConnection it) {
                  String _name = it.getName();
                  Assert.assertEquals("portconn36", _name);
                  ConnectedElement _source = it.getSource();
                  Aadl2JavaValidatorTest.assertError(_source, allIssues, "An \'abstract feature\' in an \'event data port\' is not a valid port connection end.");
                  ConnectedElement _destination = it.getDestination();
                  Aadl2JavaValidatorTest.assertNoIssues(_destination, allIssues);
                }
              };
              ObjectExtensions.<PortConnection>operator_doubleArrow(_get_344, _function_344);
              EList<PortConnection> _ownedPortConnections_36 = it.getOwnedPortConnections();
              PortConnection _get_345 = _ownedPortConnections_36.get(36);
              final Procedure1<PortConnection> _function_345 = new Procedure1<PortConnection>() {
                public void apply(final PortConnection it) {
                  String _name = it.getName();
                  Assert.assertEquals("portconn37", _name);
                  ConnectedElement _source = it.getSource();
                  Aadl2JavaValidatorTest.assertError(_source, allIssues, "A \'feature group\' in an \'event data port\' is not a valid port connection end.");
                  ConnectedElement _destination = it.getDestination();
                  Aadl2JavaValidatorTest.assertNoIssues(_destination, allIssues);
                }
              };
              ObjectExtensions.<PortConnection>operator_doubleArrow(_get_345, _function_345);
              EList<PortConnection> _ownedPortConnections_37 = it.getOwnedPortConnections();
              PortConnection _get_346 = _ownedPortConnections_37.get(37);
              final Procedure1<PortConnection> _function_346 = new Procedure1<PortConnection>() {
                public void apply(final PortConnection it) {
                  String _name = it.getName();
                  Assert.assertEquals("portconn38", _name);
                  ConnectedElement _source = it.getSource();
                  Aadl2JavaValidatorTest.assertError(_source, allIssues, "A \'bus access\' in an \'event data port\' is not a valid port connection end.");
                  ConnectedElement _destination = it.getDestination();
                  Aadl2JavaValidatorTest.assertNoIssues(_destination, allIssues);
                }
              };
              ObjectExtensions.<PortConnection>operator_doubleArrow(_get_346, _function_346);
              EList<PortConnection> _ownedPortConnections_38 = it.getOwnedPortConnections();
              PortConnection _get_347 = _ownedPortConnections_38.get(38);
              final Procedure1<PortConnection> _function_347 = new Procedure1<PortConnection>() {
                public void apply(final PortConnection it) {
                  String _name = it.getName();
                  Assert.assertEquals("portconn39", _name);
                  ConnectedElement _source = it.getSource();
                  Aadl2JavaValidatorTest.assertError(_source, allIssues, "A \'data access\' in an \'event data port\' is not a valid port connection end.");
                  ConnectedElement _destination = it.getDestination();
                  Aadl2JavaValidatorTest.assertNoIssues(_destination, allIssues);
                }
              };
              ObjectExtensions.<PortConnection>operator_doubleArrow(_get_347, _function_347);
              EList<PortConnection> _ownedPortConnections_39 = it.getOwnedPortConnections();
              PortConnection _get_348 = _ownedPortConnections_39.get(39);
              final Procedure1<PortConnection> _function_348 = new Procedure1<PortConnection>() {
                public void apply(final PortConnection it) {
                  String _name = it.getName();
                  Assert.assertEquals("portconn40", _name);
                  ConnectedElement _source = it.getSource();
                  Aadl2JavaValidatorTest.assertError(_source, allIssues, "An \'event port\' in an \'event data port\' is not a valid port connection end.");
                  ConnectedElement _destination = it.getDestination();
                  Aadl2JavaValidatorTest.assertNoIssues(_destination, allIssues);
                }
              };
              ObjectExtensions.<PortConnection>operator_doubleArrow(_get_348, _function_348);
              EList<PortConnection> _ownedPortConnections_40 = it.getOwnedPortConnections();
              PortConnection _get_349 = _ownedPortConnections_40.get(40);
              final Procedure1<PortConnection> _function_349 = new Procedure1<PortConnection>() {
                public void apply(final PortConnection it) {
                  String _name = it.getName();
                  Assert.assertEquals("portconn41", _name);
                  ConnectedElement _source = it.getSource();
                  Aadl2JavaValidatorTest.assertError(_source, allIssues, "A \'data port\' in an \'event data port\' is not a valid port connection end.");
                  ConnectedElement _destination = it.getDestination();
                  Aadl2JavaValidatorTest.assertNoIssues(_destination, allIssues);
                }
              };
              ObjectExtensions.<PortConnection>operator_doubleArrow(_get_349, _function_349);
              EList<PortConnection> _ownedPortConnections_41 = it.getOwnedPortConnections();
              PortConnection _get_350 = _ownedPortConnections_41.get(41);
              final Procedure1<PortConnection> _function_350 = new Procedure1<PortConnection>() {
                public void apply(final PortConnection it) {
                  String _name = it.getName();
                  Assert.assertEquals("portconn42", _name);
                  ConnectedElement _source = it.getSource();
                  Aadl2JavaValidatorTest.assertError(_source, allIssues, "An \'event data port\' in an \'event data port\' is not a valid port connection end.");
                  ConnectedElement _destination = it.getDestination();
                  Aadl2JavaValidatorTest.assertNoIssues(_destination, allIssues);
                }
              };
              ObjectExtensions.<PortConnection>operator_doubleArrow(_get_350, _function_350);
              EList<PortConnection> _ownedPortConnections_42 = it.getOwnedPortConnections();
              PortConnection _get_351 = _ownedPortConnections_42.get(42);
              final Procedure1<PortConnection> _function_351 = new Procedure1<PortConnection>() {
                public void apply(final PortConnection it) {
                  String _name = it.getName();
                  Assert.assertEquals("portconn43", _name);
                  ConnectedElement _source = it.getSource();
                  Aadl2JavaValidatorTest.assertError(_source, allIssues, "An \'abstract feature\' in a \'feature group\' is not a valid port connection end.");
                  ConnectedElement _destination = it.getDestination();
                  Aadl2JavaValidatorTest.assertNoIssues(_destination, allIssues);
                }
              };
              ObjectExtensions.<PortConnection>operator_doubleArrow(_get_351, _function_351);
              EList<PortConnection> _ownedPortConnections_43 = it.getOwnedPortConnections();
              PortConnection _get_352 = _ownedPortConnections_43.get(43);
              final Procedure1<PortConnection> _function_352 = new Procedure1<PortConnection>() {
                public void apply(final PortConnection it) {
                  String _name = it.getName();
                  Assert.assertEquals("portconn44", _name);
                  ConnectedElement _source = it.getSource();
                  Aadl2JavaValidatorTest.assertError(_source, allIssues, "A \'feature group\' in a \'feature group\' is not a valid port connection end.");
                  ConnectedElement _destination = it.getDestination();
                  Aadl2JavaValidatorTest.assertNoIssues(_destination, allIssues);
                }
              };
              ObjectExtensions.<PortConnection>operator_doubleArrow(_get_352, _function_352);
              EList<PortConnection> _ownedPortConnections_44 = it.getOwnedPortConnections();
              PortConnection _get_353 = _ownedPortConnections_44.get(44);
              final Procedure1<PortConnection> _function_353 = new Procedure1<PortConnection>() {
                public void apply(final PortConnection it) {
                  String _name = it.getName();
                  Assert.assertEquals("portconn45", _name);
                  ConnectedElement _source = it.getSource();
                  Aadl2JavaValidatorTest.assertError(_source, allIssues, "A \'parameter\' in a \'feature group\' is not a valid port connection end.");
                  ConnectedElement _destination = it.getDestination();
                  Aadl2JavaValidatorTest.assertNoIssues(_destination, allIssues);
                }
              };
              ObjectExtensions.<PortConnection>operator_doubleArrow(_get_353, _function_353);
              EList<PortConnection> _ownedPortConnections_45 = it.getOwnedPortConnections();
              PortConnection _get_354 = _ownedPortConnections_45.get(45);
              final Procedure1<PortConnection> _function_354 = new Procedure1<PortConnection>() {
                public void apply(final PortConnection it) {
                  String _name = it.getName();
                  Assert.assertEquals("portconn46", _name);
                  ConnectedElement _source = it.getSource();
                  Aadl2JavaValidatorTest.assertError(_source, allIssues, "A \'bus access\' in a \'feature group\' is not a valid port connection end.");
                  ConnectedElement _destination = it.getDestination();
                  Aadl2JavaValidatorTest.assertNoIssues(_destination, allIssues);
                }
              };
              ObjectExtensions.<PortConnection>operator_doubleArrow(_get_354, _function_354);
              EList<PortConnection> _ownedPortConnections_46 = it.getOwnedPortConnections();
              PortConnection _get_355 = _ownedPortConnections_46.get(46);
              final Procedure1<PortConnection> _function_355 = new Procedure1<PortConnection>() {
                public void apply(final PortConnection it) {
                  String _name = it.getName();
                  Assert.assertEquals("portconn47", _name);
                  ConnectedElement _source = it.getSource();
                  Aadl2JavaValidatorTest.assertNoIssues(_source, allIssues);
                  ConnectedElement _destination = it.getDestination();
                  Aadl2JavaValidatorTest.assertNoIssues(_destination, allIssues);
              ...
              ObjectExtensions.<PortConnection>operator_doubleArrow(_get_355, _function_355);
              EList<PortConnection> _ownedPortConnections_47 = it.getOwnedPortConnections();
              PortConnection _get_356 = _ownedPortConnections_47.get(47);
              final Procedure1<PortConnection> _function_356 = new Procedure1<PortConnection>() {
                public void apply(final PortConnection it) {
                  String _name = it.getName();
                  Assert.assertEquals("portconn48", _name);
                  ConnectedElement _source = it.getSource();
                  Aadl2JavaValidatorTest.assertNoIssues(_source, allIssues);
                  ConnectedElement _destination = it.getDestination();
                  Aadl2JavaValidatorTest.assertNoIssues(_destination, allIssues);
              ...
              ObjectExtensions.<PortConnection>operator_doubleArrow(_get_356, _function_356);
              EList<PortConnection> _ownedPortConnections_48 = it.getOwnedPortConnections();
              PortConnection _get_357 = _ownedPortConnections_48.get(48);
              final Procedure1<PortConnection> _function_357 = new Procedure1<PortConnection>() {
                public void apply(final PortConnection it) {
                  String _name = it.getName();
                  Assert.assertEquals("portconn49", _name);
                  ConnectedElement _source = it.getSource();
                  Aadl2JavaValidatorTest.assertNoIssues(_source, allIssues);
                  ConnectedElement _destination = it.getDestination();
                  Aadl2JavaValidatorTest.assertNoIssues(_destination, allIssues);
              ...
              ObjectExtensions.<PortConnection>operator_doubleArrow(_get_357, _function_357);
              EList<PortConnection> _ownedPortConnections_49 = it.getOwnedPortConnections();
              PortConnection _get_358 = _ownedPortConnections_49.get(49);
              final Procedure1<PortConnection> _function_358 = new Procedure1<PortConnection>() {
                public void apply(final PortConnection it) {
                  String _name = it.getName();
                  Assert.assertEquals("portconn50", _name);
                  ConnectedElement _source = it.getSource();
                  Aadl2JavaValidatorTest.assertNoIssues(_source, allIssues);
                  ConnectedElement _destination = it.getDestination();
                  Aadl2JavaValidatorTest.assertNoIssues(_destination, allIssues);
              ...
              ObjectExtensions.<PortConnection>operator_doubleArrow(_get_358, _function_358);
              EList<PortConnection> _ownedPortConnections_50 = it.getOwnedPortConnections();
              PortConnection _get_359 = _ownedPortConnections_50.get(50);
              final Procedure1<PortConnection> _function_359 = new Procedure1<PortConnection>() {
                public void apply(final PortConnection it) {
                  String _name = it.getName();
                  Assert.assertEquals("portconn51", _name);
                  ConnectedElement _source = it.getSource();
                  Aadl2JavaValidatorTest.assertError(_source, allIssues, "A \'bus subcomponent\' in an \'abstract subcomponent\' is not a valid port connection end.");
                  ConnectedElement _destination = it.getDestination();
                  Aadl2JavaValidatorTest.assertNoIssues(_destination, allIssues);
                }
              };
              ObjectExtensions.<PortConnection>operator_doubleArrow(_get_359, _function_359);
              EList<PortConnection> _ownedPortConnections_51 = it.getOwnedPortConnections();
              PortConnection _get_360 = _ownedPortConnections_51.get(51);
              final Procedure1<PortConnection> _function_360 = new Procedure1<PortConnection>() {
                public void apply(final PortConnection it) {
                  String _name = it.getName();
                  Assert.assertEquals("portconn52", _name);
                  ConnectedElement _source = it.getSource();
                  Aadl2JavaValidatorTest.assertError(_source, allIssues, "A \'data subcomponent\' in an \'abstract subcomponent\' is not a valid port connection end.");
                  ConnectedElement _destination = it.getDestination();
                  Aadl2JavaValidatorTest.assertNoIssues(_destination, allIssues);
                }
              };
              ObjectExtensions.<PortConnection>operator_doubleArrow(_get_360, _function_360);
              EList<PortConnection> _ownedPortConnections_52 = it.getOwnedPortConnections();
              PortConnection _get_361 = _ownedPortConnections_52.get(52);
              final Procedure1<PortConnection> _function_361 = new Procedure1<PortConnection>() {
                public void apply(final PortConnection it) {
                  String _name = it.getName();
                  Assert.assertEquals("portconn53", _name);
                  ConnectedElement _source = it.getSource();
                  Aadl2JavaValidatorTest.assertError(_source, allIssues, "A \'subprogram group subcomponent\' in an \'abstract subcomponent\' is not a valid port connection end.");
                  ConnectedElement _destination = it.getDestination();
                  Aadl2JavaValidatorTest.assertNoIssues(_destination, allIssues);
                }
              };
              ObjectExtensions.<PortConnection>operator_doubleArrow(_get_361, _function_361);
              EList<PortConnection> _ownedPortConnections_53 = it.getOwnedPortConnections();
              PortConnection _get_362 = _ownedPortConnections_53.get(53);
              final Procedure1<PortConnection> _function_362 = new Procedure1<PortConnection>() {
                public void apply(final PortConnection it) {
                  String _name = it.getName();
                  Assert.assertEquals("portconn54", _name);
                  ConnectedElement _source = it.getSource();
                  Aadl2JavaValidatorTest.assertError(_source, allIssues, "A \'subprogram subcomponent\' in an \'abstract subcomponent\' is not a valid port connection end.");
                  ConnectedElement _destination = it.getDestination();
                  Aadl2JavaValidatorTest.assertNoIssues(_destination, allIssues);
                }
              };
              ObjectExtensions.<PortConnection>operator_doubleArrow(_get_362, _function_362);
              EList<PortConnection> _ownedPortConnections_54 = it.getOwnedPortConnections();
              PortConnection _get_363 = _ownedPortConnections_54.get(54);
              final Procedure1<PortConnection> _function_363 = new Procedure1<PortConnection>() {
                public void apply(final PortConnection it) {
                  String _name = it.getName();
                  Assert.assertEquals("portconn55", _name);
                  ConnectedElement _source = it.getSource();
                  Aadl2JavaValidatorTest.assertError(_source, allIssues, "A \'subprogram proxy\' in an \'abstract subcomponent\' is not a valid port connection end.");
                  ConnectedElement _destination = it.getDestination();
                  Aadl2JavaValidatorTest.assertNoIssues(_destination, allIssues);
                }
              };
              ObjectExtensions.<PortConnection>operator_doubleArrow(_get_363, _function_363);
              EList<PortConnection> _ownedPortConnections_55 = it.getOwnedPortConnections();
              PortConnection _get_364 = _ownedPortConnections_55.get(55);
              final Procedure1<PortConnection> _function_364 = new Procedure1<PortConnection>() {
                public void apply(final PortConnection it) {
                  String _name = it.getName();
                  Assert.assertEquals("portconn56", _name);
                  ConnectedElement _source = it.getSource();
                  Aadl2JavaValidatorTest.assertError(_source, allIssues, "A \'port proxy\' in an \'abstract subcomponent\' is not a valid port connection end.");
                  ConnectedElement _destination = it.getDestination();
                  Aadl2JavaValidatorTest.assertNoIssues(_destination, allIssues);
                }
              };
              ObjectExtensions.<PortConnection>operator_doubleArrow(_get_364, _function_364);
              EList<PortConnection> _ownedPortConnections_56 = it.getOwnedPortConnections();
              PortConnection _get_365 = _ownedPortConnections_56.get(56);
              final Procedure1<PortConnection> _function_365 = new Procedure1<PortConnection>() {
                public void apply(final PortConnection it) {
                  String _name = it.getName();
                  Assert.assertEquals("portconn57", _name);
                  ConnectedElement _source = it.getSource();
                  Aadl2JavaValidatorTest.assertError(_source, allIssues, "An \'event data source\' in an \'abstract subcomponent\' is not a valid port connection end.");
                  ConnectedElement _destination = it.getDestination();
                  Aadl2JavaValidatorTest.assertNoIssues(_destination, allIssues);
                }
              };
              ObjectExtensions.<PortConnection>operator_doubleArrow(_get_365, _function_365);
              EList<PortConnection> _ownedPortConnections_57 = it.getOwnedPortConnections();
              PortConnection _get_366 = _ownedPortConnections_57.get(57);
              final Procedure1<PortConnection> _function_366 = new Procedure1<PortConnection>() {
                public void apply(final PortConnection it) {
                  String _name = it.getName();
                  Assert.assertEquals("portconn58", _name);
                  ConnectedElement _source = it.getSource();
                  Aadl2JavaValidatorTest.assertError(_source, allIssues, "An \'abstract feature\' in an \'abstract subcomponent\' is not a valid port connection end.");
                  ConnectedElement _destination = it.getDestination();
                  Aadl2JavaValidatorTest.assertNoIssues(_destination, allIssues);
                }
              };
              ObjectExtensions.<PortConnection>operator_doubleArrow(_get_366, _function_366);
              EList<PortConnection> _ownedPortConnections_58 = it.getOwnedPortConnections();
              PortConnection _get_367 = _ownedPortConnections_58.get(58);
              final Procedure1<PortConnection> _function_367 = new Procedure1<PortConnection>() {
                public void apply(final PortConnection it) {
                  String _name = it.getName();
                  Assert.assertEquals("portconn59", _name);
                  ConnectedElement _source = it.getSource();
                  Aadl2JavaValidatorTest.assertError(_source, allIssues, "A \'feature group\' in an \'abstract subcomponent\' is not a valid port connection end.");
                  ConnectedElement _destination = it.getDestination();
                  Aadl2JavaValidatorTest.assertNoIssues(_destination, allIssues);
                }
              };
              ObjectExtensions.<PortConnection>operator_doubleArrow(_get_367, _function_367);
              EList<PortConnection> _ownedPortConnections_59 = it.getOwnedPortConnections();
              PortConnection _get_368 = _ownedPortConnections_59.get(59);
              final Procedure1<PortConnection> _function_368 = new Procedure1<PortConnection>() {
                public void apply(final PortConnection it) {
                  String _name = it.getName();
                  Assert.assertEquals("portconn60", _name);
                  ConnectedElement _source = it.getSource();
                  Aadl2JavaValidatorTest.assertError(_source, allIssues, "A \'parameter\' in a \'subprogram subcomponent\' is not a valid port connection end.");
                  ConnectedElement _destination = it.getDestination();
                  Aadl2JavaValidatorTest.assertNoIssues(_destination, allIssues);
                }
              };
              ObjectExtensions.<PortConnection>operator_doubleArrow(_get_368, _function_368);
              EList<PortConnection> _ownedPortConnections_60 = it.getOwnedPortConnections();
              PortConnection _get_369 = _ownedPortConnections_60.get(60);
              final Procedure1<PortConnection> _function_369 = new Procedure1<PortConnection>() {
                public void apply(final PortConnection it) {
                  String _name = it.getName();
                  Assert.assertEquals("portconn61", _name);
                  ConnectedElement _source = it.getSource();
                  Aadl2JavaValidatorTest.assertError(_source, allIssues, "A \'bus access\' in an \'abstract subcomponent\' is not a valid port connection end.");
                  ConnectedElement _destination = it.getDestination();
                  Aadl2JavaValidatorTest.assertNoIssues(_destination, allIssues);
                }
              };
              ObjectExtensions.<PortConnection>operator_doubleArrow(_get_369, _function_369);
              EList<PortConnection> _ownedPortConnections_61 = it.getOwnedPortConnections();
              PortConnection _get_370 = _ownedPortConnections_61.get(61);
              final Procedure1<PortConnection> _function_370 = new Procedure1<PortConnection>() {
                public void apply(final PortConnection it) {
                  String _name = it.getName();
                  Assert.assertEquals("portconn62", _name);
                  ConnectedElement _source = it.getSource();
                  Aadl2JavaValidatorTest.assertNoIssues(_source, allIssues);
                  ConnectedElement _destination = it.getDestination();
                  Aadl2JavaValidatorTest.assertNoIssues(_destination, allIssues);
              ...
              ObjectExtensions.<PortConnection>operator_doubleArrow(_get_370, _function_370);
              EList<PortConnection> _ownedPortConnections_62 = it.getOwnedPortConnections();
              PortConnection _get_371 = _ownedPortConnections_62.get(62);
              final Procedure1<PortConnection> _function_371 = new Procedure1<PortConnection>() {
                public void apply(final PortConnection it) {
                  String _name = it.getName();
                  Assert.assertEquals("portconn63", _name);
                  ConnectedElement _source = it.getSource();
                  Aadl2JavaValidatorTest.assertNoIssues(_source, allIssues);
                  ConnectedElement _destination = it.getDestination();
                  Aadl2JavaValidatorTest.assertNoIssues(_destination, allIssues);
              ...
              ObjectExtensions.<PortConnection>operator_doubleArrow(_get_371, _function_371);
              EList<PortConnection> _ownedPortConnections_63 = it.getOwnedPortConnections();
              PortConnection _get_372 = _ownedPortConnections_63.get(63);
              final Procedure1<PortConnection> _function_372 = new Procedure1<PortConnection>() {
                public void apply(final PortConnection it) {
                  String _name = it.getName();
                  Assert.assertEquals("portconn64", _name);
                  ConnectedElement _source = it.getSource();
                  Aadl2JavaValidatorTest.assertNoIssues(_source, allIssues);
                  ConnectedElement _destination = it.getDestination();
                  Aadl2JavaValidatorTest.assertNoIssues(_destination, allIssues);
              ...
              ObjectExtensions.<PortConnection>operator_doubleArrow(_get_372, _function_372);
              EList<PortConnection> _ownedPortConnections_64 = it.getOwnedPortConnections();
              PortConnection _get_373 = _ownedPortConnections_64.get(64);
              final Procedure1<PortConnection> _function_373 = new Procedure1<PortConnection>() {
                public void apply(final PortConnection it) {
                  String _name = it.getName();
                  Assert.assertEquals("portconn65", _name);
                  ConnectedElement _source = it.getSource();
                  Aadl2JavaValidatorTest.assertNoIssues(_source, allIssues);
                  ConnectedElement _destination = it.getDestination();
                  Aadl2JavaValidatorTest.assertNoIssues(_destination, allIssues);
              ...
              ObjectExtensions.<PortConnection>operator_doubleArrow(_get_373, _function_373);
              EList<PortConnection> _ownedPortConnections_65 = it.getOwnedPortConnections();
              PortConnection _get_374 = _ownedPortConnections_65.get(65);
              final Procedure1<PortConnection> _function_374 = new Procedure1<PortConnection>() {
                public void apply(final PortConnection it) {
                  String _name = it.getName();
                  Assert.assertEquals("portconn66", _name);
                  ConnectedElement _source = it.getSource();
                  Aadl2JavaValidatorTest.assertError(_source, allIssues, "A \'bus subcomponent\' in a \'data subcomponent\' is not a valid port connection end.");
                  ConnectedElement _destination = it.getDestination();
                  Aadl2JavaValidatorTest.assertNoIssues(_destination, allIssues);
                }
              };
              ObjectExtensions.<PortConnection>operator_doubleArrow(_get_374, _function_374);
              EList<PortConnection> _ownedPortConnections_66 = it.getOwnedPortConnections();
              PortConnection _get_375 = _ownedPortConnections_66.get(66);
              final Procedure1<PortConnection> _function_375 = new Procedure1<PortConnection>() {
                public void apply(final PortConnection it) {
                  String _name = it.getName();
                  Assert.assertEquals("portconn67", _name);
                  ConnectedElement _source = it.getSource();
                  Aadl2JavaValidatorTest.assertNoIssues(_source, allIssues);
                  ConnectedElement _destination = it.getDestination();
                  Aadl2JavaValidatorTest.assertNoIssues(_destination, allIssues);
              ...
              ObjectExtensions.<PortConnection>operator_doubleArrow(_get_375, _function_375);
              EList<PortConnection> _ownedPortConnections_67 = it.getOwnedPortConnections();
              PortConnection _get_376 = _ownedPortConnections_67.get(67);
              final Procedure1<PortConnection> _function_376 = new Procedure1<PortConnection>() {
                public void apply(final PortConnection it) {
                  String _name = it.getName();
                  Assert.assertEquals("portconn68", _name);
                  ConnectedElement _source = it.getSource();
                  Aadl2JavaValidatorTest.assertError(_source, allIssues, "A \'subprogram group subcomponent\' in a \'data subcomponent\' is not a valid port connection end.");
                  ConnectedElement _destination = it.getDestination();
                  Aadl2JavaValidatorTest.assertNoIssues(_destination, allIssues);
                }
              };
              ObjectExtensions.<PortConnection>operator_doubleArrow(_get_376, _function_376);
              EList<PortConnection> _ownedPortConnections_68 = it.getOwnedPortConnections();
              PortConnection _get_377 = _ownedPortConnections_68.get(68);
              final Procedure1<PortConnection> _function_377 = new Procedure1<PortConnection>() {
                public void apply(final PortConnection it) {
                  String _name = it.getName();
                  Assert.assertEquals("portconn69", _name);
                  ConnectedElement _source = it.getSource();
                  Aadl2JavaValidatorTest.assertError(_source, allIssues, "A \'subprogram subcomponent\' in a \'data subcomponent\' is not a valid port connection end.");
                  ConnectedElement _destination = it.getDestination();
                  Aadl2JavaValidatorTest.assertNoIssues(_destination, allIssues);
                }
              };
              ObjectExtensions.<PortConnection>operator_doubleArrow(_get_377, _function_377);
              EList<PortConnection> _ownedPortConnections_69 = it.getOwnedPortConnections();
              PortConnection _get_378 = _ownedPortConnections_69.get(69);
              final Procedure1<PortConnection> _function_378 = new Procedure1<PortConnection>() {
                public void apply(final PortConnection it) {
                  String _name = it.getName();
                  Assert.assertEquals("portconn70", _name);
                  ConnectedElement _source = it.getSource();
                  Aadl2JavaValidatorTest.assertError(_source, allIssues, "A \'subprogram proxy\' in a \'data subcomponent\' is not a valid port connection end.");
                  ConnectedElement _destination = it.getDestination();
                  Aadl2JavaValidatorTest.assertNoIssues(_destination, allIssues);
                }
              };
              ObjectExtensions.<PortConnection>operator_doubleArrow(_get_378, _function_378);
              EList<PortConnection> _ownedPortConnections_70 = it.getOwnedPortConnections();
              PortConnection _get_379 = _ownedPortConnections_70.get(70);
              final Procedure1<PortConnection> _function_379 = new Procedure1<PortConnection>() {
                public void apply(final PortConnection it) {
                  String _name = it.getName();
                  Assert.assertEquals("portconn71", _name);
                  ConnectedElement _source = it.getSource();
                  Aadl2JavaValidatorTest.assertError(_source, allIssues, "A \'port proxy\' in a \'data subcomponent\' is not a valid port connection end.");
                  ConnectedElement _destination = it.getDestination();
                  Aadl2JavaValidatorTest.assertNoIssues(_destination, allIssues);
                }
              };
              ObjectExtensions.<PortConnection>operator_doubleArrow(_get_379, _function_379);
              EList<PortConnection> _ownedPortConnections_71 = it.getOwnedPortConnections();
              PortConnection _get_380 = _ownedPortConnections_71.get(71);
              final Procedure1<PortConnection> _function_380 = new Procedure1<PortConnection>() {
                public void apply(final PortConnection it) {
                  String _name = it.getName();
                  Assert.assertEquals("portconn72", _name);
                  ConnectedElement _source = it.getSource();
                  Aadl2JavaValidatorTest.assertError(_source, allIssues, "An \'event data source\' in a \'data subcomponent\' is not a valid port connection end.");
                  ConnectedElement _destination = it.getDestination();
                  Aadl2JavaValidatorTest.assertNoIssues(_destination, allIssues);
                }
              };
              ObjectExtensions.<PortConnection>operator_doubleArrow(_get_380, _function_380);
              EList<PortConnection> _ownedPortConnections_72 = it.getOwnedPortConnections();
              PortConnection _get_381 = _ownedPortConnections_72.get(72);
              final Procedure1<PortConnection> _function_381 = new Procedure1<PortConnection>() {
                public void apply(final PortConnection it) {
                  String _name = it.getName();
                  Assert.assertEquals("portconn73", _name);
                  ConnectedElement _source = it.getSource();
                  Aadl2JavaValidatorTest.assertError(_source, allIssues, "An \'abstract feature\' in a \'data subcomponent\' is not a valid port connection end.");
                  ConnectedElement _destination = it.getDestination();
                  Aadl2JavaValidatorTest.assertNoIssues(_destination, allIssues);
                }
              };
              ObjectExtensions.<PortConnection>operator_doubleArrow(_get_381, _function_381);
              EList<PortConnection> _ownedPortConnections_73 = it.getOwnedPortConnections();
              PortConnection _get_382 = _ownedPortConnections_73.get(73);
              final Procedure1<PortConnection> _function_382 = new Procedure1<PortConnection>() {
                public void apply(final PortConnection it) {
                  String _name = it.getName();
                  Assert.assertEquals("portconn74", _name);
                  ConnectedElement _source = it.getSource();
                  Aadl2JavaValidatorTest.assertError(_source, allIssues, "A \'feature group\' in a \'data subcomponent\' is not a valid port connection end.");
                  ConnectedElement _destination = it.getDestination();
                  Aadl2JavaValidatorTest.assertNoIssues(_destination, allIssues);
                }
              };
              ObjectExtensions.<PortConnection>operator_doubleArrow(_get_382, _function_382);
              EList<PortConnection> _ownedPortConnections_74 = it.getOwnedPortConnections();
              PortConnection _get_383 = _ownedPortConnections_74.get(74);
              final Procedure1<PortConnection> _function_383 = new Procedure1<PortConnection>() {
                public void apply(final PortConnection it) {
                  String _name = it.getName();
                  Assert.assertEquals("portconn75", _name);
                  ConnectedElement _source = it.getSource();
                  Aadl2JavaValidatorTest.assertError(_source, allIssues, "A \'bus access\' in a \'data subcomponent\' is not a valid port connection end.");
                  ConnectedElement _destination = it.getDestination();
                  Aadl2JavaValidatorTest.assertNoIssues(_destination, allIssues);
                }
              };
              ObjectExtensions.<PortConnection>operator_doubleArrow(_get_383, _function_383);
              EList<PortConnection> _ownedPortConnections_75 = it.getOwnedPortConnections();
              PortConnection _get_384 = _ownedPortConnections_75.get(75);
              final Procedure1<PortConnection> _function_384 = new Procedure1<PortConnection>() {
                public void apply(final PortConnection it) {
                  String _name = it.getName();
                  Assert.assertEquals("portconn76", _name);
                  ConnectedElement _source = it.getSource();
                  Aadl2JavaValidatorTest.assertNoIssues(_source, allIssues);
                  ConnectedElement _destination = it.getDestination();
                  Aadl2JavaValidatorTest.assertNoIssues(_destination, allIssues);
              ...
              ObjectExtensions.<PortConnection>operator_doubleArrow(_get_384, _function_384);
              EList<PortConnection> _ownedPortConnections_76 = it.getOwnedPortConnections();
              PortConnection _get_385 = _ownedPortConnections_76.get(76);
              final Procedure1<PortConnection> _function_385 = new Procedure1<PortConnection>() {
                public void apply(final PortConnection it) {
                  String _name = it.getName();
                  Assert.assertEquals("portconn77", _name);
                  ConnectedElement _source = it.getSource();
                  Aadl2JavaValidatorTest.assertNoIssues(_source, allIssues);
                  ConnectedElement _destination = it.getDestination();
                  Aadl2JavaValidatorTest.assertNoIssues(_destination, allIssues);
              ...
              ObjectExtensions.<PortConnection>operator_doubleArrow(_get_385, _function_385);
              EList<PortConnection> _ownedPortConnections_77 = it.getOwnedPortConnections();
              PortConnection _get_386 = _ownedPortConnections_77.get(77);
              final Procedure1<PortConnection> _function_386 = new Procedure1<PortConnection>() {
                public void apply(final PortConnection it) {
                  String _name = it.getName();
                  Assert.assertEquals("portconn78", _name);
                  ConnectedElement _source = it.getSource();
                  Aadl2JavaValidatorTest.assertNoIssues(_source, allIssues);
                  ConnectedElement _destination = it.getDestination();
                  Aadl2JavaValidatorTest.assertNoIssues(_destination, allIssues);
              ...
              ObjectExtensions.<PortConnection>operator_doubleArrow(_get_386, _function_386);
              EList<PortConnection> _ownedPortConnections_78 = it.getOwnedPortConnections();
              PortConnection _get_387 = _ownedPortConnections_78.get(78);
              final Procedure1<PortConnection> _function_387 = new Procedure1<PortConnection>() {
                public void apply(final PortConnection it) {
                  String _name = it.getName();
                  Assert.assertEquals("portconn79", _name);
                  ConnectedElement _source = it.getSource();
                  Aadl2JavaValidatorTest.assertNoIssues(_source, allIssues);
                  ConnectedElement _destination = it.getDestination();
                  Aadl2JavaValidatorTest.assertNoIssues(_destination, allIssues);
              ...
              ObjectExtensions.<PortConnection>operator_doubleArrow(_get_387, _function_387);
              EList<PortConnection> _ownedPortConnections_79 = it.getOwnedPortConnections();
              PortConnection _get_388 = _ownedPortConnections_79.get(79);
              final Procedure1<PortConnection> _function_388 = new Procedure1<PortConnection>() {
                public void apply(final PortConnection it) {
                  String _name = it.getName();
                  Assert.assertEquals("portconn80", _name);
                  ConnectedElement _source = it.getSource();
                  Aadl2JavaValidatorTest.assertNoIssues(_source, allIssues);
                  ConnectedElement _destination = it.getDestination();
                  Aadl2JavaValidatorTest.assertNoIssues(_destination, allIssues);
              ...
              ObjectExtensions.<PortConnection>operator_doubleArrow(_get_388, _function_388);
              EList<PortConnection> _ownedPortConnections_80 = it.getOwnedPortConnections();
              PortConnection _get_389 = _ownedPortConnections_80.get(80);
              final Procedure1<PortConnection> _function_389 = new Procedure1<PortConnection>() {
                public void apply(final PortConnection it) {
                  String _name = it.getName();
                  Assert.assertEquals("portconn81", _name);
                  ConnectedElement _source = it.getSource();
                  Aadl2JavaValidatorTest.assertError(_source, allIssues, "A \'subprogram subcomponent\' in a \'subprogram call\' is not a valid port connection end.");
                  ConnectedElement _destination = it.getDestination();
                  Aadl2JavaValidatorTest.assertNoIssues(_destination, allIssues);
                }
              };
              ObjectExtensions.<PortConnection>operator_doubleArrow(_get_389, _function_389);
              EList<PortConnection> _ownedPortConnections_81 = it.getOwnedPortConnections();
              PortConnection _get_390 = _ownedPortConnections_81.get(81);
              final Procedure1<PortConnection> _function_390 = new Procedure1<PortConnection>() {
                public void apply(final PortConnection it) {
                  String _name = it.getName();
                  Assert.assertEquals("portconn82", _name);
                  ConnectedElement _source = it.getSource();
                  Aadl2JavaValidatorTest.assertError(_source, allIssues, "A \'subprogram proxy\' in a \'subprogram call\' is not a valid port connection end.");
                  ConnectedElement _destination = it.getDestination();
                  Aadl2JavaValidatorTest.assertNoIssues(_destination, allIssues);
                }
              };
              ObjectExtensions.<PortConnection>operator_doubleArrow(_get_390, _function_390);
              EList<PortConnection> _ownedPortConnections_82 = it.getOwnedPortConnections();
              PortConnection _get_391 = _ownedPortConnections_82.get(82);
              final Procedure1<PortConnection> _function_391 = new Procedure1<PortConnection>() {
                public void apply(final PortConnection it) {
                  String _name = it.getName();
                  Assert.assertEquals("portconn83", _name);
                  ConnectedElement _source = it.getSource();
                  Aadl2JavaValidatorTest.assertError(_source, allIssues, "A \'port proxy\' in a \'subprogram call\' is not a valid port connection end.");
                  ConnectedElement _destination = it.getDestination();
                  Aadl2JavaValidatorTest.assertNoIssues(_destination, allIssues);
                }
              };
              ObjectExtensions.<PortConnection>operator_doubleArrow(_get_391, _function_391);
              EList<PortConnection> _ownedPortConnections_83 = it.getOwnedPortConnections();
              PortConnection _get_392 = _ownedPortConnections_83.get(83);
              final Procedure1<PortConnection> _function_392 = new Procedure1<PortConnection>() {
                public void apply(final PortConnection it) {
                  String _name = it.getName();
                  Assert.assertEquals("portconn84", _name);
                  ConnectedElement _source = it.getSource();
                  Aadl2JavaValidatorTest.assertError(_source, allIssues, "An \'event data source\' in a \'subprogram call\' is not a valid port connection end.");
                  ConnectedElement _destination = it.getDestination();
                  Aadl2JavaValidatorTest.assertNoIssues(_destination, allIssues);
                }
              };
              ObjectExtensions.<PortConnection>operator_doubleArrow(_get_392, _function_392);
              EList<PortConnection> _ownedPortConnections_84 = it.getOwnedPortConnections();
              PortConnection _get_393 = _ownedPortConnections_84.get(84);
              final Procedure1<PortConnection> _function_393 = new Procedure1<PortConnection>() {
                public void apply(final PortConnection it) {
                  String _name = it.getName();
                  Assert.assertEquals("portconn85", _name);
                  ConnectedElement _source = it.getSource();
                  Aadl2JavaValidatorTest.assertError(_source, allIssues, "An \'abstract feature\' in a \'subprogram call\' is not a valid port connection end.");
                  ConnectedElement _destination = it.getDestination();
                  Aadl2JavaValidatorTest.assertNoIssues(_destination, allIssues);
                }
              };
              ObjectExtensions.<PortConnection>operator_doubleArrow(_get_393, _function_393);
              EList<PortConnection> _ownedPortConnections_85 = it.getOwnedPortConnections();
              PortConnection _get_394 = _ownedPortConnections_85.get(85);
              final Procedure1<PortConnection> _function_394 = new Procedure1<PortConnection>() {
                public void apply(final PortConnection it) {
                  String _name = it.getName();
                  Assert.assertEquals("portconn86", _name);
                  ConnectedElement _source = it.getSource();
                  Aadl2JavaValidatorTest.assertError(_source, allIssues, "A \'feature group\' in a \'subprogram call\' is not a valid port connection end.");
                  ConnectedElement _destination = it.getDestination();
                  Aadl2JavaValidatorTest.assertNoIssues(_destination, allIssues);
                }
              };
              ObjectExtensions.<PortConnection>operator_doubleArrow(_get_394, _function_394);
              EList<PortConnection> _ownedPortConnections_86 = it.getOwnedPortConnections();
              PortConnection _get_395 = _ownedPortConnections_86.get(86);
              final Procedure1<PortConnection> _function_395 = new Procedure1<PortConnection>() {
                public void apply(final PortConnection it) {
                  String _name = it.getName();
                  Assert.assertEquals("portconn87", _name);
                  ConnectedElement _source = it.getSource();
                  Aadl2JavaValidatorTest.assertError(_source, allIssues, "A \'parameter\' in a \'subprogram call\' is not a valid port connection end.");
                  ConnectedElement _destination = it.getDestination();
                  Aadl2JavaValidatorTest.assertNoIssues(_destination, allIssues);
                }
              };
              ObjectExtensions.<PortConnection>operator_doubleArrow(_get_395, _function_395);
              EList<PortConnection> _ownedPortConnections_87 = it.getOwnedPortConnections();
              PortConnection _get_396 = _ownedPortConnections_87.get(87);
              final Procedure1<PortConnection> _function_396 = new Procedure1<PortConnection>() {
                public void apply(final PortConnection it) {
                  String _name = it.getName();
                  Assert.assertEquals("portconn88", _name);
                  ConnectedElement _source = it.getSource();
                  Aadl2JavaValidatorTest.assertError(_source, allIssues, "A \'subprogram access\' in a \'subprogram call\' is not a valid port connection end.");
                  ConnectedElement _destination = it.getDestination();
                  Aadl2JavaValidatorTest.assertNoIssues(_destination, allIssues);
                }
              };
              ObjectExtensions.<PortConnection>operator_doubleArrow(_get_396, _function_396);
              EList<PortConnection> _ownedPortConnections_88 = it.getOwnedPortConnections();
              PortConnection _get_397 = _ownedPortConnections_88.get(88);
              final Procedure1<PortConnection> _function_397 = new Procedure1<PortConnection>() {
                public void apply(final PortConnection it) {
                  String _name = it.getName();
                  Assert.assertEquals("portconn89", _name);
                  ConnectedElement _source = it.getSource();
                  Aadl2JavaValidatorTest.assertNoIssues(_source, allIssues);
                  ConnectedElement _destination = it.getDestination();
                  Aadl2JavaValidatorTest.assertNoIssues(_destination, allIssues);
              ...
              ObjectExtensions.<PortConnection>operator_doubleArrow(_get_397, _function_397);
              EList<PortConnection> _ownedPortConnections_89 = it.getOwnedPortConnections();
              PortConnection _get_398 = _ownedPortConnections_89.get(89);
              final Procedure1<PortConnection> _function_398 = new Procedure1<PortConnection>() {
                public void apply(final PortConnection it) {
                  String _name = it.getName();
                  Assert.assertEquals("portconn90", _name);
                  ConnectedElement _source = it.getSource();
                  Aadl2JavaValidatorTest.assertNoIssues(_source, allIssues);
                  ConnectedElement _destination = it.getDestination();
                  Aadl2JavaValidatorTest.assertNoIssues(_destination, allIssues);
              ...
              ObjectExtensions.<PortConnection>operator_doubleArrow(_get_398, _function_398);
              EList<PortConnection> _ownedPortConnections_90 = it.getOwnedPortConnections();
              PortConnection _get_399 = _ownedPortConnections_90.get(90);
              final Procedure1<PortConnection> _function_399 = new Procedure1<PortConnection>() {
                public void apply(final PortConnection it) {
                  String _name = it.getName();
                  Assert.assertEquals("portconn91", _name);
                  ConnectedElement _source = it.getSource();
                  Aadl2JavaValidatorTest.assertNoIssues(_source, allIssues);
                  ConnectedElement _destination = it.getDestination();
                  Aadl2JavaValidatorTest.assertNoIssues(_destination, allIssues);
              ...
              ObjectExtensions.<PortConnection>operator_doubleArrow(_get_399, _function_399);
            }
          };
          ObjectExtensions.<AbstractImplementation>operator_doubleArrow(
            ((AbstractImplementation) _get), _function_1);
          ...
          Classifier _get_1 = _ownedClassifiers_1.get(3);
          final Procedure1<SubprogramImplementation> _function_2 = new Procedure1<SubprogramImplementation>() {
            public void apply(final SubprogramImplementation it) {
              ...
              final Procedure1<AccessConnection> _function = new Procedure1<AccessConnection>() {
                public void apply(final AccessConnection it) {
                  ...
                  ConnectedElement _source = it.getSource();
                  Aadl2JavaValidatorTest.assertError(_source, allIssues, "A \'parameter\' is not a valid access connection end.");
                  ConnectedElement _destination = it.getDestination();
                  Aadl2JavaValidatorTest.assertNoIssues(_destination, allIssues);
                }
              };
              ...
              final Procedure1<AccessConnection> _function_1 = new Procedure1<AccessConnection>() {
                public void apply(final AccessConnection it) {
                  ...
                  ConnectedElement _source = it.getSource();
                  Aadl2JavaValidatorTest.assertError(_source, allIssues, "Anything in a \'parameter\' is not a valid access connection end.");
                  ConnectedElement _destination = it.getDestination();
                  Aadl2JavaValidatorTest.assertNoIssues(_destination, allIssues);
                }
              };
              ...
              ObjectExtensions.<AccessConnection>operator_doubleArrow(_get_14, _function_14);
              EList<FeatureConnection> _ownedFeatureConnections = it.getOwnedFeatureConnections();
              FeatureConnection _get_15 = _ownedFeatureConnections.get(0);
              final Procedure1<FeatureConnection> _function_15 = new Procedure1<FeatureConnection>() {
                public void apply(final FeatureConnection it) {
                  String _name = it.getName();
                  Assert.assertEquals("fconn78", _name);
                  ConnectedElement _source = it.getSource();
                  Aadl2JavaValidatorTest.assertNoIssues(_source, allIssues);
                  ConnectedElement _destination = it.getDestination();
                  Aadl2JavaValidatorTest.assertNoIssues(_destination, allIssues);
              ...
              EList<FeatureConnection> _ownedFeatureConnections_1 = it.getOwnedFeatureConnections();
              FeatureConnection _get_16 = _ownedFeatureConnections_1.get(1);
              final Procedure1<FeatureConnection> _function_16 = new Procedure1<FeatureConnection>() {
                public void apply(final FeatureConnection it) {
                  String _name = it.getName();
                  Assert.assertEquals("fconn79", _name);
                  ConnectedElement _source = it.getSource();
                  Aadl2JavaValidatorTest.assertError(_source, allIssues, "Anything in a \'parameter\' is not a valid feature connection end.");
                  ConnectedElement _destination = it.getDestination();
                  Aadl2JavaValidatorTest.assertNoIssues(_destination, allIssues);
                }
              };
              ...
              EList<FeatureConnection> _ownedFeatureConnections_2 = it.getOwnedFeatureConnections();
              FeatureConnection _get_17 = _ownedFeatureConnections_2.get(2);
              ...
              EList<FeatureConnection> _ownedFeatureConnections_3 = it.getOwnedFeatureConnections();
              FeatureConnection _get_18 = _ownedFeatureConnections_3.get(3);
              ...
              EList<FeatureConnection> _ownedFeatureConnections_4 = it.getOwnedFeatureConnections();
              FeatureConnection _get_19 = _ownedFeatureConnections_4.get(4);
              ...
              EList<FeatureConnection> _ownedFeatureConnections_5 = it.getOwnedFeatureConnections();
              FeatureConnection _get_20 = _ownedFeatureConnections_5.get(5);
              ...
              EList<FeatureConnection> _ownedFeatureConnections_6 = it.getOwnedFeatureConnections();
              FeatureConnection _get_21 = _ownedFeatureConnections_6.get(6);
              ...
              EList<FeatureConnection> _ownedFeatureConnections_7 = it.getOwnedFeatureConnections();
              FeatureConnection _get_22 = _ownedFeatureConnections_7.get(7);
              ...
              EList<FeatureConnection> _ownedFeatureConnections_8 = it.getOwnedFeatureConnections();
              FeatureConnection _get_23 = _ownedFeatureConnections_8.get(8);
              ...
              EList<FeatureConnection> _ownedFeatureConnections_9 = it.getOwnedFeatureConnections();
              FeatureConnection _get_24 = _ownedFeatureConnections_9.get(9);
              ...
              EList<FeatureConnection> _ownedFeatureConnections_10 = it.getOwnedFeatureConnections();
              FeatureConnection _get_25 = _ownedFeatureConnections_10.get(10);
              ...
              EList<FeatureConnection> _ownedFeatureConnections_11 = it.getOwnedFeatureConnections();
              FeatureConnection _get_26 = _ownedFeatureConnections_11.get(11);
              ...
              EList<FeatureConnection> _ownedFeatureConnections_12 = it.getOwnedFeatureConnections();
              FeatureConnection _get_27 = _ownedFeatureConnections_12.get(12);
              ...
              EList<FeatureConnection> _ownedFeatureConnections_13 = it.getOwnedFeatureConnections();
              FeatureConnection _get_28 = _ownedFeatureConnections_13.get(13);
              ...
              EList<FeatureConnection> _ownedFeatureConnections_14 = it.getOwnedFeatureConnections();
              FeatureConnection _get_29 = _ownedFeatureConnections_14.get(14);
              final Procedure1<FeatureConnection> _function_29 = new Procedure1<FeatureConnection>() {
                public void apply(final FeatureConnection it) {
                  String _name = it.getName();
              ...
              ObjectExtensions.<FeatureConnection>operator_doubleArrow(_get_29, _function_29);
              EList<FeatureGroupConnection> _ownedFeatureGroupConnections = it.getOwnedFeatureGroupConnections();
              FeatureGroupConnection _get_30 = _ownedFeatureGroupConnections.get(0);
              final Procedure1<FeatureGroupConnection> _function_30 = new Procedure1<FeatureGroupConnection>() {
                public void apply(final FeatureGroupConnection it) {
                  ...
                  ConnectedElement _source = it.getSource();
                  Aadl2JavaValidatorTest.assertError(_source, allIssues, "A \'parameter\' is not a valid feature group connection end.");
                  ConnectedElement _destination = it.getDestination();
                  Aadl2JavaValidatorTest.assertNoIssues(_destination, allIssues);
                }
              };
              ...
              EList<FeatureGroupConnection> _ownedFeatureGroupConnections_1 = it.getOwnedFeatureGroupConnections();
              FeatureGroupConnection _get_31 = _ownedFeatureGroupConnections_1.get(1);
              final Procedure1<FeatureGroupConnection> _function_31 = new Procedure1<FeatureGroupConnection>() {
                public void apply(final FeatureGroupConnection it) {
                  ...
                  ConnectedElement _source = it.getSource();
                  Aadl2JavaValidatorTest.assertError(_source, allIssues, "Anything in a \'parameter\' is not a valid feature group connection end.");
                  ConnectedElement _destination = it.getDestination();
                  Aadl2JavaValidatorTest.assertNoIssues(_destination, allIssues);
                }
              };
              ...
              EList<FeatureGroupConnection> _ownedFeatureGroupConnections_2 = it.getOwnedFeatureGroupConnections();
              FeatureGroupConnection _get_32 = _ownedFeatureGroupConnections_2.get(2);
              ...
              EList<FeatureGroupConnection> _ownedFeatureGroupConnections_3 = it.getOwnedFeatureGroupConnections();
              FeatureGroupConnection _get_33 = _ownedFeatureGroupConnections_3.get(3);
              ...
              EList<FeatureGroupConnection> _ownedFeatureGroupConnections_4 = it.getOwnedFeatureGroupConnections();
              FeatureGroupConnection _get_34 = _ownedFeatureGroupConnections_4.get(4);
              ...
              EList<FeatureGroupConnection> _ownedFeatureGroupConnections_5 = it.getOwnedFeatureGroupConnections();
              FeatureGroupConnection _get_35 = _ownedFeatureGroupConnections_5.get(5);
              ...
              EList<FeatureGroupConnection> _ownedFeatureGroupConnections_6 = it.getOwnedFeatureGroupConnections();
              FeatureGroupConnection _get_36 = _ownedFeatureGroupConnections_6.get(6);
              ...
              EList<FeatureGroupConnection> _ownedFeatureGroupConnections_7 = it.getOwnedFeatureGroupConnections();
              FeatureGroupConnection _get_37 = _ownedFeatureGroupConnections_7.get(7);
              ...
              EList<FeatureGroupConnection> _ownedFeatureGroupConnections_8 = it.getOwnedFeatureGroupConnections();
              FeatureGroupConnection _get_38 = _ownedFeatureGroupConnections_8.get(8);
              ...
              EList<FeatureGroupConnection> _ownedFeatureGroupConnections_9 = it.getOwnedFeatureGroupConnections();
              FeatureGroupConnection _get_39 = _ownedFeatureGroupConnections_9.get(9);
              ...
              EList<FeatureGroupConnection> _ownedFeatureGroupConnections_10 = it.getOwnedFeatureGroupConnections();
              FeatureGroupConnection _get_40 = _ownedFeatureGroupConnections_10.get(10);
              ...
              EList<FeatureGroupConnection> _ownedFeatureGroupConnections_11 = it.getOwnedFeatureGroupConnections();
              FeatureGroupConnection _get_41 = _ownedFeatureGroupConnections_11.get(11);
              ...
              EList<FeatureGroupConnection> _ownedFeatureGroupConnections_12 = it.getOwnedFeatureGroupConnections();
              FeatureGroupConnection _get_42 = _ownedFeatureGroupConnections_12.get(12);
              ...
              EList<FeatureGroupConnection> _ownedFeatureGroupConnections_13 = it.getOwnedFeatureGroupConnections();
              FeatureGroupConnection _get_43 = _ownedFeatureGroupConnections_13.get(13);
              ...
              EList<FeatureGroupConnection> _ownedFeatureGroupConnections_14 = it.getOwnedFeatureGroupConnections();
              FeatureGroupConnection _get_44 = _ownedFeatureGroupConnections_14.get(14);
              final Procedure1<FeatureGroupConnection> _function_44 = new Procedure1<FeatureGroupConnection>() {
                public void apply(final FeatureGroupConnection it) {
                  String _name = it.getName();
              ...
              ObjectExtensions.<FeatureGroupConnection>operator_doubleArrow(_get_44, _function_44);
              EList<ParameterConnection> _ownedParameterConnections = it.getOwnedParameterConnections();
              ParameterConnection _get_45 = _ownedParameterConnections.get(0);
              final Procedure1<ParameterConnection> _function_45 = new Procedure1<ParameterConnection>() {
                public void apply(final ParameterConnection it) {
                  String _name = it.getName();
                  Assert.assertEquals("paramconn78", _name);
                  ConnectedElement _source = it.getSource();
                  Aadl2JavaValidatorTest.assertNoIssues(_source, allIssues);
                  ConnectedElement _destination = it.getDestination();
                  Aadl2JavaValidatorTest.assertNoIssues(_destination, allIssues);
              ...
              EList<ParameterConnection> _ownedParameterConnections_1 = it.getOwnedParameterConnections();
              ParameterConnection _get_46 = _ownedParameterConnections_1.get(1);
              final Procedure1<ParameterConnection> _function_46 = new Procedure1<ParameterConnection>() {
                public void apply(final ParameterConnection it) {
                  ...
                  ConnectedElement _source = it.getSource();
                  Aadl2JavaValidatorTest.assertError(_source, allIssues, "A \'bus subcomponent\' in a \'parameter\' is not a valid parameter connection end.");
                  ConnectedElement _destination = it.getDestination();
                  Aadl2JavaValidatorTest.assertNoIssues(_destination, allIssues);
                }
              };
              ...
              EList<ParameterConnection> _ownedParameterConnections_2 = it.getOwnedParameterConnections();
              ParameterConnection _get_47 = _ownedParameterConnections_2.get(2);
              final Procedure1<ParameterConnection> _function_47 = new Procedure1<ParameterConnection>() {
                public void apply(final ParameterConnection it) {
                  String _name = it.getName();
                  Assert.assertEquals("paramconn80", _name);
                  ConnectedElement _source = it.getSource();
                  Aadl2JavaValidatorTest.assertNoIssues(_source, allIssues);
                  ConnectedElement _destination = it.getDestination();
                  Aadl2JavaValidatorTest.assertNoIssues(_destination, allIssues);
              ...
              EList<ParameterConnection> _ownedParameterConnections_3 = it.getOwnedParameterConnections();
              ParameterConnection _get_48 = _ownedParameterConnections_3.get(3);
              final Procedure1<ParameterConnection> _function_48 = new Procedure1<ParameterConnection>() {
                public void apply(final ParameterConnection it) {
                  ...
                  ConnectedElement _source = it.getSource();
                  Aadl2JavaValidatorTest.assertError(_source, allIssues, "A \'subprogram group subcomponent\' in a \'parameter\' is not a valid parameter connection end.");
                  ConnectedElement _destination = it.getDestination();
                  Aadl2JavaValidatorTest.assertNoIssues(_destination, allIssues);
                }
              };
              ...
              EList<ParameterConnection> _ownedParameterConnections_4 = it.getOwnedParameterConnections();
              ParameterConnection _get_49 = _ownedParameterConnections_4.get(4);
              final Procedure1<ParameterConnection> _function_49 = new Procedure1<ParameterConnection>() {
                public void apply(final ParameterConnection it) {
                  ...
                  ConnectedElement _source = it.getSource();
                  Aadl2JavaValidatorTest.assertError(_source, allIssues, "A \'subprogram subcomponent\' in a \'parameter\' is not a valid parameter connection end.");
                  ConnectedElement _destination = it.getDestination();
                  Aadl2JavaValidatorTest.assertNoIssues(_destination, allIssues);
                }
              };
              ...
              EList<ParameterConnection> _ownedParameterConnections_5 = it.getOwnedParameterConnections();
              ParameterConnection _get_50 = _ownedParameterConnections_5.get(5);
              final Procedure1<ParameterConnection> _function_50 = new Procedure1<ParameterConnection>() {
                public void apply(final ParameterConnection it) {
                  ...
                  ConnectedElement _source = it.getSource();
                  Aadl2JavaValidatorTest.assertError(_source, allIssues, "A \'subprogram proxy\' in a \'parameter\' is not a valid parameter connection end.");
                  ConnectedElement _destination = it.getDestination();
                  Aadl2JavaValidatorTest.assertNoIssues(_destination, allIssues);
                }
              };
              ...
              EList<ParameterConnection> _ownedParameterConnections_6 = it.getOwnedParameterConnections();
              ParameterConnection _get_51 = _ownedParameterConnections_6.get(6);
              final Procedure1<ParameterConnection> _function_51 = new Procedure1<ParameterConnection>() {
                public void apply(final ParameterConnection it) {
                  ...
                  ConnectedElement _source = it.getSource();
                  Aadl2JavaValidatorTest.assertError(_source, allIssues, "A \'port proxy\' in a \'parameter\' is not a valid parameter connection end.");
                  ConnectedElement _destination = it.getDestination();
                  Aadl2JavaValidatorTest.assertNoIssues(_destination, allIssues);
                }
              };
              ...
              EList<ParameterConnection> _ownedParameterConnections_7 = it.getOwnedParameterConnections();
              ParameterConnection _get_52 = _ownedParameterConnections_7.get(7);
              final Procedure1<ParameterConnection> _function_52 = new Procedure1<ParameterConnection>() {
                public void apply(final ParameterConnection it) {
                  ...
                  ConnectedElement _source = it.getSource();
                  Aadl2JavaValidatorTest.assertError(_source, allIssues, "An \'event data source\' in a \'parameter\' is not a valid parameter connection end.");
                  ConnectedElement _destination = it.getDestination();
                  Aadl2JavaValidatorTest.assertNoIssues(_destination, allIssues);
                }
              };
              ...
              EList<ParameterConnection> _ownedParameterConnections_8 = it.getOwnedParameterConnections();
              ParameterConnection _get_53 = _ownedParameterConnections_8.get(8);
              final Procedure1<ParameterConnection> _function_53 = new Procedure1<ParameterConnection>() {
                public void apply(final ParameterConnection it) {
                  ...
                  ConnectedElement _source = it.getSource();
                  Aadl2JavaValidatorTest.assertError(_source, allIssues, "An \'abstract feature\' in a \'parameter\' is not a valid parameter connection end.");
                  ConnectedElement _destination = it.getDestination();
                  Aadl2JavaValidatorTest.assertNoIssues(_destination, allIssues);
                }
              };
              ...
              EList<ParameterConnection> _ownedParameterConnections_9 = it.getOwnedParameterConnections();
              ParameterConnection _get_54 = _ownedParameterConnections_9.get(9);
              final Procedure1<ParameterConnection> _function_54 = new Procedure1<ParameterConnection>() {
                public void apply(final ParameterConnection it) {
                  ...
                  ConnectedElement _source = it.getSource();
                  Aadl2JavaValidatorTest.assertError(_source, allIssues, "A \'feature group\' in a \'parameter\' is not a valid parameter connection end.");
                  ConnectedElement _destination = it.getDestination();
                  Aadl2JavaValidatorTest.assertNoIssues(_destination, allIssues);
                }
              };
              ...
              EList<ParameterConnection> _ownedParameterConnections_10 = it.getOwnedParameterConnections();
              ParameterConnection _get_55 = _ownedParameterConnections_10.get(10);
              final Procedure1<ParameterConnection> _function_55 = new Procedure1<ParameterConnection>() {
                public void apply(final ParameterConnection it) {
                  ...
                  ConnectedElement _source = it.getSource();
                  Aadl2JavaValidatorTest.assertError(_source, allIssues, "A \'bus access\' in a \'parameter\' is not a valid parameter connection end.");
                  ConnectedElement _destination = it.getDestination();
                  Aadl2JavaValidatorTest.assertNoIssues(_destination, allIssues);
                }
              };
              ...
              EList<ParameterConnection> _ownedParameterConnections_11 = it.getOwnedParameterConnections();
              ParameterConnection _get_56 = _ownedParameterConnections_11.get(11);
              final Procedure1<ParameterConnection> _function_56 = new Procedure1<ParameterConnection>() {
                public void apply(final ParameterConnection it) {
                  ...
                  ConnectedElement _source = it.getSource();
                  Aadl2JavaValidatorTest.assertError(_source, allIssues, "A \'data access\' in a \'parameter\' is not a valid parameter connection end.");
                  ConnectedElement _destination = it.getDestination();
                  Aadl2JavaValidatorTest.assertNoIssues(_destination, allIssues);
                }
              };
              ...
              EList<ParameterConnection> _ownedParameterConnections_12 = it.getOwnedParameterConnections();
              ParameterConnection _get_57 = _ownedParameterConnections_12.get(12);
              final Procedure1<ParameterConnection> _function_57 = new Procedure1<ParameterConnection>() {
                public void apply(final ParameterConnection it) {
                  String _name = it.getName();
                  Assert.assertEquals("paramconn90", _name);
                  ConnectedElement _source = it.getSource();
                  Aadl2JavaValidatorTest.assertError(_source, allIssues, "An \'event port\' in a \'parameter\' is not a valid parameter connection end.");
                  ConnectedElement _destination = it.getDestination();
                  Aadl2JavaValidatorTest.assertNoIssues(_destination, allIssues);
                }
              };
              ObjectExtensions.<ParameterConnection>operator_doubleArrow(_get_57, _function_57);
              EList<ParameterConnection> _ownedParameterConnections_13 = it.getOwnedParameterConnections();
              ParameterConnection _get_58 = _ownedParameterConnections_13.get(13);
              final Procedure1<ParameterConnection> _function_58 = new Procedure1<ParameterConnection>() {
                public void apply(final ParameterConnection it) {
                  String _name = it.getName();
                  Assert.assertEquals("paramconn91", _name);
                  ConnectedElement _source = it.getSource();
                  Aadl2JavaValidatorTest.assertError(_source, allIssues, "A \'data port\' in a \'parameter\' is not a valid parameter connection end.");
                  ConnectedElement _destination = it.getDestination();
                  Aadl2JavaValidatorTest.assertNoIssues(_destination, allIssues);
                }
              };
              ObjectExtensions.<ParameterConnection>operator_doubleArrow(_get_58, _function_58);
              EList<ParameterConnection> _ownedParameterConnections_14 = it.getOwnedParameterConnections();
              ParameterConnection _get_59 = _ownedParameterConnections_14.get(14);
              final Procedure1<ParameterConnection> _function_59 = new Procedure1<ParameterConnection>() {
                public void apply(final ParameterConnection it) {
                  String _name = it.getName();
                  Assert.assertEquals("paramconn92", _name);
                  ConnectedElement _source = it.getSource();
                  Aadl2JavaValidatorTest.assertError(_source, allIssues, "An \'event data port\' in a \'parameter\' is not a valid parameter connection end.");
                  ConnectedElement _destination = it.getDestination();
                  Aadl2JavaValidatorTest.assertNoIssues(_destination, allIssues);
                }
              };
              ObjectExtensions.<ParameterConnection>operator_doubleArrow(_get_59, _function_59);
              EList<PortConnection> _ownedPortConnections = it.getOwnedPortConnections();
              PortConnection _get_60 = _ownedPortConnections.get(0);
              final Procedure1<PortConnection> _function_60 = new Procedure1<PortConnection>() {
                public void apply(final PortConnection it) {
                  String _name = it.getName();
                  Assert.assertEquals("portconn92", _name);
                  ConnectedElement _source = it.getSource();
                  Aadl2JavaValidatorTest.assertError(_source, allIssues, "A \'parameter\' is not a valid port connection end.");
                  ConnectedElement _destination = it.getDestination();
                  Aadl2JavaValidatorTest.assertNoIssues(_destination, allIssues);
                }
              };
              ...
              EList<PortConnection> _ownedPortConnections_1 = it.getOwnedPortConnections();
              PortConnection _get_61 = _ownedPortConnections_1.get(1);
              final Procedure1<PortConnection> _function_61 = new Procedure1<PortConnection>() {
                public void apply(final PortConnection it) {
                  String _name = it.getName();
                  Assert.assertEquals("portconn93", _name);
                  ConnectedElement _source = it.getSource();
                  Aadl2JavaValidatorTest.assertError(_source, allIssues, "Anything in a \'parameter\' is not a valid port connection end.");
                  ConnectedElement _destination = it.getDestination();
                  Aadl2JavaValidatorTest.assertNoIssues(_destination, allIssues);
                }
              };
              ...
              EList<PortConnection> _ownedPortConnections_2 = it.getOwnedPortConnections();
              PortConnection _get_62 = _ownedPortConnections_2.get(2);
              ...
              EList<PortConnection> _ownedPortConnections_3 = it.getOwnedPortConnections();
              PortConnection _get_63 = _ownedPortConnections_3.get(3);
              ...
              EList<PortConnection> _ownedPortConnections_4 = it.getOwnedPortConnections();
              PortConnection _get_64 = _ownedPortConnections_4.get(4);
              ...
              EList<PortConnection> _ownedPortConnections_5 = it.getOwnedPortConnections();
              PortConnection _get_65 = _ownedPortConnections_5.get(5);
              ...
              EList<PortConnection> _ownedPortConnections_6 = it.getOwnedPortConnections();
              PortConnection _get_66 = _ownedPortConnections_6.get(6);
              ...
              EList<PortConnection> _ownedPortConnections_7 = it.getOwnedPortConnections();
              PortConnection _get_67 = _ownedPortConnections_7.get(7);
              ...
              EList<PortConnection> _ownedPortConnections_8 = it.getOwnedPortConnections();
              PortConnection _get_68 = _ownedPortConnections_8.get(8);
              ...
              EList<PortConnection> _ownedPortConnections_9 = it.getOwnedPortConnections();
              PortConnection _get_69 = _ownedPortConnections_9.get(9);
              ...
              EList<PortConnection> _ownedPortConnections_10 = it.getOwnedPortConnections();
              PortConnection _get_70 = _ownedPortConnections_10.get(10);
              ...
              EList<PortConnection> _ownedPortConnections_11 = it.getOwnedPortConnections();
              PortConnection _get_71 = _ownedPortConnections_11.get(11);
              ...
              EList<PortConnection> _ownedPortConnections_12 = it.getOwnedPortConnections();
              PortConnection _get_72 = _ownedPortConnections_12.get(12);
              final Procedure1<PortConnection> _function_72 = new Procedure1<PortConnection>() {
                public void apply(final PortConnection it) {
                  String _name = it.getName();
              ...
              ObjectExtensions.<PortConnection>operator_doubleArrow(_get_72, _function_72);
              EList<PortConnection> _ownedPortConnections_13 = it.getOwnedPortConnections();
              PortConnection _get_73 = _ownedPortConnections_13.get(13);
              final Procedure1<PortConnection> _function_73 = new Procedure1<PortConnection>() {
                public void apply(final PortConnection it) {
                  String _name = it.getName();
              ...
              ObjectExtensions.<PortConnection>operator_doubleArrow(_get_73, _function_73);
              EList<PortConnection> _ownedPortConnections_14 = it.getOwnedPortConnections();
              PortConnection _get_74 = _ownedPortConnections_14.get(14);
              final Procedure1<PortConnection> _function_74 = new Procedure1<PortConnection>() {
                public void apply(final PortConnection it) {
                  String _name = it.getName();
              ...
              ObjectExtensions.<PortConnection>operator_doubleArrow(_get_74, _function_74);
            }
          };
          ObjectExtensions.<SubprogramImplementation>operator_doubleArrow(
            ((SubprogramImplementation) _get_1), _function_2);
        }
      };
      ObjectExtensions.<AadlPackage>operator_doubleArrow(
        ((AadlPackage) _parse), _function);
    } catch (Throwable _e) {
      throw Exceptions.sneakyThrow(_e);
    }
  }
  
  private static void assertNoIssues(final EObject eObject, final List<Issue> allIssues) {
    try {
      final Function1<Issue, Boolean> _function = new Function1<Issue, Boolean>() {
        public Boolean apply(final Issue it) {
          URI _uriToProblem = it.getUriToProblem();
          URI _uRI = EcoreUtil.getURI(eObject);
          return Boolean.valueOf(Objects.equal(_uriToProblem, _uRI));
        }
      };
      Iterable<Issue> _filter = IterableExtensions.<Issue>filter(allIssues, _function);
      ...
      final Iterable<String> issueMessagesForEObject = IterableExtensions.<Issue, String>map(_filter, _function_1);
      boolean _isEmpty = IterableExtensions.isEmpty(issueMessagesForEObject);
      boolean _not = (!_isEmpty);
      if (_not) {
        String _join = IterableExtensions.join(issueMessagesForEObject, "\n");
        throw new ComparisonFailure("", "", _join);
      }
    } catch (Throwable _e) {
      throw Exceptions.sneakyThrow(_e);
    }
  ...
  private static void assertError(final EObject eObject, final List<Issue> allIssues, final String... expectedMessages) {
    try {
      final Function1<Issue, Boolean> _function = new Function1<Issue, Boolean>() {
        public Boolean apply(final Issue it) {
          boolean _and = false;
      ...
      final Iterable<String> issueMessagesForEObject = IterableExtensions.<Issue, String>map(_filter, _function_1);
      Set<String> _set = IterableExtensions.<String>toSet(issueMessagesForEObject);
      ...
      if (_notEquals) {
        ...
        String _join_1 = IterableExtensions.join(issueMessagesForEObject, "\n");
