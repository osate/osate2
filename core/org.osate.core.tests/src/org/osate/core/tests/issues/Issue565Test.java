...
public class Issue565Test extends XtextTest {
	...
	@Test
	public void issue565() throws Exception {
		...
		assertTrue("In Top_i_instance: Expected 2 connections but found " + connections.size(),
				connections.size() == 2);
	}
}
