...
public class Issue2362InstanceTest {
	...
	@Test
	public void test_Sub_to_provides() throws Exception {
	...
	@Test
	public void test_Sub_FG_to_provides() throws Exception {
	...
	@Test
	public void test_Sub_FG_inverse_to_provides() throws Exception {
	...
	@Test
	public void test_Sub_FG_inverse_to_provides2() throws Exception {
	...
	@Test
	public void test_Sub_FG_inverse_to_provides3() throws Exception {
	...
	@Test
	public void test_Sub_to_peer_requires() throws Exception {
	...
	@Test
	public void test_Sub_provides_to_provides() throws Exception {
	...
	@Test
	public void test_Sub_FG_provides_to_provides() throws Exception {
	...
	@Test
	public void test_Sub_FG_inverse_provides_to_provides() throws Exception {
	...
	@Test
	public void test_Sub_FG_inverse_provides_to_provides2() throws Exception {
	...
	@Test
	public void test_Sub_FG_inverse_provides_to_provides3() throws Exception {
	...
	@Test
	public void test_Peer_to_peer() throws Exception {
	...
	@Test
	public void test_To_sub_requires() throws Exception {
	...
	@Test
	public void test_FG_To_sub_requires() throws Exception {
	...
	@Test
	public void test_FG_inverse_To_sub_requires() throws Exception {
	...
	@Test
	public void test_FG_inverse_To_sub_requires2() throws Exception {
	...
	@Test
	public void test_FG_inverse_To_sub_requires3() throws Exception {
	...
	private void testIncoming(String systemName, String prefix1, String prefix2) throws Exception {
		List<Message> messages = instantiate(systemName);
		assertTrue(messages.size() == 6);
		incomingErrors(messages, prefix1, prefix2);
	}

	private void testOutgoing(String systemName, String prefix1, String prefix2) throws Exception {
		List<Message> messages = instantiate(systemName);
		assertTrue(messages.size() == 6);
		outgoingErrors(messages, prefix1, prefix2);
	}

	private void testBidirectional(String systemName, String prefix1, String prefix2) throws Exception {
		List<Message> messages = instantiate(systemName);
	...
	private List<Message> instantiate(String systemName) throws Exception {
		AadlPackage pkg = testHelper.parseFile(FILE_LOCATION);
		SystemImplementation sysImpl = (SystemImplementation) pkg.getOwnedPublicSection()
				.getOwnedClassifiers()
				.stream()
				.filter(classifier -> systemName.equals(classifier.getName()))
				.findFirst()
				.orElse(null);
	...
	protected void outgoingErrors(List<Message> messages, String prefix1, String prefix2) {
		hasError(messages, prefix1 + "dd -> " + prefix2 + "_d_dd",
				"'" + prefix1 + "dd' and '" + prefix2 + "_d_dd' have incompatible classifiers.");
		hasError(messages, prefix1 + "e -> " + prefix2 + "_d_e",
				"'" + prefix1 + "e' and '" + prefix2 + "_d_e' have incompatible classifiers.");

		hasError(messages, prefix1 + "d -> " + prefix2 + "_e_d",
				"'" + prefix1 + "d' and '" + prefix2 + "_e_d' have incompatible classifiers.");
		hasError(messages, prefix1 + "dd -> " + prefix2 + "_e_dd",
				"'" + prefix1 + "dd' and '" + prefix2 + "_e_dd' have incompatible classifiers.");
		hasError(messages, prefix1 + "di -> " + prefix2 + "_e_di",
				"The types of '" + prefix1 + "di' and '" + prefix2 + "_e_di' do not match.");
		hasError(messages, prefix1 + "dj -> " + prefix2 + "_e_dj",
				"The types of '" + prefix1 + "dj' and '" + prefix2 + "_e_dj' do not match.");
	}

	protected void incomingErrors(List<Message> messages, String prefix1, String prefix2) {
		hasError(messages, prefix2 + "_d_dd -> " + prefix1 + "dd",
				"'" + prefix1 + "dd' and '" + prefix2 + "_d_dd' have incompatible classifiers.");
		hasError(messages, prefix2 + "_d_e -> " + prefix1 + "e",
				"'" + prefix1 + "e' and '" + prefix2 + "_d_e' have incompatible classifiers.");

		hasError(messages, prefix2 + "_e_d -> " + prefix1 + "d",
				"'" + prefix1 + "d' and '" + prefix2 + "_e_d' have incompatible classifiers.");
		hasError(messages, prefix2 + "_e_dd -> " + prefix1 + "dd",
				"'" + prefix1 + "dd' and '" + prefix2 + "_e_dd' have incompatible classifiers.");
		hasError(messages, prefix2 + "_e_di -> " + prefix1 + "di",
				"The types of '" + prefix1 + "di' and '" + prefix2 + "_e_di' do not match.");
		hasError(messages, prefix2 + "_e_dj -> " + prefix1 + "dj",
				"The types of '" + prefix1 + "dj' and '" + prefix2 + "_e_dj' do not match.");
	}

	private static void hasError(List<Message> messages, String connectionName, String errorMsg) {
		Message message = messages.stream()
				.filter(candidate -> connectionName.equals(((ConnectionInstance) candidate.where).getName()))
				.findFirst()
				.orElse(null);
		assertEquals(message.kind, QueuingAnalysisErrorReporter.Kind.ERROR);
		assertEquals(message.message, errorMsg);
	}
}
