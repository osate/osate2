...
public class Issue2874Test extends XtextTest {

	private static final String PATH = "org.osate.core.tests/models/issue2874/";
	...
	public void testInstantiation() throws Exception {
		AadlPackage pkg = testHelper.parseFile(PATH + "Issue2874.aadl", PATH + "PS.aadl");
		...
		Assert.assertEquals("Found " + pas.size() + " property associations, expected 2", 2, pas.size());
