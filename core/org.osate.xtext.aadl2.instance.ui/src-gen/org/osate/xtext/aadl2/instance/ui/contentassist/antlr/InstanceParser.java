		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getFLOWELEMENTREFAccess().getAlternatives_1(), "rule__FLOWELEMENTREF__Alternatives_1");
					...
					put(grammarAccess.getMODEREFAccess().getGroup_0(), "rule__MODEREF__Group_0__0");
					put(grammarAccess.getMODEREFAccess().getGroup_2(), "rule__MODEREF__Group_2__0");
					...
					put(grammarAccess.getSIMPLEINSTANCEREFAccess().getGroup(), "rule__SIMPLEINSTANCEREF__Group__0");
					put(grammarAccess.getSIMPLEINSTANCEREFAccess().getGroup_1(), "rule__SIMPLEINSTANCEREF__Group_1__0");
					put(grammarAccess.getSIMPLEINSTANCEREFAccess().getGroup_2(), "rule__SIMPLEINSTANCEREF__Group_2__0");
					put(grammarAccess.getSIMPLEINSTANCEREFAccess().getGroup_2_2(), "rule__SIMPLEINSTANCEREF__Group_2_2__0");
					...
					put(grammarAccess.getFLOWELEMENTREFAccess().getGroup(), "rule__FLOWELEMENTREF__Group__0");
					put(grammarAccess.getFLOWELEMENTREFAccess().getGroup_0(), "rule__FLOWELEMENTREF__Group_0__0");
					put(grammarAccess.getFLOWELEMENTREFAccess().getGroup_0_1(), "rule__FLOWELEMENTREF__Group_0_1__0");
					put(grammarAccess.getFLOWELEMENTREFAccess().getGroup_1_1(), "rule__FLOWELEMENTREF__Group_1_1__0");
					put(grammarAccess.getFLOWELEMENTREFAccess().getGroup_1_1_1(), "rule__FLOWELEMENTREF__Group_1_1_1__0");
					...
					put(grammarAccess.getConnectionInstanceAccess().getConnectionReferenceAssignment_9(), "rule__ConnectionInstance__ConnectionReferenceAssignment_9");
					...
					put(grammarAccess.getFlowSpecificationInstanceAccess().getFlowSpecificationAssignment_9(), "rule__FlowSpecificationInstance__FlowSpecificationAssignment_9");
					...
					put(grammarAccess.getModeInstanceAccess().getModeAssignment_5(), "rule__ModeInstance__ModeAssignment_5");
