		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getComponentInstanceAccess().getAlternatives_6_1(), "rule__ComponentInstance__Alternatives_6_1");
					...
					put(grammarAccess.getComponentInstanceAccess().getFeatureInstanceAssignment_6_1_0(), "rule__ComponentInstance__FeatureInstanceAssignment_6_1_0");
					put(grammarAccess.getComponentInstanceAccess().getComponentInstanceAssignment_6_1_1(), "rule__ComponentInstance__ComponentInstanceAssignment_6_1_1");
					put(grammarAccess.getComponentInstanceAccess().getConnectionInstanceAssignment_6_1_2(), "rule__ComponentInstance__ConnectionInstanceAssignment_6_1_2");
					put(grammarAccess.getComponentInstanceAccess().getFlowSpecificationAssignment_6_1_3(), "rule__ComponentInstance__FlowSpecificationAssignment_6_1_3");
					put(grammarAccess.getComponentInstanceAccess().getEndToEndFlowAssignment_6_1_4(), "rule__ComponentInstance__EndToEndFlowAssignment_6_1_4");
					put(grammarAccess.getComponentInstanceAccess().getModeInstanceAssignment_6_1_5(), "rule__ComponentInstance__ModeInstanceAssignment_6_1_5");
					put(grammarAccess.getComponentInstanceAccess().getModeTransitionInstanceAssignment_6_1_6(), "rule__ComponentInstance__ModeTransitionInstanceAssignment_6_1_6");
					put(grammarAccess.getComponentInstanceAccess().getOwnedPropertyAssociationAssignment_6_1_7(), "rule__ComponentInstance__OwnedPropertyAssociationAssignment_6_1_7");
