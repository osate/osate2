 ...
 * </copyright>
 *
 * $Id: ThreadGroupTypeItemProvider.java,v 1.20 2011-04-11 13:36:10 lwrage Exp $
 */
...
/**
 * This is the item provider adapter for a {@link org.osate.aadl2.ThreadGroupType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ThreadGroupTypeItemProvider extends ComponentTypeItemProvider {
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ? getString("_UI_ThreadGroupType_type")
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(createChildParameter(Aadl2Package.eINSTANCE.getThreadGroupType_OwnedDataPort(),
				Aadl2Factory.eINSTANCE.createDataPort()));

		newChildDescriptors.add(createChildParameter(Aadl2Package.eINSTANCE.getThreadGroupType_OwnedEventDataPort(),
				Aadl2Factory.eINSTANCE.createEventDataPort()));

		newChildDescriptors.add(createChildParameter(Aadl2Package.eINSTANCE.getThreadGroupType_OwnedEventPort(),
				Aadl2Factory.eINSTANCE.createEventPort()));

		newChildDescriptors.add(createChildParameter(Aadl2Package.eINSTANCE.getThreadGroupType_OwnedDataAccess(),
