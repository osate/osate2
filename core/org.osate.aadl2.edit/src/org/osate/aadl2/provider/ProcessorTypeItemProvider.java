 ...
 * </copyright>
 *
 * $Id: ProcessorTypeItemProvider.java,v 1.20 2011-04-11 13:36:06 lwrage Exp $
 */
...
/**
 * This is the item provider adapter for a {@link org.osate.aadl2.ProcessorType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ProcessorTypeItemProvider extends ComponentTypeItemProvider {
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ? getString("_UI_ProcessorType_type")
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(createChildParameter(Aadl2Package.eINSTANCE.getProcessorType_OwnedDataPort(),
				Aadl2Factory.eINSTANCE.createDataPort()));

		newChildDescriptors.add(createChildParameter(Aadl2Package.eINSTANCE.getProcessorType_OwnedEventDataPort(),
				Aadl2Factory.eINSTANCE.createEventDataPort()));

		newChildDescriptors.add(createChildParameter(Aadl2Package.eINSTANCE.getProcessorType_OwnedEventPort(),
				Aadl2Factory.eINSTANCE.createEventPort()));

		newChildDescriptors.add(createChildParameter(Aadl2Package.eINSTANCE.getProcessorType_OwnedBusAccess(),
