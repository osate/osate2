 ...
 */
public class PropertiesIdeSetup extends PropertiesStandaloneSetup {

	@Override
	public Injector createInjector() {
		return Guice.createInjector(Modules2.mixin(new PropertiesRuntimeModule(), new PropertiesIdeModule()));
	}
