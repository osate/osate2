...
public class Aadl2JavaValidator extends AbstractAadl2JavaValidator {
	...
	public void caseComponentImplementation(TriggerPort tp)
	{
		ModeTransition mt = (ModeTransition)tp.getOwner();				
	 ...
	 * They can on the error reporter thus reside in here
	 */
			...
			for (EObject child : componentImplementation.eContents())
			{
				if (child instanceof ClassifierFeature && !(child instanceof ModeFeature))
				{
					error( "When a component implementation is declared in both the public section and the private" +
							...
							" properties subclause and a modes subclause.",(Element)child,Aadl2Package.eINSTANCE.getComponentClassifier_OwnedMode());
				}
			}
		}
	}
