...
class Aadl2Formatter extends PropertiesFormatter {
	...
	def dispatch void format(BusType busType, extension IFormattableDocument document) {
		...
		formatComponentTypeCommon(
			busType,
			document,
			busType.regionFor.assignment(busTypeAccess.nameAssignment_1),
	...
	def dispatch void format(DataType dataType, extension IFormattableDocument document) {
		...
		formatComponentTypeCommon(
			dataType,
			document,
			dataType.regionFor.assignment(dataTypeAccess.nameAssignment_1),
	...
	def private formatComponentTypeCommon(
		...
		// Section headings
		componentType.regionFor.keywords("prototypes", "features", "flows", "properties").forEach [
			surround[indent].append[newLines = 1]
		]
	...
	def dispatch void format(FeatureGroupType featureGroupType, extension IFormattableDocument document) {
		...
		featureGroupType.regionFor.keywords(
			featureGroupTypeAccess.prototypesKeyword_3_0,
		...
		featureGroupType.regionFor.assignment(featureGroupTypeAccess.inverseAssignment_5_1).prepend[oneSpace].append [
			newLines = 1
		]
	...
	def private formatComponentImplementationCommon(
		...
		// Section headings
		componentImplementation.regionFor.keywords("prototypes", "subcomponents", "connections", "flows", "modes",
			"properties").forEach [
			surround[indent].append[newLines = 1]
		]
		...
		componentImplementation.regionFor.keyword(processorFeaturesKeywordsAccess.processorKeyword_0).surround[indent].
			append[oneSpace]
	...
	def dispatch void format(SubprogramCallSequence subprogramCallSequence, extension IFormattableDocument document) {
		...
		subprogramCallSequence.regionFor.keyword(subprogramCallSequenceAccess.leftCurlyBracketKeyword_2).append [
			newLines = 1
		]
