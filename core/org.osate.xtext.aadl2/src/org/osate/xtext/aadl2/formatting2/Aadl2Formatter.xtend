...
class Aadl2Formatter extends PropertiesFormatter {
	...
	def dispatch void format(PropertySet propertySet, extension IFormattableDocument document) {
		...
		if (!withSemicolons.empty) {
			...
			propertySet.regionFor.keywords(propertySetAccess.commaKeyword_4_2_0).forEach [
				prepend[noSpace].append[oneSpace]
			]
			withSemicolons.take(withSemicolons.size - 1).forEach[prepend[noSpace].append[newLines = 1]]
			val newLineCount = if (propertySet.ownedPropertyTypes.empty && propertySet.ownedProperties.empty &&
					propertySet.ownedPropertyConstants.empty && propertySet.ownedAnnexSubclauses.empty) {
					1
				} else {
					2
				}
	...
	def dispatch void format(EnumerationType enumerationType, extension IFormattableDocument document) {
		if (enumerationType.name === null) {
			...
			formatEnumerationTypeCommon(
				document,
				enumerationType.regionFor.keyword(unnamedEnumerationTypeAccess.leftParenthesisKeyword_1),
			...
			formatEnumerationTypeCommon(
				document,
				enumerationType.regionFor.keyword(enumerationTypeAccess.leftParenthesisKeyword_4),
	...
	def private formatEnumerationTypeCommon(extension IFormattableDocument document, ISemanticRegion leftParenthesis,
	...
	def dispatch void format(UnitsType unitsType, extension IFormattableDocument document) {
		if (unitsType.name === null) {
			...
			formatUnitsTypeCommon(
				unitsType,
				document,
				unitsType.regionFor.keyword(unnamedUnitsTypeAccess.leftParenthesisKeyword_1),
				unitsType.regionFor.keyword(unnamedUnitsTypeAccess.rightParenthesisKeyword_4),
				unitsType.regionFor.keywords(unnamedUnitsTypeAccess.commaKeyword_3_0)
			)
		} else {
			...
			formatUnitsTypeCommon(
				unitsType,
				document,
				unitsType.regionFor.keyword(unitsTypeAccess.leftParenthesisKeyword_4),
				unitsType.regionFor.keyword(unitsTypeAccess.rightParenthesisKeyword_7),
				unitsType.regionFor.keywords(unitsTypeAccess.commaKeyword_6_0)
			)
			unitsType.regionFor.keyword(propertyTypeAccess.semicolonKeyword_1).prepend[noSpace]
		}
	}

	def private formatUnitsTypeCommon(UnitsType unitsType, extension IFormattableDocument document,
	...
	def dispatch void format(AadlReal aadlReal, extension IFormattableDocument document) {
		if (aadlReal.name === null) {
			formatAadlRealCommon(aadlReal, document,
				aadlReal.regionFor.keyword(unnamedRealTypeAccess.unitsKeyword_3_1_0))
		} else {
	...
	def private formatAadlRealCommon(AadlReal aadlReal, extension IFormattableDocument document,
		ISemanticRegion unitsKeyword) {
		// Range
	...
	def dispatch void format(AadlInteger aadlInteger, extension IFormattableDocument document) {
		if (aadlInteger.name === null) {
			formatAadlIntegerCommon(aadlInteger, document,
				aadlInteger.regionFor.keyword(unnamedIntegerTypeAccess.unitsKeyword_3_1_0))
		} else {
			...
			formatAadlIntegerCommon(aadlInteger, document,
				aadlInteger.regionFor.keyword(integerTypeAccess.unitsKeyword_5_1_0))

			aadlInteger.regionFor.keyword(propertyTypeAccess.semicolonKeyword_1).prepend[noSpace]
		}
	}

	def private formatAadlIntegerCommon(AadlInteger aadlInteger, extension IFormattableDocument document,
		ISemanticRegion unitsKeyword) {
		// Range
	...
	def dispatch void format(RangeType rangeType, extension IFormattableDocument document) {
		if (rangeType.name === null) {
			...
			formatRangeTypeCommon(rangeType, document,
				rangeType.regionFor.assignment(unnamedRangeTypeAccess.referencedNumberTypeAssignment_2_1))
		} else {
			...
			formatRangeTypeCommon(rangeType, document,
				rangeType.regionFor.assignment(rangeTypeAccess.referencedNumberTypeAssignment_4_1))

			rangeType.regionFor.keyword(propertyTypeAccess.semicolonKeyword_1).prepend[noSpace]
		}
	}

	def private formatRangeTypeCommon(RangeType rangeType, extension IFormattableDocument document,
		ISemanticRegion referencedNumberType) {
		// Owned number type
	...
	def dispatch void format(ClassifierType classifierType, extension IFormattableDocument document) {
		if (classifierType.name === null) {
			formatClassifierTypeCommon(
				classifierType,
				document,
				classifierType.regionFor.keyword(unnamedClassifierTypeAccess.leftParenthesisKeyword_2_0),
			...
			formatClassifierTypeCommon(
				classifierType,
				document,
				classifierType.regionFor.keyword(classifierTypeAccess.leftParenthesisKeyword_4_0),
	...
	def private formatClassifierTypeCommon(
		ClassifierType classifierType,
		extension IFormattableDocument document,
		ISemanticRegion leftParenthesis,
		ISemanticRegion rightParenthesis,
		Iterable<ISemanticRegion> commas
	) {
	...
	def dispatch void format(MetaclassReference metaclassReference, extension IFormattableDocument document) {
		...
		// Names
		metaclassReference.regionFor.assignments(QMReferenceAccess.metaclassNameAssignment_1).tail.forEach [
			prepend[oneSpace]
		]
	}
	...
	def dispatch void format(ReferenceType referenceType, extension IFormattableDocument document) {
		if (referenceType.name === null) {
			formatReferenceTypeCommon(
				referenceType,
				document,
				referenceType.regionFor.keyword(unnamedReferenceTypeAccess.leftParenthesisKeyword_2_0),
			...
			formatReferenceTypeCommon(
				referenceType,
				document,
				referenceType.regionFor.keyword(referenceTypeAccess.leftParenthesisKeyword_4_0),
	...
	def private formatReferenceTypeCommon(
	...
	def dispatch void format(RecordType recordType, extension IFormattableDocument document) {
		if (recordType.name === null) {
			formatRecordTypeCommon(
				recordType,
				document,
				recordType.regionFor.keyword(unnamedRecordTypeAccess.leftParenthesisKeyword_1),
			...
			formatRecordTypeCommon(
				recordType,
				document,
				recordType.regionFor.keyword(recordTypeAccess.leftParenthesisKeyword_4),
	...
	def private formatRecordTypeCommon(RecordType recordType, extension IFormattableDocument document,
	...
	def dispatch void format(AadlPackage aadlPackage, extension IFormattableDocument document) {
		...
		// Declaration line
		aadlPackage.regionFor.assignment(aadlPackageAccess.nameAssignment_1).prepend[oneSpace].append [
			setNewLines(1, 1, 2)
		]
		...
		aadlPackage.regionFor.keyword(aadlPackageAccess.semicolonKeyword_3_1_1_1).prepend[noSpace].append [
			setNewLines(1, 1, 2)
		]
	...
	def private formatPackageSectionCommon(
		PackageSection packageSection,
		extension IFormattableDocument document,
		ISemanticRegion visibilityKeyword,
		Iterable<ISemanticRegion> withs,
		Iterable<ISemanticRegion> commas,
	...
	def dispatch void format(AbstractType abstractType, extension IFormattableDocument document) {
		...
		formatComponentTypeCommon(abstractType, document,
			abstractType.regionFor.assignment(abstractTypeAccess.nameAssignment_1))
	}
	...
	def dispatch void format(SystemType systemType, extension IFormattableDocument document) {
		...
		formatComponentTypeCommon(systemType, document,
			systemType.regionFor.assignment(systemTypeAccess.nameAssignment_1))
	}
	...
	def dispatch void format(ProcessType processType, extension IFormattableDocument document) {
		...
		formatComponentTypeCommon(processType, document,
			processType.regionFor.assignment(processTypeAccess.nameAssignment_1))
	}
	...
	def dispatch void format(ThreadGroupType threadGroupType, extension IFormattableDocument document) {
		...
		formatComponentTypeCommon(threadGroupType, document,
			threadGroupType.regionFor.assignment(threadGroupTypeAccess.nameAssignment_1))
	}
	...
	def dispatch void format(ThreadType threadType, extension IFormattableDocument document) {
		...
		formatComponentTypeCommon(threadType, document,
			threadType.regionFor.assignment(threadTypeAccess.nameAssignment_1))
	}
	...
	def dispatch void format(SubprogramType subprogramType, extension IFormattableDocument document) {
		...
		formatComponentTypeCommon(subprogramType, document,
			subprogramType.regionFor.assignment(subprogramTypeAccess.nameAssignment_1))
	}
	...
	def dispatch void format(ProcessorType processorType, extension IFormattableDocument document) {
		...
		formatComponentTypeCommon(processorType, document,
			processorType.regionFor.assignment(processorTypeAccess.nameAssignment_1))
	}
	...
	def dispatch void format(DeviceType deviceType, extension IFormattableDocument document) {
		...
		formatComponentTypeCommon(deviceType, document,
			deviceType.regionFor.assignment(deviceTypeAccess.nameAssignment_1))
	}
	...
	def dispatch void format(MemoryType memoryType, extension IFormattableDocument document) {
		...
		formatComponentTypeCommon(memoryType, document,
			memoryType.regionFor.assignment(memoryTypeAccess.nameAssignment_1))
	}
	...
	def dispatch void format(VirtualBusType virtualBusType, extension IFormattableDocument document) {
		...
		formatComponentTypeCommon(virtualBusType, document,
			virtualBusType.regionFor.assignment(virtualBusTypeAccess.nameAssignment_1))
	}
	...
	def private formatComponentTypeCommon(
		...
		if (componentType.ownedExtension === null) {
			...
			if (componentType.ownedPrototypeBindings.empty) {
				...
				interior(leftParenthesis, rightParenthesis, [indent])
				leftParenthesis.prepend[oneSpace].append[noSpace; setNewLines(0, 0, 1); autowrap]
				componentType.regionFor.keywords(",").forEach [
					prepend[noSpace].append[oneSpace; setNewLines(0, 0, 1); autowrap]
				]
		...
		// Contents
		(componentType.ownedPrototypes + componentType.ownedFeatures + componentType.ownedFlowSpecifications +
			componentType.ownedModes + componentType.ownedModeTransitions + componentType.ownedAnnexSubclauses
	...
	def dispatch void format(FeatureGroupPrototypeBinding featureGroupPrototypeBinding,
		extension IFormattableDocument document) {
		featureGroupPrototypeBinding.regionFor.keyword(
			featureGroupPrototypeBindingAccess.equalsSignGreaterThanSignKeyword_1).surround[oneSpace]
	...
	def dispatch void format(FeatureGroupPrototypeActual featureGroupPrototypeActual,
		extension IFormattableDocument document) {
		val leftParenthesis = featureGroupPrototypeActual.regionFor.keyword(
			featureGroupPrototypeActualAccess.leftParenthesisKeyword_1_0)
		val rightParenthesis = featureGroupPrototypeActual.regionFor.keyword(
			featureGroupPrototypeActualAccess.rightParenthesisKeyword_1_3)
		if (leftParenthesis !== null && rightParenthesis !== null) {
			interior(leftParenthesis, rightParenthesis, [indent])
			leftParenthesis.prepend[oneSpace].append[noSpace; setNewLines(0, 0, 1); autowrap]
	...
	def dispatch void format(FeaturePrototypeBinding featurePrototypeBinding, extension IFormattableDocument document) {
		featurePrototypeBinding.regionFor.keyword(featurePrototypeBindingAccess.equalsSignGreaterThanSignKeyword_1).
			surround[oneSpace]
	...
	def dispatch void format(FeaturePrototypeReference featurePrototypeReference,
		extension IFormattableDocument document) {
		featurePrototypeReference.regionFor.keyword(featurePrototypeReferenceAccess.inInKeyword_0_0_0).append[oneSpace]
		featurePrototypeReference.regionFor.keyword(featurePrototypeReferenceAccess.outOutKeyword_0_1_0).append [
			oneSpace
		]
		featurePrototypeReference.regionFor.keyword(featurePrototypeReferenceAccess.featureKeyword_1).append[oneSpace]
	}

	def dispatch void format(ComponentPrototypeBinding componentPrototypeBinding,
		extension IFormattableDocument document) {
		componentPrototypeBinding.regionFor.keyword(componentPrototypeBindingAccess.equalsSignGreaterThanSignKeyword_1).
			surround[oneSpace]
		componentPrototypeBinding.actuals.forEach[it.format(document)]
		val leftParenthesis = componentPrototypeBinding.regionFor.keyword(
			componentPrototypeBindingAccess.leftParenthesisKeyword_2_1_0)
		val rightParenthesis = componentPrototypeBinding.regionFor.keyword(
			componentPrototypeBindingAccess.rightParenthesisKeyword_2_1_3)
		if (leftParenthesis !== null && rightParenthesis !== null) {
			interior(leftParenthesis, rightParenthesis, [indent])
			leftParenthesis.append[noSpace; setNewLines(0, 0, 1); autowrap]
	...
	def dispatch void format(ComponentPrototypeActual componentPrototypeActual,
		extension IFormattableDocument document) {
		componentPrototypeActual.regionFor.assignment(componentReferenceAccess.categoryAssignment_0).append[oneSpace]
		val leftParenthesis = componentPrototypeActual.regionFor.keyword(
			componentReferenceAccess.leftParenthesisKeyword_2_0)
		val rightParenthesis = componentPrototypeActual.regionFor.keyword(
			componentReferenceAccess.rightParenthesisKeyword_2_3)
		if (leftParenthesis !== null && rightParenthesis !== null) {
			interior(leftParenthesis, rightParenthesis, [indent])
			leftParenthesis.prepend[oneSpace].append[noSpace; setNewLines(0, 0, 1); autowrap]
	...
	def dispatch void format(DataPort dataPort, extension IFormattableDocument document) {
		...
		formatCurlyProperties(
			dataPort,
			document,
			dataPort.regionFor.keyword(dataPortAccess.leftCurlyBracketKeyword_6_0),
	...
	def dispatch void format(EventDataPort eventDataPort, extension IFormattableDocument document) {
		...
		formatCurlyProperties(
			eventDataPort,
			document,
			eventDataPort.regionFor.keyword(eventDataPortAccess.leftCurlyBracketKeyword_6_0),
	...
	def dispatch void format(EventPort eventPort, extension IFormattableDocument document) {
		...
		formatCurlyProperties(
			eventPort,
			document,
			eventPort.regionFor.keyword(eventPortAccess.leftCurlyBracketKeyword_5_0),
	...
	def dispatch void format(FeatureGroup featureGroup, extension IFormattableDocument document) {
		...
		formatCurlyProperties(
			featureGroup,
			document,
			featureGroup.regionFor.keyword(featureGroupAccess.leftCurlyBracketKeyword_5_0),
	...
	def dispatch void format(Parameter parameter, extension IFormattableDocument document) {
		...
		formatCurlyProperties(
			parameter,
			document,
			parameter.regionFor.keyword(parameterAccess.leftCurlyBracketKeyword_5_0),
	...
	def dispatch void format(SubprogramAccess subprogramAccess, extension IFormattableDocument document) {
		...
		subprogramAccess.regionFor.assignment(subprogramAccessAccess.subprogramFeatureClassifierAssignment_3).prepend [
			oneSpace
		]
		...
		formatCurlyProperties(
			subprogramAccess,
			document,
			subprogramAccess.regionFor.keyword(subprogramAccessAccess.leftCurlyBracketKeyword_5_0),
	...
	def dispatch void format(SubprogramGroupAccess subprogramGroupAccess, extension IFormattableDocument document) {
		...
		// Named
		subprogramGroupAccess.regionFor.keyword(subprogramGroupAccessAccess.colonKeyword_0_0_1).prepend[noSpace].append [
			oneSpace
		]

		// Refined
		subprogramGroupAccess.regionFor.keyword(subprogramGroupAccessAccess.colonKeyword_0_1_1).prepend[noSpace].append [
			oneSpace
		]
		subprogramGroupAccess.regionFor.keyword(refinedToKeywordsAccess.toKeyword_1).surround[oneSpace]

		subprogramGroupAccess.regionFor.keyword(subprogramGroupAccessKeywordsAccess.subprogramKeyword_0).surround [
			oneSpace
		]
		subprogramGroupAccess.regionFor.keyword(subprogramGroupAccessKeywordsAccess.groupKeyword_1).append[oneSpace]
		subprogramGroupAccess.regionFor.assignment(
			subprogramGroupAccessAccess.subprogramGroupFeatureClassifierAssignment_3).prepend[oneSpace]
	...
	def dispatch void format(BusAccess busAccess, extension IFormattableDocument document) {
		...
		formatCurlyProperties(
			busAccess,
			document,
			busAccess.regionFor.keyword(busAccessAccess.leftCurlyBracketKeyword_6_0),
	...
	def dispatch void format(DataAccess dataAccess, extension IFormattableDocument document) {
		...
		formatCurlyProperties(
			dataAccess,
			document,
			dataAccess.regionFor.keyword(dataAccessAccess.leftCurlyBracketKeyword_5_0),
	...
	def dispatch void format(AbstractFeature abstractFeature, extension IFormattableDocument document) {
		...
		abstractFeature.regionFor.assignment(abstractFeatureAccess.abstractFeatureClassifierAssignment_2_1_1).prepend [
			oneSpace
		]
		...
		formatCurlyProperties(
			abstractFeature,
			document,
			abstractFeature.regionFor.keyword(abstractFeatureAccess.leftCurlyBracketKeyword_4_0),
	...
	def dispatch void format(Mode mode, extension IFormattableDocument document) {
		...
		formatCurlyProperties(
			mode,
			document,
			mode.regionFor.keyword(modeAccess.leftCurlyBracketKeyword_4_0),
	...
	def dispatch void format(ModeTransition modeTransition, extension IFormattableDocument document) {
		...
		val rightMarker = modeTransition.regionFor.keyword(
			modeTransitionAccess.rightSquareBracketHyphenMinusGreaterThanSignKeyword_5)
		...
		formatCurlyProperties(
			modeTransition,
			document,
			modeTransition.regionFor.keyword(modeTransitionAccess.leftCurlyBracketKeyword_7_0),
	...
	def private formatCurlyProperties(NamedElement namedElement, extension IFormattableDocument document,
	...
	def dispatch void format(FeatureGroupPrototype featureGroupPrototype, extension IFormattableDocument document) {
		...
		// Named
		featureGroupPrototype.regionFor.keyword(featureGroupPrototypeAccess.colonKeyword_0_0_1).prepend[noSpace].append [
			oneSpace
		]

		// Refined
		featureGroupPrototype.regionFor.keyword(featureGroupPrototypeAccess.colonKeyword_0_1_1).prepend[noSpace].append [
			oneSpace
		]
		...
		featureGroupPrototype.regionFor.assignment(
			featureGroupPrototypeAccess.constrainingFeatureGroupTypeAssignment_2).prepend[oneSpace]
		formatCurlyProperties(
	...
	def dispatch void format(FeaturePrototype featurePrototype, extension IFormattableDocument document) {
		...
		featurePrototype.regionFor.assignment(featurePrototypeAccess.constrainingClassifierAssignment_3).prepend [
			oneSpace
		]
		formatCurlyProperties(
			featurePrototype,
			document,
			featurePrototype.regionFor.keyword(featurePrototypeAccess.leftCurlyBracketKeyword_4_0),
	...
	def private formatComponentPrototypeCommon(ComponentPrototype componentPrototype,
		extension IFormattableDocument document, ISemanticRegion constrainingClassifierAssignment) {
	...
	def dispatch void format(AbstractPrototype abstractPrototype, extension IFormattableDocument document) {
		formatComponentPrototypeCommon(
			abstractPrototype,
			document,
	...
	def dispatch void format(SubprogramGroupPrototype subprogramGroupPrototype,
		extension IFormattableDocument document) {
		formatComponentPrototypeCommon(
			subprogramGroupPrototype,
			document,
			subprogramGroupPrototype.regionFor.assignment(
				subprogramGroupPrototypeAccess.constrainingClassifierAssignment_2)
		)
	...
	def dispatch void format(VirtualProcessorPrototype virtualProcessorPrototype,
		extension IFormattableDocument document) {
		formatComponentPrototypeCommon(
			virtualProcessorPrototype,
			document,
			virtualProcessorPrototype.regionFor.assignment(
				virtualProcessorPrototypeAccess.constrainingClassifierAssignment_2)
		)
	...
	def dispatch void format(DefaultAnnexSubclause defaultAnnexSubclause, extension IFormattableDocument document) {
		...
		formatAnnexText(defaultAnnexSubclause, annexName, sourceTextRegion, 2, document, [ annexParser, source |
			...
			performModification(defaultAnnexSubclause, [defaultAnnexSubclause.parsedAnnexSubclause = subclause])
			subclause
		])

		// In modes
		val leftParenthesis = defaultAnnexSubclause.regionFor.keyword(
			defaultAnnexSubclauseAccess.leftParenthesisKeyword_3_1)
		val rightParenthesis = defaultAnnexSubclause.regionFor.keyword(
			defaultAnnexSubclauseAccess.rightParenthesisKeyword_3_3)
		if (leftParenthesis !== null && rightParenthesis !== null) {
	...
	def dispatch void format(FeatureGroupType featureGroupType, extension IFormattableDocument document) {
		...
		if (featureGroupType.ownedExtension === null) {
			...
			if (featureGroupType.ownedPrototypeBindings.empty) {
				...
				val leftParenthesis = featureGroupType.regionFor.keyword(
					featureGroupTypeAccess.leftParenthesisKeyword_2_1_0)
				val rightParenthesis = featureGroupType.regionFor.keyword(
					featureGroupTypeAccess.rightParenthesisKeyword_2_1_3)
				interior(leftParenthesis, rightParenthesis, [indent])
				leftParenthesis.prepend[oneSpace].append[noSpace; setNewLines(0, 0, 1); autowrap]
		...
		// None keywords
		featureGroupType.regionFor.keywords(
			featureGroupTypeAccess.noPrototypesNoneKeyword_3_1_0_0_0,
		...
		// Contents
		(featureGroupType.ownedPrototypes + featureGroupType.ownedFeatures + featureGroupType.ownedAnnexSubclauses
		).forEach[it.format(document)]
	...
	def private formatComponentImplementationCommon(
		...
		if (componentImplementation.ownedExtension === null && componentImplementation.ownedPrototypeBindings.empty) {
			...
			if (componentImplementation.ownedPrototypeBindings.empty) {
				...
				interior(leftParenthesis, rightParenthesis, [indent])
				leftParenthesis.append[noSpace; setNewLines(0, 0, 1); autowrap]
				componentImplementation.regionFor.keywords(",").forEach [
					prepend[noSpace].append[oneSpace; setNewLines(0, 0, 1); autowrap]
				]
		...
		val internalKeyword = componentImplementation.regionFor.keyword(
			internalFeaturesKeywordsAccess.internalKeyword_0)
		val internalFeaturesKeyword = componentImplementation.regionFor.keyword(
			internalFeaturesKeywordsAccess.featuresKeyword_1)
		val processorKeyword = componentImplementation.regionFor.keyword(
			processorFeaturesKeywordsAccess.processorKeyword_0)
		val processorFeaturesKeyword = componentImplementation.regionFor.keyword(
			processorFeaturesKeywordsAccess.featuresKeyword_1)
		...
		// Contents
		(componentImplementation.ownedPrototypes + componentImplementation.ownedSubcomponents +
			componentImplementation.ownedInternalFeatures + componentImplementation.ownedProcessorFeatures +
			componentImplementation.ownedConnections + componentImplementation.ownedFlowImplementations +
			componentImplementation.ownedEndToEndFlows + componentImplementation.ownedModes +
			componentImplementation.ownedModeTransitions + componentImplementation.ownedAnnexSubclauses
		).forEach[it.format(document)]
	...
	def private formatBehavioredImplementationCommon(
	...
	def dispatch void format(AbstractImplementation abstractImplementation, extension IFormattableDocument document) {
		abstractImplementation.regionFor.keyword(abstractImplementationKeywordsAccess.abstractKeyword_0).append [
			oneSpace
		]
		formatBehavioredImplementationCommon(
	...
	def dispatch void format(SubprogramImplementation subprogramImplementation,
		extension IFormattableDocument document) {
		subprogramImplementation.regionFor.keyword(subprogramImplementationKeywordsAccess.subprogramKeyword_0).append [
			oneSpace
		]
		formatBehavioredImplementationCommon(
	...
	def dispatch void format(SystemImplementation systemImplementation, extension IFormattableDocument document) {
		...
		formatComponentImplementationCommon(
	...
	def dispatch void format(ThreadGroupImplementation threadGroupImplementation,
		extension IFormattableDocument document) {
		threadGroupImplementation.regionFor.keyword(threadGroupImplementationKeywordsAccess.groupKeyword_1).surround [
			oneSpace
		]
		formatComponentImplementationCommon(
	...
	def dispatch void format(SubprogramGroupImplementation subprogramGroupImplementation,
		extension IFormattableDocument document) {
		subprogramGroupImplementation.regionFor.keyword(subprogramGroupImplementationKeywordsAccess.groupKeyword_1).
			surround[oneSpace]
		formatComponentImplementationCommon(
	...
	def dispatch void format(ProcessorImplementation processorImplementation, extension IFormattableDocument document) {
		processorImplementation.regionFor.keyword(processorImplementationKeywordsAccess.processorKeyword_0).append [
			oneSpace
		]
		formatComponentImplementationCommon(
	...
	def dispatch void format(VirtualProcessorImplementation virtualProcessorImplementation,
		extension IFormattableDocument document) {
		virtualProcessorImplementation.regionFor.keyword(
			virtualProcessorImplementationKeywordsAccess.processorKeyword_1).surround[oneSpace]
		formatComponentImplementationCommon(
	...
	def dispatch void format(VirtualBusImplementation virtualBusImplementation,
		extension IFormattableDocument document) {
		virtualBusImplementation.regionFor.keyword(virtualBusImplementationKeywordsAccess.busKeyword_1).surround [
			oneSpace
		]
		formatComponentImplementationCommon(
	...
	def dispatch void format(SubprogramCallSequence subprogramCallSequence, extension IFormattableDocument document) {
		...
		subprogramCallSequence.regionFor.keyword(subprogramCallSequenceAccess.colonKeyword_1).prepend[noSpace].append [
			oneSpace
		]
		...
		interior(leftCurly,
			subprogramCallSequence.regionFor.keyword(subprogramCallSequenceAccess.rightCurlyBracketKeyword_4), [indent])
		...
		// In modes
		val leftParenthesis = subprogramCallSequence.regionFor.keyword(
			subprogramCallSequenceAccess.leftParenthesisKeyword_6_1)
		val rightParenthesis = subprogramCallSequence.regionFor.keyword(
			subprogramCallSequenceAccess.rightParenthesisKeyword_6_3)
		if (leftParenthesis !== null && rightParenthesis !== null) {
	...
	def private formatSubcomponentCommon(
		...
		formatCurlyProperties(subcomponent, document, subcomponent.regionFor.keyword("{"),
			subcomponent.regionFor.keyword("}"))
	...
	def dispatch void format(ThreadGroupSubcomponent threadGroupSubcomponent, extension IFormattableDocument document) {
		...
		formatSubcomponentCommon(
			...
			document,
			threadGroupSubcomponent.regionFor.assignment(
				threadGroupSubcomponentAccess.threadGroupSubcomponentTypeAssignment_2_0)
		)
	}
	...
	def dispatch void format(SubprogramSubcomponent subprogramSubcomponent, extension IFormattableDocument document) {
		formatSubcomponentCommon(
			...
			document,
			subprogramSubcomponent.regionFor.assignment(
				subprogramSubcomponentAccess.subprogramSubcomponentTypeAssignment_2_0)
		)
	}

	def dispatch void format(SubprogramGroupSubcomponent subprogramGroupSubcomponent,
		extension IFormattableDocument document) {
		subprogramGroupSubcomponent.regionFor.keyword(subprogramGroupKeywordsAccess.subprogramKeyword_0).append [
			oneSpace
		]
		formatSubcomponentCommon(
			subprogramGroupSubcomponent,
			document,
			subprogramGroupSubcomponent.regionFor.assignment(
				subprogramGroupSubcomponentAccess.subprogramGroupSubcomponentTypeAssignment_2_0)
		)
	}
	...
	def dispatch void format(ProcessorSubcomponent processorSubcomponent, extension IFormattableDocument document) {
		formatSubcomponentCommon(
			...
			document,
			processorSubcomponent.regionFor.assignment(
				processorSubcomponentAccess.processorSubcomponentTypeAssignment_2_0)
		)
	}

	def dispatch void format(VirtualProcessorSubcomponent virtualProcessorSubcomponent,
		extension IFormattableDocument document) {
		...
		formatSubcomponentCommon(
			...
			document,
			virtualProcessorSubcomponent.regionFor.assignment(
				virtualProcessorSubcomponentAccess.virtualProcessorSubcomponentTypeAssignment_2_0)
		)
	}
	...
	def dispatch void format(VirtualBusSubcomponent virtualBusSubcomponent, extension IFormattableDocument document) {
		...
		formatSubcomponentCommon(
			...
			document,
			virtualBusSubcomponent.regionFor.assignment(
				virtualBusSubcomponentAccess.virtualBusSubcomponentTypeAssignment_2_0)
		)
	}
	...
	def dispatch void format(ComponentImplementationReference componentImplementationReference,
		extension IFormattableDocument document) {
		val leftParenthesis = componentImplementationReference.regionFor.keyword(
			componentImplementationReferenceAccess.leftParenthesisKeyword_2_0)
		val rightParenthesis = componentImplementationReference.regionFor.keyword(
			componentImplementationReferenceAccess.rightParenthesisKeyword_2_3)
		if (leftParenthesis !== null && rightParenthesis !== null) {
			interior(leftParenthesis, rightParenthesis, [indent])
			leftParenthesis.prepend[oneSpace].append[noSpace; setNewLines(0, 0, 1); autowrap]
			componentImplementationReference.ownedPrototypeBindings.forEach[it.format(document)]
			componentImplementationReference.regionFor.keywords(
				componentImplementationReferenceAccess.commaKeyword_2_2_0).forEach [
				prepend[noSpace].append[oneSpace; setNewLines(0, 0, 1); autowrap]
			]
			if (rightParenthesis.previousHiddenRegion.multiline) {
				rightParenthesis.prepend[newLines = 1]
	...
	def private formatConnectionCommon(Connection connection, extension IFormattableDocument document) {
		...
		formatCurlyProperties(connection, document, connection.regionFor.keyword("{"),
			connection.regionFor.keyword("}"))
		...
		if (leftParenthesis !== null && rightParenthesis !== null) {
			...
			interior(leftParenthesis, rightParenthesis, [indent])
			leftParenthesis.prepend[oneSpace].append[noSpace; setNewLines(0, 0, 1); autowrap]
			connection.regionFor.keywords(",").forEach [
				prepend[noSpace].append[oneSpace; setNewLines(0, 0, 1); autowrap]
			]
			if (rightParenthesis.previousHiddenRegion.multiline) {
				rightParenthesis.prepend[newLines = 1]
	...
	def dispatch void format(FlowSpecification flowSpecification, extension IFormattableDocument document) {
		...
		formatCurlyProperties(flowSpecification, document, flowSpecification.regionFor.keyword("{"),
			flowSpecification.regionFor.keyword("}"))
	...
	def dispatch void format(FlowImplementation flowImplementation, extension IFormattableDocument document) {
		...
		formatCurlyProperties(flowImplementation, document, flowImplementation.regionFor.keyword("{"),
			flowImplementation.regionFor.keyword("}"))
	...
	def protected void performModification(EObject semanticObject, Runnable runnable) {
		val resourceSet = semanticObject?.eResource()?.getResourceSet()
		val TransactionalEditingDomain domain = if (resourceSet === null)
				null
			else
