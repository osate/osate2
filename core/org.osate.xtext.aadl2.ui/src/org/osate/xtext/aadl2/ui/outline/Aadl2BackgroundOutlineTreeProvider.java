...
/**
 * Customization of the default outline structure (SHould be able to run in a background thread)
 *
 * @since 5.0
 */
public class Aadl2BackgroundOutlineTreeProvider extends BackgroundOutlineTreeProvider {
	@Override
