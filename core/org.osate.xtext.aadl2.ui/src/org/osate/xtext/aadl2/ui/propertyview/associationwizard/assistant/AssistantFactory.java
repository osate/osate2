...
public class AssistantFactory {
	...
	public static AbstractAssistant getAssistantForType(Composite parent, PropertyType type, ISerializer serializer,
			NamedElement holder, AssistantValueChangedListener listener) {
