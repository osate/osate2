...
public class ResoluteUtil {
	...
	private final static String CLASS_ID = "com.rockwellcollins.atc.resolute.analysis.execution.ResoluteInterface";
	...
	public static ResoluteAccess getResolute() {
		...
		if (RESOLUTE == null) {
			try {
				...
				RESOLUTE = (ResoluteAccess) resoluteInterface.getDeclaredConstructor().newInstance();
			} catch (Exception e) {
