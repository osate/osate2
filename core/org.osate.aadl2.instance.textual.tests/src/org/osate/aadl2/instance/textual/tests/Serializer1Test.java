...
public class Serializer1Test extends AbstractSerializerTest {
	@Inject
	...
	public void testNestedPackage() throws Exception {
		var abcd = testHelper.parseString("""
				package a::b::c::d
				public
					system s
					end s;
	...
	@Test
	public void testSimpleAcrossConnection() throws Exception {
		var pkg1 = testHelper.parseString("""
				package pkg1
				public
					system s
	...
	@Test
	public void testAcrossToComponentConnection() throws Exception {
		var pkg1 = testHelper.parseString("""
				package pkg1
				public
					processor p
	...
	@Test
	public void testUpAndDownAndAcrossConnection() throws Exception {
		var pkg1 = testHelper.parseString("""
				package pkg1
				public
					thread t1
	...
	@Test
	public void testUpAndDownConnections() throws Exception {
		var pkg1 = testHelper.parseString("""
				package pkg1
				public
					process p
	...
	@Test
	public void testConnectionInSubcomponent() throws Exception {
		var pkg1 = testHelper.parseString("""
				package pkg1
				public
					thread t1
	...
	@Test
	public void testConnectionKinds() throws Exception {
		var pkg1 = testHelper.parseString("""
				package pkg1
				public
					abstract a1
	...
	@Test
	public void testFeatureGroupConnections() throws Exception {
		var pkg1 = testHelper.parseString("""
				package pkg1
				public
					feature group fgt1
