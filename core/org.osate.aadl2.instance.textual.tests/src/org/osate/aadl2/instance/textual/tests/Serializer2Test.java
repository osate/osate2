...
@InjectWith(InstanceInjectorProvider.class)
public class Serializer2Test extends AbstractSerializerTest {
	@Inject
	private TestHelper<AadlPackage> testHelper;

	@Test
	public void testEndToEndFlows() throws Exception {
	...
	@Test
	public void testInModes() throws Exception {
		var pkg1 = testHelper.parseString("""
				package pkg1
				public
					system s1
	...
	@Test
	public void testParentMode() throws Exception {
		var pkg1 = testHelper.parseString("""
				package pkg1
				public
					system s1
	...
	@Test
	public void testModeTransitionInstances() throws Exception {
		var pkg1 = testHelper.parseString("""
				package pkg1
				public
					system s
	...
	@Test
	public void testModeTransitionTriggers() throws Exception {
		var pkg1 = testHelper.parseString("""
				package pkg1
				public
					system s1
	...
	@Test
	public void testInModeTransitions() throws Exception {
		var pkg1 = testHelper.parseString("""
				package pkg1
				public
					system s1
	...
	@Test
	public void testPropertyAssociations() throws Exception {
		var pkg1 = testHelper.parseString("""
				package pkg1
				public
					with ps1;
	...
	@Test
	public void testModalProperties() throws Exception {
		var pkg1 = testHelper.parseString("""
				package pkg1
				public
					with ps1;
	...
	@Test
	public void testDeclarativeReferenceValue() throws Exception {
		var pkg1 = testHelper.parseString("""
				package pkg1
				public
					with ps1;
	...
	@Test
	public void testInstanceReferenceValue() throws Exception {
		var pkg1 = testHelper.parseString("""
				package pkg1
				public
					with ps1;
