...
/**
 * Which side of the pivot a leg descends towards.
 *
 * <p>
 ...
 */
public enum LegRole {
	/** Towards the ultimate source, following declarations opposite semantic direction. */
	SOURCE_LEG,

	/** Towards the ultimate destination, following declarations in semantic direction. */
	DESTINATION_LEG;

	/**
	 * Whether a candidate segment is entered from its declared destination side. The
	 * source leg travels against semantic direction, so it arrives at a declaration's
	 * destination and continues from its source.
	 */
