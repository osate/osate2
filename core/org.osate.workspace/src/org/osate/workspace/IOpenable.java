...
public interface IOpenable {
	 ...
	 *                resource.
	 * @return the buffer opened for this element, or <code>null</code> if this
	 *         element does not have a buffer
	 */
//public IBuffer getBuffer() throws AadlModelException;
	/**
	 ...
	 * <code>ICompilationUnit#reconcile()</code> operation will not account for
	 ...
	 */
	void makeConsistent(IProgressMonitor progress) throws AadlModelException;
	 ...
	 *                </ul>
	 */
	public void open(IProgressMonitor progress) throws AadlModelException;
	 ...
	 *                <ul>
	 *                <li>This Java element does not exist
	 *                (ELEMENT_DOES_NOT_EXIST)</li> <li>This Java element is
	 *                read-only (READ_ONLY)</li>
	 *                </ul>
	 */
	public void save(IProgressMonitor progress, boolean force) throws AadlModelException;
}
