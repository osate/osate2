...
public final class CharOperation {
	 ...
	 * @return the concatenation of the three arrays, or null if the three arrays
	 *         are null.
	 */
	 ...
	 * @param array the array that is concanated with the prefix and suffix
	 *            characters
	 * @param suffix the suffix character
	 * @return the new array
	 */
	 ...
	 * @param first the first array
	 * @param second the second array
	 * @param isCaseSensitive check whether or not the equality should be case
	 *            sensitive
	 * @return true if the two arrays are identical character by character
	 ...
	 * @param first the first array
	 * @param second the second array
	 * @param secondStart inclusive start position in the second array to
	 *            compare
	 ...
	 * case insensitive. Answers true if the name contains the fragment at the
	 * starting index startIndex, otherwise false. <br>
	 * <br>
	 * For example:
	 * <ol>
	 * <li>
	 ...
	 *         otherwise
	 * @throws NullPointerException if array is null
	 * @throws ArrayIndexOutOfBoundsException if endIndex is greater or equals
	 *             to array length or starting is lower than 0
	 */
	 ...
	 * char[] pattern matching accepts wild-cards '*' and '?'. When not case
	 * sensitive, the pattern is assumed to already be lowercased, the name will
	 * be lowercased character per character as comparing. If name is null, the
	 * answer is false. If pattern is null, the answer is true if name is not
	 * null. <br>
	 * <br>
	 * For example:
	 * <ol>
	 ...
	 * @param name the given name
	 * @param isCaseSensitive flag to know whether or not the matching should be
	 *            case sensitive
	 ...
	 * @param isCaseSensitive flag to know if the matching should be case
	 *            sensitive
	 ...
	 * false otherwise. Path char[] pattern matching, accepting wild-cards '**',
	 * '*' and '?' (using Ant directory tasks conventions, also see
	 ...
	 * @param isCaseSensitive to find out whether or not the matching should be
	 *            case sensitive
	 ...
	 *         otherwise
	 * @throws NullPointerException if the given name is null or if the given
	 *             prefix is null
	 */
	 ...
	 * @param prefix the given prefix
	 * @param name the given name
	 * @param isCaseSensitive to find out whether or not the comparison should
	 *            be case sensitive
	 * @return true if the given name starts with the given prefix, false
	 *         otherwise
	 * @throws NullPointerException if the given name is null or if the given
