...
editor = bot.editorByTitle("AADL2.EMF.merged.uml");
editor.show();
editor.setFocus();
tree = editor.bot().tree();
root = tree.getTreeItem("platform:/resource/org.osate.aadl2.metamodel/Models/AADL2.EMF.merged.uml");
waitExpand(root);
...
shell = bot.shell("Merge Package 'AADL2 - AADL2.EMF.merged.uml'");
