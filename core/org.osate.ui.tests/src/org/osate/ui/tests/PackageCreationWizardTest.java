...
public class PackageCreationWizardTest {
	...
	public static void closeWelcome() {
		bot.editorByTitle("Welcome").close();
	}
	...
	public void testDuplicateNameError() {
		...
		bot.text().setText("p2");
		Assert.assertEquals(" Package 'p2' already exists in project 'B' that depends on the selected project: 'p2.aadl'", bot.text(1).getText());
		...
		bot.text().setText("p1");
		Assert.assertEquals(" Package 'p1' already exists in project 'A' that the selected project depends on: 'p1.aadl'", bot.text(1).getText());
		bot.text().setText("p2");
