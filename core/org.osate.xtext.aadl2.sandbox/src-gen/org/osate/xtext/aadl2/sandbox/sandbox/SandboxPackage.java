...
public interface SandboxPackage extends EPackage
{
  ...
  /**
   * Returns the meta object for the reference '{@link org.osate.xtext.aadl2.sandbox.sandbox.SystemConfiguration#getSystemImplementation <em>System Implementation</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
