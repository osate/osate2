	...
	public static final class NameMappings {
		...
		private static final class Init0 {
			private static void doInit(ImmutableMap.Builder<AbstractElement, String> builder, Aadl2GrammarAccess grammarAccess) {
				...
				builder.put(grammarAccess.getBusImplementationAccess().getAlternatives_11_1_0(), "rule__BusImplementation__Alternatives_11_1_0");
				builder.put(grammarAccess.getBusImplementationAccess().getAlternatives_12_1(), "rule__BusImplementation__Alternatives_12_1");
				...
				builder.put(grammarAccess.getVirtualBusImplementationAccess().getAlternatives_12_1_0(), "rule__VirtualBusImplementation__Alternatives_12_1_0");
				builder.put(grammarAccess.getVirtualBusImplementationAccess().getAlternatives_13_1(), "rule__VirtualBusImplementation__Alternatives_13_1");
				...
				builder.put(grammarAccess.getBusImplementationAccess().getGroup_12(), "rule__BusImplementation__Group_12__0");
				builder.put(grammarAccess.getBusImplementationAccess().getGroup_12_1_1(), "rule__BusImplementation__Group_12_1_1__0");
				...
				builder.put(grammarAccess.getVirtualBusImplementationAccess().getGroup_13(), "rule__VirtualBusImplementation__Group_13__0");
				builder.put(grammarAccess.getVirtualBusImplementationAccess().getGroup_13_1_1(), "rule__VirtualBusImplementation__Group_13_1_1__0");
				...
				builder.put(grammarAccess.getMemoryImplementationAccess().getOwnedVirtualBusSubcomponentAssignment_8_1_0_3(), "rule__MemoryImplementation__OwnedVirtualBusSubcomponentAssignment_8_1_0_3");
				...
				builder.put(grammarAccess.getBusImplementationAccess().getOwnedPortConnectionAssignment_10_1_0_0(), "rule__BusImplementation__OwnedPortConnectionAssignment_10_1_0_0");
				builder.put(grammarAccess.getBusImplementationAccess().getOwnedAccessConnectionAssignment_10_1_0_1(), "rule__BusImplementation__OwnedAccessConnectionAssignment_10_1_0_1");
				builder.put(grammarAccess.getBusImplementationAccess().getOwnedFeatureGroupConnectionAssignment_10_1_0_2(), "rule__BusImplementation__OwnedFeatureGroupConnectionAssignment_10_1_0_2");
				builder.put(grammarAccess.getBusImplementationAccess().getOwnedFeatureConnectionAssignment_10_1_0_3(), "rule__BusImplementation__OwnedFeatureConnectionAssignment_10_1_0_3");
				builder.put(grammarAccess.getBusImplementationAccess().getNoConnectionsAssignment_10_1_1_0(), "rule__BusImplementation__NoConnectionsAssignment_10_1_1_0");
				builder.put(grammarAccess.getBusImplementationAccess().getOwnedModeAssignment_11_1_0_0(), "rule__BusImplementation__OwnedModeAssignment_11_1_0_0");
				builder.put(grammarAccess.getBusImplementationAccess().getOwnedModeTransitionAssignment_11_1_0_1(), "rule__BusImplementation__OwnedModeTransitionAssignment_11_1_0_1");
				builder.put(grammarAccess.getBusImplementationAccess().getNoModesAssignment_11_1_1_0(), "rule__BusImplementation__NoModesAssignment_11_1_1_0");
				builder.put(grammarAccess.getBusImplementationAccess().getOwnedPropertyAssociationAssignment_12_1_0(), "rule__BusImplementation__OwnedPropertyAssociationAssignment_12_1_0");
				builder.put(grammarAccess.getBusImplementationAccess().getNoPropertiesAssignment_12_1_1_0(), "rule__BusImplementation__NoPropertiesAssignment_12_1_1_0");
				builder.put(grammarAccess.getBusImplementationAccess().getOwnedAnnexSubclauseAssignment_13(), "rule__BusImplementation__OwnedAnnexSubclauseAssignment_13");
				...
				builder.put(grammarAccess.getVirtualBusImplementationAccess().getOwnedPortConnectionAssignment_11_1_0_0(), "rule__VirtualBusImplementation__OwnedPortConnectionAssignment_11_1_0_0");
				builder.put(grammarAccess.getVirtualBusImplementationAccess().getOwnedAccessConnectionAssignment_11_1_0_1(), "rule__VirtualBusImplementation__OwnedAccessConnectionAssignment_11_1_0_1");
				builder.put(grammarAccess.getVirtualBusImplementationAccess().getOwnedFeatureGroupConnectionAssignment_11_1_0_2(), "rule__VirtualBusImplementation__OwnedFeatureGroupConnectionAssignment_11_1_0_2");
				builder.put(grammarAccess.getVirtualBusImplementationAccess().getOwnedFeatureConnectionAssignment_11_1_0_3(), "rule__VirtualBusImplementation__OwnedFeatureConnectionAssignment_11_1_0_3");
				builder.put(grammarAccess.getVirtualBusImplementationAccess().getNoConnectionsAssignment_11_1_1_0(), "rule__VirtualBusImplementation__NoConnectionsAssignment_11_1_1_0");
				builder.put(grammarAccess.getVirtualBusImplementationAccess().getOwnedModeAssignment_12_1_0_0(), "rule__VirtualBusImplementation__OwnedModeAssignment_12_1_0_0");
				builder.put(grammarAccess.getVirtualBusImplementationAccess().getOwnedModeTransitionAssignment_12_1_0_1(), "rule__VirtualBusImplementation__OwnedModeTransitionAssignment_12_1_0_1");
				builder.put(grammarAccess.getVirtualBusImplementationAccess().getNoModesAssignment_12_1_1_0(), "rule__VirtualBusImplementation__NoModesAssignment_12_1_1_0");
				builder.put(grammarAccess.getVirtualBusImplementationAccess().getOwnedPropertyAssociationAssignment_13_1_0(), "rule__VirtualBusImplementation__OwnedPropertyAssociationAssignment_13_1_0");
				builder.put(grammarAccess.getVirtualBusImplementationAccess().getNoPropertiesAssignment_13_1_1_0(), "rule__VirtualBusImplementation__NoPropertiesAssignment_13_1_1_0");
				builder.put(grammarAccess.getVirtualBusImplementationAccess().getOwnedAnnexSubclauseAssignment_14(), "rule__VirtualBusImplementation__OwnedAnnexSubclauseAssignment_14");
