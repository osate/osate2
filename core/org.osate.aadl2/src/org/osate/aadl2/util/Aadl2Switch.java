...
public class Aadl2Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		...
		case Aadl2Package.AADL_PACKAGE: {
			...
			if (result == null)
				result = caseAadlUnit(aadlPackage);
			if (result == null)
		...
		case Aadl2Package.AADL_UNIT: {
			AadlUnit aadlUnit = (AadlUnit) theEObject;
			T result = caseAadlUnit(aadlUnit);
			if (result == null)
				result = caseNamedElement(aadlUnit);
			if (result == null)
				result = caseElement(aadlUnit);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		...
		case Aadl2Package.PROPERTY_SET: {
			...
			if (result == null)
				result = caseAadlUnit(propertySet);
			if (result == null)
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Aadl Unit</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Aadl Unit</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseAadlUnit(AadlUnit object) {
		return null;
	}
