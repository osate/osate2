 ...
 * </copyright>
 *
 * $Id: VirtualProcessorTypeImpl.java,v 1.19 2011-04-11 13:35:53 lwrage Exp $
 */
 ...
 * <ul>
 *   <li>{@link org.osate.aadl2.impl.VirtualProcessorTypeImpl#getOwnedFeatures <em>Owned Feature</em>}</li>
 *   <li>{@link org.osate.aadl2.impl.VirtualProcessorTypeImpl#getOwnedDataPorts <em>Owned Data Port</em>}</li>
 *   <li>{@link org.osate.aadl2.impl.VirtualProcessorTypeImpl#getOwnedEventDataPorts <em>Owned Event Data Port</em>}</li>
 ...
 * @generated
 */
public class VirtualProcessorTypeImpl extends ComponentTypeImpl implements
			...
			if (ownedFeatures == null) {
				cache.put(
						...
						ownedFeatures = new DerivedUnionEObjectEList<Feature>(
								Feature.class,
								this,
								Aadl2Package.VIRTUAL_PROCESSOR_TYPE__OWNED_FEATURE,
	...
	protected static final int[] OWNED_FEATURE_ESUBSETS = new int[] {
			Aadl2Package.VIRTUAL_PROCESSOR_TYPE__OWNED_FEATURE_GROUP,
			Aadl2Package.VIRTUAL_PROCESSOR_TYPE__OWNED_ABSTRACT_FEATURE,
	...
	public boolean isSetOwnedFeatures() {
		return super.isSetOwnedFeatures()
				|| eIsSet(Aadl2Package.VIRTUAL_PROCESSOR_TYPE__OWNED_DATA_PORT)
