...
public class AadlPackageImpl extends ModelUnitImpl implements AadlPackage {
			...
			if (ownedElements == null) {
				cache.put(eResource, this, Aadl2Package.eINSTANCE
						...
						ownedElements = new DerivedUnionEObjectEList<Element>(
								Element.class, this,
								Aadl2Package.AADL_PACKAGE__OWNED_ELEMENT,
	...
	protected static final int[] OWNED_ELEMENT_ESUBSETS = new int[] {
			Aadl2Package.AADL_PACKAGE__OWNED_COMMENT,
	...
	public void setNoProperties(boolean newNoProperties) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					Aadl2Package.AADL_PACKAGE__NO_PROPERTIES, oldNoProperties,
					noProperties));
	}
	...
	public boolean isSetOwnedElements() {
		return super.isSetOwnedElements()
				|| eIsSet(Aadl2Package.AADL_PACKAGE__OWNED_PUBLIC_SECTION)
