 ...
 * 
 *
 * $Id: FeatureConnectionImpl.java,v 1.4 2009-03-25 18:34:50 lwrage Exp $
 */
 ...
 * <ul>
 *   <li>{@link org.osate.aadl2.impl.FeatureConnectionImpl#getSource <em>Source</em>}</li>
 *   <li>{@link org.osate.aadl2.impl.FeatureConnectionImpl#getDestination <em>Destination</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class FeatureConnectionImpl extends ConnectionImpl implements FeatureConnection {
	 ...
	 * @generated
	 */
	protected FeatureConnectionImpl() {
		super();
	}
		...
		if (source != null && ((EObject) source).eIsProxy()) {
			...
			if (source != oldSource) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Aadl2Package.FEATURE_CONNECTION__SOURCE,
							oldSource, source));
			}
		}
		return source;
	...
	public void setSource(ConnectionEnd newSource) {
		...
		source = newSource;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Aadl2Package.FEATURE_CONNECTION__SOURCE, oldSource,
					source));
	}
			...
			if (destination != oldDestination) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							Aadl2Package.FEATURE_CONNECTION__DESTINATION, oldDestination, destination));
			}
		}
		return destination;
	}
	...
	public void setDestination(ConnectionEnd newDestination) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Aadl2Package.FEATURE_CONNECTION__DESTINATION,
