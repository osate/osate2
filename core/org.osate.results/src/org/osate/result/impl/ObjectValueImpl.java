 ...
 * </p>
 * <ul>
 *   <li>{@link org.osate.result.impl.ObjectValueImpl#getValue <em>Value</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ObjectValueImpl extends ValueImpl implements ObjectValue {
	...
	protected EClass eStaticClass() {
		return ResultPackage.Literals.OBJECT_VALUE;
	}
	...
	public void setValue(Object newValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ResultPackage.OBJECT_VALUE__VALUE, oldValue, value));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ResultPackage.OBJECT_VALUE__VALUE:
				return getValue();
		}
