 ...
 * </p>
 * <ul>
 *   <li>{@link org.osate.result.impl.BooleanValueImpl#isValue <em>Value</em>}</li>
 * </ul>
 *
 * @generated
 */
public class BooleanValueImpl extends ValueImpl implements BooleanValue {
	...
	protected EClass eStaticClass() {
		return ResultPackage.Literals.BOOLEAN_VALUE;
	}
	...
	public void setValue(boolean newValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ResultPackage.BOOLEAN_VALUE__VALUE, oldValue, value));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ResultPackage.BOOLEAN_VALUE__VALUE:
				return isValue();
		}
