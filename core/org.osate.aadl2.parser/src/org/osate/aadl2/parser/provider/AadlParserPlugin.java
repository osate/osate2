 ...
 * </copyright>
 *
 * @version $Id: AadlParserPlugin.java,v 1.7 2005-08-15 16:41:46 lwrage Exp $
 */
package org.osate.aadl2.parser.provider;
...
public final class AadlParserPlugin extends EMFPlugin {
	...
	public static final String PLUGIN_ID = "org.osate.aadl2.parser";
	...
	public static void internalError(String message)  {
		INSTANCE.log("*** Internal error: " + message);
	}
