...
public class NotCollocated extends GeneratedRecord {
	public static final String TARGETS__NAME = "Targets";
	public static final String LOCATION__NAME = "Location";
	public static final URI TARGETS__URI = URI.createURI("platform:/plugin/org.osate.aadl2.contrib/resources/properties/Predeclared_Property_Sets/Deployment_Properties.aadl#/0/@ownedProperty.18/@ownedPropertyType/@ownedField.0");
	public static final URI LOCATION__URI = URI.createURI("platform:/plugin/org.osate.aadl2.contrib/resources/properties/Predeclared_Property_Sets/Deployment_Properties.aadl#/0/@ownedProperty.18/@ownedPropertyType/@ownedField.1");
	
	private final Optional<List<InstanceObject>> targets;
	private final Optional<Classifier> location;
	
	public NotCollocated(
	...
	public NotCollocated(PropertyExpression propertyExpression, NamedElement lookupContext, Optional<Mode> mode) {
	...
	public NotCollocated(PropertyExpression propertyExpression) {
		RecordValue recordValue = (RecordValue) propertyExpression;
	...
	public boolean equals(Object obj) {
		...
		if (!(obj instanceof NotCollocated)) {
			return false;
		}
		NotCollocated other = (NotCollocated) obj;
