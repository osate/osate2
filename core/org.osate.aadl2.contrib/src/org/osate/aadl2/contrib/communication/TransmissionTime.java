...
public class TransmissionTime extends GeneratedRecord {
	public static final String FIXED__NAME = "Fixed";
	public static final String PERBYTE__NAME = "PerByte";
	public static final URI FIXED__URI = URI.createURI("platform:/plugin/org.osate.aadl2.contrib/resources/properties/Predeclared_Property_Sets/Communication_Properties.aadl#/0/@ownedProperty.14/@ownedPropertyType/@ownedField.0");
	public static final URI PERBYTE__URI = URI.createURI("platform:/plugin/org.osate.aadl2.contrib/resources/properties/Predeclared_Property_Sets/Communication_Properties.aadl#/0/@ownedProperty.14/@ownedPropertyType/@ownedField.1");
	...
	public TransmissionTime(PropertyExpression propertyExpression, NamedElement lookupContext, Optional<Mode> mode) {
	...
	public TransmissionTime(PropertyExpression propertyExpression) {
		RecordValue recordValue = (RecordValue) propertyExpression;
	...
	public boolean equals(Object obj) {
		...
		if (!(obj instanceof TransmissionTime)) {
			return false;
		}
		TransmissionTime other = (TransmissionTime) obj;
