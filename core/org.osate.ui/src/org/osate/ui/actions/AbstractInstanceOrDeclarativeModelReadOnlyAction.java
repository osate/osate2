...
public abstract class AbstractInstanceOrDeclarativeModelReadOnlyAction extends AaxlReadOnlyActionAsJob {
	...
	private static final String[] ALL_MODE_CHOICE_LABELS = {
		INITIAL_MODE_LABEL, CHOOSE_MODE_LABEL, ALL_MODES_LABEL };
	private static final String[] SINGLE_MODE_CHOICE_LABELS = {
		INITIAL_MODE_LABEL, CHOOSE_MODE_LABEL };
	 ...
	 */
	protected abstract void analyzeDeclarativeModel(
	 ...
	 */
	protected abstract void analyzeInstanceModel(
			IProgressMonitor monitor, AnalysisErrorReporterManager errManager,
