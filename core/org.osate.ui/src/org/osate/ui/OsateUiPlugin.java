...
import org.osate.ui.rerun.internal.impl.CyclicRerunManager;
...
public class OsateUiPlugin extends AbstractUIPlugin {
	...
	private static final RerunManager rerunManager = new CyclicRerunManager();
	 ...
	 * @since 6.0
	 */
	public static RerunManager getRerunManager() {
		return rerunManager;
	}
}