...
The diagram in Figure 32 of the TR is generated by opening main.aadl in the "functional" folder and selecting *system implementation Aircraft.basic*. If this implementation is instantiated running a Fault Impact Analysis produces an output identical to that in Figure 36 of the TR.
