 ...
 * @generated
 */
public class OrlessExpressionImpl extends TriggerConditionExpressionImpl implements OrlessExpression
{
  /**
   ...
   * @ordered
   */
  protected EList<StateConditionExpression> operands;
   ...
   * @generated
   */
  public EList<StateConditionExpression> getOperands()
  {
    if (operands == null)
    {
      operands = new EObjectContainmentEList<StateConditionExpression>(StateConditionExpression.class, this, ErrorModelPackage.ORLESS_EXPRESSION__OPERANDS);
    }
    return operands;
  }
  ...
  public void eSet(int featureID, Object newValue)
  {
    switch (featureID)
    {
      ...
      case ErrorModelPackage.ORLESS_EXPRESSION__OPERANDS:
        getOperands().clear();
        getOperands().addAll((Collection<? extends StateConditionExpression>)newValue);
        return;
    }
