...
/** Verifies exact generated Java for integer with units. */
...
public class IntegerWithUnitsTest {
	...
	@Test
	public void testIntegerWithUnits() throws Exception {
		var otherPs = """
				property set other_ps is
				\tmass: type units (g, kg => g * 1000);
				end other_ps;
				""";
		var integerWithUnitsTest = """
		...
		var integerWithUnitsTestClass = """
				...
				\t\tvar name = INTEGER_WITH_UNITS_TEST__NAME + "::" + OWNED__NAME;
				...
				\t\tvar name = INTEGER_WITH_UNITS_TEST__NAME + "::" + SAME_FILE__NAME;
				\t\treturn Aadl2GlobalScopeUtil.get(lookupContext, Aadl2Package.eINSTANCE.getProperty(), name);
				\t}
				...
				\t\tvar name = INTEGER_WITH_UNITS_TEST__NAME + "::" + OTHER_FILE__NAME;
				\t\treturn Aadl2GlobalScopeUtil.get(lookupContext, Aadl2Package.eINSTANCE.getProperty(), name);
				\t}
				...
				\t\tvar name = INTEGER_WITH_UNITS_TEST__NAME + "::" + LIST_1_OWNED__NAME;
				\t\treturn Aadl2GlobalScopeUtil.get(lookupContext, Aadl2Package.eINSTANCE.getProperty(), name);
				\t}
				...
				\t\tvar name = INTEGER_WITH_UNITS_TEST__NAME + "::" + LIST_1_SAME_FILE__NAME;
				\t\treturn Aadl2GlobalScopeUtil.get(lookupContext, Aadl2Package.eINSTANCE.getProperty(), name);
				\t}
				...
				\t\tvar name = INTEGER_WITH_UNITS_TEST__NAME + "::" + LIST_1_OTHER_FILE__NAME;
				\t\treturn Aadl2GlobalScopeUtil.get(lookupContext, Aadl2Package.eINSTANCE.getProperty(), name);
				\t}
				...
				\t\tvar name = INTEGER_WITH_UNITS_TEST__NAME + "::" + RECORD_PROPERTY__NAME;
				\t\treturn Aadl2GlobalScopeUtil.get(lookupContext, Aadl2Package.eINSTANCE.getProperty(), name);
				\t}
				...
				\t\tvar name = INTEGER_WITH_UNITS_TEST__NAME + "::" + OWNED_CONSTANT__NAME;
				...
				\t\tvar name = INTEGER_WITH_UNITS_TEST__NAME + "::" + SAME_FILE_CONSTANT__NAME;
				\t\treturn Aadl2GlobalScopeUtil.get(lookupContext, Aadl2Package.eINSTANCE.getPropertyConstant(), name);
				\t}
				...
				\t\tvar name = INTEGER_WITH_UNITS_TEST__NAME + "::" + OTHER_FILE_CONSTANT__NAME;
				\t\treturn Aadl2GlobalScopeUtil.get(lookupContext, Aadl2Package.eINSTANCE.getPropertyConstant(), name);
				\t}
				...
				\t\tvar name = INTEGER_WITH_UNITS_TEST__NAME + "::" + LIST_1_OWNED_CONSTANT__NAME;
				\t\treturn Aadl2GlobalScopeUtil.get(lookupContext, Aadl2Package.eINSTANCE.getPropertyConstant(), name);
				\t}
				...
				\t\tvar name = INTEGER_WITH_UNITS_TEST__NAME + "::" + LIST_1_SAME_FILE_CONSTANT__NAME;
				\t\treturn Aadl2GlobalScopeUtil.get(lookupContext, Aadl2Package.eINSTANCE.getPropertyConstant(), name);
				\t}
				...
				\t\tvar name = INTEGER_WITH_UNITS_TEST__NAME + "::" + LIST_1_OTHER_FILE_CONSTANT__NAME;
				\t\treturn Aadl2GlobalScopeUtil.get(lookupContext, Aadl2Package.eINSTANCE.getPropertyConstant(), name);
				\t}
				...
				\t\tvar constant = getRecordConstant_PropertyConstant(lookupContext);
				\t\tvar resolved = CodeGenUtil.resolveNamedValue(constant.getConstantValue());
				...
				\t\tvar name = INTEGER_WITH_UNITS_TEST__NAME + "::" + RECORD_CONSTANT__NAME;
				\t\treturn Aadl2GlobalScopeUtil.get(lookupContext, Aadl2Package.eINSTANCE.getPropertyConstant(), name);
				\t}
				}
				""";
		...
		var recordConstant = """
				...
				\t\t\treturn true;
				\t\t}
				\t\tif (!(obj instanceof RecordConstant other)) {
				\t\t\treturn false;
				\t\t}
				\t\treturn Objects.equals(this.owned, other.owned)
				\t\t\t\t&& Objects.equals(this.sameFile, other.sameFile)
				...
				""";
		var results = generateAndCompile(testHelper.parseString(integerWithUnitsTest, otherPs));
		assertEquals("src-gen/integerwithunitstest", results.getPackagePath());
		assertEquals(8, results.getClasses().size());

		assertEquals("IntegerWithUnitsTest.java", results.getClasses().get(0).getFileName());
		assertEquals(integerWithUnitsTestClass, results.getClasses().get(0).getContents());
		...
		assertEquals("RecordConstant.java", results.getClasses().get(7).getFileName());
		assertEquals(recordConstant, results.getClasses().get(7).getContents());
	}
}
