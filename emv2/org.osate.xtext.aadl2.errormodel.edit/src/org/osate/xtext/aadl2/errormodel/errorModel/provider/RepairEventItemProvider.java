 ...
 * @generated
 */
public class RepairEventItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_RepairEvent_condition_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_RepairEvent_condition_feature", "_UI_RepairEvent_type"),
				 ErrorModelPackage.Literals.REPAIR_EVENT__CONDITION,
				 true,
				 false,
				 false,
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(RepairEvent.class)) {
