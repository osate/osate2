...
public class ErrorBehaviorTransitionItemProvider extends NamedElementItemProvider
{
    ...
    itemPropertyDescriptors.add
      (createItemPropertyDescriptor
        (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
         ...
         ErrorModelPackage.Literals.ERROR_BEHAVIOR_TRANSITION__STEADY_STATE,
         true,
         false,
         false,
         ItemPropertyDescriptor.BOOLEAN_VALUE_IMAGE,
  ...
  public String getCreateChildText(Object owner, Object feature, Object child, Collection<?> selection)
  {
    ...
    boolean qualify =
      childFeature == ErrorModelPackage.Literals.ERROR_BEHAVIOR_TRANSITION__TYPE_TOKEN_CONSTRAINT ||
      childFeature == ErrorModelPackage.Literals.ERROR_BEHAVIOR_TRANSITION__TARGET_TOKEN;
