...
/**
 * This is the item provider adapter for a {@link org.osate.xtext.aadl2.errormodel.errorModel.ErrorPropagation} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ErrorPropagationItemProvider extends NamedElementItemProvider
{
    ...
    itemPropertyDescriptors.add
      (createItemPropertyDescriptor
        (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
         ...
         ErrorModelPackage.Literals.ERROR_PROPAGATION__KIND,
         true,
         false,
         false,
    ...
    itemPropertyDescriptors.add
      (createItemPropertyDescriptor
        (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
         ...
         ErrorModelPackage.Literals.ERROR_PROPAGATION__NOT,
         true,
         false,
         false,
    ...
    itemPropertyDescriptors.add
      (createItemPropertyDescriptor
        (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
         ...
         ErrorModelPackage.Literals.ERROR_PROPAGATION__DIRECTION,
         true,
         false,
         false,
         ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
  ...
  public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object)
  {
    if (childrenFeatures == null)
    {
      ...
      childrenFeatures.add(ErrorModelPackage.Literals.ERROR_PROPAGATION__FEATUREOR_PP_REF);
      childrenFeatures.add(ErrorModelPackage.Literals.ERROR_PROPAGATION__TYPE_SET);
    }
  ...
  protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object)
  {
    ...
    newChildDescriptors.add
      (createChildParameter
        (ErrorModelPackage.Literals.ERROR_PROPAGATION__FEATUREOR_PP_REF,
         ErrorModelFactory.eINSTANCE.createFeatureorPPReference()));

    newChildDescriptors.add
      (createChildParameter
        (ErrorModelPackage.Literals.ERROR_PROPAGATION__TYPE_SET,
