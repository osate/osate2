...
/**
 * This is the item provider adapter for a {@link org.osate.xtext.aadl2.errormodel.errorModel.EMV2PropertyAssociation} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class EMV2PropertyAssociationItemProvider extends ElementItemProvider
{
   ...
   * @generated
   */
  public EMV2PropertyAssociationItemProvider(AdapterFactory adapterFactory)
  {
  ...
  public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object)
  {
    if (childrenFeatures == null)
    {
      ...
      childrenFeatures.add(ErrorModelPackage.Literals.EMV2_PROPERTY_ASSOCIATION__OWNED_VALUES);
      childrenFeatures.add(ErrorModelPackage.Literals.EMV2_PROPERTY_ASSOCIATION__EMV2_PATH);
    }
  ...
  /**
   * This returns EMV2PropertyAssociation.gif.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @generated
   */
  ...
  {
    return overlayImage(object, getResourceLocator().getImage("full/obj16/EMV2PropertyAssociation"));
  }
  ...
  public void notifyChanged(Notification notification)
  {
    ...
    switch (notification.getFeatureID(EMV2PropertyAssociation.class))
    {
  ...
  protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object)
  {
    ...
    newChildDescriptors.add
      (createChildParameter
        (ErrorModelPackage.Literals.EMV2_PROPERTY_ASSOCIATION__OWNED_VALUES,
         Aadl2Factory.eINSTANCE.createModalPropertyValue()));

    newChildDescriptors.add
      (createChildParameter
        (ErrorModelPackage.Literals.EMV2_PROPERTY_ASSOCIATION__EMV2_PATH,
         ErrorModelFactory.eINSTANCE.createEMV2Path()));

    newChildDescriptors.add
      (createChildParameter
        (ErrorModelPackage.Literals.EMV2_PROPERTY_ASSOCIATION__EMV2_PATH,
         ErrorModelFactory.eINSTANCE.createQualifiedErrorEventOrPropagation()));
