...
/**
 * This is the item provider adapter for a {@link org.osate.aadl2.errormodel.FaultTree.FaultTree} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class FaultTreeItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_FaultTree_name_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_FaultTree_name_feature", "_UI_FaultTree_type"),
				 FaultTreePackage.Literals.FAULT_TREE__NAME,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(FaultTreePackage.Literals.FAULT_TREE__EVENTS);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(FaultTreePackage.Literals.FAULT_TREE__EVENTS,
				 FaultTreeFactory.eINSTANCE.createEvent()));
	}
