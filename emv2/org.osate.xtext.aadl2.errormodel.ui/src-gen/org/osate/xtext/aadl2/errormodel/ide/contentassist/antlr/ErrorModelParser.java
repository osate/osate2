...
public class ErrorModelParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, ErrorModelGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getErrorModelLibraryAccess().getAlternatives_1_3(), "rule__ErrorModelLibrary__Alternatives_1_3");
			builder.put(grammarAccess.getEMV2LibraryAccess().getAlternatives(), "rule__EMV2Library__Alternatives");
			builder.put(grammarAccess.getEMV2LibraryAccess().getAlternatives_0_1_2_3(), "rule__EMV2Library__Alternatives_0_1_2_3");
			builder.put(grammarAccess.getEMV2LibraryAccess().getAlternatives_1_6_3(), "rule__EMV2Library__Alternatives_1_6_3");
			...
			builder.put(grammarAccess.getErrorSourceAccess().getAlternatives_3(), "rule__ErrorSource__Alternatives_3");
			builder.put(grammarAccess.getErrorSourceAccess().getAlternatives_5_1(), "rule__ErrorSource__Alternatives_5_1");
			builder.put(grammarAccess.getErrorSinkAccess().getAlternatives_3(), "rule__ErrorSink__Alternatives_3");
			builder.put(grammarAccess.getErrorPathAccess().getAlternatives_3(), "rule__ErrorPath__Alternatives_3");
			builder.put(grammarAccess.getErrorPathAccess().getAlternatives_6(), "rule__ErrorPath__Alternatives_6");
			...
			builder.put(grammarAccess.getErrorModelSubclauseAccess().getGroup_1_2(), "rule__ErrorModelSubclause__Group_1_2__0");
			...
			builder.put(grammarAccess.getErrorModelSubclauseAccess().getGroup_5_2(), "rule__ErrorModelSubclause__Group_5_2__0");
			builder.put(grammarAccess.getErrorModelSubclauseAccess().getGroup_6(), "rule__ErrorModelSubclause__Group_6__0");
			builder.put(grammarAccess.getErrorModelSubclauseAccess().getGroup_6_1(), "rule__ErrorModelSubclause__Group_6_1__0");
			builder.put(grammarAccess.getErrorModelSubclauseAccess().getGroup_6_2(), "rule__ErrorModelSubclause__Group_6_2__0");
			...
			builder.put(grammarAccess.getErrorModelSubclauseAccess().getGroup_7_1(), "rule__ErrorModelSubclause__Group_7_1__0");
			builder.put(grammarAccess.getErrorModelSubclauseAccess().getGroup_8(), "rule__ErrorModelSubclause__Group_8__0");
			builder.put(grammarAccess.getErrorModelSubclauseAccess().getGroup_8_1(), "rule__ErrorModelSubclause__Group_8_1__0");
			...
			builder.put(grammarAccess.getEMV2SubclauseAccess().getGroup_3_2(), "rule__EMV2Subclause__Group_3_2__0");
			...
			builder.put(grammarAccess.getEMV2SubclauseAccess().getGroup_7_2(), "rule__EMV2Subclause__Group_7_2__0");
			builder.put(grammarAccess.getEMV2SubclauseAccess().getGroup_8(), "rule__EMV2Subclause__Group_8__0");
			builder.put(grammarAccess.getEMV2SubclauseAccess().getGroup_8_1(), "rule__EMV2Subclause__Group_8_1__0");
			builder.put(grammarAccess.getEMV2SubclauseAccess().getGroup_8_2(), "rule__EMV2Subclause__Group_8_2__0");
			...
			builder.put(grammarAccess.getEMV2SubclauseAccess().getGroup_9_1(), "rule__EMV2Subclause__Group_9_1__0");
			builder.put(grammarAccess.getEMV2SubclauseAccess().getGroup_10(), "rule__EMV2Subclause__Group_10__0");
			builder.put(grammarAccess.getEMV2SubclauseAccess().getGroup_10_1(), "rule__EMV2Subclause__Group_10_1__0");
			...
			builder.put(grammarAccess.getErrorModelLibraryAccess().getGroup_1_1(), "rule__ErrorModelLibrary__Group_1_1__0");
			builder.put(grammarAccess.getErrorModelLibraryAccess().getGroup_1_1_2(), "rule__ErrorModelLibrary__Group_1_1_2__0");
			builder.put(grammarAccess.getErrorModelLibraryAccess().getGroup_1_2(), "rule__ErrorModelLibrary__Group_1_2__0");
			builder.put(grammarAccess.getErrorModelLibraryAccess().getGroup_1_2_2(), "rule__ErrorModelLibrary__Group_1_2_2__0");
			builder.put(grammarAccess.getErrorModelLibraryAccess().getGroup_1_4(), "rule__ErrorModelLibrary__Group_1_4__0");
			...
			builder.put(grammarAccess.getEMV2LibraryAccess().getGroup_0_1_2_1(), "rule__EMV2Library__Group_0_1_2_1__0");
			builder.put(grammarAccess.getEMV2LibraryAccess().getGroup_0_1_2_1_2(), "rule__EMV2Library__Group_0_1_2_1_2__0");
			builder.put(grammarAccess.getEMV2LibraryAccess().getGroup_0_1_2_2(), "rule__EMV2Library__Group_0_1_2_2__0");
			builder.put(grammarAccess.getEMV2LibraryAccess().getGroup_0_1_2_2_2(), "rule__EMV2Library__Group_0_1_2_2_2__0");
			builder.put(grammarAccess.getEMV2LibraryAccess().getGroup_0_1_2_4(), "rule__EMV2Library__Group_0_1_2_4__0");
			...
			builder.put(grammarAccess.getEMV2LibraryAccess().getGroup_1_6_1(), "rule__EMV2Library__Group_1_6_1__0");
			builder.put(grammarAccess.getEMV2LibraryAccess().getGroup_1_6_1_2(), "rule__EMV2Library__Group_1_6_1_2__0");
			builder.put(grammarAccess.getEMV2LibraryAccess().getGroup_1_6_2(), "rule__EMV2Library__Group_1_6_2__0");
			builder.put(grammarAccess.getEMV2LibraryAccess().getGroup_1_6_2_2(), "rule__EMV2Library__Group_1_6_2_2__0");
			builder.put(grammarAccess.getEMV2LibraryAccess().getGroup_1_6_4(), "rule__EMV2Library__Group_1_6_4__0");
			...
			builder.put(grammarAccess.getEMV2PropertyAssociationAccess().getGroup_3_1(), "rule__EMV2PropertyAssociation__Group_3_1__0");
			builder.put(grammarAccess.getEMV2PropertyAssociationAccess().getGroup_3_1_1(), "rule__EMV2PropertyAssociation__Group_3_1_1__0");
			...
			builder.put(grammarAccess.getBasicEMV2PropertyAssociationAccess().getGroup_3_1(), "rule__BasicEMV2PropertyAssociation__Group_3_1__0");
			builder.put(grammarAccess.getBasicEMV2PropertyAssociationAccess().getGroup_3_1_1(), "rule__BasicEMV2PropertyAssociation__Group_3_1_1__0");
			...
			builder.put(grammarAccess.getTypeSetDefinitionAccess().getGroup_1_0_4(), "rule__TypeSetDefinition__Group_1_0_4__0");
			...
			builder.put(grammarAccess.getTypeTransformationSetAccess().getGroup_2(), "rule__TypeTransformationSet__Group_2__0");
			builder.put(grammarAccess.getTypeTransformationSetAccess().getGroup_2_2(), "rule__TypeTransformationSet__Group_2_2__0");
			...
			builder.put(grammarAccess.getTypeMappingSetAccess().getGroup_2(), "rule__TypeMappingSet__Group_2__0");
			builder.put(grammarAccess.getTypeMappingSetAccess().getGroup_2_2(), "rule__TypeMappingSet__Group_2_2__0");
			...
			builder.put(grammarAccess.getErrorSourceAccess().getGroup_5(), "rule__ErrorSource__Group_5__0");
			builder.put(grammarAccess.getErrorSourceAccess().getGroup_5_1_0(), "rule__ErrorSource__Group_5_1_0__0");
			...
			builder.put(grammarAccess.getErrorSinkAccess().getGroup_5(), "rule__ErrorSink__Group_5__0");
			builder.put(grammarAccess.getErrorPathAccess().getGroup(), "rule__ErrorPath__Group__0");
			builder.put(grammarAccess.getErrorPathAccess().getGroup_7_1(), "rule__ErrorPath__Group_7_1__0");
			builder.put(grammarAccess.getErrorPathAccess().getGroup_8(), "rule__ErrorPath__Group_8__0");
			...
			builder.put(grammarAccess.getErrorBehaviorStateMachineAccess().getGroup_2(), "rule__ErrorBehaviorStateMachine__Group_2__0");
			builder.put(grammarAccess.getErrorBehaviorStateMachineAccess().getGroup_2_2(), "rule__ErrorBehaviorStateMachine__Group_2_2__0");
			...
			builder.put(grammarAccess.getErrorEventAccess().getGroup_4(), "rule__ErrorEvent__Group_4__0");
			builder.put(grammarAccess.getRepairEventAccess().getGroup(), "rule__RepairEvent__Group__0");
			builder.put(grammarAccess.getRepairEventAccess().getGroup_3(), "rule__RepairEvent__Group_3__0");
			builder.put(grammarAccess.getRepairEventAccess().getGroup_3_2(), "rule__RepairEvent__Group_3_2__0");
			builder.put(grammarAccess.getRecoverEventAccess().getGroup(), "rule__RecoverEvent__Group__0");
			builder.put(grammarAccess.getRecoverEventAccess().getGroup_3(), "rule__RecoverEvent__Group_3__0");
			builder.put(grammarAccess.getRecoverEventAccess().getGroup_3_2(), "rule__RecoverEvent__Group_3_2__0");
			...
			builder.put(grammarAccess.getErrorStateToModeMappingAccess().getGroup_5(), "rule__ErrorStateToModeMapping__Group_5__0");
			...
			builder.put(grammarAccess.getComponentErrorBehaviorKeywordsAccess().getGroup(), "rule__ComponentErrorBehaviorKeywords__Group__0");
			builder.put(grammarAccess.getCompositeErrorBehaviorKeywordsAccess().getGroup(), "rule__CompositeErrorBehaviorKeywords__Group__0");
			builder.put(grammarAccess.getConnectionErrorKeywordsAccess().getGroup(), "rule__ConnectionErrorKeywords__Group__0");
			builder.put(grammarAccess.getEndBehaviorKeywordsAccess().getGroup(), "rule__EndBehaviorKeywords__Group__0");
			builder.put(grammarAccess.getEndComponentKeywordsAccess().getGroup(), "rule__EndComponentKeywords__Group__0");
			builder.put(grammarAccess.getEndCompositeKeywordsAccess().getGroup(), "rule__EndCompositeKeywords__Group__0");
			builder.put(grammarAccess.getEndConnectionKeywordsAccess().getGroup(), "rule__EndConnectionKeywords__Group__0");
			builder.put(grammarAccess.getEndMappingsKeywordsAccess().getGroup(), "rule__EndMappingsKeywords__Group__0");
			builder.put(grammarAccess.getEndPathsKeywordsAccess().getGroup(), "rule__EndPathsKeywords__Group__0");
			builder.put(grammarAccess.getEndPropagationsKeywordsAccess().getGroup(), "rule__EndPropagationsKeywords__Group__0");
			builder.put(grammarAccess.getEndSubclauseKeywordsAccess().getGroup(), "rule__EndSubclauseKeywords__Group__0");
			builder.put(grammarAccess.getEndTransformationsKeywordsAccess().getGroup(), "rule__EndTransformationsKeywords__Group__0");
			builder.put(grammarAccess.getEndTypesKeywordsAccess().getGroup(), "rule__EndTypesKeywords__Group__0");
			builder.put(grammarAccess.getErrorBehaviorKeywordsAccess().getGroup(), "rule__ErrorBehaviorKeywords__Group__0");
			builder.put(grammarAccess.getErrorEventKeywordsAccess().getGroup(), "rule__ErrorEventKeywords__Group__0");
			builder.put(grammarAccess.getErrorPathKeywordsAccess().getGroup(), "rule__ErrorPathKeywords__Group__0");
			builder.put(grammarAccess.getErrorPropagationsKeywordsAccess().getGroup(), "rule__ErrorPropagationsKeywords__Group__0");
			builder.put(grammarAccess.getErrorSinkKeywordsAccess().getGroup(), "rule__ErrorSinkKeywords__Group__0");
			builder.put(grammarAccess.getErrorSourceKeywordsAccess().getGroup(), "rule__ErrorSourceKeywords__Group__0");
			builder.put(grammarAccess.getErrorTypesKeywordsAccess().getGroup(), "rule__ErrorTypesKeywords__Group__0");
			builder.put(grammarAccess.getModeMappingsKeywordsAccess().getGroup(), "rule__ModeMappingsKeywords__Group__0");
			builder.put(grammarAccess.getPropagationPathsKeywordsAccess().getGroup(), "rule__PropagationPathsKeywords__Group__0");
			builder.put(grammarAccess.getPropagationPointKeywordsAccess().getGroup(), "rule__PropagationPointKeywords__Group__0");
			builder.put(grammarAccess.getRecoverEventKeywordsAccess().getGroup(), "rule__RecoverEventKeywords__Group__0");
			builder.put(grammarAccess.getRepairEventKeywordsAccess().getGroup(), "rule__RepairEventKeywords__Group__0");
			builder.put(grammarAccess.getSameStateKeywordsAccess().getGroup(), "rule__SameStateKeywords__Group__0");
			builder.put(grammarAccess.getTypeMappingsKeywordsAccess().getGroup(), "rule__TypeMappingsKeywords__Group__0");
			builder.put(grammarAccess.getTypeSetKeywordsAccess().getGroup(), "rule__TypeSetKeywords__Group__0");
			builder.put(grammarAccess.getTypeTransformationsKeywordsAccess().getGroup(), "rule__TypeTransformationsKeywords__Group__0");
			builder.put(grammarAccess.getUseBehaviorKeywordsAccess().getGroup(), "rule__UseBehaviorKeywords__Group__0");
			builder.put(grammarAccess.getUseMappingsKeywordsAccess().getGroup(), "rule__UseMappingsKeywords__Group__0");
			builder.put(grammarAccess.getUseTransformationsKeywordsAccess().getGroup(), "rule__UseTransformationsKeywords__Group__0");
			builder.put(grammarAccess.getUseTypeEquivalenceKeywordsAccess().getGroup(), "rule__UseTypeEquivalenceKeywords__Group__0");
			builder.put(grammarAccess.getUseTypesKeywordsAccess().getGroup(), "rule__UseTypesKeywords__Group__0");
			...
			builder.put(grammarAccess.getErrorModelSubclauseAccess().getUseTypesAssignment_1_1(), "rule__ErrorModelSubclause__UseTypesAssignment_1_1");
			builder.put(grammarAccess.getErrorModelSubclauseAccess().getUseTypesAssignment_1_2_1(), "rule__ErrorModelSubclause__UseTypesAssignment_1_2_1");
			builder.put(grammarAccess.getErrorModelSubclauseAccess().getTypeEquivalenceAssignment_2_1(), "rule__ErrorModelSubclause__TypeEquivalenceAssignment_2_1");
			builder.put(grammarAccess.getErrorModelSubclauseAccess().getTypeMappingSetAssignment_3_1(), "rule__ErrorModelSubclause__TypeMappingSetAssignment_3_1");
			builder.put(grammarAccess.getErrorModelSubclauseAccess().getUseBehaviorAssignment_4_1(), "rule__ErrorModelSubclause__UseBehaviorAssignment_4_1");
			builder.put(grammarAccess.getErrorModelSubclauseAccess().getPropagationsAssignment_5_1(), "rule__ErrorModelSubclause__PropagationsAssignment_5_1");
			builder.put(grammarAccess.getErrorModelSubclauseAccess().getFlowsAssignment_5_2_1(), "rule__ErrorModelSubclause__FlowsAssignment_5_2_1");
			builder.put(grammarAccess.getErrorModelSubclauseAccess().getUseTransformationAssignment_6_1_1(), "rule__ErrorModelSubclause__UseTransformationAssignment_6_1_1");
			builder.put(grammarAccess.getErrorModelSubclauseAccess().getEventsAssignment_6_2_1(), "rule__ErrorModelSubclause__EventsAssignment_6_2_1");
			builder.put(grammarAccess.getErrorModelSubclauseAccess().getTransitionsAssignment_6_3_1(), "rule__ErrorModelSubclause__TransitionsAssignment_6_3_1");
			builder.put(grammarAccess.getErrorModelSubclauseAccess().getOutgoingPropagationConditionsAssignment_6_4_1(), "rule__ErrorModelSubclause__OutgoingPropagationConditionsAssignment_6_4_1");
			builder.put(grammarAccess.getErrorModelSubclauseAccess().getErrorDetectionsAssignment_6_5_1(), "rule__ErrorModelSubclause__ErrorDetectionsAssignment_6_5_1");
			builder.put(grammarAccess.getErrorModelSubclauseAccess().getErrorStateToModeMappingsAssignment_6_6_1(), "rule__ErrorModelSubclause__ErrorStateToModeMappingsAssignment_6_6_1");
			builder.put(grammarAccess.getErrorModelSubclauseAccess().getStatesAssignment_7_1_1(), "rule__ErrorModelSubclause__StatesAssignment_7_1_1");
			builder.put(grammarAccess.getErrorModelSubclauseAccess().getTypeTransformationSetAssignment_8_1_1(), "rule__ErrorModelSubclause__TypeTransformationSetAssignment_8_1_1");
			builder.put(grammarAccess.getErrorModelSubclauseAccess().getConnectionErrorSourcesAssignment_8_2(), "rule__ErrorModelSubclause__ConnectionErrorSourcesAssignment_8_2");
			builder.put(grammarAccess.getErrorModelSubclauseAccess().getPointsAssignment_9_1(), "rule__ErrorModelSubclause__PointsAssignment_9_1");
			builder.put(grammarAccess.getErrorModelSubclauseAccess().getPathsAssignment_9_2(), "rule__ErrorModelSubclause__PathsAssignment_9_2");
			...
			builder.put(grammarAccess.getEMV2SubclauseAccess().getUseTypesAssignment_3_1(), "rule__EMV2Subclause__UseTypesAssignment_3_1");
			builder.put(grammarAccess.getEMV2SubclauseAccess().getUseTypesAssignment_3_2_1(), "rule__EMV2Subclause__UseTypesAssignment_3_2_1");
			builder.put(grammarAccess.getEMV2SubclauseAccess().getTypeEquivalenceAssignment_4_1(), "rule__EMV2Subclause__TypeEquivalenceAssignment_4_1");
			builder.put(grammarAccess.getEMV2SubclauseAccess().getTypeMappingSetAssignment_5_1(), "rule__EMV2Subclause__TypeMappingSetAssignment_5_1");
			builder.put(grammarAccess.getEMV2SubclauseAccess().getUseBehaviorAssignment_6_1(), "rule__EMV2Subclause__UseBehaviorAssignment_6_1");
			builder.put(grammarAccess.getEMV2SubclauseAccess().getPropagationsAssignment_7_1(), "rule__EMV2Subclause__PropagationsAssignment_7_1");
			builder.put(grammarAccess.getEMV2SubclauseAccess().getFlowsAssignment_7_2_1(), "rule__EMV2Subclause__FlowsAssignment_7_2_1");
			builder.put(grammarAccess.getEMV2SubclauseAccess().getUseTransformationAssignment_8_1_1(), "rule__EMV2Subclause__UseTransformationAssignment_8_1_1");
			builder.put(grammarAccess.getEMV2SubclauseAccess().getEventsAssignment_8_2_1(), "rule__EMV2Subclause__EventsAssignment_8_2_1");
			builder.put(grammarAccess.getEMV2SubclauseAccess().getTransitionsAssignment_8_3_1(), "rule__EMV2Subclause__TransitionsAssignment_8_3_1");
			builder.put(grammarAccess.getEMV2SubclauseAccess().getOutgoingPropagationConditionsAssignment_8_4_1(), "rule__EMV2Subclause__OutgoingPropagationConditionsAssignment_8_4_1");
			builder.put(grammarAccess.getEMV2SubclauseAccess().getErrorDetectionsAssignment_8_5_1(), "rule__EMV2Subclause__ErrorDetectionsAssignment_8_5_1");
			builder.put(grammarAccess.getEMV2SubclauseAccess().getErrorStateToModeMappingsAssignment_8_6_1(), "rule__EMV2Subclause__ErrorStateToModeMappingsAssignment_8_6_1");
			builder.put(grammarAccess.getEMV2SubclauseAccess().getStatesAssignment_9_1_1(), "rule__EMV2Subclause__StatesAssignment_9_1_1");
			builder.put(grammarAccess.getEMV2SubclauseAccess().getTypeTransformationSetAssignment_10_1_1(), "rule__EMV2Subclause__TypeTransformationSetAssignment_10_1_1");
			builder.put(grammarAccess.getEMV2SubclauseAccess().getConnectionErrorSourcesAssignment_10_2(), "rule__EMV2Subclause__ConnectionErrorSourcesAssignment_10_2");
			builder.put(grammarAccess.getEMV2SubclauseAccess().getPointsAssignment_11_1(), "rule__EMV2Subclause__PointsAssignment_11_1");
			builder.put(grammarAccess.getEMV2SubclauseAccess().getPathsAssignment_11_2(), "rule__EMV2Subclause__PathsAssignment_11_2");
			...
			builder.put(grammarAccess.getErrorModelLibraryAccess().getUseTypesAssignment_1_1_1(), "rule__ErrorModelLibrary__UseTypesAssignment_1_1_1");
			builder.put(grammarAccess.getErrorModelLibraryAccess().getUseTypesAssignment_1_1_2_1(), "rule__ErrorModelLibrary__UseTypesAssignment_1_1_2_1");
			builder.put(grammarAccess.getErrorModelLibraryAccess().getExtendsAssignment_1_2_1(), "rule__ErrorModelLibrary__ExtendsAssignment_1_2_1");
			builder.put(grammarAccess.getErrorModelLibraryAccess().getExtendsAssignment_1_2_2_1(), "rule__ErrorModelLibrary__ExtendsAssignment_1_2_2_1");
			builder.put(grammarAccess.getErrorModelLibraryAccess().getTypesAssignment_1_3_0(), "rule__ErrorModelLibrary__TypesAssignment_1_3_0");
			builder.put(grammarAccess.getErrorModelLibraryAccess().getTypesetsAssignment_1_3_1(), "rule__ErrorModelLibrary__TypesetsAssignment_1_3_1");
			builder.put(grammarAccess.getErrorModelLibraryAccess().getPropertiesAssignment_1_4_1(), "rule__ErrorModelLibrary__PropertiesAssignment_1_4_1");
			...
			builder.put(grammarAccess.getEMV2LibraryAccess().getUseTypesAssignment_0_1_2_1_1(), "rule__EMV2Library__UseTypesAssignment_0_1_2_1_1");
			builder.put(grammarAccess.getEMV2LibraryAccess().getUseTypesAssignment_0_1_2_1_2_1(), "rule__EMV2Library__UseTypesAssignment_0_1_2_1_2_1");
			builder.put(grammarAccess.getEMV2LibraryAccess().getExtendsAssignment_0_1_2_2_1(), "rule__EMV2Library__ExtendsAssignment_0_1_2_2_1");
			builder.put(grammarAccess.getEMV2LibraryAccess().getExtendsAssignment_0_1_2_2_2_1(), "rule__EMV2Library__ExtendsAssignment_0_1_2_2_2_1");
			builder.put(grammarAccess.getEMV2LibraryAccess().getTypesAssignment_0_1_2_3_0(), "rule__EMV2Library__TypesAssignment_0_1_2_3_0");
			builder.put(grammarAccess.getEMV2LibraryAccess().getTypesetsAssignment_0_1_2_3_1(), "rule__EMV2Library__TypesetsAssignment_0_1_2_3_1");
			builder.put(grammarAccess.getEMV2LibraryAccess().getPropertiesAssignment_0_1_2_4_1(), "rule__EMV2Library__PropertiesAssignment_0_1_2_4_1");
			...
			builder.put(grammarAccess.getEMV2LibraryAccess().getUseTypesAssignment_1_6_1_1(), "rule__EMV2Library__UseTypesAssignment_1_6_1_1");
			builder.put(grammarAccess.getEMV2LibraryAccess().getUseTypesAssignment_1_6_1_2_1(), "rule__EMV2Library__UseTypesAssignment_1_6_1_2_1");
			builder.put(grammarAccess.getEMV2LibraryAccess().getExtendsAssignment_1_6_2_1(), "rule__EMV2Library__ExtendsAssignment_1_6_2_1");
			builder.put(grammarAccess.getEMV2LibraryAccess().getExtendsAssignment_1_6_2_2_1(), "rule__EMV2Library__ExtendsAssignment_1_6_2_2_1");
			builder.put(grammarAccess.getEMV2LibraryAccess().getTypesAssignment_1_6_3_0(), "rule__EMV2Library__TypesAssignment_1_6_3_0");
			builder.put(grammarAccess.getEMV2LibraryAccess().getTypesetsAssignment_1_6_3_1(), "rule__EMV2Library__TypesetsAssignment_1_6_3_1");
			builder.put(grammarAccess.getEMV2LibraryAccess().getPropertiesAssignment_1_6_4_1(), "rule__EMV2Library__PropertiesAssignment_1_6_4_1");
			...
			builder.put(grammarAccess.getEMV2PropertyAssociationAccess().getEmv2PathAssignment_3_1_0(), "rule__EMV2PropertyAssociation__Emv2PathAssignment_3_1_0");
			builder.put(grammarAccess.getEMV2PropertyAssociationAccess().getEmv2PathAssignment_3_1_1_1(), "rule__EMV2PropertyAssociation__Emv2PathAssignment_3_1_1_1");
			...
			builder.put(grammarAccess.getBasicEMV2PropertyAssociationAccess().getEmv2PathAssignment_3_1_0(), "rule__BasicEMV2PropertyAssociation__Emv2PathAssignment_3_1_0");
			builder.put(grammarAccess.getBasicEMV2PropertyAssociationAccess().getEmv2PathAssignment_3_1_1_1(), "rule__BasicEMV2PropertyAssociation__Emv2PathAssignment_3_1_1_1");
			...
			builder.put(grammarAccess.getTypeSetDefinitionAccess().getTypeTokensAssignment_1_0_3(), "rule__TypeSetDefinition__TypeTokensAssignment_1_0_3");
			builder.put(grammarAccess.getTypeSetDefinitionAccess().getTypeTokensAssignment_1_0_4_1(), "rule__TypeSetDefinition__TypeTokensAssignment_1_0_4_1");
			builder.put(grammarAccess.getTypeSetDefinitionAccess().getAliasedTypeAssignment_1_1_2(), "rule__TypeSetDefinition__AliasedTypeAssignment_1_1_2");
			...
			builder.put(grammarAccess.getTypeTransformationSetAccess().getNameAssignment_1(), "rule__TypeTransformationSet__NameAssignment_1");
			builder.put(grammarAccess.getTypeTransformationSetAccess().getUseTypesAssignment_2_1(), "rule__TypeTransformationSet__UseTypesAssignment_2_1");
			builder.put(grammarAccess.getTypeTransformationSetAccess().getUseTypesAssignment_2_2_1(), "rule__TypeTransformationSet__UseTypesAssignment_2_2_1");
			builder.put(grammarAccess.getTypeTransformationSetAccess().getTransformationAssignment_3(), "rule__TypeTransformationSet__TransformationAssignment_3");
			...
			builder.put(grammarAccess.getTypeMappingSetAccess().getNameAssignment_1(), "rule__TypeMappingSet__NameAssignment_1");
			builder.put(grammarAccess.getTypeMappingSetAccess().getUseTypesAssignment_2_1(), "rule__TypeMappingSet__UseTypesAssignment_2_1");
			builder.put(grammarAccess.getTypeMappingSetAccess().getUseTypesAssignment_2_2_1(), "rule__TypeMappingSet__UseTypesAssignment_2_2_1");
			builder.put(grammarAccess.getTypeMappingSetAccess().getMappingAssignment_3(), "rule__TypeMappingSet__MappingAssignment_3");
			...
			builder.put(grammarAccess.getErrorSourceAccess().getSourceModelElementAssignment_3_0(), "rule__ErrorSource__SourceModelElementAssignment_3_0");
			builder.put(grammarAccess.getErrorSourceAccess().getAllAssignment_3_1(), "rule__ErrorSource__AllAssignment_3_1");
			builder.put(grammarAccess.getErrorSourceAccess().getTypeTokenConstraintAssignment_4(), "rule__ErrorSource__TypeTokenConstraintAssignment_4");
			builder.put(grammarAccess.getErrorSourceAccess().getFailureModeReferenceAssignment_5_1_0_0(), "rule__ErrorSource__FailureModeReferenceAssignment_5_1_0_0");
			builder.put(grammarAccess.getErrorSourceAccess().getFailureModeTypeAssignment_5_1_0_1(), "rule__ErrorSource__FailureModeTypeAssignment_5_1_0_1");
			builder.put(grammarAccess.getErrorSourceAccess().getFailureModeTypeAssignment_5_1_1(), "rule__ErrorSource__FailureModeTypeAssignment_5_1_1");
			builder.put(grammarAccess.getErrorSourceAccess().getFailureModeDescriptionAssignment_5_1_2(), "rule__ErrorSource__FailureModeDescriptionAssignment_5_1_2");
			builder.put(grammarAccess.getErrorSourceAccess().getFlowconditionAssignment_6_1(), "rule__ErrorSource__FlowconditionAssignment_6_1");
			builder.put(grammarAccess.getErrorSinkAccess().getNameAssignment_0(), "rule__ErrorSink__NameAssignment_0");
			builder.put(grammarAccess.getErrorSinkAccess().getIncomingAssignment_3_0(), "rule__ErrorSink__IncomingAssignment_3_0");
			builder.put(grammarAccess.getErrorSinkAccess().getAllIncomingAssignment_3_1(), "rule__ErrorSink__AllIncomingAssignment_3_1");
			builder.put(grammarAccess.getErrorSinkAccess().getTypeTokenConstraintAssignment_4(), "rule__ErrorSink__TypeTokenConstraintAssignment_4");
			builder.put(grammarAccess.getErrorSinkAccess().getFlowconditionAssignment_5_1(), "rule__ErrorSink__FlowconditionAssignment_5_1");
			builder.put(grammarAccess.getErrorPathAccess().getNameAssignment_0(), "rule__ErrorPath__NameAssignment_0");
			builder.put(grammarAccess.getErrorPathAccess().getIncomingAssignment_3_0(), "rule__ErrorPath__IncomingAssignment_3_0");
			builder.put(grammarAccess.getErrorPathAccess().getAllIncomingAssignment_3_1(), "rule__ErrorPath__AllIncomingAssignment_3_1");
			builder.put(grammarAccess.getErrorPathAccess().getTypeTokenConstraintAssignment_4(), "rule__ErrorPath__TypeTokenConstraintAssignment_4");
			builder.put(grammarAccess.getErrorPathAccess().getOutgoingAssignment_6_0(), "rule__ErrorPath__OutgoingAssignment_6_0");
			builder.put(grammarAccess.getErrorPathAccess().getAllOutgoingAssignment_6_1(), "rule__ErrorPath__AllOutgoingAssignment_6_1");
			builder.put(grammarAccess.getErrorPathAccess().getTargetTokenAssignment_7_0(), "rule__ErrorPath__TargetTokenAssignment_7_0");
			builder.put(grammarAccess.getErrorPathAccess().getTypeMappingSetAssignment_7_1_1(), "rule__ErrorPath__TypeMappingSetAssignment_7_1_1");
			builder.put(grammarAccess.getErrorPathAccess().getFlowconditionAssignment_8_1(), "rule__ErrorPath__FlowconditionAssignment_8_1");
			...
			builder.put(grammarAccess.getErrorBehaviorStateMachineAccess().getNameAssignment_1(), "rule__ErrorBehaviorStateMachine__NameAssignment_1");
			builder.put(grammarAccess.getErrorBehaviorStateMachineAccess().getUseTypesAssignment_2_1(), "rule__ErrorBehaviorStateMachine__UseTypesAssignment_2_1");
			builder.put(grammarAccess.getErrorBehaviorStateMachineAccess().getUseTypesAssignment_2_2_1(), "rule__ErrorBehaviorStateMachine__UseTypesAssignment_2_2_1");
			builder.put(grammarAccess.getErrorBehaviorStateMachineAccess().getUseTransformationAssignment_3_1(), "rule__ErrorBehaviorStateMachine__UseTransformationAssignment_3_1");
			builder.put(grammarAccess.getErrorBehaviorStateMachineAccess().getEventsAssignment_4_1(), "rule__ErrorBehaviorStateMachine__EventsAssignment_4_1");
			builder.put(grammarAccess.getErrorBehaviorStateMachineAccess().getStatesAssignment_5_1(), "rule__ErrorBehaviorStateMachine__StatesAssignment_5_1");
			builder.put(grammarAccess.getErrorBehaviorStateMachineAccess().getTransitionsAssignment_6_1(), "rule__ErrorBehaviorStateMachine__TransitionsAssignment_6_1");
			builder.put(grammarAccess.getErrorBehaviorStateMachineAccess().getPropertiesAssignment_7_1(), "rule__ErrorBehaviorStateMachine__PropertiesAssignment_7_1");
			builder.put(grammarAccess.getErrorEventAccess().getNameAssignment_0(), "rule__ErrorEvent__NameAssignment_0");
			builder.put(grammarAccess.getErrorEventAccess().getTypeSetAssignment_3(), "rule__ErrorEvent__TypeSetAssignment_3");
			builder.put(grammarAccess.getErrorEventAccess().getEventconditionAssignment_4_1(), "rule__ErrorEvent__EventconditionAssignment_4_1");
			builder.put(grammarAccess.getRepairEventAccess().getNameAssignment_0(), "rule__RepairEvent__NameAssignment_0");
			builder.put(grammarAccess.getRepairEventAccess().getEventInitiatorAssignment_3_1(), "rule__RepairEvent__EventInitiatorAssignment_3_1");
			builder.put(grammarAccess.getRepairEventAccess().getEventInitiatorAssignment_3_2_1(), "rule__RepairEvent__EventInitiatorAssignment_3_2_1");
			builder.put(grammarAccess.getRecoverEventAccess().getNameAssignment_0(), "rule__RecoverEvent__NameAssignment_0");
			builder.put(grammarAccess.getRecoverEventAccess().getEventInitiatorAssignment_3_1(), "rule__RecoverEvent__EventInitiatorAssignment_3_1");
			builder.put(grammarAccess.getRecoverEventAccess().getEventInitiatorAssignment_3_2_1(), "rule__RecoverEvent__EventInitiatorAssignment_3_2_1");
			builder.put(grammarAccess.getRecoverEventAccess().getConditionAssignment_4_1(), "rule__RecoverEvent__ConditionAssignment_4_1");
			...
			builder.put(grammarAccess.getErrorBehaviorTransitionAccess().getSteadyStateAssignment_5_1(), "rule__ErrorBehaviorTransition__SteadyStateAssignment_5_1");
			...
			builder.put(grammarAccess.getTransitionBranchAccess().getSteadyStateAssignment_0_1(), "rule__TransitionBranch__SteadyStateAssignment_0_1");
			...
			builder.put(grammarAccess.getErrorStateToModeMappingAccess().getMappedModesAssignment_4(), "rule__ErrorStateToModeMapping__MappedModesAssignment_4");
			builder.put(grammarAccess.getErrorStateToModeMappingAccess().getMappedModesAssignment_5_1(), "rule__ErrorStateToModeMapping__MappedModesAssignment_5_1");
