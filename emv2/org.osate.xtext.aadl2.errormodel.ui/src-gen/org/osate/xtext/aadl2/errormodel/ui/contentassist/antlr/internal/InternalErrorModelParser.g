...
@members {
 	...
 	
 	{
		...
		tokenNameToValue.put("KEYWORD_27", "'bus'");
		tokenNameToValue.put("KEYWORD_28", "'end'");
		tokenNameToValue.put("KEYWORD_29", "'not'");
		tokenNameToValue.put("KEYWORD_30", "'out'");
		tokenNameToValue.put("KEYWORD_31", "'set'");
		tokenNameToValue.put("KEYWORD_32", "'use'");
		tokenNameToValue.put("KEYWORD_33", "'mask'");
		tokenNameToValue.put("KEYWORD_34", "'mode'");
		tokenNameToValue.put("KEYWORD_35", "'path'");
		tokenNameToValue.put("KEYWORD_36", "'self'");
		tokenNameToValue.put("KEYWORD_37", "'sink'");
		...
		tokenNameToValue.put("KEYWORD_42", "'delta'");
		tokenNameToValue.put("KEYWORD_43", "'error'");
		tokenNameToValue.put("KEYWORD_44", "'event'");
		tokenNameToValue.put("KEYWORD_45", "'false'");
		tokenNameToValue.put("KEYWORD_46", "'flows'");
		tokenNameToValue.put("KEYWORD_47", "'modes'");
		tokenNameToValue.put("KEYWORD_48", "'paths'");
		tokenNameToValue.put("KEYWORD_49", "'point'");
		tokenNameToValue.put("KEYWORD_50", "'state'");
		tokenNameToValue.put("KEYWORD_51", "'types'");
		tokenNameToValue.put("KEYWORD_52", "'access'");
		tokenNameToValue.put("KEYWORD_53", "'device'");
		tokenNameToValue.put("KEYWORD_54", "'events'");
		tokenNameToValue.put("KEYWORD_55", "'memory'");
		tokenNameToValue.put("KEYWORD_56", "'orless'");
		tokenNameToValue.put("KEYWORD_57", "'ormore'");
		tokenNameToValue.put("KEYWORD_58", "'others'");
		tokenNameToValue.put("KEYWORD_59", "'repair'");
		tokenNameToValue.put("KEYWORD_60", "'source'");
		tokenNameToValue.put("KEYWORD_61", "'states'");
		tokenNameToValue.put("KEYWORD_62", "'system'");
		tokenNameToValue.put("KEYWORD_63", "'applies'");
		tokenNameToValue.put("KEYWORD_64", "'binding'");
		tokenNameToValue.put("KEYWORD_65", "'compute'");
		tokenNameToValue.put("KEYWORD_66", "'extends'");
		tokenNameToValue.put("KEYWORD_67", "'initial'");
		tokenNameToValue.put("KEYWORD_68", "'library'");
		tokenNameToValue.put("KEYWORD_69", "'noerror'");
		tokenNameToValue.put("KEYWORD_70", "'recover'");
		tokenNameToValue.put("KEYWORD_71", "'renames'");
		tokenNameToValue.put("KEYWORD_72", "'virtual'");
		tokenNameToValue.put("KEYWORD_73", "'behavior'");
		tokenNameToValue.put("KEYWORD_74", "'bindings'");
		tokenNameToValue.put("KEYWORD_75", "'constant'");
		tokenNameToValue.put("KEYWORD_76", "'mappings'");
		tokenNameToValue.put("KEYWORD_77", "'component'");
		tokenNameToValue.put("KEYWORD_78", "'composite'");
		tokenNameToValue.put("KEYWORD_79", "'processor'");
		tokenNameToValue.put("KEYWORD_80", "'reference'");
		tokenNameToValue.put("KEYWORD_81", "'classifier'");
		tokenNameToValue.put("KEYWORD_82", "'connection'");
		tokenNameToValue.put("KEYWORD_83", "'detections'");
		tokenNameToValue.put("KEYWORD_84", "'properties'");
		tokenNameToValue.put("KEYWORD_85", "'connections'");
		tokenNameToValue.put("KEYWORD_86", "'propagation'");
		tokenNameToValue.put("KEYWORD_87", "'transitions'");
		tokenNameToValue.put("KEYWORD_88", "'propagations'");
		tokenNameToValue.put("KEYWORD_89", "'transformations'");
 	}
...
ruleTypeTokenOrNoError 
    ...
    :
(
{ before(grammarAccess.getTypeTokenOrNoErrorAccess().getGroup()); }
(rule__TypeTokenOrNoError__Group__0)
{ after(grammarAccess.getTypeTokenOrNoErrorAccess().getGroup()); }
)
...
// Entry rule entryRulePropagationPaths
entryRulePropagationPaths 
:
{ before(grammarAccess.getPropagationPathsRule()); }
	 rulePropagationPaths
{ after(grammarAccess.getPropagationPathsRule()); } 
	 EOF 
;

// Rule PropagationPaths
rulePropagationPaths 
    @init {
		int stackSize = keepStackSize();
    }
    :
(
{ before(grammarAccess.getPropagationPathsAccess().getGroup()); }
(rule__PropagationPaths__Group__0)
{ after(grammarAccess.getPropagationPathsAccess().getGroup()); }
)
...
// Entry rule entryRulePropagationPointConnection
entryRulePropagationPointConnection 
:
{ before(grammarAccess.getPropagationPointConnectionRule()); }
	 rulePropagationPointConnection
{ after(grammarAccess.getPropagationPointConnectionRule()); } 
	 EOF 
;

// Rule PropagationPointConnection
rulePropagationPointConnection 
    @init {
		int stackSize = keepStackSize();
    }
    :
(
{ before(grammarAccess.getPropagationPointConnectionAccess().getGroup()); }
(rule__PropagationPointConnection__Group__0)
{ after(grammarAccess.getPropagationPointConnectionAccess().getGroup()); }
)
...
// Entry rule entryRuleConnectionErrorBehavior
entryRuleConnectionErrorBehavior 
:
{ before(grammarAccess.getConnectionErrorBehaviorRule()); }
	 ruleConnectionErrorBehavior
{ after(grammarAccess.getConnectionErrorBehaviorRule()); } 
	 EOF 
;

// Rule ConnectionErrorBehavior
ruleConnectionErrorBehavior 
    @init {
		int stackSize = keepStackSize();
    }
    :
(
{ before(grammarAccess.getConnectionErrorBehaviorAccess().getGroup()); }
(rule__ConnectionErrorBehavior__Group__0)
{ after(grammarAccess.getConnectionErrorBehaviorAccess().getGroup()); }
)
...
rule__TypeTokenOrNoError__Alternatives_2
    @init {
		int stackSize = keepStackSize();
    }
:
(
{ before(grammarAccess.getTypeTokenOrNoErrorAccess().getGroup_2_0()); }
(rule__TypeTokenOrNoError__Group_2_0__0)
{ after(grammarAccess.getTypeTokenOrNoErrorAccess().getGroup_2_0()); }
)

    |(
{ before(grammarAccess.getTypeTokenOrNoErrorAccess().getNoerrorKeyword_2_1()); }

	KEYWORD_69 

{ after(grammarAccess.getTypeTokenOrNoErrorAccess().getNoerrorKeyword_2_1()); }
)
...
rule__ErrorBehaviorTransition__Alternatives_4
    @init {
		int stackSize = keepStackSize();
    }
:
(
{ before(grammarAccess.getErrorBehaviorTransitionAccess().getGroup_4_0()); }
(rule__ErrorBehaviorTransition__Group_4_0__0)
{ after(grammarAccess.getErrorBehaviorTransitionAccess().getGroup_4_0()); }
)

    |(
{ before(grammarAccess.getErrorBehaviorTransitionAccess().getMaskAssignment_4_1()); }
(rule__ErrorBehaviorTransition__MaskAssignment_4_1)
{ after(grammarAccess.getErrorBehaviorTransitionAccess().getMaskAssignment_4_1()); }
)
...
rule__ErrorBehaviorTransition__Alternatives_4_0_1
    @init {
		int stackSize = keepStackSize();
    }
:
(
{ before(grammarAccess.getErrorBehaviorTransitionAccess().getAlternatives_4_0_1_0()); }
(rule__ErrorBehaviorTransition__Alternatives_4_0_1_0)
{ after(grammarAccess.getErrorBehaviorTransitionAccess().getAlternatives_4_0_1_0()); }
)

    |(
{ before(grammarAccess.getErrorBehaviorTransitionAccess().getGroup_4_0_1_1()); }
(rule__ErrorBehaviorTransition__Group_4_0_1_1__0)
{ after(grammarAccess.getErrorBehaviorTransitionAccess().getGroup_4_0_1_1()); }
)
...
:
(
{ before(grammarAccess.getErrorBehaviorTransitionAccess().getGroup_4_0_1_0_0()); }
(rule__ErrorBehaviorTransition__Group_4_0_1_0_0__0)
{ after(grammarAccess.getErrorBehaviorTransitionAccess().getGroup_4_0_1_0_0()); }
)

    |(
{ before(grammarAccess.getErrorBehaviorTransitionAccess().getMaskAssignment_4_0_1_0_1()); }
(rule__ErrorBehaviorTransition__MaskAssignment_4_0_1_0_1)
{ after(grammarAccess.getErrorBehaviorTransitionAccess().getMaskAssignment_4_0_1_0_1()); }
)
...
rule__OutgoingPropagationCondition__Alternatives_5_0_0
    @init {
		int stackSize = keepStackSize();
    }
:
(
{ before(grammarAccess.getOutgoingPropagationConditionAccess().getOutgoingAssignment_5_0_0_0()); }
(rule__OutgoingPropagationCondition__OutgoingAssignment_5_0_0_0)
{ after(grammarAccess.getOutgoingPropagationConditionAccess().getOutgoingAssignment_5_0_0_0()); }
)

    |(
{ before(grammarAccess.getOutgoingPropagationConditionAccess().getAllPropagationsAssignment_5_0_0_1()); }
(rule__OutgoingPropagationCondition__AllPropagationsAssignment_5_0_0_1)
{ after(grammarAccess.getOutgoingPropagationConditionAccess().getAllPropagationsAssignment_5_0_0_1()); }
)
...
:
(
{ before(grammarAccess.getErrorModelSubclauseAccess().getErrorPropagationsAssignment_3()); }
(rule__ErrorModelSubclause__ErrorPropagationsAssignment_3)?
{ after(grammarAccess.getErrorModelSubclauseAccess().getErrorPropagationsAssignment_3()); }
)
...
:
(
{ before(grammarAccess.getErrorModelSubclauseAccess().getConnectionBehaviorAssignment_6()); }
(rule__ErrorModelSubclause__ConnectionBehaviorAssignment_6)?
{ after(grammarAccess.getErrorModelSubclauseAccess().getConnectionBehaviorAssignment_6()); }
)
...
:
(
{ before(grammarAccess.getErrorModelSubclauseAccess().getPropagationPathsAssignment_7()); }
(rule__ErrorModelSubclause__PropagationPathsAssignment_7)?
{ after(grammarAccess.getErrorModelSubclauseAccess().getPropagationPathsAssignment_7()); }
)
...
:
	rule__TypeTokenOrNoError__Group__0__Impl
	rule__TypeTokenOrNoError__Group__1
;
finally {
	restoreStackSize(stackSize);
}
...
:
(
{ before(grammarAccess.getTypeTokenOrNoErrorAccess().getTypeTokenAction_0()); }
(

)
{ after(grammarAccess.getTypeTokenOrNoErrorAccess().getTypeTokenAction_0()); }
)
...
:
	rule__TypeTokenOrNoError__Group__1__Impl
	rule__TypeTokenOrNoError__Group__2
;
finally {
	restoreStackSize(stackSize);
}
...
:
(
{ before(grammarAccess.getTypeTokenOrNoErrorAccess().getLeftParenthesisKeyword_1()); }

	KEYWORD_2 

{ after(grammarAccess.getTypeTokenOrNoErrorAccess().getLeftParenthesisKeyword_1()); }
)
...
:
	rule__TypeTokenOrNoError__Group__2__Impl
	rule__TypeTokenOrNoError__Group__3
;
finally {
	restoreStackSize(stackSize);
}
...
:
(
{ before(grammarAccess.getTypeTokenOrNoErrorAccess().getAlternatives_2()); }
(rule__TypeTokenOrNoError__Alternatives_2)
{ after(grammarAccess.getTypeTokenOrNoErrorAccess().getAlternatives_2()); }
)
...
:
	rule__TypeTokenOrNoError__Group__3__Impl
;
finally {
	restoreStackSize(stackSize);
}
...
:
(
{ before(grammarAccess.getTypeTokenOrNoErrorAccess().getRightParenthesisKeyword_3()); }

	KEYWORD_3 

{ after(grammarAccess.getTypeTokenOrNoErrorAccess().getRightParenthesisKeyword_3()); }
)
...
:
	rule__TypeTokenOrNoError__Group_2_0__0__Impl
	rule__TypeTokenOrNoError__Group_2_0__1
;
finally {
	restoreStackSize(stackSize);
}
...
:
(
{ before(grammarAccess.getTypeTokenOrNoErrorAccess().getTypeAssignment_2_0_0()); }
(rule__TypeTokenOrNoError__TypeAssignment_2_0_0)
{ after(grammarAccess.getTypeTokenOrNoErrorAccess().getTypeAssignment_2_0_0()); }
)
...
:
	rule__TypeTokenOrNoError__Group_2_0__1__Impl
;
finally {
	restoreStackSize(stackSize);
}
...
:
(
{ before(grammarAccess.getTypeTokenOrNoErrorAccess().getGroup_2_0_1()); }
(rule__TypeTokenOrNoError__Group_2_0_1__0)*
{ after(grammarAccess.getTypeTokenOrNoErrorAccess().getGroup_2_0_1()); }
)
...
:
	rule__TypeTokenOrNoError__Group_2_0_1__0__Impl
	rule__TypeTokenOrNoError__Group_2_0_1__1
;
finally {
	restoreStackSize(stackSize);
}
...
:
(
{ before(grammarAccess.getTypeTokenOrNoErrorAccess().getAsteriskKeyword_2_0_1_0()); }

	KEYWORD_4 

{ after(grammarAccess.getTypeTokenOrNoErrorAccess().getAsteriskKeyword_2_0_1_0()); }
)
...
:
	rule__TypeTokenOrNoError__Group_2_0_1__1__Impl
;
finally {
	restoreStackSize(stackSize);
}
...
:
(
{ before(grammarAccess.getTypeTokenOrNoErrorAccess().getTypeAssignment_2_0_1_1()); }
(rule__TypeTokenOrNoError__TypeAssignment_2_0_1_1)
{ after(grammarAccess.getTypeTokenOrNoErrorAccess().getTypeAssignment_2_0_1_1()); }
)
...
:
(
{ before(grammarAccess.getErrorPropagationAccess().getFeaturerefsAssignment_1_1_0()); }
(rule__ErrorPropagation__FeaturerefsAssignment_1_1_0)
{ after(grammarAccess.getErrorPropagationAccess().getFeaturerefsAssignment_1_1_0()); }
)
...
:
(
{ before(grammarAccess.getErrorPropagationAccess().getFeaturerefsAssignment_1_1_1_1()); }
(rule__ErrorPropagation__FeaturerefsAssignment_1_1_1_1)
{ after(grammarAccess.getErrorPropagationAccess().getFeaturerefsAssignment_1_1_1_1()); }
)
...
:
	rule__PropagationPaths__Group__0__Impl
	rule__PropagationPaths__Group__1
;
finally {
	restoreStackSize(stackSize);
}
...
:
(
{ before(grammarAccess.getPropagationPathsAccess().getPropagationKeyword_0()); }

	KEYWORD_86 

{ after(grammarAccess.getPropagationPathsAccess().getPropagationKeyword_0()); }
)
...
:
	rule__PropagationPaths__Group__1__Impl
	rule__PropagationPaths__Group__2
;
finally {
	restoreStackSize(stackSize);
}
...
:
(
{ before(grammarAccess.getPropagationPathsAccess().getPathsKeyword_1()); }

	KEYWORD_48 

{ after(grammarAccess.getPropagationPathsAccess().getPathsKeyword_1()); }
)
...
:
	rule__PropagationPaths__Group__2__Impl
	rule__PropagationPaths__Group__3
;
finally {
	restoreStackSize(stackSize);
}
...
(
(
{ before(grammarAccess.getPropagationPathsAccess().getPointsAssignment_2()); }
(rule__PropagationPaths__PointsAssignment_2)
{ after(grammarAccess.getPropagationPathsAccess().getPointsAssignment_2()); }
)
(
{ before(grammarAccess.getPropagationPathsAccess().getPointsAssignment_2()); }
(rule__PropagationPaths__PointsAssignment_2)*
...
:
	rule__PropagationPaths__Group__3__Impl
	rule__PropagationPaths__Group__4
;
finally {
	restoreStackSize(stackSize);
}
...
:
(
{ before(grammarAccess.getPropagationPathsAccess().getGroup_3()); }
(rule__PropagationPaths__Group_3__0)?
{ after(grammarAccess.getPropagationPathsAccess().getGroup_3()); }
)
...
:
	rule__PropagationPaths__Group__4__Impl
	rule__PropagationPaths__Group__5
;
finally {
	restoreStackSize(stackSize);
}
...
:
(
{ before(grammarAccess.getPropagationPathsAccess().getEndKeyword_4()); }

	KEYWORD_28 

{ after(grammarAccess.getPropagationPathsAccess().getEndKeyword_4()); }
)
...
:
	rule__PropagationPaths__Group__5__Impl
	rule__PropagationPaths__Group__6
;
finally {
	restoreStackSize(stackSize);
}
...
:
(
{ before(grammarAccess.getPropagationPathsAccess().getPathsKeyword_5()); }

	KEYWORD_48 

{ after(grammarAccess.getPropagationPathsAccess().getPathsKeyword_5()); }
)
...
:
	rule__PropagationPaths__Group__6__Impl
;
finally {
	restoreStackSize(stackSize);
}
...
:
(
{ before(grammarAccess.getPropagationPathsAccess().getSemicolonKeyword_6()); }

	KEYWORD_10 

{ after(grammarAccess.getPropagationPathsAccess().getSemicolonKeyword_6()); }
)
...
:
	rule__PropagationPaths__Group_3__0__Impl
	rule__PropagationPaths__Group_3__1
;
finally {
	restoreStackSize(stackSize);
}
...
:
(
{ before(grammarAccess.getPropagationPathsAccess().getConnectionsKeyword_3_0()); }

	KEYWORD_85 

{ after(grammarAccess.getPropagationPathsAccess().getConnectionsKeyword_3_0()); }
)
...
:
	rule__PropagationPaths__Group_3__1__Impl
;
finally {
	restoreStackSize(stackSize);
}
...
(
(
{ before(grammarAccess.getPropagationPathsAccess().getConnectionsAssignment_3_1()); }
(rule__PropagationPaths__ConnectionsAssignment_3_1)
{ after(grammarAccess.getPropagationPathsAccess().getConnectionsAssignment_3_1()); }
)
(
{ before(grammarAccess.getPropagationPathsAccess().getConnectionsAssignment_3_1()); }
(rule__PropagationPaths__ConnectionsAssignment_3_1)*
...
:
	rule__PropagationPointConnection__Group__0__Impl
	rule__PropagationPointConnection__Group__1
;
finally {
	restoreStackSize(stackSize);
}
...
:
(
{ before(grammarAccess.getPropagationPointConnectionAccess().getNameAssignment_0()); }
(rule__PropagationPointConnection__NameAssignment_0)
{ after(grammarAccess.getPropagationPointConnectionAccess().getNameAssignment_0()); }
)
...
:
	rule__PropagationPointConnection__Group__1__Impl
	rule__PropagationPointConnection__Group__2
;
finally {
	restoreStackSize(stackSize);
}
...
:
(
{ before(grammarAccess.getPropagationPointConnectionAccess().getColonKeyword_1()); }

	KEYWORD_9 

{ after(grammarAccess.getPropagationPointConnectionAccess().getColonKeyword_1()); }
)
...
:
	rule__PropagationPointConnection__Group__2__Impl
	rule__PropagationPointConnection__Group__3
;
finally {
	restoreStackSize(stackSize);
}
...
:
(
{ before(grammarAccess.getPropagationPointConnectionAccess().getSourceAssignment_2()); }
(rule__PropagationPointConnection__SourceAssignment_2)
{ after(grammarAccess.getPropagationPointConnectionAccess().getSourceAssignment_2()); }
)
...
:
	rule__PropagationPointConnection__Group__3__Impl
	rule__PropagationPointConnection__Group__4
;
finally {
	restoreStackSize(stackSize);
}
...
:
(
{ before(grammarAccess.getPropagationPointConnectionAccess().getHyphenMinusGreaterThanSignKeyword_3()); }

	KEYWORD_15 

{ after(grammarAccess.getPropagationPointConnectionAccess().getHyphenMinusGreaterThanSignKeyword_3()); }
)
...
:
	rule__PropagationPointConnection__Group__4__Impl
	rule__PropagationPointConnection__Group__5
;
finally {
	restoreStackSize(stackSize);
}
...
:
(
{ before(grammarAccess.getPropagationPointConnectionAccess().getTargetAssignment_4()); }
(rule__PropagationPointConnection__TargetAssignment_4)
{ after(grammarAccess.getPropagationPointConnectionAccess().getTargetAssignment_4()); }
)
...
:
	rule__PropagationPointConnection__Group__5__Impl
;
finally {
	restoreStackSize(stackSize);
}
...
:
(
{ before(grammarAccess.getPropagationPointConnectionAccess().getSemicolonKeyword_5()); }

	KEYWORD_10 

{ after(grammarAccess.getPropagationPointConnectionAccess().getSemicolonKeyword_5()); }
)
...
:
(
{ before(grammarAccess.getErrorBehaviorTransitionAccess().getAlternatives_4()); }
(rule__ErrorBehaviorTransition__Alternatives_4)
{ after(grammarAccess.getErrorBehaviorTransitionAccess().getAlternatives_4()); }
)
...
:
(
{ before(grammarAccess.getErrorBehaviorTransitionAccess().getSemicolonKeyword_5()); }

	KEYWORD_10 

{ after(grammarAccess.getErrorBehaviorTransitionAccess().getSemicolonKeyword_5()); }
)
...
:
	rule__ErrorBehaviorTransition__Group_4_0__0__Impl
	rule__ErrorBehaviorTransition__Group_4_0__1
;
finally {
	restoreStackSize(stackSize);
}
...
:
(
{ before(grammarAccess.getErrorBehaviorTransitionAccess().getRightSquareBracketHyphenMinusGreaterThanSignKeyword_4_0_0()); }

	KEYWORD_24 

{ after(grammarAccess.getErrorBehaviorTransitionAccess().getRightSquareBracketHyphenMinusGreaterThanSignKeyword_4_0_0()); }
)
...
:
	rule__ErrorBehaviorTransition__Group_4_0__1__Impl
;
finally {
	restoreStackSize(stackSize);
}
...
:
(
{ before(grammarAccess.getErrorBehaviorTransitionAccess().getAlternatives_4_0_1()); }
(rule__ErrorBehaviorTransition__Alternatives_4_0_1)
{ after(grammarAccess.getErrorBehaviorTransitionAccess().getAlternatives_4_0_1()); }
)
...
:
	rule__ErrorBehaviorTransition__Group_4_0_1_0_0__0__Impl
	rule__ErrorBehaviorTransition__Group_4_0_1_0_0__1
;
finally {
	restoreStackSize(stackSize);
}
...
:
(
{ before(grammarAccess.getErrorBehaviorTransitionAccess().getTargetAssignment_4_0_1_0_0_0()); }
(rule__ErrorBehaviorTransition__TargetAssignment_4_0_1_0_0_0)
{ after(grammarAccess.getErrorBehaviorTransitionAccess().getTargetAssignment_4_0_1_0_0_0()); }
)
...
:
	rule__ErrorBehaviorTransition__Group_4_0_1_0_0__1__Impl
;
finally {
	restoreStackSize(stackSize);
}
...
:
(
{ before(grammarAccess.getErrorBehaviorTransitionAccess().getTargetTokenAssignment_4_0_1_0_0_1()); }
(rule__ErrorBehaviorTransition__TargetTokenAssignment_4_0_1_0_0_1)?
{ after(grammarAccess.getErrorBehaviorTransitionAccess().getTargetTokenAssignment_4_0_1_0_0_1()); }
)
...
:
	rule__ErrorBehaviorTransition__Group_4_0_1_1__0__Impl
	rule__ErrorBehaviorTransition__Group_4_0_1_1__1
;
finally {
	restoreStackSize(stackSize);
}
...
:
(
{ before(grammarAccess.getErrorBehaviorTransitionAccess().getLeftParenthesisKeyword_4_0_1_1_0()); }

	KEYWORD_2 

{ after(grammarAccess.getErrorBehaviorTransitionAccess().getLeftParenthesisKeyword_4_0_1_1_0()); }
)
...
:
	rule__ErrorBehaviorTransition__Group_4_0_1_1__1__Impl
	rule__ErrorBehaviorTransition__Group_4_0_1_1__2
;
finally {
	restoreStackSize(stackSize);
}
...
:
(
{ before(grammarAccess.getErrorBehaviorTransitionAccess().getDestinationBranchesAssignment_4_0_1_1_1()); }
(rule__ErrorBehaviorTransition__DestinationBranchesAssignment_4_0_1_1_1)
{ after(grammarAccess.getErrorBehaviorTransitionAccess().getDestinationBranchesAssignment_4_0_1_1_1()); }
)
...
:
	rule__ErrorBehaviorTransition__Group_4_0_1_1__2__Impl
	rule__ErrorBehaviorTransition__Group_4_0_1_1__3
;
finally {
	restoreStackSize(stackSize);
}
...
(
(
{ before(grammarAccess.getErrorBehaviorTransitionAccess().getGroup_4_0_1_1_2()); }
(rule__ErrorBehaviorTransition__Group_4_0_1_1_2__0)
{ after(grammarAccess.getErrorBehaviorTransitionAccess().getGroup_4_0_1_1_2()); }
)
(
{ before(grammarAccess.getErrorBehaviorTransitionAccess().getGroup_4_0_1_1_2()); }
(rule__ErrorBehaviorTransition__Group_4_0_1_1_2__0)*
...
:
	rule__ErrorBehaviorTransition__Group_4_0_1_1__3__Impl
;
finally {
	restoreStackSize(stackSize);
}
...
:
(
{ before(grammarAccess.getErrorBehaviorTransitionAccess().getRightParenthesisKeyword_4_0_1_1_3()); }

	KEYWORD_3 

{ after(grammarAccess.getErrorBehaviorTransitionAccess().getRightParenthesisKeyword_4_0_1_1_3()); }
)
...
:
	rule__ErrorBehaviorTransition__Group_4_0_1_1_2__0__Impl
	rule__ErrorBehaviorTransition__Group_4_0_1_1_2__1
;
finally {
	restoreStackSize(stackSize);
}
...
:
(
{ before(grammarAccess.getErrorBehaviorTransitionAccess().getCommaKeyword_4_0_1_1_2_0()); }

	KEYWORD_6 

{ after(grammarAccess.getErrorBehaviorTransitionAccess().getCommaKeyword_4_0_1_1_2_0()); }
)
...
:
	rule__ErrorBehaviorTransition__Group_4_0_1_1_2__1__Impl
;
finally {
	restoreStackSize(stackSize);
}
...
:
(
{ before(grammarAccess.getErrorBehaviorTransitionAccess().getDestinationBranchesAssignment_4_0_1_1_2_1()); }
(rule__ErrorBehaviorTransition__DestinationBranchesAssignment_4_0_1_1_2_1)
{ after(grammarAccess.getErrorBehaviorTransitionAccess().getDestinationBranchesAssignment_4_0_1_1_2_1()); }
)
...
:
	rule__ConnectionErrorBehavior__Group__0__Impl
	rule__ConnectionErrorBehavior__Group__1
;
finally {
	restoreStackSize(stackSize);
}
...
:
(
{ before(grammarAccess.getConnectionErrorBehaviorAccess().getConnectionKeyword_0()); }

	KEYWORD_82 

{ after(grammarAccess.getConnectionErrorBehaviorAccess().getConnectionKeyword_0()); }
)
...
:
	rule__ConnectionErrorBehavior__Group__1__Impl
	rule__ConnectionErrorBehavior__Group__2
;
finally {
	restoreStackSize(stackSize);
}
...
:
(
{ before(grammarAccess.getConnectionErrorBehaviorAccess().getErrorKeyword_1()); }

	KEYWORD_43 

{ after(grammarAccess.getConnectionErrorBehaviorAccess().getErrorKeyword_1()); }
)
...
:
	rule__ConnectionErrorBehavior__Group__2__Impl
	rule__ConnectionErrorBehavior__Group__3
;
finally {
	restoreStackSize(stackSize);
}
...
:
(
{ before(grammarAccess.getConnectionErrorBehaviorAccess().getBehaviorKeyword_2()); }

	KEYWORD_73 

{ after(grammarAccess.getConnectionErrorBehaviorAccess().getBehaviorKeyword_2()); }
)
...
:
	rule__ConnectionErrorBehavior__Group__3__Impl
	rule__ConnectionErrorBehavior__Group__4
;
finally {
	restoreStackSize(stackSize);
}
...
:
(
{ before(grammarAccess.getConnectionErrorBehaviorAccess().getConnectionErrorBehaviorAction_3()); }
(

)
{ after(grammarAccess.getConnectionErrorBehaviorAccess().getConnectionErrorBehaviorAction_3()); }
)
...
:
	rule__ConnectionErrorBehavior__Group__4__Impl
	rule__ConnectionErrorBehavior__Group__5
;
finally {
	restoreStackSize(stackSize);
}
...
:
(
{ before(grammarAccess.getConnectionErrorBehaviorAccess().getGroup_4()); }
(rule__ConnectionErrorBehavior__Group_4__0)?
{ after(grammarAccess.getConnectionErrorBehaviorAccess().getGroup_4()); }
)
...
:
	rule__ConnectionErrorBehavior__Group__5__Impl
	rule__ConnectionErrorBehavior__Group__6
;
finally {
	restoreStackSize(stackSize);
}
...
:
(
{ before(grammarAccess.getConnectionErrorBehaviorAccess().getConnectionErrorSourcesAssignment_5()); }
(rule__ConnectionErrorBehavior__ConnectionErrorSourcesAssignment_5)*
{ after(grammarAccess.getConnectionErrorBehaviorAccess().getConnectionErrorSourcesAssignment_5()); }
)
...
:
	rule__ConnectionErrorBehavior__Group__6__Impl
	rule__ConnectionErrorBehavior__Group__7
;
finally {
	restoreStackSize(stackSize);
}
...
:
(
{ before(grammarAccess.getConnectionErrorBehaviorAccess().getEndKeyword_6()); }

	KEYWORD_28 

{ after(grammarAccess.getConnectionErrorBehaviorAccess().getEndKeyword_6()); }
)
...
:
	rule__ConnectionErrorBehavior__Group__7__Impl
	rule__ConnectionErrorBehavior__Group__8
;
finally {
	restoreStackSize(stackSize);
}
...
:
(
{ before(grammarAccess.getConnectionErrorBehaviorAccess().getConnectionKeyword_7()); }

	KEYWORD_82 

{ after(grammarAccess.getConnectionErrorBehaviorAccess().getConnectionKeyword_7()); }
)
...
:
	rule__ConnectionErrorBehavior__Group__8__Impl
;
finally {
	restoreStackSize(stackSize);
}
...
:
(
{ before(grammarAccess.getConnectionErrorBehaviorAccess().getSemicolonKeyword_8()); }

	KEYWORD_10 

{ after(grammarAccess.getConnectionErrorBehaviorAccess().getSemicolonKeyword_8()); }
)
...
:
	rule__ConnectionErrorBehavior__Group_4__0__Impl
	rule__ConnectionErrorBehavior__Group_4__1
;
finally {
	restoreStackSize(stackSize);
}
...
:
(
{ before(grammarAccess.getConnectionErrorBehaviorAccess().getUseKeyword_4_0()); }

	KEYWORD_32 

{ after(grammarAccess.getConnectionErrorBehaviorAccess().getUseKeyword_4_0()); }
)
...
:
	rule__ConnectionErrorBehavior__Group_4__1__Impl
	rule__ConnectionErrorBehavior__Group_4__2
;
finally {
	restoreStackSize(stackSize);
}
...
:
(
{ before(grammarAccess.getConnectionErrorBehaviorAccess().getTransformationsKeyword_4_1()); }

	KEYWORD_89 

{ after(grammarAccess.getConnectionErrorBehaviorAccess().getTransformationsKeyword_4_1()); }
)
...
:
	rule__ConnectionErrorBehavior__Group_4__2__Impl
	rule__ConnectionErrorBehavior__Group_4__3
;
finally {
	restoreStackSize(stackSize);
}
...
:
(
{ before(grammarAccess.getConnectionErrorBehaviorAccess().getTypeTransformationSetAssignment_4_2()); }
(rule__ConnectionErrorBehavior__TypeTransformationSetAssignment_4_2)
{ after(grammarAccess.getConnectionErrorBehaviorAccess().getTypeTransformationSetAssignment_4_2()); }
)
...
:
	rule__ConnectionErrorBehavior__Group_4__3__Impl
;
finally {
	restoreStackSize(stackSize);
}
...
:
(
{ before(grammarAccess.getConnectionErrorBehaviorAccess().getSemicolonKeyword_4_3()); }

	KEYWORD_10 

{ after(grammarAccess.getConnectionErrorBehaviorAccess().getSemicolonKeyword_4_3()); }
)
...
:
(
{ before(grammarAccess.getConnectionErrorSourceAccess().getFailureModeTypeAssignment_6_1()); }
(rule__ConnectionErrorSource__FailureModeTypeAssignment_6_1)
{ after(grammarAccess.getConnectionErrorSourceAccess().getFailureModeTypeAssignment_6_1()); }
)
...
:
(
{ before(grammarAccess.getOutgoingPropagationConditionAccess().getAlternatives_5_0_0()); }
(rule__OutgoingPropagationCondition__Alternatives_5_0_0)
{ after(grammarAccess.getOutgoingPropagationConditionAccess().getAlternatives_5_0_0()); }
)
...
:
(
{ before(grammarAccess.getErrorModelSubclauseAccess().getErrorPropagationsErrorPropagationsParserRuleCall_3_0()); }
	ruleErrorPropagations{ after(grammarAccess.getErrorModelSubclauseAccess().getErrorPropagationsErrorPropagationsParserRuleCall_3_0()); }
)
...
:
(
{ before(grammarAccess.getErrorModelSubclauseAccess().getConnectionBehaviorConnectionErrorBehaviorParserRuleCall_6_0()); }
	ruleConnectionErrorBehavior{ after(grammarAccess.getErrorModelSubclauseAccess().getConnectionBehaviorConnectionErrorBehaviorParserRuleCall_6_0()); }
)
...
:
(
{ before(grammarAccess.getErrorModelSubclauseAccess().getPropagationPathsPropagationPathsParserRuleCall_7_0()); }
	rulePropagationPaths{ after(grammarAccess.getErrorModelSubclauseAccess().getPropagationPathsPropagationPathsParserRuleCall_7_0()); }
)
...
:
(
{ before(grammarAccess.getTypeTokenOrNoErrorAccess().getTypeErrorTypeCrossReference_2_0_0_0()); }
(
{ before(grammarAccess.getTypeTokenOrNoErrorAccess().getTypeErrorTypeQEMREFParserRuleCall_2_0_0_0_1()); }
	ruleQEMREF{ after(grammarAccess.getTypeTokenOrNoErrorAccess().getTypeErrorTypeQEMREFParserRuleCall_2_0_0_0_1()); }
)
{ after(grammarAccess.getTypeTokenOrNoErrorAccess().getTypeErrorTypeCrossReference_2_0_0_0()); }
)
...
:
(
{ before(grammarAccess.getTypeTokenOrNoErrorAccess().getTypeErrorTypeCrossReference_2_0_1_1_0()); }
(
{ before(grammarAccess.getTypeTokenOrNoErrorAccess().getTypeErrorTypeQEMREFParserRuleCall_2_0_1_1_0_1()); }
	ruleQEMREF{ after(grammarAccess.getTypeTokenOrNoErrorAccess().getTypeErrorTypeQEMREFParserRuleCall_2_0_1_1_0_1()); }
)
{ after(grammarAccess.getTypeTokenOrNoErrorAccess().getTypeErrorTypeCrossReference_2_0_1_1_0()); }
)
...
:
(
{ before(grammarAccess.getErrorPropagationAccess().getFeaturerefsFeatureReferenceParserRuleCall_1_1_0_0()); }
	ruleFeatureReference{ after(grammarAccess.getErrorPropagationAccess().getFeaturerefsFeatureReferenceParserRuleCall_1_1_0_0()); }
)
...
:
(
{ before(grammarAccess.getErrorPropagationAccess().getFeaturerefsFeatureReferenceParserRuleCall_1_1_1_1_0()); }
	ruleFeatureReference{ after(grammarAccess.getErrorPropagationAccess().getFeaturerefsFeatureReferenceParserRuleCall_1_1_1_1_0()); }
)
...
:
(
{ before(grammarAccess.getFeatureReferenceAccess().getFeatureNamedElementCrossReference_0()); }
(
{ before(grammarAccess.getFeatureReferenceAccess().getFeatureNamedElementIDTerminalRuleCall_0_1()); }
	RULE_ID{ after(grammarAccess.getFeatureReferenceAccess().getFeatureNamedElementIDTerminalRuleCall_0_1()); }
)
{ after(grammarAccess.getFeatureReferenceAccess().getFeatureNamedElementCrossReference_0()); }
)
...
:
(
{ before(grammarAccess.getPropagationPathsAccess().getPointsPropagationPointParserRuleCall_2_0()); }
	rulePropagationPoint{ after(grammarAccess.getPropagationPathsAccess().getPointsPropagationPointParserRuleCall_2_0()); }
)
...
:
(
{ before(grammarAccess.getPropagationPathsAccess().getConnectionsPropagationPointConnectionParserRuleCall_3_1_0()); }
	rulePropagationPointConnection{ after(grammarAccess.getPropagationPathsAccess().getConnectionsPropagationPointConnectionParserRuleCall_3_1_0()); }
)
...
:
(
{ before(grammarAccess.getPropagationPointConnectionAccess().getNameIDTerminalRuleCall_0_0()); }
	RULE_ID{ after(grammarAccess.getPropagationPointConnectionAccess().getNameIDTerminalRuleCall_0_0()); }
)
...
:
(
{ before(grammarAccess.getPropagationPointConnectionAccess().getSourceQualifiedPropagationPointParserRuleCall_2_0()); }
	ruleQualifiedPropagationPoint{ after(grammarAccess.getPropagationPointConnectionAccess().getSourceQualifiedPropagationPointParserRuleCall_2_0()); }
)
...
:
(
{ before(grammarAccess.getPropagationPointConnectionAccess().getTargetQualifiedPropagationPointParserRuleCall_4_0()); }
	ruleQualifiedPropagationPoint{ after(grammarAccess.getPropagationPointConnectionAccess().getTargetQualifiedPropagationPointParserRuleCall_4_0()); }
)
...
:
(
{ before(grammarAccess.getQualifiedPropagationPointAccess().getSubcomponentSubcomponentCrossReference_0_0_0()); }
(
{ before(grammarAccess.getQualifiedPropagationPointAccess().getSubcomponentSubcomponentIDTerminalRuleCall_0_0_0_1()); }
	RULE_ID{ after(grammarAccess.getQualifiedPropagationPointAccess().getSubcomponentSubcomponentIDTerminalRuleCall_0_0_0_1()); }
)
{ after(grammarAccess.getQualifiedPropagationPointAccess().getSubcomponentSubcomponentCrossReference_0_0_0()); }
)
...
:
(
{ before(grammarAccess.getErrorBehaviorTransitionAccess().getTargetErrorBehaviorStateCrossReference_4_0_1_0_0_0_0()); }
(
{ before(grammarAccess.getErrorBehaviorTransitionAccess().getTargetErrorBehaviorStateIDTerminalRuleCall_4_0_1_0_0_0_0_1()); }
	RULE_ID{ after(grammarAccess.getErrorBehaviorTransitionAccess().getTargetErrorBehaviorStateIDTerminalRuleCall_4_0_1_0_0_0_0_1()); }
)
{ after(grammarAccess.getErrorBehaviorTransitionAccess().getTargetErrorBehaviorStateCrossReference_4_0_1_0_0_0_0()); }
)
...
:
(
{ before(grammarAccess.getErrorBehaviorTransitionAccess().getTargetTokenTypeTokenParserRuleCall_4_0_1_0_0_1_0()); }
	ruleTypeToken{ after(grammarAccess.getErrorBehaviorTransitionAccess().getTargetTokenTypeTokenParserRuleCall_4_0_1_0_0_1_0()); }
)
...
:
(
{ before(grammarAccess.getErrorBehaviorTransitionAccess().getMaskMaskKeyword_4_0_1_0_1_0()); }
(
{ before(grammarAccess.getErrorBehaviorTransitionAccess().getMaskMaskKeyword_4_0_1_0_1_0()); }

	KEYWORD_33 

{ after(grammarAccess.getErrorBehaviorTransitionAccess().getMaskMaskKeyword_4_0_1_0_1_0()); }
)
...
:
(
{ before(grammarAccess.getErrorBehaviorTransitionAccess().getDestinationBranchesTransitionBranchParserRuleCall_4_0_1_1_1_0()); }
	ruleTransitionBranch{ after(grammarAccess.getErrorBehaviorTransitionAccess().getDestinationBranchesTransitionBranchParserRuleCall_4_0_1_1_1_0()); }
)
...
:
(
{ before(grammarAccess.getErrorBehaviorTransitionAccess().getDestinationBranchesTransitionBranchParserRuleCall_4_0_1_1_2_1_0()); }
	ruleTransitionBranch{ after(grammarAccess.getErrorBehaviorTransitionAccess().getDestinationBranchesTransitionBranchParserRuleCall_4_0_1_1_2_1_0()); }
)
...
:
(
{ before(grammarAccess.getErrorBehaviorTransitionAccess().getMaskRightSquareBracketKeyword_4_1_0()); }
(
{ before(grammarAccess.getErrorBehaviorTransitionAccess().getMaskRightSquareBracketKeyword_4_1_0()); }

	KEYWORD_12 

{ after(grammarAccess.getErrorBehaviorTransitionAccess().getMaskRightSquareBracketKeyword_4_1_0()); }
)
...
:
(
{ before(grammarAccess.getConnectionErrorBehaviorAccess().getTypeTransformationSetTypeTransformationSetCrossReference_4_2_0()); }
(
{ before(grammarAccess.getConnectionErrorBehaviorAccess().getTypeTransformationSetTypeTransformationSetQEMREFParserRuleCall_4_2_0_1()); }
	ruleQEMREF{ after(grammarAccess.getConnectionErrorBehaviorAccess().getTypeTransformationSetTypeTransformationSetQEMREFParserRuleCall_4_2_0_1()); }
)
{ after(grammarAccess.getConnectionErrorBehaviorAccess().getTypeTransformationSetTypeTransformationSetCrossReference_4_2_0()); }
)
...
:
(
{ before(grammarAccess.getConnectionErrorBehaviorAccess().getConnectionErrorSourcesConnectionErrorSourceParserRuleCall_5_0()); }
	ruleConnectionErrorSource{ after(grammarAccess.getConnectionErrorBehaviorAccess().getConnectionErrorSourcesConnectionErrorSourceParserRuleCall_5_0()); }
)
...
:
(
{ before(grammarAccess.getConnectionErrorSourceAccess().getFailureModeTypeTypeSetConstructorParserRuleCall_6_1_0()); }
	ruleTypeSetConstructor{ after(grammarAccess.getConnectionErrorSourceAccess().getFailureModeTypeTypeSetConstructorParserRuleCall_6_1_0()); }
)
...
:
(
{ before(grammarAccess.getOutgoingPropagationConditionAccess().getOutgoingErrorPropagationCrossReference_5_0_0_0_0()); }
(
{ before(grammarAccess.getOutgoingPropagationConditionAccess().getOutgoingErrorPropagationErrorPropagationPointParserRuleCall_5_0_0_0_0_1()); }
	ruleErrorPropagationPoint{ after(grammarAccess.getOutgoingPropagationConditionAccess().getOutgoingErrorPropagationErrorPropagationPointParserRuleCall_5_0_0_0_0_1()); }
)
{ after(grammarAccess.getOutgoingPropagationConditionAccess().getOutgoingErrorPropagationCrossReference_5_0_0_0_0()); }
)
...
:
(
{ before(grammarAccess.getOutgoingPropagationConditionAccess().getAllPropagationsAllKeyword_5_0_0_1_0()); }
(
{ before(grammarAccess.getOutgoingPropagationConditionAccess().getAllPropagationsAllKeyword_5_0_0_1_0()); }

	KEYWORD_25 

{ after(grammarAccess.getOutgoingPropagationConditionAccess().getAllPropagationsAllKeyword_5_0_0_1_0()); }
)
...
:
(
{ before(grammarAccess.getOutgoingPropagationConditionAccess().getTypeTokenTypeTokenOrNoErrorParserRuleCall_5_0_1_0()); }
	ruleTypeTokenOrNoError{ after(grammarAccess.getOutgoingPropagationConditionAccess().getTypeTokenTypeTokenOrNoErrorParserRuleCall_5_0_1_0()); }
)
