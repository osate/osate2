		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getTypeTokenOrNoErrorAccess().getAlternatives_2(), "rule__TypeTokenOrNoError__Alternatives_2");
					...
					put(grammarAccess.getErrorModelSubclauseAccess().getGroup_3_3(), "rule__ErrorModelSubclause__Group_3_3__0");
					...
					put(grammarAccess.getErrorModelSubclauseAccess().getGroup_4_4(), "rule__ErrorModelSubclause__Group_4_4__0");
					put(grammarAccess.getErrorModelSubclauseAccess().getGroup_4_5(), "rule__ErrorModelSubclause__Group_4_5__0");
					put(grammarAccess.getErrorModelSubclauseAccess().getGroup_4_6(), "rule__ErrorModelSubclause__Group_4_6__0");
					put(grammarAccess.getErrorModelSubclauseAccess().getGroup_4_7(), "rule__ErrorModelSubclause__Group_4_7__0");
					put(grammarAccess.getErrorModelSubclauseAccess().getGroup_4_8(), "rule__ErrorModelSubclause__Group_4_8__0");
					...
					put(grammarAccess.getTypeTokenOrNoErrorAccess().getGroup(), "rule__TypeTokenOrNoError__Group__0");
					put(grammarAccess.getTypeTokenOrNoErrorAccess().getGroup_2_0(), "rule__TypeTokenOrNoError__Group_2_0__0");
					put(grammarAccess.getTypeTokenOrNoErrorAccess().getGroup_2_0_1(), "rule__TypeTokenOrNoError__Group_2_0_1__0");
					...
					put(grammarAccess.getErrorModelSubclauseAccess().getPropagationsAssignment_3_2(), "rule__ErrorModelSubclause__PropagationsAssignment_3_2");
					put(grammarAccess.getErrorModelSubclauseAccess().getFlowsAssignment_3_3_1(), "rule__ErrorModelSubclause__FlowsAssignment_3_3_1");
					put(grammarAccess.getErrorModelSubclauseAccess().getUseTransformationAssignment_4_3_2(), "rule__ErrorModelSubclause__UseTransformationAssignment_4_3_2");
					put(grammarAccess.getErrorModelSubclauseAccess().getEventsAssignment_4_4_1(), "rule__ErrorModelSubclause__EventsAssignment_4_4_1");
					put(grammarAccess.getErrorModelSubclauseAccess().getTransitionsAssignment_4_5_1(), "rule__ErrorModelSubclause__TransitionsAssignment_4_5_1");
					put(grammarAccess.getErrorModelSubclauseAccess().getOutgoingPropagationConditionsAssignment_4_6_1(), "rule__ErrorModelSubclause__OutgoingPropagationConditionsAssignment_4_6_1");
					put(grammarAccess.getErrorModelSubclauseAccess().getErrorDetectionsAssignment_4_7_1(), "rule__ErrorModelSubclause__ErrorDetectionsAssignment_4_7_1");
					put(grammarAccess.getErrorModelSubclauseAccess().getErrorStateToModeMappingsAssignment_4_8_2(), "rule__ErrorModelSubclause__ErrorStateToModeMappingsAssignment_4_8_2");
					put(grammarAccess.getErrorModelSubclauseAccess().getStatesAssignment_5_3_1(), "rule__ErrorModelSubclause__StatesAssignment_5_3_1");
					put(grammarAccess.getErrorModelSubclauseAccess().getTypeTransformationSetAssignment_6_3_2(), "rule__ErrorModelSubclause__TypeTransformationSetAssignment_6_3_2");
					put(grammarAccess.getErrorModelSubclauseAccess().getConnectionErrorSourcesAssignment_6_4(), "rule__ErrorModelSubclause__ConnectionErrorSourcesAssignment_6_4");
					put(grammarAccess.getErrorModelSubclauseAccess().getPointsAssignment_7_2(), "rule__ErrorModelSubclause__PointsAssignment_7_2");
					put(grammarAccess.getErrorModelSubclauseAccess().getConnectionsAssignment_7_3_1(), "rule__ErrorModelSubclause__ConnectionsAssignment_7_3_1");
					...
					put(grammarAccess.getTypeTokenOrNoErrorAccess().getTypeAssignment_2_0_1_1(), "rule__TypeTokenOrNoError__TypeAssignment_2_0_1_1");
					put(grammarAccess.getTypeTokenOrNoErrorAccess().getNoErrorAssignment_2_1(), "rule__TypeTokenOrNoError__NoErrorAssignment_2_1");
