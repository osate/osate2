		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getErrorPropagationsAccess().getGroup_3_3(), "rule__ErrorPropagations__Group_3_3__0");
					put(grammarAccess.getErrorPropagationsAccess().getGroup_4(), "rule__ErrorPropagations__Group_4__0");
					put(grammarAccess.getErrorPropagationsAccess().getGroup_6(), "rule__ErrorPropagations__Group_6__0");
					put(grammarAccess.getErrorPropagationsAccess().getGroup_7(), "rule__ErrorPropagations__Group_7__0");
					...
					put(grammarAccess.getErrorModelSubclauseAccess().getPropagationAssignment_1(), "rule__ErrorModelSubclause__PropagationAssignment_1");
					put(grammarAccess.getErrorModelSubclauseAccess().getComponentBehaviorAssignment_2(), "rule__ErrorModelSubclause__ComponentBehaviorAssignment_2");
					put(grammarAccess.getErrorModelSubclauseAccess().getCompositeBehaviorAssignment_3(), "rule__ErrorModelSubclause__CompositeBehaviorAssignment_3");
					put(grammarAccess.getErrorModelSubclauseAccess().getObservablePropagationConnectionsAssignment_4(), "rule__ErrorModelSubclause__ObservablePropagationConnectionsAssignment_4");
					put(grammarAccess.getErrorModelSubclauseAccess().getConnectionTransformationAssignment_5(), "rule__ErrorModelSubclause__ConnectionTransformationAssignment_5");
					put(grammarAccess.getErrorModelSubclauseAccess().getPropertiesAssignment_6_1(), "rule__ErrorModelSubclause__PropertiesAssignment_6_1");
					...
					put(grammarAccess.getErrorPropagationsAccess().getUseTypesAssignment_3_2(), "rule__ErrorPropagations__UseTypesAssignment_3_2");
					put(grammarAccess.getErrorPropagationsAccess().getUseTypesAssignment_3_3_1(), "rule__ErrorPropagations__UseTypesAssignment_3_3_1");
					put(grammarAccess.getErrorPropagationsAccess().getUseBehaviorAssignment_4_2(), "rule__ErrorPropagations__UseBehaviorAssignment_4_2");
					put(grammarAccess.getErrorPropagationsAccess().getPropagationsAssignment_5(), "rule__ErrorPropagations__PropagationsAssignment_5");
					put(grammarAccess.getErrorPropagationsAccess().getFlowsAssignment_6_1(), "rule__ErrorPropagations__FlowsAssignment_6_1");
					put(grammarAccess.getErrorPropagationsAccess().getPropertiesAssignment_7_1(), "rule__ErrorPropagations__PropertiesAssignment_7_1");
