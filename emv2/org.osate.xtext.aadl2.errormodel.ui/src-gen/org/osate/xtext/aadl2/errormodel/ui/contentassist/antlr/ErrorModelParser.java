		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getEMV2PropertyAssociationAccess().getGroup_5_0(), "rule__EMV2PropertyAssociation__Group_5_0__0");
					...
					put(grammarAccess.getEMV2PropertyAssociationAccess().getOwnedValueAssignment_2_0(), "rule__EMV2PropertyAssociation__OwnedValueAssignment_2_0");
					put(grammarAccess.getEMV2PropertyAssociationAccess().getOwnedValueAssignment_2_1_1(), "rule__EMV2PropertyAssociation__OwnedValueAssignment_2_1_1");
					put(grammarAccess.getEMV2PropertyAssociationAccess().getAppliesToAssignment_5_0_0(), "rule__EMV2PropertyAssociation__AppliesToAssignment_5_0_0");
					put(grammarAccess.getEMV2PropertyAssociationAccess().getEmv2PathAssignment_5_1(), "rule__EMV2PropertyAssociation__Emv2PathAssignment_5_1");
