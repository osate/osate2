		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getErrorBehaviorTransitionAccess().getAlternatives_4(), "rule__ErrorBehaviorTransition__Alternatives_4");
					...
					put(grammarAccess.getErrorBehaviorTransitionAccess().getAlternatives_4_0_1_0(), "rule__ErrorBehaviorTransition__Alternatives_4_0_1_0");
					...
					put(grammarAccess.getPropagationPathsAccess().getGroup(), "rule__PropagationPaths__Group__0");
					put(grammarAccess.getPropagationPathsAccess().getGroup_3(), "rule__PropagationPaths__Group_3__0");
					...
					put(grammarAccess.getErrorBehaviorTransitionAccess().getGroup_4_0(), "rule__ErrorBehaviorTransition__Group_4_0__0");
					put(grammarAccess.getErrorBehaviorTransitionAccess().getGroup_4_0_1_0_0(), "rule__ErrorBehaviorTransition__Group_4_0_1_0_0__0");
					put(grammarAccess.getErrorBehaviorTransitionAccess().getGroup_4_0_1_1(), "rule__ErrorBehaviorTransition__Group_4_0_1_1__0");
					put(grammarAccess.getErrorBehaviorTransitionAccess().getGroup_4_0_1_1_2(), "rule__ErrorBehaviorTransition__Group_4_0_1_1_2__0");
					...
					put(grammarAccess.getErrorPropagationAccess().getFeaturerefsAssignment_1_1_0(), "rule__ErrorPropagation__FeaturerefsAssignment_1_1_0");
					put(grammarAccess.getErrorPropagationAccess().getFeaturerefsAssignment_1_1_1_1(), "rule__ErrorPropagation__FeaturerefsAssignment_1_1_1_1");
					...
					put(grammarAccess.getPropagationPathsAccess().getPointsAssignment_2(), "rule__PropagationPaths__PointsAssignment_2");
					put(grammarAccess.getPropagationPathsAccess().getConnectionsAssignment_3_1(), "rule__PropagationPaths__ConnectionsAssignment_3_1");
					...
					put(grammarAccess.getErrorBehaviorTransitionAccess().getTargetAssignment_4_0_1_0_0_0(), "rule__ErrorBehaviorTransition__TargetAssignment_4_0_1_0_0_0");
					put(grammarAccess.getErrorBehaviorTransitionAccess().getTargetTokenAssignment_4_0_1_0_0_1(), "rule__ErrorBehaviorTransition__TargetTokenAssignment_4_0_1_0_0_1");
					put(grammarAccess.getErrorBehaviorTransitionAccess().getMaskAssignment_4_0_1_0_1(), "rule__ErrorBehaviorTransition__MaskAssignment_4_0_1_0_1");
					put(grammarAccess.getErrorBehaviorTransitionAccess().getDestinationBranchesAssignment_4_0_1_1_1(), "rule__ErrorBehaviorTransition__DestinationBranchesAssignment_4_0_1_1_1");
					put(grammarAccess.getErrorBehaviorTransitionAccess().getDestinationBranchesAssignment_4_0_1_1_2_1(), "rule__ErrorBehaviorTransition__DestinationBranchesAssignment_4_0_1_1_2_1");
					put(grammarAccess.getErrorBehaviorTransitionAccess().getMaskAssignment_4_1(), "rule__ErrorBehaviorTransition__MaskAssignment_4_1");
					...
					put(grammarAccess.getOutgoingPropagationConditionAccess().getAllPropagationsAssignment_5_0_0_1(), "rule__OutgoingPropagationCondition__AllPropagationsAssignment_5_0_0_1");
