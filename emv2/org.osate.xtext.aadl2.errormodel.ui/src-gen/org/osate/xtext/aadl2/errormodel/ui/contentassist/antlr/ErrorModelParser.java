		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getErrorModelSubclauseAccess().getGroup_5_4(), "rule__ErrorModelSubclause__Group_5_4__0");
					put(grammarAccess.getErrorModelSubclauseAccess().getGroup_5_5(), "rule__ErrorModelSubclause__Group_5_5__0");
					put(grammarAccess.getErrorModelSubclauseAccess().getGroup_5_6(), "rule__ErrorModelSubclause__Group_5_6__0");
					put(grammarAccess.getErrorModelSubclauseAccess().getGroup_5_7(), "rule__ErrorModelSubclause__Group_5_7__0");
					put(grammarAccess.getErrorModelSubclauseAccess().getGroup_5_8(), "rule__ErrorModelSubclause__Group_5_8__0");
					...
					put(grammarAccess.getErrorModelSubclauseAccess().getUseBehaviorAssignment_3_2(), "rule__ErrorModelSubclause__UseBehaviorAssignment_3_2");
					put(grammarAccess.getErrorModelSubclauseAccess().getPropagationsAssignment_4_2(), "rule__ErrorModelSubclause__PropagationsAssignment_4_2");
					put(grammarAccess.getErrorModelSubclauseAccess().getFlowsAssignment_4_3_1(), "rule__ErrorModelSubclause__FlowsAssignment_4_3_1");
					put(grammarAccess.getErrorModelSubclauseAccess().getUseTransformationAssignment_5_3_2(), "rule__ErrorModelSubclause__UseTransformationAssignment_5_3_2");
					put(grammarAccess.getErrorModelSubclauseAccess().getEventsAssignment_5_4_1(), "rule__ErrorModelSubclause__EventsAssignment_5_4_1");
					put(grammarAccess.getErrorModelSubclauseAccess().getTransitionsAssignment_5_5_1(), "rule__ErrorModelSubclause__TransitionsAssignment_5_5_1");
					put(grammarAccess.getErrorModelSubclauseAccess().getOutgoingPropagationConditionsAssignment_5_6_1(), "rule__ErrorModelSubclause__OutgoingPropagationConditionsAssignment_5_6_1");
