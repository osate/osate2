		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getErrorModelSubclauseAccess().getGroup_9_3(), "rule__ErrorModelSubclause__Group_9_3__0");
					...
					put(grammarAccess.getTypeActualAccess().getGroup(), "rule__TypeActual__Group__0");
					...
					put(grammarAccess.getPropagationPointConnectionAccess().getGroup(), "rule__PropagationPointConnection__Group__0");
					...
					put(grammarAccess.getErrorBehaviorStateMachineAccess().getGroup_3_2(), "rule__ErrorBehaviorStateMachine__Group_3_2__0");
					...
					put(grammarAccess.getErrorBehaviorStateMachineAccess().getGroup_5_3(), "rule__ErrorBehaviorStateMachine__Group_5_3__0");
					...
					put(grammarAccess.getErrorBehaviorStateMachineAccess().getGroup_10(), "rule__ErrorBehaviorStateMachine__Group_10__0");
					...
					put(grammarAccess.getErrorModelSubclauseAccess().getTypeBindingAssignment_4_3_1(), "rule__ErrorModelSubclause__TypeBindingAssignment_4_3_1");
					put(grammarAccess.getErrorModelSubclauseAccess().getTypeBindingAssignment_4_3_2_1(), "rule__ErrorModelSubclause__TypeBindingAssignment_4_3_2_1");
					...
					put(grammarAccess.getErrorModelSubclauseAccess().getConnectionsAssignment_9_3_1(), "rule__ErrorModelSubclause__ConnectionsAssignment_9_3_1");
					...
					put(grammarAccess.getTypeActualAccess().getFormalAssignment_0(), "rule__TypeActual__FormalAssignment_0");
					put(grammarAccess.getTypeActualAccess().getActualTypeAssignment_2(), "rule__TypeActual__ActualTypeAssignment_2");
					...
					put(grammarAccess.getErrorPathAccess().getTargetTokenAssignment_8(), "rule__ErrorPath__TargetTokenAssignment_8");
					put(grammarAccess.getPropagationPointAccess().getNameAssignment_0(), "rule__PropagationPoint__NameAssignment_0");
					put(grammarAccess.getPropagationPointConnectionAccess().getNameAssignment_0(), "rule__PropagationPointConnection__NameAssignment_0");
					put(grammarAccess.getPropagationPointConnectionAccess().getSourceAssignment_2(), "rule__PropagationPointConnection__SourceAssignment_2");
					put(grammarAccess.getPropagationPointConnectionAccess().getTargetAssignment_4(), "rule__PropagationPointConnection__TargetAssignment_4");
					...
					put(grammarAccess.getErrorBehaviorStateMachineAccess().getParamAssignment_3_1(), "rule__ErrorBehaviorStateMachine__ParamAssignment_3_1");
					put(grammarAccess.getErrorBehaviorStateMachineAccess().getParamAssignment_3_2_1(), "rule__ErrorBehaviorStateMachine__ParamAssignment_3_2_1");
					put(grammarAccess.getErrorBehaviorStateMachineAccess().getExtendsAssignment_4_1(), "rule__ErrorBehaviorStateMachine__ExtendsAssignment_4_1");
					put(grammarAccess.getErrorBehaviorStateMachineAccess().getUseTypesAssignment_5_2(), "rule__ErrorBehaviorStateMachine__UseTypesAssignment_5_2");
					put(grammarAccess.getErrorBehaviorStateMachineAccess().getUseTypesAssignment_5_3_1(), "rule__ErrorBehaviorStateMachine__UseTypesAssignment_5_3_1");
					put(grammarAccess.getErrorBehaviorStateMachineAccess().getUseTransformationAssignment_6_2(), "rule__ErrorBehaviorStateMachine__UseTransformationAssignment_6_2");
					put(grammarAccess.getErrorBehaviorStateMachineAccess().getEventsAssignment_7_1(), "rule__ErrorBehaviorStateMachine__EventsAssignment_7_1");
					put(grammarAccess.getErrorBehaviorStateMachineAccess().getStatesAssignment_8_1(), "rule__ErrorBehaviorStateMachine__StatesAssignment_8_1");
					put(grammarAccess.getErrorBehaviorStateMachineAccess().getTransitionsAssignment_9_1(), "rule__ErrorBehaviorStateMachine__TransitionsAssignment_9_1");
					put(grammarAccess.getErrorBehaviorStateMachineAccess().getPropertiesAssignment_10_1(), "rule__ErrorBehaviorStateMachine__PropertiesAssignment_10_1");
