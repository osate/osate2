...
/**
 * Keeps embedded EMV2 rename operations in the EMV2 injector instead of dispatching by the containing AADL file URI.
 */
public class ErrorModelRenameSupportFactory extends DefaultRenameSupport.Factory {
	@Inject
	private Provider<DefaultRenameSupport> renameSupportProvider;

	@Override
	protected DefaultRenameSupport getDefaultRenameSupport(IRenameElementContext renameElementContext) {
		return renameSupportProvider.get();
	}
}
