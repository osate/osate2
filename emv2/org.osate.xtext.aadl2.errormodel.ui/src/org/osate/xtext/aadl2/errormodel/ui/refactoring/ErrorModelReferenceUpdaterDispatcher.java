...
/**
 * Uses the EMV2 reference updater for annex objects embedded in an AADL resource.
 */
@SuppressWarnings("restriction")
public class ErrorModelReferenceUpdaterDispatcher extends ReferenceUpdaterDispatcher {
	@Inject
	...
	protected ReferenceDescriptionAcceptor createFindReferenceAcceptor(IRefactoringUpdateAcceptor updateAcceptor) {
		IReferenceUpdater referenceUpdater = resourceServiceProvider.get(IReferenceUpdater.class);
