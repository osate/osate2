...
<FaultTree:FaultTree xmi:version="2.0" xmlns:xmi="http://www.omg.org/XMI" xmlns:FaultTree="http://www.aadl.info/FaultTree" name="common_error3_main_commoneventssingleport-failstop" description="Top Level Failure" root="//@events.3">
  <events name="c0-failure-serviceerror" description="Component 'c0' failure event 'ServiceError'" referenceCount="1">
  ...
  <events name="common_error3_main_commoneventssingleport-failstop" description="Component 'main.commoneventssingleport' in failure mode 'FailStop'" subEvents="//@events.1 //@events.0 //@events.2" referenceCount="1" type="Intermediate">
