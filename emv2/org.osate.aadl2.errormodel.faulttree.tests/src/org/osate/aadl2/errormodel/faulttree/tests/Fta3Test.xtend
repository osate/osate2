...
<FaultTree:FaultTree xmi:version="2.0" xmlns:xmi="http://www.omg.org/XMI" xmlns:FaultTree="http://www.aadl.info/FaultTree" name="fta3test_main_i-failed" root="//@events.8">
  ...
  <events name="sens1-f0-badvalue" referenceCount="1">
    ...
    <relatedErrorType href="../../../ErrorModellibrary.aadl#emv2$ErrorModelLibrary.BadValue"/>
  ...
  <events name="s1-failed" subEvents="//@events.2 //@events.0 //@events.1" referenceCount="1" type="Intermediate">
    <relatedInstanceObject href="../../fta3Test_main_i_Instance.aaxl2#//@componentInstance.4"/>
  ...
  <events name="act2-f0-badvalue" referenceCount="1">
  ...
  <events name="s2-failed" subEvents="//@events.6 //@events.4 //@events.5" referenceCount="1" type="Intermediate">
    <relatedInstanceObject href="../../fta3Test_main_i_Instance.aaxl2#//@componentInstance.5"/>
    <relatedEMV2Object href="../../../ErrorModellibrary.aadl#/0/@ownedPublicSection/@ownedAnnexLibrary.0/@parsedAnnexLibrary/@behaviors.0/@states.1"/>
  </events>
