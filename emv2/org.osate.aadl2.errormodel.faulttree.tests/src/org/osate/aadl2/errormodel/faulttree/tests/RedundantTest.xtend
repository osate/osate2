...
<FaultTree:FaultTree xmi:version="2.0" xmlns:xmi="http://www.omg.org/XMI" xmlns:FaultTree="http://www.aadl.info/FaultTree" name="redundant_main_compositestate-failstop" description="Top Level Failure" root="//@events.4">
  <events name="sensor1-failure" description="Component 'sensor1'" referenceCount="1">
    <relatedInstanceObject href="../../changeme_main_compositestate_Instance.aaxl2#//@componentInstance.1"/>
  ...
  <events name="sensor2-failure" description="Component 'sensor2'" referenceCount="1">
    <relatedInstanceObject href="../../changeme_main_compositestate_Instance.aaxl2#//@componentInstance.2"/>
    <relatedEMV2Object href="../../../../../plugin/org.osate.aadl2.errormodel.contrib/resources/packages/ErrorLibrary.aadl#/0/@ownedPublicSection/@ownedAnnexLibrary.0/@parsedAnnexLibrary/@behaviors.0/@events.0"/>
  </events>
  <events name="actuator-failure" description="Component 'actuator'" referenceCount="1">
    <relatedInstanceObject href="../../changeme_main_compositestate_Instance.aaxl2#//@componentInstance.3"/>
    <relatedEMV2Object href="../../../../../plugin/org.osate.aadl2.errormodel.contrib/resources/packages/ErrorLibrary.aadl#/0/@ownedPublicSection/@ownedAnnexLibrary.0/@parsedAnnexLibrary/@behaviors.0/@events.0"/>
  </events>
  <events name="voter.thr-failure" description="Component 'voter.thr'" referenceCount="1">
    <relatedInstanceObject href="../../changeme_main_compositestate_Instance.aaxl2#//@componentInstance.5/@componentInstance.0"/>
    <relatedEMV2Object href="../../../../../plugin/org.osate.aadl2.errormodel.contrib/resources/packages/ErrorLibrary.aadl#/0/@ownedPublicSection/@ownedAnnexLibrary.0/@parsedAnnexLibrary/@behaviors.0/@events.0"/>
  </events>
  <events name="redundant_main_compositestate-failstop" description="Component 'main.compositestate' in failure mode 'FailStop'" subEvents="//@events.0 //@events.1 //@events.2 //@events.3" referenceCount="1" type="Intermediate">
    <relatedInstanceObject href="../../changeme_main_compositestate_Instance.aaxl2#/"/>
