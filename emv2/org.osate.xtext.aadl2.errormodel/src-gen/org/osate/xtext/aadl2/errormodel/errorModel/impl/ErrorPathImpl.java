...
public class ErrorPathImpl extends ErrorFlowImpl implements ErrorPath {
		...
		if (incoming != null && incoming.eIsProxy()) {
			...
			if (incoming != oldIncoming) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ErrorModelPackage.ERROR_PATH__INCOMING,
	...
	public void setIncoming(ErrorPropagation newIncoming) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ErrorModelPackage.ERROR_PATH__INCOMING, oldIncoming,
					incoming));
	}
	...
	public void setAllIncoming(boolean newAllIncoming) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ErrorModelPackage.ERROR_PATH__ALL_INCOMING,
					oldAllIncoming, allIncoming));
	}
	...
	public ErrorPropagation getOutgoing() {
		if (outgoing != null && outgoing.eIsProxy()) {
			...
			if (outgoing != oldOutgoing) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ErrorModelPackage.ERROR_PATH__OUTGOING,
	...
	public void setOutgoing(ErrorPropagation newOutgoing) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ErrorModelPackage.ERROR_PATH__OUTGOING, oldOutgoing,
					outgoing));
	}
	...
	public void setAllOutgoing(boolean newAllOutgoing) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ErrorModelPackage.ERROR_PATH__ALL_OUTGOING,
	...
	public NotificationChain basicSetTargetToken(TypeSet newTargetToken, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					ErrorModelPackage.ERROR_PATH__TARGET_TOKEN, oldTargetToken, newTargetToken);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newTargetToken != targetToken) {
			...
			if (targetToken != null)
				msgs = ((InternalEObject) targetToken).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - ErrorModelPackage.ERROR_PATH__TARGET_TOKEN, null, msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET, ErrorModelPackage.ERROR_PATH__TARGET_TOKEN,
			...
			if (typeMappingSet != oldTypeMappingSet) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							ErrorModelPackage.ERROR_PATH__TYPE_MAPPING_SET, oldTypeMappingSet, typeMappingSet));
			}
		}
	...
	public void setTypeMappingSet(TypeMappingSet newTypeMappingSet) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ErrorModelPackage.ERROR_PATH__TYPE_MAPPING_SET,
					oldTypeMappingSet, typeMappingSet));
	}
