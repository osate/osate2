...
public class ErrorModelFactoryImpl extends EFactoryImpl implements ErrorModelFactory {
	...
	public static ErrorModelFactory init() {
		try {
			ErrorModelFactory theErrorModelFactory = (ErrorModelFactory) EPackage.Registry.INSTANCE
					.getEFactory(ErrorModelPackage.eNS_URI);
