...
public class CompositeStateImpl extends NamedElementImpl implements CompositeState {
	...
	public NotificationChain basicSetCondition(ConditionExpression newCondition, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					ErrorModelPackage.COMPOSITE_STATE__CONDITION, oldCondition, newCondition);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newCondition != condition) {
			...
			if (condition != null)
				msgs = ((InternalEObject) condition).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - ErrorModelPackage.COMPOSITE_STATE__CONDITION, null, msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET, ErrorModelPackage.COMPOSITE_STATE__CONDITION,
	...
	public void setOthers(boolean newOthers) {
		...
		others = newOthers;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ErrorModelPackage.COMPOSITE_STATE__OTHERS, oldOthers,
					others));
	}
	...
	public ErrorBehaviorState getState() {
		if (state != null && state.eIsProxy()) {
			...
			if (state != oldState) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ErrorModelPackage.COMPOSITE_STATE__STATE,
							oldState, state));
			}
		}
		return state;
	...
	public void setState(ErrorBehaviorState newState) {
		...
		state = newState;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ErrorModelPackage.COMPOSITE_STATE__STATE, oldState,
					state));
	}
	...
	public NotificationChain basicSetTypedToken(TypeSet newTypedToken, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					ErrorModelPackage.COMPOSITE_STATE__TYPED_TOKEN, oldTypedToken, newTypedToken);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
	...
	public void setTypedToken(TypeSet newTypedToken) {
		if (newTypedToken != typedToken) {
			NotificationChain msgs = null;
			if (typedToken != null)
				msgs = ((InternalEObject) typedToken).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - ErrorModelPackage.COMPOSITE_STATE__TYPED_TOKEN, null, msgs);
			if (newTypedToken != null)
				msgs = ((InternalEObject) newTypedToken).eInverseAdd(this,
						EOPPOSITE_FEATURE_BASE - ErrorModelPackage.COMPOSITE_STATE__TYPED_TOKEN, null, msgs);
			msgs = basicSetTypedToken(newTypedToken, msgs);
			if (msgs != null)
				msgs.dispatch();
		} else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ErrorModelPackage.COMPOSITE_STATE__TYPED_TOKEN,
					newTypedToken, newTypedToken));
	}
