...
public class ErrorModelSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		...
		case ErrorModelPackage.ERROR_MODEL_SUBCLAUSE: {
			...
			if (result == null)
				result = caseAnnexSubclause(errorModelSubclause);
			if (result == null)
				result = caseModalElement(errorModelSubclause);
			if (result == null)
				result = caseNamedElement(errorModelSubclause);
			if (result == null)
				result = caseElement(errorModelSubclause);
			if (result == null)
		...
		case ErrorModelPackage.ERROR_MODEL_LIBRARY: {
			...
			if (result == null)
				result = caseAnnexLibrary(errorModelLibrary);
			if (result == null)
				result = caseNamedElement(errorModelLibrary);
			if (result == null)
				result = caseElement(errorModelLibrary);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case ErrorModelPackage.EMV2_PROPERTY_ASSOCIATION: {
			...
			if (result == null)
				result = caseElement(emv2PropertyAssociation);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		...
		case ErrorModelPackage.EMV2_PATH_ELEMENT: {
			...
			if (result == null)
				result = caseElement(emv2PathElement);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case ErrorModelPackage.ERROR_TYPES: {
			...
			if (result == null)
				result = caseNamedElement(errorTypes);
			if (result == null)
				result = caseElement(errorTypes);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case ErrorModelPackage.ERROR_TYPE: {
			...
			if (result == null)
				result = caseErrorTypes(errorType);
			if (result == null)
				result = caseNamedElement(errorType);
			if (result == null)
				result = caseElement(errorType);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case ErrorModelPackage.TYPE_SET: {
			...
			if (result == null)
				result = caseErrorTypes(typeSet);
			if (result == null)
				result = caseNamedElement(typeSet);
			if (result == null)
				result = caseElement(typeSet);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		...
		case ErrorModelPackage.TYPE_TRANSFORMATION_SET: {
			...
			if (result == null)
				result = caseNamedElement(typeTransformationSet);
			if (result == null)
				result = caseElement(typeTransformationSet);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case ErrorModelPackage.TYPE_TRANSFORMATION: {
			...
			if (result == null)
				result = caseElement(typeTransformation);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case ErrorModelPackage.TYPE_MAPPING_SET: {
			...
			if (result == null)
				result = caseNamedElement(typeMappingSet);
			if (result == null)
				result = caseElement(typeMappingSet);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case ErrorModelPackage.TYPE_MAPPING: {
			...
			if (result == null)
				result = caseElement(typeMapping);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case ErrorModelPackage.ERROR_PROPAGATION: {
			...
			if (result == null)
				result = caseEventOrPropagation(errorPropagation);
			if (result == null)
				result = caseNamedElement(errorPropagation);
			if (result == null)
				result = caseElement(errorPropagation);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case ErrorModelPackage.FEATUREOR_PP_REFERENCE: {
			...
			if (result == null)
				result = caseElement(featureorPPReference);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case ErrorModelPackage.ERROR_FLOW: {
			...
			if (result == null)
				result = caseNamedElement(errorFlow);
			if (result == null)
				result = caseElement(errorFlow);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case ErrorModelPackage.ERROR_SOURCE: {
			...
			if (result == null)
				result = caseErrorFlow(errorSource);
			if (result == null)
				result = caseNamedElement(errorSource);
			if (result == null)
				result = caseElement(errorSource);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case ErrorModelPackage.ERROR_SINK: {
			...
			if (result == null)
				result = caseErrorFlow(errorSink);
			if (result == null)
				result = caseNamedElement(errorSink);
			if (result == null)
				result = caseElement(errorSink);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case ErrorModelPackage.ERROR_PATH: {
			...
			if (result == null)
				result = caseErrorFlow(errorPath);
			if (result == null)
				result = caseNamedElement(errorPath);
			if (result == null)
				result = caseElement(errorPath);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case ErrorModelPackage.PROPAGATION_POINT: {
			...
			if (result == null)
				result = caseNamedElement(propagationPoint);
			if (result == null)
				result = caseElement(propagationPoint);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case ErrorModelPackage.PROPAGATION_PATH: {
			...
			if (result == null)
				result = caseNamedElement(propagationPath);
			if (result == null)
				result = caseElement(propagationPath);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case ErrorModelPackage.QUALIFIED_PROPAGATION_POINT: {
			...
			if (result == null)
				result = caseElement(qualifiedPropagationPoint);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case ErrorModelPackage.ERROR_BEHAVIOR_STATE_MACHINE: {
			...
			if (result == null)
				result = caseNamedElement(errorBehaviorStateMachine);
			if (result == null)
				result = caseElement(errorBehaviorStateMachine);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case ErrorModelPackage.ERROR_BEHAVIOR_EVENT: {
			...
			if (result == null)
				result = caseEventOrPropagation(errorBehaviorEvent);
			if (result == null)
				result = caseNamedElement(errorBehaviorEvent);
			if (result == null)
				result = caseElement(errorBehaviorEvent);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case ErrorModelPackage.ERROR_EVENT: {
			...
			if (result == null)
				result = caseErrorBehaviorEvent(errorEvent);
			if (result == null)
				result = caseEventOrPropagation(errorEvent);
			if (result == null)
				result = caseNamedElement(errorEvent);
			if (result == null)
				result = caseElement(errorEvent);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case ErrorModelPackage.REPAIR_EVENT: {
			...
			if (result == null)
				result = caseErrorBehaviorEvent(repairEvent);
			if (result == null)
				result = caseEventOrPropagation(repairEvent);
			if (result == null)
				result = caseNamedElement(repairEvent);
			if (result == null)
				result = caseElement(repairEvent);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case ErrorModelPackage.RECOVER_EVENT: {
			...
			if (result == null)
				result = caseErrorBehaviorEvent(recoverEvent);
			if (result == null)
				result = caseEventOrPropagation(recoverEvent);
			if (result == null)
				result = caseNamedElement(recoverEvent);
			if (result == null)
				result = caseElement(recoverEvent);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case ErrorModelPackage.ERROR_BEHAVIOR_STATE: {
			...
			if (result == null)
				result = caseNamedElement(errorBehaviorState);
			if (result == null)
				result = caseElement(errorBehaviorState);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case ErrorModelPackage.ERROR_BEHAVIOR_TRANSITION: {
			...
			if (result == null)
				result = caseNamedElement(errorBehaviorTransition);
			if (result == null)
				result = caseElement(errorBehaviorTransition);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case ErrorModelPackage.TRANSITION_BRANCH: {
			...
			if (result == null)
				result = caseElement(transitionBranch);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case ErrorModelPackage.BRANCH_VALUE: {
			...
			if (result == null)
				result = caseElement(branchValue);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case ErrorModelPackage.CONNECTION_ERROR_SOURCE: {
			...
			if (result == null)
				result = caseNamedElement(connectionErrorSource);
			if (result == null)
				result = caseElement(connectionErrorSource);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case ErrorModelPackage.CONDITION_EXPRESSION: {
			...
			if (result == null)
				result = caseElement(conditionExpression);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case ErrorModelPackage.ORMORE_EXPRESSION: {
			...
			if (result == null)
				result = caseConditionExpression(ormoreExpression);
			if (result == null)
				result = caseElement(ormoreExpression);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case ErrorModelPackage.ORLESS_EXPRESSION: {
			...
			if (result == null)
				result = caseConditionExpression(orlessExpression);
			if (result == null)
				result = caseElement(orlessExpression);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case ErrorModelPackage.CONDITION_ELEMENT: {
			...
			if (result == null)
				result = caseConditionExpression(conditionElement);
			if (result == null)
				result = caseElement(conditionElement);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case ErrorModelPackage.EVENT_OR_PROPAGATION: {
			...
			if (result == null)
				result = caseNamedElement(eventOrPropagation);
			if (result == null)
				result = caseElement(eventOrPropagation);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case ErrorModelPackage.OUTGOING_PROPAGATION_CONDITION: {
			...
			if (result == null)
				result = caseNamedElement(outgoingPropagationCondition);
			if (result == null)
				result = caseElement(outgoingPropagationCondition);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case ErrorModelPackage.ERROR_DETECTION: {
			...
			if (result == null)
				result = caseNamedElement(errorDetection);
			if (result == null)
				result = caseElement(errorDetection);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case ErrorModelPackage.ERROR_CODE_VALUE: {
			...
			if (result == null)
				result = caseElement(errorCodeValue);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case ErrorModelPackage.ERROR_STATE_TO_MODE_MAPPING: {
			...
			if (result == null)
				result = caseElement(errorStateToModeMapping);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case ErrorModelPackage.COMPOSITE_STATE: {
			...
			if (result == null)
				result = caseNamedElement(compositeState);
			if (result == null)
				result = caseElement(compositeState);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case ErrorModelPackage.QUALIFIED_ERROR_BEHAVIOR_STATE: {
			...
			if (result == null)
				result = caseElement(qualifiedErrorBehaviorState);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case ErrorModelPackage.SUBCOMPONENT_ELEMENT: {
			...
			if (result == null)
				result = caseElement(subcomponentElement);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case ErrorModelPackage.EMV2_ROOT: {
			...
			if (result == null)
				result = caseNamedElement(emv2Root);
			if (result == null)
				result = caseElement(emv2Root);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case ErrorModelPackage.OR_EXPRESSION: {
			...
			if (result == null)
				result = caseConditionExpression(orExpression);
			if (result == null)
				result = caseElement(orExpression);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case ErrorModelPackage.AND_EXPRESSION: {
			...
			if (result == null)
				result = caseConditionExpression(andExpression);
			if (result == null)
				result = caseElement(andExpression);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case ErrorModelPackage.ALL_EXPRESSION: {
			...
			if (result == null)
				result = caseConditionExpression(allExpression);
			if (result == null)
				result = caseElement(allExpression);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case ErrorModelPackage.QUALIFIED_ERROR_EVENT_OR_PROPAGATION: {
			...
			if (result == null)
				result = caseEMV2Path(qualifiedErrorEventOrPropagation);
			if (result == null)
				result = caseElement(qualifiedErrorEventOrPropagation);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case ErrorModelPackage.QUALIFIED_ERROR_PROPAGATION: {
			...
			if (result == null)
				result = caseEMV2Path(qualifiedErrorPropagation);
			if (result == null)
				result = caseElement(qualifiedErrorPropagation);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case ErrorModelPackage.SCONDITION_ELEMENT: {
			...
			if (result == null)
				result = caseConditionElement(sConditionElement);
			if (result == null)
				result = caseConditionExpression(sConditionElement);
			if (result == null)
				result = caseElement(sConditionElement);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
