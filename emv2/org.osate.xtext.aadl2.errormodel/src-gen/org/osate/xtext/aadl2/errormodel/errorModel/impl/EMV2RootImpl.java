...
public class EMV2RootImpl extends NamedElementImpl implements EMV2Root {
	...
	public NotificationChain basicSetLibrary(ErrorModelLibrary newLibrary, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					ErrorModelPackage.EMV2_ROOT__LIBRARY, oldLibrary, newLibrary);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newLibrary != library) {
			...
			if (library != null)
				msgs = ((InternalEObject) library).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - ErrorModelPackage.EMV2_ROOT__LIBRARY, null, msgs);
			if (newLibrary != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET, ErrorModelPackage.EMV2_ROOT__LIBRARY, newLibrary,
					newLibrary));
	}
	...
	public EList<ErrorModelSubclause> getSubclauses() {
		if (subclauses == null) {
			subclauses = new EObjectContainmentEList<ErrorModelSubclause>(ErrorModelSubclause.class, this,
					ErrorModelPackage.EMV2_ROOT__SUBCLAUSES);
		}
		return subclauses;
	}
