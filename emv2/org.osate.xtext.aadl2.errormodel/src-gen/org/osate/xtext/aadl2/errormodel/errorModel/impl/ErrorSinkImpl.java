...
public class ErrorSinkImpl extends ErrorFlowImpl implements ErrorSink {
		...
		if (incoming != null && incoming.eIsProxy()) {
			...
			if (incoming != oldIncoming) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ErrorModelPackage.ERROR_SINK__INCOMING,
	...
	public void setIncoming(ErrorPropagation newIncoming) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ErrorModelPackage.ERROR_SINK__INCOMING, oldIncoming,
					incoming));
	}
	...
	public void setAllIncoming(boolean newAllIncoming) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ErrorModelPackage.ERROR_SINK__ALL_INCOMING,
