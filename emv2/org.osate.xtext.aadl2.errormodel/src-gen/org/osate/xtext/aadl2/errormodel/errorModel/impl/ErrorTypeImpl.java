...
public class ErrorTypeImpl extends ErrorTypesImpl implements ErrorType {
		...
		if (superType != null && superType.eIsProxy()) {
			...
			if (superType != oldSuperType) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ErrorModelPackage.ERROR_TYPE__SUPER_TYPE,
	...
	public void setSuperType(ErrorType newSuperType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ErrorModelPackage.ERROR_TYPE__SUPER_TYPE,
					oldSuperType, superType));
	}
			...
			if (aliasedType != oldAliasedType) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							ErrorModelPackage.ERROR_TYPE__ALIASED_TYPE, oldAliasedType, aliasedType));
			}
		}
		return aliasedType;
	}
	...
	public void setAliasedType(ErrorType newAliasedType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ErrorModelPackage.ERROR_TYPE__ALIASED_TYPE,
