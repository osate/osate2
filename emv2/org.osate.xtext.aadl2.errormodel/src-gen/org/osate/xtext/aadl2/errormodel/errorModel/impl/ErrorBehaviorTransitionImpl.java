...
public class ErrorBehaviorTransitionImpl extends NamedElementImpl implements ErrorBehaviorTransition {
			...
			if (source != oldSource) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							ErrorModelPackage.ERROR_BEHAVIOR_TRANSITION__SOURCE, oldSource, source));
			}
		}
		return source;
	}
	...
	public void setSource(ErrorBehaviorState newSource) {
		...
		source = newSource;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ErrorModelPackage.ERROR_BEHAVIOR_TRANSITION__SOURCE,
					oldSource, source));
	}
	...
	public NotificationChain basicSetTypeTokenConstraint(TypeSet newTypeTokenConstraint, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					ErrorModelPackage.ERROR_BEHAVIOR_TRANSITION__TYPE_TOKEN_CONSTRAINT, oldTypeTokenConstraint,
		...
		if (newTypeTokenConstraint != typeTokenConstraint) {
			...
			if (typeTokenConstraint != null)
				msgs = ((InternalEObject) typeTokenConstraint).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - ErrorModelPackage.ERROR_BEHAVIOR_TRANSITION__TYPE_TOKEN_CONSTRAINT,
						null, msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					ErrorModelPackage.ERROR_BEHAVIOR_TRANSITION__TYPE_TOKEN_CONSTRAINT, newTypeTokenConstraint,
					newTypeTokenConstraint));
	}
	...
	public void setAllStates(boolean newAllStates) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ErrorModelPackage.ERROR_BEHAVIOR_TRANSITION__ALL_STATES, oldAllStates, allStates));
	}
	...
	public NotificationChain basicSetCondition(ConditionExpression newCondition, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					ErrorModelPackage.ERROR_BEHAVIOR_TRANSITION__CONDITION, oldCondition, newCondition);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
		...
		if (newCondition != condition) {
			...
			if (condition != null)
				msgs = ((InternalEObject) condition).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - ErrorModelPackage.ERROR_BEHAVIOR_TRANSITION__CONDITION, null, msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					ErrorModelPackage.ERROR_BEHAVIOR_TRANSITION__CONDITION, newCondition, newCondition));
	}
	...
	public ErrorBehaviorState getTarget() {
		if (target != null && target.eIsProxy()) {
			...
			if (target != oldTarget) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							ErrorModelPackage.ERROR_BEHAVIOR_TRANSITION__TARGET, oldTarget, target));
			}
		}
		return target;
	}
	...
	public void setTarget(ErrorBehaviorState newTarget) {
		...
		target = newTarget;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ErrorModelPackage.ERROR_BEHAVIOR_TRANSITION__TARGET,
					oldTarget, target));
	}
	...
	public NotificationChain basicSetTargetToken(TypeSet newTargetToken, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					ErrorModelPackage.ERROR_BEHAVIOR_TRANSITION__TARGET_TOKEN, oldTargetToken, newTargetToken);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
		...
		if (newTargetToken != targetToken) {
			...
			if (targetToken != null)
				msgs = ((InternalEObject) targetToken).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - ErrorModelPackage.ERROR_BEHAVIOR_TRANSITION__TARGET_TOKEN, null, msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					ErrorModelPackage.ERROR_BEHAVIOR_TRANSITION__TARGET_TOKEN, newTargetToken, newTargetToken));
	}
	...
	public void setSteadyState(boolean newSteadyState) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ErrorModelPackage.ERROR_BEHAVIOR_TRANSITION__STEADY_STATE, oldSteadyState, steadyState));
	}
	...
	public EList<TransitionBranch> getDestinationBranches() {
		if (destinationBranches == null) {
			destinationBranches = new EObjectContainmentEList<TransitionBranch>(TransitionBranch.class, this,
					ErrorModelPackage.ERROR_BEHAVIOR_TRANSITION__DESTINATION_BRANCHES);
		}
