...
public class ErrorStateToModeMappingImpl extends ElementImpl implements ErrorStateToModeMapping {
			...
			if (errorState != oldErrorState) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							ErrorModelPackage.ERROR_STATE_TO_MODE_MAPPING__ERROR_STATE, oldErrorState, errorState));
			}
		}
		return errorState;
	}
	...
	public NotificationChain basicSetTypeToken(TypeSet newTypeToken, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					ErrorModelPackage.ERROR_STATE_TO_MODE_MAPPING__TYPE_TOKEN, oldTypeToken, newTypeToken);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newTypeToken != typeToken) {
			...
			if (typeToken != null)
				msgs = ((InternalEObject) typeToken).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - ErrorModelPackage.ERROR_STATE_TO_MODE_MAPPING__TYPE_TOKEN, null, msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					ErrorModelPackage.ERROR_STATE_TO_MODE_MAPPING__TYPE_TOKEN, newTypeToken, newTypeToken));
	}
	...
	public EList<Mode> getMappedModes() {
		if (mappedModes == null) {
			mappedModes = new EObjectResolvingEList<Mode>(Mode.class, this,
					ErrorModelPackage.ERROR_STATE_TO_MODE_MAPPING__MAPPED_MODES);
		}
		return mappedModes;
	}
