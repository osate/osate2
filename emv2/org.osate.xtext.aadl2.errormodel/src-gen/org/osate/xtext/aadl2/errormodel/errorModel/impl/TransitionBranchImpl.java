...
public class TransitionBranchImpl extends ElementImpl implements TransitionBranch {
			...
			if (target != oldTarget) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							ErrorModelPackage.TRANSITION_BRANCH__TARGET, oldTarget, target));
			}
		}
		return target;
	}
	...
	public void setTarget(ErrorBehaviorState newTarget) {
		...
		target = newTarget;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ErrorModelPackage.TRANSITION_BRANCH__TARGET,
					oldTarget, target));
	}
	...
	public NotificationChain basicSetTargetToken(TypeSet newTargetToken, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					ErrorModelPackage.TRANSITION_BRANCH__TARGET_TOKEN, oldTargetToken, newTargetToken);
			if (msgs == null)
				msgs = notification;
			else
	...
	public void setTargetToken(TypeSet newTargetToken) {
		if (newTargetToken != targetToken) {
			...
			if (targetToken != null)
				msgs = ((InternalEObject) targetToken).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - ErrorModelPackage.TRANSITION_BRANCH__TARGET_TOKEN, null, msgs);
			if (newTargetToken != null)
				msgs = ((InternalEObject) newTargetToken).eInverseAdd(this,
						EOPPOSITE_FEATURE_BASE - ErrorModelPackage.TRANSITION_BRANCH__TARGET_TOKEN, null, msgs);
			msgs = basicSetTargetToken(newTargetToken, msgs);
			if (msgs != null)
				msgs.dispatch();
		} else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ErrorModelPackage.TRANSITION_BRANCH__TARGET_TOKEN,
					newTargetToken, newTargetToken));
	}
	...
	public void setSteadyState(boolean newSteadyState) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ErrorModelPackage.TRANSITION_BRANCH__STEADY_STATE,
					oldSteadyState, steadyState));
	}
	...
	public NotificationChain basicSetValue(BranchValue newValue, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					ErrorModelPackage.TRANSITION_BRANCH__VALUE, oldValue, newValue);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
		...
		if (newValue != value) {
			...
			if (value != null)
				msgs = ((InternalEObject) value).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - ErrorModelPackage.TRANSITION_BRANCH__VALUE, null, msgs);
			if (newValue != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET, ErrorModelPackage.TRANSITION_BRANCH__VALUE, newValue,
					newValue));
	}
