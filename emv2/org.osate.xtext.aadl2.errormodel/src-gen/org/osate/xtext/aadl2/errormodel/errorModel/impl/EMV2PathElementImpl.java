...
public class EMV2PathElementImpl extends ElementImpl implements EMV2PathElement {
	...
	public void setEmv2PropagationKind(String newEmv2PropagationKind) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ErrorModelPackage.EMV2_PATH_ELEMENT__EMV2_PROPAGATION_KIND, oldEmv2PropagationKind,
					emv2PropagationKind));
	}
			...
			if (errorType != oldErrorType) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							ErrorModelPackage.EMV2_PATH_ELEMENT__ERROR_TYPE, oldErrorType, errorType));
			}
		}
		return errorType;
	}
	...
	public void setErrorType(ErrorTypes newErrorType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ErrorModelPackage.EMV2_PATH_ELEMENT__ERROR_TYPE,
	...
	public NamedElement getNamedElement() {
		if (namedElement != null && ((EObject) namedElement).eIsProxy()) {
			...
			if (namedElement != oldNamedElement) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							ErrorModelPackage.EMV2_PATH_ELEMENT__NAMED_ELEMENT, oldNamedElement, namedElement));
			}
		}
		return namedElement;
	}
	...
	public void setNamedElement(NamedElement newNamedElement) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ErrorModelPackage.EMV2_PATH_ELEMENT__NAMED_ELEMENT,
	...
	public NotificationChain basicSetPath(EMV2PathElement newPath, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					ErrorModelPackage.EMV2_PATH_ELEMENT__PATH, oldPath, newPath);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newPath != path) {
			...
			if (path != null)
				msgs = ((InternalEObject) path).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - ErrorModelPackage.EMV2_PATH_ELEMENT__PATH, null, msgs);
			if (newPath != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET, ErrorModelPackage.EMV2_PATH_ELEMENT__PATH, newPath,
					newPath));
	}
	...
	public boolean eIsSet(int featureID) {
		switch (featureID) {
		case ErrorModelPackage.EMV2_PATH_ELEMENT__EMV2_PROPAGATION_KIND:
			return EMV2_PROPAGATION_KIND_EDEFAULT == null ? emv2PropagationKind != null
					: !EMV2_PROPAGATION_KIND_EDEFAULT.equals(emv2PropagationKind);
		case ErrorModelPackage.EMV2_PATH_ELEMENT__ERROR_TYPE:
