...
public class ErrorModelSubclauseImpl extends AnnexSubclauseImpl implements ErrorModelSubclause {
	...
	public EList<ErrorModelLibrary> getUseTypes() {
		if (useTypes == null) {
			useTypes = new EObjectResolvingEList<ErrorModelLibrary>(ErrorModelLibrary.class, this,
					ErrorModelPackage.ERROR_MODEL_SUBCLAUSE__USE_TYPES);
		}
		return useTypes;
	}
			...
			if (typeEquivalence != oldTypeEquivalence) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							ErrorModelPackage.ERROR_MODEL_SUBCLAUSE__TYPE_EQUIVALENCE, oldTypeEquivalence,
							typeEquivalence));
			}
		}
	...
	public void setTypeEquivalence(TypeMappingSet newTypeEquivalence) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ErrorModelPackage.ERROR_MODEL_SUBCLAUSE__TYPE_EQUIVALENCE, oldTypeEquivalence, typeEquivalence));
	}
	...
	public TypeMappingSet getTypeMappingSet() {
		if (typeMappingSet != null && typeMappingSet.eIsProxy()) {
			...
			if (typeMappingSet != oldTypeMappingSet) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							ErrorModelPackage.ERROR_MODEL_SUBCLAUSE__TYPE_MAPPING_SET, oldTypeMappingSet,
							typeMappingSet));
			}
		}
	...
	public void setTypeMappingSet(TypeMappingSet newTypeMappingSet) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ErrorModelPackage.ERROR_MODEL_SUBCLAUSE__TYPE_MAPPING_SET, oldTypeMappingSet, typeMappingSet));
	}
	...
	public ErrorBehaviorStateMachine getUseBehavior() {
		if (useBehavior != null && useBehavior.eIsProxy()) {
			...
			if (useBehavior != oldUseBehavior) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							ErrorModelPackage.ERROR_MODEL_SUBCLAUSE__USE_BEHAVIOR, oldUseBehavior, useBehavior));
			}
		}
		return useBehavior;
	}
	...
	public void setUseBehavior(ErrorBehaviorStateMachine newUseBehavior) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ErrorModelPackage.ERROR_MODEL_SUBCLAUSE__USE_BEHAVIOR,
					oldUseBehavior, useBehavior));
	}
	...
	public EList<ErrorPropagation> getPropagations() {
		if (propagations == null) {
			propagations = new EObjectContainmentEList<ErrorPropagation>(ErrorPropagation.class, this,
					ErrorModelPackage.ERROR_MODEL_SUBCLAUSE__PROPAGATIONS);
		}
		return propagations;
	}
	...
	public EList<ErrorFlow> getFlows() {
		if (flows == null) {
			flows = new EObjectContainmentEList<ErrorFlow>(ErrorFlow.class, this,
					ErrorModelPackage.ERROR_MODEL_SUBCLAUSE__FLOWS);
		}
		return flows;
	}
	...
	public TypeTransformationSet getUseTransformation() {
		if (useTransformation != null && useTransformation.eIsProxy()) {
			...
			if (useTransformation != oldUseTransformation) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							ErrorModelPackage.ERROR_MODEL_SUBCLAUSE__USE_TRANSFORMATION, oldUseTransformation,
							useTransformation));
			}
		}
	...
	public EList<ErrorBehaviorEvent> getEvents() {
		if (events == null) {
			events = new EObjectContainmentEList<ErrorBehaviorEvent>(ErrorBehaviorEvent.class, this,
					ErrorModelPackage.ERROR_MODEL_SUBCLAUSE__EVENTS);
		}
		return events;
	}
	...
	public EList<ErrorBehaviorTransition> getTransitions() {
		if (transitions == null) {
			transitions = new EObjectContainmentEList<ErrorBehaviorTransition>(ErrorBehaviorTransition.class, this,
					ErrorModelPackage.ERROR_MODEL_SUBCLAUSE__TRANSITIONS);
		}
		return transitions;
	}
	...
	public EList<OutgoingPropagationCondition> getOutgoingPropagationConditions() {
		if (outgoingPropagationConditions == null) {
			outgoingPropagationConditions = new EObjectContainmentEList<OutgoingPropagationCondition>(
					OutgoingPropagationCondition.class, this,
					ErrorModelPackage.ERROR_MODEL_SUBCLAUSE__OUTGOING_PROPAGATION_CONDITIONS);
		}
	...
	public EList<ErrorDetection> getErrorDetections() {
		if (errorDetections == null) {
			errorDetections = new EObjectContainmentEList<ErrorDetection>(ErrorDetection.class, this,
					ErrorModelPackage.ERROR_MODEL_SUBCLAUSE__ERROR_DETECTIONS);
		}
	...
	public EList<ErrorStateToModeMapping> getErrorStateToModeMappings() {
		if (errorStateToModeMappings == null) {
			errorStateToModeMappings = new EObjectContainmentEList<ErrorStateToModeMapping>(
					ErrorStateToModeMapping.class, this,
					ErrorModelPackage.ERROR_MODEL_SUBCLAUSE__ERROR_STATE_TO_MODE_MAPPINGS);
		}
	...
	public EList<CompositeState> getStates() {
		if (states == null) {
			states = new EObjectContainmentEList<CompositeState>(CompositeState.class, this,
					ErrorModelPackage.ERROR_MODEL_SUBCLAUSE__STATES);
		}
		return states;
	}
	...
	public TypeTransformationSet getTypeTransformationSet() {
		if (typeTransformationSet != null && typeTransformationSet.eIsProxy()) {
			...
			if (typeTransformationSet != oldTypeTransformationSet) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							ErrorModelPackage.ERROR_MODEL_SUBCLAUSE__TYPE_TRANSFORMATION_SET, oldTypeTransformationSet,
	...
	public EList<ConnectionErrorSource> getConnectionErrorSources() {
		if (connectionErrorSources == null) {
			connectionErrorSources = new EObjectContainmentEList<ConnectionErrorSource>(ConnectionErrorSource.class,
					this, ErrorModelPackage.ERROR_MODEL_SUBCLAUSE__CONNECTION_ERROR_SOURCES);
		}
	...
	public EList<PropagationPoint> getPoints() {
		if (points == null) {
			points = new EObjectContainmentEList<PropagationPoint>(PropagationPoint.class, this,
					ErrorModelPackage.ERROR_MODEL_SUBCLAUSE__POINTS);
		}
		return points;
	}
	...
	public EList<PropagationPath> getPaths() {
		if (paths == null) {
			paths = new EObjectContainmentEList<PropagationPath>(PropagationPath.class, this,
					ErrorModelPackage.ERROR_MODEL_SUBCLAUSE__PATHS);
		}
		return paths;
	}
	...
	public EList<EMV2PropertyAssociation> getProperties() {
		if (properties == null) {
			properties = new EObjectContainmentEList<EMV2PropertyAssociation>(EMV2PropertyAssociation.class, this,
					ErrorModelPackage.ERROR_MODEL_SUBCLAUSE__PROPERTIES);
		}
		return properties;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		...
		case ErrorModelPackage.ERROR_MODEL_SUBCLAUSE__TYPE_TRANSFORMATION_SET:
			if (resolve)
				return getTypeTransformationSet();
