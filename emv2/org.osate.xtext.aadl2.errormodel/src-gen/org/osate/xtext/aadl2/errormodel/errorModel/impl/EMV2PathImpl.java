...
public class EMV2PathImpl extends ElementImpl implements EMV2Path {
	 ...
	 * @generated
	 */
	public NotificationChain basicSetContainmentPath(ContainmentPathElement newContainmentPath,
			NotificationChain msgs) {
		ContainmentPathElement oldContainmentPath = containmentPath;
		containmentPath = newContainmentPath;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					ErrorModelPackage.EMV2_PATH__CONTAINMENT_PATH, oldContainmentPath, newContainmentPath);
			if (msgs == null)
				msgs = notification;
			else
	...
	public void setContainmentPath(ContainmentPathElement newContainmentPath) {
		if (newContainmentPath != containmentPath) {
			...
			if (containmentPath != null)
				msgs = ((InternalEObject) containmentPath).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - ErrorModelPackage.EMV2_PATH__CONTAINMENT_PATH, null, msgs);
			if (newContainmentPath != null)
				msgs = ((InternalEObject) newContainmentPath).eInverseAdd(this,
						EOPPOSITE_FEATURE_BASE - ErrorModelPackage.EMV2_PATH__CONTAINMENT_PATH, null, msgs);
			msgs = basicSetContainmentPath(newContainmentPath, msgs);
			if (msgs != null)
				msgs.dispatch();
		} else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ErrorModelPackage.EMV2_PATH__CONTAINMENT_PATH,
					newContainmentPath, newContainmentPath));
	}
	...
	public NotificationChain basicSetEmv2Target(EMV2PathElement newEmv2Target, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					ErrorModelPackage.EMV2_PATH__EMV2_TARGET, oldEmv2Target, newEmv2Target);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
	...
	public void setEmv2Target(EMV2PathElement newEmv2Target) {
		if (newEmv2Target != emv2Target) {
			NotificationChain msgs = null;
			if (emv2Target != null)
				msgs = ((InternalEObject) emv2Target).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - ErrorModelPackage.EMV2_PATH__EMV2_TARGET, null, msgs);
			if (newEmv2Target != null)
				msgs = ((InternalEObject) newEmv2Target).eInverseAdd(this,
						EOPPOSITE_FEATURE_BASE - ErrorModelPackage.EMV2_PATH__EMV2_TARGET, null, msgs);
			msgs = basicSetEmv2Target(newEmv2Target, msgs);
			if (msgs != null)
				msgs.dispatch();
		} else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ErrorModelPackage.EMV2_PATH__EMV2_TARGET,
					newEmv2Target, newEmv2Target));
	}
