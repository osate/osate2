...
public class TypeTransformationImpl extends ElementImpl implements TypeTransformation {
	...
	public NotificationChain basicSetSource(TypeSet newSource, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					ErrorModelPackage.TYPE_TRANSFORMATION__SOURCE, oldSource, newSource);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newSource != source) {
			...
			if (source != null)
				msgs = ((InternalEObject) source).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - ErrorModelPackage.TYPE_TRANSFORMATION__SOURCE, null, msgs);
			if (newSource != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET, ErrorModelPackage.TYPE_TRANSFORMATION__SOURCE,
					newSource, newSource));
	}
	...
	public void setAllSources(boolean newAllSources) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ErrorModelPackage.TYPE_TRANSFORMATION__ALL_SOURCES,
					oldAllSources, allSources));
	}
	...
	public NotificationChain basicSetContributor(TypeSet newContributor, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					ErrorModelPackage.TYPE_TRANSFORMATION__CONTRIBUTOR, oldContributor, newContributor);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
	...
	public void setContributor(TypeSet newContributor) {
		if (newContributor != contributor) {
			NotificationChain msgs = null;
			if (contributor != null)
				msgs = ((InternalEObject) contributor).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - ErrorModelPackage.TYPE_TRANSFORMATION__CONTRIBUTOR, null, msgs);
			if (newContributor != null)
				msgs = ((InternalEObject) newContributor).eInverseAdd(this,
						EOPPOSITE_FEATURE_BASE - ErrorModelPackage.TYPE_TRANSFORMATION__CONTRIBUTOR, null, msgs);
			msgs = basicSetContributor(newContributor, msgs);
			if (msgs != null)
				msgs.dispatch();
		} else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ErrorModelPackage.TYPE_TRANSFORMATION__CONTRIBUTOR,
	...
	public NotificationChain basicSetTarget(TypeSet newTarget, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					ErrorModelPackage.TYPE_TRANSFORMATION__TARGET, oldTarget, newTarget);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
		...
		if (newTarget != target) {
			...
			if (target != null)
				msgs = ((InternalEObject) target).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - ErrorModelPackage.TYPE_TRANSFORMATION__TARGET, null, msgs);
			if (newTarget != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET, ErrorModelPackage.TYPE_TRANSFORMATION__TARGET,
					newTarget, newTarget));
	}
