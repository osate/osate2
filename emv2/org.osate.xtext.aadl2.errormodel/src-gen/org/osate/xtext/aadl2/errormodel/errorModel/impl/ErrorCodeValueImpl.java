...
public class ErrorCodeValueImpl extends ElementImpl implements ErrorCodeValue {
	...
	public void setIntValue(String newIntValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ErrorModelPackage.ERROR_CODE_VALUE__INT_VALUE,
			...
			if (constant != oldConstant) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							ErrorModelPackage.ERROR_CODE_VALUE__CONSTANT, oldConstant, constant));
			}
		}
		return constant;
	}
	...
	public void setConstant(PropertyConstant newConstant) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ErrorModelPackage.ERROR_CODE_VALUE__CONSTANT,
	...
	public void setEnumLiteral(String newEnumLiteral) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ErrorModelPackage.ERROR_CODE_VALUE__ENUM_LITERAL,
					oldEnumLiteral, enumLiteral));
	}
