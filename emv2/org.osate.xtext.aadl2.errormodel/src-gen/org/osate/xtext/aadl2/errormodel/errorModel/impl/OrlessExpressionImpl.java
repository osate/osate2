...
public class OrlessExpressionImpl extends ElementImpl implements OrlessExpression {
	...
	public void setCount(long newCount) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ErrorModelPackage.ORLESS_EXPRESSION__COUNT, oldCount,
					count));
	}
	...
	public EList<ConditionElement> getOperands() {
		if (operands == null) {
			operands = new EObjectContainmentEList<ConditionElement>(ConditionElement.class, this,
					ErrorModelPackage.ORLESS_EXPRESSION__OPERANDS);
		}
		return operands;
	}
