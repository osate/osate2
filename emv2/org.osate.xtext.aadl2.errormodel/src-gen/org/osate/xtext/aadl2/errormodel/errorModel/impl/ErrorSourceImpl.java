...
public class ErrorSourceImpl extends ErrorFlowImpl implements ErrorSource {
		...
		if (outgoing != null && outgoing.eIsProxy()) {
			...
			if (outgoing != oldOutgoing) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ErrorModelPackage.ERROR_SOURCE__OUTGOING,
	...
	public void setOutgoing(ErrorPropagation newOutgoing) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ErrorModelPackage.ERROR_SOURCE__OUTGOING, oldOutgoing,
					outgoing));
	}
	...
	public void setAllOutgoing(boolean newAllOutgoing) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ErrorModelPackage.ERROR_SOURCE__ALL_OUTGOING,
					oldAllOutgoing, allOutgoing));
	}
			...
			if (failureModeReference != oldFailureModeReference) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							ErrorModelPackage.ERROR_SOURCE__FAILURE_MODE_REFERENCE, oldFailureModeReference,
	...
	public NotificationChain basicSetFailureModeType(TypeSet newFailureModeType, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					ErrorModelPackage.ERROR_SOURCE__FAILURE_MODE_TYPE, oldFailureModeType, newFailureModeType);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newFailureModeType != failureModeType) {
			...
			if (failureModeType != null)
				msgs = ((InternalEObject) failureModeType).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - ErrorModelPackage.ERROR_SOURCE__FAILURE_MODE_TYPE, null, msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET, ErrorModelPackage.ERROR_SOURCE__FAILURE_MODE_TYPE,
					newFailureModeType, newFailureModeType));
	}
	...
	public void setFailureModeDescription(String newFailureModeDescription) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ErrorModelPackage.ERROR_SOURCE__FAILURE_MODE_DESCRIPTION, oldFailureModeDescription,
	...
	public void setCondition(String newCondition) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ErrorModelPackage.ERROR_SOURCE__CONDITION,
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		...
		case ErrorModelPackage.ERROR_SOURCE__FAILURE_MODE_REFERENCE:
			if (resolve)
				return getFailureModeReference();
