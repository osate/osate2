...
public class QualifiedErrorBehaviorStateImpl extends ElementImpl implements QualifiedErrorBehaviorState {
	...
	public NotificationChain basicSetSubcomponent(SubcomponentElement newSubcomponent, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					ErrorModelPackage.QUALIFIED_ERROR_BEHAVIOR_STATE__SUBCOMPONENT, oldSubcomponent, newSubcomponent);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newSubcomponent != subcomponent) {
			...
			if (subcomponent != null)
				msgs = ((InternalEObject) subcomponent).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - ErrorModelPackage.QUALIFIED_ERROR_BEHAVIOR_STATE__SUBCOMPONENT, null,
						msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					ErrorModelPackage.QUALIFIED_ERROR_BEHAVIOR_STATE__SUBCOMPONENT, newSubcomponent, newSubcomponent));
	}
	...
	public NotificationChain basicSetNext(QualifiedErrorBehaviorState newNext, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					ErrorModelPackage.QUALIFIED_ERROR_BEHAVIOR_STATE__NEXT, oldNext, newNext);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
		...
		if (newNext != next) {
			...
			if (next != null)
				msgs = ((InternalEObject) next).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - ErrorModelPackage.QUALIFIED_ERROR_BEHAVIOR_STATE__NEXT, null, msgs);
			if (newNext != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					ErrorModelPackage.QUALIFIED_ERROR_BEHAVIOR_STATE__NEXT, newNext, newNext));
	}
			...
			if (state != oldState) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							ErrorModelPackage.QUALIFIED_ERROR_BEHAVIOR_STATE__STATE, oldState, state));
			}
		}
		return state;
	}
