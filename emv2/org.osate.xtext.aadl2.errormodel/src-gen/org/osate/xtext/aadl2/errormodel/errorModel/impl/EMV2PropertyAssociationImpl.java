...
public class EMV2PropertyAssociationImpl extends ElementImpl implements EMV2PropertyAssociation {
			...
			if (property != oldProperty) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							ErrorModelPackage.EMV2_PROPERTY_ASSOCIATION__PROPERTY, oldProperty, property));
			}
		}
		return property;
	}
	...
	public void setProperty(Property newProperty) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ErrorModelPackage.EMV2_PROPERTY_ASSOCIATION__PROPERTY,
	...
	public EList<ModalPropertyValue> getOwnedValues() {
		if (ownedValues == null) {
			ownedValues = new EObjectContainmentEList<ModalPropertyValue>(ModalPropertyValue.class, this,
					ErrorModelPackage.EMV2_PROPERTY_ASSOCIATION__OWNED_VALUES);
		}
		return ownedValues;
	}
	...
	public EList<EMV2Path> getEmv2Path() {
		if (emv2Path == null) {
			emv2Path = new EObjectContainmentEList<EMV2Path>(EMV2Path.class, this,
					ErrorModelPackage.EMV2_PROPERTY_ASSOCIATION__EMV2_PATH);
		}
		return emv2Path;
	}
