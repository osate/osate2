...
public class ErrorPropagationImpl extends NamedElementImpl implements ErrorPropagation {
	...
	public void setKind(String newKind) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ErrorModelPackage.ERROR_PROPAGATION__KIND, oldKind,
					kind));
	}
	...
	public NotificationChain basicSetFeatureorPPRef(FeatureorPPReference newFeatureorPPRef, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					ErrorModelPackage.ERROR_PROPAGATION__FEATUREOR_PP_REF, oldFeatureorPPRef, newFeatureorPPRef);
			if (msgs == null)
				msgs = notification;
			else
	...
	public void setFeatureorPPRef(FeatureorPPReference newFeatureorPPRef) {
		if (newFeatureorPPRef != featureorPPRef) {
			...
			if (featureorPPRef != null)
				msgs = ((InternalEObject) featureorPPRef).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - ErrorModelPackage.ERROR_PROPAGATION__FEATUREOR_PP_REF, null, msgs);
			if (newFeatureorPPRef != null)
				msgs = ((InternalEObject) newFeatureorPPRef).eInverseAdd(this,
						EOPPOSITE_FEATURE_BASE - ErrorModelPackage.ERROR_PROPAGATION__FEATUREOR_PP_REF, null, msgs);
			msgs = basicSetFeatureorPPRef(newFeatureorPPRef, msgs);
			if (msgs != null)
				msgs.dispatch();
		} else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ErrorModelPackage.ERROR_PROPAGATION__FEATUREOR_PP_REF,
					newFeatureorPPRef, newFeatureorPPRef));
	}
	...
	public void setNot(boolean newNot) {
		...
		not = newNot;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ErrorModelPackage.ERROR_PROPAGATION__NOT, oldNot,
					not));
	}
	...
	public void setDirection(DirectionType newDirection) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ErrorModelPackage.ERROR_PROPAGATION__DIRECTION,
	...
	public NotificationChain basicSetTypeSet(TypeSet newTypeSet, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					ErrorModelPackage.ERROR_PROPAGATION__TYPE_SET, oldTypeSet, newTypeSet);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
		...
		if (newTypeSet != typeSet) {
			...
			if (typeSet != null)
				msgs = ((InternalEObject) typeSet).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - ErrorModelPackage.ERROR_PROPAGATION__TYPE_SET, null, msgs);
			if (newTypeSet != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET, ErrorModelPackage.ERROR_PROPAGATION__TYPE_SET,
