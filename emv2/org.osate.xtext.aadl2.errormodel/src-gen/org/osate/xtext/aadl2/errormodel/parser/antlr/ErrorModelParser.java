...
public class ErrorModelParser extends org.eclipse.xtext.parser.antlr.AbstractAntlrParser {
	...
	@Override
	protected org.osate.xtext.aadl2.errormodel.parser.antlr.internal.InternalErrorModelParser createParser(
			XtextTokenStream stream) {
		return new org.osate.xtext.aadl2.errormodel.parser.antlr.internal.InternalErrorModelParser(stream,
				getGrammarAccess());
	}
