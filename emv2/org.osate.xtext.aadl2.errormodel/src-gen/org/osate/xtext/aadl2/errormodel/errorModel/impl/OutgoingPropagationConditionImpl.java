...
public class OutgoingPropagationConditionImpl extends NamedElementImpl implements OutgoingPropagationCondition {
			...
			if (state != oldState) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							ErrorModelPackage.OUTGOING_PROPAGATION_CONDITION__STATE, oldState, state));
			}
		}
		return state;
	}
	...
	public NotificationChain basicSetTypeTokenConstraint(TypeSet newTypeTokenConstraint, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					ErrorModelPackage.OUTGOING_PROPAGATION_CONDITION__TYPE_TOKEN_CONSTRAINT, oldTypeTokenConstraint,
	...
	public void setTypeTokenConstraint(TypeSet newTypeTokenConstraint) {
		if (newTypeTokenConstraint != typeTokenConstraint) {
			...
			if (typeTokenConstraint != null)
				msgs = ((InternalEObject) typeTokenConstraint)
						.eInverseRemove(this,
								EOPPOSITE_FEATURE_BASE
										- ErrorModelPackage.OUTGOING_PROPAGATION_CONDITION__TYPE_TOKEN_CONSTRAINT,
								null, msgs);
			if (newTypeTokenConstraint != null)
				msgs = ((InternalEObject) newTypeTokenConstraint)
						.eInverseAdd(this,
								EOPPOSITE_FEATURE_BASE
										- ErrorModelPackage.OUTGOING_PROPAGATION_CONDITION__TYPE_TOKEN_CONSTRAINT,
								null, msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					ErrorModelPackage.OUTGOING_PROPAGATION_CONDITION__TYPE_TOKEN_CONSTRAINT, newTypeTokenConstraint,
					newTypeTokenConstraint));
	}
	...
	public void setAllStates(boolean newAllStates) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ErrorModelPackage.OUTGOING_PROPAGATION_CONDITION__ALL_STATES, oldAllStates, allStates));
	}
	...
	public NotificationChain basicSetCondition(ConditionExpression newCondition, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					ErrorModelPackage.OUTGOING_PROPAGATION_CONDITION__CONDITION, oldCondition, newCondition);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
		...
		if (newCondition != condition) {
			...
			if (condition != null)
				msgs = ((InternalEObject) condition).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - ErrorModelPackage.OUTGOING_PROPAGATION_CONDITION__CONDITION, null,
						msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					ErrorModelPackage.OUTGOING_PROPAGATION_CONDITION__CONDITION, newCondition, newCondition));
	}
	...
	public ErrorPropagation getOutgoing() {
		if (outgoing != null && outgoing.eIsProxy()) {
			...
			if (outgoing != oldOutgoing) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							ErrorModelPackage.OUTGOING_PROPAGATION_CONDITION__OUTGOING, oldOutgoing, outgoing));
			}
		}
		return outgoing;
	}
	...
	public void setAllPropagations(boolean newAllPropagations) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ErrorModelPackage.OUTGOING_PROPAGATION_CONDITION__ALL_PROPAGATIONS, oldAllPropagations,
					allPropagations));
	}
	...
	public NotificationChain basicSetTypeToken(TypeSet newTypeToken, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					ErrorModelPackage.OUTGOING_PROPAGATION_CONDITION__TYPE_TOKEN, oldTypeToken, newTypeToken);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
	...
	public void setTypeToken(TypeSet newTypeToken) {
		if (newTypeToken != typeToken) {
			NotificationChain msgs = null;
			if (typeToken != null)
				msgs = ((InternalEObject) typeToken).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - ErrorModelPackage.OUTGOING_PROPAGATION_CONDITION__TYPE_TOKEN, null,
						msgs);
			if (newTypeToken != null)
				msgs = ((InternalEObject) newTypeToken).eInverseAdd(this,
						EOPPOSITE_FEATURE_BASE - ErrorModelPackage.OUTGOING_PROPAGATION_CONDITION__TYPE_TOKEN, null,
						msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					ErrorModelPackage.OUTGOING_PROPAGATION_CONDITION__TYPE_TOKEN, newTypeToken, newTypeToken));
	}
