...
public class TypeMappingSetImpl extends NamedElementImpl implements TypeMappingSet {
	...
	public EList<ErrorModelLibrary> getUseTypes() {
		if (useTypes == null) {
			useTypes = new EObjectResolvingEList<ErrorModelLibrary>(ErrorModelLibrary.class, this,
					ErrorModelPackage.TYPE_MAPPING_SET__USE_TYPES);
		}
		return useTypes;
	}
	...
	public EList<TypeMapping> getMapping() {
		if (mapping == null) {
			mapping = new EObjectContainmentEList<TypeMapping>(TypeMapping.class, this,
					ErrorModelPackage.TYPE_MAPPING_SET__MAPPING);
		}
		return mapping;
	}
