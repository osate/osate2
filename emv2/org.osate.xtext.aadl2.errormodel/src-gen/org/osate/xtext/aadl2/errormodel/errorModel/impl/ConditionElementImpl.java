...
public class ConditionElementImpl extends ElementImpl implements ConditionElement {
	 ...
	 * @generated
	 */
	public NotificationChain basicSetQualifiedErrorPropagationReference(EMV2Path newQualifiedErrorPropagationReference,
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					ErrorModelPackage.CONDITION_ELEMENT__QUALIFIED_ERROR_PROPAGATION_REFERENCE,
					oldQualifiedErrorPropagationReference, newQualifiedErrorPropagationReference);
			if (msgs == null)
				msgs = notification;
			else
	...
	public void setQualifiedErrorPropagationReference(EMV2Path newQualifiedErrorPropagationReference) {
		if (newQualifiedErrorPropagationReference != qualifiedErrorPropagationReference) {
			...
			if (qualifiedErrorPropagationReference != null)
				msgs = ((InternalEObject) qualifiedErrorPropagationReference).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE
								- ErrorModelPackage.CONDITION_ELEMENT__QUALIFIED_ERROR_PROPAGATION_REFERENCE,
						null, msgs);
			if (newQualifiedErrorPropagationReference != null)
				msgs = ((InternalEObject) newQualifiedErrorPropagationReference).eInverseAdd(this,
						EOPPOSITE_FEATURE_BASE
								- ErrorModelPackage.CONDITION_ELEMENT__QUALIFIED_ERROR_PROPAGATION_REFERENCE,
						null, msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					ErrorModelPackage.CONDITION_ELEMENT__QUALIFIED_ERROR_PROPAGATION_REFERENCE,
					newQualifiedErrorPropagationReference, newQualifiedErrorPropagationReference));
	}
	...
	public NotificationChain basicSetConstraint(TypeSet newConstraint, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					ErrorModelPackage.CONDITION_ELEMENT__CONSTRAINT, oldConstraint, newConstraint);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
		...
		if (newConstraint != constraint) {
			...
			if (constraint != null)
				msgs = ((InternalEObject) constraint).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - ErrorModelPackage.CONDITION_ELEMENT__CONSTRAINT, null, msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET, ErrorModelPackage.CONDITION_ELEMENT__CONSTRAINT,
