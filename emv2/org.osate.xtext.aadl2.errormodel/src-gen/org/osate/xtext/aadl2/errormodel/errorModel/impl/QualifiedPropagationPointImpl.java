...
public class QualifiedPropagationPointImpl extends ElementImpl implements QualifiedPropagationPoint {
	...
	public NotificationChain basicSetSubcomponent(SubcomponentElement newSubcomponent, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					ErrorModelPackage.QUALIFIED_PROPAGATION_POINT__SUBCOMPONENT, oldSubcomponent, newSubcomponent);
			if (msgs == null)
				msgs = notification;
			else
	...
	public void setSubcomponent(SubcomponentElement newSubcomponent) {
		if (newSubcomponent != subcomponent) {
			...
			if (subcomponent != null)
				msgs = ((InternalEObject) subcomponent).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - ErrorModelPackage.QUALIFIED_PROPAGATION_POINT__SUBCOMPONENT, null,
						msgs);
			if (newSubcomponent != null)
				msgs = ((InternalEObject) newSubcomponent).eInverseAdd(this,
						EOPPOSITE_FEATURE_BASE - ErrorModelPackage.QUALIFIED_PROPAGATION_POINT__SUBCOMPONENT, null,
						msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					ErrorModelPackage.QUALIFIED_PROPAGATION_POINT__SUBCOMPONENT, newSubcomponent, newSubcomponent));
	}
	...
	public NotificationChain basicSetNext(QualifiedPropagationPoint newNext, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					ErrorModelPackage.QUALIFIED_PROPAGATION_POINT__NEXT, oldNext, newNext);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
		...
		if (newNext != next) {
			...
			if (next != null)
				msgs = ((InternalEObject) next).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - ErrorModelPackage.QUALIFIED_PROPAGATION_POINT__NEXT, null, msgs);
			if (newNext != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET, ErrorModelPackage.QUALIFIED_PROPAGATION_POINT__NEXT,
					newNext, newNext));
	}
			...
			if (propagationPoint != oldPropagationPoint) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							ErrorModelPackage.QUALIFIED_PROPAGATION_POINT__PROPAGATION_POINT, oldPropagationPoint,
							propagationPoint));
			}
		}
