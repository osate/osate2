...
public class ErrorDetectionImpl extends NamedElementImpl implements ErrorDetection {
		...
		if (state != null && state.eIsProxy()) {
			...
			if (state != oldState) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ErrorModelPackage.ERROR_DETECTION__STATE,
							oldState, state));
			}
		}
		return state;
	...
	public void setState(ErrorBehaviorState newState) {
		...
		state = newState;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ErrorModelPackage.ERROR_DETECTION__STATE, oldState,
					state));
	}
	...
	public NotificationChain basicSetTypeTokenConstraint(TypeSet newTypeTokenConstraint, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					ErrorModelPackage.ERROR_DETECTION__TYPE_TOKEN_CONSTRAINT, oldTypeTokenConstraint,
		...
		if (newTypeTokenConstraint != typeTokenConstraint) {
			...
			if (typeTokenConstraint != null)
				msgs = ((InternalEObject) typeTokenConstraint).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - ErrorModelPackage.ERROR_DETECTION__TYPE_TOKEN_CONSTRAINT, null, msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					ErrorModelPackage.ERROR_DETECTION__TYPE_TOKEN_CONSTRAINT, newTypeTokenConstraint,
					newTypeTokenConstraint));
	}
	...
	public void setAllStates(boolean newAllStates) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ErrorModelPackage.ERROR_DETECTION__ALL_STATES,
					oldAllStates, allStates));
	}
	...
	public NotificationChain basicSetCondition(ConditionExpression newCondition, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					ErrorModelPackage.ERROR_DETECTION__CONDITION, oldCondition, newCondition);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
		...
		if (newCondition != condition) {
			...
			if (condition != null)
				msgs = ((InternalEObject) condition).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - ErrorModelPackage.ERROR_DETECTION__CONDITION, null, msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET, ErrorModelPackage.ERROR_DETECTION__CONDITION,
			...
			if (detectionReportingPort != oldDetectionReportingPort) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							ErrorModelPackage.ERROR_DETECTION__DETECTION_REPORTING_PORT, oldDetectionReportingPort,
	...
	public NotificationChain basicSetErrorCode(ErrorCodeValue newErrorCode, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					ErrorModelPackage.ERROR_DETECTION__ERROR_CODE, oldErrorCode, newErrorCode);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
		...
		if (newErrorCode != errorCode) {
			...
			if (errorCode != null)
				msgs = ((InternalEObject) errorCode).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - ErrorModelPackage.ERROR_DETECTION__ERROR_CODE, null, msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET, ErrorModelPackage.ERROR_DETECTION__ERROR_CODE,
