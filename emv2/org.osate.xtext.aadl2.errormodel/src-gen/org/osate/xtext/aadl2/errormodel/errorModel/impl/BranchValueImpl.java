...
public class BranchValueImpl extends ElementImpl implements BranchValue {
	...
	public void setRealvalue(String newRealvalue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ErrorModelPackage.BRANCH_VALUE__REALVALUE,
			...
			if (symboliclabel != oldSymboliclabel) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							ErrorModelPackage.BRANCH_VALUE__SYMBOLICLABEL, oldSymboliclabel, symboliclabel));
			}
		}
	...
	public void setSymboliclabel(Property newSymboliclabel) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ErrorModelPackage.BRANCH_VALUE__SYMBOLICLABEL,
					oldSymboliclabel, symboliclabel));
	}
	...
	public void setOthers(boolean newOthers) {
		...
		others = newOthers;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ErrorModelPackage.BRANCH_VALUE__OTHERS, oldOthers,
					others));
	}
