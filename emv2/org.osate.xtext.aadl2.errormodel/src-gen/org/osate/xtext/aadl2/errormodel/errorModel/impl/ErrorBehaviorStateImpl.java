...
public class ErrorBehaviorStateImpl extends NamedElementImpl implements ErrorBehaviorState {
	...
	public void setIntial(boolean newIntial) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ErrorModelPackage.ERROR_BEHAVIOR_STATE__INTIAL,
					oldIntial, intial));
	}
	...
	public NotificationChain basicSetTypeSet(TypeSet newTypeSet, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					ErrorModelPackage.ERROR_BEHAVIOR_STATE__TYPE_SET, oldTypeSet, newTypeSet);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newTypeSet != typeSet) {
			...
			if (typeSet != null)
				msgs = ((InternalEObject) typeSet).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - ErrorModelPackage.ERROR_BEHAVIOR_STATE__TYPE_SET, null, msgs);
			if (newTypeSet != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET, ErrorModelPackage.ERROR_BEHAVIOR_STATE__TYPE_SET,
