...
public class ErrorModelLibraryImpl extends AnnexLibraryImpl implements ErrorModelLibrary {
	...
	public EList<ErrorModelLibrary> getUseTypes() {
		if (useTypes == null) {
			useTypes = new EObjectResolvingEList<ErrorModelLibrary>(ErrorModelLibrary.class, this,
					ErrorModelPackage.ERROR_MODEL_LIBRARY__USE_TYPES);
		}
		return useTypes;
	}
	...
	public EList<ErrorModelLibrary> getExtends() {
		if (extends_ == null) {
			extends_ = new EObjectResolvingEList<ErrorModelLibrary>(ErrorModelLibrary.class, this,
					ErrorModelPackage.ERROR_MODEL_LIBRARY__EXTENDS);
		}
		return extends_;
	}
	...
	public EList<ErrorType> getTypes() {
		if (types == null) {
			types = new EObjectContainmentEList<ErrorType>(ErrorType.class, this,
					ErrorModelPackage.ERROR_MODEL_LIBRARY__TYPES);
		}
		return types;
	}
	...
	public EList<TypeSet> getTypesets() {
		if (typesets == null) {
			typesets = new EObjectContainmentEList<TypeSet>(TypeSet.class, this,
					ErrorModelPackage.ERROR_MODEL_LIBRARY__TYPESETS);
		}
		return typesets;
	}
	...
	public EList<EMV2PropertyAssociation> getProperties() {
		if (properties == null) {
			properties = new EObjectContainmentEList<EMV2PropertyAssociation>(EMV2PropertyAssociation.class, this,
					ErrorModelPackage.ERROR_MODEL_LIBRARY__PROPERTIES);
		}
		return properties;
	}
	...
	public EList<ErrorBehaviorStateMachine> getBehaviors() {
		if (behaviors == null) {
			behaviors = new EObjectContainmentEList<ErrorBehaviorStateMachine>(ErrorBehaviorStateMachine.class, this,
					ErrorModelPackage.ERROR_MODEL_LIBRARY__BEHAVIORS);
		}
		return behaviors;
	}
	...
	public EList<TypeMappingSet> getMappings() {
		if (mappings == null) {
			mappings = new EObjectContainmentEList<TypeMappingSet>(TypeMappingSet.class, this,
					ErrorModelPackage.ERROR_MODEL_LIBRARY__MAPPINGS);
		}
		return mappings;
	}
	...
	public EList<TypeTransformationSet> getTransformations() {
		if (transformations == null) {
			transformations = new EObjectContainmentEList<TypeTransformationSet>(TypeTransformationSet.class, this,
					ErrorModelPackage.ERROR_MODEL_LIBRARY__TRANSFORMATIONS);
		}
