...
public class ErrorModelLibraryImpl extends AnnexLibraryImpl implements ErrorModelLibrary
{
   ...
   * <!-- end-user-doc -->
	 ...
	 * @ordered
	 */
  protected EList<ErrorTypes> types;
   ...
   * <!-- end-user-doc -->
	 * @generated
	 */
  public EList<ErrorTypes> getTypes()
  {
		if (types == null) {
			types = new EObjectContainmentEList<ErrorTypes>(ErrorTypes.class, this, ErrorModelPackage.ERROR_MODEL_LIBRARY__TYPES);
		}
		return types;
	}
  ...
  public void eSet(int featureID, Object newValue)
  {
		switch (featureID) {
			...
			case ErrorModelPackage.ERROR_MODEL_LIBRARY__TYPES:
				getTypes().clear();
				getTypes().addAll((Collection<? extends ErrorTypes>)newValue);
				return;
			case ErrorModelPackage.ERROR_MODEL_LIBRARY__PROPERTIES:
				getProperties().clear();
