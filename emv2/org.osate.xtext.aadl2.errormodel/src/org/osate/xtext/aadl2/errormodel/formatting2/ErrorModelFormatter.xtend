...
class ErrorModelFormatter extends PropertiesFormatter {
	...
	def dispatch void format(ErrorModelSubclause errorModelSubclause, extension IFormattableDocument document) {
		...
		val useTypeEquivalenceSemicolon = errorModelSubclause.regionFor.keyword(errorModelSubclauseAccess.semicolonKeyword_2_2) ?:
		...
		val useMappingsSemicolon = errorModelSubclause.regionFor.keyword(errorModelSubclauseAccess.semicolonKeyword_3_2) ?:
		...
		val useBehaviorSemicolon = errorModelSubclause.regionFor.keyword(errorModelSubclauseAccess.semicolonKeyword_4_2) ?:
		...
		errorModelSubclause.regionFor.keyword(errorPropagationsKeywordsAccess.propagationsKeyword_1).prepend[oneSpace].append[newLines = 1]
		...
		errorModelSubclause.regionFor.keyword(endPropagationsKeywordsAccess.propagationsKeyword_1).prepend[oneSpace].append[noSpace]
		val errorPropagationsSemicolon = errorModelSubclause.regionFor.keyword(errorModelSubclauseAccess.semicolonKeyword_5_4) ?:
		...
		errorModelSubclause.regionFor.keyword(componentErrorBehaviorKeywordsAccess.behaviorKeyword_2).append[newLines = 1]
		...
		val useTransformationsSemicolon = errorModelSubclause.regionFor.keyword(errorModelSubclauseAccess.semicolonKeyword_6_1_2) ?:
		...
		val transitionsKeyword = errorModelSubclause.regionFor.keyword(errorModelSubclauseAccess.transitionsKeyword_6_3_0) ?:
		...
		val propagationsKeyword = errorModelSubclause.regionFor.keyword(errorModelSubclauseAccess.propagationsKeyword_6_4_0) ?:
		...
		val detectionsKeyword = errorModelSubclause.regionFor.keyword(errorModelSubclauseAccess.detectionsKeyword_6_5_0) ?:
		...
		errorModelSubclause.regionFor.keyword(modeMappingsKeywordsAccess.mappingsKeyword_1).prepend[oneSpace].append[newLines = 1]
		errorModelSubclause.errorStateToModeMappings.forEach[
			surround[indent].append[newLines = 1]
			it.format(document)
		]
		//Component error behavior (end line)
		errorModelSubclause.regionFor.keyword(endComponentKeywordsAccess.componentKeyword_1).prepend[oneSpace].append[noSpace]
		val componentErrorBehaviorSemicolon = errorModelSubclause.regionFor.keyword(errorModelSubclauseAccess.semicolonKeyword_6_8) ?:
		...
		errorModelSubclause.regionFor.keyword(compositeErrorBehaviorKeywordsAccess.behaviorKeyword_2).append[newLines = 1]
		...
		errorModelSubclause.regionFor.keyword(endCompositeKeywordsAccess.compositeKeyword_1).prepend[oneSpace].append[noSpace]
		val compositeErrorBehaviorSemicolon = errorModelSubclause.regionFor.keyword(errorModelSubclauseAccess.semicolonKeyword_7_3) ?:
		...
		errorModelSubclause.regionFor.keyword(connectionErrorKeywordsAccess.errorKeyword_1).prepend[oneSpace].append[newLines = 1]
		//Connection error (use transformations)
		//The transformations keyword is handled earlier for component error behavior
		val connectionErrorUseTransformationsSemicolon = errorModelSubclause.regionFor.keyword(errorModelSubclauseAccess.semicolonKeyword_8_1_2) ?:
		...
		errorModelSubclause.regionFor.keyword(endConnectionKeywordsAccess.connectionKeyword_1).prepend[oneSpace].append[noSpace]
		val connectionErrorSemicolon = errorModelSubclause.regionFor.keyword(errorModelSubclauseAccess.semicolonKeyword_8_4) ?:
		...
		errorModelSubclause.regionFor.keyword(propagationPathsKeywordsAccess.pathsKeyword_1).prepend[oneSpace].append[newLines = 1]
		...
		val propagationPathsSemicolon = errorModelSubclause.regionFor.keyword(errorModelSubclauseAccess.semicolonKeyword_9_4) ?:
		...
		//Properties
		val propertiesKeyword = errorModelSubclause.regionFor.keyword(errorModelSubclauseAccess.propertiesKeyword_10_0) ?:
	...
	def dispatch void format(ErrorModelLibrary errorModelLibrary, extension IFormattableDocument document) {
		...
		//Library line
		errorModelLibrary.regionFor.assignment(EMV2LibraryAccess.nameAssignment_0_1_1).prepend[oneSpace].append[newLines = 2]
		
		//Package declaration
		errorModelLibrary.regionFor.assignment(EMV2LibraryAccess.nameAssignment_1_1).prepend[oneSpace].append[newLines = 1]
		...
		val leftCurly = errorModelLibrary.regionFor.keyword(EMV2LibraryAccess.leftCurlyBracketAsteriskAsteriskKeyword_1_5) 
		leftCurly.prepend[oneSpace].append[newLines = 1]
		
		//Begin error types
		errorModelLibrary.regionFor.keyword(errorTypesKeywordsAccess.typesKeyword_1).prepend[oneSpace].append[newLines = 1]
		...
		val rightCurly = errorModelLibrary.regionFor.keyword(EMV2LibraryAccess.asteriskAsteriskRightCurlyBracketKeyword_1_10)
		...
		errorModelLibrary.regionFor.keyword(EMV2LibraryAccess.semicolonKeyword_1_11).prepend[noSpace].append[newLines = 1]
		errorModelLibrary.regionFor.ruleCall(EMV2LibraryAccess.QEMREFParserRuleCall_1_13).prepend[oneSpace].append[noSpace]
	...
	def dispatch void format(EMV2PropertyAssociation emv2PropertyAssociation, extension IFormattableDocument document) {
		//Assign symbol
		val assign = emv2PropertyAssociation.regionFor.keyword(EMV2PropertyAssociationAccess.equalsSignGreaterThanSignKeyword_1) ?:
			emv2PropertyAssociation.regionFor.keyword(basicEMV2PropertyAssociationAccess.equalsSignGreaterThanSignKeyword_1)
		assign.surround[oneSpace]
		
		//Values
		emv2PropertyAssociation.ownedValues.forEach[it.format(document)]
		val valuesCommas = emv2PropertyAssociation.regionFor.keywords(EMV2PropertyAssociationAccess.commaKeyword_2_1_0) +
		...
		val appliesToCommas = emv2PropertyAssociation.regionFor.keywords(EMV2PropertyAssociationAccess.commaKeyword_3_1_1_0) +
	...
	def dispatch void format(TypeTransformationSet typeTransformationSet, extension IFormattableDocument document) {
		...
		typeTransformationSet.regionFor.keyword(typeTransformationsKeywordsAccess.transformationsKeyword_1).surround[oneSpace]
		...
		//End transformations
		typeTransformationSet.regionFor.keyword(endTransformationsKeywordsAccess.transformationsKeyword_1).prepend[oneSpace].append[noSpace]
	}
	...
	def dispatch void format(TypeTransformation typeTransformation, extension IFormattableDocument document) {
		...
		typeTransformation.regionFor.keyword(typeTransformationAccess.hyphenMinusLeftSquareBracketKeyword_1).prepend[oneSpace].append[noSpace]
		typeTransformation.contributor.format(document)
		typeTransformation.regionFor.keyword(typeTransformationAccess.rightSquareBracketHyphenMinusGreaterThanSignKeyword_3).prepend[noSpace].append[oneSpace]
	...
	def dispatch void format(PropagationPoint propagationPoint, extension IFormattableDocument document) {
		...
		propagationPoint.regionFor.keyword(propagationPointKeywordsAccess.pointKeyword_1).prepend[oneSpace].append[noSpace]
	}
	...
	def dispatch void format(QualifiedPropagationPoint qualifiedPropagationPoint, extension IFormattableDocument document) {
		...
		qualifiedPropagationPoint.regionFor.keyword(qualifiedPropagationPointAccess.fullStopKeyword_0_1).surround[noSpace]
	...
	def dispatch void format(ErrorBehaviorStateMachine errorBehaviorStateMachine, extension IFormattableDocument document) {
		...
		errorBehaviorStateMachine.regionFor.assignment(errorBehaviorStateMachineAccess.nameAssignment_1).append[newLines = 1]
		
		//Use types
		val typesKeyword = errorBehaviorStateMachine.regionFor.keyword(useTypesKeywordsAccess.typesKeyword_1)
		val useTypesSemicolon = errorBehaviorStateMachine.regionFor.keyword(errorBehaviorStateMachineAccess.semicolonKeyword_2_3)
		interior(typesKeyword, useTypesSemicolon, [indent])
		typesKeyword.surround[oneSpace]
		...
		//Use transformations
		errorBehaviorStateMachine.regionFor.keyword(useTransformationsKeywordsAccess.transformationsKeyword_1).surround[oneSpace]
		errorBehaviorStateMachine.regionFor.keyword(errorBehaviorStateMachineAccess.semicolonKeyword_3_2).prepend[noSpace].append[newLines = 1]
		
		//Events
		errorBehaviorStateMachine.regionFor.keyword(errorBehaviorStateMachineAccess.eventsKeyword_4_0).append[newLines = 1]
		...
		//States
		errorBehaviorStateMachine.regionFor.keyword(errorBehaviorStateMachineAccess.statesKeyword_5_0).append[newLines = 1]
		...
		//Transitions
		errorBehaviorStateMachine.regionFor.keyword(errorBehaviorStateMachineAccess.transitionsKeyword_6_0).append[newLines = 1]
		...
		//Properties
		errorBehaviorStateMachine.regionFor.keyword(errorBehaviorStateMachineAccess.propertiesKeyword_7_0).append[newLines = 1]
		...
		//End behavior
		errorBehaviorStateMachine.regionFor.keyword(endBehaviorKeywordsAccess.behaviorKeyword_1).prepend[oneSpace].append[noSpace]
	}
	...
	def dispatch void format(ErrorBehaviorTransition errorBehaviorTransition, extension IFormattableDocument document) {
		//Name
		errorBehaviorTransition.regionFor.keyword(errorBehaviorTransitionAccess.colonKeyword_0_1).prepend[noSpace].append[oneSpace]
		...
		//Condition
		val leftSquare = errorBehaviorTransition.regionFor.keyword(errorBehaviorTransitionAccess.hyphenMinusLeftSquareBracketKeyword_2)
		val rightSquare = errorBehaviorTransition.regionFor.keyword(errorBehaviorTransitionAccess.rightSquareBracketHyphenMinusGreaterThanSignKeyword_4)
		...
		val leftParen = errorBehaviorTransition.regionFor.keyword(errorBehaviorTransitionAccess.leftParenthesisKeyword_5_2_0)
		val rightParen = errorBehaviorTransition.regionFor.keyword(errorBehaviorTransitionAccess.rightParenthesisKeyword_5_2_3)
	...
	def dispatch void format(OutgoingPropagationCondition outgoingPropagationCondition, extension IFormattableDocument document) {
		outgoingPropagationCondition.regionFor.keyword(outgoingPropagationConditionAccess.colonKeyword_0_1).prepend[noSpace].append[oneSpace]
		...
		val leftSquare = outgoingPropagationCondition.regionFor.keyword(outgoingPropagationConditionAccess.hyphenMinusLeftSquareBracketKeyword_2)
		val rightSquare = outgoingPropagationCondition.regionFor.keyword(outgoingPropagationConditionAccess.rightSquareBracketHyphenMinusGreaterThanSignKeyword_4)
		interior(leftSquare, rightSquare, [indent])
		leftSquare.prepend[oneSpace].append[noSpace]
		...
		outgoingPropagationCondition.regionFor.keyword(outgoingPropagationConditionAccess.semicolonKeyword_6).prepend[noSpace]
	}
	...
	def dispatch void format(ErrorDetection errorDetection, extension IFormattableDocument document) {
		...
		val rightSquare = errorDetection.regionFor.keyword(errorDetectionAccess.rightSquareBracketHyphenMinusGreaterThanSignKeyword_4)
		interior(leftSquare, rightSquare, [indent])
		leftSquare.prepend[oneSpace].append[noSpace]
		...
		errorDetection.regionFor.keyword(errorDetectionAccess.leftParenthesisKeyword_7_0).prepend[oneSpace].append[noSpace]
	...
	def dispatch void format(ErrorStateToModeMapping errorStateToModeMapping, extension IFormattableDocument document) {
		...
		val leftParen = errorStateToModeMapping.regionFor.keyword(errorStateToModeMappingAccess.leftParenthesisKeyword_3)
		val rightParen = errorStateToModeMapping.regionFor.keyword(errorStateToModeMappingAccess.rightParenthesisKeyword_6)
		interior(leftParen, rightParen, [indent])
		leftParen.prepend[oneSpace].append[noSpace]
	...
	def dispatch void format(CompositeState compositeState, extension IFormattableDocument document) {
		...
		val rightSquare = compositeState.regionFor.keyword(compositeStateAccess.rightSquareBracketHyphenMinusGreaterThanSignKeyword_3)
		interior(leftSquare, rightSquare, [indent])
	...
	def dispatch void format(QualifiedErrorBehaviorState qualifiedErrorBehaviorState, extension IFormattableDocument document) {
		...
		qualifiedErrorBehaviorState.regionFor.keyword(qualifiedErrorBehaviorStateAccess.fullStopKeyword_1).surround[noSpace]
	 ...
	 */
	def private ISemanticRegion conditionalAppend(ISemanticRegion appendAfter, extension IFormattableDocument document,
