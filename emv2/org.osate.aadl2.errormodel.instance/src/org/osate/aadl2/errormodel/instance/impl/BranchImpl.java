 ...
 * </p>
 * <ul>
 *   <li>{@link org.osate.aadl2.errormodel.instance.impl.BranchImpl#getProbability <em>Probability</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class BranchImpl extends EMV2InstanceObjectImpl implements Branch {
	/**
	...
	protected EClass eStaticClass() {
		return EMV2InstancePackage.Literals.BRANCH;
	}
	...
	public void setProbability(BigDecimal newProbability) {
		...
		if (eNotificationRequired()) {
			eNotify(new ENotificationImpl(this, Notification.SET, EMV2InstancePackage.BRANCH__PROBABILITY,
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case EMV2InstancePackage.BRANCH__PROBABILITY:
