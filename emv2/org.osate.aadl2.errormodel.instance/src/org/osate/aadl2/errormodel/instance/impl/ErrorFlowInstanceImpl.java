 ...
 * </p>
 * <ul>
 *   <li>{@link org.osate.aadl2.errormodel.instance.impl.ErrorFlowInstanceImpl#getEmv2Element <em>Emv2 Element</em>}</li>
 *   <li>{@link org.osate.aadl2.errormodel.instance.impl.ErrorFlowInstanceImpl#getIncoming <em>Incoming</em>}</li>
 *   <li>{@link org.osate.aadl2.errormodel.instance.impl.ErrorFlowInstanceImpl#getOutgoing <em>Outgoing</em>}</li>
 *   <li>{@link org.osate.aadl2.errormodel.instance.impl.ErrorFlowInstanceImpl#isSource <em>Source</em>}</li>
 *   <li>{@link org.osate.aadl2.errormodel.instance.impl.ErrorFlowInstanceImpl#isSink <em>Sink</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ErrorFlowInstanceImpl extends EMV2InstanceObjectImpl implements ErrorFlowInstance {
			...
			if (emv2Element != oldEmv2Element) {
				if (eNotificationRequired()) {
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							EMV2InstancePackage.ERROR_FLOW_INSTANCE__EMV2_ELEMENT, oldEmv2Element, emv2Element));
				}
			}
		}
		return emv2Element;
	...
	public void setEmv2Element(NamedElement newEmv2Element) {
		...
		if (eNotificationRequired()) {
			eNotify(new ENotificationImpl(this, Notification.SET, EMV2InstancePackage.ERROR_FLOW_INSTANCE__EMV2_ELEMENT,
	...
	public NotificationChain basicSetIncoming(ConstrainedInstanceObject newIncoming, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					EMV2InstancePackage.ERROR_FLOW_INSTANCE__INCOMING, oldIncoming, newIncoming);
			if (msgs == null) {
				msgs = notification;
			} else {
		...
		if (newIncoming != incoming) {
			...
			if (incoming != null) {
				msgs = ((InternalEObject) incoming).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - EMV2InstancePackage.ERROR_FLOW_INSTANCE__INCOMING, null, msgs);
			}
			if (newIncoming != null) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET, EMV2InstancePackage.ERROR_FLOW_INSTANCE__INCOMING,
	...
	public NotificationChain basicSetOutgoing(ConstrainedInstanceObject newOutgoing, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					EMV2InstancePackage.ERROR_FLOW_INSTANCE__OUTGOING, oldOutgoing, newOutgoing);
			if (msgs == null) {
				msgs = notification;
			} else {
				msgs.add(notification);
		...
		if (newOutgoing != outgoing) {
			...
			if (outgoing != null) {
				msgs = ((InternalEObject) outgoing).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - EMV2InstancePackage.ERROR_FLOW_INSTANCE__OUTGOING, null, msgs);
			}
			if (newOutgoing != null) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET, EMV2InstancePackage.ERROR_FLOW_INSTANCE__OUTGOING,
	...
	public void setSource(boolean newSource) {
		...
		source = newSource;
		if (eNotificationRequired()) {
			eNotify(new ENotificationImpl(this, Notification.SET, EMV2InstancePackage.ERROR_FLOW_INSTANCE__SOURCE,
					oldSource, source));
		}
	}
	...
	public void setSink(boolean newSink) {
		...
		sink = newSink;
		if (eNotificationRequired()) {
			eNotify(new ENotificationImpl(this, Notification.SET, EMV2InstancePackage.ERROR_FLOW_INSTANCE__SINK,
					oldSink, sink));
		}
	}
