 ...
 * </p>
 * <ul>
 *   <li>{@link org.osate.aadl2.errormodel.instance.impl.EventInstanceImpl#getEvent <em>Event</em>}</li>
 *   <li>{@link org.osate.aadl2.errormodel.instance.impl.EventInstanceImpl#getGeneratedTypedEvents <em>Generated Typed Events</em>}</li>
 * </ul>
 *
 * @generated
 */
public class EventInstanceImpl extends EMV2InstanceObjectImpl implements EventInstance {
		...
		if (event != null && event.eIsProxy()) {
			...
			if (event != oldEvent) {
				if (eNotificationRequired()) {
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, EMV2InstancePackage.EVENT_INSTANCE__EVENT,
							oldEvent, event));
				}
			}
		}
	...
	public void setEvent(ErrorBehaviorEvent newEvent) {
		...
		event = newEvent;
		if (eNotificationRequired()) {
			eNotify(new ENotificationImpl(this, Notification.SET, EMV2InstancePackage.EVENT_INSTANCE__EVENT, oldEvent,
					event));
		}
	}
	...
	public EList<ConstrainedInstanceObject> getGeneratedTypedEvents() {
		if (generatedTypedEvents == null) {
			generatedTypedEvents = new EObjectContainmentEList<>(
					ConstrainedInstanceObject.class, this, EMV2InstancePackage.EVENT_INSTANCE__GENERATED_TYPED_EVENTS);
		}
