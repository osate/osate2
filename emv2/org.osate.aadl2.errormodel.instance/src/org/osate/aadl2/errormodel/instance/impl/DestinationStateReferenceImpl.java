...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Destination State Reference</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link org.osate.aadl2.errormodel.instance.impl.DestinationStateReferenceImpl#getState <em>State</em>}</li>
 *   <li>{@link org.osate.aadl2.errormodel.instance.impl.DestinationStateReferenceImpl#getTypeSet <em>Type Set</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DestinationStateReferenceImpl extends EMV2InstanceObjectImpl implements DestinationStateReference {
	/**
	 ...
	 * @generated
	 */
	protected DestinationStateReferenceImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return EMV2InstancePackage.Literals.DESTINATION_STATE_REFERENCE;
	}
			...
			if (state != oldState) {
				if (eNotificationRequired()) {
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							EMV2InstancePackage.DESTINATION_STATE_REFERENCE__STATE, oldState, state));
				}
			}
		}
		return state;
	...
	public NotificationChain basicSetTypeSet(AnonymousTypeSet newTypeSet, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					EMV2InstancePackage.DESTINATION_STATE_REFERENCE__TYPE_SET, oldTypeSet, newTypeSet);
			if (msgs == null) {
				msgs = notification;
			} else {
		...
		if (newTypeSet != typeSet) {
			...
			if (typeSet != null) {
				msgs = ((InternalEObject) typeSet).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - EMV2InstancePackage.DESTINATION_STATE_REFERENCE__TYPE_SET, null, msgs);
			}
			if (newTypeSet != null) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					EMV2InstancePackage.DESTINATION_STATE_REFERENCE__TYPE_SET, newTypeSet, newTypeSet));
		}
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
		case EMV2InstancePackage.DESTINATION_STATE_REFERENCE__TYPE_SET:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case EMV2InstancePackage.DESTINATION_STATE_REFERENCE__STATE:
			if (resolve) {
				return getState();
			}
