...
public class FeaturePropagationImpl extends ErrorPropagationInstanceImpl implements FeaturePropagation {
			...
			if (feature != oldFeature) {
				if (eNotificationRequired()) {
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							EMV2InstancePackage.FEATURE_PROPAGATION__FEATURE, oldFeature, feature));
				}
			}
		}
		return feature;
	...
	public void setFeature(FeatureInstance newFeature) {
		...
		feature = newFeature;
		if (eNotificationRequired()) {
			eNotify(new ENotificationImpl(this, Notification.SET, EMV2InstancePackage.FEATURE_PROPAGATION__FEATURE,
					oldFeature, feature));
		}
	}
