...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>All Propagations</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link org.osate.aadl2.errormodel.instance.impl.AllPropagationsImpl#getTypeSet <em>Type Set</em>}</li>
 * </ul>
 *
 * @generated
 */
public class AllPropagationsImpl extends EMV2InstanceObjectImpl implements AllPropagations {
	/**
	...
	protected EClass eStaticClass() {
		return EMV2InstancePackage.Literals.ALL_PROPAGATIONS;
	}
	...
	public NotificationChain basicSetTypeSet(AnonymousTypeSet newTypeSet, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					EMV2InstancePackage.ALL_PROPAGATIONS__TYPE_SET, oldTypeSet, newTypeSet);
			if (msgs == null) {
				msgs = notification;
			} else {
		...
		if (newTypeSet != typeSet) {
			...
			if (typeSet != null) {
				msgs = ((InternalEObject) typeSet).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - EMV2InstancePackage.ALL_PROPAGATIONS__TYPE_SET, null, msgs);
			}
			if (newTypeSet != null) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET, EMV2InstancePackage.ALL_PROPAGATIONS__TYPE_SET,
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
		case EMV2InstancePackage.ALL_PROPAGATIONS__TYPE_SET:
