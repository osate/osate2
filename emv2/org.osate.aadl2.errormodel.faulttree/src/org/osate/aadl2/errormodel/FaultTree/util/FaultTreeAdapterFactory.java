...
import org.osate.aadl2.errormodel.FaultTree.*;
...
public class FaultTreeAdapterFactory extends AdapterFactoryImpl {
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.osate.aadl2.errormodel.FaultTree.FaultTree <em>Fault Tree</em>}'.
	 * <!-- begin-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.osate.aadl2.errormodel.FaultTree.Event <em>Event</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
