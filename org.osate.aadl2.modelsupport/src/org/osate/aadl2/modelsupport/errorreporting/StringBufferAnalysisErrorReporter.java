...
public final class StringBufferAnalysisErrorReporter extends
	...
	private StringBufferAnalysisErrorReporter(final Resource rsrc, 
			final String error, final String warning, final String info,
	...
	private void outputMessage(final String lead, final String message,
...
//		}
	...
	public static final class Factory implements AnalysisErrorReporterFactory {
		...
		public Factory(final String error, final String warning, final String info,
		...
		public AnalysisErrorReporter getReporterFor(final Resource rsrc) {
			return new StringBufferAnalysisErrorReporter(
					rsrc, errorLead, warningLead, infoLead, buffer);
		}
	}
}
