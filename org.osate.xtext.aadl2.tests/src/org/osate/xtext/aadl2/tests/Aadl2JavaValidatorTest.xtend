...
class Aadl2JavaValidatorTest extends OsateTest {
	...
	/*
	 * Tests typeCheckAccessConnectionEnd, typeCheckFeatureConnectionEnd, typeCheckFeatureGroupConnectionEnd, typeCheckParameterConnectionEnd, and
	 * typeCheckPortConnectionEnd
	 */
	@Test
	def void testConnectionTypes() {
		'''
		...
		'''.parse as AadlPackage => [
			...
			val allIssues = validate
			Assert::assertTrue(allIssues.filter[syntaxError].empty)
			assertAllCrossReferencesResolvable
			398.assertEquals(allIssues.size)
			publicSection.ownedClassifiers.get(1) as AbstractImplementation => [
				...
				ownedAccessConnections.get(0) => [
					...
					source.assertNoIssues(allIssues)
					//Tests typeCheckAccessConnectionEnd
					destination.assertNoIssues(allIssues)
				]
				ownedAccessConnections.get(1) => [
					"aconn2".assertEquals(name)
					//Tests typeCheckAccessConnectionEnd
					source.assertNoIssues(allIssues)
					//Tests typeCheckAccessConnectionEnd
					destination.assertNoIssues(allIssues)
				...
				ownedAccessConnections.get(5) => [
					...
					//Tests typeCheckAccessConnectionEnd
					source.assertError(allIssues, "A 'port proxy' is not a valid access connection end.")
					//Tests typeCheckAccessConnectionEnd
					destination.assertNoIssues(allIssues)
				]
				ownedAccessConnections.get(6) => [
					...
					//Tests typeCheckAccessConnectionEnd
					source.assertError(allIssues, "An 'event data source' is not a valid access connection end.")
					//Tests typeCheckAccessConnectionEnd
					destination.assertNoIssues(allIssues)
				]
				ownedAccessConnections.get(7) => [
					...
					//Tests typeCheckAccessConnectionEnd
					source.assertError(allIssues, "An 'abstract feature' is not a valid access connection end.")
					//Tests typeCheckAccessConnectionEnd
					destination.assertNoIssues(allIssues)
				]
				ownedAccessConnections.get(8) => [
					...
					//Tests typeCheckAccessConnectionEnd
					source.assertError(allIssues, "A 'feature group' is not a valid access connection end.")
					//Tests typeCheckAccessConnectionEnd
					destination.assertNoIssues(allIssues)
				]
				ownedAccessConnections.get(9) => [
					"aconn10".assertEquals(name)
					//Tests typeCheckAccessConnectionEnd
					source.assertNoIssues(allIssues)
					//Tests typeCheckAccessConnectionEnd
					destination.assertNoIssues(allIssues)
				...
				ownedAccessConnections.get(11) => [
					...
					//Tests typeCheckAccessConnectionEnd
					source.assertError(allIssues, "An 'event port' is not a valid access connection end.")
					//Tests typeCheckAccessConnectionEnd
					destination.assertNoIssues(allIssues)
				]
				ownedAccessConnections.get(12) => [
					...
					//Tests typeCheckAccessConnectionEnd
					source.assertError(allIssues, "A 'data port' is not a valid access connection end.")
					//Tests typeCheckAccessConnectionEnd
					destination.assertNoIssues(allIssues)
				]
				ownedAccessConnections.get(13) => [
					...
					//Tests typeCheckAccessConnectionEnd
					source.assertError(allIssues, "An 'event data port' is not a valid access connection end.")
					//Tests typeCheckAccessConnectionEnd
					destination.assertNoIssues(allIssues)
				]
				ownedAccessConnections.get(14) => [
					...
					//Tests typeCheckAccessConnectionEnd
					source.assertError(allIssues, "Anything in a 'data port' is not a valid access connection end.")
					//Tests typeCheckAccessConnectionEnd
					destination.assertNoIssues(allIssues)
				]
				...
				ownedAccessConnections.get(28) => [
					...
					//Tests typeCheckAccessConnectionEnd
					source.assertError(allIssues, "Anything in an 'event data port' is not a valid access connection end.")
					//Tests typeCheckAccessConnectionEnd
					destination.assertNoIssues(allIssues)
				]
				...
				ownedAccessConnections.get(42) => [
					...
					//Tests typeCheckAccessConnectionEnd
					source.assertError(allIssues, "An 'abstract feature' in a 'feature group' is not a valid access connection end.")
					//Tests typeCheckAccessConnectionEnd
					destination.assertNoIssues(allIssues)
				]
				ownedAccessConnections.get(43) => [
					...
					//Tests typeCheckAccessConnectionEnd
					source.assertError(allIssues, "A 'feature group' in a 'feature group' is not a valid access connection end.")
					//Tests typeCheckAccessConnectionEnd
					destination.assertNoIssues(allIssues)
				]
				ownedAccessConnections.get(44) => [
					...
					//Tests typeCheckAccessConnectionEnd
					source.assertError(allIssues, "A 'parameter' in a 'feature group' is not a valid access connection end.")
					//Tests typeCheckAccessConnectionEnd
					destination.assertNoIssues(allIssues)
				]
				ownedAccessConnections.get(45) => [
					"aconn46".assertEquals(name)
					//Tests typeCheckAccessConnectionEnd
					source.assertNoIssues(allIssues)
					//Tests typeCheckAccessConnectionEnd
					destination.assertNoIssues(allIssues)
				]
				ownedAccessConnections.get(46) => [
					"aconn47".assertEquals(name)
					//Tests typeCheckAccessConnectionEnd
					source.assertNoIssues(allIssues)
					//Tests typeCheckAccessConnectionEnd
					destination.assertNoIssues(allIssues)
				...
				ownedAccessConnections.get(47) => [
					...
					//Tests typeCheckAccessConnectionEnd
					source.assertError(allIssues, "An 'event port' in a 'feature group' is not a valid access connection end.")
					//Tests typeCheckAccessConnectionEnd
					destination.assertNoIssues(allIssues)
				]
				ownedAccessConnections.get(48) => [
					...
					//Tests typeCheckAccessConnectionEnd
					source.assertError(allIssues, "A 'data port' in a 'feature group' is not a valid access connection end.")
					//Tests typeCheckAccessConnectionEnd
					destination.assertNoIssues(allIssues)
				]
				ownedAccessConnections.get(49) => [
					...
					//Tests typeCheckAccessConnectionEnd
					source.assertError(allIssues, "An 'event data port' in a 'feature group' is not a valid access connection end.")
					//Tests typeCheckAccessConnectionEnd
					destination.assertNoIssues(allIssues)
				]
				ownedAccessConnections.get(50) => [
					...
					//Tests typeCheckAccessConnectionEnd
					source.assertError(allIssues, "A 'bus subcomponent' in an 'abstract subcomponent' is not a valid access connection end.")
					//Tests typeCheckAccessConnectionEnd
					destination.assertNoIssues(allIssues)
				]
				ownedAccessConnections.get(51) => [
					...
					//Tests typeCheckAccessConnectionEnd
					source.assertError(allIssues, "A 'data subcomponent' in an 'abstract subcomponent' is not a valid access connection end.")
					//Tests typeCheckAccessConnectionEnd
					destination.assertNoIssues(allIssues)
				]
				ownedAccessConnections.get(52) => [
					...
					//Tests typeCheckAccessConnectionEnd
					source.assertError(allIssues, "A 'subprogram group subcomponent' in an 'abstract subcomponent' is not a valid access connection end.")
					//Tests typeCheckAccessConnectionEnd
					destination.assertNoIssues(allIssues)
				]
				ownedAccessConnections.get(53) => [
					...
					//Tests typeCheckAccessConnectionEnd
					source.assertError(allIssues, "A 'subprogram subcomponent' in an 'abstract subcomponent' is not a valid access connection end.")
					//Tests typeCheckAccessConnectionEnd
					destination.assertNoIssues(allIssues)
				]
				ownedAccessConnections.get(54) => [
					...
					//Tests typeCheckAccessConnectionEnd
					source.assertError(allIssues, "A 'subprogram proxy' in an 'abstract subcomponent' is not a valid access connection end.")
					//Tests typeCheckAccessConnectionEnd
					destination.assertNoIssues(allIssues)
				]
				ownedAccessConnections.get(55) => [
					...
					//Tests typeCheckAccessConnectionEnd
					source.assertError(allIssues, "A 'port proxy' in an 'abstract subcomponent' is not a valid access connection end.")
					//Tests typeCheckAccessConnectionEnd
					destination.assertNoIssues(allIssues)
				]
				ownedAccessConnections.get(56) => [
					...
					//Tests typeCheckAccessConnectionEnd
					source.assertError(allIssues, "An 'event data source' in an 'abstract subcomponent' is not a valid access connection end.")
					//Tests typeCheckAccessConnectionEnd
					destination.assertNoIssues(allIssues)
				]
				ownedAccessConnections.get(57) => [
					...
					//Tests typeCheckAccessConnectionEnd
					source.assertError(allIssues, "An 'abstract feature' in an 'abstract subcomponent' is not a valid access connection end.")
					//Tests typeCheckAccessConnectionEnd
					destination.assertNoIssues(allIssues)
				]
				ownedAccessConnections.get(58) => [
					...
					//Tests typeCheckAccessConnectionEnd
					source.assertError(allIssues, "A 'feature group' in an 'abstract subcomponent' is not a valid access connection end.")
					//Tests typeCheckAccessConnectionEnd
					destination.assertNoIssues(allIssues)
				]
				ownedAccessConnections.get(59) => [
					...
					//Tests typeCheckAccessConnectionEnd
					source.assertError(allIssues, "A 'parameter' in a 'subprogram subcomponent' is not a valid access connection end.")
					//Tests typeCheckAccessConnectionEnd
					destination.assertNoIssues(allIssues)
				]
				ownedAccessConnections.get(60) => [
					"aconn61".assertEquals(name)
					//Tests typeCheckAccessConnectionEnd
					source.assertNoIssues(allIssues)
					//Tests typeCheckAccessConnectionEnd
					destination.assertNoIssues(allIssues)
				]
				ownedAccessConnections.get(61) => [
					"aconn62".assertEquals(name)
					//Tests typeCheckAccessConnectionEnd
					source.assertNoIssues(allIssues)
					//Tests typeCheckAccessConnectionEnd
					destination.assertNoIssues(allIssues)
				...
				ownedAccessConnections.get(62) => [
					...
					//Tests typeCheckAccessConnectionEnd
					source.assertError(allIssues, "An 'event port' in an 'abstract subcomponent' is not a valid access connection end.")
					//Tests typeCheckAccessConnectionEnd
					destination.assertNoIssues(allIssues)
				]
				ownedAccessConnections.get(63) => [
					...
					//Tests typeCheckAccessConnectionEnd
					source.assertError(allIssues, "A 'data port' in an 'abstract subcomponent' is not a valid access connection end.")
					//Tests typeCheckAccessConnectionEnd
					destination.assertNoIssues(allIssues)
				]
				ownedAccessConnections.get(64) => [
					...
					//Tests typeCheckAccessConnectionEnd
					source.assertError(allIssues, "An 'event data port' in an 'abstract subcomponent' is not a valid access connection end.")
					//Tests typeCheckAccessConnectionEnd
					destination.assertNoIssues(allIssues)
				]
				ownedAccessConnections.get(65) => [
					...
					//Tests typeCheckAccessConnectionEnd
					source.assertError(allIssues, "A 'data subcomponent' in a 'subprogram call' is not a valid access connection end.")
					//Tests typeCheckAccessConnectionEnd
					destination.assertNoIssues(allIssues)
				]
				ownedAccessConnections.get(66) => [
					...
					//Tests typeCheckAccessConnectionEnd
					source.assertError(allIssues, "A 'subprogram subcomponent' in a 'subprogram call' is not a valid access connection end.")
					//Tests typeCheckAccessConnectionEnd
					destination.assertNoIssues(allIssues)
				]
				ownedAccessConnections.get(67) => [
					...
					//Tests typeCheckAccessConnectionEnd
					source.assertError(allIssues, "A 'subprogram proxy' in a 'subprogram call' is not a valid access connection end.")
					//Tests typeCheckAccessConnectionEnd
					destination.assertNoIssues(allIssues)
				]
				ownedAccessConnections.get(68) => [
					...
					//Tests typeCheckAccessConnectionEnd
					source.assertError(allIssues, "A 'port proxy' in a 'subprogram call' is not a valid access connection end.")
					//Tests typeCheckAccessConnectionEnd
					destination.assertNoIssues(allIssues)
				]
				ownedAccessConnections.get(69) => [
					...
					//Tests typeCheckAccessConnectionEnd
					source.assertError(allIssues, "An 'event data source' in a 'subprogram call' is not a valid access connection end.")
					//Tests typeCheckAccessConnectionEnd
					destination.assertNoIssues(allIssues)
				]
				ownedAccessConnections.get(70) => [
					...
					//Tests typeCheckAccessConnectionEnd
					source.assertError(allIssues, "An 'abstract feature' in a 'subprogram call' is not a valid access connection end.")
					//Tests typeCheckAccessConnectionEnd
					destination.assertNoIssues(allIssues)
				]
				ownedAccessConnections.get(71) => [
					...
					//Tests typeCheckAccessConnectionEnd
					source.assertError(allIssues, "A 'feature group' in a 'subprogram call' is not a valid access connection end.")
					//Tests typeCheckAccessConnectionEnd
					destination.assertNoIssues(allIssues)
				]
				ownedAccessConnections.get(72) => [
					...
					//Tests typeCheckAccessConnectionEnd
					source.assertError(allIssues, "A 'parameter' in a 'subprogram call' is not a valid access connection end.")
					//Tests typeCheckAccessConnectionEnd
					destination.assertNoIssues(allIssues)
				]
				ownedAccessConnections.get(73) => [
					"aconn74".assertEquals(name)
					//Tests typeCheckAccessConnectionEnd
					source.assertNoIssues(allIssues)
					//Tests typeCheckAccessConnectionEnd
					destination.assertNoIssues(allIssues)
				]
				ownedAccessConnections.get(74) => [
					"aconn75".assertEquals(name)
					//Tests typeCheckAccessConnectionEnd
					source.assertNoIssues(allIssues)
					//Tests typeCheckAccessConnectionEnd
					destination.assertNoIssues(allIssues)
				...
				ownedAccessConnections.get(75) => [
					...
					//Tests typeCheckAccessConnectionEnd
					source.assertError(allIssues, "An 'event port' in a 'subprogram call' is not a valid access connection end.")
					//Tests typeCheckAccessConnectionEnd
					destination.assertNoIssues(allIssues)
				]
				ownedAccessConnections.get(76) => [
					...
					//Tests typeCheckAccessConnectionEnd
					source.assertError(allIssues, "An 'event data port' in a 'subprogram call' is not a valid access connection end.")
					//Tests typeCheckAccessConnectionEnd
					destination.assertNoIssues(allIssues)
				]
				ownedFeatureConnections.get(0) => [
					...
					source.assertError(allIssues, "A 'bus subcomponent' is not a valid feature connection end.")
					//Tests typeCheckFeatureConnectionEnd
					destination.assertNoIssues(allIssues)
				]
				ownedFeatureConnections.get(1) => [
					...
					//Tests typeCheckFeatureConnectionEnd
					source.assertError(allIssues, "A 'data subcomponent' is not a valid feature connection end.")
					//Tests typeCheckFeatureConnectionEnd
					destination.assertNoIssues(allIssues)
				]
				ownedFeatureConnections.get(2) => [
					...
					//Tests typeCheckFeatureConnectionEnd
					source.assertError(allIssues, "A 'subprogram group subcomponent' is not a valid feature connection end.")
					//Tests typeCheckFeatureConnectionEnd
					destination.assertNoIssues(allIssues)
				]
				ownedFeatureConnections.get(3) => [
					...
					//Tests typeCheckFeatureConnectionEnd
					source.assertError(allIssues, "A 'subprogram subcomponent' is not a valid feature connection end.")
					//Tests typeCheckFeatureConnectionEnd
					destination.assertNoIssues(allIssues)
				]
				ownedFeatureConnections.get(4) => [
					...
					//Tests typeCheckFeatureConnectionEnd
					source.assertError(allIssues, "A 'subprogram proxy' is not a valid feature connection end.")
					//Tests typeCheckFeatureConnectionEnd
					destination.assertNoIssues(allIssues)
				]
				ownedFeatureConnections.get(5) => [
					"fconn6".assertEquals(name)
					//Tests typeCheckFeatureConnectionEnd
					source.assertNoIssues(allIssues)
					//Tests typeCheckFeatureConnectionEnd
					destination.assertNoIssues(allIssues)
				...
				ownedFeatureConnections.get(14) => [
					...
					//Tests typeCheckFeatureConnectionEnd
					source.assertError(allIssues, "Anything in a 'data port' is not a valid feature connection end.")
					//Tests typeCheckFeatureConnectionEnd
					destination.assertNoIssues(allIssues)
				]
				...
				ownedFeatureConnections.get(28) => [
					...
					//Tests typeCheckFeatureConnectionEnd
					source.assertError(allIssues, "Anything in an 'event data port' is not a valid feature connection end.")
					//Tests typeCheckFeatureConnectionEnd
					destination.assertNoIssues(allIssues)
				]
				...
				ownedFeatureConnections.get(42) => [
					"fconn43".assertEquals(name)
					//Tests typeCheckFeatureConnectionEnd
					source.assertNoIssues(allIssues)
					//Tests typeCheckFeatureConnectionEnd
					destination.assertNoIssues(allIssues)
				]
				ownedFeatureConnections.get(43) => [
					"fconn44".assertEquals(name)
					//Tests typeCheckFeatureConnectionEnd
					source.assertNoIssues(allIssues)
					//Tests typeCheckFeatureConnectionEnd
					destination.assertNoIssues(allIssues)
				...
				ownedFeatureConnections.get(45) => [
					"fconn46".assertEquals(name)
					//Tests typeCheckFeatureConnectionEnd
					source.assertNoIssues(allIssues)
					//Tests typeCheckFeatureConnectionEnd
					destination.assertNoIssues(allIssues)
				...
				ownedFeatureConnections.get(47) => [
					"fconn48".assertEquals(name)
					//Tests typeCheckFeatureConnectionEnd
					source.assertNoIssues(allIssues)
					//Tests typeCheckFeatureConnectionEnd
					destination.assertNoIssues(allIssues)
				...
				ownedFeatureConnections.get(50) => [
					...
					//Tests typeCheckFeatureConnectionEnd
					source.assertError(allIssues, "A 'bus subcomponent' in an 'abstract subcomponent' is not a valid feature connection end.")
					//Tests typeCheckFeatureConnectionEnd
					destination.assertNoIssues(allIssues)
				]
				ownedFeatureConnections.get(51) => [
					...
					//Tests typeCheckFeatureConnectionEnd
					source.assertError(allIssues, "A 'data subcomponent' in an 'abstract subcomponent' is not a valid feature connection end.")
					//Tests typeCheckFeatureConnectionEnd
					destination.assertNoIssues(allIssues)
				]
				ownedFeatureConnections.get(52) => [
					...
					//Tests typeCheckFeatureConnectionEnd
					source.assertError(allIssues, "A 'subprogram group subcomponent' in an 'abstract subcomponent' is not a valid feature connection end.")
					//Tests typeCheckFeatureConnectionEnd
					destination.assertNoIssues(allIssues)
				]
				ownedFeatureConnections.get(53) => [
					...
					//Tests typeCheckFeatureConnectionEnd
					source.assertError(allIssues, "A 'subprogram subcomponent' in an 'abstract subcomponent' is not a valid feature connection end.")
					//Tests typeCheckFeatureConnectionEnd
					destination.assertNoIssues(allIssues)
				]
				ownedFeatureConnections.get(54) => [
					...
					//Tests typeCheckFeatureConnectionEnd
					source.assertError(allIssues, "A 'subprogram proxy' in an 'abstract subcomponent' is not a valid feature connection end.")
					//Tests typeCheckFeatureConnectionEnd
					destination.assertNoIssues(allIssues)
				]
				ownedFeatureConnections.get(55) => [
					...
					//Tests typeCheckFeatureConnectionEnd
					source.assertError(allIssues, "A 'port proxy' in an 'abstract subcomponent' is not a valid feature connection end.")
					//Tests typeCheckFeatureConnectionEnd
					destination.assertNoIssues(allIssues)
				]
				ownedFeatureConnections.get(56) => [
					...
					//Tests typeCheckFeatureConnectionEnd
					source.assertError(allIssues, "An 'event data source' in an 'abstract subcomponent' is not a valid feature connection end.")
					//Tests typeCheckFeatureConnectionEnd
					destination.assertNoIssues(allIssues)
				]
				ownedFeatureConnections.get(57) => [
					"fconn58".assertEquals(name)
					//Tests typeCheckFeatureConnectionEnd
					source.assertNoIssues(allIssues)
					//Tests typeCheckFeatureConnectionEnd
					destination.assertNoIssues(allIssues)
				]
				ownedFeatureConnections.get(58) => [
					"fconn59".assertEquals(name)
					//Tests typeCheckFeatureConnectionEnd
					source.assertNoIssues(allIssues)
					//Tests typeCheckFeatureConnectionEnd
					destination.assertNoIssues(allIssues)
				...
				ownedFeatureConnections.get(60) => [
					"fconn61".assertEquals(name)
					//Tests typeCheckFeatureConnectionEnd
					source.assertNoIssues(allIssues)
					//Tests typeCheckFeatureConnectionEnd
					destination.assertNoIssues(allIssues)
				...
				ownedFeatureConnections.get(62) => [
					"fconn63".assertEquals(name)
					//Tests typeCheckFeatureConnectionEnd
					source.assertNoIssues(allIssues)
					//Tests typeCheckFeatureConnectionEnd
					destination.assertNoIssues(allIssues)
				...
				ownedFeatureConnections.get(65) => [
					...
					//Tests typeCheckFeatureConnectionEnd
					source.assertError(allIssues, "A 'data subcomponent' in a 'subprogram call' is not a valid feature connection end.")
					//Tests typeCheckFeatureConnectionEnd
					destination.assertNoIssues(allIssues)
				]
				ownedFeatureConnections.get(66) => [
					...
					//Tests typeCheckFeatureConnectionEnd
					source.assertError(allIssues, "A 'subprogram subcomponent' in a 'subprogram call' is not a valid feature connection end.")
					//Tests typeCheckFeatureConnectionEnd
					destination.assertNoIssues(allIssues)
				]
				ownedFeatureConnections.get(67) => [
					...
					//Tests typeCheckFeatureConnectionEnd
					source.assertError(allIssues, "A 'subprogram proxy' in a 'subprogram call' is not a valid feature connection end.")
					//Tests typeCheckFeatureConnectionEnd
					destination.assertNoIssues(allIssues)
				]
				ownedFeatureConnections.get(68) => [
					...
					//Tests typeCheckFeatureConnectionEnd
					source.assertError(allIssues, "A 'port proxy' in a 'subprogram call' is not a valid feature connection end.")
					//Tests typeCheckFeatureConnectionEnd
					destination.assertNoIssues(allIssues)
				]
				ownedFeatureConnections.get(69) => [
					...
					//Tests typeCheckFeatureConnectionEnd
					source.assertError(allIssues, "An 'event data source' in a 'subprogram call' is not a valid feature connection end.")
					//Tests typeCheckFeatureConnectionEnd
					destination.assertNoIssues(allIssues)
				]
				ownedFeatureConnections.get(70) => [
					"fconn71".assertEquals(name)
					//Tests typeCheckFeatureConnectionEnd
					source.assertNoIssues(allIssues)
					//Tests typeCheckFeatureConnectionEnd
					destination.assertNoIssues(allIssues)
				]
				ownedFeatureConnections.get(71) => [
					"fconn72".assertEquals(name)
					//Tests typeCheckFeatureConnectionEnd
					source.assertNoIssues(allIssues)
					//Tests typeCheckFeatureConnectionEnd
					destination.assertNoIssues(allIssues)
				...
				ownedFeatureConnections.get(75) => [
					"fconn76".assertEquals(name)
					//Tests typeCheckFeatureConnectionEnd
					source.assertNoIssues(allIssues)
					//Tests typeCheckFeatureConnectionEnd
					destination.assertNoIssues(allIssues)
				]
				ownedFeatureConnections.get(76) => [
					"fconn77".assertEquals(name)
					//Tests typeCheckFeatureConnectionEnd
					source.assertNoIssues(allIssues)
					//Tests typeCheckFeatureConnectionEnd
					destination.assertNoIssues(allIssues)
				...
				ownedFeatureGroupConnections.get(0) => [
					...
					source.assertError(allIssues, "A 'bus subcomponent' is not a valid feature group connection end.")
					//Tests typeCheckFeatureGroupConnectionEnd
					destination.assertNoIssues(allIssues)
				]
				ownedFeatureGroupConnections.get(1) => [
					...
					//Tests typeCheckFeatureGroupConnectionEnd
					source.assertError(allIssues, "A 'data subcomponent' is not a valid feature group connection end.")
					//Tests typeCheckFeatureGroupConnectionEnd
					destination.assertNoIssues(allIssues)
				]
				ownedFeatureGroupConnections.get(2) => [
					...
					//Tests typeCheckFeatureGroupConnectionEnd
					source.assertError(allIssues, "A 'subprogram group subcomponent' is not a valid feature group connection end.")
					//Tests typeCheckFeatureGroupConnectionEnd
					destination.assertNoIssues(allIssues)
				]
				ownedFeatureGroupConnections.get(3) => [
					...
					//Tests typeCheckFeatureGroupConnectionEnd
					source.assertError(allIssues, "A 'subprogram subcomponent' is not a valid feature group connection end.")
					//Tests typeCheckFeatureGroupConnectionEnd
					destination.assertNoIssues(allIssues)
				]
				ownedFeatureGroupConnections.get(4) => [
					...
					//Tests typeCheckFeatureGroupConnectionEnd
					source.assertError(allIssues, "A 'subprogram proxy' is not a valid feature group connection end.")
					//Tests typeCheckFeatureGroupConnectionEnd
					destination.assertNoIssues(allIssues)
				]
				ownedFeatureGroupConnections.get(5) => [
					...
					//Tests typeCheckFeatureGroupConnectionEnd
					source.assertError(allIssues, "A 'port proxy' is not a valid feature group connection end.")
					//Tests typeCheckFeatureGroupConnectionEnd
					destination.assertNoIssues(allIssues)
				]
				ownedFeatureGroupConnections.get(6) => [
					...
					//Tests typeCheckFeatureGroupConnectionEnd
					source.assertError(allIssues, "An 'event data source' is not a valid feature group connection end.")
					//Tests typeCheckFeatureGroupConnectionEnd
					destination.assertNoIssues(allIssues)
				]
				ownedFeatureGroupConnections.get(7) => [
					...
					//Tests typeCheckFeatureGroupConnectionEnd
					source.assertError(allIssues, "An 'abstract feature' is not a valid feature group connection end.")
					//Tests typeCheckFeatureGroupConnectionEnd
					destination.assertNoIssues(allIssues)
				]
				ownedFeatureGroupConnections.get(8) => [
					"fgconn9".assertEquals(name)
					//Tests typeCheckFeatureGroupConnectionEnd
					source.assertNoIssues(allIssues)
					//Tests typeCheckFeatureGroupConnectionEnd
					destination.assertNoIssues(allIssues)
				...
				ownedFeatureGroupConnections.get(9) => [
					...
					//Tests typeCheckFeatureGroupConnectionEnd
					source.assertError(allIssues, "A 'bus access' is not a valid feature group connection end.")
					//Tests typeCheckFeatureGroupConnectionEnd
					destination.assertNoIssues(allIssues)
				]
				ownedFeatureGroupConnections.get(10) => [
					...
					//Tests typeCheckFeatureGroupConnectionEnd
					source.assertError(allIssues, "A 'data access' is not a valid feature group connection end.")
					//Tests typeCheckFeatureGroupConnectionEnd
					destination.assertNoIssues(allIssues)
				]
				ownedFeatureGroupConnections.get(11) => [
					...
					//Tests typeCheckFeatureGroupConnectionEnd
					source.assertError(allIssues, "An 'event port' is not a valid feature group connection end.")
					//Tests typeCheckFeatureGroupConnectionEnd
					destination.assertNoIssues(allIssues)
				]
				ownedFeatureGroupConnections.get(12) => [
					...
					//Tests typeCheckFeatureGroupConnectionEnd
					source.assertError(allIssues, "A 'data port' is not a valid feature group connection end.")
					//Tests typeCheckFeatureGroupConnectionEnd
					destination.assertNoIssues(allIssues)
				]
				ownedFeatureGroupConnections.get(13) => [
					...
					//Tests typeCheckFeatureGroupConnectionEnd
					source.assertError(allIssues, "An 'event data port' is not a valid feature group connection end.")
					//Tests typeCheckFeatureGroupConnectionEnd
					destination.assertNoIssues(allIssues)
				]
				ownedFeatureGroupConnections.get(14) => [
					...
					//Tests typeCheckFeatureGroupConnectionEnd
					source.assertError(allIssues, "Anything in a 'data port' is not a valid feature group connection end.")
					//Tests typeCheckFeatureGroupConnectionEnd
					destination.assertNoIssues(allIssues)
				]
				...
				ownedFeatureGroupConnections.get(28) => [
					...
					//Tests typeCheckFeatureGroupConnectionEnd
					source.assertError(allIssues, "Anything in an 'event data port' is not a valid feature group connection end.")
					//Tests typeCheckFeatureGroupConnectionEnd
					destination.assertNoIssues(allIssues)
				]
				...
				ownedFeatureGroupConnections.get(42) => [
					...
					//Tests typeCheckFeatureGroupConnectionEnd
					source.assertError(allIssues, "An 'abstract feature' in a 'feature group' is not a valid feature group connection end.")
					//Tests typeCheckFeatureGroupConnectionEnd
					destination.assertNoIssues(allIssues)
				]
				ownedFeatureGroupConnections.get(43) => [
					"fgconn44".assertEquals(name)
					//Tests typeCheckFeatureGroupConnectionEnd
					source.assertNoIssues(allIssues)
					//Tests typeCheckFeatureGroupConnectionEnd
					destination.assertNoIssues(allIssues)
				...
				ownedFeatureGroupConnections.get(44) => [
					...
					//Tests typeCheckFeatureGroupConnectionEnd
					source.assertError(allIssues, "A 'parameter' in a 'feature group' is not a valid feature group connection end.")
					//Tests typeCheckFeatureGroupConnectionEnd
					destination.assertNoIssues(allIssues)
				]
				ownedFeatureGroupConnections.get(45) => [
					...
					//Tests typeCheckFeatureGroupConnectionEnd
					source.assertError(allIssues, "A 'bus access' in a 'feature group' is not a valid feature group connection end.")
					//Tests typeCheckFeatureGroupConnectionEnd
					destination.assertNoIssues(allIssues)
				]
				ownedFeatureGroupConnections.get(46) => [
					...
					//Tests typeCheckFeatureGroupConnectionEnd
					source.assertError(allIssues, "A 'data access' in a 'feature group' is not a valid feature group connection end.")
					//Tests typeCheckFeatureGroupConnectionEnd
					destination.assertNoIssues(allIssues)
				]
				ownedFeatureGroupConnections.get(47) => [
					...
					//Tests typeCheckFeatureGroupConnectionEnd
					source.assertError(allIssues, "An 'event port' in a 'feature group' is not a valid feature group connection end.")
					//Tests typeCheckFeatureGroupConnectionEnd
					destination.assertNoIssues(allIssues)
				]
				ownedFeatureGroupConnections.get(48) => [
					...
					//Tests typeCheckFeatureGroupConnectionEnd
					source.assertError(allIssues, "A 'data port' in a 'feature group' is not a valid feature group connection end.")
					//Tests typeCheckFeatureGroupConnectionEnd
					destination.assertNoIssues(allIssues)
				]
				ownedFeatureGroupConnections.get(49) => [
					...
					//Tests typeCheckFeatureGroupConnectionEnd
					source.assertError(allIssues, "An 'event data port' in a 'feature group' is not a valid feature group connection end.")
					//Tests typeCheckFeatureGroupConnectionEnd
					destination.assertNoIssues(allIssues)
				]
				ownedFeatureGroupConnections.get(50) => [
					...
					//Tests typeCheckFeatureGroupConnectionEnd
					source.assertError(allIssues, "A 'bus subcomponent' in an 'abstract subcomponent' is not a valid feature group connection end.")
					//Tests typeCheckFeatureGroupConnectionEnd
					destination.assertNoIssues(allIssues)
				]
				ownedFeatureGroupConnections.get(51) => [
					...
					//Tests typeCheckFeatureGroupConnectionEnd
					source.assertError(allIssues, "A 'data subcomponent' in an 'abstract subcomponent' is not a valid feature group connection end.")
					//Tests typeCheckFeatureGroupConnectionEnd
					destination.assertNoIssues(allIssues)
				]
				ownedFeatureGroupConnections.get(52) => [
					...
					//Tests typeCheckFeatureGroupConnectionEnd
					source.assertError(allIssues, "A 'subprogram group subcomponent' in an 'abstract subcomponent' is not a valid feature group connection end.")
					//Tests typeCheckFeatureGroupConnectionEnd
					destination.assertNoIssues(allIssues)
				]
				ownedFeatureGroupConnections.get(53) => [
					...
					//Tests typeCheckFeatureGroupConnectionEnd
					source.assertError(allIssues, "A 'subprogram subcomponent' in an 'abstract subcomponent' is not a valid feature group connection end.")
					//Tests typeCheckFeatureGroupConnectionEnd
					destination.assertNoIssues(allIssues)
				]
				ownedFeatureGroupConnections.get(54) => [
					...
					//Tests typeCheckFeatureGroupConnectionEnd
					source.assertError(allIssues, "A 'subprogram proxy' in an 'abstract subcomponent' is not a valid feature group connection end.")
					//Tests typeCheckFeatureGroupConnectionEnd
					destination.assertNoIssues(allIssues)
				]
				ownedFeatureGroupConnections.get(55) => [
					...
					//Tests typeCheckFeatureGroupConnectionEnd
					source.assertError(allIssues, "A 'port proxy' in an 'abstract subcomponent' is not a valid feature group connection end.")
					//Tests typeCheckFeatureGroupConnectionEnd
					destination.assertNoIssues(allIssues)
				]
				ownedFeatureGroupConnections.get(56) => [
					...
					//Tests typeCheckFeatureGroupConnectionEnd
					source.assertError(allIssues, "An 'event data source' in an 'abstract subcomponent' is not a valid feature group connection end.")
					//Tests typeCheckFeatureGroupConnectionEnd
					destination.assertNoIssues(allIssues)
				]
				ownedFeatureGroupConnections.get(57) => [
					...
					//Tests typeCheckFeatureGroupConnectionEnd
					source.assertError(allIssues, "An 'abstract feature' in an 'abstract subcomponent' is not a valid feature group connection end.")
					//Tests typeCheckFeatureGroupConnectionEnd
					destination.assertNoIssues(allIssues)
				]
				ownedFeatureGroupConnections.get(58) => [
					"fgconn59".assertEquals(name)
					//Tests typeCheckFeatureGroupConnectionEnd
					source.assertNoIssues(allIssues)
					//Tests typeCheckFeatureGroupConnectionEnd
					destination.assertNoIssues(allIssues)
				...
				ownedFeatureGroupConnections.get(59) => [
					...
					//Tests typeCheckFeatureGroupConnectionEnd
					source.assertError(allIssues, "A 'parameter' in a 'subprogram subcomponent' is not a valid feature group connection end.")
					//Tests typeCheckFeatureGroupConnectionEnd
					destination.assertNoIssues(allIssues)
				]
				ownedFeatureGroupConnections.get(60) => [
					...
					//Tests typeCheckFeatureGroupConnectionEnd
					source.assertError(allIssues, "A 'bus access' in an 'abstract subcomponent' is not a valid feature group connection end.")
					//Tests typeCheckFeatureGroupConnectionEnd
					destination.assertNoIssues(allIssues)
				]
				ownedFeatureGroupConnections.get(61) => [
					...
					//Tests typeCheckFeatureGroupConnectionEnd
					source.assertError(allIssues, "A 'data access' in an 'abstract subcomponent' is not a valid feature group connection end.")
					//Tests typeCheckFeatureGroupConnectionEnd
					destination.assertNoIssues(allIssues)
				]
				ownedFeatureGroupConnections.get(62) => [
					...
					//Tests typeCheckFeatureGroupConnectionEnd
					source.assertError(allIssues, "An 'event port' in an 'abstract subcomponent' is not a valid feature group connection end.")
					//Tests typeCheckFeatureGroupConnectionEnd
					destination.assertNoIssues(allIssues)
				]
				ownedFeatureGroupConnections.get(63) => [
					...
					//Tests typeCheckFeatureGroupConnectionEnd
					source.assertError(allIssues, "A 'data port' in an 'abstract subcomponent' is not a valid feature group connection end.")
					//Tests typeCheckFeatureGroupConnectionEnd
					destination.assertNoIssues(allIssues)
				]
				ownedFeatureGroupConnections.get(64) => [
					...
					//Tests typeCheckFeatureGroupConnectionEnd
					source.assertError(allIssues, "An 'event data port' in an 'abstract subcomponent' is not a valid feature group connection end.")
					//Tests typeCheckFeatureGroupConnectionEnd
					destination.assertNoIssues(allIssues)
				]
				ownedFeatureGroupConnections.get(65) => [
					...
					//Tests typeCheckFeatureGroupConnectionEnd
					source.assertError(allIssues, "Anything in a 'subprogram call' is not a valid feature group connection end.")
					//Tests typeCheckFeatureGroupConnectionEnd
					destination.assertNoIssues(allIssues)
				]
				...
				ownedParameterConnections.get(0) => [
					...
					source.assertError(allIssues, "A 'bus subcomponent' is not a valid parameter connection end.")
					//Tests typeCheckParameterConnectionEnd
					destination.assertNoIssues(allIssues)
				]
				ownedParameterConnections.get(1) => [
					"paramconn2".assertEquals(name)
					//Tests typeCheckParameterConnectionEnd
					source.assertNoIssues(allIssues)
					//Tests typeCheckParameterConnectionEnd
					destination.assertNoIssues(allIssues)
				...
				ownedParameterConnections.get(2) => [
					...
					//Tests typeCheckParameterConnectionEnd
					source.assertError(allIssues, "A 'subprogram group subcomponent' is not a valid parameter connection end.")
					//Tests typeCheckParameterConnectionEnd
					destination.assertNoIssues(allIssues)
				]
				ownedParameterConnections.get(3) => [
					...
					//Tests typeCheckParameterConnectionEnd
					source.assertError(allIssues, "A 'subprogram subcomponent' is not a valid parameter connection end.")
					//Tests typeCheckParameterConnectionEnd
					destination.assertNoIssues(allIssues)
				]
				ownedParameterConnections.get(4) => [
					...
					//Tests typeCheckParameterConnectionEnd
					source.assertError(allIssues, "A 'subprogram proxy' is not a valid parameter connection end.")
					//Tests typeCheckParameterConnectionEnd
					destination.assertNoIssues(allIssues)
				]
				ownedParameterConnections.get(5) => [
					...
					//Tests typeCheckParameterConnectionEnd
					source.assertError(allIssues, "A 'port proxy' is not a valid parameter connection end.")
					//Tests typeCheckParameterConnectionEnd
					destination.assertNoIssues(allIssues)
				]
				ownedParameterConnections.get(6) => [
					...
					//Tests typeCheckParameterConnectionEnd
					source.assertError(allIssues, "An 'event data source' is not a valid parameter connection end.")
					//Tests typeCheckParameterConnectionEnd
					destination.assertNoIssues(allIssues)
				]
				ownedParameterConnections.get(7) => [
					...
					//Tests typeCheckParameterConnectionEnd
					source.assertError(allIssues, "An 'abstract feature' is not a valid parameter connection end.")
					//Tests typeCheckParameterConnectionEnd
					destination.assertNoIssues(allIssues)
				]
				ownedParameterConnections.get(8) => [
					...
					//Tests typeCheckParameterConnectionEnd
					source.assertError(allIssues, "A 'feature group' is not a valid parameter connection end.")
					//Tests typeCheckParameterConnectionEnd
					destination.assertNoIssues(allIssues)
				]
				ownedParameterConnections.get(9) => [
					...
					//Tests typeCheckParameterConnectionEnd
					source.assertError(allIssues, "A 'bus access' is not a valid parameter connection end.")
					//Tests typeCheckParameterConnectionEnd
					destination.assertNoIssues(allIssues)
				]
				ownedParameterConnections.get(10) => [
					"paramconn11".assertEquals(name)
					//Tests typeCheckParameterConnectionEnd
					source.assertNoIssues(allIssues)
					//Tests typeCheckParameterConnectionEnd
					destination.assertNoIssues(allIssues)
				...
				ownedParameterConnections.get(11) => [
					...
					//Tests typeCheckParameterConnectionEnd
					source.assertError(allIssues, "An 'event port' is not a valid parameter connection end.")
					//Tests typeCheckParameterConnectionEnd
					destination.assertNoIssues(allIssues)
				]
				ownedParameterConnections.get(12) => [
					"paramconn13".assertEquals(name)
					//Tests typeCheckParameterConnectionEnd
					source.assertNoIssues(allIssues)
					//Tests typeCheckParameterConnectionEnd
					destination.assertNoIssues(allIssues)
				...
				ownedParameterConnections.get(14) => [
					...
					//Tests typeCheckParameterConnectionEnd
					source.assertError(allIssues, "A 'bus subcomponent' in a 'data port' is not a valid parameter connection end.")
					//Tests typeCheckParameterConnectionEnd
					destination.assertNoIssues(allIssues)
				]
				ownedParameterConnections.get(15) => [
					"paramconn16".assertEquals(name)
					//Tests typeCheckParameterConnectionEnd
					source.assertNoIssues(allIssues)
					//Tests typeCheckParameterConnectionEnd
					destination.assertNoIssues(allIssues)
				...
				ownedParameterConnections.get(16) => [
					...
					//Tests typeCheckParameterConnectionEnd
					source.assertError(allIssues, "A 'subprogram group subcomponent' in a 'data port' is not a valid parameter connection end.")
					//Tests typeCheckParameterConnectionEnd
					destination.assertNoIssues(allIssues)
				]
				ownedParameterConnections.get(17) => [
					...
					//Tests typeCheckParameterConnectionEnd
					source.assertError(allIssues, "A 'subprogram subcomponent' in a 'data port' is not a valid parameter connection end.")
					//Tests typeCheckParameterConnectionEnd
					destination.assertNoIssues(allIssues)
				]
				ownedParameterConnections.get(18) => [
					...
					//Tests typeCheckParameterConnectionEnd
					source.assertError(allIssues, "A 'subprogram proxy' in a 'data port' is not a valid parameter connection end.")
					//Tests typeCheckParameterConnectionEnd
					destination.assertNoIssues(allIssues)
				]
				ownedParameterConnections.get(19) => [
					...
					//Tests typeCheckParameterConnectionEnd
					source.assertError(allIssues, "A 'port proxy' in a 'data port' is not a valid parameter connection end.")
					//Tests typeCheckParameterConnectionEnd
					destination.assertNoIssues(allIssues)
				]
				ownedParameterConnections.get(20) => [
					...
					//Tests typeCheckParameterConnectionEnd
					source.assertError(allIssues, "An 'event data source' in a 'data port' is not a valid parameter connection end.")
					//Tests typeCheckParameterConnectionEnd
					destination.assertNoIssues(allIssues)
				]
				ownedParameterConnections.get(21) => [
					...
					//Tests typeCheckParameterConnectionEnd
					source.assertError(allIssues, "An 'abstract feature' in a 'data port' is not a valid parameter connection end.")
					//Tests typeCheckParameterConnectionEnd
					destination.assertNoIssues(allIssues)
				]
				ownedParameterConnections.get(22) => [
					...
					//Tests typeCheckParameterConnectionEnd
					source.assertError(allIssues, "A 'feature group' in a 'data port' is not a valid parameter connection end.")
					//Tests typeCheckParameterConnectionEnd
					destination.assertNoIssues(allIssues)
				]
				ownedParameterConnections.get(23) => [
					...
					//Tests typeCheckParameterConnectionEnd
					source.assertError(allIssues, "A 'bus access' in a 'data port' is not a valid parameter connection end.")
					//Tests typeCheckParameterConnectionEnd
					destination.assertNoIssues(allIssues)
				]
				ownedParameterConnections.get(24) => [
					...
					//Tests typeCheckParameterConnectionEnd
					source.assertError(allIssues, "A 'data access' in a 'data port' is not a valid parameter connection end.")
					//Tests typeCheckParameterConnectionEnd
					destination.assertNoIssues(allIssues)
				]
				ownedParameterConnections.get(25) => [
					...
					//Tests typeCheckParameterConnectionEnd
					source.assertError(allIssues, "An 'event port' in a 'data port' is not a valid parameter connection end.")
					//Tests typeCheckParameterConnectionEnd
					destination.assertNoIssues(allIssues)
				]
				ownedParameterConnections.get(26) => [
					...
					//Tests typeCheckParameterConnectionEnd
					source.assertError(allIssues, "A 'data port' in a 'data port' is not a valid parameter connection end.")
					//Tests typeCheckParameterConnectionEnd
					destination.assertNoIssues(allIssues)
				]
				ownedParameterConnections.get(27) => [
					...
					//Tests typeCheckParameterConnectionEnd
					source.assertError(allIssues, "An 'event data port' in a 'data port' is not a valid parameter connection end.")
					//Tests typeCheckParameterConnectionEnd
					destination.assertNoIssues(allIssues)
				]
				ownedParameterConnections.get(28) => [
					...
					//Tests typeCheckParameterConnectionEnd
					source.assertError(allIssues, "A 'bus subcomponent' in an 'event data port' is not a valid parameter connection end.")
					//Tests typeCheckParameterConnectionEnd
					destination.assertNoIssues(allIssues)
				]
				ownedParameterConnections.get(29) => [
					"paramconn30".assertEquals(name)
					//Tests typeCheckParameterConnectionEnd
					source.assertNoIssues(allIssues)
					//Tests typeCheckParameterConnectionEnd
					destination.assertNoIssues(allIssues)
				...
				ownedParameterConnections.get(30) => [
					...
					//Tests typeCheckParameterConnectionEnd
					source.assertError(allIssues, "A 'subprogram group subcomponent' in an 'event data port' is not a valid parameter connection end.")
					//Tests typeCheckParameterConnectionEnd
					destination.assertNoIssues(allIssues)
				]
				ownedParameterConnections.get(31) => [
					...
					//Tests typeCheckParameterConnectionEnd
					source.assertError(allIssues, "A 'subprogram subcomponent' in an 'event data port' is not a valid parameter connection end.")
					//Tests typeCheckParameterConnectionEnd
					destination.assertNoIssues(allIssues)
				]
				ownedParameterConnections.get(32) => [
					...
					//Tests typeCheckParameterConnectionEnd
					source.assertError(allIssues, "A 'subprogram proxy' in an 'event data port' is not a valid parameter connection end.")
					//Tests typeCheckParameterConnectionEnd
					destination.assertNoIssues(allIssues)
				]
				ownedParameterConnections.get(33) => [
					...
					//Tests typeCheckParameterConnectionEnd
					source.assertError(allIssues, "A 'port proxy' in an 'event data port' is not a valid parameter connection end.")
					//Tests typeCheckParameterConnectionEnd
					destination.assertNoIssues(allIssues)
				]
				ownedParameterConnections.get(34) => [
					...
					//Tests typeCheckParameterConnectionEnd
					source.assertError(allIssues, "An 'event data source' in an 'event data port' is not a valid parameter connection end.")
					//Tests typeCheckParameterConnectionEnd
					destination.assertNoIssues(allIssues)
				]
				ownedParameterConnections.get(35) => [
					...
					//Tests typeCheckParameterConnectionEnd
					source.assertError(allIssues, "An 'abstract feature' in an 'event data port' is not a valid parameter connection end.")
					//Tests typeCheckParameterConnectionEnd
					destination.assertNoIssues(allIssues)
				]
				ownedParameterConnections.get(36) => [
					...
					//Tests typeCheckParameterConnectionEnd
					source.assertError(allIssues, "A 'feature group' in an 'event data port' is not a valid parameter connection end.")
					//Tests typeCheckParameterConnectionEnd
					destination.assertNoIssues(allIssues)
				]
				ownedParameterConnections.get(37) => [
					...
					//Tests typeCheckParameterConnectionEnd
					source.assertError(allIssues, "A 'bus access' in an 'event data port' is not a valid parameter connection end.")
					//Tests typeCheckParameterConnectionEnd
					destination.assertNoIssues(allIssues)
				]
				ownedParameterConnections.get(38) => [
					...
					//Tests typeCheckParameterConnectionEnd
					source.assertError(allIssues, "A 'data access' in an 'event data port' is not a valid parameter connection end.")
					//Tests typeCheckParameterConnectionEnd
					destination.assertNoIssues(allIssues)
				]
				ownedParameterConnections.get(39) => [
					...
					//Tests typeCheckParameterConnectionEnd
					source.assertError(allIssues, "An 'event port' in an 'event data port' is not a valid parameter connection end.")
					//Tests typeCheckParameterConnectionEnd
					destination.assertNoIssues(allIssues)
				]
				ownedParameterConnections.get(40) => [
					...
					//Tests typeCheckParameterConnectionEnd
					source.assertError(allIssues, "A 'data port' in an 'event data port' is not a valid parameter connection end.")
					//Tests typeCheckParameterConnectionEnd
					destination.assertNoIssues(allIssues)
				]
				ownedParameterConnections.get(41) => [
					...
					//Tests typeCheckParameterConnectionEnd
					source.assertError(allIssues, "An 'event data port' in an 'event data port' is not a valid parameter connection end.")
					//Tests typeCheckParameterConnectionEnd
					destination.assertNoIssues(allIssues)
				]
				ownedParameterConnections.get(42) => [
					...
					//Tests typeCheckParameterConnectionEnd
					source.assertError(allIssues, "An 'abstract feature' in a 'feature group' is not a valid parameter connection end.")
					//Tests typeCheckParameterConnectionEnd
					destination.assertNoIssues(allIssues)
				]
				ownedParameterConnections.get(43) => [
					...
					//Tests typeCheckParameterConnectionEnd
					source.assertError(allIssues, "A 'feature group' in a 'feature group' is not a valid parameter connection end.")
					//Tests typeCheckParameterConnectionEnd
					destination.assertNoIssues(allIssues)
				]
				ownedParameterConnections.get(44) => [
					"paramconn45".assertEquals(name)
					//Tests typeCheckParameterConnectionEnd
					source.assertNoIssues(allIssues)
					//Tests typeCheckParameterConnectionEnd
					destination.assertNoIssues(allIssues)
				...
				ownedParameterConnections.get(45) => [
					...
					//Tests typeCheckParameterConnectionEnd
					source.assertError(allIssues, "A 'bus access' in a 'feature group' is not a valid parameter connection end.")
					//Tests typeCheckParameterConnectionEnd
					destination.assertNoIssues(allIssues)
				]
				ownedParameterConnections.get(46) => [
					"paramconn47".assertEquals(name)
					//Tests typeCheckParameterConnectionEnd
					source.assertNoIssues(allIssues)
					//Tests typeCheckParameterConnectionEnd
					destination.assertNoIssues(allIssues)
				...
				ownedParameterConnections.get(47) => [
					...
					//Tests typeCheckParameterConnectionEnd
					source.assertError(allIssues, "An 'event port' in a 'feature group' is not a valid parameter connection end.")
					//Tests typeCheckParameterConnectionEnd
					destination.assertNoIssues(allIssues)
				]
				ownedParameterConnections.get(48) => [
					"paramconn49".assertEquals(name)
					//Tests typeCheckParameterConnectionEnd
					source.assertNoIssues(allIssues)
					//Tests typeCheckParameterConnectionEnd
					destination.assertNoIssues(allIssues)
				]
				ownedParameterConnections.get(49) => [
					"paramconn50".assertEquals(name)
					//Tests typeCheckParameterConnectionEnd
					source.assertNoIssues(allIssues)
					//Tests typeCheckParameterConnectionEnd
					destination.assertNoIssues(allIssues)
				...
				ownedParameterConnections.get(50) => [
					...
					//Tests typeCheckParameterConnectionEnd
					source.assertError(allIssues, "Anything in an 'abstract subcomponent' is not a valid parameter connection end.")
					//Tests typeCheckParameterConnectionEnd
					destination.assertNoIssues(allIssues)
				]
				...
				ownedParameterConnections.get(59) => [
					...
					//Tests typeCheckParameterConnectionEnd
					source.assertError(allIssues, "Anything in a 'subprogram subcomponent' is not a valid parameter connection end.")
					//Tests typeCheckParameterConnectionEnd
					destination.assertNoIssues(allIssues)
				]
				...
				ownedParameterConnections.get(65) => [
					...
					//Tests typeCheckParameterConnectionEnd
					source.assertError(allIssues, "A 'data subcomponent' in a 'subprogram call' is not a valid parameter connection end.")
					//Tests typeCheckParameterConnectionEnd
					destination.assertNoIssues(allIssues)
				]
				ownedParameterConnections.get(66) => [
					...
					//Tests typeCheckParameterConnectionEnd
					source.assertError(allIssues, "A 'subprogram subcomponent' in a 'subprogram call' is not a valid parameter connection end.")
					//Tests typeCheckParameterConnectionEnd
					destination.assertNoIssues(allIssues)
				]
				ownedParameterConnections.get(67) => [
					...
					//Tests typeCheckParameterConnectionEnd
					source.assertError(allIssues, "A 'subprogram proxy' in a 'subprogram call' is not a valid parameter connection end.")
					//Tests typeCheckParameterConnectionEnd
					destination.assertNoIssues(allIssues)
				]
				ownedParameterConnections.get(68) => [
					...
					//Tests typeCheckParameterConnectionEnd
					source.assertError(allIssues, "A 'port proxy' in a 'subprogram call' is not a valid parameter connection end.")
					//Tests typeCheckParameterConnectionEnd
					destination.assertNoIssues(allIssues)
				]
				ownedParameterConnections.get(69) => [
					...
					//Tests typeCheckParameterConnectionEnd
					source.assertError(allIssues, "An 'event data source' in a 'subprogram call' is not a valid parameter connection end.")
					//Tests typeCheckParameterConnectionEnd
					destination.assertNoIssues(allIssues)
				]
				ownedParameterConnections.get(70) => [
					...
					//Tests typeCheckParameterConnectionEnd
					source.assertError(allIssues, "An 'abstract feature' in a 'subprogram call' is not a valid parameter connection end.")
					//Tests typeCheckParameterConnectionEnd
					destination.assertNoIssues(allIssues)
				]
				ownedParameterConnections.get(71) => [
					...
					//Tests typeCheckParameterConnectionEnd
					source.assertError(allIssues, "A 'feature group' in a 'subprogram call' is not a valid parameter connection end.")
					//Tests typeCheckParameterConnectionEnd
					destination.assertNoIssues(allIssues)
				]
				ownedParameterConnections.get(72) => [
					"paramconn73".assertEquals(name)
					//Tests typeCheckParameterConnectionEnd
					source.assertNoIssues(allIssues)
					//Tests typeCheckParameterConnectionEnd
					destination.assertNoIssues(allIssues)
				...
				ownedParameterConnections.get(73) => [
					...
					//Tests typeCheckParameterConnectionEnd
					source.assertError(allIssues, "A 'subprogram access' in a 'subprogram call' is not a valid parameter connection end.")
					//Tests typeCheckParameterConnectionEnd
					destination.assertNoIssues(allIssues)
				]
				ownedParameterConnections.get(74) => [
					...
					//Tests typeCheckParameterConnectionEnd
					source.assertError(allIssues, "A 'data access' in a 'subprogram call' is not a valid parameter connection end.")
					//Tests typeCheckParameterConnectionEnd
					destination.assertNoIssues(allIssues)
				]
				ownedParameterConnections.get(75) => [
					...
					//Tests typeCheckParameterConnectionEnd
					source.assertError(allIssues, "An 'event port' in a 'subprogram call' is not a valid parameter connection end.")
					//Tests typeCheckParameterConnectionEnd
					destination.assertNoIssues(allIssues)
				]
				ownedParameterConnections.get(76) => [
					...
					//Tests typeCheckParameterConnectionEnd
					source.assertError(allIssues, "An 'event data port' in a 'subprogram call' is not a valid parameter connection end.")
					//Tests typeCheckParameterConnectionEnd
					destination.assertNoIssues(allIssues)
				]
				ownedPortConnections.get(0) => [
					...
					source.assertError(allIssues, "A 'bus subcomponent' is not a valid port connection end.")
					//Tests typeCheckPortConnectionEnd
					destination.assertNoIssues(allIssues)
				]
				...
				ownedPortConnections.get(2) => [
					...
					//Tests typeCheckPortConnectionEnd
					source.assertError(allIssues, "A 'subprogram group subcomponent' is not a valid port connection end.")
					//Tests typeCheckPortConnectionEnd
					destination.assertNoIssues(allIssues)
				]
				ownedPortConnections.get(3) => [
					...
					//Tests typeCheckPortConnectionEnd
					source.assertError(allIssues, "A 'subprogram subcomponent' is not a valid port connection end.")
					//Tests typeCheckPortConnectionEnd
					destination.assertNoIssues(allIssues)
				]
				ownedPortConnections.get(4) => [
					...
					//Tests typeCheckPortConnectionEnd
					source.assertError(allIssues, "A 'subprogram proxy' is not a valid port connection end.")
					//Tests typeCheckPortConnectionEnd
					destination.assertNoIssues(allIssues)
				]
				...
				ownedPortConnections.get(7) => [
					...
					//Tests typeCheckPortConnectionEnd
					source.assertError(allIssues, "An 'abstract feature' is not a valid port connection end.")
					//Tests typeCheckPortConnectionEnd
					destination.assertNoIssues(allIssues)
				]
				ownedPortConnections.get(8) => [
					...
					//Tests typeCheckPortConnectionEnd
					source.assertError(allIssues, "A 'feature group' is not a valid port connection end.")
					//Tests typeCheckPortConnectionEnd
					destination.assertNoIssues(allIssues)
				]
				ownedPortConnections.get(9) => [
					...
					//Tests typeCheckPortConnectionEnd
					source.assertError(allIssues, "A 'bus access' is not a valid port connection end.")
					//Tests typeCheckPortConnectionEnd
					destination.assertNoIssues(allIssues)
				]
				...
				ownedPortConnections.get(14) => [
					...
					//Tests typeCheckPortConnectionEnd
					source.assertError(allIssues, "A 'bus subcomponent' in a 'data port' is not a valid port connection end.")
					//Tests typeCheckPortConnectionEnd
					destination.assertNoIssues(allIssues)
				]
				...
				ownedPortConnections.get(16) => [
					...
					//Tests typeCheckPortConnectionEnd
					source.assertError(allIssues, "A 'subprogram group subcomponent' in a 'data port' is not a valid port connection end.")
					//Tests typeCheckPortConnectionEnd
					destination.assertNoIssues(allIssues)
				]
				ownedPortConnections.get(17) => [
					...
					//Tests typeCheckPortConnectionEnd
					source.assertError(allIssues, "A 'subprogram subcomponent' in a 'data port' is not a valid port connection end.")
					//Tests typeCheckPortConnectionEnd
					destination.assertNoIssues(allIssues)
				]
				ownedPortConnections.get(18) => [
					...
					//Tests typeCheckPortConnectionEnd
					source.assertError(allIssues, "A 'subprogram proxy' in a 'data port' is not a valid port connection end.")
					//Tests typeCheckPortConnectionEnd
					destination.assertNoIssues(allIssues)
				]
				ownedPortConnections.get(19) => [
					...
					//Tests typeCheckPortConnectionEnd
					source.assertError(allIssues, "A 'port proxy' in a 'data port' is not a valid port connection end.")
					//Tests typeCheckPortConnectionEnd
					destination.assertNoIssues(allIssues)
				]
				ownedPortConnections.get(20) => [
					...
					//Tests typeCheckPortConnectionEnd
					source.assertError(allIssues, "An 'event data source' in a 'data port' is not a valid port connection end.")
					//Tests typeCheckPortConnectionEnd
					destination.assertNoIssues(allIssues)
				]
				ownedPortConnections.get(21) => [
					...
					//Tests typeCheckPortConnectionEnd
					source.assertError(allIssues, "An 'abstract feature' in a 'data port' is not a valid port connection end.")
					//Tests typeCheckPortConnectionEnd
					destination.assertNoIssues(allIssues)
				]
				ownedPortConnections.get(22) => [
					...
					//Tests typeCheckPortConnectionEnd
					source.assertError(allIssues, "A 'feature group' in a 'data port' is not a valid port connection end.")
					//Tests typeCheckPortConnectionEnd
					destination.assertNoIssues(allIssues)
				]
				ownedPortConnections.get(23) => [
					...
					//Tests typeCheckPortConnectionEnd
					source.assertError(allIssues, "A 'bus access' in a 'data port' is not a valid port connection end.")
					//Tests typeCheckPortConnectionEnd
					destination.assertNoIssues(allIssues)
				]
				ownedPortConnections.get(24) => [
					...
					//Tests typeCheckPortConnectionEnd
					source.assertError(allIssues, "A 'data access' in a 'data port' is not a valid port connection end.")
					//Tests typeCheckPortConnectionEnd
					destination.assertNoIssues(allIssues)
				]
				ownedPortConnections.get(25) => [
					...
					//Tests typeCheckPortConnectionEnd
					source.assertError(allIssues, "An 'event port' in a 'data port' is not a valid port connection end.")
					//Tests typeCheckPortConnectionEnd
					destination.assertNoIssues(allIssues)
				]
				ownedPortConnections.get(26) => [
					...
					//Tests typeCheckPortConnectionEnd
					source.assertError(allIssues, "A 'data port' in a 'data port' is not a valid port connection end.")
					//Tests typeCheckPortConnectionEnd
					destination.assertNoIssues(allIssues)
				]
				ownedPortConnections.get(27) => [
					...
					//Tests typeCheckPortConnectionEnd
					source.assertError(allIssues, "An 'event data port' in a 'data port' is not a valid port connection end.")
					//Tests typeCheckPortConnectionEnd
					destination.assertNoIssues(allIssues)
				]
				ownedPortConnections.get(28) => [
					...
					//Tests typeCheckPortConnectionEnd
					source.assertError(allIssues, "A 'bus subcomponent' in an 'event data port' is not a valid port connection end.")
					//Tests typeCheckPortConnectionEnd
					destination.assertNoIssues(allIssues)
				]
				...
				ownedPortConnections.get(30) => [
					...
					//Tests typeCheckPortConnectionEnd
					source.assertError(allIssues, "A 'subprogram group subcomponent' in an 'event data port' is not a valid port connection end.")
					//Tests typeCheckPortConnectionEnd
					destination.assertNoIssues(allIssues)
				]
				ownedPortConnections.get(31) => [
					...
					//Tests typeCheckPortConnectionEnd
					source.assertError(allIssues, "A 'subprogram subcomponent' in an 'event data port' is not a valid port connection end.")
					//Tests typeCheckPortConnectionEnd
					destination.assertNoIssues(allIssues)
				]
				ownedPortConnections.get(32) => [
					...
					//Tests typeCheckPortConnectionEnd
					source.assertError(allIssues, "A 'subprogram proxy' in an 'event data port' is not a valid port connection end.")
					//Tests typeCheckPortConnectionEnd
					destination.assertNoIssues(allIssues)
				]
				ownedPortConnections.get(33) => [
					...
					//Tests typeCheckPortConnectionEnd
					source.assertError(allIssues, "A 'port proxy' in an 'event data port' is not a valid port connection end.")
					//Tests typeCheckPortConnectionEnd
					destination.assertNoIssues(allIssues)
				]
				ownedPortConnections.get(34) => [
					...
					//Tests typeCheckPortConnectionEnd
					source.assertError(allIssues, "An 'event data source' in an 'event data port' is not a valid port connection end.")
					//Tests typeCheckPortConnectionEnd
					destination.assertNoIssues(allIssues)
				]
				ownedPortConnections.get(35) => [
					...
					//Tests typeCheckPortConnectionEnd
					source.assertError(allIssues, "An 'abstract feature' in an 'event data port' is not a valid port connection end.")
					//Tests typeCheckPortConnectionEnd
					destination.assertNoIssues(allIssues)
				]
				ownedPortConnections.get(36) => [
					...
					//Tests typeCheckPortConnectionEnd
					source.assertError(allIssues, "A 'feature group' in an 'event data port' is not a valid port connection end.")
					//Tests typeCheckPortConnectionEnd
					destination.assertNoIssues(allIssues)
				]
				ownedPortConnections.get(37) => [
					...
					//Tests typeCheckPortConnectionEnd
					source.assertError(allIssues, "A 'bus access' in an 'event data port' is not a valid port connection end.")
					//Tests typeCheckPortConnectionEnd
					destination.assertNoIssues(allIssues)
				]
				ownedPortConnections.get(38) => [
					...
					//Tests typeCheckPortConnectionEnd
					source.assertError(allIssues, "A 'data access' in an 'event data port' is not a valid port connection end.")
					//Tests typeCheckPortConnectionEnd
					destination.assertNoIssues(allIssues)
				]
				ownedPortConnections.get(39) => [
					...
					//Tests typeCheckPortConnectionEnd
					source.assertError(allIssues, "An 'event port' in an 'event data port' is not a valid port connection end.")
					//Tests typeCheckPortConnectionEnd
					destination.assertNoIssues(allIssues)
				]
				ownedPortConnections.get(40) => [
					...
					//Tests typeCheckPortConnectionEnd
					source.assertError(allIssues, "A 'data port' in an 'event data port' is not a valid port connection end.")
					//Tests typeCheckPortConnectionEnd
					destination.assertNoIssues(allIssues)
				]
				ownedPortConnections.get(41) => [
					...
					//Tests typeCheckPortConnectionEnd
					source.assertError(allIssues, "An 'event data port' in an 'event data port' is not a valid port connection end.")
					//Tests typeCheckPortConnectionEnd
					destination.assertNoIssues(allIssues)
				]
				ownedPortConnections.get(42) => [
					...
					//Tests typeCheckPortConnectionEnd
					source.assertError(allIssues, "An 'abstract feature' in a 'feature group' is not a valid port connection end.")
					//Tests typeCheckPortConnectionEnd
					destination.assertNoIssues(allIssues)
				]
				ownedPortConnections.get(43) => [
					...
					//Tests typeCheckPortConnectionEnd
					source.assertError(allIssues, "A 'feature group' in a 'feature group' is not a valid port connection end.")
					//Tests typeCheckPortConnectionEnd
					destination.assertNoIssues(allIssues)
				]
				ownedPortConnections.get(44) => [
					...
					//Tests typeCheckPortConnectionEnd
					source.assertError(allIssues, "A 'parameter' in a 'feature group' is not a valid port connection end.")
					//Tests typeCheckPortConnectionEnd
					destination.assertNoIssues(allIssues)
				]
				ownedPortConnections.get(45) => [
					...
					//Tests typeCheckPortConnectionEnd
					source.assertError(allIssues, "A 'bus access' in a 'feature group' is not a valid port connection end.")
					//Tests typeCheckPortConnectionEnd
					destination.assertNoIssues(allIssues)
				]
				...
				ownedPortConnections.get(47) => [
					"portconn48".assertEquals(name)
					//Tests typeCheckPortConnectionEnd
					source.assertNoIssues(allIssues)
					//Tests typeCheckPortConnectionEnd
					destination.assertNoIssues(allIssues)
				...
				ownedPortConnections.get(50) => [
					...
					//Tests typeCheckPortConnectionEnd
					source.assertError(allIssues, "A 'bus subcomponent' in an 'abstract subcomponent' is not a valid port connection end.")
					//Tests typeCheckPortConnectionEnd
					destination.assertNoIssues(allIssues)
				]
				ownedPortConnections.get(51) => [
					...
					//Tests typeCheckPortConnectionEnd
					source.assertError(allIssues, "A 'data subcomponent' in an 'abstract subcomponent' is not a valid port connection end.")
					//Tests typeCheckPortConnectionEnd
					destination.assertNoIssues(allIssues)
				]
				ownedPortConnections.get(52) => [
					...
					//Tests typeCheckPortConnectionEnd
					source.assertError(allIssues, "A 'subprogram group subcomponent' in an 'abstract subcomponent' is not a valid port connection end.")
					//Tests typeCheckPortConnectionEnd
					destination.assertNoIssues(allIssues)
				]
				ownedPortConnections.get(53) => [
					...
					//Tests typeCheckPortConnectionEnd
					source.assertError(allIssues, "A 'subprogram subcomponent' in an 'abstract subcomponent' is not a valid port connection end.")
					//Tests typeCheckPortConnectionEnd
					destination.assertNoIssues(allIssues)
				]
				ownedPortConnections.get(54) => [
					...
					//Tests typeCheckPortConnectionEnd
					source.assertError(allIssues, "A 'subprogram proxy' in an 'abstract subcomponent' is not a valid port connection end.")
					//Tests typeCheckPortConnectionEnd
					destination.assertNoIssues(allIssues)
				]
				ownedPortConnections.get(55) => [
					...
					//Tests typeCheckPortConnectionEnd
					source.assertError(allIssues, "A 'port proxy' in an 'abstract subcomponent' is not a valid port connection end.")
					//Tests typeCheckPortConnectionEnd
					destination.assertNoIssues(allIssues)
				]
				ownedPortConnections.get(56) => [
					...
					//Tests typeCheckPortConnectionEnd
					source.assertError(allIssues, "An 'event data source' in an 'abstract subcomponent' is not a valid port connection end.")
					//Tests typeCheckPortConnectionEnd
					destination.assertNoIssues(allIssues)
				]
				ownedPortConnections.get(57) => [
					...
					//Tests typeCheckPortConnectionEnd
					source.assertError(allIssues, "An 'abstract feature' in an 'abstract subcomponent' is not a valid port connection end.")
					//Tests typeCheckPortConnectionEnd
					destination.assertNoIssues(allIssues)
				]
				ownedPortConnections.get(58) => [
					...
					//Tests typeCheckPortConnectionEnd
					source.assertError(allIssues, "A 'feature group' in an 'abstract subcomponent' is not a valid port connection end.")
					//Tests typeCheckPortConnectionEnd
					destination.assertNoIssues(allIssues)
				]
				ownedPortConnections.get(59) => [
					...
					//Tests typeCheckPortConnectionEnd
					source.assertError(allIssues, "A 'parameter' in a 'subprogram subcomponent' is not a valid port connection end.")
					//Tests typeCheckPortConnectionEnd
					destination.assertNoIssues(allIssues)
				]
				ownedPortConnections.get(60) => [
					...
					//Tests typeCheckPortConnectionEnd
					source.assertError(allIssues, "A 'bus access' in an 'abstract subcomponent' is not a valid port connection end.")
					//Tests typeCheckPortConnectionEnd
					destination.assertNoIssues(allIssues)
				]
				...
				ownedPortConnections.get(62) => [
					"portconn63".assertEquals(name)
					//Tests typeCheckPortConnectionEnd
					source.assertNoIssues(allIssues)
					//Tests typeCheckPortConnectionEnd
					destination.assertNoIssues(allIssues)
				...
				ownedPortConnections.get(65) => [
					...
					//Tests typeCheckPortConnectionEnd
					source.assertError(allIssues, "A 'bus subcomponent' in a 'data subcomponent' is not a valid port connection end.")
					//Tests typeCheckPortConnectionEnd
					destination.assertNoIssues(allIssues)
				]
				...
				ownedPortConnections.get(67) => [
					...
					//Tests typeCheckPortConnectionEnd
					source.assertError(allIssues, "A 'subprogram group subcomponent' in a 'data subcomponent' is not a valid port connection end.")
					//Tests typeCheckPortConnectionEnd
					destination.assertNoIssues(allIssues)
				]
				ownedPortConnections.get(68) => [
					...
					//Tests typeCheckPortConnectionEnd
					source.assertError(allIssues, "A 'subprogram subcomponent' in a 'data subcomponent' is not a valid port connection end.")
					//Tests typeCheckPortConnectionEnd
					destination.assertNoIssues(allIssues)
				]
				ownedPortConnections.get(69) => [
					...
					//Tests typeCheckPortConnectionEnd
					source.assertError(allIssues, "A 'subprogram proxy' in a 'data subcomponent' is not a valid port connection end.")
					//Tests typeCheckPortConnectionEnd
					destination.assertNoIssues(allIssues)
				]
				ownedPortConnections.get(70) => [
					...
					//Tests typeCheckPortConnectionEnd
					source.assertError(allIssues, "A 'port proxy' in a 'data subcomponent' is not a valid port connection end.")
					//Tests typeCheckPortConnectionEnd
					destination.assertNoIssues(allIssues)
				]
				ownedPortConnections.get(71) => [
					...
					//Tests typeCheckPortConnectionEnd
					source.assertError(allIssues, "An 'event data source' in a 'data subcomponent' is not a valid port connection end.")
					//Tests typeCheckPortConnectionEnd
					destination.assertNoIssues(allIssues)
				]
				ownedPortConnections.get(72) => [
					...
					//Tests typeCheckPortConnectionEnd
					source.assertError(allIssues, "An 'abstract feature' in a 'data subcomponent' is not a valid port connection end.")
					//Tests typeCheckPortConnectionEnd
					destination.assertNoIssues(allIssues)
				]
				ownedPortConnections.get(73) => [
					...
					//Tests typeCheckPortConnectionEnd
					source.assertError(allIssues, "A 'feature group' in a 'data subcomponent' is not a valid port connection end.")
					//Tests typeCheckPortConnectionEnd
					destination.assertNoIssues(allIssues)
				]
				ownedPortConnections.get(74) => [
					...
					//Tests typeCheckPortConnectionEnd
					source.assertError(allIssues, "A 'bus access' in a 'data subcomponent' is not a valid port connection end.")
					//Tests typeCheckPortConnectionEnd
					destination.assertNoIssues(allIssues)
				]
				...
				ownedPortConnections.get(76) => [
					"portconn77".assertEquals(name)
					//Tests typeCheckPortConnectionEnd
					source.assertNoIssues(allIssues)
					//Tests typeCheckPortConnectionEnd
					destination.assertNoIssues(allIssues)
				...
				ownedPortConnections.get(80) => [
					...
					//Tests typeCheckPortConnectionEnd
					source.assertError(allIssues, "A 'subprogram subcomponent' in a 'subprogram call' is not a valid port connection end.")
					//Tests typeCheckPortConnectionEnd
					destination.assertNoIssues(allIssues)
				]
				ownedPortConnections.get(81) => [
					...
					//Tests typeCheckPortConnectionEnd
					source.assertError(allIssues, "A 'subprogram proxy' in a 'subprogram call' is not a valid port connection end.")
					//Tests typeCheckPortConnectionEnd
					destination.assertNoIssues(allIssues)
				]
				ownedPortConnections.get(82) => [
					...
					//Tests typeCheckPortConnectionEnd
					source.assertError(allIssues, "A 'port proxy' in a 'subprogram call' is not a valid port connection end.")
					//Tests typeCheckPortConnectionEnd
					destination.assertNoIssues(allIssues)
				]
				ownedPortConnections.get(83) => [
					...
					//Tests typeCheckPortConnectionEnd
					source.assertError(allIssues, "An 'event data source' in a 'subprogram call' is not a valid port connection end.")
					//Tests typeCheckPortConnectionEnd
					destination.assertNoIssues(allIssues)
				]
				ownedPortConnections.get(84) => [
					...
					//Tests typeCheckPortConnectionEnd
					source.assertError(allIssues, "An 'abstract feature' in a 'subprogram call' is not a valid port connection end.")
					//Tests typeCheckPortConnectionEnd
					destination.assertNoIssues(allIssues)
				]
				ownedPortConnections.get(85) => [
					...
					//Tests typeCheckPortConnectionEnd
					source.assertError(allIssues, "A 'feature group' in a 'subprogram call' is not a valid port connection end.")
					//Tests typeCheckPortConnectionEnd
					destination.assertNoIssues(allIssues)
				]
				ownedPortConnections.get(86) => [
					...
					//Tests typeCheckPortConnectionEnd
					source.assertError(allIssues, "A 'parameter' in a 'subprogram call' is not a valid port connection end.")
					//Tests typeCheckPortConnectionEnd
					destination.assertNoIssues(allIssues)
				]
				ownedPortConnections.get(87) => [
					...
					//Tests typeCheckPortConnectionEnd
					source.assertError(allIssues, "A 'subprogram access' in a 'subprogram call' is not a valid port connection end.")
					//Tests typeCheckPortConnectionEnd
					destination.assertNoIssues(allIssues)
				]
				...
				ownedPortConnections.get(89) => [
					"portconn90".assertEquals(name)
					//Tests typeCheckPortConnectionEnd
					source.assertNoIssues(allIssues)
					//Tests typeCheckPortConnectionEnd
					destination.assertNoIssues(allIssues)
				]
				ownedPortConnections.get(90) => [
					"portconn91".assertEquals(name)
					//Tests typeCheckPortConnectionEnd
					source.assertNoIssues(allIssues)
					//Tests typeCheckPortConnectionEnd
					destination.assertNoIssues(allIssues)
			...
			publicSection.ownedClassifiers.get(3) as SubprogramImplementation => [
				...
				ownedAccessConnections.get(0) => [
					...
					//Tests typeCheckAccessConnectionEnd
					source.assertError(allIssues, "A 'parameter' is not a valid access connection end.")
					//Tests typeCheckAccessConnectionEnd
					destination.assertNoIssues(allIssues)
				]
				ownedAccessConnections.get(1) => [
					...
					//Tests typeCheckAccessConnectionEnd
					source.assertError(allIssues, "Anything in a 'parameter' is not a valid access connection end.")
					//Tests typeCheckAccessConnectionEnd
					destination.assertNoIssues(allIssues)
				]
				ownedAccessConnections.get(2) => [
				...
				ownedFeatureConnections.get(1) => [
					...
					//Tests typeCheckFeatureConnectionEnd
					source.assertError(allIssues, "Anything in a 'parameter' is not a valid feature connection end.")
					//Tests typeCheckFeatureConnectionEnd
					destination.assertNoIssues(allIssues)
				]
				ownedFeatureConnections.get(2) => [
				...
				ownedFeatureGroupConnections.get(0) => [
					...
					//Tests typeCheckFeatureGroupConnectionEnd
					source.assertError(allIssues, "A 'parameter' is not a valid feature group connection end.")
					//Tests typeCheckFeatureGroupConnectionEnd
					destination.assertNoIssues(allIssues)
				]
				ownedFeatureGroupConnections.get(1) => [
					...
					//Tests typeCheckFeatureGroupConnectionEnd
					source.assertError(allIssues, "Anything in a 'parameter' is not a valid feature group connection end.")
					//Tests typeCheckFeatureGroupConnectionEnd
					destination.assertNoIssues(allIssues)
				]
				ownedFeatureGroupConnections.get(2) => [
				...
				ownedParameterConnections.get(1) => [
					...
					//Tests typeCheckParameterConnectionEnd
					source.assertError(allIssues, "A 'bus subcomponent' in a 'parameter' is not a valid parameter connection end.")
					//Tests typeCheckParameterConnectionEnd
					destination.assertNoIssues(allIssues)
				]
				ownedParameterConnections.get(2) => [
					"paramconn80".assertEquals(name)
					//Tests typeCheckParameterConnectionEnd
					source.assertNoIssues(allIssues)
					//Tests typeCheckParameterConnectionEnd
					destination.assertNoIssues(allIssues)
				...
				ownedParameterConnections.get(3) => [
					...
					//Tests typeCheckParameterConnectionEnd
					source.assertError(allIssues, "A 'subprogram group subcomponent' in a 'parameter' is not a valid parameter connection end.")
					//Tests typeCheckParameterConnectionEnd
					destination.assertNoIssues(allIssues)
				]
				ownedParameterConnections.get(4) => [
					...
					//Tests typeCheckParameterConnectionEnd
					source.assertError(allIssues, "A 'subprogram subcomponent' in a 'parameter' is not a valid parameter connection end.")
					//Tests typeCheckParameterConnectionEnd
					destination.assertNoIssues(allIssues)
				]
				ownedParameterConnections.get(5) => [
					...
					//Tests typeCheckParameterConnectionEnd
					source.assertError(allIssues, "A 'subprogram proxy' in a 'parameter' is not a valid parameter connection end.")
					//Tests typeCheckParameterConnectionEnd
					destination.assertNoIssues(allIssues)
				]
				ownedParameterConnections.get(6) => [
					...
					//Tests typeCheckParameterConnectionEnd
					source.assertError(allIssues, "A 'port proxy' in a 'parameter' is not a valid parameter connection end.")
					//Tests typeCheckParameterConnectionEnd
					destination.assertNoIssues(allIssues)
				]
				ownedParameterConnections.get(7) => [
					...
					//Tests typeCheckParameterConnectionEnd
					source.assertError(allIssues, "An 'event data source' in a 'parameter' is not a valid parameter connection end.")
					//Tests typeCheckParameterConnectionEnd
					destination.assertNoIssues(allIssues)
				]
				ownedParameterConnections.get(8) => [
					...
					//Tests typeCheckParameterConnectionEnd
					source.assertError(allIssues, "An 'abstract feature' in a 'parameter' is not a valid parameter connection end.")
					//Tests typeCheckParameterConnectionEnd
					destination.assertNoIssues(allIssues)
				]
				ownedParameterConnections.get(9) => [
					...
					//Tests typeCheckParameterConnectionEnd
					source.assertError(allIssues, "A 'feature group' in a 'parameter' is not a valid parameter connection end.")
					//Tests typeCheckParameterConnectionEnd
					destination.assertNoIssues(allIssues)
				]
				ownedParameterConnections.get(10) => [
					...
					//Tests typeCheckParameterConnectionEnd
					source.assertError(allIssues, "A 'bus access' in a 'parameter' is not a valid parameter connection end.")
					//Tests typeCheckParameterConnectionEnd
					destination.assertNoIssues(allIssues)
				]
				ownedParameterConnections.get(11) => [
					...
					//Tests typeCheckParameterConnectionEnd
					source.assertError(allIssues, "A 'data access' in a 'parameter' is not a valid parameter connection end.")
					//Tests typeCheckParameterConnectionEnd
					destination.assertNoIssues(allIssues)
				]
				ownedParameterConnections.get(12) => [
					...
					//Tests typeCheckParameterConnectionEnd
					source.assertError(allIssues, "An 'event port' in a 'parameter' is not a valid parameter connection end.")
					//Tests typeCheckParameterConnectionEnd
					destination.assertNoIssues(allIssues)
				]
				ownedParameterConnections.get(13) => [
					...
					//Tests typeCheckParameterConnectionEnd
					source.assertError(allIssues, "A 'data port' in a 'parameter' is not a valid parameter connection end.")
					//Tests typeCheckParameterConnectionEnd
					destination.assertNoIssues(allIssues)
				]
				ownedParameterConnections.get(14) => [
					...
					//Tests typeCheckParameterConnectionEnd
					source.assertError(allIssues, "An 'event data port' in a 'parameter' is not a valid parameter connection end.")
					//Tests typeCheckParameterConnectionEnd
					destination.assertNoIssues(allIssues)
				]
				ownedPortConnections.get(0) => [
					...
					//Tests typeCheckPortConnectionEnd
					source.assertError(allIssues, "A 'parameter' is not a valid port connection end.")
					//Tests typeCheckPortConnectionEnd
					destination.assertNoIssues(allIssues)
				]
				ownedPortConnections.get(1) => [
					...
					//Tests typeCheckPortConnectionEnd
					source.assertError(allIssues, "Anything in a 'parameter' is not a valid port connection end.")
					//Tests typeCheckPortConnectionEnd
					destination.assertNoIssues(allIssues)
				]
				ownedPortConnections.get(2) => [
	...
	def private static assertNoIssues(EObject eObject, List<Issue> allIssues) {
		val issueMessagesForEObject = allIssues.filter[uriToProblem == eObject.URI].map[message]
		if (!issueMessagesForEObject.empty) {
			throw new ComparisonFailure("", "", issueMessagesForEObject.join("\n"))
		}
	}
	
	def private static assertError(EObject eObject, List<Issue> allIssues, String... expectedMessages) {
		val issueMessagesForEObject = allIssues.filter[severity == Severity::ERROR && uriToProblem == eObject.URI].map[message]
		if (issueMessagesForEObject.toSet != expectedMessages.toSet) {
			throw new ComparisonFailure("", expectedMessages.join("\n"), issueMessagesForEObject.join("\n"))
		}
	}
}