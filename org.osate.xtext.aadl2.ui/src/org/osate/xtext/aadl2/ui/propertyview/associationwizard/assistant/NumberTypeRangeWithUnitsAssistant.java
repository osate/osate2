...
public class NumberTypeRangeWithUnitsAssistant extends AbstractAssistant {
	...
	public NumberTypeRangeWithUnitsAssistant(Composite parent, NumberType numType, ISerializer serializer,
	...
	public String getValueText() {
		...
		valueText.append(' ');
		valueText.append(((UnitLiteral) ((IStructuredSelection) lowerUnitsViewer.getSelection()).getFirstElement())
				.getName());
		valueText.append(" .. ");
		valueText.append(upperField.getText());
		valueText.append(' ');
		valueText.append(((UnitLiteral) ((IStructuredSelection) upperUnitsViewer.getSelection()).getFirstElement())
				.getName());
		if (deltaField.getText().length() != 0) {
			valueText.append(" delta ");
			valueText.append(deltaField.getText());
			valueText.append(' ');
			valueText.append(((UnitLiteral) ((IStructuredSelection) deltaUnitsViewer.getSelection()).getFirstElement())
					.getName());
		}
