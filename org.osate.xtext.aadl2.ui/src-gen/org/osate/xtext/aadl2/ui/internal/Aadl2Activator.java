...
public class Aadl2Activator extends AbstractUIPlugin {
	...
	private static final Logger logger = Logger.getLogger(Aadl2Activator.class);
	...
	public static final String ORG_OSATE_XTEXT_AADL2_AADL2 = "org.osate.xtext.aadl2.Aadl2";
	...
	protected Module getRuntimeModule(String grammar) {
		if (ORG_OSATE_XTEXT_AADL2_AADL2.equals(grammar)) {
