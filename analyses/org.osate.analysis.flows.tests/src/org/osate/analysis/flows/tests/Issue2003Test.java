...
public class Issue2003Test extends XtextTest {
	private static final String FILE = "org.osate.analysis.flows.tests/models/latencytest/issue2003.aadl";

	@Inject
	TestHelper<AadlPackage> testHelper;

	@Test
	public void issue2003etef() throws Exception {
		...
		assertEquals(5.0, ((RealValue) etefResult.getValues().get(1)).getValue(), 0.0);
		assertEquals(36.0, ((RealValue) etefResult.getValues().get(2)).getValue(), 0.0);
		...
		assertEquals(100.0, ((RealValue) etefResult.getValues().get(6)).getValue(), 0.0);
