...
class BandwidthTest extends OsateTest {
	...
	def void testBandwidth() {
		val fileNames = #[
			"missing_reference_processor.aadl",
			"broadcast.aadl",
			"no_capacity_but_bound.aadl",
			"capacity.aadl",
			"capacity_and_bound.aadl",
			"modal.aadl",
			"connection_budget.aadl",
			"actual_only.aadl",
			"connection_not_active.aadl",
			"broadcast_with_connection.aadl",
			"source_not_feature.aadl"
		]
