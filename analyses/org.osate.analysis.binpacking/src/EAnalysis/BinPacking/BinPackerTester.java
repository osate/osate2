...
public class BinPackerTester {
	 ...
	 *            see
	 * @link{processorNumberIncrement} @param
	 *                                 maximumNumberOfProcessors The maximum
	 *                                 number of processors to stop incrementing
	 * @param minimumCyclesPerSecond
	 ...
	 *            End of range see
	 * @link{minimumNumberOfLinksPerProcessor} @param
	 *                                         minimumBitsPerSecond Start of
	 *                                         range of random variable of speed
	 *                                         of link
	 * @param maximumBitsPerSecond
	 *            End of range see
	 * @link{minimumBitsPerSecond} @param
	 *                             minimumNumberOfModules Starting number of
	 *                             modules to produce
	 * @param moduleNuberIncrement
	 *            Increment of series of module sets, see
	 * @link{processorNumberIncrement} @param
	 *                                 moduleNumberFactor Factor for geometric
	 *                                 series, see
	 * @link{processorNumberIncrement} @param
	 *                                 maximumNumberOfModules Maximum number of
	 *                                 modules allowed
...
//	}
	...
	public Vector createSiteBasedExperiment(int numberOfClones, int minimumNumberOfSites, int siteNumberIncrement,
		...
		for (int i = 0; i < netInterfaces.length; i++) {
			siteGuest.add(netInterfaces[i].link);
			interfaces.add(netInterfaces[i].link);
		}
	...
	public static void runPerfectFitExperiment(String args[]) {
		...
		supportedHardware[10] = netInterfaces[0].link;
		supportedHardware[11] = netInterfaces[1].link;
	...
	public static void runWorstFitExperiment(String args[]) {
		...
		supportedNets[0] = netInterfaces[0].link;
		supportedNets[1] = netInterfaces[1].link;
