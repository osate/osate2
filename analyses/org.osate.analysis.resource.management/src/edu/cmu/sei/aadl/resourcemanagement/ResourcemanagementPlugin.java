package edu.cmu.sei.aadl.resourcemanagement;
...
public class ResourcemanagementPlugin extends AbstractUIPlugin {
	...
	public ResourcemanagementPlugin() {
		...
		plugin = this;
		try {
			resourceBundle = ResourceBundle.getBundle("edu.cmu.sei.aadl.resourcemanagement.ResourcemanagementPluginResources");
