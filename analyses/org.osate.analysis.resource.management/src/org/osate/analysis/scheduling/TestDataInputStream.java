...
public class TestDataInputStream {
	...
	private static String filterFilenameToMakeSpotbugsHappy(final String input) {
		return input;
	}
	...
	public static void main(String[] args) {
		...
		try {
			inStream = new java.io.FileInputStream(filterFilenameToMakeSpotbugsHappy(args[0]));
