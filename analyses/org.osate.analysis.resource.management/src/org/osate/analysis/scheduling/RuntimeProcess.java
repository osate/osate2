 ...
 */
 public class RuntimeProcess  {
     ...
     public void setExecutionTime(int e) { executionTime = e; }
     public int  getExecutionTime() { return executionTime; }

     public void setPhaseOffset(int p) { phaseOffset= p; }
     public int  getPhaseOffset() { return phaseOffset; }

     public void setPriority(int p) { priority = p; }
     public int  getPriority() { return priority; }

     public void setSchedulability(boolean schedulable) { schedulableOrNot= schedulable; }
     public boolean  getSchedulability() { return schedulableOrNot; }

     public void setProcessorName(String proc){ processor = proc; }
	 public void setComponentName(String name) { componentName = name; }
     public void setARCName ( String id) { ARCName = id; }
	 public String getProcessorName() { return processor; }
     ...
     public void setMaxResponseTime(double time) { maxResponseTime=time; }
     public double getMaxResponseTime() { return maxResponseTime; }

     public void setSensitivity(double time) { sensitivity = time; }
	 ...
	 public void setAssociatedComponent(Object c) { associatedComponent = c; }
	 public Object getAssociatedComponent() { return associatedComponent; } 
