 ...
 * </p>
 * <ul>
 *   <li>{@link org.osate.analysis.resource.budgets.internal.models.power.impl.PowerSupplierImpl#getFeatureInstance <em>Feature Instance</em>}</li>
 * </ul>
 *
 * @generated
 * @since 4.1
 */
public class PowerSupplierImpl extends PowerElementImpl implements PowerSupplier {
	/**
	...
	protected EClass eStaticClass() {
		return PowerPackage.Literals.POWER_SUPPLIER;
	}
		...
		if (featureInstance != null && featureInstance.eIsProxy()) {
			...
			if (featureInstance != oldFeatureInstance) {
				if (eNotificationRequired()) {
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, PowerPackage.POWER_SUPPLIER__FEATURE_INSTANCE, oldFeatureInstance, featureInstance));
				}
			}
		}
	...
	public void setFeatureInstance(FeatureInstance newFeatureInstance) {
		...
		if (eNotificationRequired()) {
			eNotify(new ENotificationImpl(this, Notification.SET, PowerPackage.POWER_SUPPLIER__FEATURE_INSTANCE, oldFeatureInstance, featureInstance));
		}
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case PowerPackage.POWER_SUPPLIER__FEATURE_INSTANCE:
				if (resolve) {
