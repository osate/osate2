...
// driven task).
	...
	public enum LatencyContributorMethod {
		UNKNOWN, DEADLINE, RESPONSE_TIME, PROCESSING_TIME, DELAYED, SAMPLED, FIRST_PERIODIC, SPECIFIED, QUEUED, TRANSMISSION_TIME, PARTITION_FRAME, PARTITION_SCHEDULE, PARTITION_OUTPUT, SAMPLED_PROTOCOL
	};
