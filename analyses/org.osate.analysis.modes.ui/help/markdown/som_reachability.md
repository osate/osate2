...
The analysis can be invoked by selecting an instance model file in the AADL navigator. Right click, and select *Semantic Checks* > *Check SOM Reachability*. The analysis adds info markers to SOMs in the instance model that are not reachable.
