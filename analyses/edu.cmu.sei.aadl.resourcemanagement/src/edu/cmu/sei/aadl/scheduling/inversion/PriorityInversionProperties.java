...
public class PriorityInversionProperties
{
	...
	public PriorityInversionProperties(final Property period, final Property actualProcessorBinding,
			final UnitLiteral microSecond, final Property priority, final Property dispatchProtocol)
	{
		this.period = period;
	...
	public double getPeriod(final NamedElement ph, final double defaultValue)
	{
		return PropertyUtils.getScaledNumberValue(ph, period, microSecond, defaultValue);
	}
	...
	public long getPriority(final NamedElement ph, long defaultValue)
	{
