...
public enum FeatureDirectionType {
	/**
	 ...
	 * @generated
	 */
	private static final FeatureDirectionType[] VALUES_ARRAY = new FeatureDirectionType[] { IN, OUT, IN_OUT, };
	 ...
	 * @generated
	 */
	public static final List<FeatureDirectionType> VALUES = Collections.unmodifiableList(Arrays.asList(VALUES_ARRAY));
	 ...
	 * @generated
	 */
	public static FeatureDirectionType get(String literal) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			FeatureDirectionType result = VALUES_ARRAY[i];
	 ...
	 * @generated
	 */
	public static FeatureDirectionType getByName(String name) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			FeatureDirectionType result = VALUES_ARRAY[i];
	 ...
	 * @generated
	 */
	public static FeatureDirectionType get(int value) {
		switch (value) {
		case IN_VALUE:
			return IN;
		case OUT_VALUE:
	 ...
	 * @generated
	 */
	private FeatureDirectionType(int value, String name, String literal) {
		this.value = value;
		this.name = name;
