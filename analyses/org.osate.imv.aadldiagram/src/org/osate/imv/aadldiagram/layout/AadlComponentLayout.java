			...
			if (locationHint == null) {
				...
				if (f instanceof FeatureFigure) {
					...
					case SOUTH:
						...
						if (locationHint.x >= featureBounds.x && locationHint.x <= featureBounds.right() - w)
							x = locationHint.x;
						else if (locationHint.x > featureBounds.right() - w)
							x = featureBounds.right() - w;
						else if (locationHint.x < featureBounds.x)
							x = featureBounds.x;
					...
					case WEST:
						...
						if (locationHint.y >= featureBounds.y && locationHint.y <= featureBounds.bottom() - h)
							y = locationHint.y;
						else if (locationHint.y > featureBounds.bottom() - h)
							y = featureBounds.bottom() - h;
						else if (locationHint.y < featureBounds.y)
							y = featureBounds.y;
