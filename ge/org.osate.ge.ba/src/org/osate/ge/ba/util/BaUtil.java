...
public class BaUtil {
	...
	public static BehaviorAnnex getOrCreateBehaviorAnnex(final Classifier c) {
		return GraphicalAnnexUtil.getOrCreateParsedAnnexSubclause(c, ANNEX_NAME,
	...
	public static BehaviorAnnex getBehaviorAnnex(final Classifier c) {
		return GraphicalAnnexUtil.getFirstParsedAnnexSubclause(c, ANNEX_NAME,
				BehaviorAnnex.class).orElse(null);
	}
}
