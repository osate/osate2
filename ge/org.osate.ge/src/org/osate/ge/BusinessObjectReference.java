...
/**
 * Immutable abstract base data type for {@link RelativeBusinessObjectReference} and {@link CanonicalBusinessObjectReference}.
 * @since 3.0
 */
public abstract class BusinessObjectReference implements Comparable<BusinessObjectReference> {
	...
	private final ImmutableList<String> lcSegments; // Lowercase segments. Used for comparison.
	...
	public boolean equals(Object obj) {
		...
		final BusinessObjectReference other = (BusinessObjectReference) obj;
	...
	@Override
	public int compareTo(final BusinessObjectReference o) {
