...
public class RenameContext {
	 ...
	 * @param newName is the new name for the business object.
	 * @noreference This constructor is not intended to be referenced by clients.
	 */
	public RenameContext(final Object bo, final String newName) {
	...
	/**
	 * Returns the name to which the business object will be renamed.
	 * @return the new name for the business object
	 */
