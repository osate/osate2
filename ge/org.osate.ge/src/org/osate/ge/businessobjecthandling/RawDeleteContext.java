...
/**
 * Contains contextual information for performing a raw deletion of a business object.
 *
 * @since 2.0
 * @noextend This class is not intended to be subclassed by clients.
 */
public class RawDeleteContext {
	 ...
	 */
	public RawDeleteContext(final Object bo) {
		this.bo = Objects.requireNonNull(bo, "bo must not be null");
	}

	/**
	 * Retrieves a readonly business object for which is being deleted if it is an instance
	 * of the specified class. This object must not be modified.
	 * @param <T> is the requested type.
	 * @param boType is the class to which to cast the business object.
	 * @return an optional containing the business object being deleted. An empty optional if the business object is not
