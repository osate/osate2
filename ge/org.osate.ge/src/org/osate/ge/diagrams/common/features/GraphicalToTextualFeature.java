...
public class GraphicalToTextualFeature extends AbstractCustomFeature {
	...
	public boolean isAvailable(final IContext context) {
		...
		return bo instanceof EObject || bo instanceof ReferenceEObjectProvider;
	}
	...
	public void execute(ICustomContext context) 
	{
		...
		if(bo instanceof EObject) {
			boEObj = (EObject)bo;
		} else if(bo instanceof ReferenceEObjectProvider) {
			boEObj = ((ReferenceEObjectProvider) bo).getRefereneEObject();
		} else {
