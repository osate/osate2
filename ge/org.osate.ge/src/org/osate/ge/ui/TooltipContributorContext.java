...
public class TooltipContributorContext {
	...
	/**
	 * Composite to which to add widgets.
	 * @return the composite to which to add widgets.
	 */
	...
	/**
	 * Provides access to the business object context for which the tooltip contributor is being called.
