...
/**
 * Parallelogram graphic
 *
 */
public class Parallelogram implements AgeShape {
	/**
	 * The horizontal offset of the parallelogram. The width of the top and bottom lines will be width - {@link #horizontalOffset}. The top line
	 * is offset by this amount.
	 */
	public final int horizontalOffset;

	/**
	 * Creates a new instance with the specified horizontal offset
	 * @param horizontalOffset see {@link #horizontalOffset}
	 */
