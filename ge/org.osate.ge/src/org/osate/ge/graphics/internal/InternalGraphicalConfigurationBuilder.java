...
public class InternalGraphicalConfigurationBuilder extends GraphicalConfigurationBuilder {
	...
	/**
	 * Configures the builder to build an instance with the specified value for whether the primary label supported multiple lines
	 * @param value whether the primary label supported multiple lines
	 * @return this builder to allow method chaining.
	 * @see GraphicalConfiguration#isPrimaryLabelIsMultiline()
	 */
