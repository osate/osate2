...
public class AnnexNameDialog extends InputDialog {
	public AnnexNameDialog(final Shell parentShell, final NamedElement targetContainer, final String title,
		...
		super(parentShell, title, message,
				"",
				newName -> isValidAnnexName(newName) ? "The specified name is not valid." : null);
	 ...
	 * @return
	 */
	final static boolean isValidAnnexName(final String newAnnexName) {
		boolean invalid = false;
		if (!AadlNamingUtil.isValidIdentifier(newAnnexName)) {
			invalid = true;
		}
