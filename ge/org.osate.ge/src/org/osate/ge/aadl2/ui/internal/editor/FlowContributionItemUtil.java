...
public class FlowContributionItemUtil {
	...
	public static BusinessObjectContext findOrCreateBusinessObjectContext(
			...
			final DiagramElement container, final Element e) {
	 ...
	 */
	public static void findSegmentDiagramElements(final EndToEndFlow eTEFlow, final BusinessObjectContext eteFlowContainer,
	 ...
	 *
	 */
	private static class ChildlessBusinessObjectContext implements BusinessObjectContext {
