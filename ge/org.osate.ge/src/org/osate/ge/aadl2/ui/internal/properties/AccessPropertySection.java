...
public class AccessPropertySection extends AbstractPropertySection {
	...
	public void createControls(final Composite parent, final TabbedPropertySheetPage aTabbedPropertySheetPage) {
		...
		providesBtn = PropertySectionUtil.createButton(getWidgetFactory(), directionContainer,
				AccessType.PROVIDES,
				accessSelectionListener, "Provides", SWT.RADIO);
		requiresBtn = PropertySectionUtil.createButton(getWidgetFactory(), directionContainer,
				AccessType.REQUIRES,
