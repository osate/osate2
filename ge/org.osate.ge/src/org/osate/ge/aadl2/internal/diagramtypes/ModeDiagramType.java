...
public class ModeDiagramType implements DiagramType {
	private final ImmutableSet<String> defaultClassifierOrSubcomponentFilters = ImmutableSet
			.of(AadlContentFilterIds.MODES,
			AadlContentFilterIds.MODE_TRANSITIONS);
