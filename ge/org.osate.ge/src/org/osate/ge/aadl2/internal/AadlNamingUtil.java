...
/**
 * Class to help checking and generation of identifiers for AADL 2 model elements.
 *
 */
public class AadlNamingUtil {
	 ...
	 */
	public static String checkNameValidity(final NamedElement ne, final String name) {
