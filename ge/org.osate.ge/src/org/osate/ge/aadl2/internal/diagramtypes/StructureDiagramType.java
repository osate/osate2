...
public class StructureDiagramType implements DiagramType {
	...
	private final ImmutableSet<String> defaultClassifierFilters = ImmutableSet.of(AadlContentFilterIds.FEATURES,
			AadlContentFilterIds.INTERNAL_FEATURES, AadlContentFilterIds.PROCESSOR_FEATURES, AadlContentFilterIds.CONNECTIONS,
			AadlContentFilterIds.FLOW_SPECIFICATIONS, AadlContentFilterIds.SUBCOMPONENTS);
	private final ImmutableSet<String> defaultSubcomponentFilters = ImmutableSet.of(AadlContentFilterIds.FEATURES,
			AadlContentFilterIds.INTERNAL_FEATURES, AadlContentFilterIds.PROCESSOR_FEATURES, AadlContentFilterIds.CONNECTIONS,
			AadlContentFilterIds.FLOW_SPECIFICATIONS);
	private final ImmutableSet<String> defaultSubprogramCallSequenceFilters = ImmutableSet
			.of(AadlContentFilterIds.SUBPROGRAM_CALL_ORDERS, AadlContentFilterIds.SUBPROGRAM_CALLS);
	private final ImmutableSet<String> defaultSubprogramCallFilters = ImmutableSet.of(AadlContentFilterIds.FEATURES,
			AadlContentFilterIds.FLOW_SPECIFICATIONS);
