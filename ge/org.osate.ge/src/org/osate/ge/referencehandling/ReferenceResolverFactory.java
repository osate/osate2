...
public interface ReferenceResolverFactory {
	 ...
	 * @param ctx is the context for creating the resolver.
	 * @return the new reference resolver. Must not return null.
	 */
	ReferenceResolver create(CreateReferenceResolverFactoryContext ctx);
}
