...
/**
 * Context for creating reference resolvers.
 *
 * @noinstantiate This class is not intended to be instantiated by clients.
 * @noextend This class is not intended to be subclassed by clients.
 * @since 2.0
 */
public final class CreateReferenceResolverFactoryContext {
	 ...
	 */
	public CreateReferenceResolverFactoryContext(final IProject project) {
