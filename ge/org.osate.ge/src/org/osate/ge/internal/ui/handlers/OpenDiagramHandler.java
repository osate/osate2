...
public class OpenDiagramHandler extends AbstractHandler {
		...
		try {
			...
			if (contextBo == null) {
				MessageDialog.openError(PlatformUI.getWorkbench().getActiveWorkbenchWindow().getShell(),
						"Unable to Open Diagram", "Selection is not a valid diagram context.");
				return null;
			}
	...
	public void setEnabled(final Object evaluationContext) {
		...
		setBaseEnabled(SelectionUtil.isAadlOrInstanceModelFile(selection) || SelectionUtil
				.getDiagramContext(selection,
