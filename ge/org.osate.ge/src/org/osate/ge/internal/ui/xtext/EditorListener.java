...
/**
 * Listener used by {@link AgeXtextUtil} which notifies an {@link OpenAadlResources} when events occur.
 *
 */
class EditorListener implements IPartListener {
	 ...
	 * @param activePage the page for which the listener is being created. Notifications will be generates for parts which are already open.
	 * @param openAadlResources the {@link OpenAadlResources} instance to notify.
	 */
