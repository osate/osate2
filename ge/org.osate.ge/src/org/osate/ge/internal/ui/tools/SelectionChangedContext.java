...
/**
 * Context for notifying tools of a selection change
 *
 * @noinstantiate This class is not intended to be instantiated by clients.
 * @noextend This class is not intended to be subclassed by clients.
 */
public final class SelectionChangedContext {
	 ...
	 */
	public SelectionChangedContext(List<BusinessObjectContext> selectedBocs) {
