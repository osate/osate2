...
public class FlowContributionItemUtil {
	...
	static ComponentImplementation getComponentImplementation(final Object container) {
		if (container instanceof BusinessObjectContext) {
			return getComponentImplementation(((BusinessObjectContext) container).getBusinessObject());
			...
			final Subcomponent sc = (Subcomponent) AgeAadlUtil.getRootRefinedElement((NamedElement) container);
