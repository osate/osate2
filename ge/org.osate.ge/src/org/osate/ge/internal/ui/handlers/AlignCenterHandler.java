...
/**
 * Handler which aligns the horizontal centers of selected diagram elements
 */
public class AlignCenterHandler extends AbstractHandler {
	private final static AlignmentHelper alignmentHelper = AlignmentHelper.createHorizontal();
