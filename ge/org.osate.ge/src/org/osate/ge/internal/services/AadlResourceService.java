...
public interface AadlResourceService {
	/**
	 * Interface for a reference to a package. References should be held for as long as the package should be retained in memory.
	 *
	 */
	public interface AadlPackageReference {
		/**
		 * Returns the referenced package.
		 * @return the referenced package. Returns null, if the referenced package could not be retrieved.
		 */
	 ...
	 * @return the package reference object for the package
	 */
