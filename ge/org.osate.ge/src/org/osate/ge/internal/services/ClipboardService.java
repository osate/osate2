...
/**
 * Provides access to a clipboard. Whether the service is implemented using the system clipboard is undefined.
 *
 */
public interface ClipboardService {
	/**
	 * Interface for the clipboard. Allows getting and setting contents.
	 *
	 */
	interface Clipboard {
		/**
		 ...
		 * @param value the new contents for the clipboard
		 * @see #getContents()
		 */
