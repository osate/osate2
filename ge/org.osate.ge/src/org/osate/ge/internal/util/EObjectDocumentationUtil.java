...
/**
 * Contains utility functions for working with documentation provided by {@link IEObjectDocumentationProvider}.
 * AADLdoc is provided using that interface.
 *
 */
public class EObjectDocumentationUtil {
	...
	/**
	 * Returns the documentation for the specified business object
	 * @param bo the business object for which to retrieve the documentation.
	 * @return the documentation for the specified business object. Returns null if the business object does not have any documentation.
	 */
	public static String getPlainTextDocumentation(final Object bo) {
		...
		final IEObjectDocumentationProvider docProvider = getDocumentationProvider(bo);
		if (docProvider == null) {
			return null;
		}
	...
	/**
	 * Returns the documentation provider for the specified business object
	 * @param bo the business object for which to return the documentation provider.
	 * @return the documentation provider for the specified business object
	 */
