 ...
 * 
 * // Show the dialog
 * final SetInModeFeaturesDialog dlg = new SetInModeFeaturesDialog(Display.getCurrent().getActiveShell(), localModeFeatureNames,
 * localModeTransitionFeatureNames, childModeNames, localToChildModeMap);
 ...
 * final ModeFeature childMode = (childModes != null && localToChildModeMapEntry.getValue() != null) ? findModeByName(childModes,
 * localToChildModeMapEntry.getValue()) : null;
