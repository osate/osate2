...
class DiagramElementCollection extends AbstractCollection<DiagramElement> {
	 ...
	 * @param e the child diagram element to remove
	 * @return true if the diagram element was removed.
	 */
	...
	/**
	 * Returns the diagram element which has the specified relative business object reference
	 * @param ref the search relative reference
	 * @return the requested diagram element. Returns null if a child with the specified relative reference could not be found.
	 */
	...
	/**
	 * Appends a string representation of the collection to the specified string builder
