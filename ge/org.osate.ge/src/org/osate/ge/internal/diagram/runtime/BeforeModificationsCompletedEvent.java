...
/**
 * Event sent to {@link DiagramModificationListener} instances before the modification is completed.
 */
public final class BeforeModificationsCompletedEvent {
	/**
	 * Diagram the diagram which is being modified
	 */
	public final AgeDiagram diagram;

	/**
	 * Modification that is being completed
	 */
	public final DiagramModification mod;

	/**
	 * Creates a new instance
	 * @param diagram the value for the {@link #diagram} field
	 * @param mod the value for the {@link #mod} field
	 */
