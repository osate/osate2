...
/**
 * Event sent to {@link DiagramModificationListener} instances after a diagram element is added to the diagram
 */
public final class ElementAddedEvent {
	/**
	 * The diagram element which was added
	 */
