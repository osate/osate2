...
/**
 * Provides access to the arguments used to evaluate the condition for {@link PictogramQuery#ifElse(org.osate.ge.query.Supplier, org.osate.ge.query.Supplier, org.osate.ge.query.Supplier)}. 
 * @param <A> the type of the query argument
 * @noextend
 * @noimplement
 * @see PictogramQuery#ifElse(org.osate.ge.query.Supplier, org.osate.ge.query.Supplier, org.osate.ge.query.Supplier)
 */
