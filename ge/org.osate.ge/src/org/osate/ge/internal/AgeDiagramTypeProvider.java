...
import org.osate.ge.internal.services.impl.DefaultComponentImplementationService;
...
public class AgeDiagramTypeProvider extends AbstractDiagramTypeProvider {
	...
	private IEclipseContext createEclipseContext(final IFeatureProvider fp) {
		...
		serializableReferenceService = new DefaultSerializableReferenceService(extensionService, refBuilder);
