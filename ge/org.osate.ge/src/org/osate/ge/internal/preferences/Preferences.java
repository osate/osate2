...
/**
 * Contains constants for the names of preferences
 *
 */
public final class Preferences {
	...
	/**
	 * The name of the incremental layout mode preference
	 */
	public static final String INCREMENTAL_LAYOUT_MODE = "layout.incremental.mode";

	/**
	 * The name of the layout ports on default sides preference
	 */
