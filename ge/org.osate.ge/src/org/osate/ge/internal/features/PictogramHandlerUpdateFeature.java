...
public class PictogramHandlerUpdateFeature extends AbstractUpdateFeature implements ICustomUndoRedoFeature {
	...
	public PictogramHandlerUpdateFeature(final InternalReferenceBuilderService refBuilder, final BusinessObjectResolutionService bor, final ConnectionService connectionService,
			final PictogramHandlerRefreshHelper refreshHelper, final IFeatureProvider fp, final Object pictogramHandler) {
		super(fp);
