...
public class PictogramHandlerResizeShapeFeature extends DefaultResizeShapeFeature {
	private final BusinessObjectResolutionService bor;
	private final ExtensionService extService;
	private final Object handler;
	
	@Inject
	public PictogramHandlerResizeShapeFeature(final BusinessObjectResolutionService bor, final ExtensionService extService, final IFeatureProvider fp, final Object pictogramHandler) {
		super(fp);
				...
				if(bo != null) {
					...
					try {
						...
						if(gr instanceof org.osate.ge.internal.graphics.Polygon) {
							...
							PictogramHandlerRefreshHelper.createPolygon(shape, agePoly, width, height);
						}
					} finally {
						eclipseCtx.dispose();
					}
