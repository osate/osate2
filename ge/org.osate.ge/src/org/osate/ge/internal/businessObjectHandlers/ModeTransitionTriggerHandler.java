...
public class ModeTransitionTriggerHandler {
	...
	public DiagramElementQuery<ModeTransitionTrigger> createDestination(final @Named(Names.ROOT_QUERY) DiagramNodeQuery<ModeTransitionTrigger> rootQuery) {
	...
	@CreateParentQuery
	public DiagramElementQuery<ModeTransitionTrigger> createParentDiagramElementQuery(final @Named(Names.DESTINATION_ROOT_QUERY) DiagramNodeQuery<ModeTransitionTrigger> dstRootQuery) {
