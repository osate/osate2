 ...
 *   <tr><td>Business Object Handler ({@link org.osate.ge.PaletteEntryBuilder#connectionCreation()} entries only)</td><td>Returns whether the handler supports {@link Create} for the specified arguments. Unlike {@link CanCreate}, the destination business object is not specified.</td><td>boolean</td></tr>
 * </table>
 ...
 *   <tr><td>{@link org.osate.ge.di.Names#SOURCE_BO}</td><td>Business Object handler</td><td>The business object of the source of the connection.</td></tr>
 * </table>
 * @see CanCreate
 * @see Create
