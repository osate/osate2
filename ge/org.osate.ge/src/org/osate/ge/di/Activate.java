 ...
 *   <tr><td>{@link org.osate.ge.di.Names#BUSINESS_OBJECT}</td><td>Command</td><td>The business object for the currently selected diagram element. Only specified when a single diagram element is selected.</td></tr>
