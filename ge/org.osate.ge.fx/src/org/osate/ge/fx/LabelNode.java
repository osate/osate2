...
public class LabelNode extends Region implements HasBackgroundColor, HasFontColor, HasFontFont {
	...
	public static void main(final String[] args) {
		// Use the supplier variant because setting the text doesn't work unless JavaFX has been initialized.
		NodeApplication.run(() -> new Node[] { new LabelNode("This is a test. This is a really long label.") });
	}
}
