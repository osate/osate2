...
/** Registers the BA Xtext language before creating the AADL injector used by GE tests. */
public final class BehaviorAnnexGeInjectorProvider extends Aadl2InjectorProvider {
	@Override
