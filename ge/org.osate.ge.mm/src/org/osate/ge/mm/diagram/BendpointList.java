...
/**
 * <!-- begin-user-doc -->
 * A representation of the model object '<em><b>Bendpoint List</b></em>'.
 * <!-- end-user-doc -->
 *
 * <p>
 ...
 * @generated
 */
public class BendpointList extends MinimalEObjectImpl.Container implements EObject {
	/**
	...
	protected EClass eStaticClass() {
		return DiagramPackage.Literals.BENDPOINT_LIST;
	}
	...
	public EList<Point> getPoint() {
		if (point == null) {
			point = new EObjectContainmentEList<Point>(Point.class, this, DiagramPackage.BENDPOINT_LIST__POINT);
		}
		return point;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case DiagramPackage.BENDPOINT_LIST__POINT:
