 ...
 * </copyright>
 *
 * $Id: ProcessTypeImpl.java,v 1.19 2011-04-11 13:35:51 lwrage Exp $
 */
 ...
 *   <li>{@link org.osate.aadl2.impl.ProcessTypeImpl#getOwnedEventDataPorts <em>Owned Event Data Port</em>}</li>
 *   <li>{@link org.osate.aadl2.impl.ProcessTypeImpl#getOwnedEventPorts <em>Owned Event Port</em>}</li>
 *   <li>{@link org.osate.aadl2.impl.ProcessTypeImpl#getOwnedDataAccesses <em>Owned Data Access</em>}</li>
...
public class ProcessTypeImpl extends ComponentTypeImpl implements ProcessType {
			...
			if (ownedFeatures == null) {
				cache.put(eResource, this, Aadl2Package.eINSTANCE.getComponentType_OwnedFeature(),
						ownedFeatures = new DerivedUnionEObjectEList<Feature>(Feature.class, this,
								Aadl2Package.PROCESS_TYPE__OWNED_FEATURE, OWNED_FEATURE_ESUBSETS));
			}
			return ownedFeatures;
		}
		return new DerivedUnionEObjectEList<Feature>(Feature.class, this, Aadl2Package.PROCESS_TYPE__OWNED_FEATURE,
	 ...
	 * @ordered
	 */
	protected static final int[] OWNED_FEATURE_ESUBSETS = new int[] { Aadl2Package.PROCESS_TYPE__OWNED_FEATURE_GROUP,
			Aadl2Package.PROCESS_TYPE__OWNED_ABSTRACT_FEATURE, Aadl2Package.PROCESS_TYPE__OWNED_DATA_PORT,
			Aadl2Package.PROCESS_TYPE__OWNED_EVENT_DATA_PORT, Aadl2Package.PROCESS_TYPE__OWNED_EVENT_PORT,
			Aadl2Package.PROCESS_TYPE__OWNED_DATA_ACCESS, Aadl2Package.PROCESS_TYPE__OWNED_SUBPROGRAM_ACCESS,
			Aadl2Package.PROCESS_TYPE__OWNED_SUBPROGRAM_GROUP_ACCESS };
	...
	public EList<DataPort> getOwnedDataPorts() {
		return getFeatures().list(Aadl2Package.eINSTANCE.getProcessType_OwnedDataPort());
	}
	...
	public EList<EventDataPort> getOwnedEventDataPorts() {
		return getFeatures().list(Aadl2Package.eINSTANCE.getProcessType_OwnedEventDataPort());
	}
	...
	public EList<EventPort> getOwnedEventPorts() {
		return getFeatures().list(Aadl2Package.eINSTANCE.getProcessType_OwnedEventPort());
	}
	...
	public EList<DataAccess> getOwnedDataAccesses() {
		return getFeatures().list(Aadl2Package.eINSTANCE.getProcessType_OwnedDataAccess());
	}
	...
	public EList<SubprogramAccess> getOwnedSubprogramAccesses() {
		return getFeatures().list(Aadl2Package.eINSTANCE.getProcessType_OwnedSubprogramAccess());
	}
	...
	public EList<SubprogramGroupAccess> getOwnedSubprogramGroupAccesses() {
		return getFeatures().list(Aadl2Package.eINSTANCE.getProcessType_OwnedSubprogramGroupAccess());
	}
	...
	public boolean isSetOwnedFeatures() {
		return super.isSetOwnedFeatures() || eIsSet(Aadl2Package.PROCESS_TYPE__OWNED_DATA_PORT)
				|| eIsSet(Aadl2Package.PROCESS_TYPE__OWNED_EVENT_DATA_PORT)
				|| eIsSet(Aadl2Package.PROCESS_TYPE__OWNED_EVENT_PORT)
				|| eIsSet(Aadl2Package.PROCESS_TYPE__OWNED_DATA_ACCESS)
				|| eIsSet(Aadl2Package.PROCESS_TYPE__OWNED_SUBPROGRAM_ACCESS)
				|| eIsSet(Aadl2Package.PROCESS_TYPE__OWNED_SUBPROGRAM_GROUP_ACCESS);
	}
