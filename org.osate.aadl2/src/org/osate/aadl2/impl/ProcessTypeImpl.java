...
public class ProcessTypeImpl extends ComponentTypeImpl implements ProcessType {
			...
			if (ownedFeatures == null) {
				cache.put(eResource, this, Aadl2Package.eINSTANCE
						...
						ownedFeatures = new DerivedUnionEObjectEList<Feature>(
								Feature.class, this,
								Aadl2Package.PROCESS_TYPE__OWNED_FEATURE,
	...
	protected static final int[] OWNED_FEATURE_ESUBSETS = new int[] {
			Aadl2Package.PROCESS_TYPE__OWNED_FEATURE_GROUP,
			Aadl2Package.PROCESS_TYPE__OWNED_ABSTRACT_FEATURE,
	...
	public boolean isSetOwnedFeatures() {
		return super.isSetOwnedFeatures()
				|| eIsSet(Aadl2Package.PROCESS_TYPE__OWNED_DATA_PORT)
