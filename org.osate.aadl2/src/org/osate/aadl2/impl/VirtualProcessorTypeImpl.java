...
public class VirtualProcessorTypeImpl extends ComponentTypeImpl implements VirtualProcessorType {
	...
	public EList<DataPort> getOwnedDataPorts() {
		return getFeatures().list(Aadl2Package.eINSTANCE.getVirtualProcessorType_OwnedDataPort());
	}
	...
	public EList<EventDataPort> getOwnedEventDataPorts() {
		return getFeatures().list(Aadl2Package.eINSTANCE.getVirtualProcessorType_OwnedEventDataPort());
	}
	...
	public EList<EventPort> getOwnedEventPorts() {
		return getFeatures().list(Aadl2Package.eINSTANCE.getVirtualProcessorType_OwnedEventPort());
	}
	...
	public EList<SubprogramAccess> getOwnedSubprogramAccesses() {
		return getFeatures().list(Aadl2Package.eINSTANCE.getVirtualProcessorType_OwnedSubprogramAccess());
	}
	...
	public EList<SubprogramGroupAccess> getOwnedSubprogramGroupAccesses() {
		return getFeatures().list(Aadl2Package.eINSTANCE.getVirtualProcessorType_OwnedSubprogramGroupAccess());
	}
