 ...
 * </copyright>
 *
 * $Id: DeviceTypeImpl.java,v 1.19 2011-04-11 13:35:52 lwrage Exp $
 */
 ...
 * <ul>
 *   <li>{@link org.osate.aadl2.impl.DeviceTypeImpl#getOwnedFeatures <em>Owned Feature</em>}</li>
 *   <li>{@link org.osate.aadl2.impl.DeviceTypeImpl#getOwnedDataPorts <em>Owned Data Port</em>}</li>
 *   <li>{@link org.osate.aadl2.impl.DeviceTypeImpl#getOwnedEventDataPorts <em>Owned Event Data Port</em>}</li>
 *   <li>{@link org.osate.aadl2.impl.DeviceTypeImpl#getOwnedEventPorts <em>Owned Event Port</em>}</li>
 *   <li>{@link org.osate.aadl2.impl.DeviceTypeImpl#getOwnedBusAccesses <em>Owned Bus Access</em>}</li>
 *   <li>{@link org.osate.aadl2.impl.DeviceTypeImpl#getOwnedSubprogramAccesses <em>Owned Subprogram Access</em>}</li>
 *   <li>{@link org.osate.aadl2.impl.DeviceTypeImpl#getOwnedSubprogramGroupAccesses <em>Owned Subprogram Group Access</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class DeviceTypeImpl extends ComponentTypeImpl implements DeviceType {
			...
			if (ownedFeatures == null) {
				cache.put(eResource, this, Aadl2Package.eINSTANCE.getComponentType_OwnedFeature(),
						ownedFeatures = new DerivedUnionEObjectEList<Feature>(Feature.class, this,
								Aadl2Package.DEVICE_TYPE__OWNED_FEATURE, OWNED_FEATURE_ESUBSETS));
			}
	 ...
	 * @ordered
	 */
	protected static final int[] OWNED_FEATURE_ESUBSETS = new int[] { Aadl2Package.DEVICE_TYPE__OWNED_FEATURE_GROUP,
			Aadl2Package.DEVICE_TYPE__OWNED_ABSTRACT_FEATURE, Aadl2Package.DEVICE_TYPE__OWNED_DATA_PORT,
			Aadl2Package.DEVICE_TYPE__OWNED_EVENT_DATA_PORT, Aadl2Package.DEVICE_TYPE__OWNED_EVENT_PORT,
			Aadl2Package.DEVICE_TYPE__OWNED_BUS_ACCESS, Aadl2Package.DEVICE_TYPE__OWNED_SUBPROGRAM_ACCESS,
			Aadl2Package.DEVICE_TYPE__OWNED_SUBPROGRAM_GROUP_ACCESS };
	...
	public EList<DataPort> getOwnedDataPorts() {
		return getFeatures().list(Aadl2Package.eINSTANCE.getDeviceType_OwnedDataPort());
	}
	...
	public EList<EventDataPort> getOwnedEventDataPorts() {
		return getFeatures().list(Aadl2Package.eINSTANCE.getDeviceType_OwnedEventDataPort());
	}
	...
	public EList<EventPort> getOwnedEventPorts() {
		return getFeatures().list(Aadl2Package.eINSTANCE.getDeviceType_OwnedEventPort());
	}
	...
	public EList<BusAccess> getOwnedBusAccesses() {
		return getFeatures().list(Aadl2Package.eINSTANCE.getDeviceType_OwnedBusAccess());
	}
	...
	public EList<SubprogramAccess> getOwnedSubprogramAccesses() {
		return getFeatures().list(Aadl2Package.eINSTANCE.getDeviceType_OwnedSubprogramAccess());
	}
	...
	public EList<SubprogramGroupAccess> getOwnedSubprogramGroupAccesses() {
		return getFeatures().list(Aadl2Package.eINSTANCE.getDeviceType_OwnedSubprogramGroupAccess());
	}
	...
	public boolean isSetOwnedFeatures() {
		return super.isSetOwnedFeatures() || eIsSet(Aadl2Package.DEVICE_TYPE__OWNED_DATA_PORT)
				...
				|| eIsSet(Aadl2Package.DEVICE_TYPE__OWNED_EVENT_PORT)
				|| eIsSet(Aadl2Package.DEVICE_TYPE__OWNED_BUS_ACCESS)
				|| eIsSet(Aadl2Package.DEVICE_TYPE__OWNED_SUBPROGRAM_ACCESS)
