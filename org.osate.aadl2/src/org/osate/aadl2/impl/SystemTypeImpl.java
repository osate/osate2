 ...
 * </copyright>
 *
 * $Id: SystemTypeImpl.java,v 1.20 2011-04-11 13:35:54 lwrage Exp $
 */
 ...
 *   <li>{@link org.osate.aadl2.impl.SystemTypeImpl#getOwnedDataAccesses <em>Owned Data Access</em>}</li>
 *   <li>{@link org.osate.aadl2.impl.SystemTypeImpl#getOwnedDataPorts <em>Owned Data Port</em>}</li>
 *   <li>{@link org.osate.aadl2.impl.SystemTypeImpl#getOwnedSubprogramGroupAccesses <em>Owned Subprogram Group Access</em>}</li>
 *   <li>{@link org.osate.aadl2.impl.SystemTypeImpl#getOwnedSubprogramAccesses <em>Owned Subprogram Access</em>}</li>
...
public class SystemTypeImpl extends ComponentTypeImpl implements SystemType {
	...
	public EList<BusAccess> getOwnedBusAccesses() {
		return getFeatures().list(Aadl2Package.eINSTANCE.getSystemType_OwnedBusAccess());
	}
	...
	public EList<DataAccess> getOwnedDataAccesses() {
		return getFeatures().list(Aadl2Package.eINSTANCE.getSystemType_OwnedDataAccess());
	}
	...
	public EList<DataPort> getOwnedDataPorts() {
		return getFeatures().list(Aadl2Package.eINSTANCE.getSystemType_OwnedDataPort());
	}
	...
	public EList<SubprogramGroupAccess> getOwnedSubprogramGroupAccesses() {
		return getFeatures().list(Aadl2Package.eINSTANCE.getSystemType_OwnedSubprogramGroupAccess());
	}
	...
	public EList<SubprogramAccess> getOwnedSubprogramAccesses() {
		return getFeatures().list(Aadl2Package.eINSTANCE.getSystemType_OwnedSubprogramAccess());
	}
	...
	public EList<EventPort> getOwnedEventPorts() {
		return getFeatures().list(Aadl2Package.eINSTANCE.getSystemType_OwnedEventPort());
	}
	...
	public EList<EventDataPort> getOwnedEventDataPorts() {
		return getFeatures().list(Aadl2Package.eINSTANCE.getSystemType_OwnedEventDataPort());
	}
	...
	public boolean isSetOwnedFeatures() {
		return super.isSetOwnedFeatures() || eIsSet(Aadl2Package.SYSTEM_TYPE__OWNED_BUS_ACCESS)
				...
				|| eIsSet(Aadl2Package.SYSTEM_TYPE__OWNED_SUBPROGRAM_ACCESS)
				|| eIsSet(Aadl2Package.SYSTEM_TYPE__OWNED_EVENT_PORT)
