 ...
 *   <li>{@link org.osate.aadl2.impl.DataPortImpl#getDataClassifier <em>Data Classifier</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class DataPortImpl extends PortImpl implements DataPort {
	...
	public FeatureClassifier basicGetFeatureClassifier() {
		if (eIsSet(Aadl2Package.DATA_PORT__DATA_CLASSIFIER)) {
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case Aadl2Package.DATA_PORT__DATA_CLASSIFIER:
			if (resolve)
	...
	public boolean isSetFeatureClassifier() {
		return super.isSetFeatureClassifier() || eIsSet(Aadl2Package.DATA_PORT__DATA_CLASSIFIER);
	}
