 ...
 * @generated
 */
public class ProcessorTypeImpl extends ComponentTypeImpl implements
		ProcessorType {
	/**
	...
	protected static final int[] OWNED_FEATURE_ESUBSETS = new int[] {
			Aadl2Package.PROCESSOR_TYPE__OWNED_FEATURE_GROUP,
			Aadl2Package.PROCESSOR_TYPE__OWNED_ABSTRACT_FEATURE,
	...
	public boolean isSetOwnedFeatures() {
		return super.isSetOwnedFeatures()
				|| eIsSet(Aadl2Package.PROCESSOR_TYPE__OWNED_DATA_PORT)
