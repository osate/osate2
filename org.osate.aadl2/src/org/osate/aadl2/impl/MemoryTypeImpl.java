 ...
 *   <li>{@link org.osate.aadl2.impl.MemoryTypeImpl#getOwnedDataPorts <em>Owned Data Port</em>}</li>
 *   <li>{@link org.osate.aadl2.impl.MemoryTypeImpl#getOwnedEventDataPorts <em>Owned Event Data Port</em>}</li>
 *   <li>{@link org.osate.aadl2.impl.MemoryTypeImpl#getOwnedEventPorts <em>Owned Event Port</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class MemoryTypeImpl extends ComponentTypeImpl implements MemoryType {
			...
			if (ownedFeatures == null) {
				cache.put(eResource, this, Aadl2Package.eINSTANCE
						...
						ownedFeatures = new DerivedUnionEObjectEList<Feature>(
								Feature.class, this,
								Aadl2Package.MEMORY_TYPE__OWNED_FEATURE,
	...
	protected static final int[] OWNED_FEATURE_ESUBSETS = new int[] {
			Aadl2Package.MEMORY_TYPE__OWNED_FEATURE_GROUP,
			Aadl2Package.MEMORY_TYPE__OWNED_ABSTRACT_FEATURE,
	...
	public boolean isSetOwnedFeatures() {
		return super.isSetOwnedFeatures()
				|| eIsSet(Aadl2Package.MEMORY_TYPE__OWNED_BUS_ACCESS)
				|| eIsSet(Aadl2Package.MEMORY_TYPE__OWNED_DATA_PORT)
				|| eIsSet(Aadl2Package.MEMORY_TYPE__OWNED_EVENT_DATA_PORT)
