...
/**
 * This is the item provider adapter for a {@link org.osate.asap.model.safe2.Constraint} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ConstraintItemProvider 
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addCompensationPropertyDescriptor(object);
		}
	...
	protected void addHazardPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Constraint_hazard_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Constraint_hazard_feature", "_UI_Constraint_type"),
				 Safe2Package.Literals.CONSTRAINT__HAZARD,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addPortPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Constraint_port_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Constraint_port_feature", "_UI_Constraint_type"),
				 Safe2Package.Literals.CONSTRAINT__PORT,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addCausePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Constraint_cause_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Constraint_cause_feature", "_UI_Constraint_type"),
				 Safe2Package.Literals.CONSTRAINT__CAUSE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	/**
	 * This adds a property descriptor for the Compensation feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addCompensationPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Constraint_compensation_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Constraint_compensation_feature", "_UI_Constraint_type"),
				 Safe2Package.Literals.CONSTRAINT__COMPENSATION,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
