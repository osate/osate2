...
/**
 * This is the item provider adapter for a {@link org.osate.asap.model.safe2.AccidentLevel} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class AccidentLevelItemProvider 
	 ...
	 * @generated
	 */
	public AccidentLevelItemProvider(AdapterFactory adapterFactory) {
	...
	protected void addAccidentPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_AccidentLevel_accident_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_AccidentLevel_accident_feature", "_UI_AccidentLevel_type"),
				 Safe2Package.Literals.ACCIDENT_LEVEL__ACCIDENT,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(Safe2Package.Literals.ACCIDENT_LEVEL__ACCIDENT);
		}
	...
	/**
	 * This returns AccidentLevel.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/AccidentLevel"));
	}
	...
	public String getText(Object object) {
		String label = ((AccidentLevel)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_AccidentLevel_type") :
			getString("_UI_AccidentLevel_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(AccidentLevel.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(Safe2Package.Literals.ACCIDENT_LEVEL__ACCIDENT,
				 Safe2Factory.eINSTANCE.createAccident()));
	}
