...
public class VerificationMethodsFileWizard extends AbstractNewFileWizard {
	private final String VERIFICATION_METHODS_LABEL = "Verification methods name";
	@Inject
	private IParser parser;
	@Inject
	private VerifyGrammarAccess grammarAccess;

	public VerificationMethodsFileWizard() {
		super("Verification Methods", "methodregistry", 1, VerifyActivator.getInstance().getLog(),
				"org.osate.verify.ui");
	...
	public String fileContents(final Map<String, String> fieldValues) {
		return "verification methods " + fieldValues.get(VERIFICATION_METHODS_LABEL) + " [\n\t\n]";
	}
}
