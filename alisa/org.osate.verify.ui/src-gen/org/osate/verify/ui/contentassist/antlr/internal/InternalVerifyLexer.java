...
public class InternalVerifyLexer extends Lexer {
    ...
    public final void mRULE_EXPONENT() throws RecognitionException {
        try {
            // InternalVerify.g:18266:24: ( ( 'e' | 'E' ) ( '+' | '-' )? ( RULE_DIGIT )+ )
            // InternalVerify.g:18266:26: ( 'e' | 'E' ) ( '+' | '-' )? ( RULE_DIGIT )+
            {
            ...
            // InternalVerify.g:18266:47: ( RULE_DIGIT )+
            int cnt2=0;
            loop2:
            do {
                int alt2=2;
    ...
    public final void mRULE_INT_EXPONENT() throws RecognitionException {
        try {
            // InternalVerify.g:18268:28: ( ( 'e' | 'E' ) ( '+' )? ( RULE_DIGIT )+ )
            // InternalVerify.g:18268:30: ( 'e' | 'E' ) ( '+' )? ( RULE_DIGIT )+
            {
            if ( input.LA(1)=='E'||input.LA(1)=='e' ) {
                input.consume();
            ...
            // InternalVerify.g:18268:45: ( RULE_DIGIT )+
            int cnt4=0;
            loop4:
            do {
                int alt4=2;
    ...
    public final void mRULE_REAL_LIT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalVerify.g:18270:15: ( ( RULE_DIGIT )+ ( '_' ( RULE_DIGIT )+ )* '.' ( RULE_DIGIT )+ ( '_' ( RULE_DIGIT )+ )* ( RULE_EXPONENT )? )
            // InternalVerify.g:18270:17: ( RULE_DIGIT )+ ( '_' ( RULE_DIGIT )+ )* '.' ( RULE_DIGIT )+ ( '_' ( RULE_DIGIT )+ )* ( RULE_EXPONENT )?
            {
            // InternalVerify.g:18270:17: ( RULE_DIGIT )+
            int cnt5=0;
            loop5:
            do {
                int alt5=2;
            ...
            // InternalVerify.g:18270:29: ( '_' ( RULE_DIGIT )+ )*
            loop7:
            do {
                int alt7=2;
                ...
                switch (alt7) {
            	case 1 :
            	    // InternalVerify.g:18270:30: '_' ( RULE_DIGIT )+
            	    {
            	    match('_'); 
            	    // InternalVerify.g:18270:34: ( RULE_DIGIT )+
            	    int cnt6=0;
            	    loop6:
            	    do {
            	        int alt6=2;
            ...
            match('.'); 
            // InternalVerify.g:18270:52: ( RULE_DIGIT )+
            int cnt8=0;
            loop8:
            do {
                int alt8=2;
            ...
            // InternalVerify.g:18270:64: ( '_' ( RULE_DIGIT )+ )*
            loop10:
            do {
                int alt10=2;
                ...
                switch (alt10) {
            	case 1 :
            	    // InternalVerify.g:18270:65: '_' ( RULE_DIGIT )+
            	    {
            	    match('_'); 
            	    // InternalVerify.g:18270:69: ( RULE_DIGIT )+
            	    int cnt9=0;
            	    loop9:
            	    do {
            	        int alt9=2;
            ...
            // InternalVerify.g:18270:83: ( RULE_EXPONENT )?
            int alt11=2;
    ...
    public final void mRULE_DIGIT() throws RecognitionException {
        try {
            // InternalVerify.g:18272:21: ( '0' .. '9' )
            // InternalVerify.g:18272:23: '0' .. '9'
            {
            matchRange('0','9'); 
    ...
    public final void mRULE_EXTENDED_DIGIT() throws RecognitionException {
        try {
            // InternalVerify.g:18274:30: ( ( '0' .. '9' | 'a' .. 'f' | 'A' .. 'F' ) )
            // InternalVerify.g:18274:32: ( '0' .. '9' | 'a' .. 'f' | 'A' .. 'F' )
            {
    ...
    public final void mRULE_BASED_INTEGER() throws RecognitionException {
        try {
            // InternalVerify.g:18276:29: ( RULE_EXTENDED_DIGIT ( ( '_' )? RULE_EXTENDED_DIGIT )* )
            // InternalVerify.g:18276:31: RULE_EXTENDED_DIGIT ( ( '_' )? RULE_EXTENDED_DIGIT )*
            {
            mRULE_EXTENDED_DIGIT(); 
            // InternalVerify.g:18276:51: ( ( '_' )? RULE_EXTENDED_DIGIT )*
            loop13:
            do {
                int alt13=2;
                ...
                switch (alt13) {
            	case 1 :
            	    // InternalVerify.g:18276:52: ( '_' )? RULE_EXTENDED_DIGIT
            	    {
            	    // InternalVerify.g:18276:52: ( '_' )?
            	    int alt12=2;
    ...
    public final void mRULE_ID() throws RecognitionException {
        try {
            int _type = RULE_ID;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalVerify.g:18278:9: ( ( '^' )? ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )* )
            // InternalVerify.g:18278:11: ( '^' )? ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )*
            {
            // InternalVerify.g:18278:11: ( '^' )?
            int alt14=2;
            ...
            // InternalVerify.g:18278:40: ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )*
            loop15:
            do {
                int alt15=2;
    ...
    public final void mRULE_INT() throws RecognitionException {
        try {
            int _type = RULE_INT;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalVerify.g:18280:10: ( ( '0' .. '9' )+ )
            // InternalVerify.g:18280:12: ( '0' .. '9' )+
            {
            // InternalVerify.g:18280:12: ( '0' .. '9' )+
            int cnt16=0;
            loop16:
    ...
    public final void mRULE_STRING() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalVerify.g:18282:13: ( ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' ) )
            // InternalVerify.g:18282:15: ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' )
            {
            // InternalVerify.g:18282:15: ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' )
            int alt19=2;
            ...
            switch (alt19) {
                case 1 :
                    // InternalVerify.g:18282:16: '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"'
                    {
                    match('\"'); 
                    // InternalVerify.g:18282:20: ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )*
                    loop17:
                    do {
                        int alt17=3;
                    ...
                    break;
                case 2 :
                    // InternalVerify.g:18282:48: '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\''
                    {
                    match('\''); 
                    // InternalVerify.g:18282:53: ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )*
                    loop18:
                    do {
                        int alt18=3;
    ...
    public final void mRULE_ML_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalVerify.g:18284:17: ( '/*' ( options {greedy=false; } : . )* '*/' )
            // InternalVerify.g:18284:19: '/*' ( options {greedy=false; } : . )* '*/'
            {
            match("/*"); 

            // InternalVerify.g:18284:24: ( options {greedy=false; } : . )*
            loop20:
            do {
                int alt20=2;
    ...
    public final void mRULE_SL_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalVerify.g:18286:17: ( '//' (~ ( ( '\\n' | '\\r' ) ) )* ( ( '\\r' )? '\\n' )? )
            // InternalVerify.g:18286:19: '//' (~ ( ( '\\n' | '\\r' ) ) )* ( ( '\\r' )? '\\n' )?
            {
            match("//"); 

            // InternalVerify.g:18286:24: (~ ( ( '\\n' | '\\r' ) ) )*
            loop21:
            do {
                int alt21=2;
    ...
    public final void mRULE_WS() throws RecognitionException {
        try {
            int _type = RULE_WS;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalVerify.g:18288:9: ( ( ' ' | '\\t' | '\\r' | '\\n' )+ )
            // InternalVerify.g:18288:11: ( ' ' | '\\t' | '\\r' | '\\n' )+
            {
            // InternalVerify.g:18288:11: ( ' ' | '\\t' | '\\r' | '\\n' )+
            int cnt24=0;
            loop24:
    ...
    public final void mRULE_ANY_OTHER() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalVerify.g:18290:16: ( . )
            // InternalVerify.g:18290:18: .
            {
            matchAny(); 
