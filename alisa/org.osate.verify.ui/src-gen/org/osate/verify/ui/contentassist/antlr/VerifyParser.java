		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getVerificationPlanAccess().getGroup_7_4(), "rule__VerificationPlan__Group_7_4__0");
					...
					put(grammarAccess.getVerificationActivityAccess().getGroup_2_2(), "rule__VerificationActivity__Group_2_2__0");
					put(grammarAccess.getVerificationActivityAccess().getGroup_2_2_1(), "rule__VerificationActivity__Group_2_2_1__0");
					put(grammarAccess.getVerificationActivityAccess().getGroup_2_4(), "rule__VerificationActivity__Group_2_4__0");
					...
					put(grammarAccess.getVerificationPlanAccess().getVerifiedAssumptionAssignment_7_3_1(), "rule__VerificationPlan__VerifiedAssumptionAssignment_7_3_1");
					put(grammarAccess.getVerificationPlanAccess().getIssuesAssignment_7_4_1(), "rule__VerificationPlan__IssuesAssignment_7_4_1");
					...
					put(grammarAccess.getVerificationActivityParameterAccess().getComputeAssignment(), "rule__VerificationActivityParameter__ComputeAssignment");
					put(grammarAccess.getVerificationActivityAccess().getNameAssignment_0(), "rule__VerificationActivity__NameAssignment_0");
					put(grammarAccess.getVerificationActivityAccess().getMethodAssignment_2_0(), "rule__VerificationActivity__MethodAssignment_2_0");
					put(grammarAccess.getVerificationActivityAccess().getParametersAssignment_2_2_0(), "rule__VerificationActivity__ParametersAssignment_2_2_0");
					put(grammarAccess.getVerificationActivityAccess().getParametersAssignment_2_2_1_1(), "rule__VerificationActivity__ParametersAssignment_2_2_1_1");
					put(grammarAccess.getVerificationActivityAccess().getTimeoutAssignment_2_4_1(), "rule__VerificationActivity__TimeoutAssignment_2_4_1");
					...
					put(grammarAccess.getVerificationMethodParameterAccess().getNameAssignment(), "rule__VerificationMethodParameter__NameAssignment");
