		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getVerificationValidationAccess().getGroup_3(), "rule__VerificationValidation__Group_3__0");
					put(grammarAccess.getVerificationValidationAccess().getGroup_7(), "rule__VerificationValidation__Group_7__0");
					put(grammarAccess.getVerificationValidationAccess().getGroup_7_1(), "rule__VerificationValidation__Group_7_1__0");
					put(grammarAccess.getVerificationPreconditionAccess().getGroup(), "rule__VerificationPrecondition__Group__0");
					put(grammarAccess.getVerificationPreconditionAccess().getGroup_3(), "rule__VerificationPrecondition__Group_3__0");
					put(grammarAccess.getVerificationPreconditionAccess().getGroup_7(), "rule__VerificationPrecondition__Group_7__0");
					put(grammarAccess.getVerificationPreconditionAccess().getGroup_7_1(), "rule__VerificationPrecondition__Group_7_1__0");
					...
					put(grammarAccess.getVerificationMethodAccess().getGroup_5_6(), "rule__VerificationMethod__Group_5_6__0");
					...
					put(grammarAccess.getVerificationActivityAccess().getCategoryAssignment_2_1(), "rule__VerificationActivity__CategoryAssignment_2_1");
					...
					put(grammarAccess.getVerificationValidationAccess().getNameAssignment_2(), "rule__VerificationValidation__NameAssignment_2");
					put(grammarAccess.getVerificationValidationAccess().getTitleAssignment_3_1(), "rule__VerificationValidation__TitleAssignment_3_1");
					put(grammarAccess.getVerificationValidationAccess().getMethodAssignment_5(), "rule__VerificationValidation__MethodAssignment_5");
					put(grammarAccess.getVerificationValidationAccess().getParametersAssignment_7_0(), "rule__VerificationValidation__ParametersAssignment_7_0");
					put(grammarAccess.getVerificationValidationAccess().getParametersAssignment_7_1_1(), "rule__VerificationValidation__ParametersAssignment_7_1_1");
					put(grammarAccess.getVerificationPreconditionAccess().getNameAssignment_2(), "rule__VerificationPrecondition__NameAssignment_2");
					put(grammarAccess.getVerificationPreconditionAccess().getTitleAssignment_3_1(), "rule__VerificationPrecondition__TitleAssignment_3_1");
					put(grammarAccess.getVerificationPreconditionAccess().getMethodAssignment_5(), "rule__VerificationPrecondition__MethodAssignment_5");
					put(grammarAccess.getVerificationPreconditionAccess().getParametersAssignment_7_0(), "rule__VerificationPrecondition__ParametersAssignment_7_0");
					put(grammarAccess.getVerificationPreconditionAccess().getParametersAssignment_7_1_1(), "rule__VerificationPrecondition__ParametersAssignment_7_1_1");
					...
					put(grammarAccess.getVerificationMethodAccess().getCategoryAssignment_5_5_1(), "rule__VerificationMethod__CategoryAssignment_5_5_1");
					put(grammarAccess.getVerificationMethodAccess().getCategoryAssignment_5_6_1(), "rule__VerificationMethod__CategoryAssignment_5_6_1");
