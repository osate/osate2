		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getVerificationMethodAccess().getFormalsAssignment_2_2_0(), "rule__VerificationMethod__FormalsAssignment_2_2_0");
					put(grammarAccess.getVerificationMethodAccess().getFormalsAssignment_2_2_1_1(), "rule__VerificationMethod__FormalsAssignment_2_2_1_1");
					...
					put(grammarAccess.getVerificationMethodAccess().getResultsAssignment_2_5_2_0(), "rule__VerificationMethod__ResultsAssignment_2_5_2_0");
					put(grammarAccess.getVerificationMethodAccess().getResultsAssignment_2_5_2_1_1(), "rule__VerificationMethod__ResultsAssignment_2_5_2_1_1");
