		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getVerificationActivityAccess().getGroup_2_0(), "rule__VerificationActivity__Group_2_0__0");
					put(grammarAccess.getVerificationActivityAccess().getGroup_2_0_1(), "rule__VerificationActivity__Group_2_0_1__0");
					put(grammarAccess.getVerificationActivityAccess().getGroup_2_3(), "rule__VerificationActivity__Group_2_3__0");
					put(grammarAccess.getVerificationActivityAccess().getGroup_2_3_1(), "rule__VerificationActivity__Group_2_3_1__0");
					put(grammarAccess.getVerificationActivityAccess().getGroup_2_5(), "rule__VerificationActivity__Group_2_5__0");
					...
					put(grammarAccess.getVerificationActivityAccess().getResultAssignment_2_0_0(), "rule__VerificationActivity__ResultAssignment_2_0_0");
					put(grammarAccess.getVerificationActivityAccess().getResultAssignment_2_0_1_1(), "rule__VerificationActivity__ResultAssignment_2_0_1_1");
					put(grammarAccess.getVerificationActivityAccess().getMethodAssignment_2_1(), "rule__VerificationActivity__MethodAssignment_2_1");
					put(grammarAccess.getVerificationActivityAccess().getParametersAssignment_2_3_0(), "rule__VerificationActivity__ParametersAssignment_2_3_0");
					put(grammarAccess.getVerificationActivityAccess().getParametersAssignment_2_3_1_1(), "rule__VerificationActivity__ParametersAssignment_2_3_1_1");
					put(grammarAccess.getVerificationActivityAccess().getTimeoutAssignment_2_5_1(), "rule__VerificationActivity__TimeoutAssignment_2_5_1");
