		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getFailThenEvidenceExprAccess().getAlternatives_1_0_0_1(), "rule__FailThenEvidenceExpr__Alternatives_1_0_0_1");
					...
					put(grammarAccess.getXValDeclarationAccess().getRightAlternatives_4_0(), "rule__XValDeclaration__RightAlternatives_4_0");
					...
					put(grammarAccess.getSupportedScopesAccess().getAlternatives(), "rule__SupportedScopes__Alternatives");
					put(grammarAccess.getSupportedReportingAccess().getAlternatives(), "rule__SupportedReporting__Alternatives");
					...
					put(grammarAccess.getClaimAccess().getGroup_7_4(), "rule__Claim__Group_7_4__0");
					...
					put(grammarAccess.getVerificationActivityAccess().getGroup_5_1_2(), "rule__VerificationActivity__Group_5_1_2__0");
					...
					put(grammarAccess.getVerificationPlanAccess().getDescriptionAssignment_6_0(), "rule__VerificationPlan__DescriptionAssignment_6_0");
					put(grammarAccess.getVerificationPlanAccess().getClaimAssignment_6_1(), "rule__VerificationPlan__ClaimAssignment_6_1");
					put(grammarAccess.getVerificationPlanAccess().getRationaleAssignment_6_2(), "rule__VerificationPlan__RationaleAssignment_6_2");
					put(grammarAccess.getVerificationPlanAccess().getVerifiedAssumptionAssignment_6_3_1(), "rule__VerificationPlan__VerifiedAssumptionAssignment_6_3_1");
					put(grammarAccess.getVerificationPlanAccess().getIssuesAssignment_6_4_1(), "rule__VerificationPlan__IssuesAssignment_6_4_1");
					...
					put(grammarAccess.getClaimAccess().getArgumentUncertaintyAssignment_7_1_2(), "rule__Claim__ArgumentUncertaintyAssignment_7_1_2");
					put(grammarAccess.getClaimAccess().getRationaleAssignment_7_2(), "rule__Claim__RationaleAssignment_7_2");
					put(grammarAccess.getClaimAccess().getSubclaimAssignment_7_3(), "rule__Claim__SubclaimAssignment_7_3");
					put(grammarAccess.getClaimAccess().getIssuesAssignment_7_4_1(), "rule__Claim__IssuesAssignment_7_4_1");
					...
					put(grammarAccess.getVerificationLibraryAccess().getDescriptionAssignment_5_0(), "rule__VerificationLibrary__DescriptionAssignment_5_0");
					...
					put(grammarAccess.getVerificationActivityAccess().getDescriptionAssignment_5_0(), "rule__VerificationActivity__DescriptionAssignment_5_0");
					...
					put(grammarAccess.getVerificationActivityAccess().getComputeVariableAssignment_5_1_2_1(), "rule__VerificationActivity__ComputeVariableAssignment_5_1_2_1");
					...
					put(grammarAccess.getVerificationActivityAccess().getRationaleAssignment_5_3(), "rule__VerificationActivity__RationaleAssignment_5_3");
					...
					put(grammarAccess.getVerificationConditionAccess().getMethodAssignment_4_1_1(), "rule__VerificationCondition__MethodAssignment_4_1_1");
					put(grammarAccess.getVerificationConditionAccess().getComputeVariableAssignment_4_1_2_1(), "rule__VerificationCondition__ComputeVariableAssignment_4_1_2_1");
					...
					put(grammarAccess.getFailThenEvidenceExprAccess().getFailedAssignment_1_0_0_1_0(), "rule__FailThenEvidenceExpr__FailedAssignment_1_0_0_1_0");
					put(grammarAccess.getFailThenEvidenceExprAccess().getUnknownAssignment_1_0_0_1_1(), "rule__FailThenEvidenceExpr__UnknownAssignment_1_0_0_1_1");
					...
					put(grammarAccess.getVerificationMethodRegistryAccess().getDescriptionAssignment_4_0(), "rule__VerificationMethodRegistry__DescriptionAssignment_4_0");
					...
					put(grammarAccess.getVerificationMethodAccess().getScopeAssignment_5_0_1(), "rule__VerificationMethod__ScopeAssignment_5_0_1");
					put(grammarAccess.getVerificationMethodAccess().getReportingAssignment_5_0_2(), "rule__VerificationMethod__ReportingAssignment_5_0_2");
					...
					put(grammarAccess.getComputeDeclarationAccess().getWriteableAssignment_1(), "rule__ComputeDeclaration__WriteableAssignment_1");
