		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getVerificationMethodAccess().getAlternatives_2_6(), "rule__VerificationMethod__Alternatives_2_6");
					...
					put(grammarAccess.getVerificationMethodAccess().getGroup_2_2(), "rule__VerificationMethod__Group_2_2__0");
					put(grammarAccess.getVerificationMethodAccess().getGroup_2_2_1(), "rule__VerificationMethod__Group_2_2_1__0");
					...
					put(grammarAccess.getVerificationMethodAccess().getGroup_2_5(), "rule__VerificationMethod__Group_2_5__0");
					put(grammarAccess.getVerificationMethodAccess().getGroup_2_5_2(), "rule__VerificationMethod__Group_2_5_2__0");
					put(grammarAccess.getVerificationMethodAccess().getGroup_2_5_2_1(), "rule__VerificationMethod__Group_2_5_2_1__0");
					...
					put(grammarAccess.getComputeDeclarationAccess().getGroup_3(), "rule__ComputeDeclaration__Group_3__0");
					...
					put(grammarAccess.getAListTermAccess().getGroup_2(), "rule__AListTerm__Group_2__0");
					put(grammarAccess.getAListTermAccess().getGroup_2_1(), "rule__AListTerm__Group_2_1__0");
					...
					put(grammarAccess.getVerificationMethodAccess().getParamsAssignment_2_2_0(), "rule__VerificationMethod__ParamsAssignment_2_2_0");
					put(grammarAccess.getVerificationMethodAccess().getParamsAssignment_2_2_1_1(), "rule__VerificationMethod__ParamsAssignment_2_2_1_1");
					put(grammarAccess.getVerificationMethodAccess().getPropertiesAssignment_2_4_2_0(), "rule__VerificationMethod__PropertiesAssignment_2_4_2_0");
					put(grammarAccess.getVerificationMethodAccess().getPropertiesAssignment_2_4_2_1_1(), "rule__VerificationMethod__PropertiesAssignment_2_4_2_1_1");
					put(grammarAccess.getVerificationMethodAccess().getResultValuesAssignment_2_5_2_0(), "rule__VerificationMethod__ResultValuesAssignment_2_5_2_0");
					put(grammarAccess.getVerificationMethodAccess().getResultValuesAssignment_2_5_2_1_1(), "rule__VerificationMethod__ResultValuesAssignment_2_5_2_1_1");
					put(grammarAccess.getVerificationMethodAccess().getIsPredicateAssignment_2_6_0(), "rule__VerificationMethod__IsPredicateAssignment_2_6_0");
					put(grammarAccess.getVerificationMethodAccess().getIsResultReportAssignment_2_6_1(), "rule__VerificationMethod__IsResultReportAssignment_2_6_1");
					...
					put(grammarAccess.getTypeRefAccess().getTypeAssignment_4_1(), "rule__TypeRef__TypeAssignment_4_1");
					put(grammarAccess.getValDeclarationAccess().getNameAssignment_2(), "rule__ValDeclaration__NameAssignment_2");
					put(grammarAccess.getValDeclarationAccess().getTypeAssignment_3_1(), "rule__ValDeclaration__TypeAssignment_3_1");
					...
					put(grammarAccess.getComputeDeclarationAccess().getTypeAssignment_3_1(), "rule__ComputeDeclaration__TypeAssignment_3_1");
					...
					put(grammarAccess.getAUnaryOperationAccess().getOperatorvAssignment_0_1(), "rule__AUnaryOperation__OperatorvAssignment_0_1");
					...
					put(grammarAccess.getAListTermAccess().getElementsAssignment_2_0(), "rule__AListTerm__ElementsAssignment_2_0");
					put(grammarAccess.getAListTermAccess().getElementsAssignment_2_1_1(), "rule__AListTerm__ElementsAssignment_2_1_1");
