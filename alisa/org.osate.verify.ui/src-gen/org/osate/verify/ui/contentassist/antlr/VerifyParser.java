		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getVerificationPlanAccess().getGroup_9_3(), "rule__VerificationPlan__Group_9_3__0");
					...
					put(grammarAccess.getVerificationPlanAccess().getNameAssignment_4(), "rule__VerificationPlan__NameAssignment_4");
					put(grammarAccess.getVerificationPlanAccess().getTitleAssignment_5_1(), "rule__VerificationPlan__TitleAssignment_5_1");
					put(grammarAccess.getVerificationPlanAccess().getRequirementsAssignment_7(), "rule__VerificationPlan__RequirementsAssignment_7");
					put(grammarAccess.getVerificationPlanAccess().getDescriptionAssignment_9_0(), "rule__VerificationPlan__DescriptionAssignment_9_0");
					put(grammarAccess.getVerificationPlanAccess().getClaimAssignment_9_1(), "rule__VerificationPlan__ClaimAssignment_9_1");
					put(grammarAccess.getVerificationPlanAccess().getRationaleAssignment_9_2(), "rule__VerificationPlan__RationaleAssignment_9_2");
					put(grammarAccess.getVerificationPlanAccess().getIssuesAssignment_9_3_1(), "rule__VerificationPlan__IssuesAssignment_9_3_1");
					...
					put(grammarAccess.getGlobalVerificationPlanAccess().getRequirementsAssignment_7(), "rule__GlobalVerificationPlan__RequirementsAssignment_7");
					...
					put(grammarAccess.getVerificationPlanAccess().getUnorderedGroup_9(), "rule__VerificationPlan__UnorderedGroup_9");
