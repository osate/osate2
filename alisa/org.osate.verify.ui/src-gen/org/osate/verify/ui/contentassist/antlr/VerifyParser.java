		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getVerificationActivityAccess().getGroup_2_8(), "rule__VerificationActivity__Group_2_8__0");
					put(grammarAccess.getVerificationActivityAccess().getGroup_2_10(), "rule__VerificationActivity__Group_2_10__0");
					...
					put(grammarAccess.getVerificationActivityAccess().getResultValAssignment_2_1(), "rule__VerificationActivity__ResultValAssignment_2_1");
					put(grammarAccess.getVerificationActivityAccess().getResultValAssignment_2_2_1(), "rule__VerificationActivity__ResultValAssignment_2_2_1");
					put(grammarAccess.getVerificationActivityAccess().getMethodAssignment_2_5(), "rule__VerificationActivity__MethodAssignment_2_5");
					put(grammarAccess.getVerificationActivityAccess().getParametersAssignment_2_7(), "rule__VerificationActivity__ParametersAssignment_2_7");
					put(grammarAccess.getVerificationActivityAccess().getParametersAssignment_2_8_1(), "rule__VerificationActivity__ParametersAssignment_2_8_1");
					put(grammarAccess.getVerificationActivityAccess().getTimeoutAssignment_2_10_1(), "rule__VerificationActivity__TimeoutAssignment_2_10_1");
