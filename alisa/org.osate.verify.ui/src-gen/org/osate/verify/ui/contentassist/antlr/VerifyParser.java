		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getVerificationActivityAccess().getGroup_6_0(), "rule__VerificationActivity__Group_6_0__0");
					put(grammarAccess.getVerificationActivityAccess().getGroup_6_1(), "rule__VerificationActivity__Group_6_1__0");
					put(grammarAccess.getVerificationActivityAccess().getGroup_6_2(), "rule__VerificationActivity__Group_6_2__0");
					put(grammarAccess.getVerificationActivityAccess().getGroup_6_3(), "rule__VerificationActivity__Group_6_3__0");
					...
					put(grammarAccess.getVerificationActivityAccess().getTargetAssignment_4(), "rule__VerificationActivity__TargetAssignment_4");
					put(grammarAccess.getVerificationActivityAccess().getTitleAssignment_6_0_1(), "rule__VerificationActivity__TitleAssignment_6_0_1");
					put(grammarAccess.getVerificationActivityAccess().getDescriptionAssignment_6_1_1(), "rule__VerificationActivity__DescriptionAssignment_6_1_1");
					put(grammarAccess.getVerificationActivityAccess().getCategoryAssignment_6_2_1(), "rule__VerificationActivity__CategoryAssignment_6_2_1");
					put(grammarAccess.getVerificationActivityAccess().getMethodAssignment_6_3_1(), "rule__VerificationActivity__MethodAssignment_6_3_1");
					...
					put(grammarAccess.getVAReferenceAccess().getReferenceAssignment_1(), "rule__VAReference__ReferenceAssignment_1");
					...
					put(grammarAccess.getConditionalEvidenceAccess().getRightAssignment_1_2(), "rule__ConditionalEvidence__RightAssignment_1_2");
					...
					put(grammarAccess.getVerificationMethodAccess().getMethodAssignment_6(), "rule__VerificationMethod__MethodAssignment_6");
					put(grammarAccess.getVerificationMethodAccess().getDescriptionAssignment_7_0_1(), "rule__VerificationMethod__DescriptionAssignment_7_0_1");
					put(grammarAccess.getVerificationMethodAccess().getCategoryAssignment_7_1_1(), "rule__VerificationMethod__CategoryAssignment_7_1_1");
					put(grammarAccess.getVerificationMethodAccess().getConditionsAssignment_7_2(), "rule__VerificationMethod__ConditionsAssignment_7_2");
					...
					put(grammarAccess.getVerificationActivityAccess().getUnorderedGroup_6(), "rule__VerificationActivity__UnorderedGroup_6");
