...
import org.osate.organization.parser.antlr.internal.InternalOrganizationParser;
import org.osate.organization.services.OrganizationGrammarAccess;

public class OrganizationParser extends AbstractAntlrParser {
	...
	@Override
	protected InternalOrganizationParser createParser(XtextTokenStream stream) {
		return new InternalOrganizationParser(stream, getGrammarAccess());
	}
