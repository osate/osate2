...
public class ReqSpecGrammarAccess extends AbstractGrammarElementFinder {
	...
	public class DocGoalElements extends AbstractParserRuleElementFinder {
		...
		//	targetElement=[aadl2::NamedElement]?))? "[" (("quality" qualityCategory+=[categories::QualityCategory]+)? // condition under which requirement applies 
		//	& ("category" userCategory+=[categories::UserCategory]+)? & description=Description? & constants+=ValDeclaration* &
		//	whencondition=WhenCondition? & rationale=Rationale? & changeUncertainty=Uncertainty? & ("refines"
		...
		//("quality" qualityCategory+=[categories::QualityCategory]+)? // condition under which requirement applies 
		//& ("category" userCategory+=[categories::UserCategory]+)? & description=Description? & constants+=ValDeclaration* &
		//whencondition=WhenCondition? & rationale=Rationale? & changeUncertainty=Uncertainty? & ("refines"
		//refinesReference+=[Goal|QualifiedName]+)? & ("conflicts" "with" conflictsReference+=[Goal|QualifiedName]+)? &
		//("evolves" evolvesReference+=[Requirement|QualifiedName]+)? & (dropped?="dropped" dropRationale=STRING?)? &
	...
	public class GoalElements extends AbstractParserRuleElementFinder {
		...
		//Goal:
		//	"goal" name=ID (":" title=STRING)? // short string for title
		//	("for" targetElement=[aadl2::NamedElement])? "[" (("quality" qualityCategory+=[categories::QualityCategory]+)? // condition under which requirement applies 
		//	& ("category" userCategory+=[categories::UserCategory]+)? & description=Description? & constants+=ValDeclaration* &
		//	whencondition=WhenCondition? & rationale=Rationale? & changeUncertainty=Uncertainty? & ("refines"
		//	refinesReference+=[Goal|QualifiedName]+)? & ("conflicts" "with" conflictsReference+=[Goal|QualifiedName]+)? &
		//	("evolves" evolvesReference+=[Requirement|QualifiedName]+)? & (dropped?="dropped" dropRationale=STRING?)? &
		//	("stakeholder" stakeholderReference+=[org::Stakeholder|QualifiedName]+)? & ("see" "goal"
	...
	public class SystemRequirementElements extends AbstractParserRuleElementFinder {
		...
		private final Keyword cQualityKeyword_6_0_0 = (Keyword)cGroup_6_0.eContents().get(0);
		private final Assignment cQualityCategoryAssignment_6_0_1 = (Assignment)cGroup_6_0.eContents().get(1);
		private final CrossReference cQualityCategoryQualityCategoryCrossReference_6_0_1_0 = (CrossReference)cQualityCategoryAssignment_6_0_1.eContents().get(0);
		private final RuleCall cQualityCategoryQualityCategoryIDTerminalRuleCall_6_0_1_0_1 = (RuleCall)cQualityCategoryQualityCategoryCrossReference_6_0_1_0.eContents().get(1);
		...
		private final Assignment cDescriptionAssignment_6_2 = (Assignment)cUnorderedGroup_6.eContents().get(2);
		private final RuleCall cDescriptionDescriptionParserRuleCall_6_2_0 = (RuleCall)cDescriptionAssignment_6_2.eContents().get(0);
		private final Assignment cConstantsAssignment_6_3 = (Assignment)cUnorderedGroup_6.eContents().get(3);
		private final RuleCall cConstantsValDeclarationParserRuleCall_6_3_0 = (RuleCall)cConstantsAssignment_6_3.eContents().get(0);
		private final Assignment cComputesAssignment_6_4 = (Assignment)cUnorderedGroup_6.eContents().get(4);
		private final RuleCall cComputesComputeDeclarationParserRuleCall_6_4_0 = (RuleCall)cComputesAssignment_6_4.eContents().get(0);
		private final Assignment cWhenconditionAssignment_6_5 = (Assignment)cUnorderedGroup_6.eContents().get(5);
		private final RuleCall cWhenconditionWhenConditionParserRuleCall_6_5_0 = (RuleCall)cWhenconditionAssignment_6_5.eContents().get(0);
		private final Assignment cPredicateAssignment_6_6 = (Assignment)cUnorderedGroup_6.eContents().get(6);
		private final RuleCall cPredicateReqPredicateParserRuleCall_6_6_0 = (RuleCall)cPredicateAssignment_6_6.eContents().get(0);
		private final Assignment cRationaleAssignment_6_7 = (Assignment)cUnorderedGroup_6.eContents().get(7);
		private final RuleCall cRationaleRationaleParserRuleCall_6_7_0 = (RuleCall)cRationaleAssignment_6_7.eContents().get(0);
		private final Assignment cChangeUncertaintyAssignment_6_8 = (Assignment)cUnorderedGroup_6.eContents().get(8);
		private final RuleCall cChangeUncertaintyUncertaintyParserRuleCall_6_8_0 = (RuleCall)cChangeUncertaintyAssignment_6_8.eContents().get(0);
		private final Group cGroup_6_9 = (Group)cUnorderedGroup_6.eContents().get(9);
		private final Keyword cMitigatesKeyword_6_9_0 = (Keyword)cGroup_6_9.eContents().get(0);
		private final Alternatives cAlternatives_6_9_1 = (Alternatives)cGroup_6_9.eContents().get(1);
		private final Assignment cExceptionAssignment_6_9_1_0 = (Assignment)cAlternatives_6_9_1.eContents().get(0);
		private final CrossReference cExceptionEObjectCrossReference_6_9_1_0_0 = (CrossReference)cExceptionAssignment_6_9_1_0.eContents().get(0);
		private final RuleCall cExceptionEObjectIDTerminalRuleCall_6_9_1_0_0_1 = (RuleCall)cExceptionEObjectCrossReference_6_9_1_0_0.eContents().get(1);
		private final Assignment cExceptionTextAssignment_6_9_1_1 = (Assignment)cAlternatives_6_9_1.eContents().get(1);
		private final RuleCall cExceptionTextSTRINGTerminalRuleCall_6_9_1_1_0 = (RuleCall)cExceptionTextAssignment_6_9_1_1.eContents().get(0);
		private final Group cGroup_6_10 = (Group)cUnorderedGroup_6.eContents().get(10);
		private final Keyword cRefinesKeyword_6_10_0 = (Keyword)cGroup_6_10.eContents().get(0);
		private final Assignment cRefinesReferenceAssignment_6_10_1 = (Assignment)cGroup_6_10.eContents().get(1);
		private final CrossReference cRefinesReferenceRequirementCrossReference_6_10_1_0 = (CrossReference)cRefinesReferenceAssignment_6_10_1.eContents().get(0);
		private final RuleCall cRefinesReferenceRequirementQualifiedNameParserRuleCall_6_10_1_0_1 = (RuleCall)cRefinesReferenceRequirementCrossReference_6_10_1_0.eContents().get(1);
		private final Group cGroup_6_11 = (Group)cUnorderedGroup_6.eContents().get(11);
		private final Keyword cDecomposesKeyword_6_11_0 = (Keyword)cGroup_6_11.eContents().get(0);
		private final Assignment cDecomposesReferenceAssignment_6_11_1 = (Assignment)cGroup_6_11.eContents().get(1);
		private final CrossReference cDecomposesReferenceRequirementCrossReference_6_11_1_0 = (CrossReference)cDecomposesReferenceAssignment_6_11_1.eContents().get(0);
		private final RuleCall cDecomposesReferenceRequirementQualifiedNameParserRuleCall_6_11_1_0_1 = (RuleCall)cDecomposesReferenceRequirementCrossReference_6_11_1_0.eContents().get(1);
		private final Group cGroup_6_12 = (Group)cUnorderedGroup_6.eContents().get(12);
		private final Keyword cInheritsKeyword_6_12_0 = (Keyword)cGroup_6_12.eContents().get(0);
		private final Assignment cInheritsReferenceAssignment_6_12_1 = (Assignment)cGroup_6_12.eContents().get(1);
		private final CrossReference cInheritsReferenceRequirementCrossReference_6_12_1_0 = (CrossReference)cInheritsReferenceAssignment_6_12_1.eContents().get(0);
		private final RuleCall cInheritsReferenceRequirementQualifiedNameParserRuleCall_6_12_1_0_1 = (RuleCall)cInheritsReferenceRequirementCrossReference_6_12_1_0.eContents().get(1);
		private final Group cGroup_6_13 = (Group)cUnorderedGroup_6.eContents().get(13);
		private final Keyword cEvolvesKeyword_6_13_0 = (Keyword)cGroup_6_13.eContents().get(0);
		private final Assignment cEvolvesReferenceAssignment_6_13_1 = (Assignment)cGroup_6_13.eContents().get(1);
		private final CrossReference cEvolvesReferenceRequirementCrossReference_6_13_1_0 = (CrossReference)cEvolvesReferenceAssignment_6_13_1.eContents().get(0);
		private final RuleCall cEvolvesReferenceRequirementQualifiedNameParserRuleCall_6_13_1_0_1 = (RuleCall)cEvolvesReferenceRequirementCrossReference_6_13_1_0.eContents().get(1);
		private final Group cGroup_6_14 = (Group)cUnorderedGroup_6.eContents().get(14);
		private final Assignment cDroppedAssignment_6_14_0 = (Assignment)cGroup_6_14.eContents().get(0);
		private final Keyword cDroppedDroppedKeyword_6_14_0_0 = (Keyword)cDroppedAssignment_6_14_0.eContents().get(0);
		private final Assignment cDropRationaleAssignment_6_14_1 = (Assignment)cGroup_6_14.eContents().get(1);
		private final RuleCall cDropRationaleSTRINGTerminalRuleCall_6_14_1_0 = (RuleCall)cDropRationaleAssignment_6_14_1.eContents().get(0);
		private final Group cGroup_6_15 = (Group)cUnorderedGroup_6.eContents().get(15);
		private final Keyword cDevelopmentKeyword_6_15_0 = (Keyword)cGroup_6_15.eContents().get(0);
		private final Keyword cStakeholderKeyword_6_15_1 = (Keyword)cGroup_6_15.eContents().get(1);
		private final Assignment cDevelopmentStakeholderAssignment_6_15_2 = (Assignment)cGroup_6_15.eContents().get(2);
		private final CrossReference cDevelopmentStakeholderStakeholderCrossReference_6_15_2_0 = (CrossReference)cDevelopmentStakeholderAssignment_6_15_2.eContents().get(0);
		private final RuleCall cDevelopmentStakeholderStakeholderQualifiedNameParserRuleCall_6_15_2_0_1 = (RuleCall)cDevelopmentStakeholderStakeholderCrossReference_6_15_2_0.eContents().get(1);
		...
		private final Keyword cGoalKeyword_6_16_1 = (Keyword)cGroup_6_16.eContents().get(1);
		private final Assignment cGoalReferenceAssignment_6_16_2 = (Assignment)cGroup_6_16.eContents().get(2);
		private final CrossReference cGoalReferenceGoalCrossReference_6_16_2_0 = (CrossReference)cGoalReferenceAssignment_6_16_2.eContents().get(0);
		private final RuleCall cGoalReferenceGoalQualifiedNameParserRuleCall_6_16_2_0_1 = (RuleCall)cGoalReferenceGoalCrossReference_6_16_2_0.eContents().get(1);
		...
		private final Keyword cRequirementKeyword_6_17_1 = (Keyword)cGroup_6_17.eContents().get(1);
		private final Assignment cRequirementReferenceAssignment_6_17_2 = (Assignment)cGroup_6_17.eContents().get(2);
		private final CrossReference cRequirementReferenceRequirementCrossReference_6_17_2_0 = (CrossReference)cRequirementReferenceAssignment_6_17_2.eContents().get(0);
		private final RuleCall cRequirementReferenceRequirementQualifiedNameParserRuleCall_6_17_2_0_1 = (RuleCall)cRequirementReferenceRequirementCrossReference_6_17_2_0.eContents().get(1);
		private final Group cGroup_6_18 = (Group)cUnorderedGroup_6.eContents().get(18);
		private final Keyword cSeeKeyword_6_18_0 = (Keyword)cGroup_6_18.eContents().get(0);
		private final Keyword cDocumentKeyword_6_18_1 = (Keyword)cGroup_6_18.eContents().get(1);
		private final Assignment cDocReferenceAssignment_6_18_2 = (Assignment)cGroup_6_18.eContents().get(2);
		private final RuleCall cDocReferenceExternalDocumentParserRuleCall_6_18_2_0 = (RuleCall)cDocReferenceAssignment_6_18_2.eContents().get(0);
		private final Group cGroup_6_19 = (Group)cUnorderedGroup_6.eContents().get(19);
		private final Keyword cIssuesKeyword_6_19_0 = (Keyword)cGroup_6_19.eContents().get(0);
		private final Assignment cIssuesAssignment_6_19_1 = (Assignment)cGroup_6_19.eContents().get(1);
		private final RuleCall cIssuesSTRINGTerminalRuleCall_6_19_1_0 = (RuleCall)cIssuesAssignment_6_19_1.eContents().get(0);
		...
		//	& ("category" userCategory+=[categories::UserCategory]+)? & description=Description? & constants+=ValDeclaration* &
		//	computes+=ComputeDeclaration* & whencondition=WhenCondition? & predicate=ReqPredicate? & rationale=Rationale? &
		...
		//	& ("inherits" inheritsReference=[Requirement|QualifiedName])? & ("evolves"
		...
		//"quality"
		public Keyword getQualityKeyword_6_0_0() { return cQualityKeyword_6_0_0; }

		//qualityCategory+=[categories::QualityCategory]+
		public Assignment getQualityCategoryAssignment_6_0_1() { return cQualityCategoryAssignment_6_0_1; }

		//[categories::QualityCategory]
		public CrossReference getQualityCategoryQualityCategoryCrossReference_6_0_1_0() { return cQualityCategoryQualityCategoryCrossReference_6_0_1_0; }

		//ID
		public RuleCall getQualityCategoryQualityCategoryIDTerminalRuleCall_6_0_1_0_1() { return cQualityCategoryQualityCategoryIDTerminalRuleCall_6_0_1_0_1; }
		...
		//Description
		public RuleCall getDescriptionDescriptionParserRuleCall_6_2_0() { return cDescriptionDescriptionParserRuleCall_6_2_0; }

		//constants+=ValDeclaration*
		public Assignment getConstantsAssignment_6_3() { return cConstantsAssignment_6_3; }

		//ValDeclaration
		public RuleCall getConstantsValDeclarationParserRuleCall_6_3_0() { return cConstantsValDeclarationParserRuleCall_6_3_0; }

		//computes+=ComputeDeclaration*
		public Assignment getComputesAssignment_6_4() { return cComputesAssignment_6_4; }

		//ComputeDeclaration
		public RuleCall getComputesComputeDeclarationParserRuleCall_6_4_0() { return cComputesComputeDeclarationParserRuleCall_6_4_0; }

		//whencondition=WhenCondition?
		public Assignment getWhenconditionAssignment_6_5() { return cWhenconditionAssignment_6_5; }

		//WhenCondition
		public RuleCall getWhenconditionWhenConditionParserRuleCall_6_5_0() { return cWhenconditionWhenConditionParserRuleCall_6_5_0; }

		//predicate=ReqPredicate?
		public Assignment getPredicateAssignment_6_6() { return cPredicateAssignment_6_6; }

		//ReqPredicate
		public RuleCall getPredicateReqPredicateParserRuleCall_6_6_0() { return cPredicateReqPredicateParserRuleCall_6_6_0; }

		//rationale=Rationale?
		public Assignment getRationaleAssignment_6_7() { return cRationaleAssignment_6_7; }

		//Rationale
		public RuleCall getRationaleRationaleParserRuleCall_6_7_0() { return cRationaleRationaleParserRuleCall_6_7_0; }

		//changeUncertainty=Uncertainty?
		public Assignment getChangeUncertaintyAssignment_6_8() { return cChangeUncertaintyAssignment_6_8; }

		//Uncertainty
		public RuleCall getChangeUncertaintyUncertaintyParserRuleCall_6_8_0() { return cChangeUncertaintyUncertaintyParserRuleCall_6_8_0; }

		//("mitigates" (exception=[ecore::EObject] | exceptionText=STRING))?
		public Group getGroup_6_9() { return cGroup_6_9; }

		//"mitigates"
		public Keyword getMitigatesKeyword_6_9_0() { return cMitigatesKeyword_6_9_0; }

		//exception=[ecore::EObject] | exceptionText=STRING
		public Alternatives getAlternatives_6_9_1() { return cAlternatives_6_9_1; }

		//exception=[ecore::EObject]
		public Assignment getExceptionAssignment_6_9_1_0() { return cExceptionAssignment_6_9_1_0; }

		//[ecore::EObject]
		public CrossReference getExceptionEObjectCrossReference_6_9_1_0_0() { return cExceptionEObjectCrossReference_6_9_1_0_0; }

		//ID
		public RuleCall getExceptionEObjectIDTerminalRuleCall_6_9_1_0_0_1() { return cExceptionEObjectIDTerminalRuleCall_6_9_1_0_0_1; }

		//exceptionText=STRING
		public Assignment getExceptionTextAssignment_6_9_1_1() { return cExceptionTextAssignment_6_9_1_1; }

		//STRING
		public RuleCall getExceptionTextSTRINGTerminalRuleCall_6_9_1_1_0() { return cExceptionTextSTRINGTerminalRuleCall_6_9_1_1_0; }

		//("refines" refinesReference+=[Requirement|QualifiedName]+)?
		public Group getGroup_6_10() { return cGroup_6_10; }

		//"refines"
		public Keyword getRefinesKeyword_6_10_0() { return cRefinesKeyword_6_10_0; }

		//refinesReference+=[Requirement|QualifiedName]+
		public Assignment getRefinesReferenceAssignment_6_10_1() { return cRefinesReferenceAssignment_6_10_1; }

		//[Requirement|QualifiedName]
		public CrossReference getRefinesReferenceRequirementCrossReference_6_10_1_0() { return cRefinesReferenceRequirementCrossReference_6_10_1_0; }

		//QualifiedName
		public RuleCall getRefinesReferenceRequirementQualifiedNameParserRuleCall_6_10_1_0_1() { return cRefinesReferenceRequirementQualifiedNameParserRuleCall_6_10_1_0_1; }

		//("decomposes" decomposesReference+=[Requirement|QualifiedName]+)?
		public Group getGroup_6_11() { return cGroup_6_11; }

		//"decomposes"
		public Keyword getDecomposesKeyword_6_11_0() { return cDecomposesKeyword_6_11_0; }

		//decomposesReference+=[Requirement|QualifiedName]+
		public Assignment getDecomposesReferenceAssignment_6_11_1() { return cDecomposesReferenceAssignment_6_11_1; }

		//[Requirement|QualifiedName]
		public CrossReference getDecomposesReferenceRequirementCrossReference_6_11_1_0() { return cDecomposesReferenceRequirementCrossReference_6_11_1_0; }

		//QualifiedName
		public RuleCall getDecomposesReferenceRequirementQualifiedNameParserRuleCall_6_11_1_0_1() { return cDecomposesReferenceRequirementQualifiedNameParserRuleCall_6_11_1_0_1; }

		//("inherits" inheritsReference=[Requirement|QualifiedName])?
		public Group getGroup_6_12() { return cGroup_6_12; }

		//"inherits"
		public Keyword getInheritsKeyword_6_12_0() { return cInheritsKeyword_6_12_0; }

		//inheritsReference=[Requirement|QualifiedName]
		public Assignment getInheritsReferenceAssignment_6_12_1() { return cInheritsReferenceAssignment_6_12_1; }

		//[Requirement|QualifiedName]
		public CrossReference getInheritsReferenceRequirementCrossReference_6_12_1_0() { return cInheritsReferenceRequirementCrossReference_6_12_1_0; }

		//QualifiedName
		public RuleCall getInheritsReferenceRequirementQualifiedNameParserRuleCall_6_12_1_0_1() { return cInheritsReferenceRequirementQualifiedNameParserRuleCall_6_12_1_0_1; }

		//("evolves" evolvesReference+=[Requirement|QualifiedName]+)?
		public Group getGroup_6_13() { return cGroup_6_13; }

		//"evolves"
		public Keyword getEvolvesKeyword_6_13_0() { return cEvolvesKeyword_6_13_0; }

		//evolvesReference+=[Requirement|QualifiedName]+
		public Assignment getEvolvesReferenceAssignment_6_13_1() { return cEvolvesReferenceAssignment_6_13_1; }

		//[Requirement|QualifiedName]
		public CrossReference getEvolvesReferenceRequirementCrossReference_6_13_1_0() { return cEvolvesReferenceRequirementCrossReference_6_13_1_0; }

		//QualifiedName
		public RuleCall getEvolvesReferenceRequirementQualifiedNameParserRuleCall_6_13_1_0_1() { return cEvolvesReferenceRequirementQualifiedNameParserRuleCall_6_13_1_0_1; }

		//(dropped?="dropped" dropRationale=STRING?)?
		public Group getGroup_6_14() { return cGroup_6_14; }

		//dropped?="dropped"
		public Assignment getDroppedAssignment_6_14_0() { return cDroppedAssignment_6_14_0; }

		//"dropped"
		public Keyword getDroppedDroppedKeyword_6_14_0_0() { return cDroppedDroppedKeyword_6_14_0_0; }

		//dropRationale=STRING?
		public Assignment getDropRationaleAssignment_6_14_1() { return cDropRationaleAssignment_6_14_1; }

		//STRING
		public RuleCall getDropRationaleSTRINGTerminalRuleCall_6_14_1_0() { return cDropRationaleSTRINGTerminalRuleCall_6_14_1_0; }
		...
		//"development"
		public Keyword getDevelopmentKeyword_6_15_0() { return cDevelopmentKeyword_6_15_0; }

		//"stakeholder"
		public Keyword getStakeholderKeyword_6_15_1() { return cStakeholderKeyword_6_15_1; }

		//developmentStakeholder+=[org::Stakeholder|QualifiedName]+
		public Assignment getDevelopmentStakeholderAssignment_6_15_2() { return cDevelopmentStakeholderAssignment_6_15_2; }

		//[org::Stakeholder|QualifiedName]
		public CrossReference getDevelopmentStakeholderStakeholderCrossReference_6_15_2_0() { return cDevelopmentStakeholderStakeholderCrossReference_6_15_2_0; }

		//QualifiedName
		public RuleCall getDevelopmentStakeholderStakeholderQualifiedNameParserRuleCall_6_15_2_0_1() { return cDevelopmentStakeholderStakeholderQualifiedNameParserRuleCall_6_15_2_0_1; }
		...
		//"goal"
		public Keyword getGoalKeyword_6_16_1() { return cGoalKeyword_6_16_1; }

		//goalReference+=[Goal|QualifiedName]+
		public Assignment getGoalReferenceAssignment_6_16_2() { return cGoalReferenceAssignment_6_16_2; }

		//[Goal|QualifiedName]
		public CrossReference getGoalReferenceGoalCrossReference_6_16_2_0() { return cGoalReferenceGoalCrossReference_6_16_2_0; }

		//QualifiedName
		public RuleCall getGoalReferenceGoalQualifiedNameParserRuleCall_6_16_2_0_1() { return cGoalReferenceGoalQualifiedNameParserRuleCall_6_16_2_0_1; }
		...
		//"requirement"
		public Keyword getRequirementKeyword_6_17_1() { return cRequirementKeyword_6_17_1; }

		//requirementReference+=[Requirement|QualifiedName]+
		public Assignment getRequirementReferenceAssignment_6_17_2() { return cRequirementReferenceAssignment_6_17_2; }

		//[Requirement|QualifiedName]
		public CrossReference getRequirementReferenceRequirementCrossReference_6_17_2_0() { return cRequirementReferenceRequirementCrossReference_6_17_2_0; }

		//QualifiedName
		public RuleCall getRequirementReferenceRequirementQualifiedNameParserRuleCall_6_17_2_0_1() { return cRequirementReferenceRequirementQualifiedNameParserRuleCall_6_17_2_0_1; }

		//("see" "document" docReference+=ExternalDocument+)?
		public Group getGroup_6_18() { return cGroup_6_18; }

		//"see"
		public Keyword getSeeKeyword_6_18_0() { return cSeeKeyword_6_18_0; }

		//"document"
		public Keyword getDocumentKeyword_6_18_1() { return cDocumentKeyword_6_18_1; }

		//docReference+=ExternalDocument+
		public Assignment getDocReferenceAssignment_6_18_2() { return cDocReferenceAssignment_6_18_2; }

		//ExternalDocument
		public RuleCall getDocReferenceExternalDocumentParserRuleCall_6_18_2_0() { return cDocReferenceExternalDocumentParserRuleCall_6_18_2_0; }

		//("issues" issues+=STRING+)?
		public Group getGroup_6_19() { return cGroup_6_19; }

		//"issues"
		public Keyword getIssuesKeyword_6_19_0() { return cIssuesKeyword_6_19_0; }

		//issues+=STRING+
		public Assignment getIssuesAssignment_6_19_1() { return cIssuesAssignment_6_19_1; }

		//STRING
		public RuleCall getIssuesSTRINGTerminalRuleCall_6_19_1_0() { return cIssuesSTRINGTerminalRuleCall_6_19_1_0; }
	...
	public class GlobalRequirementElements extends AbstractParserRuleElementFinder {
		...
		//	connections?="connections"))? "[" (("quality" qualityCategory+=[categories::QualityCategory]+)? // condition under which requirement applies 
		//	// predicate expression 
		//	& ("category" userCategory+=[categories::UserCategory]+)? & description=Description? & constants+=ValDeclaration* &
		//	computes+=ComputeDeclaration* & whencondition=WhenCondition? & predicate=ReqPredicate? & rationale=Rationale? &
		//	changeUncertainty=Uncertainty? & ("mitigates" (exception=[ecore::EObject] | exceptionText=STRING))? & ("refines"
	...
	public class DocRequirementElements extends AbstractParserRuleElementFinder {
		...
		private final Keyword cForKeyword_4_0 = (Keyword)cGroup_4.eContents().get(0);
		private final Alternatives cAlternatives_4_1 = (Alternatives)cGroup_4.eContents().get(1);
		private final Assignment cTargetDescriptionAssignment_4_1_0 = (Assignment)cAlternatives_4_1.eContents().get(0);
		private final RuleCall cTargetDescriptionSTRINGTerminalRuleCall_4_1_0_0 = (RuleCall)cTargetDescriptionAssignment_4_1_0.eContents().get(0);
		private final Group cGroup_4_1_1 = (Group)cAlternatives_4_1.eContents().get(1);
		private final Assignment cTargetAssignment_4_1_1_0 = (Assignment)cGroup_4_1_1.eContents().get(0);
		private final CrossReference cTargetComponentClassifierCrossReference_4_1_1_0_0 = (CrossReference)cTargetAssignment_4_1_1_0.eContents().get(0);
		private final RuleCall cTargetComponentClassifierAadlClassifierReferenceParserRuleCall_4_1_1_0_0_1 = (RuleCall)cTargetComponentClassifierCrossReference_4_1_1_0_0.eContents().get(1);
		private final Assignment cTargetElementAssignment_4_1_1_1 = (Assignment)cGroup_4_1_1.eContents().get(1);
		private final CrossReference cTargetElementNamedElementCrossReference_4_1_1_1_0 = (CrossReference)cTargetElementAssignment_4_1_1_1.eContents().get(0);
		private final RuleCall cTargetElementNamedElementIDTerminalRuleCall_4_1_1_1_0_1 = (RuleCall)cTargetElementNamedElementCrossReference_4_1_1_1_0.eContents().get(1);
		private final Assignment cComponentCategoryAssignment_4_1_2 = (Assignment)cAlternatives_4_1.eContents().get(2);
		private final RuleCall cComponentCategoryComponentCategoryParserRuleCall_4_1_2_0 = (RuleCall)cComponentCategoryAssignment_4_1_2.eContents().get(0);
		private final Keyword cLeftSquareBracketKeyword_5 = (Keyword)cGroup.eContents().get(5);
		private final UnorderedGroup cUnorderedGroup_6 = (UnorderedGroup)cGroup.eContents().get(6);
		private final Group cGroup_6_0 = (Group)cUnorderedGroup_6.eContents().get(0);
		private final Keyword cQualityKeyword_6_0_0 = (Keyword)cGroup_6_0.eContents().get(0);
		...
		//	"requirement" name=ID ("(" reqKind=ReqKind ")")? (":" title=STRING)? ("for" (targetDescription=STRING |
		//	target=[aadl2::ComponentClassifier|AadlClassifierReference] targetElement=[aadl2::NamedElement]? |
		//	componentCategory+=ComponentCategory+))? "[" (("quality" qualityCategory+=[categories::QualityCategory]+)? // condition under which requirement applies 
		//	// predicate expression 
		//	& ("category" userCategory+=[categories::UserCategory]+)? & description=Description? & constants+=ValDeclaration* &
		//	computes+=ComputeDeclaration* & whencondition=WhenCondition? & predicate=ReqPredicate? & rationale=Rationale? &
		//	changeUncertainty=Uncertainty? & ("mitigates" (exception=[ecore::EObject] | exceptionText=STRING))? & ("refines"
		...
		//targetDescription=STRING
		public Assignment getTargetDescriptionAssignment_4_1_0() { return cTargetDescriptionAssignment_4_1_0; }

		//STRING
		public RuleCall getTargetDescriptionSTRINGTerminalRuleCall_4_1_0_0() { return cTargetDescriptionSTRINGTerminalRuleCall_4_1_0_0; }

		//target=[aadl2::ComponentClassifier|AadlClassifierReference] targetElement=[aadl2::NamedElement]?
		public Group getGroup_4_1_1() { return cGroup_4_1_1; }

		//target=[aadl2::ComponentClassifier|AadlClassifierReference]
		public Assignment getTargetAssignment_4_1_1_0() { return cTargetAssignment_4_1_1_0; }

		//[aadl2::ComponentClassifier|AadlClassifierReference]
		public CrossReference getTargetComponentClassifierCrossReference_4_1_1_0_0() { return cTargetComponentClassifierCrossReference_4_1_1_0_0; }

		//AadlClassifierReference
		public RuleCall getTargetComponentClassifierAadlClassifierReferenceParserRuleCall_4_1_1_0_0_1() { return cTargetComponentClassifierAadlClassifierReferenceParserRuleCall_4_1_1_0_0_1; }

		//targetElement=[aadl2::NamedElement]?
		public Assignment getTargetElementAssignment_4_1_1_1() { return cTargetElementAssignment_4_1_1_1; }

		//[aadl2::NamedElement]
		public CrossReference getTargetElementNamedElementCrossReference_4_1_1_1_0() { return cTargetElementNamedElementCrossReference_4_1_1_1_0; }

		//ID
		public RuleCall getTargetElementNamedElementIDTerminalRuleCall_4_1_1_1_0_1() { return cTargetElementNamedElementIDTerminalRuleCall_4_1_1_1_0_1; }

		//componentCategory+=ComponentCategory+
		public Assignment getComponentCategoryAssignment_4_1_2() { return cComponentCategoryAssignment_4_1_2; }

		//ComponentCategory
		public RuleCall getComponentCategoryComponentCategoryParserRuleCall_4_1_2_0() { return cComponentCategoryComponentCategoryParserRuleCall_4_1_2_0; }
