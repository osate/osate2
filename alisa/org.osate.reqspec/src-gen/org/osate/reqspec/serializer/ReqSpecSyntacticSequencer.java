...
public class ReqSpecSyntacticSequencer extends AbstractSyntacticSequencer {
	...
	protected AbstractElementAlias match_SystemRequirement_IssuesKeyword_5_16_0_q;
	...
	protected AbstractElementAlias match_SystemRequirement___SeeKeyword_5_15_0_DocumentKeyword_5_15_1__q;
	...
	protected void init(IGrammarAccess access) {
		...
		match_SystemRequirement_IssuesKeyword_5_16_0_q = new TokenAlias(false, true, grammarAccess.getSystemRequirementAccess().getIssuesKeyword_5_16_0());
		...
		match_SystemRequirement___SeeKeyword_5_15_0_DocumentKeyword_5_15_1__q = new GroupAlias(false, true, new TokenAlias(false, false, grammarAccess.getSystemRequirementAccess().getSeeKeyword_5_15_0()), new TokenAlias(false, false, grammarAccess.getSystemRequirementAccess().getDocumentKeyword_5_15_1()));
	...
	protected void emitUnassignedTokens(EObject semanticObject, ISynTransition transition, INode fromNode, INode toNode) {
		...
		for (AbstractElementAlias syntax : transition.getAmbiguousSyntaxes()) {
			...
			else if(match_SystemRequirement_IssuesKeyword_5_16_0_q.equals(syntax))
				emit_SystemRequirement_IssuesKeyword_5_16_0_q(semanticObject, getLastNavigableState(), syntaxNodes);
			...
			else if(match_SystemRequirement___SeeKeyword_5_15_0_DocumentKeyword_5_15_1__q.equals(syntax))
				emit_SystemRequirement___SeeKeyword_5_15_0_DocumentKeyword_5_15_1__q(semanticObject, getLastNavigableState(), syntaxNodes);
	 ...
	 *     issues+=STRING (ambiguity) issues+=STRING
	 */
	protected void emit_SystemRequirement_IssuesKeyword_5_16_0_q(EObject semanticObject, ISynNavigable transition, List<INode> nodes) {
		acceptNodes(transition, nodes);
	}
	 ...
	 *     docReference+=ExternalDocument (ambiguity) docReference+=ExternalDocument
	 */
	protected void emit_SystemRequirement___SeeKeyword_5_15_0_DocumentKeyword_5_15_1__q(EObject semanticObject, ISynNavigable transition, List<INode> nodes) {
		acceptNodes(transition, nodes);
	}
