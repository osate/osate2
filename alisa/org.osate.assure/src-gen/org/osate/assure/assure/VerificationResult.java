 ...
 * <ul>
 *   <li>{@link org.osate.assure.assure.VerificationResult#getName <em>Name</em>}</li>
...
public interface VerificationResult extends AssureResult, VerificationExpr
{
   ...
   * @see #setName(String)
   * @see org.osate.assure.assure.AssurePackage#getVerificationResult_Name()
   * @model
   * @generated
   */
  String getName();
  ...
  /**
   * Sets the value of the '{@link org.osate.assure.assure.VerificationResult#getName <em>Name</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
