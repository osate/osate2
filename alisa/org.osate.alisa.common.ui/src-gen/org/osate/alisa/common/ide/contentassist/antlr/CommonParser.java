...
import org.osate.alisa.common.ide.contentassist.antlr.internal.InternalCommonParser;
...
public class CommonParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		@Inject
		public NameMappings(CommonGrammarAccess grammarAccess) {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, CommonGrammarAccess grammarAccess) {
	...
	@Override
	protected InternalCommonParser createParser() {
		InternalCommonParser result = new InternalCommonParser(null);
