		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getCategoriesDefinitionsAccess().getMethodcategoriesAssignment_1(), "rule__CategoriesDefinitions__MethodcategoriesAssignment_1");
					...
					put(grammarAccess.getCategoriesDefinitionsAccess().getPhasecategoriesAssignment_3(), "rule__CategoriesDefinitions__PhasecategoriesAssignment_3");
