...
public class ResultsAdapterFactory extends AdapterFactoryImpl {
	...
	protected ResultsSwitch<Adapter> modelSwitch =
		new ResultsSwitch<Adapter>() {
			...
			@Override
			public Adapter caseResultDataSpec(ResultDataSpec object) {
				return createResultDataSpecAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.osate.results.Results <em>Results</em>}'.
	 * <!-- begin-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.osate.results.ResultContributor <em>Result Contributor</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.osate.results.ResultIssue <em>Result Issue</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.osate.results.ResultDataSpec <em>Result Data Spec</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createResultDataSpecAdapter() {
		return null;
	}
