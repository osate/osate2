...
public class AlisaOutputConfiugrationProvider extends OutputConfigurationProvider {
  ...
  public Set<OutputConfiguration> getOutputConfigurations() {
    ...
    final Procedure1<Set<OutputConfiguration>> _function = new Procedure1<Set<OutputConfiguration>>() {
      public void apply(final Set<OutputConfiguration> it) {
        ...
        _head.setOutputDirectory(AlisaOutputConfiugrationProvider.this.ALISA_GEN);
      }
    };
