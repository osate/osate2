 ...
 *   <li>{@link org.osate.alisa.workbench.alisa.AssurancePlan#getModelPlan <em>Model Plan</em>}</li>
 * </ul>
 *
...
public interface AssurancePlan extends EObject
{
  ...
  /**
   * Returns the value of the '<em><b>Model Plan</b></em>' containment reference list.
   * The list contents are of type {@link org.osate.alisa.workbench.alisa.ModelPlan}.
   * <!-- begin-user-doc -->
   * <p>
   * If the meaning of the '<em>Model Plan</em>' containment reference list isn't clear,
   * there really should be more of a description here...
   * </p>
   * <!-- end-user-doc -->
   * @return the value of the '<em>Model Plan</em>' containment reference list.
   * @see org.osate.alisa.workbench.alisa.AlisaPackage#getAssurancePlan_ModelPlan()
   * @model containment="true"
   * @generated
   */
  EList<ModelPlan> getModelPlan();
