		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getModelResultAccess().getMessageAssignment_5_1(), "rule__ModelResult__MessageAssignment_5_1");
					put(grammarAccess.getModelResultAccess().getClaimResultAssignment_6(), "rule__ModelResult__ClaimResultAssignment_6");
					put(grammarAccess.getModelResultAccess().getSubsystemResultAssignment_7(), "rule__ModelResult__SubsystemResultAssignment_7");
					put(grammarAccess.getModelResultAccess().getSubAssuranceCaseAssignment_8(), "rule__ModelResult__SubAssuranceCaseAssignment_8");
