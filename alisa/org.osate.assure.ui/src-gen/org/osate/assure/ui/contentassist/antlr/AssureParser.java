		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getPreconditionResultAccess().getResultsAssignment_9_1(), "rule__PreconditionResult__ResultsAssignment_9_1");
					...
					put(grammarAccess.getValidationResultAccess().getResultsAssignment_9_1(), "rule__ValidationResult__ResultsAssignment_9_1");
					...
					put(grammarAccess.getVerificationActivityResultAccess().getResultsAssignment_9_1(), "rule__VerificationActivityResult__ResultsAssignment_9_1");
					...
					put(grammarAccess.getPredicateResultAccess().getResultsAssignment_9_1(), "rule__PredicateResult__ResultsAssignment_9_1");
