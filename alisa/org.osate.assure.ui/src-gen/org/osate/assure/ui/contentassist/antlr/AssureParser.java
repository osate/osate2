		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getMetricsAccess().getRequirementsWithoutPlanClaimCountAssignment_13_1(), "rule__Metrics__RequirementsWithoutPlanClaimCountAssignment_13_1");
					put(grammarAccess.getMetricsAccess().getNoVerificationPlansCountAssignment_14_1(), "rule__Metrics__NoVerificationPlansCountAssignment_14_1");
					put(grammarAccess.getMetricsAccess().getRequirementsCountAssignment_15_1(), "rule__Metrics__RequirementsCountAssignment_15_1");
					put(grammarAccess.getMetricsAccess().getWeightAssignment_16_1(), "rule__Metrics__WeightAssignment_16_1");
					put(grammarAccess.getMetricsAccess().getExecutionTimeAssignment_17_1(), "rule__Metrics__ExecutionTimeAssignment_17_1");
