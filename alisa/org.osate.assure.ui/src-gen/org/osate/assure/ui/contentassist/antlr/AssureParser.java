		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getAssuranceEvidenceAccess().getMetricsAssignment_7(), "rule__AssuranceEvidence__MetricsAssignment_7");
					put(grammarAccess.getAssuranceEvidenceAccess().getMessageAssignment_8_1(), "rule__AssuranceEvidence__MessageAssignment_8_1");
					put(grammarAccess.getAssuranceEvidenceAccess().getSubAssuranceEvidenceAssignment_9(), "rule__AssuranceEvidence__SubAssuranceEvidenceAssignment_9");
					put(grammarAccess.getAssuranceEvidenceAccess().getClaimResultAssignment_10(), "rule__AssuranceEvidence__ClaimResultAssignment_10");
					...
					put(grammarAccess.getClaimResultAccess().getMetricsAssignment_4(), "rule__ClaimResult__MetricsAssignment_4");
