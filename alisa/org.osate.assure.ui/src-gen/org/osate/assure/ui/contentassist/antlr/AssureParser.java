		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getVerificationActivityResultAccess().getAndthenCountAssignment_11_1(), "rule__VerificationActivityResult__AndthenCountAssignment_11_1");
					put(grammarAccess.getVerificationActivityResultAccess().getTbdCountAssignment_12_1(), "rule__VerificationActivityResult__TbdCountAssignment_12_1");
