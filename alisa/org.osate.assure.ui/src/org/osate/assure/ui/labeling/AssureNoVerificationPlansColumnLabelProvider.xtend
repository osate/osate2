...
class AssureNoVerificationPlansColumnLabelProvider extends AssureRequirementsCoverageMetricsColumnLabelProvider {

	def int getCumulativeNoVerificationPlansCount(Object ele){
		switch ele {
			AssuranceCaseResult : {
