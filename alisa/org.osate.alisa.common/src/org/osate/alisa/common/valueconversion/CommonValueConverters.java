...
@Singleton
public class CommonValueConverters extends CommonValueConverter {
	// This class is bound as the value converter for AExpressions.
	@ValueConverter(rule = "AadlClassifierReference")
	public IValueConverter<String> AadlClassifierReference() {
		return new AbstractNullSafeConverter<String>() {
			@Override
			protected String internalToString(final String value) {
				return convertQualifiedName(value);
			}
	...
	private String convertQualifiedName(final String value) {
