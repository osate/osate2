 ...
 * @generated
 */
public class ABinaryOperationImpl extends AExpressionImpl implements ABinaryOperation
{
  /**
   * The cached value of the '{@link #getLeftOperand() <em>Left Operand</em>}' containment reference.
   * <!-- begin-user-doc -->
   ...
   * @ordered
   */
  protected AExpression leftOperand;
   ...
   * @ordered
   */
  protected AExpression rightOperand;
   ...
   * @generated
   */
  public NotificationChain basicSetLeftOperand(AExpression newLeftOperand, NotificationChain msgs)
  {
    AExpression oldLeftOperand = leftOperand;
    leftOperand = newLeftOperand;
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, CommonPackage.ABINARY_OPERATION__LEFT_OPERAND, oldLeftOperand, newLeftOperand);
   ...
   * @generated
   */
  public void setLeftOperand(AExpression newLeftOperand)
  {
    if (newLeftOperand != leftOperand)
    {
      NotificationChain msgs = null;
   ...
   * @generated
   */
  public NotificationChain basicSetRightOperand(AExpression newRightOperand, NotificationChain msgs)
  {
    AExpression oldRightOperand = rightOperand;
    rightOperand = newRightOperand;
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, CommonPackage.ABINARY_OPERATION__RIGHT_OPERAND, oldRightOperand, newRightOperand);
   ...
   * @generated
   */
  public void setRightOperand(AExpression newRightOperand)
  {
    if (newRightOperand != rightOperand)
    {
      NotificationChain msgs = null;
  ...
  public void eSet(int featureID, Object newValue)
  {
    ...
    {
      case CommonPackage.ABINARY_OPERATION__LEFT_OPERAND:
        setLeftOperand((AExpression)newValue);
        return;
      case CommonPackage.ABINARY_OPERATION__FEATURE:
        setFeature((String)newValue);
        return;
      case CommonPackage.ABINARY_OPERATION__RIGHT_OPERAND:
        setRightOperand((AExpression)newValue);
        return;
    }
    super.eSet(featureID, newValue);
  }
  ...
  public void eUnset(int featureID)
  {
    ...
    {
      case CommonPackage.ABINARY_OPERATION__LEFT_OPERAND:
        setLeftOperand((AExpression)null);
        return;
      case CommonPackage.ABINARY_OPERATION__FEATURE:
        setFeature(FEATURE_EDEFAULT);
        return;
      case CommonPackage.ABINARY_OPERATION__RIGHT_OPERAND:
        setRightOperand((AExpression)null);
