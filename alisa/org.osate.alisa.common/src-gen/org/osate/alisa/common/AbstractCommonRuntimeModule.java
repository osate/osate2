...
import org.osate.alisa.common.parser.antlr.CommonAntlrTokenFileProvider;
import org.osate.alisa.common.parser.antlr.CommonParser;
...
import org.osate.alisa.common.serializer.CommonSyntacticSequencer;
...
public abstract class AbstractCommonRuntimeModule extends DefaultRuntimeModule {
	...
	// contributed by org.eclipse.xtext.xtext.generator.parser.antlr.XtextAntlrGeneratorFragment2
	public Provider<? extends InternalCommonLexer> provideInternalCommonLexer() {
		return LexerProvider.create(InternalCommonLexer.class);
	}
