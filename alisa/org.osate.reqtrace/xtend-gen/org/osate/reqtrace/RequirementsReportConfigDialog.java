...
public class RequirementsReportConfigDialog extends TitleAreaDialog {
  ...
  public RequirementsReportConfigDialog(final Shell parent, final List<String> formats) {
    super(parent);
  ...
  protected void configureShell(final Shell newShell) {
    ...
    newShell.setText("Requirements Report");
  }

  @Override
  public void create() {
    super.create();
    this.setTitle("Requirements Report");
  ...
  protected Control createDialogArea(final Composite parent) {
    ...
    final Procedure1<Composite> _function = (Composite it) -> {
      ...
      final Procedure1<Composite> _function_1 = (Composite it_1) -> {
        ...
        ObjectExtensions.<Label>operator_doubleArrow(_label, _function_2);
        Text _text = new Text(it_1, ((SWT.SINGLE | SWT.LEFT) | SWT.BORDER));
        final Procedure1<Text> _function_3 = (Text it_2) -> {
          String _elvis = null;
          String _get = this.dialogSettings.get(RequirementsReportConfigDialog.OUTPUT_FILE_SETTING);
          if (_get != null) {
            _elvis = _get;
          } else {
            _elvis = "";
          ...
          it_2.setLayoutData(_gridData_1);
          final ModifyListener _function_4 = (ModifyEvent it_3) -> {
            this.validateOutputFile();
          };
          it_2.addModifyListener(_function_4);
        };
        ...
        final Procedure1<Button> _function_4 = (Button it_2) -> {
          ...
          it_2.addSelectionListener(new SelectionAdapter() {
            ...
            public void widgetSelected(final SelectionEvent e) {
              ...
              dialog.setFilterExtensions(((String[])Conversions.unwrapArray(ListExtensions.<String, String>map(RequirementsReportConfigDialog.this.formats, _function), String.class)));
              dialog.setFilterNames(((String[])Conversions.unwrapArray(RequirementsReportConfigDialog.this.formatDescriptions, String.class)));
              dialog.setText("Output File");
              final String selectedFileName = dialog.open();
              if ((selectedFileName != null)) {
                RequirementsReportConfigDialog.this.outputFileText.setText(selectedFileName);
                RequirementsReportConfigDialog.this.validateOutputFile();
              }
            }
          });
        };
      ...
      final Procedure1<Button> _function_2 = (Button it_1) -> {
        ...
        it_1.setLayoutData(_gridData);
        final String preference = this.dialogSettings.get(RequirementsReportConfigDialog.OPEN_FILE_SETTING);
  ...
  protected void okPressed() {
    ...
    this.dialogSettings.put(RequirementsReportConfigDialog.OUTPUT_FILE_SETTING, this.outputFile);
    this.dialogSettings.put(RequirementsReportConfigDialog.OPEN_FILE_SETTING, this.openFileAutomatically);
    super.okPressed();
  }
