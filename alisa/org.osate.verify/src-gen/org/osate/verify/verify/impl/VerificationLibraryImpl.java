...
public class VerificationLibraryImpl extends VerificationContainerImpl implements VerificationLibrary
{
  ...
  public ComponentClassifier getTarget()
  {
    if (target != null && ((EObject)target).eIsProxy())
    {
      ...
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, VerifyPackage.VERIFICATION_LIBRARY__TARGET, oldTarget, target));
      }
    }
    return target;
  }
  ...
  public NotificationChain basicSetDescription(Description newDescription, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, VerifyPackage.VERIFICATION_LIBRARY__DESCRIPTION, oldDescription, newDescription);
  ...
  public void setDescription(Description newDescription)
  {
    if (newDescription != description)
    {
      ...
      if (description != null)
        msgs = ((InternalEObject)description).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - VerifyPackage.VERIFICATION_LIBRARY__DESCRIPTION, null, msgs);
      if (newDescription != null)
        msgs = ((InternalEObject)newDescription).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - VerifyPackage.VERIFICATION_LIBRARY__DESCRIPTION, null, msgs);
      msgs = basicSetDescription(newDescription, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, VerifyPackage.VERIFICATION_LIBRARY__DESCRIPTION, newDescription, newDescription));
  }
