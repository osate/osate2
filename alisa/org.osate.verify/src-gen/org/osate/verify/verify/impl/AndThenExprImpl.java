 ...
 *   <li>{@link org.osate.verify.verify.impl.AndThenExprImpl#getOp <em>Op</em>}</li>
...
public class AndThenExprImpl extends ArgumentExprImpl implements AndThenExpr
{
  ...
  public void setOp(String newOp)
  {
    ...
    op = newOp;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, VerifyPackage.AND_THEN_EXPR__OP, oldOp, op));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case VerifyPackage.AND_THEN_EXPR__LEFT:
        return getLeft();
      case VerifyPackage.AND_THEN_EXPR__OP:
        return getOp();
      case VerifyPackage.AND_THEN_EXPR__RIGHT:
        return getRight();
    }
