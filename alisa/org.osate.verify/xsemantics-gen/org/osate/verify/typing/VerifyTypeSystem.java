...
public class VerifyTypeSystem extends CommonTypeSystem {
  ...
  protected Result<Boolean> assignablesequenceImpl(final RuleEnvironment G, final RuleApplicationTrace _trace_, final VerificationActivity owner, final List<FormalParameter> formals, final EList<PropertyExpression> actuals) throws RuleFailedException {
    try {
    	final RuleApplicationTrace _subtrace_ = newTrace(_trace_);
  ...
  protected Result<Boolean> applyRuleAssignableSequence(final RuleEnvironment G, final RuleApplicationTrace _trace_, final VerificationActivity owner, final List<FormalParameter> formals, final EList<PropertyExpression> actuals) throws RuleFailedException {
