...
package org.osate.reqspec.ui.linking;
...
public class ReqSpecLinkingDiagnosticMessageProvider extends LinkingDiagnosticMessageProvider {
	...
	public DiagnosticMessage getUnresolvedProxyMessage(ILinkingDiagnosticContext context) {
		...
		} else if (Aadl2Package.eINSTANCE.getNamedElement() == referenceType) {
			String targetName = "Component Classifier or Implementation";
			String msg = "Please provide model with target " + targetName + " containing named element '"
					+ context.getLinkText() + "' for verification.";
			return new DiagnosticMessage(msg, Severity.WARNING, Diagnostic.LINKING_DIAGNOSTIC);
		}
