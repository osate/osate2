...
public class GlobalRequirementsFileWizard extends AbstractNewFileWizard {
	private final String GLOBAL_REQUIREMENTS_LABEL = "Global requirements name";
	@Inject
	private IParser parser;
	@Inject
	private ReqSpecGrammarAccess grammarAccess;

	public GlobalRequirementsFileWizard() {
		super("Global Requirements", "reqspec", 1, ReqspecActivator.getInstance().getLog(), "org.osate.reqspec.ui");
	...
	public String fileContents(final Map<String, String> fieldValues) {
		return "global requirements " + fieldValues.get(GLOBAL_REQUIREMENTS_LABEL) + " [\n\t\n]";
	}
}
