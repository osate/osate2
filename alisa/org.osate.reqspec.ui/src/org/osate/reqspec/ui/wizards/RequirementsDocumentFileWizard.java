...
public class RequirementsDocumentFileWizard extends AbstractNewFileWizard {
	private final String DOCUMENT_LABEL = "Document name";
	@Inject
	private IParser parser;
	@Inject
	private ReqSpecGrammarAccess grammarAccess;

	public RequirementsDocumentFileWizard() {
		super("Requirements Document", "reqdoc", 1, ReqspecActivator.getInstance().getLog(), "org.osate.reqspec.ui");
	...
	public String fileContents(final Map<String, String> fieldValues) {
		return "document " + fieldValues.get(DOCUMENT_LABEL) + " [\n\t\n]";
	}
}
