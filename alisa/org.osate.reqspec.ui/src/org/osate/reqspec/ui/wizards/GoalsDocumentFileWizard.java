...
public class GoalsDocumentFileWizard extends AbstractNewFileWizard {
	...
	public GoalsDocumentFileWizard() {
		super("Goals Document", "goaldoc", 1, ReqspecActivator.getInstance().getLog(), "org.osate.reqspec.ui");
