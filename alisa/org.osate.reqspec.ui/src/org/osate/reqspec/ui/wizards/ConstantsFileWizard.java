...
public class ConstantsFileWizard extends AbstractNewFileWizard {
	private final String CONSTANTS_LABEL = "Constants name";
	@Inject
	private IParser parser;
	@Inject
	private ReqSpecGrammarAccess grammarAccess;

	public ConstantsFileWizard() {
		super("Constants", "constants", 1, ReqspecActivator.getInstance().getLog(), "org.osate.reqspec.ui");
	...
	public String fileContents(final Map<String, String> fieldValues) {
		return "constants " + fieldValues.get(CONSTANTS_LABEL) + " [\n\t\n]";
	}
}
