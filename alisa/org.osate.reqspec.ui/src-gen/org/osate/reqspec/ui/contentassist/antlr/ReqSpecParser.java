		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getSystemRequirementSetAccess().getGroup_9_4(), "rule__SystemRequirementSet__Group_9_4__0");
					...
					put(grammarAccess.getGlobalRequirementSetAccess().getGroup_7_3(), "rule__GlobalRequirementSet__Group_7_3__0");
					...
					put(grammarAccess.getSystemRequirementSetAccess().getRequirementsAssignment_9_2(), "rule__SystemRequirementSet__RequirementsAssignment_9_2");
					put(grammarAccess.getSystemRequirementSetAccess().getIncludeAssignment_9_3(), "rule__SystemRequirementSet__IncludeAssignment_9_3");
					put(grammarAccess.getSystemRequirementSetAccess().getDocReferenceAssignment_9_4_2(), "rule__SystemRequirementSet__DocReferenceAssignment_9_4_2");
					put(grammarAccess.getSystemRequirementSetAccess().getStakeholderGoalsAssignment_9_5_2(), "rule__SystemRequirementSet__StakeholderGoalsAssignment_9_5_2");
					put(grammarAccess.getSystemRequirementSetAccess().getIssuesAssignment_9_6_1(), "rule__SystemRequirementSet__IssuesAssignment_9_6_1");
					...
					put(grammarAccess.getGlobalRequirementSetAccess().getRequirementsAssignment_7_2(), "rule__GlobalRequirementSet__RequirementsAssignment_7_2");
					put(grammarAccess.getGlobalRequirementSetAccess().getDocReferenceAssignment_7_3_2(), "rule__GlobalRequirementSet__DocReferenceAssignment_7_3_2");
					put(grammarAccess.getGlobalRequirementSetAccess().getStakeholderGoalsAssignment_7_4_2(), "rule__GlobalRequirementSet__StakeholderGoalsAssignment_7_4_2");
					put(grammarAccess.getGlobalRequirementSetAccess().getIssuesAssignment_7_5_1(), "rule__GlobalRequirementSet__IssuesAssignment_7_5_1");
