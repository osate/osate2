		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getReqSpecsAccess().getGlobalAssignment_4_1_1(), "rule__ReqSpecs__GlobalAssignment_4_1_1");
					...
					put(grammarAccess.getDocGoalAccess().getStakeholderReferenceAssignment_5_7_1(), "rule__DocGoal__StakeholderReferenceAssignment_5_7_1");
					put(grammarAccess.getDocGoalAccess().getDocumentRequirementAssignment_5_8_3(), "rule__DocGoal__DocumentRequirementAssignment_5_8_3");
					put(grammarAccess.getDocGoalAccess().getDocReferenceAssignment_5_9_2(), "rule__DocGoal__DocReferenceAssignment_5_9_2");
					put(grammarAccess.getDocGoalAccess().getIssuesAssignment_5_10_1(), "rule__DocGoal__IssuesAssignment_5_10_1");
					...
					put(grammarAccess.getDocRequirementAccess().getGoalReferenceAssignment_5_9_2(), "rule__DocRequirement__GoalReferenceAssignment_5_9_2");
					put(grammarAccess.getDocRequirementAccess().getStakeholderRequirementReferenceAssignment_5_10_3(), "rule__DocRequirement__StakeholderRequirementReferenceAssignment_5_10_3");
					put(grammarAccess.getDocRequirementAccess().getDocumentRequirementAssignment_5_11_3(), "rule__DocRequirement__DocumentRequirementAssignment_5_11_3");
					put(grammarAccess.getDocRequirementAccess().getDocReferenceAssignment_5_12_2(), "rule__DocRequirement__DocReferenceAssignment_5_12_2");
					put(grammarAccess.getDocRequirementAccess().getIssuesAssignment_5_13_1(), "rule__DocRequirement__IssuesAssignment_5_13_1");
