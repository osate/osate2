		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getSystemRequirementAccess().getEvolvesReferenceAssignment_6_12_1(), "rule__SystemRequirement__EvolvesReferenceAssignment_6_12_1");
					put(grammarAccess.getSystemRequirementAccess().getDroppedAssignment_6_13_0(), "rule__SystemRequirement__DroppedAssignment_6_13_0");
					put(grammarAccess.getSystemRequirementAccess().getDropRationaleAssignment_6_13_1(), "rule__SystemRequirement__DropRationaleAssignment_6_13_1");
					put(grammarAccess.getSystemRequirementAccess().getDevelopmentStakeholderAssignment_6_14_2(), "rule__SystemRequirement__DevelopmentStakeholderAssignment_6_14_2");
					put(grammarAccess.getSystemRequirementAccess().getGoalReferenceAssignment_6_15_2(), "rule__SystemRequirement__GoalReferenceAssignment_6_15_2");
					put(grammarAccess.getSystemRequirementAccess().getRequirementReferenceAssignment_6_16_2(), "rule__SystemRequirement__RequirementReferenceAssignment_6_16_2");
					put(grammarAccess.getSystemRequirementAccess().getDocReferenceAssignment_6_17_2(), "rule__SystemRequirement__DocReferenceAssignment_6_17_2");
					put(grammarAccess.getSystemRequirementAccess().getIssuesAssignment_6_18_1(), "rule__SystemRequirement__IssuesAssignment_6_18_1");
					...
					put(grammarAccess.getDocRequirementAccess().getEvolvesReferenceAssignment_6_12_1(), "rule__DocRequirement__EvolvesReferenceAssignment_6_12_1");
					put(grammarAccess.getDocRequirementAccess().getDroppedAssignment_6_13_0(), "rule__DocRequirement__DroppedAssignment_6_13_0");
					put(grammarAccess.getDocRequirementAccess().getDropRationaleAssignment_6_13_1(), "rule__DocRequirement__DropRationaleAssignment_6_13_1");
					put(grammarAccess.getDocRequirementAccess().getDevelopmentStakeholderAssignment_6_14_2(), "rule__DocRequirement__DevelopmentStakeholderAssignment_6_14_2");
					put(grammarAccess.getDocRequirementAccess().getGoalReferenceAssignment_6_15_2(), "rule__DocRequirement__GoalReferenceAssignment_6_15_2");
					put(grammarAccess.getDocRequirementAccess().getDocReferenceAssignment_6_16_2(), "rule__DocRequirement__DocReferenceAssignment_6_16_2");
					put(grammarAccess.getDocRequirementAccess().getIssuesAssignment_6_17_1(), "rule__DocRequirement__IssuesAssignment_6_17_1");
