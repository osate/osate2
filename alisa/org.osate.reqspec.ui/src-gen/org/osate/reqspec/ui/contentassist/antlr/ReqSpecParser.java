		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getSystemRequirementAccess().getAlternatives_6_8_1(), "rule__SystemRequirement__Alternatives_6_8_1");
					put(grammarAccess.getGlobalRequirementAccess().getAlternatives_4_1(), "rule__GlobalRequirement__Alternatives_4_1");
					put(grammarAccess.getGlobalRequirementAccess().getAlternatives_6_8_1(), "rule__GlobalRequirement__Alternatives_6_8_1");
					...
					put(grammarAccess.getSystemRequirementAccess().getGroup_6_8(), "rule__SystemRequirement__Group_6_8__0");
					...
					put(grammarAccess.getGlobalRequirementAccess().getGroup_6_8(), "rule__GlobalRequirement__Group_6_8__0");
					...
					put(grammarAccess.getSystemRequirementAccess().getCategoryAssignment_6_0_1(), "rule__SystemRequirement__CategoryAssignment_6_0_1");
					put(grammarAccess.getSystemRequirementAccess().getDescriptionAssignment_6_1(), "rule__SystemRequirement__DescriptionAssignment_6_1");
					put(grammarAccess.getSystemRequirementAccess().getConstantsAssignment_6_2(), "rule__SystemRequirement__ConstantsAssignment_6_2");
					put(grammarAccess.getSystemRequirementAccess().getComputesAssignment_6_3(), "rule__SystemRequirement__ComputesAssignment_6_3");
					put(grammarAccess.getSystemRequirementAccess().getWhenconditionAssignment_6_4(), "rule__SystemRequirement__WhenconditionAssignment_6_4");
					put(grammarAccess.getSystemRequirementAccess().getPredicateAssignment_6_5(), "rule__SystemRequirement__PredicateAssignment_6_5");
					put(grammarAccess.getSystemRequirementAccess().getRationaleAssignment_6_6(), "rule__SystemRequirement__RationaleAssignment_6_6");
					put(grammarAccess.getSystemRequirementAccess().getChangeUncertaintyAssignment_6_7(), "rule__SystemRequirement__ChangeUncertaintyAssignment_6_7");
					put(grammarAccess.getSystemRequirementAccess().getExceptionAssignment_6_8_1_0(), "rule__SystemRequirement__ExceptionAssignment_6_8_1_0");
					put(grammarAccess.getSystemRequirementAccess().getExceptionTextAssignment_6_8_1_1(), "rule__SystemRequirement__ExceptionTextAssignment_6_8_1_1");
					put(grammarAccess.getSystemRequirementAccess().getRefinesReferenceAssignment_6_9_1(), "rule__SystemRequirement__RefinesReferenceAssignment_6_9_1");
					put(grammarAccess.getSystemRequirementAccess().getDecomposesReferenceAssignment_6_10_1(), "rule__SystemRequirement__DecomposesReferenceAssignment_6_10_1");
					put(grammarAccess.getSystemRequirementAccess().getInheritsReferenceAssignment_6_11_1(), "rule__SystemRequirement__InheritsReferenceAssignment_6_11_1");
					...
					put(grammarAccess.getGlobalRequirementAccess().getCategoryAssignment_6_0_1(), "rule__GlobalRequirement__CategoryAssignment_6_0_1");
					put(grammarAccess.getGlobalRequirementAccess().getDescriptionAssignment_6_1(), "rule__GlobalRequirement__DescriptionAssignment_6_1");
					put(grammarAccess.getGlobalRequirementAccess().getConstantsAssignment_6_2(), "rule__GlobalRequirement__ConstantsAssignment_6_2");
					put(grammarAccess.getGlobalRequirementAccess().getComputesAssignment_6_3(), "rule__GlobalRequirement__ComputesAssignment_6_3");
					put(grammarAccess.getGlobalRequirementAccess().getWhenconditionAssignment_6_4(), "rule__GlobalRequirement__WhenconditionAssignment_6_4");
					put(grammarAccess.getGlobalRequirementAccess().getPredicateAssignment_6_5(), "rule__GlobalRequirement__PredicateAssignment_6_5");
					put(grammarAccess.getGlobalRequirementAccess().getRationaleAssignment_6_6(), "rule__GlobalRequirement__RationaleAssignment_6_6");
					put(grammarAccess.getGlobalRequirementAccess().getChangeUncertaintyAssignment_6_7(), "rule__GlobalRequirement__ChangeUncertaintyAssignment_6_7");
					put(grammarAccess.getGlobalRequirementAccess().getExceptionAssignment_6_8_1_0(), "rule__GlobalRequirement__ExceptionAssignment_6_8_1_0");
					put(grammarAccess.getGlobalRequirementAccess().getExceptionTextAssignment_6_8_1_1(), "rule__GlobalRequirement__ExceptionTextAssignment_6_8_1_1");
					put(grammarAccess.getGlobalRequirementAccess().getRefinesReferenceAssignment_6_9_1(), "rule__GlobalRequirement__RefinesReferenceAssignment_6_9_1");
					put(grammarAccess.getGlobalRequirementAccess().getDecomposesReferenceAssignment_6_10_1(), "rule__GlobalRequirement__DecomposesReferenceAssignment_6_10_1");
					put(grammarAccess.getGlobalRequirementAccess().getEvolvesReferenceAssignment_6_11_1(), "rule__GlobalRequirement__EvolvesReferenceAssignment_6_11_1");
					put(grammarAccess.getGlobalRequirementAccess().getDroppedAssignment_6_12_0(), "rule__GlobalRequirement__DroppedAssignment_6_12_0");
					put(grammarAccess.getGlobalRequirementAccess().getDropRationaleAssignment_6_12_1(), "rule__GlobalRequirement__DropRationaleAssignment_6_12_1");
					put(grammarAccess.getGlobalRequirementAccess().getDevelopmentStakeholderAssignment_6_13_2(), "rule__GlobalRequirement__DevelopmentStakeholderAssignment_6_13_2");
					put(grammarAccess.getGlobalRequirementAccess().getGoalReferenceAssignment_6_14_2(), "rule__GlobalRequirement__GoalReferenceAssignment_6_14_2");
					put(grammarAccess.getGlobalRequirementAccess().getRequirementReferenceAssignment_6_15_2(), "rule__GlobalRequirement__RequirementReferenceAssignment_6_15_2");
					put(grammarAccess.getGlobalRequirementAccess().getDocReferenceAssignment_6_16_2(), "rule__GlobalRequirement__DocReferenceAssignment_6_16_2");
					put(grammarAccess.getGlobalRequirementAccess().getIssuesAssignment_6_17_1(), "rule__GlobalRequirement__IssuesAssignment_6_17_1");
