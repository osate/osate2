		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getRequirementAccess().getAlternatives_5_9_1(), "rule__Requirement__Alternatives_5_9_1");
					...
					put(grammarAccess.getSystemRequirementsAccess().getGroup_5(), "rule__SystemRequirements__Group_5__0");
					put(grammarAccess.getSystemRequirementsAccess().getGroup_7_4(), "rule__SystemRequirements__Group_7_4__0");
					put(grammarAccess.getSystemRequirementsAccess().getGroup_7_5(), "rule__SystemRequirements__Group_7_5__0");
					...
					put(grammarAccess.getGoalAccess().getGroup_5_14(), "rule__Goal__Group_5_14__0");
					...
					put(grammarAccess.getRequirementAccess().getGroup_3_1_0(), "rule__Requirement__Group_3_1_0__0");
					...
					put(grammarAccess.getRequirementAccess().getGroup_5_18(), "rule__Requirement__Group_5_18__0");
					put(grammarAccess.getRequirementAccess().getGroup_5_19(), "rule__Requirement__Group_5_19__0");
					...
					put(grammarAccess.getSystemRequirementsAccess().getComputesAssignment_7_2(), "rule__SystemRequirements__ComputesAssignment_7_2");
					put(grammarAccess.getSystemRequirementsAccess().getContentAssignment_7_3(), "rule__SystemRequirements__ContentAssignment_7_3");
					put(grammarAccess.getSystemRequirementsAccess().getDocReferenceAssignment_7_4_2(), "rule__SystemRequirements__DocReferenceAssignment_7_4_2");
					put(grammarAccess.getSystemRequirementsAccess().getIssuesAssignment_7_5_1(), "rule__SystemRequirements__IssuesAssignment_7_5_1");
					...
					put(grammarAccess.getGoalAccess().getDocumentRequirementAssignment_5_12_3(), "rule__Goal__DocumentRequirementAssignment_5_12_3");
					put(grammarAccess.getGoalAccess().getDocReferenceAssignment_5_13_2(), "rule__Goal__DocReferenceAssignment_5_13_2");
					put(grammarAccess.getGoalAccess().getIssuesAssignment_5_14_1(), "rule__Goal__IssuesAssignment_5_14_1");
					...
					put(grammarAccess.getRequirementAccess().getTargetAssignment_3_1_0_0(), "rule__Requirement__TargetAssignment_3_1_0_0");
					put(grammarAccess.getRequirementAccess().getTargetElementAssignment_3_1_0_1(), "rule__Requirement__TargetElementAssignment_3_1_0_1");
					put(grammarAccess.getRequirementAccess().getTargetElementAssignment_3_1_1(), "rule__Requirement__TargetElementAssignment_3_1_1");
					put(grammarAccess.getRequirementAccess().getComponentCategoryAssignment_3_1_2(), "rule__Requirement__ComponentCategoryAssignment_3_1_2");
					put(grammarAccess.getRequirementAccess().getGlobalAssignment_3_1_3(), "rule__Requirement__GlobalAssignment_3_1_3");
					put(grammarAccess.getRequirementAccess().getCategoryAssignment_5_0_1(), "rule__Requirement__CategoryAssignment_5_0_1");
					put(grammarAccess.getRequirementAccess().getCategoryAssignment_5_1_1(), "rule__Requirement__CategoryAssignment_5_1_1");
					put(grammarAccess.getRequirementAccess().getCategoryAssignment_5_2_1(), "rule__Requirement__CategoryAssignment_5_2_1");
					put(grammarAccess.getRequirementAccess().getDescriptionAssignment_5_3(), "rule__Requirement__DescriptionAssignment_5_3");
					put(grammarAccess.getRequirementAccess().getConstantsAssignment_5_4(), "rule__Requirement__ConstantsAssignment_5_4");
					put(grammarAccess.getRequirementAccess().getComputesAssignment_5_5(), "rule__Requirement__ComputesAssignment_5_5");
					put(grammarAccess.getRequirementAccess().getPredicateAssignment_5_6(), "rule__Requirement__PredicateAssignment_5_6");
					put(grammarAccess.getRequirementAccess().getRationaleAssignment_5_7(), "rule__Requirement__RationaleAssignment_5_7");
					put(grammarAccess.getRequirementAccess().getChangeUncertaintyAssignment_5_8(), "rule__Requirement__ChangeUncertaintyAssignment_5_8");
					put(grammarAccess.getRequirementAccess().getExceptionAssignment_5_9_1_0(), "rule__Requirement__ExceptionAssignment_5_9_1_0");
					put(grammarAccess.getRequirementAccess().getExceptionTextAssignment_5_9_1_1(), "rule__Requirement__ExceptionTextAssignment_5_9_1_1");
					put(grammarAccess.getRequirementAccess().getRefinesReferenceAssignment_5_10_1(), "rule__Requirement__RefinesReferenceAssignment_5_10_1");
					put(grammarAccess.getRequirementAccess().getDecomposesReferenceAssignment_5_11_1(), "rule__Requirement__DecomposesReferenceAssignment_5_11_1");
					put(grammarAccess.getRequirementAccess().getEvolvesReferenceAssignment_5_12_1(), "rule__Requirement__EvolvesReferenceAssignment_5_12_1");
					put(grammarAccess.getRequirementAccess().getDroppedAssignment_5_13_0(), "rule__Requirement__DroppedAssignment_5_13_0");
					put(grammarAccess.getRequirementAccess().getDropRationaleAssignment_5_13_1(), "rule__Requirement__DropRationaleAssignment_5_13_1");
					put(grammarAccess.getRequirementAccess().getDevelopmentStakeholderAssignment_5_14_2(), "rule__Requirement__DevelopmentStakeholderAssignment_5_14_2");
					put(grammarAccess.getRequirementAccess().getGoalReferenceAssignment_5_15_2(), "rule__Requirement__GoalReferenceAssignment_5_15_2");
					put(grammarAccess.getRequirementAccess().getStakeholderRequirementReferenceAssignment_5_16_3(), "rule__Requirement__StakeholderRequirementReferenceAssignment_5_16_3");
					put(grammarAccess.getRequirementAccess().getDocumentRequirementAssignment_5_17_3(), "rule__Requirement__DocumentRequirementAssignment_5_17_3");
					put(grammarAccess.getRequirementAccess().getDocReferenceAssignment_5_18_2(), "rule__Requirement__DocReferenceAssignment_5_18_2");
					put(grammarAccess.getRequirementAccess().getIssuesAssignment_5_19_1(), "rule__Requirement__IssuesAssignment_5_19_1");
					...
					put(grammarAccess.getDocRequirementAccess().getGoalReferenceAssignment_5_13_2(), "rule__DocRequirement__GoalReferenceAssignment_5_13_2");
					put(grammarAccess.getDocRequirementAccess().getStakeholderRequirementReferenceAssignment_5_14_3(), "rule__DocRequirement__StakeholderRequirementReferenceAssignment_5_14_3");
					put(grammarAccess.getDocRequirementAccess().getDocumentRequirementAssignment_5_15_3(), "rule__DocRequirement__DocumentRequirementAssignment_5_15_3");
					...
					put(grammarAccess.getSystemRequirementsAccess().getUnorderedGroup_7(), "rule__SystemRequirements__UnorderedGroup_7");
