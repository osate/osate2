		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getReqSpecsAccess().getGroup_6(), "rule__ReqSpecs__Group_6__0");
					...
					put(grammarAccess.getReqSpecsAccess().getConstantsAssignment_6_1(), "rule__ReqSpecs__ConstantsAssignment_6_1");
