		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getSystemRequirementsAccess().getGroup_9_4(), "rule__SystemRequirements__Group_9_4__0");
					...
					put(grammarAccess.getSystemRequirementsAccess().getDocReferenceAssignment_9_4_2(), "rule__SystemRequirements__DocReferenceAssignment_9_4_2");
					put(grammarAccess.getSystemRequirementsAccess().getStakeholderGoalsAssignment_9_5_2(), "rule__SystemRequirements__StakeholderGoalsAssignment_9_5_2");
					put(grammarAccess.getSystemRequirementsAccess().getIssuesAssignment_9_6_1(), "rule__SystemRequirements__IssuesAssignment_9_6_1");
					...
					put(grammarAccess.getDocGoalAccess().getRequirementTypeAssignment_5_0_2(), "rule__DocGoal__RequirementTypeAssignment_5_0_2");
					put(grammarAccess.getDocGoalAccess().getQualityAttributeAssignment_5_1_2(), "rule__DocGoal__QualityAttributeAssignment_5_1_2");
					put(grammarAccess.getDocGoalAccess().getUserSelectionAssignment_5_2_2(), "rule__DocGoal__UserSelectionAssignment_5_2_2");
					...
					put(grammarAccess.getGoalAccess().getRequirementTypeAssignment_5_0_2(), "rule__Goal__RequirementTypeAssignment_5_0_2");
					put(grammarAccess.getGoalAccess().getQualityAttributeAssignment_5_1_2(), "rule__Goal__QualityAttributeAssignment_5_1_2");
					put(grammarAccess.getGoalAccess().getUserSelectionAssignment_5_2_2(), "rule__Goal__UserSelectionAssignment_5_2_2");
					...
					put(grammarAccess.getSystemRequirementAccess().getRequirementTypeAssignment_5_0_2(), "rule__SystemRequirement__RequirementTypeAssignment_5_0_2");
					put(grammarAccess.getSystemRequirementAccess().getQualityAttributeAssignment_5_1_2(), "rule__SystemRequirement__QualityAttributeAssignment_5_1_2");
					put(grammarAccess.getSystemRequirementAccess().getUserSelectionAssignment_5_2_2(), "rule__SystemRequirement__UserSelectionAssignment_5_2_2");
					...
					put(grammarAccess.getRequirementAccess().getRequirementTypeAssignment_5_0_2(), "rule__Requirement__RequirementTypeAssignment_5_0_2");
					put(grammarAccess.getRequirementAccess().getQualityAttributeAssignment_5_1_2(), "rule__Requirement__QualityAttributeAssignment_5_1_2");
					put(grammarAccess.getRequirementAccess().getUserSelectionAssignment_5_2_2(), "rule__Requirement__UserSelectionAssignment_5_2_2");
