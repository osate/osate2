		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getSystemRequirementsAccess().getGroup_7_6(), "rule__SystemRequirements__Group_7_6__0");
					...
					put(grammarAccess.getSystemRequirementsAccess().getDocReferenceAssignment_7_4_1(), "rule__SystemRequirements__DocReferenceAssignment_7_4_1");
					put(grammarAccess.getSystemRequirementsAccess().getStakeholderGoalsAssignment_7_5_2(), "rule__SystemRequirements__StakeholderGoalsAssignment_7_5_2");
					put(grammarAccess.getSystemRequirementsAccess().getIssuesAssignment_7_6_1(), "rule__SystemRequirements__IssuesAssignment_7_6_1");
