		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getSystemRequirementAccess().getConstantsAssignment_5_2(), "rule__SystemRequirement__ConstantsAssignment_5_2");
					put(grammarAccess.getSystemRequirementAccess().getComputesAssignment_5_3(), "rule__SystemRequirement__ComputesAssignment_5_3");
					put(grammarAccess.getSystemRequirementAccess().getWhenconditionAssignment_5_4(), "rule__SystemRequirement__WhenconditionAssignment_5_4");
					...
					put(grammarAccess.getSystemRequirementAccess().getInheritsReferenceAssignment_5_11_1(), "rule__SystemRequirement__InheritsReferenceAssignment_5_11_1");
