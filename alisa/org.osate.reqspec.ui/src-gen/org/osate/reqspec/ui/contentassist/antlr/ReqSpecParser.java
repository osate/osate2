		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getRequirementAccess().getGroup_6_3_2(), "rule__Requirement__Group_6_3_2__0");
					put(grammarAccess.getRequirementAccess().getGroup_6_4(), "rule__Requirement__Group_6_4__0");
					put(grammarAccess.getRequirementAccess().getGroup_6_4_3(), "rule__Requirement__Group_6_4_3__0");
					put(grammarAccess.getRequirementAccess().getGroup_6_5(), "rule__Requirement__Group_6_5__0");
					put(grammarAccess.getRequirementAccess().getGroup_6_5_2(), "rule__Requirement__Group_6_5_2__0");
					...
					put(grammarAccess.getRequirementAccess().getGroup_6_8_2(), "rule__Requirement__Group_6_8_2__0");
					...
					put(grammarAccess.getReqSpecModelAccess().getImportDeclarationsAssignment_3(), "rule__ReqSpecModel__ImportDeclarationsAssignment_3");
					...
					put(grammarAccess.getRequirementAccess().getIssueAssignment_6_3_1(), "rule__Requirement__IssueAssignment_6_3_1");
					put(grammarAccess.getRequirementAccess().getIssueAssignment_6_3_2_1(), "rule__Requirement__IssueAssignment_6_3_2_1");
					put(grammarAccess.getRequirementAccess().getGoalReferenceAssignment_6_4_2(), "rule__Requirement__GoalReferenceAssignment_6_4_2");
					put(grammarAccess.getRequirementAccess().getGoalReferenceAssignment_6_4_3_1(), "rule__Requirement__GoalReferenceAssignment_6_4_3_1");
					put(grammarAccess.getRequirementAccess().getHazardReferenceAssignment_6_5_1(), "rule__Requirement__HazardReferenceAssignment_6_5_1");
					put(grammarAccess.getRequirementAccess().getHazardReferenceAssignment_6_5_2_1(), "rule__Requirement__HazardReferenceAssignment_6_5_2_1");
					put(grammarAccess.getRequirementAccess().getRefinesReferenceAssignment_6_6_1(), "rule__Requirement__RefinesReferenceAssignment_6_6_1");
					put(grammarAccess.getRequirementAccess().getRefinesReferenceAssignment_6_6_2_1(), "rule__Requirement__RefinesReferenceAssignment_6_6_2_1");
					put(grammarAccess.getRequirementAccess().getSubrequirementAssignment_6_7(), "rule__Requirement__SubrequirementAssignment_6_7");
					put(grammarAccess.getRequirementAccess().getDecomposesReferenceAssignment_6_8_1(), "rule__Requirement__DecomposesReferenceAssignment_6_8_1");
					put(grammarAccess.getRequirementAccess().getDecomposesReferenceAssignment_6_8_2_1(), "rule__Requirement__DecomposesReferenceAssignment_6_8_2_1");
