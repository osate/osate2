		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getGlobalRequirementAccess().getAlternatives_5_9_1(), "rule__GlobalRequirement__Alternatives_5_9_1");
					...
					put(grammarAccess.getDesiredValueAccess().getAlternatives_0(), "rule__DesiredValue__Alternatives_0");
					...
					put(grammarAccess.getGlobalRequirementAccess().getGroup_5_1(), "rule__GlobalRequirement__Group_5_1__0");
					...
					put(grammarAccess.getGlobalRequirementAccess().getGroup_5_18(), "rule__GlobalRequirement__Group_5_18__0");
					...
					put(grammarAccess.getDocGoalAccess().getWhenconditionAssignment_5_4(), "rule__DocGoal__WhenconditionAssignment_5_4");
					...
					put(grammarAccess.getGoalAccess().getWhenconditionAssignment_5_4(), "rule__Goal__WhenconditionAssignment_5_4");
					...
					put(grammarAccess.getGoalAccess().getGoalReferenceAssignment_5_12_2(), "rule__Goal__GoalReferenceAssignment_5_12_2");
					...
					put(grammarAccess.getSystemRequirementAccess().getWhenconditionAssignment_5_5(), "rule__SystemRequirement__WhenconditionAssignment_5_5");
					...
					put(grammarAccess.getGlobalRequirementAccess().getConnectionsAssignment_3_1_1(), "rule__GlobalRequirement__ConnectionsAssignment_3_1_1");
					put(grammarAccess.getGlobalRequirementAccess().getQualityCategoryAssignment_5_0_1(), "rule__GlobalRequirement__QualityCategoryAssignment_5_0_1");
					put(grammarAccess.getGlobalRequirementAccess().getUserCategoryAssignment_5_1_1(), "rule__GlobalRequirement__UserCategoryAssignment_5_1_1");
					put(grammarAccess.getGlobalRequirementAccess().getDescriptionAssignment_5_2(), "rule__GlobalRequirement__DescriptionAssignment_5_2");
					put(grammarAccess.getGlobalRequirementAccess().getConstantsAssignment_5_3(), "rule__GlobalRequirement__ConstantsAssignment_5_3");
					put(grammarAccess.getGlobalRequirementAccess().getComputesAssignment_5_4(), "rule__GlobalRequirement__ComputesAssignment_5_4");
					put(grammarAccess.getGlobalRequirementAccess().getWhenconditionAssignment_5_5(), "rule__GlobalRequirement__WhenconditionAssignment_5_5");
					put(grammarAccess.getGlobalRequirementAccess().getPredicateAssignment_5_6(), "rule__GlobalRequirement__PredicateAssignment_5_6");
					put(grammarAccess.getGlobalRequirementAccess().getRationaleAssignment_5_7(), "rule__GlobalRequirement__RationaleAssignment_5_7");
					put(grammarAccess.getGlobalRequirementAccess().getChangeUncertaintyAssignment_5_8(), "rule__GlobalRequirement__ChangeUncertaintyAssignment_5_8");
					put(grammarAccess.getGlobalRequirementAccess().getExceptionAssignment_5_9_1_0(), "rule__GlobalRequirement__ExceptionAssignment_5_9_1_0");
					put(grammarAccess.getGlobalRequirementAccess().getExceptionTextAssignment_5_9_1_1(), "rule__GlobalRequirement__ExceptionTextAssignment_5_9_1_1");
					put(grammarAccess.getGlobalRequirementAccess().getRefinesReferenceAssignment_5_10_1(), "rule__GlobalRequirement__RefinesReferenceAssignment_5_10_1");
					put(grammarAccess.getGlobalRequirementAccess().getDecomposesReferenceAssignment_5_11_1(), "rule__GlobalRequirement__DecomposesReferenceAssignment_5_11_1");
					put(grammarAccess.getGlobalRequirementAccess().getEvolvesReferenceAssignment_5_12_1(), "rule__GlobalRequirement__EvolvesReferenceAssignment_5_12_1");
					put(grammarAccess.getGlobalRequirementAccess().getDroppedAssignment_5_13_0(), "rule__GlobalRequirement__DroppedAssignment_5_13_0");
					put(grammarAccess.getGlobalRequirementAccess().getDropRationaleAssignment_5_13_1(), "rule__GlobalRequirement__DropRationaleAssignment_5_13_1");
					put(grammarAccess.getGlobalRequirementAccess().getDevelopmentStakeholderAssignment_5_14_2(), "rule__GlobalRequirement__DevelopmentStakeholderAssignment_5_14_2");
					put(grammarAccess.getGlobalRequirementAccess().getGoalReferenceAssignment_5_15_2(), "rule__GlobalRequirement__GoalReferenceAssignment_5_15_2");
					put(grammarAccess.getGlobalRequirementAccess().getRequirementReferenceAssignment_5_16_2(), "rule__GlobalRequirement__RequirementReferenceAssignment_5_16_2");
					put(grammarAccess.getGlobalRequirementAccess().getDocReferenceAssignment_5_17_2(), "rule__GlobalRequirement__DocReferenceAssignment_5_17_2");
					put(grammarAccess.getGlobalRequirementAccess().getIssuesAssignment_5_18_1(), "rule__GlobalRequirement__IssuesAssignment_5_18_1");
					...
					put(grammarAccess.getDocRequirementAccess().getWhenconditionAssignment_5_5(), "rule__DocRequirement__WhenconditionAssignment_5_5");
					...
					put(grammarAccess.getValuePredicateAccess().getDesiredValueAssignment_3(), "rule__ValuePredicate__DesiredValueAssignment_3");
					put(grammarAccess.getDesiredValueAccess().getUptoAssignment_0_0(), "rule__DesiredValue__UptoAssignment_0_0");
					put(grammarAccess.getDesiredValueAccess().getValueAssignment_1(), "rule__DesiredValue__ValueAssignment_1");
