		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getReqSpecsAccess().getContentAlternatives_8_0(), "rule__ReqSpecs__ContentAlternatives_8_0");
					put(grammarAccess.getReqLibAccess().getAlternatives_3_1(), "rule__ReqLib__Alternatives_3_1");
					put(grammarAccess.getReqLibAccess().getContentAlternatives_6_0(), "rule__ReqLib__ContentAlternatives_6_0");
					...
					put(grammarAccess.getReqSpecsAccess().getGroup_7(), "rule__ReqSpecs__Group_7__0");
					put(grammarAccess.getQualifiedNameWithWildCardAccess().getGroup(), "rule__QualifiedNameWithWildCard__Group__0");
					put(grammarAccess.getReqLibAccess().getGroup(), "rule__ReqLib__Group__0");
					put(grammarAccess.getReqLibAccess().getGroup_2(), "rule__ReqLib__Group_2__0");
					put(grammarAccess.getReqLibAccess().getGroup_3(), "rule__ReqLib__Group_3__0");
					put(grammarAccess.getReqLibAccess().getGroup_5(), "rule__ReqLib__Group_5__0");
					...
					put(grammarAccess.getGoalAccess().getGroup_5_3_2(), "rule__Goal__Group_5_3_2__0");
					...
					put(grammarAccess.getGoalAccess().getGroup_5_6_4(), "rule__Goal__Group_5_6_4__0");
					...
					put(grammarAccess.getRequirementAccess().getGroup_5_7_2(), "rule__Requirement__Group_5_7_2__0");
					put(grammarAccess.getRequirementAccess().getGroup_5_8(), "rule__Requirement__Group_5_8__0");
					put(grammarAccess.getRequirementAccess().getGroup_5_8_4(), "rule__Requirement__Group_5_8_4__0");
					put(grammarAccess.getRequirementAccess().getGroup_5_9(), "rule__Requirement__Group_5_9__0");
					put(grammarAccess.getRequirementAccess().getGroup_5_9_4(), "rule__Requirement__Group_5_9_4__0");
					...
					put(grammarAccess.getStakeholderGoalsAccess().getConsistsOfAssignment_7(), "rule__StakeholderGoals__ConsistsOfAssignment_7");
					...
					put(grammarAccess.getReqSpecsAccess().getLibrariesAssignment_5_1(), "rule__ReqSpecs__LibrariesAssignment_5_1");
					put(grammarAccess.getReqSpecsAccess().getConstantsAssignment_7_1(), "rule__ReqSpecs__ConstantsAssignment_7_1");
					put(grammarAccess.getReqSpecsAccess().getContentAssignment_8(), "rule__ReqSpecs__ContentAssignment_8");
					put(grammarAccess.getReqLibAccess().getNameAssignment_1(), "rule__ReqLib__NameAssignment_1");
					put(grammarAccess.getReqLibAccess().getTitleAssignment_2_1(), "rule__ReqLib__TitleAssignment_2_1");
					put(grammarAccess.getReqLibAccess().getTargetAssignment_3_1_0(), "rule__ReqLib__TargetAssignment_3_1_0");
					put(grammarAccess.getReqLibAccess().getTargetDescriptionAssignment_3_1_1(), "rule__ReqLib__TargetDescriptionAssignment_3_1_1");
					put(grammarAccess.getReqLibAccess().getConstantsAssignment_5_1(), "rule__ReqLib__ConstantsAssignment_5_1");
					put(grammarAccess.getReqLibAccess().getContentAssignment_6(), "rule__ReqLib__ContentAssignment_6");
					...
					put(grammarAccess.getGoalAccess().getRefinesReferenceAssignment_5_3_2_1(), "rule__Goal__RefinesReferenceAssignment_5_3_2_1");
					put(grammarAccess.getGoalAccess().getConflictsReferenceAssignment_5_4_2(), "rule__Goal__ConflictsReferenceAssignment_5_4_2");
					put(grammarAccess.getGoalAccess().getConflictsReferenceAssignment_5_4_3_1(), "rule__Goal__ConflictsReferenceAssignment_5_4_3_1");
					put(grammarAccess.getGoalAccess().getStakeholderReferenceAssignment_5_5_1(), "rule__Goal__StakeholderReferenceAssignment_5_5_1");
					put(grammarAccess.getGoalAccess().getStakeholderReferenceAssignment_5_5_2_1(), "rule__Goal__StakeholderReferenceAssignment_5_5_2_1");
					put(grammarAccess.getGoalAccess().getDocumentRequirementAssignment_5_6_3(), "rule__Goal__DocumentRequirementAssignment_5_6_3");
					put(grammarAccess.getGoalAccess().getDocumentRequirementAssignment_5_6_4_1(), "rule__Goal__DocumentRequirementAssignment_5_6_4_1");
					put(grammarAccess.getGoalAccess().getDocReferenceAssignment_5_7_2(), "rule__Goal__DocReferenceAssignment_5_7_2");
					put(grammarAccess.getGoalAccess().getDocReferenceAssignment_5_7_3_1(), "rule__Goal__DocReferenceAssignment_5_7_3_1");
					...
					put(grammarAccess.getRequirementAccess().getRefinesReferenceAssignment_5_7_2_1(), "rule__Requirement__RefinesReferenceAssignment_5_7_2_1");
					...
					put(grammarAccess.getRequirementAccess().getStakeholderRequirementReferenceAssignment_5_8_4_1(), "rule__Requirement__StakeholderRequirementReferenceAssignment_5_8_4_1");
					...
					put(grammarAccess.getRequirementAccess().getDocumentRequirementAssignment_5_9_4_1(), "rule__Requirement__DocumentRequirementAssignment_5_9_4_1");
					put(grammarAccess.getRequirementAccess().getDocReferenceAssignment_5_10_2(), "rule__Requirement__DocReferenceAssignment_5_10_2");
					put(grammarAccess.getRequirementAccess().getDocReferenceAssignment_5_10_3_1(), "rule__Requirement__DocReferenceAssignment_5_10_3_1");
