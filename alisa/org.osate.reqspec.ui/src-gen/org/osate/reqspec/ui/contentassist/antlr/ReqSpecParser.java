		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getRequirementAccess().getGoalReferenceAssignment_5_13_2(), "rule__Requirement__GoalReferenceAssignment_5_13_2");
					put(grammarAccess.getRequirementAccess().getStakeholderRequirementReferenceAssignment_5_14_3(), "rule__Requirement__StakeholderRequirementReferenceAssignment_5_14_3");
					put(grammarAccess.getRequirementAccess().getDocumentRequirementAssignment_5_15_3(), "rule__Requirement__DocumentRequirementAssignment_5_15_3");
