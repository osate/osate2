		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getReqSpecsAccess().getContentAlternatives_7_2_0(), "rule__ReqSpecs__ContentAlternatives_7_2_0");
					...
					put(grammarAccess.getStakeholderGoalsAccess().getGroup_8(), "rule__StakeholderGoals__Group_8__0");
					...
					put(grammarAccess.getReqSpecsAccess().getGroup_8(), "rule__ReqSpecs__Group_8__0");
					...
					put(grammarAccess.getRequirementAccess().getGroup_3_1_2(), "rule__Requirement__Group_3_1_2__0");
					put(grammarAccess.getRequirementAccess().getGroup_3_1_2_1(), "rule__Requirement__Group_3_1_2_1__0");
					...
					put(grammarAccess.getStakeholderGoalsAccess().getDescriptionAssignment_5(), "rule__StakeholderGoals__DescriptionAssignment_5");
					put(grammarAccess.getStakeholderGoalsAccess().getContentAssignment_7(), "rule__StakeholderGoals__ContentAssignment_7");
					put(grammarAccess.getStakeholderGoalsAccess().getIssuesAssignment_8_1(), "rule__StakeholderGoals__IssuesAssignment_8_1");
					...
					put(grammarAccess.getReqSpecsAccess().getComputesAssignment_7_1(), "rule__ReqSpecs__ComputesAssignment_7_1");
					put(grammarAccess.getReqSpecsAccess().getContentAssignment_7_2(), "rule__ReqSpecs__ContentAssignment_7_2");
					put(grammarAccess.getReqSpecsAccess().getIssuesAssignment_8_1(), "rule__ReqSpecs__IssuesAssignment_8_1");
					...
					put(grammarAccess.getGoalAccess().getRationaleAssignment_5_2(), "rule__Goal__RationaleAssignment_5_2");
					put(grammarAccess.getGoalAccess().getChangeUncertaintyAssignment_5_3(), "rule__Goal__ChangeUncertaintyAssignment_5_3");
					put(grammarAccess.getGoalAccess().getRefinesReferenceAssignment_5_4_1(), "rule__Goal__RefinesReferenceAssignment_5_4_1");
					put(grammarAccess.getGoalAccess().getConflictsReferenceAssignment_5_5_2(), "rule__Goal__ConflictsReferenceAssignment_5_5_2");
					put(grammarAccess.getGoalAccess().getStakeholderReferenceAssignment_5_6_1(), "rule__Goal__StakeholderReferenceAssignment_5_6_1");
					put(grammarAccess.getGoalAccess().getDocumentRequirementAssignment_5_7_3(), "rule__Goal__DocumentRequirementAssignment_5_7_3");
					put(grammarAccess.getGoalAccess().getDocReferenceAssignment_5_8_2(), "rule__Goal__DocReferenceAssignment_5_8_2");
					put(grammarAccess.getGoalAccess().getIssuesAssignment_5_9_1(), "rule__Goal__IssuesAssignment_5_9_1");
					...
					put(grammarAccess.getRequirementAccess().getTargetElementAssignment_3_1_0(), "rule__Requirement__TargetElementAssignment_3_1_0");
					...
					put(grammarAccess.getRequirementAccess().getTargetAssignment_3_1_2_0(), "rule__Requirement__TargetAssignment_3_1_2_0");
					put(grammarAccess.getRequirementAccess().getTargetElementAssignment_3_1_2_1_1(), "rule__Requirement__TargetElementAssignment_3_1_2_1_1");
