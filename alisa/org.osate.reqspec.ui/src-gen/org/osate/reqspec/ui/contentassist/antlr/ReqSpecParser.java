		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getStakeholderGoalsAccess().getAlternatives_0_4_1(), "rule__StakeholderGoals__Alternatives_0_4_1");
					put(grammarAccess.getReqDocumentAccess().getContentAlternatives_5_0(), "rule__ReqDocument__ContentAlternatives_5_0");
					...
					put(grammarAccess.getStakeholderGoalsAccess().getGroup_0(), "rule__StakeholderGoals__Group_0__0");
					put(grammarAccess.getStakeholderGoalsAccess().getGroup_0_3(), "rule__StakeholderGoals__Group_0_3__0");
					put(grammarAccess.getStakeholderGoalsAccess().getGroup_0_4(), "rule__StakeholderGoals__Group_0_4__0");
					put(grammarAccess.getStakeholderGoalsAccess().getGroup_1(), "rule__StakeholderGoals__Group_1__0");
					put(grammarAccess.getStakeholderGoalsAccess().getGroup_1_0(), "rule__StakeholderGoals__Group_1_0__0");
					put(grammarAccess.getStakeholderGoalsAccess().getGroup_1_3(), "rule__StakeholderGoals__Group_1_3__0");
					...
					put(grammarAccess.getReqDocumentAccess().getGroup_6(), "rule__ReqDocument__Group_6__0");
					...
					put(grammarAccess.getReqSpecsAccess().getGroup_7_2(), "rule__ReqSpecs__Group_7_2__0");
					...
					put(grammarAccess.getRequirementAccess().getGroup_3_1_1(), "rule__Requirement__Group_3_1_1__0");
					put(grammarAccess.getRequirementAccess().getGroup_3_1_1_1(), "rule__Requirement__Group_3_1_1_1__0");
					...
					put(grammarAccess.getStakeholderGoalsAccess().getNameAssignment_0_2(), "rule__StakeholderGoals__NameAssignment_0_2");
					put(grammarAccess.getStakeholderGoalsAccess().getTitleAssignment_0_3_1(), "rule__StakeholderGoals__TitleAssignment_0_3_1");
					put(grammarAccess.getStakeholderGoalsAccess().getTargetAssignment_0_4_1_0(), "rule__StakeholderGoals__TargetAssignment_0_4_1_0");
					put(grammarAccess.getStakeholderGoalsAccess().getTargetDescriptionAssignment_0_4_1_1(), "rule__StakeholderGoals__TargetDescriptionAssignment_0_4_1_1");
					put(grammarAccess.getStakeholderGoalsAccess().getGlobalAssignment_0_4_1_2(), "rule__StakeholderGoals__GlobalAssignment_0_4_1_2");
					put(grammarAccess.getStakeholderGoalsAccess().getDescriptionAssignment_0_5(), "rule__StakeholderGoals__DescriptionAssignment_0_5");
					put(grammarAccess.getStakeholderGoalsAccess().getDocReferenceAssignment_1_0_2(), "rule__StakeholderGoals__DocReferenceAssignment_1_0_2");
					put(grammarAccess.getStakeholderGoalsAccess().getContentAssignment_1_2(), "rule__StakeholderGoals__ContentAssignment_1_2");
					put(grammarAccess.getStakeholderGoalsAccess().getIssuesAssignment_1_3_1(), "rule__StakeholderGoals__IssuesAssignment_1_3_1");
					...
					put(grammarAccess.getReqDocumentAccess().getDescriptionAssignment_3(), "rule__ReqDocument__DescriptionAssignment_3");
					put(grammarAccess.getReqDocumentAccess().getContentAssignment_5(), "rule__ReqDocument__ContentAssignment_5");
					put(grammarAccess.getReqDocumentAccess().getIssuesAssignment_6_1(), "rule__ReqDocument__IssuesAssignment_6_1");
					...
					put(grammarAccess.getDocumentSectionAccess().getDescriptionAssignment_3(), "rule__DocumentSection__DescriptionAssignment_3");
					...
					put(grammarAccess.getReqSpecsAccess().getGlobalAssignment_4_1_2(), "rule__ReqSpecs__GlobalAssignment_4_1_2");
					...
					put(grammarAccess.getReqSpecsAccess().getDocReferenceAssignment_7_2_2(), "rule__ReqSpecs__DocReferenceAssignment_7_2_2");
					...
					put(grammarAccess.getGoalAccess().getStakeholderReferenceAssignment_5_7_1(), "rule__Goal__StakeholderReferenceAssignment_5_7_1");
					put(grammarAccess.getGoalAccess().getDocumentRequirementAssignment_5_8_3(), "rule__Goal__DocumentRequirementAssignment_5_8_3");
					put(grammarAccess.getGoalAccess().getDocReferenceAssignment_5_9_2(), "rule__Goal__DocReferenceAssignment_5_9_2");
					put(grammarAccess.getGoalAccess().getIssuesAssignment_5_10_1(), "rule__Goal__IssuesAssignment_5_10_1");
					...
					put(grammarAccess.getRequirementAccess().getTargetDescriptionAssignment_3_1_0(), "rule__Requirement__TargetDescriptionAssignment_3_1_0");
					put(grammarAccess.getRequirementAccess().getTargetAssignment_3_1_1_0(), "rule__Requirement__TargetAssignment_3_1_1_0");
					put(grammarAccess.getRequirementAccess().getTargetElementAssignment_3_1_1_1_1(), "rule__Requirement__TargetElementAssignment_3_1_1_1_1");
					...
					put(grammarAccess.getRequirementAccess().getIssuesAssignment_5_13_1(), "rule__Requirement__IssuesAssignment_5_13_1");
					...
					put(grammarAccess.getStakeholderGoalsAccess().getUnorderedGroup(), "rule__StakeholderGoals__UnorderedGroup");
