		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getDocRequirementAccess().getAlternatives_5_9_1(), "rule__DocRequirement__Alternatives_5_9_1");
					...
					put(grammarAccess.getGlobalRequirementsAccess().getGroup_2(), "rule__GlobalRequirements__Group_2__0");
					put(grammarAccess.getGlobalRequirementsAccess().getGroup_3(), "rule__GlobalRequirements__Group_3__0");
					put(grammarAccess.getGlobalRequirementsAccess().getGroup_5_4(), "rule__GlobalRequirements__Group_5_4__0");
					put(grammarAccess.getGlobalRequirementsAccess().getGroup_5_5(), "rule__GlobalRequirements__Group_5_5__0");
					put(grammarAccess.getGlobalRequirementsAccess().getGroup_5_6(), "rule__GlobalRequirements__Group_5_6__0");
					...
					put(grammarAccess.getDocRequirementAccess().getGroup_5_2(), "rule__DocRequirement__Group_5_2__0");
					...
					put(grammarAccess.getSystemRequirementsAccess().getDocReferenceAssignment_8_4_2(), "rule__SystemRequirements__DocReferenceAssignment_8_4_2");
					...
					put(grammarAccess.getGlobalRequirementsAccess().getNameAssignment_1(), "rule__GlobalRequirements__NameAssignment_1");
					put(grammarAccess.getGlobalRequirementsAccess().getTitleAssignment_2_1(), "rule__GlobalRequirements__TitleAssignment_2_1");
					put(grammarAccess.getGlobalRequirementsAccess().getImportConstantsAssignment_3_2(), "rule__GlobalRequirements__ImportConstantsAssignment_3_2");
					put(grammarAccess.getGlobalRequirementsAccess().getDescriptionAssignment_5_0(), "rule__GlobalRequirements__DescriptionAssignment_5_0");
					put(grammarAccess.getGlobalRequirementsAccess().getConstantsAssignment_5_1(), "rule__GlobalRequirements__ConstantsAssignment_5_1");
					put(grammarAccess.getGlobalRequirementsAccess().getComputesAssignment_5_2(), "rule__GlobalRequirements__ComputesAssignment_5_2");
					put(grammarAccess.getGlobalRequirementsAccess().getContentAssignment_5_3(), "rule__GlobalRequirements__ContentAssignment_5_3");
					put(grammarAccess.getGlobalRequirementsAccess().getDocReferenceAssignment_5_4_2(), "rule__GlobalRequirements__DocReferenceAssignment_5_4_2");
					put(grammarAccess.getGlobalRequirementsAccess().getStakeholderGoalsAssignment_5_5_2(), "rule__GlobalRequirements__StakeholderGoalsAssignment_5_5_2");
					put(grammarAccess.getGlobalRequirementsAccess().getIssuesAssignment_5_6_1(), "rule__GlobalRequirements__IssuesAssignment_5_6_1");
					...
					put(grammarAccess.getDocGoalAccess().getDocReferenceAssignment_5_12_2(), "rule__DocGoal__DocReferenceAssignment_5_12_2");
					...
					put(grammarAccess.getDocRequirementAccess().getCategoryAssignment_5_1_1(), "rule__DocRequirement__CategoryAssignment_5_1_1");
					put(grammarAccess.getDocRequirementAccess().getCategoryAssignment_5_2_1(), "rule__DocRequirement__CategoryAssignment_5_2_1");
					put(grammarAccess.getDocRequirementAccess().getDescriptionAssignment_5_3(), "rule__DocRequirement__DescriptionAssignment_5_3");
					put(grammarAccess.getDocRequirementAccess().getConstantsAssignment_5_4(), "rule__DocRequirement__ConstantsAssignment_5_4");
					put(grammarAccess.getDocRequirementAccess().getComputesAssignment_5_5(), "rule__DocRequirement__ComputesAssignment_5_5");
					put(grammarAccess.getDocRequirementAccess().getPredicateAssignment_5_6(), "rule__DocRequirement__PredicateAssignment_5_6");
					put(grammarAccess.getDocRequirementAccess().getRationaleAssignment_5_7(), "rule__DocRequirement__RationaleAssignment_5_7");
					put(grammarAccess.getDocRequirementAccess().getChangeUncertaintyAssignment_5_8(), "rule__DocRequirement__ChangeUncertaintyAssignment_5_8");
					put(grammarAccess.getDocRequirementAccess().getExceptionAssignment_5_9_1_0(), "rule__DocRequirement__ExceptionAssignment_5_9_1_0");
					put(grammarAccess.getDocRequirementAccess().getExceptionTextAssignment_5_9_1_1(), "rule__DocRequirement__ExceptionTextAssignment_5_9_1_1");
					put(grammarAccess.getDocRequirementAccess().getRefinesReferenceAssignment_5_10_1(), "rule__DocRequirement__RefinesReferenceAssignment_5_10_1");
					put(grammarAccess.getDocRequirementAccess().getDecomposesReferenceAssignment_5_11_1(), "rule__DocRequirement__DecomposesReferenceAssignment_5_11_1");
					...
					put(grammarAccess.getGlobalRequirementsAccess().getUnorderedGroup_5(), "rule__GlobalRequirements__UnorderedGroup_5");
