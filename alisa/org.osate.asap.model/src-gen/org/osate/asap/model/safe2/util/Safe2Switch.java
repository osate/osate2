/**
 */
package org.osate.asap.model.safe2.util;
 ...
 * @generated
 */
public class Safe2Switch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case Safe2Package.FUNDAMENTAL: {
				Fundamental fundamental = (Fundamental)theEObject;
				T result = caseFundamental(fundamental);
				if (result == null) result = caseNode(fundamental);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Safe2Package.ACCIDENT: {
				Accident accident = (Accident)theEObject;
				T result = caseAccident(accident);
				if (result == null) result = caseFundamental(accident);
				if (result == null) result = caseNode(accident);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Safe2Package.HAZARD: {
				Hazard hazard = (Hazard)theEObject;
				T result = caseHazard(hazard);
				if (result == null) result = caseFundamental(hazard);
				if (result == null) result = caseNode(hazard);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Safe2Package.ACCIDENT_LEVEL: {
				AccidentLevel accidentLevel = (AccidentLevel)theEObject;
				T result = caseAccidentLevel(accidentLevel);
				if (result == null) result = caseFundamental(accidentLevel);
				if (result == null) result = caseNode(accidentLevel);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Safe2Package.CONSTRAINT: {
				Constraint constraint = (Constraint)theEObject;
				T result = caseConstraint(constraint);
				if (result == null) result = caseFundamental(constraint);
				if (result == null) result = caseNode(constraint);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Safe2Package.CONTROL_ACTION: {
				ControlAction controlAction = (ControlAction)theEObject;
				T result = caseControlAction(controlAction);
				if (result == null) result = caseNode(controlAction);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Safe2Package.NODE: {
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Fundamental</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Fundamental</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseFundamental(Fundamental object) {
		return null;
	}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Accident Level</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Accident Level</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseAccidentLevel(AccidentLevel object) {
		return null;
	}
