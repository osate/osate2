...
public abstract class AbstractAlisaUiModule extends org.eclipse.xtext.ui.DefaultUiModule {
	...
	public void configureCompareViewerTitle(com.google.inject.Binder binder) {
		binder.bind(String.class).annotatedWith(com.google.inject.name.Names.named(org.eclipse.xtext.ui.UIBindings.COMPARE_VIEWER_TITLE)).toInstance("Alisa Compare");
	}
