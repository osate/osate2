		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getAssuranceCaseConfigurationAccess().getGroup_6_3(), "rule__AssuranceCaseConfiguration__Group_6_3__0");
					...
					put(grammarAccess.getAssuranceCaseConfigurationAccess().getConstantsAssignment_6_1_1(), "rule__AssuranceCaseConfiguration__ConstantsAssignment_6_1_1");
					put(grammarAccess.getAssuranceCaseConfigurationAccess().getPlansAssignment_6_2_1(), "rule__AssuranceCaseConfiguration__PlansAssignment_6_2_1");
					put(grammarAccess.getAssuranceCaseConfigurationAccess().getSelectionFilterAssignment_6_3_1(), "rule__AssuranceCaseConfiguration__SelectionFilterAssignment_6_3_1");
