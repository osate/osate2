	...
	protected String getRuleName(AbstractElement element) {
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				...
				{
					put(grammarAccess.getAssurancePlanAccess().getAlternatives_7_2_2(), "rule__AssurancePlan__Alternatives_7_2_2");
					...
					put(grammarAccess.getAssuranceTaskAccess().getGroup_6_4(), "rule__AssuranceTask__Group_6_4__0");
					...
					put(grammarAccess.getAssurancePlanAccess().getAssureSubsystemsAssignment_7_2_2_0(), "rule__AssurancePlan__AssureSubsystemsAssignment_7_2_2_0");
					put(grammarAccess.getAssurancePlanAccess().getAssureAllAssignment_7_2_2_1(), "rule__AssurancePlan__AssureAllAssignment_7_2_2_1");
					...
					put(grammarAccess.getAssuranceTaskAccess().getUserCategoryAssignment_6_1_1(), "rule__AssuranceTask__UserCategoryAssignment_6_1_1");
					put(grammarAccess.getAssuranceTaskAccess().getAnyUserSelectionAssignment_6_1_2(), "rule__AssuranceTask__AnyUserSelectionAssignment_6_1_2");
					put(grammarAccess.getAssuranceTaskAccess().getQualityCategoryAssignment_6_2_1(), "rule__AssuranceTask__QualityCategoryAssignment_6_2_1");
					put(grammarAccess.getAssuranceTaskAccess().getAnyQualityAttributeAssignment_6_2_2(), "rule__AssuranceTask__AnyQualityAttributeAssignment_6_2_2");
					put(grammarAccess.getAssuranceTaskAccess().getPhaseCategoryAssignment_6_3_1(), "rule__AssuranceTask__PhaseCategoryAssignment_6_3_1");
					put(grammarAccess.getAssuranceTaskAccess().getAnyDevelopmentPhaseAssignment_6_3_2(), "rule__AssuranceTask__AnyDevelopmentPhaseAssignment_6_3_2");
					put(grammarAccess.getAssuranceTaskAccess().getIssuesAssignment_6_4_1(), "rule__AssuranceTask__IssuesAssignment_6_4_1");
