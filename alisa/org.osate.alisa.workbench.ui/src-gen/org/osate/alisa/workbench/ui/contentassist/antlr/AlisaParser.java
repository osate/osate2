		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getAssuranceTaskAccess().getGroup_8_4(), "rule__AssuranceTask__Group_8_4__0");
					put(grammarAccess.getAssuranceTaskAccess().getGroup_8_5(), "rule__AssuranceTask__Group_8_5__0");
					...
					put(grammarAccess.getAssuranceTaskAccess().getRequirementTypeAssignment_8_0_2(), "rule__AssuranceTask__RequirementTypeAssignment_8_0_2");
					put(grammarAccess.getAssuranceTaskAccess().getAnyRequirementTypeAssignment_8_0_3(), "rule__AssuranceTask__AnyRequirementTypeAssignment_8_0_3");
					put(grammarAccess.getAssuranceTaskAccess().getMethodTypeAssignment_8_1_2(), "rule__AssuranceTask__MethodTypeAssignment_8_1_2");
					put(grammarAccess.getAssuranceTaskAccess().getAnyMethodTypeAssignment_8_1_3(), "rule__AssuranceTask__AnyMethodTypeAssignment_8_1_3");
					put(grammarAccess.getAssuranceTaskAccess().getUserSelectionAssignment_8_2_2(), "rule__AssuranceTask__UserSelectionAssignment_8_2_2");
					put(grammarAccess.getAssuranceTaskAccess().getAnyUserSelectionAssignment_8_2_3(), "rule__AssuranceTask__AnyUserSelectionAssignment_8_2_3");
					put(grammarAccess.getAssuranceTaskAccess().getQualityAttributeAssignment_8_3_2(), "rule__AssuranceTask__QualityAttributeAssignment_8_3_2");
					put(grammarAccess.getAssuranceTaskAccess().getAnyQualityAttributeAssignment_8_3_3(), "rule__AssuranceTask__AnyQualityAttributeAssignment_8_3_3");
					put(grammarAccess.getAssuranceTaskAccess().getDevelopmentPhaseAssignment_8_4_2(), "rule__AssuranceTask__DevelopmentPhaseAssignment_8_4_2");
					put(grammarAccess.getAssuranceTaskAccess().getAnyDevelopmentPhaseAssignment_8_4_3(), "rule__AssuranceTask__AnyDevelopmentPhaseAssignment_8_4_3");
					put(grammarAccess.getAssuranceTaskAccess().getIssuesAssignment_8_5_1(), "rule__AssuranceTask__IssuesAssignment_8_5_1");
