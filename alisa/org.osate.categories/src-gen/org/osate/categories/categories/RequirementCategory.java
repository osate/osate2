 ...
 * <ul>
 *   <li>{@link org.osate.categories.categories.RequirementCategory#getName <em>Name</em>}</li>
 ...
 * @generated
 */
public interface RequirementCategory extends EObject
{
  /**
   ...
   * @see #setName(String)
   * @see org.osate.categories.categories.CategoriesPackage#getRequirementCategory_Name()
   * @model
   * @generated
   */
  String getName();
  ...
  /**
   * Sets the value of the '{@link org.osate.categories.categories.RequirementCategory#getName <em>Name</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
