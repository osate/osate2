...
public class InternalCategoriesLexer extends Lexer {
    ...
    public final void mT__14() throws RecognitionException {
        try {
            int _type = T__14;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalCategories.g:14:7: ( 'any' )
            // InternalCategories.g:14:9: 'any'
            {
            match("any"); 
    ...
    public final void mT__15() throws RecognitionException {
        try {
            int _type = T__15;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalCategories.g:15:7: ( '.' )
            // InternalCategories.g:15:9: '.'
            {
            match('.'); 
    ...
    public final void mRULE_ID() throws RecognitionException {
        try {
            int _type = RULE_ID;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalCategories.g:356:9: ( ( '^' )? ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )* )
            // InternalCategories.g:356:11: ( '^' )? ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )*
            {
            // InternalCategories.g:356:11: ( '^' )?
            int alt1=2;
            ...
            // InternalCategories.g:356:40: ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )*
            loop2:
            do {
                int alt2=2;
    ...
    public final void mRULE_INT() throws RecognitionException {
        try {
            int _type = RULE_INT;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalCategories.g:358:10: ( ( '0' .. '9' )+ )
            // InternalCategories.g:358:12: ( '0' .. '9' )+
            {
            // InternalCategories.g:358:12: ( '0' .. '9' )+
            int cnt3=0;
            loop3:
            do {
                ...
                switch (alt3) {
            	case 1 :
            	    // InternalCategories.g:358:13: '0' .. '9'
            	    {
            	    matchRange('0','9'); 
    ...
    public final void mRULE_STRING() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalCategories.g:360:13: ( ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' ) )
            // InternalCategories.g:360:15: ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' )
            {
            // InternalCategories.g:360:15: ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' )
            int alt6=2;
            ...
            switch (alt6) {
                case 1 :
                    // InternalCategories.g:360:16: '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"'
                    {
                    match('\"'); 
                    // InternalCategories.g:360:20: ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )*
                    loop4:
                    do {
                        int alt4=3;
                    ...
                    break;
                case 2 :
                    // InternalCategories.g:360:48: '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\''
                    {
                    match('\''); 
                    // InternalCategories.g:360:53: ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )*
                    loop5:
                    do {
                        int alt5=3;
    ...
    public final void mRULE_ML_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalCategories.g:362:17: ( '/*' ( options {greedy=false; } : . )* '*/' )
            // InternalCategories.g:362:19: '/*' ( options {greedy=false; } : . )* '*/'
            {
            match("/*"); 

            // InternalCategories.g:362:24: ( options {greedy=false; } : . )*
            loop7:
            do {
                int alt7=2;
    ...
    public final void mRULE_SL_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalCategories.g:364:17: ( '//' (~ ( ( '\\n' | '\\r' ) ) )* ( ( '\\r' )? '\\n' )? )
            // InternalCategories.g:364:19: '//' (~ ( ( '\\n' | '\\r' ) ) )* ( ( '\\r' )? '\\n' )?
            {
            match("//"); 

            // InternalCategories.g:364:24: (~ ( ( '\\n' | '\\r' ) ) )*
            loop8:
            do {
                int alt8=2;
    ...
    public final void mRULE_WS() throws RecognitionException {
        try {
            int _type = RULE_WS;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalCategories.g:366:9: ( ( ' ' | '\\t' | '\\r' | '\\n' )+ )
            // InternalCategories.g:366:11: ( ' ' | '\\t' | '\\r' | '\\n' )+
            {
            // InternalCategories.g:366:11: ( ' ' | '\\t' | '\\r' | '\\n' )+
            int cnt11=0;
            loop11:
    ...
    public final void mRULE_ANY_OTHER() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalCategories.g:368:16: ( . )
            // InternalCategories.g:368:18: .
            {
            matchAny(); 
    ...
    static final String DFA12_eotS =
        "\3\uffff\2\21\1\uffff\1\15\2\uffff\3\15\4\uffff\1\21\1\uffff\1\21\6\uffff\1\21\1\34\1\21\1\uffff\1\21\1\37\1\uffff";
    static final String DFA12_eofS =
        "\40\uffff";
    static final String DFA12_minS =
        "\1\0\2\uffff\1\151\1\156\1\uffff\1\101\2\uffff\2\0\1\52\4\uffff\1\154\1\uffff\1\171\6\uffff\1\164\1\60\1\145\1\uffff\1\162\1\60\1\uffff";
    static final String DFA12_maxS =
        "\1\uffff\2\uffff\1\151\1\156\1\uffff\1\172\2\uffff\2\uffff\1\57\4\uffff\1\154\1\uffff\1\171\6\uffff\1\164\1\172\1\145\1\uffff\1\162\1\172\1\uffff";
    static final String DFA12_acceptS =
        "\1\uffff\1\1\1\2\2\uffff\1\5\1\uffff\1\6\1\7\3\uffff\1\13\1\14\1\1\1\2\1\uffff\1\6\1\uffff\1\5\1\7\1\10\1\11\1\12\1\13\3\uffff\1\4\2\uffff\1\3";
    static final String DFA12_specialS =
        "\1\1\10\uffff\1\2\1\0\25\uffff}>";
    static final String[] DFA12_transitionS = {
            "\11\15\2\14\2\15\1\14\22\15\1\14\1\15\1\11\4\15\1\12\6\15\1\5\1\13\12\10\7\15\32\7\1\1\1\15\1\2\1\6\1\7\1\15\1\4\4\7\1\3\24\7\uff85\15",
            "",
            "",
            "\1\20",
            "\1\22",
