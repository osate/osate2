...
public class InternalCategoriesParser extends AbstractInternalAntlrParser {
    ...
    public final String entryRuleCatRef() throws RecognitionException {
        ...
        try {
            ...
            pushFollow(FOLLOW_ruleCatRef_in_entryRuleCatRef1076);
            iv_ruleCatRef=ruleCatRef();

            state._fsp--;

             current =iv_ruleCatRef.getText(); 
            match(input,EOF,FOLLOW_EOF_in_entryRuleCatRef1087); 
    ...
    public final AntlrDatatypeRuleToken ruleCatRef() throws RecognitionException {
        ...
        try {
            ...
            {
            this_ID_0=(Token)match(input,RULE_ID,FOLLOW_RULE_ID_in_ruleCatRef1126); 
    ...
    public static final BitSet FOLLOW_ruleCatRef_in_entryRuleCatRef1076 = new BitSet(new long[]{0x0000000000000000L});
    public static final BitSet FOLLOW_EOF_in_entryRuleCatRef1087 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_RULE_ID_in_ruleCatRef1126 = new BitSet(new long[]{0x0000000000000002L});
